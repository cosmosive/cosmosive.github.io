import{i as m}from"./rolldown-runtime-BOC55nOF.js";import{p as f}from"./r3f-vendor-CiF_hEUp.js";import{kt as p}from"./sceneRuntimeTypes-Ba-OycFt.js";import{a as d}from"./catalog-query-defaults-BcARUz2n.js";import{$ as v}from"./index-DrOwY-TC.js";import{a as h,i as C,o as S}from"./r3fHostExtras-C8VytOx0.js";import{D as g,W as y,h as P,ht as R,pt as k}from"./three-vendor-DnPFe64c.js";import{i as D}from"./majorDsoSelector-CQtzxLKn.js";import{n as A}from"./dsoMajorCluster-Cu-xWQOQ.js";import{t as M}from"./shaderNoiseHelpers-DXgXQMEZ.js";import{t as _}from"./createDsoMountR3f-NsDJI0Go.js";var i=m(f(),1),F=Math.PI/180/60,x=v.far/4;function E(r){return r.openNgcTypeRaw==="GCl"?"globular":"open"}function L(r){if(r.type!=="star_cluster"||!Number.isFinite(r.distPc)||r.distPc<=0||!Number.isFinite(r.majAxArcmin)||(r.majAxArcmin??0)<=0)return null;const o=r.majAxArcmin/2*F,e=r.distPc*Math.tan(o);if(!Number.isFinite(e)||e<=0)return null;const a=Math.min(p(e),x);return a<=0?null:{radiusSu:a,radiusPc:e,morphScale:[1,1,1],kind:E(r)}}var T={colorCore:[1.4,1.5,1.7],colorHalo:[.5,.6,.9],coreDensity:1.5,haloStrength:.4,sparkleContrast:5,intensity:1.1},H={colorCore:[1.5,1.25,.75],colorHalo:[1,.75,.45],coreDensity:2.4,haloStrength:1.6,sparkleContrast:3,intensity:1.2};function N(r){return r==="globular"?H:T}var w=`
