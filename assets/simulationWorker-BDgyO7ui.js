(function() {
	var o2 = Object.defineProperty, We = (t, e) => {
		let n = {};
		for (var o in t) o2(n, o, {
			get: t[o],
			enumerable: !0
		});
		return e || o2(n, Symbol.toStringTag, { value: "Module" }), n;
	};
	const r2 = Symbol("Comlink.proxy"), Ze = Symbol("Comlink.endpoint"), tn = Symbol("Comlink.releaseProxy"), ot = Symbol("Comlink.finalizer"), p1 = Symbol("Comlink.thrown"), s2 = (t) => typeof t == "object" && t !== null || typeof t == "function", a2 = /* @__PURE__ */ new Map([["proxy", {
	...
	function rt(t, e = globalThis, n = ["*"]) {
		e.addEventListener("message", function o(r) {
			...
			Promise.resolve(u).catch((l) => ({
				...
				const [h, f] = m1(l);
				e.postMessage(Object.assign(Object.assign({}, h), { id: s }), f), a === "RELEASE" && (e.removeEventListener("message", o), i2(e), ot in t && typeof t[ot] == "function" && t[ot]());
			}).catch((l) => {
				const [h, f] = m1({
	...
	const y1 = /* @__PURE__ */ new WeakMap(), R1 = "FinalizationRegistry" in globalThis && new FinalizationRegistry((t) => {
		const e = (y1.get(t) || 0) - 1;
		y1.set(t, e), e === 0 && c2(t);
	});
	function rn(t, e) {
		const n = (y1.get(e) || 0) + 1;
		y1.set(e, n), R1 && R1.register(t, e, t);
	}
	function sn(t) {
		R1 && R1.unregister(t);
	}
	function st(t, e, n = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(a, c, i) {
				...
				if (u === Ze) return L0(t, e, { type: "ENDPOINT" }).then(D0);
	...
	180 / Math.PI;
	const g1 = 86400, dn = 365.25, y0 = 299792.458, at = y0 * dn * g1, b = 149597870.7, it = 648e3 / Math.PI, h2 = it * b / at, d2 = 23.4392911, Mn = 1e3, _n = y0, An = y0 ** Math.sqrt(Math.E), Sn = y0 ** 2, pn = y0 ** Math.E, En = [
		1,
		Mn,
		_n,
		An
	...
	var I1 = (t, e, n) => Object.defineProperty(t, e, {
		...
		writable: !0,
		configurable: !0
	}), yn = Symbol.for("bitecs-relation"), Rn = Symbol.for("bitecs-pairTarget"), mn = Symbol.for("bitecs-isPairComponent"), gn = Symbol.for("bitecs-relationData"), M2 = () => {
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				I1(r, yn, e), I1(r, Rn, o), I1(r, mn, !0), t.pairsMap.set(o, r);
			}
			return t.pairsMap.get(o);
		};
		return I1(e, gn, t), e;
	}, In = Symbol.for("bitecs-wildcard");
	function wn() {
		let t = M2();
	...
	function xn() {
		...
		return globalThis[t] || (globalThis[t] = wn()), globalThis[t];
	}
	var Tn = xn();
	function vn() {
		return M2();
	...
	function Dn() {
		...
		return globalThis[t] || (globalThis[t] = vn()), globalThis[t];
	}
	Dn();
	const Pn = 384399 / b, Nn = 421800 / b, Un = 671034 / b, On = 1070400 / b, zn = 1882700 / b, Cn = 9376 / b, Ln = 23463 / b, bn = 185540 / b, kn = 237948 / b, Kn = 294619 / b, Hn = 377396 / b, Jn = 527108 / b, Vn = 1221870 / b, Bn = 3560820 / b, Fn = 129390 / b, Yn = 190900 / b, Gn = 266e3 / b, jn = 436300 / b, $n = 583520 / b, Qn = 354759 / b, qn = {
		[A.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	Object.fromEntries(Object.entries(qn).map(([t, e]) => [t, Xn(e)]));
	new TextEncoder();
	new TextDecoder();
	new TextEncoder();
	new TextDecoder("utf-8");
	const E2 = 1e3 / b, lt = E2 * at * h2, Wn = 695700, Zn = 6378.137;
	function y2(t) {
		return !Number.isFinite(t) || t <= 0 ? 0 : t * E2;
	}
	y2(Zn);
	y2(Wn);
	const t3 = d2;
	...
	const R2 = h2;
	function m2(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * lt;
	}
	const e3 = 5e4, n3 = 2e3, o3 = e3 / R2, r3 = n3 / R2;
	m2(o3);
	m2(r3);
	[...ct];
	const ht = 1721545, dt = 3181545;
	t3 * Math.PI / 180;
	function s3(t) {
	...
	var a3 = We({
		...
		CombineRotation: () => x0,
		Constellation: () => L4,
		ConstellationInfo: () => we,
		CorrectLightTravel: () => W2,
		DEG2RAD: () => S,
		DefineStar: () => N3,
		...
		GANYMEDE_RADIUS_KM: () => d3,
		GeoEmbState: () => wt,
		GeoMoon: () => i0,
		GeoMoonState: () => i1,
		GeoVector: () => o0,
		GlobalSolarEclipseInfo: () => Ne,
		GravitySimulator: () => e6,
		HOUR2RAD: () => ft,
		HelioDistance: () => O0,
		HelioState: () => Y1,
		...
		KM_PER_AU: () => O,
		LagrangePoint: () => t6,
		LagrangePointFast: () => Ge,
		Libration: () => k3,
		LibrationInfo: () => b2,
		LocalSolarEclipseInfo: () => Ce,
		LunarEclipseInfo: () => xe,
		MakeRotation: () => B3,
		MakeTime: () => R,
		MassProduct: () => Et,
		...
		Search: () => F,
		SearchAltitude: () => d4,
		SearchGlobalSolarEclipse: () => Oe,
		SearchHourAngle: () => _4,
		SearchLocalSolarEclipse: () => Ke,
		SearchLunarApsis: () => he,
		SearchLunarEclipse: () => Pe,
		SearchMaxElongation: () => p4,
		SearchMoonNode: () => Ye,
		SearchMoonPhase: () => d1,
		SearchMoonQuarter: () => oe,
		SearchPeakMagnitude: () => E4,
		SearchPlanetApsis: () => fe,
		SearchRelativeLongitude: () => t1,
		SearchRiseSet: () => h4,
		SearchSunLongitude: () => te,
		SearchTransit: () => Ve,
		SeasonInfo: () => ce,
		Seasons: () => S4,
		...
		TransitInfo: () => He,
		Vector: () => D,
		VectorFromHorizon: () => x4,
		VectorFromSphere: () => j1,
		VectorObserver: () => G3,
		e_tilt: () => g0
	});
	const w1 = 173.1446326846693, O = 149597870.69098932, g2 = 63241.07708807546, S = .017453292519943295, ft = .26179938779914946, k = 57.29577951308232, Mt = 3.819718634205488, i3 = 71492, c3 = 66854, u3 = 69911, l3 = 1821.6, h3 = 1560.8, d3 = 2631.2, f3 = 2410.3, I2 = 365.24217, w2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), b0 = 484813681109536e-20, x2 = 648e3, M3 = 2 * x2, _3 = 7292115e-11, A3 = x2 / Math.PI, S3 = -.17 - 5 * Math.log10(A3), x1 = 29.530588, T1 = 86400, p3 = T1 * 1e3, T2 = .9972695717592592, _t = 695700, v2 = _t / O, s0 = .996647180302104, v1 = s0 * s0, M0 = 6378.1366, E3 = M0 / O, y3 = M0 * s0, R3 = 6371, m3 = 6459, g3 = 1738.1 / O, X = 1737.4, D2 = 1736, I3 = D2 / O, w3 = 34 / 60, x3 = 81.30056, r1 = .0002959122082855911, At = 4912547451450812e-26, St = 7243452486162703e-25, P2 = 8887692390113509e-25, pt = 9549535105779258e-26, k0 = 2.825345909524226e-7, K0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, T3 = 218869976542597e-26, v3 = P2 / x3;
	function Et(t) {
		switch (t) {
			case d.Sun: return r1;
			case d.Mercury: return At;
			case d.Venus: return St;
			case d.Earth: return P2;
			case d.Moon: return v3;
			case d.EMB: return 8997011346712498e-25;
			case d.Mars: return pt;
			case d.Jupiter: return k0;
			case d.Saturn: return K0;
			case d.Uranus: return H0;
			case d.Neptune: return J0;
			case d.Pluto: return T3;
	...
	var m0 = class nt {
		constructor(e) {
			...
			if (e instanceof Date && Number.isFinite(e.getTime())) {
				this.date = e, this.ut = (e.getTime() - w2.getTime()) / n, this.tt = O2(this.ut);
				return;
			}
			if (Number.isFinite(e)) {
				this.date = new Date(w2.getTime() + e * n), this.ut = e, this.tt = O2(this.ut);
				return;
			}
		...
		AddDays(e) {
			return new nt(this.ut + e);
		}
	};
	function C3(t, e, n) {
		return new m0(t.ut + n * (e.ut - t.ut));
	}
	function R(t) {
		return t instanceof m0 ? t : new m0(t);
	}
	function L3(t) {
		function e(f) {
			return f % M3 * b0;
	...
	function g0(t) {
		if (!U1 || Math.abs(U1.tt - t.tt) > 1e-6) {
			const e = L3(t), n = z2(t), o = n + e.deps / 3600;
			U1 = {
				tt: t.tt,
				dpsi: e.dpsi,
				deps: e.deps,
	...
	function I0(t) {
		...
		function o(P, z, H, V) {
			const G = [];
			for (let v0 = 0; v0 <= z - P; ++v0) G.push(n(H, V));
			return {
				min: P,
				array: G
			};
		...
		var d0 = U(.19833 + .05611 * e), Xt = U(.27869 + .04508 * e), Wt = U(.16827 - .36903 * e), Zt = U(.34734 - 5.37261 * e), t2 = U(.10498 - 5.37899 * e), et = U(.42681 - .41855 * e), a6 = U(.14943 - 5.37511 * e);
		for (N = .84 * d0 + .31 * Xt + 14.27 * Wt + 7.26 * Zt + .28 * t2 + .24 * et, L = 2.94 * d0 + .31 * Xt + 14.27 * Wt + 9.34 * Zt + 1.12 * t2 + .83 * et, K = -6.4 * d0 - 1.89 * et, Q = .21 * d0 + .31 * Xt + 14.27 * Wt - 88.7 * Zt - 15.3 * t2 + .24 * et - 1.86 * a6, Y = N - K, E = -3332e-9 * U(.59734 - 5.37261 * e) - 539e-9 * U(.35498 - 5.37899 * e) - 64e-9 * U(.39943 - 5.37511 * e), y = n0 * V0(.60643382 + 1336.85522467 * e - 313e-8 * f) + N / R0, g = n0 * V0(.37489701 + 1325.55240982 * e + 2565e-8 * f) + L / R0, x = n0 * V0(.99312619 + 99.99735956 * e - 44e-8 * f) + K / R0, I = n0 * V0(.25909118 + 1342.2278298 * e - 892e-8 * f) + Q / R0, v = n0 * V0(.82736186 + 1236.85308708 * e - 397e-8 * f) + Y / R0, l = 1; l <= 4; ++l) {
			switch (l) {
				case 1:
			...
			for (h0(0, l, 1), h0(1, l, Math.cos(i) * u), T0(0, l, 0), T0(1, l, Math.sin(i) * u), h = 2; h <= c; ++h) n1(S0(h - 1, l), l0(h - 1, l), S0(1, l), l0(1, l), (P, z) => (h0(h, l, P), T0(h, l, z)));
			for (h = 1; h <= c; ++h) h0(-h, l, S0(h, l)), T0(-h, l, -l0(h, l));
		}
		function qe(P, z, H, V) {
			for (var G = {
				x: 1,
				...
				H,
				V
			], p0 = 1; p0 <= 4; ++p0) v0[p0] !== 0 && n1(G.x, G.y, S0(v0[p0], p0), l0(v0[p0], p0), (e2, o1) => (G.x = e2, G.y = o1));
			return G;
		}
		function _(P, z, H, V, G, v0, p0, e2) {
			var o1 = qe(G, v0, p0, e2);
			M += P * o1.y, q += z * o1.y, w += H * o1.x, m += V * o1.x;
		}
		...
		function f0(P, z, H, V, G) {
			return P * qe(z, H, V, G).y;
		}
		p = 0, p += f0(-526.069, 0, 0, 1, -2), p += f0(-3.352, 0, 0, 1, -4), p += f0(44.297, 1, 0, 1, -2), p += f0(-6, 1, 0, 1, -4), p += f0(20.599, -1, 0, 1, 0), p += f0(-30.598, -1, 0, 1, -2), p += f0(-24.649, -2, 0, 1, 0), p += f0(-2, -2, 0, 1, -2), p += f0(-22.571, 0, 1, 1, -2), p += f0(10.985, 0, -1, 1, -2), M += .82 * U(.7736 - 62.5512 * e) + .31 * U(.0466 - 125.1025 * e) + .35 * U(.5785 - 25.1042 * e) + .66 * U(.4591 + 1335.8075 * e) + .64 * U(.313 - 91.568 * e) + 1.14 * U(.148 + 1331.2898 * e) + .21 * U(.5918 + 1056.5859 * e) + .44 * U(.5784 + 1322.8595 * e) + .24 * U(.2275 - 5.7374 * e) + .28 * U(.2965 + 2.6929 * e) + .33 * U(.3132 + 6.3368 * e), a = I + q / R0;
		let i6 = (1.000002708 + 139.978 * E) * (18518.511 + 1.189 + w) * Math.sin(a) - 6.24 * Math.sin(3 * a) + p;
		return {
			geo_eclip_lon: n0 * V0((y + M / R0) / n0),
			geo_eclip_lat: Math.PI / 648e3 * i6,
			distance_au: R0 * E3 / (.999953253 * m)
		};
	}
	var b2 = class {
	...
	function H3(t, e) {
		...
		let a, c, i;
		if (s < 1e-6) a = 0, c = r > 0 ? 90 : -90, i = Math.abs(r) - y3;
		else {
			...
			for (;;) {
				...
				const p = -.006694397995865464 * M0, w = l * l, m = h * h, y = w + v1 * m;
				f = Math.sqrt(y);
				const g = p * h * l / f - r * l + s * h;
				if (Math.abs(g) < 1e-8) break;
				const x = p * ((w - m) / f - m * w * -.006694397995865464 / (p * y)) + r * h + s * l;
				u -= g / x;
			}
			c = k * u;
			const M = M0 / f;
			Math.abs(h) > Math.abs(l) ? i = r / h - v1 * M : i = s / l - M;
		}
		return new gt(c, a, 1e3 * i);
	}
	function Rt(t, e) {
		const n = t.latitude * S, o = Math.sin(n), r = Math.cos(n), s = 1 / Math.hypot(r, s0 * o), a = v1 * s, c = t.height / 1e3, i = M0 * s + c, u = M0 * a + c, l = (15 * e + t.longitude) * S, h = Math.sin(l), f = Math.cos(l);
		return {
			pos: [
				i * r * f / O,
				i * r * h / O,
	...
	function C1(t, e) {
		const n = g0(t), o = n.mobl * S, r = n.tobl * S, s = n.dpsi * b0, a = Math.cos(o), c = Math.sin(o), i = Math.cos(r), u = Math.sin(r), l = Math.cos(s), h = Math.sin(s), f = l, E = -h * a, M = -h * c, p = h * i, w = l * a * i + c * u, m = l * c * i - a * u, y = h * u, g = l * a * u - c * i, x = l * c * u + a * i;
		if (e === C.From2000) return new B([
			[
				f,
				p,
	...
	function L1(t, e, n) {
		return n === C.Into2000 ? B0(F0(t, e, n), e, n) : F0(B0(t, e, n), e, n);
	}
	function J3(t, e, n) {
		return n === C.Into2000 ? K2(J2(t, e, n), e, n) : J2(K2(t, e, n), e, n);
	}
	function V2(t, e) {
		const n = Rt(e, _0(t)).pos;
		return L1(n, t, C.Into2000);
	}
	var D = class {
		constructor(t, e, n, o) {
	...
	function Y2(t, e) {
		const n = mt(t, e), o = n.x * n.x + n.y * n.y, r = Math.sqrt(o + n.z * n.z);
		if (o === 0) {
			if (n.z === 0) throw "Indeterminate sky coordinates";
			return new b1(0, n.z < 0 ? -90 : 90, r, n);
		}
		let s = Mt * Math.atan2(n.y, n.x);
		s < 0 && (s += 24);
		const a = k * Math.atan2(t[2], Math.sqrt(o));
		return new b1(s, a, r, n);
	}
	function G0(t, e) {
		const n = t * S, o = Math.cos(n), r = Math.sin(n);
		return [
	...
	function k1(t, e, n, o, r) {
		let s = R(t);
		j0(e), T(n), T(o);
		const a = Math.sin(e.latitude * S), c = Math.cos(e.latitude * S), i = Math.sin(e.longitude * S), u = Math.cos(e.longitude * S), l = Math.sin(o * S), h = Math.cos(o * S), f = Math.sin(n * ft), E = Math.cos(n * ft);
		let M = [
			c * u,
			c * i,
			a
		...
		const m = -15 * _0(s);
		let y = G0(m, M), g = G0(m, p), x = G0(m, w), I = [
			h * E,
			h * f,
			l
		];
		...
		if (r) {
			let r0 = Y, S0 = M1(r, 90 - Y);
			if (Y -= S0, S0 > 0 && Y > 3e-4) {
				const l0 = Math.sin(Y * S), h0 = Math.cos(Y * S), T0 = Math.sin(r0 * S), n1 = Math.cos(r0 * S), U = [];
				for (let d0 = 0; d0 < 3; ++d0) U.push((I[d0] - n1 * y[d0]) / T0 * l0 + y[d0] * h0);
				K = Math.hypot(U[0], U[1]), K > 0 ? (q = Mt * Math.atan2(U[1], U[0]), q < 0 && (q += 24)) : q = 0, u0 = k * Math.atan2(U[2], K);
			}
		}
		return new B2(Q, 90 - Y, q, u0);
	}
	function j0(t) {
	...
	function G2(t) {
		const e = R(t).AddDays(-1 / w1), n = Q0(j.Earth, e), [o, r, s] = L1([
			-n.x,
			-n.y,
			-n.z
		], e, C.From2000), a = S * g0(e).tobl, c = Math.cos(a), i = Math.sin(a);
		return It(new D(o, r, s, e), c, i);
	}
	function s1(t, e, n, o, r) {
		j0(n), D1(o), D1(r);
		const s = R(e), a = V2(s, n), c = o0(t, s, r), i = [
			c.x - a[0],
			c.y - a[1],
			c.z - a[2]
		];
		return Y2(o ? L1(i, s, C.From2000) : i, s);
	}
	function F3(t, e, n) {
		const o = R(t);
		let r = Rt(e, _0(o)).pos;
		return n || (r = L1(r, o, C.Into2000)), mt(r, o);
	}
	function Y3(t, e, n) {
		const o = R(t), r = Rt(e, _0(o)), s = new J(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
		return n ? s : J3(s, o, C.Into2000);
	}
	function G3(t, e) {
		const n = _0(t.t);
		let o = [
		...
		return e || (o = B0(o, t.t, C.From2000), o = F0(o, t.t, C.From2000)), H3(o, n);
	}
	function j3(t, e) {
	...
	function It(t, e, n) {
		...
		return new F2(new D(o, r, s, t.t), i, c);
	}
	function a1(t) {
		const e = g0(t.t), [n, o, r] = F0(B0([
			t.x,
			t.y,
			t.z
		], t.t, C.From2000), t.t, C.From2000), s = new D(n, o, r, t.t), a = e.tobl * S;
		return It(s, Math.cos(a), Math.sin(a));
	}
	function i0(t) {
		const e = R(t), n = I0(e), o = n.distance_au * Math.cos(n.geo_eclip_lat), r = B0(b3(e, [
	...
	function K1(t) {
		const e = R(t), n = I0(e), o = n.distance_au * Math.cos(n.geo_eclip_lat), r = [
			o * Math.cos(n.geo_eclip_lon),
			o * Math.sin(n.geo_eclip_lon),
			n.distance_au * Math.sin(n.geo_eclip_lat)
		], s = g0(e), a = mt(F0(C2(s.mobl, r), e, C.From2000), e), c = s.tobl * S, i = It(a, Math.cos(c), Math.sin(c));
		return new Y0(i.elat, i.elon, n.distance_au);
	}
	function i1(t) {
	...
	function Q0(t, e) {
		const n = e.tt / $0;
		return Dt(j2(P0(t[Tt], n, !0), P0(t[vt], n, !1), P0(t[H1], n, !1))).ToAstroVector(e);
	}
	function c1(t, e) {
		const n = e / $0, o = P0(t[Tt], n, !0), r = P0(t[vt], n, !1), s = P0(t[H1], n, !1), a = xt(t[Tt], n), c = xt(t[vt], n), i = xt(t[H1], n), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), f = Math.sin(r), E = +(i * h * u) - s * f * u * c - s * h * l * a, M = +(i * h * l) - s * f * l * c + s * h * u * a, p = +(i * f) + s * h * c, w = j2(o, r, s), m = [
			E / $0,
			M / $0,
			p / $0
		];
		return new U0(e, Dt(w), Dt(m));
	}
	function J1(t, e, n, o) {
		const r = o / (o + r1), s = Q0(j[n], e);
		t.x += r * s.x, t.y += r * s.y, t.z += r * s.z;
	}
	function $3(t) {
		const e = new D(0, 0, 0, t);
		return J1(e, t, d.Jupiter, k0), J1(e, t, d.Saturn, K0), J1(e, t, d.Uranus, H0), J1(e, t, d.Neptune, J0), e;
	}
	const Q3 = 29200, V1 = 146, N0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var $ = class E0 {
		...
		add(e) {
			return new E0(this.x + e.x, this.y + e.y, this.z + e.z);
		}
		sub(e) {
			return new E0(this.x - e.x, this.y - e.y, this.z - e.z);
		}
		...
		mul(e) {
			return new E0(e * this.x, e * this.y, e * this.z);
		}
		div(e) {
			return new E0(this.x / e, this.y / e, this.z / e);
		}
		mean(e) {
			return new E0((this.x + e.x) / 2, (this.y + e.y) / 2, (this.z + e.z) / 2);
		}
		neg() {
			return new E0(-this.x, -this.y, -this.z);
		}
		...
		sub(e) {
			return new n2(this.tt, this.r.sub(e.r), this.v.sub(e.v));
		}
	};
	function q3(t) {
		let [e, [n, o, r], [s, a, c]] = t;
		return new U0(e, new $(n, o, r), new $(s, a, c));
	}
	function W(t, e, n, o) {
		const r = o / (o + r1), s = c1(j[n], e);
	...
	var l1 = class {
		constructor(t) {
			...
			this.Jupiter = W(e, t, d.Jupiter, k0), this.Saturn = W(e, t, d.Saturn, K0), this.Uranus = W(e, t, d.Uranus, H0), this.Neptune = W(e, t, d.Neptune, J0), this.Jupiter.r.decr(e.r), this.Jupiter.v.decr(e.v), this.Saturn.r.decr(e.r), this.Saturn.v.decr(e.v), this.Uranus.r.decr(e.r), this.Uranus.v.decr(e.v), this.Neptune.r.decr(e.r), this.Neptune.v.decr(e.v), this.Sun = new U0(t, e.r.mul(-1), e.v.mul(-1));
		}
		Acceleration(t) {
			let e = u1(t, r1, this.Sun.r);
			return e.incr(u1(t, k0, this.Jupiter.r)), e.incr(u1(t, K0, this.Saturn.r)), e.incr(u1(t, H0, this.Uranus.r)), e.incr(u1(t, J0, this.Neptune.r)), e;
		}
	}, Pt = class Xe {
		constructor(e, n, o, r) {
	...
	function Ut(t, e) {
		const n = t - e.tt, o = new l1(t), r = q0(n, e.r, e.v, e.a), s = o.Acceleration(r).mean(e.a), a = q0(n, e.r, e.v, s);
		return new $2(o, new Pt(t, a, e.v.add(s.mul(n)), o.Acceleration(a)));
	}
	const X3 = [];
	function Q2(t, e) {
	...
	function Ot(t) {
		const e = q3(t), n = new l1(e.tt), o = e.r.add(n.Sun.r), r = e.v.add(n.Sun.v), s = n.Acceleration(o);
		return new $2(n, new Pt(e.tt, o, r, s));
	}
	function W3(t, e) {
		const n = N0[0][0];
		if (e < n || e > N0[50][0]) return null;
		const o = Q2((e - n) / Q3, 50);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Ot(N0[o]).grav, s[200] = Ot(N0[o + 1]).grav;
			let a, c = s[0].tt;
			for (a = 1; a < 200; ++a) s[a] = Ut(c += V1, s[a - 1]).grav;
			c = s[200].tt;
			var r = [];
			for (r[200] = s[200], a = 199; a > 0; --a) r[a] = Ut(c -= V1, r[a + 1]).grav;
			for (a = 199; a > 0; --a) {
				const i = a / 200;
	...
	function q2(t, e, n) {
		...
		for (let s = 0; s < r; ++s) o = Ut(s + 1 === r ? e : o.grav.tt + n, o.grav);
		return o;
	}
	function zt(t, e) {
		let n, o, r;
		const s = W3(X3, t.tt);
		if (s) {
			const a = Q2((t.tt - s[0].tt) / V1, 200), c = s[a], i = s[a + 1], u = c.a.mean(i.a), l = q0(t.tt - c.tt, c.r, c.v, u), h = Nt(t.tt - c.tt, c.v, u), f = q0(t.tt - i.tt, i.r, i.v, u), E = Nt(t.tt - i.tt, i.v, u), M = (t.tt - c.tt) / V1;
			n = l.mul(1 - M).add(f.mul(M)), o = h.mul(1 - M).add(E.mul(M));
		} else {
			let a;
			t.tt < N0[0][0] ? a = q2(N0[0], t.tt, -146) : a = q2(N0[50], t.tt, 146), n = a.grav.r, o = a.grav.v, r = a.bary;
		}
		return e && (r || (r = new l1(t.tt)), n = n.sub(r.Sun.r), o = o.sub(r.Sun.v)), new J(n.x, n.y, n.z, o.x, o.y, o.z, t);
	}
	const Z3 = new B([
		[
			.999432765338654,
	...
	function e4(t) {
		const e = new m0(t);
		return new X2(F1(e, B1[0]), F1(e, B1[1]), F1(e, B1[2]), F1(e, B1[3]));
	}
	function c0(t, e) {
		var n = R(e);
		...
		if (t === d.SSB) return $3(n);
		const s = N1(t);
		if (s) return j1(new Y0(s.dec, 15 * s.ra, s.dist), n);
	...
	function O0(t, e) {
		...
		if (n) return n.dist;
		const o = R(e);
		return t in j ? P0(j[t][H1], o.tt / $0, !1) : c0(t, o).Length();
	}
	function W2(t, e) {
		let n = e, o = 0;
		for (let r = 0; r < 10; ++r) {
			const s = t(n), a = s.Length() / w1;
	...
	function Z2(t, e, n, o) {
		...
		if (N1(n)) {
			const c = c0(n, r);
			if (o) {
				const u = Y1(e, r), l = new D(c.x - u.x, c.y - u.y, c.z - u.z, r), h = w1 / l.Length();
		...
		const a = new n4(e, n, o, s);
		return W2((c) => a.Position(c), r);
	}
	function o0(t, e, n) {
		D1(n);
		const o = R(e);
	...
	function o4(t, e) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = c1(j[d.Earth], n.tt), s = t === d.Moon ? i1(n) : wt(n);
	...
	function Y1(t, e) {
		...
		switch (t) {
			...
			case d.Saturn:
			case d.Uranus:
			case d.Neptune: return z0(c1(j[t], n.tt), n);
			case d.Pluto: return zt(n, !0);
			case d.Moon:
			case d.EMB:
				const r = c1(j.Earth, n.tt), s = t == d.Moon ? i1(n) : wt(n);
	...
	function a4(t, e, n, o, r) {
		const s = a1(o), a = S * 28.06, c = S * (169.51 + 382e-7 * r.tt), i = S * s.elat, u = S * s.elon, l = Math.asin(Math.sin(i) * Math.cos(a) - Math.cos(i) * Math.sin(a) * Math.sin(u - c)), h = Math.sin(Math.abs(l));
		let f = -9 + .044 * t;
	...
	function G1(t, e) {
		...
		let r, s, a, c;
		t === d.Sun ? (a = new D(-o.x, -o.y, -o.z, n), s = new D(0, 0, 0, n), r = 0) : (t === d.Moon ? (a = i0(n), s = new D(o.x + a.x, o.y + a.y, o.z + a.z, n)) : (s = c0(t, e), a = new D(s.x - o.x, s.y - o.y, s.z - o.z, n)), r = P1(a, s));
		let i = a.Length(), u = s.Length(), l;
		if (t === d.Sun) c = S3 + 5 * Math.log10(i);
		else if (t === d.Moon) c = i4(r, u, i);
		else if (t === d.Saturn) {
			const h = a4(r, u, i, a, n);
			c = h.mag, l = h.ring_tilt;
		} else c = s4(t, r, u, i);
		return new ee(n, c, r, u, i, a, s, l);
	}
	function h1(t) {
		if (t === d.Earth) throw "The Earth does not have a synodic period as seen from itself.";
		if (t === d.Moon) return x1;
		let e = a0[t];
	...
	function t1(t, e, n) {
		...
		function s(u) {
			const l = C0(t, u), h = C0(d.Earth, u);
			return X0(r * (h - l) - e);
		}
		let a = h1(t), c = R(n), i = s(c);
		i > 0 && (i -= 360);
		for (let u = 0; u < 100; ++u) {
			let l = -i / 360 * a;
			if (c = c.AddDays(l), Math.abs(l) * T1 < 1) return c;
			let h = i;
	...
	function d1(t, e, n) {
		...
		let a = o(s), c, i, u;
		if (n < 0) {
			if (a < 0 && (a += 360), c = -(x1 * a) / 360, u = c + r, u < n) return null;
			i = Math.max(n, c - r);
		} else {
			if (a > 0 && (a -= 360), c = -(x1 * a) / 360, i = c - r, i > n) return null;
			u = Math.min(n, c + r);
		}
	...
	function oe(t) {
		let e = Lt(t), n = (Math.floor(e / 90) + 1) % 4, o = d1(90 * n, t, 10);
		if (!o) throw "Cannot find moon quarter";
		return new ne(n, o);
	}
	function c4(t) {
		return oe(new Date(t.time.date.getTime() + 6 * p3));
	}
	var re = class {
		constructor(t, e, n) {
	...
	function l4(t) {
		switch (t) {
			case d.Sun: return v2;
			case d.Moon: return g3;
			default: return 0;
		}
	}
	function h4(t, e, n, o, r, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const a = l4(t), c = se(e.height - s);
		return ae(t, e, n, o, r, a, u4(e, s) - w3 * c.density);
	}
	function d4(t, e, n, o, r, s) {
		if (!Number.isFinite(s) || s < -90 || s > 90) throw `Invalid altitude angle: ${s}`;
		return ae(t, e, n, o, r, 0, s);
	}
	var f4 = class {
		constructor(t, e, n, o) {
	...
	function bt(t, e, n, o, r, s, a) {
		if (s < 0 && a >= 0) return new f4(o, r, s, a);
		if (s >= 0 && a < 0) return null;
		if (t > 17) throw "Excessive recursion in rise/set ascent search.";
		const c = r.ut - o.ut;
		if (c * T1 < 1 || Math.min(Math.abs(s), Math.abs(a)) > n * (c / 2)) return null;
		const i = new m0((o.ut + r.ut) / 2), u = e(i);
		return bt(1 + t, e, n, o, i, s, u) || bt(1 + t, e, n, i, r, u, a);
	}
	function M4(t, e) {
		...
		const r = S * e;
		return Math.abs((360 / T2 - n) * Math.cos(r)) + Math.abs(o * Math.sin(r));
	}
	function ae(t, e, n, o, r, s, a) {
		if (j0(e), T(r), T(s), T(a), a < -90 || a > 90) throw `Invalid target altitude angle: ${a}`;
		const c = M4(t, e.latitude);
		function i(M) {
			const p = s1(t, M, e, !0, !0);
	...
	function _4(t, e, n, o, r = 1) {
		...
		for (;;) {
			++a;
			let c = _0(s), i = s1(t, s, e, !0, !0), u = (n + i.ra - e.longitude / 15 - c) % 24;
	...
	function A4(t, e, n) {
		const o = R(e), r = H2(o), s = s1(t, o, n, !0, !0);
	...
	function S4(t) {
		function e(a, c, i) {
			let u = new Date(Date.UTC(t, c - 1, i)), l = te(a, u, 20);
		...
		return new ce(e(0, 3, 10), e(90, 6, 10), e(180, 9, 10), e(270, 12, 10));
	}
	var ue = class {
		constructor(t, e, n, o) {
	...
	function le(t, e) {
		let n = R(e), o = Ct(t, d.Sun, n), r;
		o > 180 ? (r = "morning", o = 360 - o) : r = "evening";
		let s = Z0(t, n);
		return new ue(n, r, s, o);
	}
	function p4(t, e) {
		function o(c) {
		...
		let a = 0;
		for (; ++a <= 2;) {
			let c = X0(C0(t, r) - C0(d.Earth, r)), i, u, l;
			c >= -s.s1 && c < +s.s1 ? (l = 0, i = +s.s1, u = +s.s2) : c >= +s.s2 || c < -s.s2 ? (l = 0, i = -s.s2, u = -s.s1) : c >= 0 ? (l = -h1(t) / 4, i = +s.s1, u = +s.s2) : (l = -h1(t) / 4, i = -s.s2, u = -s.s1);
			let h = r.AddDays(l), f = t1(t, i, h), E = t1(t, u, f), M = o(f);
	...
	function E4(t, e) {
		...
		const n = .01;
		function o(a) {
			const c = a.AddDays(-.005), i = a.AddDays(.01 / 2), u = G1(t, c).mag;
			return (G1(t, i).mag - u) / n;
		}
		let r = R(e), s = 0;
		for (; ++s <= 2;) {
			let a = X0(C0(t, r) - C0(d.Earth, r)), c, i, u;
			a >= -10 && a < 10 ? (u = 0, c = 10, i = 30) : a >= 30 || a < -30 ? (u = 0, c = -30, i = -10) : a >= 0 ? (u = -h1(t) / 4, c = 10, i = 30) : (u = -h1(t) / 4, c = -30, i = -10);
			let l = r.AddDays(u), h = t1(t, c, l), f = t1(t, i, h), E = o(h);
	...
	function he(t) {
		function n(i) {
			let u = i.AddDays(-5e-4), l = i.AddDays(.001 / 2), h = I0(u).distance_au;
	...
	function de(t, e, n, o) {
		...
		for (;;) {
			...
			if (a < 1 / 1440) {
				...
				return new f1(u, e, O0(t, u));
			}
			let c = -1, i = 0;
			for (let u = 0; u < s; ++u) {
				const l = r * O0(t, n.AddDays(u * a));
				(u == 0 || l > i) && (c = u, i = l);
			}
	...
	function R4(t, e) {
		...
		const l = de(t, 0, s.AddDays(-2 * u), 4 * u), h = de(t, 1, a.AddDays(-2 * u), 4 * u);
	...
	function fe(t, e) {
		if (e = R(e), t === d.Neptune || t === d.Pluto) return R4(t, e);
		function n(i) {
			let l = i.AddDays(-5e-4), h = i.AddDays(.001 / 2), f = O0(t, l);
			return (O0(t, h) - f) / .001;
		}
		function o(i) {
			return -n(i);
		...
		for (let i = 0; i * s < 2 * r; ++i) {
			...
			if (c * l <= 0) {
				let h, f;
				if (c < 0 || l > 0) h = n, f = w0.Pericenter;
				else if (c > 0 || l < 0) h = o, f = w0.Apocenter;
	...
	function m4(t, e) {
		...
		const n = .25 * a0[t].OrbitalPeriod, o = fe(t, e.time.AddDays(n));
	...
	function kt(t) {
		const e = Kt(t);
		return new b1(e.lon / 15, e.lat, e.dist, t);
	}
	function Kt(t) {
	...
	function w4(t, e) {
		const n = Kt(t);
		return n.lon = Me(n.lon), n.lat += M1(e, n.lat), n;
	}
	function x4(t, e, n) {
		e = R(e);
		const o = Me(t.lon);
		return j1(new Y0(t.lat + _e(n, t.lat), o, t.dist), e);
	}
	function M1(t, e) {
		let n;
	...
	function Q1(t) {
		return t = R(t), x0(O1(t, C.From2000), C1(t, C.From2000));
	}
	function v4(t) {
		const e = R(t);
		return x0(Q1(e), ge(e));
	...
	function q1(t) {
		return t = R(t), x0(C1(t, C.Into2000), O1(t, C.Into2000));
	}
	function Ht(t, e) {
		t = R(t);
		const n = Math.sin(e.latitude * S), o = Math.cos(e.latitude * S), r = Math.sin(e.longitude * S), s = Math.cos(e.longitude * S), a = [
			...
			-s,
			0
		], u = -15 * _0(t), l = G0(u, a), h = G0(u, c), f = G0(u, i);
		return new B([
			[
				h[0],
				f[0],
	...
	function me(t) {
		const e = g0(R(t)).tobl * S, n = Math.cos(e), o = Math.sin(e);
		return new B([
			[
				1,
				0,
	...
	function L4(t, e) {
		...
		t %= 24, t < 0 && (t += 24), Jt || (Jt = Q1(new m0(-45655.74141261017)), Ie = new m0(0));
		const n = j1(new Y0(e, 15 * t, 1), Ie), o = kt(_1(Jt, n)), r = 10 / 240, s = r / 15;
		for (let a of C4) {
			const c = a[3] * r, i = a[1] * s, u = a[2] * s;
			if (c <= o.dec && i <= o.ra && o.ra < u) {
				const l = z4[a[0]];
				return new we(l[0], l[1], o.ra, o.dec);
			}
		}
	...
	function A1(t, e, n, o) {
		...
		return new b4(e, r, O * Math.hypot(s, a, c), 695700 - (1 + r) * (_t - t), -695700 + (1 + r) * (_t + t), n, o);
	}
	function X1(t) {
	...
	function Te(t) {
		...
		return n.x -= e.x, n.y -= e.y, n.z -= e.z, A1(X, t, o, n);
	}
	function Vt(t, e) {
		const n = V2(t, e), o = o0(d.Sun, t, !0), r = i0(t), s = new D(n[0] - r.x, n[1] - r.y, n[2] - r.z, t);
		return r.x -= o.x, r.y -= o.y, r.z -= o.z, A1(X, t, s, r);
	}
	function W1(t, e, n) {
		const o = o0(t, n, !0), r = o0(d.Sun, n, !0), s = new D(o.x - r.x, o.y - r.y, o.z - r.z, n);
		return r.x = -o.x, r.y = -o.y, r.z = -o.z, A1(e, n, r, s);
	}
	function Bt(t, e) {
	...
	function k4(t, e, n) {
		const o = 11574074074074073e-21, r = W1(t, e, n.AddDays(-11574074074074073e-21));
		return (W1(t, e, n.AddDays(11574074074074073e-21)).r - r.r) / o;
	}
	function K4(t) {
		const e = F((n) => Bt(X1, n), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return X1(e);
	}
	function H4(t) {
		const e = F((n) => Bt(Te, n), t.AddDays(-.03), t.AddDays(.03));
	...
	function V4(t, e) {
		...
		const s = F((a) => Bt(r, a), n, o);
		if (!s) throw `PeakLocalMoonShadow: search failure for search_center_time = ${t}`;
		return Vt(s, e);
	}
	function Ft(t, e, n) {
		const o = n / 1440, r = t.AddDays(-o), s = t.AddDays(+o), a = F((i) => -(X1(i).r - e), r, t), c = F((i) => +(X1(i).r - e), t, s);
	...
	function De(t, e) {
		const n = new D(t.x + e.x, t.y + e.y, t.z + e.z, t.t), o = ve(Math.asin(v2 / n.Length()), Math.asin(I3 / e.Length()), P1(e, n) * S);
	...
	function Pe(t) {
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				const a = K4(r);
				if (a.r < a.p + X) {
					let c = Z.Penumbral, i = 0, u = 0, l = 0, h = Ft(a.time, a.p + X, 200);
					return a.r < a.k + X && (c = Z.Partial, l = Ft(a.time, a.k + X, h), a.r + X < a.k ? (c = Z.Total, i = 1, u = Ft(a.time, a.k - X, l)) : i = ve(X, a.k, a.r)), new xe(c, i, a.time, h, l, u);
				}
			}
			n = r.AddDays(10);
		}
	...
	function B4(t) {
		...
		const a = Q1(t.time), c = _1(a, t.dir), i = _1(a, t.target);
		...
		let M;
		if (E > 0) {
			const p = (-h - Math.sqrt(E)) / (2 * l), w = p * c.x - i.x, m = p * c.y - i.y, y = (p * c.z - i.z) * s0, g = Math.hypot(w, m) * v1;
			g == 0 ? r = y > 0 ? 90 : -90 : r = k * Math.atan(y / g);
			const x = _0(n);
			s = (k * Math.atan2(m, w) - 15 * x) % 360, s <= -180 ? s += 360 : s > 180 && (s -= 360);
			const I = e1(a);
			let v = new D(w / O, m / O, y / O, t.time);
			v = _1(I, v), v.x += t.target.x, v.y += t.target.y, v.z += t.target.z;
			const N = A1(D2, t.time, v, t.dir);
			if (N.r > 1e-9 || N.r < 0) throw `Unexpected shadow distance from geoid intersection = ${N.r}`;
			e = Ue(N.k), M = e === Z.Total ? 1 : De(t.dir, v);
		} else M = void 0;
		return new Ne(e, M, n, o, r, s);
	}
	function F4(t) {
		return t = R(t), Pe(t.AddDays(10));
	}
	function Oe(t) {
		t = R(t);
		const e = 1.8;
	...
	function G4(t, e) {
		...
		const s = Z1(e, 1, Le, o, t.time), a = Z1(e, -1, Le, t.time, r);
		let c, i, u;
		t.r < Math.abs(t.k) ? (o = t.time.AddDays(-.01), r = t.time.AddDays(.01), c = Z1(e, 1, be, o, t.time), i = Z1(e, -1, be, t.time, r), u = Ue(t.k)) : u = Z.Partial;
		const l = u === Z.Total ? 1 : De(t.dir, t.target);
		return new Ce(u, l, s, c, n, i, a);
	}
	function Z1(t, e, n, o, r) {
		function s(c) {
			return e * n(Vt(c, t));
		}
		const a = F(s, o, r);
	...
	function ke(t, e) {
		return new ze(e, j4(e, t));
	}
	function j4(t, e) {
		const n = s1(d.Sun, t, e, !0, !0);
	...
	function $4(t, e) {
		return t = R(t), Ke(t.AddDays(10), e);
	}
	var He = class {
		constructor(t, e, n, o) {
	...
	function Ve(t, e) {
		...
		for (;;) {
			...
			if (Z0(t, s) < n) {
				const a = J4(t, o, s);
				if (a.r < a.p) {
					const c = a.time.AddDays(-1), i = Je(t, o, c, a.time, -1), u = a.time.AddDays(1), l = Je(t, o, a.time, u, 1), h = 60 * Z0(t, a.time);
					return new He(i, a.time, l, h);
				}
			}
			r = s.AddDays(10);
		}
	...
	function q4(t, e) {
		return e = R(e), Ve(t, e.AddDays(100));
	}
	var A0;
	(function(t) {
	...
	function Ye(t) {
		let e = R(t), n = K1(e);
		for (;;) {
			const o = e.AddDays(Fe), r = K1(o);
			if (n.lat * r.lat <= 0) {
				const s = r.lat > n.lat ? A0.Ascending : A0.Descending, a = F((c) => s * K1(c).lat, e, o);
	...
	function X4(t) {
		const e = Ye(t.time.AddDays(Fe));
		switch (t.kind) {
			case A0.Ascending:
				if (e.kind !== A0.Descending) throw `Internal error: previous node was ascending, but this node was: ${e.kind}`;
				break;
			case A0.Descending:
				if (e.kind !== A0.Ascending) throw `Internal error: previous node was descending, but this node was: ${e.kind}`;
				break;
	...
	function W4(t) {
		const e = B0(F0([
			...
			0,
			1
		], t, C.Into2000), t, C.Into2000), n = new D(e[0], e[1], e[2], t), o = kt(n), r = 190.41375788700253 + 360.9856122880876 * t.ut;
		return new Gt(o.ra, o.dec, r, n);
	}
	function Z4(t, e) {
		...
		return new Gt(s / 15, a, c, h);
	}
	function t6(t, e, n, o) {
		const r = R(e), s = Et(n), a = Et(o);
		let c, i;
		return n === d.Earth && o === d.Moon ? (c = new J(0, 0, 0, 0, 0, 0, r), i = i1(r)) : (c = Y1(n, r), i = Y1(o, r)), Ge(t, c, s, i, a);
	}
	function Ge(t, e, n, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const v = t == 4 ? .8660254037844386 : -.8660254037844386, N = .5 * a + v * y, L = .5 * c + v * g, K = .5 * i + v * x, Q = .5 * y - v * a, Y = .5 * g - v * c, q = .5 * x - v * i, u0 = l * N, r0 = l * L, S0 = l * K, l0 = h * a + f * c + E * i, h0 = h * y + f * g + E * x;
			M = new J(u0, r0, S0, l0 * N + h0 * Q, l0 * L + h0 * Y, l0 * K + h0 * q, e.t);
		} else {
	...
	var e6 = class e0 {
		...
		Update(e) {
			...
			if (o === 0) this.prev = this.Duplicate();
				...
				for (let a = 0; a < this.curr.bodies.length; ++a) {
					...
					i.tt = n.tt, i.r = q0(o, c.r, c.v, u), i.v = Nt(o, c.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(e) {
			...
			n[d.Mercury] = W(o, e.tt, d.Mercury, At), n[d.Venus] = W(o, e.tt, d.Venus, St), n[d.Earth] = W(o, e.tt, d.Earth, 8997011346712498e-25), n[d.Mars] = W(o, e.tt, d.Mars, pt), n[d.Jupiter] = W(o, e.tt, d.Jupiter, k0), n[d.Saturn] = W(o, e.tt, d.Saturn, K0), n[d.Uranus] = W(o, e.tt, d.Uranus, H0), n[d.Neptune] = W(o, e.tt, d.Neptune, J0);
			for (let r in n) n[r].r.decr(o.r), n[r].v.decr(o.v);
			return n[d.Sun] = new U0(e.tt, o.r.neg(), o.v.neg()), n;
		}
		CalcBodyAccelerations() {
			for (let e of this.curr.bodies) e.a = $.zero(), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Sun].r, r1), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Mercury].r, At), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Venus].r, St), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Earth].r, 8997011346712498e-25), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Mars].r, pt), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Jupiter].r, k0), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Saturn].r, K0), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Uranus].r, H0), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Neptune].r, J0);
		}
	...
	function Qe(t, e) {
		...
		switch (n.type) {
			...
			case "seek": {
				...
				const o = n.jd;
				let r = o;
				(r < 1721545 || r > 3181545) && (console.warn(`[kernel/seek] JD ${r} outside supported range [${ht}, ${dt}] (years 0-4000 AD); clamping.`), r = Math.max(ht, Math.min(dt, r)));
				const s = {
					...t,
					jd: r
				}, a = [{
			...
			case "step": {
				...
				const r = t.jd + t.speed * o / g1, s = Math.max(ht, Math.min(dt, r)), a = {
					...t,
					jd: s
				}, c = [{
					type: "tick",
	...
	let t0 = jt(), tt = null, S1 = null;
	function $t(t) {
		S1?.(t);
	}
	function Qt() {
		tt != null && (clearInterval(tt), tt = null);
	}
	function r6() {
		Qt(), tt = setInterval(() => {
			const { state: t, events: e } = Qe(t0, {
				type: "step",
				deltaSeconds: .5
			});
			t0 = t, $t({
	...
	function s6(t) {
		...
		if (t.type === "time") {
			const { state: e, events: n } = Qe(t0, t.cmd);
			t0 = e, $t({
				type: "workerTick",
				state: t0,
				events: n
	...
	rt({
		...
		subscribe(t) {
			S1 != null && S1 !== t && console.warn("[simulationWorker] replacing existing outbound subscriber (double subscribe)"), S1 = t, qt();
		},
		unsubscribe() {
			S1 = null, Qt();
		}
