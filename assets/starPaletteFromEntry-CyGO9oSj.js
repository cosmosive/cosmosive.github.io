...
`;function te(e){return new U(e[0],e[1],e[2])}function Mt(){return{warm:te(M.star3),hot:te(M.star2),flare:te(M.star1)}}function sr(e){return e==null||Array.isArray(e)||!(e instanceof q)?!1:e.userData.cosmosiveSunCorona===!0}function lr(e){const t=Mt(),r={warm:e?.warm??t.warm,hot:e?.hot??t.hot,flare:e?.flare??t.flare},o={uTime:{value:0},uIntensity:{value:1.4},uPaletteWarm:{value:r.warm.clone()},uPaletteHot:{value:r.hot.clone()},uPaletteFlare:{value:r.flare.clone()}},a=new q({uniforms:o,vertexShader:Pt,fragmentShader:kt,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1});return a.userData.cosmosiveSunCorona=!0,a}var re=$("#d6ebff"),pe=$("#f5c238"),Ct=.01;function K(e){return[e[0],e[1],e[2]]}function _t(){return{cool:K(M.star4),warm:K(M.star3),hot:K(M.star2),flare:K(M.star1)}}function zt(e){return typeof e.c=="string"&&e.c.length>0?$(`#${e.c}`):K(M.star2)}function At(e){return typeof e.warm=="number"&&Number.isFinite(e.warm)?ze(e.warm):Ct}function Tt(e){const t=_t(),r=zt(e),o=At(e),a=1-o;return{cool:z(z(t.cool,re,a*.7),r,.2),warm:z(z(t.warm,r,.45),pe,o*.6),hot:z(z(t.hot,r,.75),re,a*.35),flare:z(z(z(t.flare,r,.35),pe,o*.45),re,a*.2)}}function X(e){return new U(e[0],e[1],e[2])}function ur(e){const t=Tt(e);return{cool:X(t.cool),warm:X(t.warm),hot:X(t.hot),flare:X(t.flare)}}export{qt as C,Ht as E,E as S,Kt as T,Xt as _,nr as a,Yt as b,Zt as c,tr as d,Qt as f,z as g,$t as h,ir as i,er as l,Y as m,lr as n,or as o,Jt as p,sr as r,ar as s,ur as t,rr as u,$ as v,Ut as w,Gt as x,jt as y};
