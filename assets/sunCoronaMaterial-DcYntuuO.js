import{E as oe,H as re,Tt as ae,Z as U,ht as ne,zt as ie}from"./sceneRuntimeTypes-DQ88oEdD.js";import{T as se,t as le}from"./simActions-Dibwa4vR.js";import{t as J}from"./r3fHostExtras-DltafJ2h.js";import{$ as Q,V as ue,dt as ce,o as j,p as N,s as fe,ut as E,w as me,xt as W,z as he}from"./three-vendor-CKuGOTEJ.js";function pe(e,t,o){return o&&t&&ie(e,t.position.x,t.position.y,t.position.z),e}function ct(e,t,o){if(o&&t){const r=e;r.x+=t.position.x,r.y+=t.position.y,r.z+=t.position.z}return e}var Y={current:null};function ft(e,t){return e.getWorldPosition(t),pe(t,Y.current,!0),t}function de(e,t,o,r,a){e.updateMatrixWorld(!0),e.getWorldPosition(o),t.position.x=o.x,t.position.y=o.y,t.position.z=o.z,e.getWorldDirection(o),r.setFromMatrixColumn(e.matrixWorld,0).normalize(),a.setFromMatrixColumn(e.matrixWorld,1).normalize(),t.forward.x=o.x,t.forward.y=o.y,t.forward.z=o.z,t.right.x=r.x,t.right.y=r.y,t.right.z=r.z,t.up.x=a.x,t.up.y=a.y,t.up.z=a.z,t.fovYRadians=he.degToRad(e.fov),t.aspect=e.aspect}function ve(e,t,o,r,a){de(e,t,o,r,a);{const n=Y.current;n&&(t.position.x-=n.position.x,t.position.y-=n.position.y,t.position.z-=n.position.z)}}function mt(e){const t=e.replace(/^#/,""),o=parseInt(t,16);return Number.isFinite(o)?[Math.floor(o/65536)%256,Math.floor(o/256)%256,o%256]:[0,0,0]}function xe(e){if(!e||typeof e!="string")return[1,1,1];const t=e.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return t?[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]:[1,1,1]}function ht(e){return Math.max(0,Math.min(255,Math.round(e)))}var ge=1,Se=-25,ye=500,Pe=.01;function G(e,t){let o=t;for(;e[o]!==o;)o=e[o];let r=t;for(;r!==o;){const a=e[r];e[r]=o,r=a}return o}function Me(e,t,o){const r=G(e,t),a=G(e,o);r!==a&&(e[r]=a)}function $(e,t,o){return`${e},${t},${o}`}function pt(e,t){const o=e.length,r=Array.from({length:o},(i,l)=>l),a=t,n=new Map;for(let i=0;i<o;i+=1){const l=e[i],f=$(Math.floor(l.x/a),Math.floor(l.y/a),Math.floor(l.z/a));n.has(f)||n.set(f,[]),n.get(f).push(i)}const u=t*t;for(let i=0;i<o;i+=1){const l=e[i],f=Math.floor(l.x/a),x=Math.floor(l.y/a),m=Math.floor(l.z/a);for(let h=-1;h<=1;h+=1)for(let d=-1;d<=1;d+=1)for(let g=-1;g<=1;g+=1){const S=$(f+h,x+d,m+g),y=n.get(S);if(y)for(const P of y){if(P<=i)continue;const M=e[P],F=M.x-l.x,C=M.y-l.y,T=M.z-l.z;F*F+C*C+T*T<u&&Me(r,i,P)}}}const c=new Map;for(let i=0;i<o;i+=1){const l=G(r,i);c.has(l)||c.set(l,[]),c.get(l).push(i)}const s=[];for(let i=0;i<o;i+=1)s.push(void 0);for(const i of c.values())i.length<=1||(i.sort((l,f)=>l-f),i.forEach((l,f)=>{f>0&&(s[l]={x:0,y:f*Se})}));return s}function Ce(){const e=[];for(let t=0;t<ye;t+=1){const o=oe(t*.7%360,t*.3%180-90);o!=null&&e.push(o)}return e}function we(){const e=Ce(),t=e.length,o=ne,r=new Float32Array(t*3);return e.forEach((a,n)=>{r[n*3]=a.x*o,r[n*3+1]=a.y*o,r[n*3+2]=a.z*o}),{abbr:"_bootstrap",positions:r,sizes:new Float32Array(t).fill(ge),colors:new Float32Array(t*3).fill(1),warm:new Float32Array(t).fill(Pe),brightness:new Float32Array(t).fill(1),mag:new Float32Array(t).fill(-1/0),starsInChunk:[]}}var Fe={raMin:0,raMax:360,decMin:-90,decMax:90},dt={chunks:[],namedStarsInView:[]};function vt(e,t){return e===0&&t!=="success"}function Z(e,t){return e.chunks.length>0?e.chunks:t==="idle"||t==="loading"?[we()]:[]}function xt(e,t){const o=Z(e,t),r=o.slice(0,3).map(a=>a.abbr).join(",");return o.length===0?{syntheticKind:"empty",chunkAbbrevSample:r}:o.length===1&&o[0]?.abbr==="_bootstrap"?{syntheticKind:"bootstrap",chunkAbbrevSample:r}:o.some(a=>a.abbr==="_fallback")?{syntheticKind:"fallback",chunkAbbrevSample:r}:{syntheticKind:"real",chunkAbbrevSample:r}}function X(e,t){return t.current===e.current}function gt(e,t,o,r,a){e.onerror=n=>{X(t,o)||(r("error"),a(n.message??"Starfield worker failed"))},e.onmessageerror=()=>{X(t,o)||(r("error"),a("Starfield worker message error"))}}function ze(e,t,o,r,a,n,u){const{runId:c,...s}=e;c===t.current&&(o.current=c,r.current=s.starsInView,a({chunks:s.chunks,namedStarsInView:s.namedStarsInView}),n("ready"),u(null))}function St(e,t,o,r,a){e.processStarfield({runId:t,catalog:o,maxDistanceLevel:r,bounds:Fe,raInHours:!1}).then(n=>{ze(n,a.runIdRef,a.lastSuccessfulRunIdRef,a.starsInViewRef,a.setStarData,a.setStarfieldStatus,a.setErrorMessage)}).catch(n=>{t===a.runIdRef.current&&(a.setStarfieldStatus("error"),a.setErrorMessage(n instanceof Error?n.message:"Starfield worker failed"))})}function be(e,t){t.length=0;for(const o of e){const r=new Float32Array(o.starsInChunk.length);for(let a=0;a<o.starsInChunk.length;a+=1){const n=o.starsInChunk[a];r[a]=n?se(n)*U:0}t.push(r)}}function ke(e,t,o){const r=Z(e(),t());return be(r,o),r}var Te=500*U;function Ae(e,t,o,r){const a=Math.sqrt(e*e+t*t+o*o);if(a<=0||!Number.isFinite(a)){r.x=0,r.y=0,r.z=0;return}const n=re(a)*U/a;r.x=e*n,r.y=t*n,r.z=o*n}function _e(e,t,o,r,a,n,u,c){const s=Math.sqrt(e*e+t*t+o*o);if(s<=0||!Number.isFinite(s)||!Number.isFinite(r)){const m=-a,h=-n,d=-u;return m*m+h*h+d*d<=c}const i=r/s,l=e*i-a,f=t*i-n,x=o*i-u;return l*l+f*f+x*x<=c}function Ie(){return{frustum:{position:{x:0,y:0,z:0},forward:{x:0,y:0,z:-1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:Math.PI/4,aspect:1},cameraHelioKm:{x:0,y:0,z:0}}}function Re(e){const t=Math.tan(e.frustum.fovYRadians*.5);return Ae(e.frustum.position.x,e.frustum.position.y,e.frustum.position.z,e.cameraHelioKm),{tanHalfV:t,maxDistSqKm:Te**2}}var We=256,Ee=320,De=`
...
`;function ee(e){return new E({uniforms:{uPointSizeMax:{value:e?.pointSizeMax??We},uTime:{value:0},uTwinkleAmp:{value:e?.twinkleAmp??0},uTwinkleFreq:{value:e?.twinkleFreq??.8},uSizeMultiplier:{value:e?.sizeMultiplier??1},uPointSizeFloor:{value:e?.pointSizeFloor??1},uMagLimit:{value:6.5},uMagFadeRange:{value:1},uMagRef:{value:0},uFluxClampMax:{value:4},uFluxGamma:{value:.45},uPsfMaxMult:{value:3.5},uPaletteHot:{value:new N(1,.78,.56)},uPaletteFlare:{value:new N(1,.92,.75)}},vertexShader:De,fragmentShader:e?.useHaloShader?He:Le,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1})}function Ne(){return ee({twinkleAmp:.03,twinkleFreq:.9,pointSizeFloor:1})}function Ve(){return ee({useHaloShader:!0,sizeMultiplier:1.6,pointSizeMax:Ee,pointSizeFloor:1,twinkleAmp:.02,twinkleFreq:.55})}function Oe(e){const{layers:t}=J(e);return{createChunk(o){const r=t[o.layer],a=new fe;for(const s of o.attributes)a.setAttribute(s.name,new j(s.data,s.components));a.computeBoundingSphere();const n=o.material,u=new Q(a,n);u.frustumCulled=!0,u.raycast=()=>{},r.add(u);const c=new Map(o.attributes.map(s=>[s.name,s.components]));return{meshRef:u,updateAttribute(s,i){const l=c.get(s);l!=null&&a.setAttribute(s,new j(i,l))},setVertexCount(s){a.computeBoundingSphere()},dispose(){r.remove(u),a.dispose()}}}}}function Be(e){return Oe(e)}function qe(e,t,o){const r=new Q(e.geometry,o);return r.frustumCulled=!0,r.renderOrder=1,r.raycast=()=>{},t.add(r),{mesh:r,dispose(){t.remove(r)}}}function te(e,t){return t?e.depthCam!==t.depthCam?e.depthCam<t.depthCam:e.renderedPx!==t.renderedPx?e.renderedPx>t.renderedPx:e.distSqPx<t.distSqPx:!0}function Ke(e,t){let o=0,r=-1,a=null;for(let n=0;n<e.length;n+=1){const u=e[n],c=u.starsInChunk.length,s=t(u,n);s&&te(s,a)&&(a=s,r=o+s.index),o+=c}return r}function Ge(e,t){if(t<0||t>=e.length)return!1;const o=e[t],r=o.proper??(o.hip!=null?`HIP ${o.hip}`:`Star ${o.id}`);return le.select(ae("hyg",o.id),r,"star"),!0}function Ue(e){if(e.starsInView.length===0)return!1;const t=e.prepared;if(t==null)return!1;const o=Ke(e.chunks,(r,a)=>e.pickInChunk(r,a,t));return Ge(e.starsInView,o)}function je(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||e<=0||t<=0?0:e/(2*Math.tan(t*.5))}function $e(){return 1}function Xe(){return 8}var O={px:0,py:0};function Je(e){const{positions:t,sizes:o,distancesKm:r,starCount:a,camFrustum:n,tanHalfV:u,cameraHelioKm:c,maxDistSqKm:s,mouseX:i,mouseY:l,projectStarToScreenPx:f}=e,x=Math.min(a,t.length/3,o.length,r.length);let m=null;for(let h=0;h<x;h+=1){const d=h*3,g=t[d],S=t[d+1],y=t[d+2];if(!_e(g,S,y,r[h]??0,c.x,c.y,c.z,s))continue;const P=g-n.position.x,M=S-n.position.y,F=y-n.position.z,C=P*n.forward.x+M*n.forward.y+F*n.forward.z;if(C<=1e-6)continue;const T=P*n.right.x+M*n.right.y+F*n.right.z,V=P*n.up.x+M*n.up.y+F*n.up.z,p=u*n.aspect*C;if(Math.abs(T)>p)continue;const v=u*C;if(Math.abs(V)>v)continue;const z=C,b=$e(),w=Xe();if(w<=0)continue;f(g,S,y,O);const I=O.px-i,A=O.py-l,R=I*I+A*A;if(R>w*w)continue;const D={index:h,distSqPx:R,depthCam:z,renderedPx:b};te(D,m)&&(m=D)}return m}var B=new W,q=new W;function Qe(e,t,o,r,a,n,u,c,s,i,l,f,x){const m=o.getBoundingClientRect();return Je({positions:n,sizes:u,distancesKm:c,starCount:s,uScale:je(m.height,r.fov*Math.PI/180),camFrustum:i,tanHalfV:l,cameraHelioKm:f,maxDistSqKm:x,mouseX:e-m.left,mouseY:t-m.top,projectStarToScreenPx:(h,d,g,S)=>{B.set(h,d,g),B.applyMatrix4(a.matrixWorld),q.copy(B).project(r),S.px=(q.x*.5+.5)*m.width,S.py=(-q.y*.5+.5)*m.height}})}function Ye(e){const{cameraThree:t,pickerScratch:o,syncScratch:r}=e;ve(t,o.frustum,r.forward,r.right,r.up);const{tanHalfV:a,maxDistSqKm:n}=Re(o);return Ue({starsInView:e.starsInView,chunks:e.chunks,prepared:{tanHalfV:a,maxDistSqKm:n},pickInChunk:(u,c,s)=>{const i=e.pointsMeshes[c],l=e.chunkDistancesKm[c],f=e.chunkOriginalSizes[c];return!i||!l||!f?null:Qe(e.clientX,e.clientY,e.canvas,t,i,u.positions,f,l,u.starsInChunk.length,o.frustum,s.tanHalfV,o.cameraHelioKm,s.maxDistSqKm)}})}function Ze(e){return Ye(e)}var k={chunks:[],pointsMeshes:[],starsInView:[]};function yt(){return k}function Pt(e,t){const o=J(e),r=o.layers.starfield,{starsInViewRef:a,getStarData:n,getStatus:u}=t,c=Be(e),s=[],i=[],l=[],f=[],x=[],m=Ne(),h=Ve();let d=0;const g=new ue,S=new me,y=new ce,P=Ie(),M=new W,F=new W,C=new W;function T(){for(const p of l)p.dispose();l.length=0;for(const p of s)p.dispose();s.length=0,i.length=0,f.length=0,x.length=0}function V(p){k.chunks=p,k.pointsMeshes=i,k.starsInView=a.current}return{refresh(){T();const p=ke(n,u,f);for(const v of p){x.push(new Float32Array(v.sizes));const z=c.createChunk({layer:"starfield",meshName:`cosmosive-starfield-points-${v.abbr.replace(/[^a-zA-Z0-9_-]/g,"_")}`,material:m,attributes:[{name:"position",data:v.positions,components:3},{name:"size",data:v.sizes,components:1},{name:"color",data:v.colors,components:3},{name:"warm",data:v.warm,components:1},{name:"brightness",data:v.brightness,components:1},{name:"mag",data:v.mag,components:1}]});s.push(z);const b=z.meshRef;i.push(b),l.push(qe(b,r,h))}V(p)},advanceTime(p){d+=p,m.uniforms.uTime&&(m.uniforms.uTime.value=d),h.uniforms.uTime&&(h.uniforms.uTime.value=d)},countFrustum(){let p=0,v=0;const z=l.map(w=>w.mesh),b=[...i,...z];if(b.length>0){const w=o.cameraThree;w.updateMatrixWorld(!0),g.multiplyMatrices(w.projectionMatrix,w.matrixWorldInverse),S.setFromProjectionMatrix(g);for(const I of b){const A=I.geometry;A.boundingSphere||A.computeBoundingSphere();const R=A.boundingSphere;if(!R)continue;y.copy(R).applyMatrix4(I.matrixWorld);const D=A.getAttribute("position");v+=D?.count??0,S.intersectsSphere(y)&&(p+=1)}}return{total:b.length,visible:p,verts:v}},pickFromClick({clientX:p,clientY:v,canvas:z}){return Ze({kind:"r3f",clientX:p,clientY:v,canvas:z,starsInView:a.current,chunks:k.chunks,chunkDistancesKm:f,chunkOriginalSizes:x,cameraThree:o.cameraThree,pointsMeshes:i,pickerScratch:P,syncScratch:{forward:M,right:F,up:C}})},dispose(){T(),m.dispose(),h.dispose(),k.chunks=[],k.pointsMeshes=[],k.starsInView=[]}}}function L(e,t=1,o=1){const[r,a,n]=xe(e),u=Math.max(.15,Math.min(1,t));return[r*u,a*u,n*u,o]}var _={star1:L("#fff3a8",1),star2:L("#f5c238",1),star3:L("#e07b1a",1),star4:L("#a8380c",1)};function H(e){return new N(e[0],e[1],e[2])}function et(){return{cool:H(_.star4),warm:H(_.star3),hot:H(_.star2),flare:H(_.star1)}}var tt=`
...
`;function K(e){return new N(e[0],e[1],e[2])}function nt(){return{warm:K(_.star3),hot:K(_.star2),flare:K(_.star1)}}function wt(e){return e==null||Array.isArray(e)||!(e instanceof E)?!1:e.userData.cosmosiveSunCorona===!0}function Ft(e){const t=nt(),o={warm:e?.warm??t.warm,hot:e?.hot??t.hot,flare:e?.flare??t.flare},r={uTime:{value:0},uIntensity:{value:1.4},uPaletteWarm:{value:o.warm.clone()},uPaletteHot:{value:o.hot.clone()},uPaletteFlare:{value:o.flare.clone()}},a=new E({uniforms:r,vertexShader:rt,fragmentShader:at,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1});return a.userData.cosmosiveSunCorona=!0,a}export{xe as _,_ as a,Y as b,yt as c,St as d,gt as f,mt as g,ht as h,Mt as i,dt as l,pt as m,wt as n,L as o,vt as p,Ct as r,Pt as s,Ft as t,xt as u,ve as v,ct as x,ft as y};
