import{j as c}from"./simStateMigration-DgAAzbA2.js";import{A as m,K as f,_ as d,gt as p,mt as v}from"./three-vendor-FS3eG5Lg.js";import{at as C,yt as h}from"./index-CP2JHRW5.js";import{a as g,o as S}from"./majorDsoSelector-CclnzEPk.js";import{n as y}from"./dsoMajorCluster-sl8ibUb5.js";import{t as P}from"./shaderNoiseHelpers-COIx0Kdf.js";import{t as k}from"./createDsoMountR3f-CPRff3nz.js";var D=Math.PI/180/60,A=C.far/4;function M(o){return o.openNgcTypeRaw==="GCl"?"globular":"open"}function R(o){if(o.type!=="star_cluster"||!Number.isFinite(o.distPc)||o.distPc<=0||!Number.isFinite(o.majAxArcmin)||(o.majAxArcmin??0)<=0)return null;const r=o.majAxArcmin/2*D,e=o.distPc*Math.tan(r);if(!Number.isFinite(e)||e<=0)return null;const a=Math.min(c(e),A);return a<=0?null:{radiusSu:a,radiusPc:e,morphScale:[1,1,1],kind:M(o)}}var x={colorCore:[1.4,1.5,1.7],colorHalo:[.5,.6,.9],coreDensity:1.5,haloStrength:.4,sparkleContrast:5,intensity:1.1},F={colorCore:[1.5,1.25,.75],colorHalo:[1,.75,.45],coreDensity:2.4,haloStrength:1.6,sparkleContrast:3,intensity:1.2};function _(o){return o==="globular"?F:x}var L=`
...
`;function n(o){return new d(o[0],o[1],o[2])}function N(o,r){return{uTime:{value:0},uRadius:{value:o.radiusSu},uIntensity:{value:r.intensity},uCoreDensity:{value:r.coreDensity},uHaloStrength:{value:r.haloStrength},uSparkleContrast:{value:r.sparkleContrast},uColorCore:{value:n(r.colorCore)},uColorHalo:{value:n(r.colorHalo)}}}function w(o){const r=R(o);if(r===null)return null;const e=_(r.kind),a=h(o),t=new m;t.name=`cluster-${o.catalogId}`,t.position.set(a.x,a.y,a.z);const s=new p(r.radiusSu,48,24),u=N(r,e),i=new v({uniforms:u,vertexShader:L,fragmentShader:E,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1}),l=new f(s,i);return l.frustumCulled=!1,l.renderOrder=-12,t.add(l),{group:t,mesh:l,material:i,geometry:s}}function H(o){o.geometry.dispose(),o.material.dispose()}function I(o){return k(o,{layerName:"clusterCloudLayer",selectEntries:()=>y(S()),createVisual:w,disposeVisual:H,applyFrame:(r,e)=>{const{uTime:a}=r.material.uniforms;a.value=e}})}var V=g(I,"present.hud");export{V as ClusterCloudMountR3f};
