import{K as le,X as ue,et as ne}from"./src-Df7YWNpX.js";import{A as be,T as Fe,q as Pe,vt as ke}from"./src-BDCn4hUT.js";import{U as Me,t as ce}from"./activeGameplayHost-DaleVz9q.js";import{t as Ce}from"./skyLightStore-CcPC6YfG.js";import{K as _e,Ot as H,_ as U,d as ae,f as ze,gt as Ae,ht as q,it as Te,k as Re}from"./three-vendor-Ce7iT1Ri.js";import{Bn as Ie,Ht as Ve,K as Le,Vn as De,zt as Ee}from"./index-pk-tVY0X.js";import{t as ve}from"./r3fHostExtras-BtatsfV9.js";import{t as Be}from"./combatFrustum-BAFMev2t.js";var ie=new Map;function Wt(e,t){ie.set(e,t)}function Ot(e){ie.delete(e)}function Kt(e,t,r){let o=null;for(const a of ie.values()){const n=a(e,t,r);n!=null&&Number.isFinite(n)&&n>=0&&(o==null||n<o)&&(o=n)}return o}var E={effectiveSpeedKmPerS:0,proximityThrottle:1,nearestBodySurfaceDistSu:null,viewpointScenePosX:0,viewpointScenePosY:0,viewpointScenePosZ:0};function Ht(e){e.effectiveSpeedKmPerS!==void 0&&(E.effectiveSpeedKmPerS=e.effectiveSpeedKmPerS),e.proximityThrottle!==void 0&&(E.proximityThrottle=e.proximityThrottle),e.nearestBodySurfaceDistSu!==void 0&&(E.nearestBodySurfaceDistSu=e.nearestBodySurfaceDistSu),e.viewpointScenePosX!==void 0&&(E.viewpointScenePosX=e.viewpointScenePosX),e.viewpointScenePosY!==void 0&&(E.viewpointScenePosY=e.viewpointScenePosY),e.viewpointScenePosZ!==void 0&&(E.viewpointScenePosZ=e.viewpointScenePosZ)}function Ut(e,t){return e.getWorldPosition(t),t}var de=null;function qt(e){de=e}function Gt(){return de}function Xt(e){if(typeof e!="string"||!/^#?[0-9a-fA-F]{6}$/.test(e))return[0,0,0];const t=e.replace(/^#/,""),r=parseInt(t,16);return Number.isFinite(r)?[Math.floor(r/65536)%256,Math.floor(r/256)%256,r%256]:[0,0,0]}function $(e){if(!e||typeof e!="string")return[1,1,1];const t=e.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return t?[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]:[1,1,1]}function Yt(e){return Math.max(0,Math.min(255,Math.round(e)))}function z(e,t,r){return[e[0]+(t[0]-e[0])*r,e[1]+(t[1]-e[1])*r,e[2]+(t[2]-e[2])*r]}function X(e,t=1,r=1){const[o,a,n]=$(e),c=Math.max(.15,Math.min(1,t));return[o*c,a*c,n*c,r]}var Ne=1,We=-25,Oe=500,Ke=.01;function oe(e,t){let r=t;for(;e[r]!==r;)r=e[r];let o=t;for(;o!==r;){const a=e[o];e[o]=r,o=a}return r}function He(e,t,r){const o=oe(e,t),a=oe(e,r);o!==a&&(e[o]=a)}function fe(e,t,r){return`${e},${t},${r}`}function jt(e,t){const r=e.length,o=Array.from({length:r},(i,l)=>l),a=t,n=new Map;for(let i=0;i<r;i+=1){const l=e[i],m=fe(Math.floor(l.x/a),Math.floor(l.y/a),Math.floor(l.z/a));n.has(m)||n.set(m,[]),n.get(m).push(i)}const c=t*t;for(let i=0;i<r;i+=1){const l=e[i],m=Math.floor(l.x/a),v=Math.floor(l.y/a),p=Math.floor(l.z/a);for(let S=-1;S<=1;S+=1)for(let d=-1;d<=1;d+=1)for(let y=-1;y<=1;y+=1){const k=fe(m+S,v+d,p+y),w=n.get(k);if(w)for(const F of w){if(F<=i)continue;const C=e[F],T=C.x-l.x,R=C.y-l.y,I=C.z-l.z;T*T+R*R+I*I<c&&He(o,i,F)}}}const s=new Map;for(let i=0;i<r;i+=1){const l=oe(o,i);s.has(l)||s.set(l,[]),s.get(l).push(i)}const u=[];for(let i=0;i<r;i+=1)u.push(void 0);for(const i of s.values())i.length<=1||(i.sort((l,m)=>l-m),i.forEach((l,m)=>{m>0&&(u[l]={x:0,y:m*We})}));return u}function Ue(){const e=[];for(let t=0;t<Oe;t+=1){const r=Pe(t*.7%360,t*.3%180-90);r!=null&&e.push(r)}return e}function qe(){const e=Ue(),t=e.length,r=Fe,o=new Float32Array(t*3);return e.forEach((a,n)=>{o[n*3]=a.x*r,o[n*3+1]=a.y*r,o[n*3+2]=a.z*r}),{abbr:"_bootstrap",positions:o,sizes:new Float32Array(t).fill(Ne),colors:new Float32Array(t*3).fill(1),warm:new Float32Array(t).fill(Ke),brightness:new Float32Array(t).fill(1),mag:new Float32Array(t).fill(-1/0),starsInChunk:[]}}var Ge={raMin:0,raMax:360,decMin:-90,decMax:90},$t={chunks:[],namedStarsInView:[]};function Jt(e,t){return e===0&&t!=="success"}function ge(e,t){return e.chunks.length>0?e.chunks:t==="idle"||t==="loading"?[qe()]:[]}function Zt(e,t){const r=ge(e,t),o=r.slice(0,3).map(a=>a.abbr).join(",");return r.length===0?{syntheticKind:"empty",chunkAbbrevSample:o}:r.length===1&&r[0]?.abbr==="_bootstrap"?{syntheticKind:"bootstrap",chunkAbbrevSample:o}:r.some(a=>a.abbr==="_fallback")?{syntheticKind:"fallback",chunkAbbrevSample:o}:{syntheticKind:"real",chunkAbbrevSample:o}}function me(e,t){return t.current===e.current}function Qt(e,t,r,o,a){e.onerror=n=>{me(t,r)||(o("error"),a(n.message??"Starfield worker failed"))},e.onmessageerror=()=>{me(t,r)||(o("error"),a("Starfield worker message error"))}}function he(e){const t=e.indexOf("__part");return t===-1?e:e.slice(0,t)}function W(e,t){const r=new Float32Array(e.length+t.length);return r.set(e,0),r.set(t,e.length),r}function Xe(e,t){return{abbr:e.abbr,positions:W(e.positions,t.positions),sizes:W(e.sizes,t.sizes),colors:W(e.colors,t.colors),warm:W(e.warm,t.warm),brightness:W(e.brightness,t.brightness),mag:W(e.mag,t.mag),starsInChunk:[...e.starsInChunk,...t.starsInChunk]}}function Ye(e,t){const r=new Map;e.chunks.forEach((a,n)=>r.set(he(a.abbr),n));const o=[...e.chunks];for(const a of t.chunks){const n=he(a.abbr),c=r.get(n);if(c!=null){const s=o[c];s&&(o[c]=Xe(s,a))}else r.set(n,o.length),o.push(a)}return{chunks:o,namedStarsInView:[...e.namedStarsInView,...t.namedStarsInView]}}function je(e,t,r,o,a,n,c,s="replace"){const{runId:u,...i}=e;u===t.current&&(r.current=u,s==="append"?(o.current=[...o.current,...i.starsInView],a(l=>Ye(l,{chunks:i.chunks,namedStarsInView:i.namedStarsInView}))):(o.current=i.starsInView,a({chunks:i.chunks,namedStarsInView:i.namedStarsInView})),n("ready"),c(null))}function er(e,t,r,o,a,n={}){const c=n.mode??"replace";e.processStarfield({runId:t,catalog:r,maxDistanceLevel:o,bounds:Ge,raInHours:!1,maxPerChunk:n.maxPerChunk}).then(s=>{je(s,a.runIdRef,a.lastSuccessfulRunIdRef,a.starsInViewRef,a.setStarData,a.setStarfieldStatus,a.setErrorMessage,c),n.onComplete?.()}).catch(s=>{t===a.runIdRef.current&&(a.setStarfieldStatus("error"),a.setErrorMessage(s instanceof Error?s.message:"Starfield worker failed"))})}function $e(e,t){t.length=0;for(const r of e){const o=new Float32Array(r.starsInChunk.length);for(let a=0;a<r.starsInChunk.length;a+=1){const n=r.starsInChunk[a];o[a]=n?Me(n)*ne:0}t.push(o)}}function Je(e,t,r){const o=ge(e(),t());return $e(o,r),o}var Ze=500*ne;function Qe(e,t,r,o){const a=Math.sqrt(e*e+t*t+r*r);if(a<=0||!Number.isFinite(a)){o.x=0,o.y=0,o.z=0;return}const n=be(a)*ne/a;o.x=e*n,o.y=t*n,o.z=r*n}function et(e,t,r,o,a,n,c,s){const u=Math.sqrt(e*e+t*t+r*r);if(u<=0||!Number.isFinite(u)||!Number.isFinite(o)){const p=-a,S=-n,d=-c;return p*p+S*S+d*d<=s}const i=o/u,l=e*i-a,m=t*i-n,v=r*i-c;return l*l+m*m+v*v<=s}function tt(){return{frustum:{position:{x:0,y:0,z:0},forward:{x:0,y:0,z:-1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:Math.PI/4,aspect:1},viewpointHelioKm:{x:0,y:0,z:0}}}function rt(e){const t=Math.tan(e.frustum.fovYRadians*.5);return Qe(e.frustum.position.x,e.frustum.position.y,e.frustum.position.z,e.viewpointHelioKm),{tanHalfV:t,maxDistSqKm:Ze**2}}var at=256,ot=320,nt=`
...
`;function st(e){return new q({uniforms:{uPointSizeMax:{value:e?.pointSizeMax??at},uTime:{value:0},uDtYears:{value:0},uTwinkleAmp:{value:e?.twinkleAmp??0},uTwinkleFreq:{value:e?.twinkleFreq??.8},uSizeMultiplier:{value:e?.sizeMultiplier??1},uPointSizeFloor:{value:e?.pointSizeFloor??1},uMagLimit:{value:6.5},uMagFadeRange:{value:2.5},uMagRef:{value:0},uFluxClampMax:{value:4},uFluxGamma:{value:.6},uPsfMaxMult:{value:5},uFaintSizeFade:{value:.5},uFlareSatLo:{value:.42},uFlareSatHi:{value:.66},uFlareMaxScale:{value:5},uFlareSpikeAmt:{value:.5},uPaletteHot:{value:new U(1,.78,.56)},uPaletteFlare:{value:new U(1,.92,.75)},uStreakAmt:{value:0},uCoreSizeRatio:{value:e?.coreSizeRatio??1}},vertexShader:nt,fragmentShader:it,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1})}function lt(){return st({sizeMultiplier:1.6,pointSizeMax:ot,pointSizeFloor:1,twinkleAmp:.03,twinkleFreq:.9,coreSizeRatio:1.6})}function ut(e){const{layers:t}=ve(e);return{createChunk(r){const o=t[r.layer],a=new ze;for(const u of r.attributes)a.setAttribute(u.name,new ae(u.data,u.components));a.computeBoundingSphere();const n=r.material,c=new Te(a,n);c.frustumCulled=!0,c.raycast=()=>{},o.add(c);const s=new Map(r.attributes.map(u=>[u.name,u.components]));return{meshRef:c,updateAttribute(u,i){const l=s.get(u);l!=null&&a.setAttribute(u,new ae(i,l))},setVertexCount(u){a.computeBoundingSphere()},dispose(){o.remove(c),a.dispose()}}}}}function ct(e){return ut(e)}function Se(e,t){return t?e.depthCam!==t.depthCam?e.depthCam<t.depthCam:e.renderedPx!==t.renderedPx?e.renderedPx>t.renderedPx:e.distSqPx<t.distSqPx:!0}function ft(e,t){let r=null,o=null;for(let a=0;a<e.length;a+=1){const n=e[a],c=t(n,a);c&&Se(c,r)&&(r=c,o=n.starsInChunk[c.index]??null)}return o}function mt(e){const t=e.proper??(e.hip!=null?`HIP ${e.hip}`:`Star ${e.id}`);return De.select(ke("hyg",e.id),t,"star"),!0}function ht(e){if(e.chunks.length===0)return!1;const t=e.prepared;if(t==null)return!1;const r=ft(e.chunks,(o,a)=>e.pickInChunk(o,a,t));return r?mt(r):!1}function pt(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||e<=0||t<=0?0:e/(2*Math.tan(t*.5))}function vt(){return 1}function dt(){return 8}var Z={px:0,py:0};function gt(e){const{positions:t,velocities:r,dtYears:o,sizes:a,distancesKm:n,starCount:c,camFrustum:s,tanHalfV:u,viewpointHelioKm:i,maxDistSqKm:l,mouseX:m,mouseY:v,projectStarToScreenPx:p}=e,S=o??0,d=Math.min(c,t.length/3,a.length,n.length);let y=null;for(let k=0;k<d;k+=1){const w=k*3,F=t[w]+(r?r[w]*S:0),C=t[w+1]+(r?r[w+1]*S:0),T=t[w+2]+(r?r[w+2]*S:0);if(!et(F,C,T,n[k]??0,i.x,i.y,i.z,l))continue;const R=F-s.position.x,I=C-s.position.y,B=T-s.position.z,N=R*s.forward.x+I*s.forward.y+B*s.forward.z;if(N<=1e-6)continue;const J=R*s.right.x+I*s.right.y+B*s.right.z,h=R*s.up.x+I*s.up.y+B*s.up.z,f=u*s.aspect*N;if(Math.abs(J)>f)continue;const g=u*N;if(Math.abs(h)>g)continue;const x=N,P=vt(),b=dt();if(b<=0)continue;p(F,C,T,Z);const L=Z.px-m,D=Z.py-v,G=L*L+D*D;if(G>b*b)continue;const O={index:k,distSqPx:G,depthCam:x,renderedPx:P};Se(O,y)&&(y=O)}return y}var Q=new H,ee=new H;function St(e,t,r,o,a,n,c,s,u,i,l,m,v,p,S){const d=r.getBoundingClientRect();return gt({positions:n,velocities:p,dtYears:S,sizes:c,distancesKm:s,starCount:u,uScale:pt(d.height,o.fov*Math.PI/180),camFrustum:i,tanHalfV:l,viewpointHelioKm:m,maxDistSqKm:v,mouseX:e-d.left,mouseY:t-d.top,projectStarToScreenPx:(y,k,w,F)=>{Q.set(y,k,w),Q.applyMatrix4(a.matrixWorld),ee.copy(Q).project(o),F.px=(ee.x*.5+.5)*d.width,F.py=(-ee.y*.5+.5)*d.height}})}function xt(e){const{cameraThree:t,pickerScratch:r,syncScratch:o}=e;Be(t,r.frustum,o.forward,o.right,o.up);const a=Ee();a&&(r.frustum.position.x+=a.x,r.frustum.position.y+=a.y,r.frustum.position.z+=a.z);const{tanHalfV:n,maxDistSqKm:c}=rt(r);return ht({chunks:e.chunks,prepared:{tanHalfV:n,maxDistSqKm:c},pickInChunk:(s,u,i)=>{const l=e.pointsMeshes[u],m=e.chunkDistancesKm[u],v=e.chunkOriginalSizes[u];return!l||!m||!v?null:St(e.clientX,e.clientY,e.canvas,t,l,s.positions,v,m,s.starsInChunk.length,r.frustum,i.tanHalfV,r.viewpointHelioKm,i.maxDistSqKm,e.chunkVelocities[u]??null,e.dtYears)}})}function yt(e){return xt(e)}var A={chunks:[],pointsMeshes:[],starsInView:[]};function tr(){return A}function rr(e,t){const r=ve(e),{starsInViewRef:o,getStarData:a,getStatus:n}=t,c=ct(e),s=[],u=[],i=[],l=[],m=[],v=[],p=lt();let S=0,d=0;const y=new Map,k=new _e,w=new Re,F=new Ae,C=tt(),T=new H,R=new H,I=new H;function B(){for(const h of s)h.dispose();s.length=0,u.length=0,i.length=0,l.length=0,m.length=0,v.length=0;for(const h of y.values())h.ref=null}function N(h){A.chunks=h,A.pointsMeshes=u,A.starsInView=o.current}function J(h){const f=A;for(let g=0;g<f.chunks.length;g+=1){const x=f.chunks[g],P=f.pointsMeshes[g];if(!(!x||!P))for(let b=0;b<x.starsInChunk.length;b+=1){const L=x.starsInChunk[b];if(!L||L.proper!==h)continue;const D=P.geometry.getAttribute("ignite");return D instanceof ae?{attribute:D,index:b}:null}}return null}return{refresh(){B();const h=Je(a,n,i);for(const f of h){l.push(new Float32Array(f.sizes));const g=Ve(f);m.push(g);const x=c.createChunk({layer:"starfield",meshName:`cosmosive-starfield-points-${f.abbr.replace(/[^a-zA-Z0-9_-]/g,"_")}`,material:p,attributes:[{name:"position",data:f.positions,components:3},{name:"size",data:f.sizes,components:1},{name:"color",data:f.colors,components:3},{name:"warm",data:f.warm,components:1},{name:"brightness",data:f.brightness,components:1},{name:"mag",data:f.mag,components:1},{name:"ignite",data:new Float32Array(f.sizes.length).fill(1),components:1},{name:"velocity",data:g,components:3}]});s.push(x);const P=x.meshRef;u.push(P)}v.length=0;for(const f of u)v.push(f);N(h)},advanceTime(h){S+=h,p.uniforms.uTime&&(p.uniforms.uTime.value=S);const f=(ce().jd-ue)/le;p.uniforms.uDtYears&&(p.uniforms.uDtYears.value=f);const g=4.5,x=7.5,P=.8,b=E.effectiveSpeedKmPerS,L=P*Math.max(0,Math.min(1,((b>1?Math.log10(b):0)-g)/(x-g))),D=1-Math.exp(-h/.35);d+=(L-d)*D;const G=Math.max(d,Le()*P);p.uniforms.uStreakAmt&&(p.uniforms.uStreakAmt.value=G);const O=Ce(),xe=1-Math.exp(-h/.7);if(p.uniforms.uMagLimit){const V=p.uniforms.uMagLimit.value;p.uniforms.uMagLimit.value=V+(O.magLimit-V)*xe}const ye=1-Math.exp(-h/.5),se=O.ignitedStarProperNames;for(const V of se)y.has(V)||y.set(V,{value:1,ref:null});for(const[V,_]of y){const we=se.includes(V)?6:1;_.ref===null&&(_.ref=J(V)),_.value+=(we-_.value)*ye,_.ref!==null&&(_.ref.attribute.setX(_.ref.index,_.value),_.ref.attribute.needsUpdate=!0)}},countFrustum(){let h=0,f=0;if(v.length>0){const g=r.cameraThree;g.updateMatrixWorld(!0),k.multiplyMatrices(g.projectionMatrix,g.matrixWorldInverse),w.setFromProjectionMatrix(k);for(const x of v){const P=x.geometry;P.boundingSphere||P.computeBoundingSphere();const b=P.boundingSphere;b&&(F.copy(b).applyMatrix4(x.matrixWorld),w.intersectsSphere(F)&&(h+=1))}for(const x of u)f+=x.geometry.getAttribute("position")?.count??0}return{total:v.length,visible:h,verts:f}},pickFromClick({clientX:h,clientY:f,canvas:g}){return yt({kind:"r3f",clientX:h,clientY:f,canvas:g,chunks:A.chunks,chunkDistancesKm:i,chunkOriginalSizes:l,chunkVelocities:m,dtYears:(ce().jd-ue)/le,cameraThree:r.cameraThree,pointsMeshes:u,pickerScratch:C,syncScratch:{forward:T,right:R,up:I}})},dispose(){B(),p.dispose(),A.chunks=[],A.pointsMeshes=[],A.starsInView=[]}}}var M={star1:X("#fff3a8",1),star2:X("#f5c238",1),star3:X("#e07b1a",1),star4:X("#a8380c",1)};function Y(e){return new U(e[0],e[1],e[2])}function wt(){return{cool:Y(M.star4),warm:Y(M.star3),hot:Y(M.star2),flare:Y(M.star1)}}var bt=`
#include <common>
...
`;function te(e){return new U(e[0],e[1],e[2])}function Mt(){return{warm:te(M.star3),hot:te(M.star2),flare:te(M.star1)}}function nr(e){return e==null||Array.isArray(e)||!(e instanceof q)?!1:e.userData.cosmosiveSunCorona===!0}function ir(e){const t=Mt(),r={warm:e?.warm??t.warm,hot:e?.hot??t.hot,flare:e?.flare??t.flare},o={uTime:{value:0},uIntensity:{value:1.4},uPaletteWarm:{value:r.warm.clone()},uPaletteHot:{value:r.hot.clone()},uPaletteFlare:{value:r.flare.clone()}},a=new q({uniforms:o,vertexShader:Pt,fragmentShader:kt,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1});return a.userData.cosmosiveSunCorona=!0,a}var re=$("#d6ebff"),pe=$("#f5c238"),Ct=.01;function K(e){return[e[0],e[1],e[2]]}function _t(){return{cool:K(M.star4),warm:K(M.star3),hot:K(M.star2),flare:K(M.star1)}}function zt(e){return typeof e.c=="string"&&e.c.length>0?$(`#${e.c}`):K(M.star2)}function At(e){return typeof e.warm=="number"&&Number.isFinite(e.warm)?Ie(e.warm):Ct}function Tt(e){const t=_t(),r=zt(e),o=At(e),a=1-o;return{cool:z(z(t.cool,re,a*.7),r,.2),warm:z(z(t.warm,r,.45),pe,o*.6),hot:z(z(t.hot,r,.75),re,a*.35),flare:z(z(z(t.flare,r,.35),pe,o*.45),re,a*.2)}}function j(e){return new U(e[0],e[1],e[2])}function sr(e){const t=Tt(e);return{cool:j(t.cool),warm:j(t.warm),hot:j(t.hot),flare:j(t.flare)}}export{Ht as C,Ot as E,E as S,Wt as T,Xt as _,ar as a,qt as b,$t as c,Qt as d,Jt as f,z as g,Yt as h,or as i,Zt as l,X as m,ir as n,rr as o,jt as p,nr as r,tr as s,sr as t,er as u,$ as v,Kt as w,Ut as x,Gt as y};
