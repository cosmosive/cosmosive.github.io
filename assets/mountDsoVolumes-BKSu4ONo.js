...
`,ya=Math.PI/180;function V(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function P(e,t){const a=Math.hypot(e[0],e[1],e[2]);return!Number.isFinite(a)||a<1e-9?t:[e[0]/a,e[1]/a,e[2]/a]}function ve(e,t,a,r){return[e[0]*t+a[0]*r,e[1]*t+a[1]*r,e[2]*t+a[2]*r]}var xa=[0,0,1];function Ca(e,t,a){const r=P(e,[0,0,1]),l=P(V(xa,r),[1,0,0]),n=P(V(r,l),[0,1,0]),i=Number.isFinite(t)?t*ya:0,s=P(ve(n,Math.cos(i),l,Math.sin(i)),n),m=P(V(r,s),l),c=Math.min(1,Math.max(.001,a)),h=Math.acos(c),o=P(ve(r,c,m,Math.sqrt(Math.max(0,1-c*c))),r),y=s;return{xAxis:y,yAxis:P(V(o,y),m),zAxis:o,inclinationRad:h}}function Ra(e,t,a){if(e.texture===null)return null;const{radius:r}=e,l=e.morphScale!==void 0?e.morphScale[1]:.5,n=Ca(t.lengthSq()>1e-12?[t.x,t.y,t.z]:[0,0,1],e.entry.positionAngleDeg,l),i=new q;i.quaternion.setFromRotationMatrix(new ze().makeBasis(new C(n.xAxis[0],n.xAxis[1],n.xAxis[2]),new C(n.yAxis[0],n.yAxis[1],n.yAxis[2]),new C(n.zAxis[0],n.zAxis[1],n.zAxis[2]))),a.add(i);const s=new ae(new Uint8Array([0,0,0,0]),1,1,re);s.needsUpdate=!0;const m={uMap:{value:s},uRadius:{value:r},uUvScale:{value:new We(pe,pe*l)},uIntensity:{value:ha*(e.galaxyBrightnessScale??1)},uBgLo:{value:ca},uBgHi:{value:da},uCenterFade:{value:ma},uEdgeFade:{value:fa}},c=new qe(r,96),h=new ye({uniforms:m,vertexShader:ba,fragmentShader:Aa,transparent:!0,depthWrite:!1,blending:1,side:2,toneMapped:!1}),o=new xe(c,h);o.name=`dso-disc-${e.entry.catalogId}`,o.raycast=()=>{},o.frustumCulled=!1,o.renderOrder=-15,i.add(o);const y=e.galaxyPalette?.colorBulge??[1,.95,.85],f=new Ve({map:Sa(),color:new N(y[0],y[1],y[2]),transparent:!0,depthWrite:!1,blending:2,toneMapped:!1});f.opacity=ge;const F=new je(f),R=r*Math.min(.6,Math.max(.2,e.galaxyPalette?.bulgeRadiusRatio??.34))*2;F.scale.set(R,R,1),F.renderOrder=-14,a.add(F);let A="none",_=null,b=null,u=!1;const S=x=>{if(e.texture===null)return;const p=Be(e.texture,x);if(p===null)return;if(b!==null){if(b.url===p)return;b.ac.abort(),b=null}const E=new AbortController;b={url:p,ac:E},Fe(p,E.signal).then(T=>{if(u||b===null||b.ac!==E){k(p);return}_!==null&&_!==p&&k(_),_=p,m.uMap.value=T,b=null}).catch(()=>{b!==null&&b.ac===E&&(b=null)})};return A="thumb",S("thumb"),{group:a,mesh:o,radius:r,scenePos:t,tick(x,p){o.frustumCulled=p>1,f.opacity=ge*Math.min(1,Math.max(0,(p-.15)/.85));const E=Ae(p),T=E==="none"?"thumb":E;T!==A&&(A=T,S(T))},dispose(){u=!0,b!==null&&(b.ac.abort(),b=null),c.dispose(),h.dispose(),f.dispose(),s.dispose(),_!==null&&(k(_),_=null)}}}function _a(e){if(e.radius<=0)return null;const{entry:t,shape:a}=e,r=be(t),l=new C(r.x,r.y,r.z),n=new q;if(n.name=`dso-${t.catalogId}`,n.position.copy(l),a==="galaxy"&&e.texture?.projection==="flat-disc")return Ra(e,l,n);let i=n;if(a==="nebula"){const u=l.clone();u.lengthSq()<1e-12&&u.set(1,0,0),u.normalize();const S=new C().crossVectors(u,new C(0,0,1));S.lengthSq()<1e-6&&S.crossVectors(u,new C(1,0,0)),S.normalize();const x=S.multiplyScalar(Math.sqrt(1-ee*ee)).addScaledVector(u,ee).normalize(),p=new q;p.quaternion.setFromUnitVectors(new C(0,0,1),x),n.add(p),i=p}const s=new He(e.radius,24,16),m=new ae(new Uint8Array([0,0,0,0]),1,1,re);m.needsUpdate=!0;const c=a==="galaxy",h=e.texture!==null,o={uMap:{value:m},uTime:{value:0},uRadius:{value:e.radius},uSteps:{value:c?28:30},uExtinction:{value:c?2:3},uIntensity:{value:fe},uDensity:{value:c?ua:1},uDrift:{value:c?sa:oa},uUsePalette:{value:h?0:1},uViewMix:{value:1},uZoom:{value:na},uWarp:{value:he},uPalA:{value:new N(0,0,0)},uPalB:{value:new N(0,0,0)},uPalC:{value:new N(0,0,0)},uShapeMode:{value:0},uShapeWarp:{value:he},uShapeFreq:{value:3},uShellMid:{value:0},uShellThick:{value:0},uClump:{value:.15},uBipolar:{value:0},uCstar:{value:0},uShapeSeed:{value:new C(0,0,0)},uBulgeStrength:{value:1},uBulgeRadiusRatio:{value:.2},uBar:{value:0},uArmCount:{value:0},uArmWinding:{value:0},uArmContrast:{value:1},uDustStrength:{value:0},uPositionAngle:{value:e.positionAngleRad??0},uColorBulge:{value:new N(0,0,0)},uColorArms:{value:new N(0,0,0)},uColorDust:{value:new N(0,0,0)},uMorphScale:{value:new C(1,1,1)}};if(c&&e.galaxyPalette!==void 0){const u=e.galaxyPalette;o.uBulgeStrength.value=u.bulgeStrength,o.uBulgeRadiusRatio.value=u.bulgeRadiusRatio,o.uArmCount.value=u.armCount,o.uArmWinding.value=u.armWinding,o.uArmContrast.value=u.armContrast,o.uDustStrength.value=u.dustStrength,o.uBar.value=u.bar??0,W(o.uColorBulge.value,u.colorBulge),W(o.uColorArms.value,u.colorArms),W(o.uColorDust.value,u.colorDust),o.uIntensity.value=u.intensity*la*(e.galaxyBrightnessScale??1),e.morphScale!==void 0&&o.uMorphScale.value.set(e.morphScale[0],e.morphScale[1],e.morphScale[2])}else if(!c&&!h&&e.nebulaPalette!==void 0){const u=e.nebulaPalette;W(o.uPalA.value,u.colorA),W(o.uPalB.value,u.colorB),W(o.uPalC.value,u.colorC),o.uIntensity.value=fe*u.intensity}if(!c&&e.nebulaShape!==void 0){const u=e.nebulaShape;o.uShapeMode.value=u.mode,o.uShapeWarp.value=u.warp,o.uShapeFreq.value=u.freq,o.uShellMid.value=u.shellMid,o.uShellThick.value=u.shellThick,o.uClump.value=u.clump,o.uBipolar.value=u.bipolar,o.uPositionAngle.value=u.positionAngleRad,o.uMorphScale.value.set(u.morphScale[0],u.morphScale[1],u.morphScale[2]),o.uShapeSeed.value.set(u.seedOffset[0],u.seedOffset[1],u.seedOffset[2]),o.uCstar.value=e.cstarBright??0}!c&&e.brightnessScale!==void 0&&(o.uIntensity.value=o.uIntensity.value*e.brightnessScale);const y=new ye({uniforms:o,vertexShader:Jt,fragmentShader:c?ra:aa,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1}),f=new xe(s,y);f.name=`dso-vol-${t.catalogId}`,f.raycast=()=>{},f.frustumCulled=!1,f.renderOrder=c?-15:-12,i.add(f);let F="none",R=null,A=null,_=!1;const b=u=>{if(e.texture===null)return;const S=Be(e.texture,u);if(S===null)return;if(A!==null){if(A.url===S)return;A.ac.abort(),A=null}const x=new AbortController;A={url:S,ac:x},Fe(S,x.signal).then(p=>{if(_||A===null||A.ac!==x){k(S);return}R!==null&&R!==S&&k(R),R=S,o.uMap.value=p,A=null}).catch(()=>{A!==null&&A.ac===x&&(A=null)})};return h&&(F="thumb",b("thumb")),{group:n,mesh:f,radius:e.radius,scenePos:l,tick(u,S){if(o.uTime.value=o.uTime.value+u,f.frustumCulled=S>1,!c){const x=Math.min(1,Math.max(0,(S-1)/2));o.uSteps.value=Math.round(16+14*x);const p=G((30-S)/28);o.uViewMix.value=p**ia}if(h){const x=Ae(S),p=x==="none"?"thumb":x;p!==F&&(F=p,b(p))}},dispose(){_=!0,A!==null&&(A.ac.abort(),A=null),s.dispose(),y.dispose(),m.dispose(),R!==null&&(k(R),R=null)}}}function Ma(e,t){const a=Xe(e),r=a.layers.dsoReRooted,l=a.cameraThree,n=new q;n.name="dsoVolumeLayer",r.add(n),Zt(a.gl);const i=Ke();let s=[];const m=new Map;let c=!1,h=0;const o={current:oe.getState().showDsoVolumes},y={current:performance.now()},f={position:{x:0,y:0,z:0},forward:{x:0,y:0,z:1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:1,aspect:1},F=new C,R=new C,A=new C,_=new C,b=()=>{n.visible=o.current&&m.size>0},u=()=>{et(l,f,F,R,A);const d=ke();d&&(f.position.x+=d.x,f.position.y+=d.y,f.position.z+=d.z),_.set(f.position.x,f.position.y,f.position.z)},S=d=>{const M=m.get(d);M!==void 0&&(n.remove(M.group),M.dispose(),m.delete(d),rt(d))},x=()=>{for(const d of[...m.keys()])S(d)},p=()=>{c||(x(),s=t.buildSpecs().filter(d=>d.radius>0).map(d=>{const M=be(d.entry);return{id:d.entry.catalogId,scenePos:new C(M.x,M.y,M.z),radius:d.radius,spec:d}}),b())},E=()=>{u();const d=[],M=[];for(const v of s){const B=v.scenePos.distanceToSquared(_),U=Math.sqrt(B);if(U<=v.radius){M.push(v);continue}const De=v.radius/U,Ie=v.spec.visibilityFactor??1;De<(m.has(v.id)?.00105:.0015)*Ie||Oe(v.scenePos,f.position,f.forward,f.right,f.up,f.fovYRadians,f.aspect)&&d.push({cand:v,distSq:B})}d.sort((v,B)=>v.distSq-B.distSq);const D=new Map;for(const v of M)D.set(v.id,v);for(const{cand:v}of d){if(D.size>=128)break;D.set(v.id,v)}for(const v of[...m.keys()])D.has(v)||S(v);let I=0;for(const[v,B]of D){if(m.has(v))continue;if(I>=4)break;const U=_a(B.spec);U!==null&&(n.add(U.group),m.set(v,U),B.spec.shape==="galaxy"&&at(v),I+=1)}b()};Promise.resolve().then(p).catch(d=>console.error("[createDsoVolumeMount] rebuildCandidates failed:",d));const T=oe.subscribe(d=>({showDsoVolumes:d.showDsoVolumes}),d=>{o.current=d.showDsoVolumes,b()},{equalityFn:Pe}),Le=i.getQueryCache().subscribe(d=>{(ie(d,"openngc-dso-catalog")||ie(d,"custom-objects-catalog"))&&p()}),Te=t.subscribeReady?.(p);return{onFrame:d=>{if(!o.current||s.length===0)return;const M=performance.now(),D=Math.min(ga,Math.max(0,(M-y.current)/1e3));if(y.current=M,h+=1,h%6===0&&E(),m.size!==0){u();for(const I of m.values()){const v=I.scenePos.distanceTo(_),B=I.radius>0?v/I.radius:Number.POSITIVE_INFINITY;I.tick(D,B)}}},dispose:()=>{c=!0,T(),Le(),Te?.(),x(),r.remove(n)}}}function wa(e){return(e.openNgcTypeRaw==null||e.openNgcTypeRaw==="G")&&e.parentGalaxyId==null}function Se(e,t){const a=Je(e.distPc,e.majAxArcmin);if(a<=0)return null;const r=Re(e.catalogId);return{entry:e,shape:"nebula",radius:a,texture:t,nebulaPalette:t===null?pt(e,r):void 0,nebulaShape:Nt(e,r),brightnessScale:Gt(e.vMag),cstarBright:e.type==="planetary_nebula"?Ut(e.cstarVMag):0,visibilityFactor:Wt(e.vMag)}}function Fa(e,t){if(!wa(e))return null;const a=Ce(e);if(a===null||a.discRadiusSu<=0)return null;const r=it(e.catalogId)?ot(e):bt(e,Re(e.catalogId));return{entry:e,shape:"galaxy",radius:t?.projection==="flat-disc"?Ze(a.discRadiusSu):a.discRadiusSu,texture:t,galaxyPalette:r,morphScale:a.morphScale,positionAngleRad:a.positionAngleRad,galaxyBrightnessScale:yt(e.surfBrightness)}}function Ea(e){let t={},a={};return Ma(e,{buildSpecs:()=>{const l=[];for(const n of Qe()){const i=Ge(n.catalogId);if(n.type==="nebula"||n.type==="planetary_nebula"){const s=Se(n,t[i]??null);s!==null&&l.push(s)}else if(n.type==="star_cluster"&&n.openNgcTypeRaw==="Cl+N"){const s=Se(n,t[i]??null);s!==null&&l.push(s)}else if(n.type==="galaxy"){const s=Fa(n,a[i]??null);s!==null&&l.push(s)}}return l},subscribeReady:l=>{let n=!1;return jt().then(i=>{n||(t=i,l())}),Ue().then(i=>{n||(a=i,l())}),()=>{n=!0}}})}var Za=$e(Ea,"present.hud");export{Za as DsoVolumesMountR3f};
