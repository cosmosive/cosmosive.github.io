(function() {
	var n2 = Object.defineProperty, Yn = (t, n) => {
		let e = {};
	...
	const e2 = Symbol("Comlink.proxy"), Wn = Symbol("Comlink.endpoint"), jn = Symbol("Comlink.releaseProxy"), at = Symbol("Comlink.finalizer"), y1 = Symbol("Comlink.thrown"), r2 = (t) => typeof t == "object" && t !== null || typeof t == "function", o2 = new Map([["proxy", {
	...
	function ut(t, n, e = [], r = function() {}) {
		...
		const s = new Proxy(r, {
			...
			apply(i, c, a) {
				...
				if (u === Wn) return O0(t, n, { type: "ENDPOINT" }).then(v0);
	...
	}, I1 = 149597870.7, lt = 648e3 / Math.PI;
	lt * I1 / 3.2615637771694;
	const u2 = 1e3 / I1, ht = I1 * u2;
	100 * ht;
	100 / lt;
	const l2 = 3.2615637771694, ft = {
		x: 0,
		y: 0,
		z: 0
	}, D1 = ht * lt;
	...
	const de = 5e4, Me = 2e3, Se = de / l2, _e = Me / l2;
	h2(Se);
	h2(_e);
	const Ae = 25 * D1, s1 = 299792.458, f2 = 1e3;
	1 * f2, 1 * s1, 1e3 * s1, 1e6 * s1, 1e9 * s1;
	1e9 * s1;
	1 * f2;
	function pe(t) {
		return {
	...
	const d2 = Object.fromEntries(Object.entries(fe).map(([t, n]) => [t, pe(n)]));
	...
	const S2 = d2[I.EARTH]?.radiusKm ?? 6371, _2 = d2[I.SUN]?.radiusKm ?? 696340;
	S2 / _2;
	function A2(t) {
		return !Number.isFinite(t) || t <= 0 ? 0 : t * u2;
	}
	A2(S2);
	A2(_2);
	function ye(t) {
	...
	const P1 = 173.1446326846693, b = 149597870.69098932, p2 = 63241.07708807546, p = .017453292519943295, dt = .26179938779914946, V = 57.29577951308232, Mt = 3.819718634205488, ge = 71492, me = 66854, Re = 69911, xe = 1821.6, Ie = 1560.8, De = 2631.2, ve = 2410.3, E2 = 365.24217, w2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), t0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), b0 = 484813681109536e-20, y2 = 10800 * 60, Pe = 2 * y2, g2 = 7292115e-11, ze = y2 / Math.PI, Te = -.17 - 5 * Math.log10(ze), z1 = 29.530588, T1 = 24 * 3600, Ne = T1 * 1e3, m2 = .9972695717592592, i1 = 695700, R2 = i1 / b, o0 = .996647180302104, k0 = o0 * o0, d0 = 6378.1366, Le = d0 / b, Ce = d0 * o0, x2 = 6371, Ue = x2 + 88, Oe = 1738.1 / b, W = 1737.4, I2 = 1736, be = I2 / b, ke = 34 / 60, St = 81.30056, a1 = .0002959122082855911, _t = 4912547451450812e-26, At = 7243452486162703e-25, c1 = 8887692390113509e-25, pt = 9549535105779258e-26, F0 = 2.825345909524226e-7, V0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, K0 = 1.524358900784276e-8, Fe = 218869976542597e-26, N1 = c1 / St;
	function Et(t) {
		switch (t) {
	...
	var y0 = class it {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - w2.getTime()) / e, this.tt = P2(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(w2.getTime() + n * e), this.ut = n, this.tt = P2(this.ut);
				return;
			}
	...
	function g0(t) {
		if (!O1 || Math.abs(O1.tt - t.tt) > 1e-6) {
			const n = Qe(t), e = z2(t), r = e + n.deps / 3600;
			O1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function m0(t) {
		...
		function r(C, k, H, G) {
			const Q = [];
			for (let D0 = 0; D0 <= k - C; ++D0) Q.push(e(H, G));
			return {
				min: C,
				array: Q
			};
		...
		let i, c, a, u, h, l, d, _, M, A, g, E, y, w, x, R, P, D, z, v, N, U, B, c0 = r(-6, 6, 1, 4), r0 = r(-6, 6, 1, 4);
		function A0(C, k) {
			return o(c0, C, k);
		}
		function I0(C, k) {
		...
		var h0 = O(.19833 + .05611 * n), Yt = O(.27869 + .04508 * n), Wt = O(.16827 - .36903 * n), jt = O(.34734 - 5.37261 * n), Xt = O(.10498 - 5.37899 * n), st = O(.42681 - .41855 * n), T4 = O(.14943 - 5.37511 * n);
		for (D = .84 * h0 + .31 * Yt + 14.27 * Wt + 7.26 * jt + .28 * Xt + .24 * st, z = 2.94 * h0 + .31 * Yt + 14.27 * Wt + 9.34 * jt + 1.12 * Xt + .83 * st, v = -6.4 * h0 - 1.89 * st, N = .21 * h0 + .31 * Yt + 14.27 * Wt - 88.7 * jt - 15.3 * Xt + .24 * st - 1.86 * T4, U = D - v, _ = -3332e-9 * O(.59734 - 5.37261 * n) - 539e-9 * O(.35498 - 5.37899 * n) - 64e-9 * O(.39943 - 5.37511 * n), y = t0 * G0(.60643382 + 1336.85522467 * n - 313e-8 * d) + D / w0, w = t0 * G0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + z / w0, x = t0 * G0(.99312619 + 99.99735956 * n - 44e-8 * d) + v / w0, R = t0 * G0(.25909118 + 1342.2278298 * n - 892e-8 * d) + N / w0, P = t0 * G0(.82736186 + 1236.85308708 * n - 397e-8 * d) + U / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (u0(0, h, 1), u0(1, h, Math.cos(a) * u), l0(0, h, 0), l0(1, h, Math.sin(a) * u), l = 2; l <= c; ++l) ot(A0(l - 1, h), I0(l - 1, h), A0(1, h), I0(1, h), (C, k) => (u0(l, h, C), l0(l, h, k)));
		...
		function Qn(C, k, H, G) {
			for (var Q = {
				...
				H,
				G
			], p0 = 1; p0 <= 4; ++p0) D0[p0] !== 0 && ot(Q.x, Q.y, A0(D0[p0], p0), I0(D0[p0], p0), (Zt, o1) => (Q.x = Zt, Q.y = o1));
			return Q;
		}
		function S(C, k, H, G, Q, D0, p0, Zt) {
			var o1 = Qn(Q, D0, p0, Zt);
			M += C * o1.y, B += k * o1.y, g += H * o1.x, E += G * o1.x;
		}
		...
		return {
			geo_eclip_lon: t0 * G0((y + M / w0) / t0),
			geo_eclip_lat: Math.PI / (180 * 3600) * N4,
			distance_au: w0 * Le / (.999953253 * E)
		};
	}
	var L2 = class {
	...
	function b1(t, n) {
		...
		r *= b0, o *= b0, s *= b0, i *= b0;
		const c = Math.sin(r), a = Math.cos(r), u = Math.sin(-o), h = Math.cos(-o), l = Math.sin(-s), d = Math.cos(-s), _ = Math.sin(i), M = Math.cos(i), A = M * h - u * _ * d, g = M * u * a + _ * d * h * a - c * _ * l, E = M * u * c + _ * d * h * c + a * _ * l, y = -_ * h - u * M * d, w = -_ * u * a + M * d * h * a - c * M * l, x = -_ * u * c + M * d * h * c + a * M * l, R = u * l, P = -l * h * a - c * d, D = -l * h * c + d * a;
	...
	function je(t, n) {
		...
		let i, c, a;
		if (s < 1e-6) i = 0, c = o > 0 ? 90 : -90, a = Math.abs(o) - Ce;
		else {
	...
	function V1(t, n, e) {
		return e === F.Into2000 ? $0(J0(t, n, e), n, e) : J0($0(t, n, e), n, e);
	}
	function Xe(t, n, e) {
		return e === F.Into2000 ? U2(b2(t, n, e), n, e) : b2(U2(t, n, e), n, e);
	}
	function k2(t, n) {
		const e = yt(n, M0(t)).pos;
		return V1(e, t, F.Into2000);
	}
	var L = class {
		constructor(t, n, e, r) {
	...
	function K1(t, n, e, r, o) {
		let s = m(t);
		q0(n), T(e), T(r);
		const i = Math.sin(n.latitude * p), c = Math.cos(n.latitude * p), a = Math.sin(n.longitude * p), u = Math.cos(n.longitude * p), h = Math.sin(r * p), l = Math.cos(r * p), d = Math.sin(e * dt), _ = Math.cos(e * dt);
		let M = [
			c * u,
			c * a,
			i
		...
		let U = V * Math.atan2(v, P), B = e, c0 = r;
		if (o) {
			let r0 = U, A0 = p1(o, 90 - U);
			if (U -= A0, A0 > 0 && U > 3e-4) {
				const I0 = Math.sin(U * p), u0 = Math.cos(U * p), l0 = Math.sin(r0 * p), ot = Math.cos(r0 * p), O = [];
				for (let h0 = 0; h0 < 3; ++h0) O.push((R[h0] - ot * y[h0]) / l0 * I0 + y[h0] * u0);
				v = Math.hypot(O[0], O[1]), v > 0 ? (B = Mt * Math.atan2(O[1], O[0]), B < 0 && (B += 24)) : B = 0, c0 = V * Math.atan2(O[2], v);
			}
		}
		return new F2(N, 90 - U, B, c0);
	}
	function q0(t) {
	...
	function K2(t) {
		const n = m(t).AddDays(-1 / P1), e = W0(q.Earth, n), [r, o, s] = V1([
			-e.x,
			-e.y,
			-e.z
		], n, F.From2000), i = p * g0(n).tobl, c = Math.cos(i), a = Math.sin(i);
		return Rt(new L(r, o, s, n), c, a);
	}
	function u1(t, n, e, r, o) {
		q0(e), L1(r), L1(o);
		const s = m(n), i = k2(s, e), c = n0(t, s, o), a = [
			c.x - i[0],
			c.y - i[1],
			c.z - i[2]
		];
		return H2(r ? V1(a, s, F.From2000) : a, s);
	}
	function n3(t, n, e) {
		const r = m(t);
		let o = yt(n, M0(r)).pos;
		return e || (o = V1(o, r, F.Into2000)), gt(o, r);
	}
	function e3(t, n, e) {
		const r = m(t), o = yt(n, M0(r)), s = new K(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
	...
	function r3(t, n) {
		...
		return n || (r = $0(r, t.t, F.From2000), r = J0(r, t.t, F.From2000)), je(r, e);
	}
	function o3(t, n) {
	...
	function Rt(t, n, e) {
		...
		return new V2(new L(r, o, s, t.t), a, c);
	}
	function l1(t) {
		const n = g0(t.t), [e, r, o] = J0($0([
			t.x,
			t.y,
			t.z
	...
	function i0(t) {
		const n = m(t), e = m0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = $0(qe(n, [
	...
	function G1(t) {
		const n = m(t), e = m0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = g0(n), i = gt(J0(T2(s.mobl, o), n, F.From2000), n), c = s.tobl * p, a = Rt(i, Math.cos(c), Math.sin(c));
	...
	function W0(t, n) {
		const e = n.tt / Y0;
		return Pt(G2(P0(t[Dt], e, !0), P0(t[vt], e, !1), P0(t[$1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / Y0, r = P0(t[Dt], e, !0), o = P0(t[vt], e, !1), s = P0(t[$1], e, !1), i = It(t[Dt], e), c = It(t[vt], e), a = It(t[$1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(a * l * u) - s * d * u * c - s * l * h * i, M = +(a * l * h) - s * d * h * c + s * l * u * i, A = +(a * d) + s * l * c, g = G2(r, o, s), E = [
			_ / Y0,
			M / Y0,
			A / Y0
		];
		return new T0(n, Pt(g), Pt(E));
	}
	function J1(t, n, e, r) {
		const o = r / (r + a1), s = W0(q[e], n);
		t.x += o * s.x, t.y += o * s.y, t.z += o * s.z;
	}
	function s3(t) {
		const n = new L(0, 0, 0, t);
		return J1(n, t, f.Jupiter, F0), J1(n, t, f.Saturn, V0), J1(n, t, f.Uranus, H0), J1(n, t, f.Neptune, K0), n;
	}
	const zt = 51, i3 = 29200, j0 = 146, S0 = 201, z0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var M1 = class {
		constructor(t) {
			...
			this.Jupiter = j(n, t, f.Jupiter, F0), this.Saturn = j(n, t, f.Saturn, V0), this.Uranus = j(n, t, f.Uranus, H0), this.Neptune = j(n, t, f.Neptune, K0), this.Jupiter.r.decr(n.r), this.Jupiter.v.decr(n.v), this.Saturn.r.decr(n.r), this.Saturn.v.decr(n.v), this.Uranus.r.decr(n.r), this.Uranus.v.decr(n.v), this.Neptune.r.decr(n.r), this.Neptune.v.decr(n.v), this.Sun = new T0(t, n.r.mul(-1), n.v.mul(-1));
		}
		Acceleration(t) {
			let n = d1(t, a1, this.Sun.r);
			return n.incr(d1(t, F0, this.Jupiter.r)), n.incr(d1(t, V0, this.Saturn.r)), n.incr(d1(t, H0, this.Uranus.r)), n.incr(d1(t, K0, this.Neptune.r)), n;
		}
	}, Tt = class qn {
		constructor(n, e, r, o) {
	...
	function Lt(t, n) {
		const e = t - n.tt, r = new M1(t), o = X0(e, n.r, n.v, n.a), s = r.Acceleration(o).mean(n.a), i = X0(e, n.r, n.v, s);
		return new $2(r, new Tt(t, i, n.v.add(s.mul(e)), r.Acceleration(i)));
	}
	const c3 = [];
	function J2(t, n) {
	...
	function Ct(t) {
		...
		return new $2(e, new Tt(n.tt, r, o, s));
	}
	function u3(t, n) {
		const e = z0[0][0];
		if (n < e || n > z0[zt - 1][0]) return null;
		const r = J2((n - e) / i3, zt - 1);
		if (!t[r]) {
			const s = t[r] = [];
			s[0] = Ct(z0[r]).grav, s[S0 - 1] = Ct(z0[r + 1]).grav;
			let i, c = s[0].tt;
	...
	function Ut(t, n) {
		...
		const s = u3(c3, t.tt);
		if (s) {
			const i = J2((t.tt - s[0].tt) / j0, S0 - 1), c = s[i], a = s[i + 1], u = c.a.mean(a.a), h = X0(t.tt - c.tt, c.r, c.v, u), l = Nt(t.tt - c.tt, c.v, u), d = X0(t.tt - a.tt, a.r, a.v, u), _ = Nt(t.tt - a.tt, a.v, u), M = (t.tt - c.tt) / j0;
			e = h.mul(1 - M).add(d.mul(M)), r = l.mul(1 - M).add(_.mul(M));
		} else {
			let i;
			t.tt < z0[0][0] ? i = B2(z0[0], t.tt, -j0) : i = B2(z0[zt - 1], t.tt, +j0), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
	...
	function h3(t, n, e) {
		...
		const M = i * h - s * l, A = -s * h - i * l, g = 1 / (1 + A), E = 1 / (1 + Math.sqrt(1 - s * s - i * i)), y = r * (h - s - E * i * M), w = r * (l - i + E * s * M), x = u * g * r * (-l - E * i * A), R = u * g * r * (+h + E * s * A), P = 2 * Math.sqrt(1 - c * c - a * a), D = 1 - 2 * a * a, z = 1 - 2 * c * c, v = 2 * a * c;
	...
	function Q1(t, n) {
		...
		return j1(l3, h3(t, n.mu, r));
	}
	function f3(t) {
		const n = new y0(t);
		return new Q2(Q1(n, B1[0]), Q1(n, B1[1]), Q1(n, B1[2]), Q1(n, B1[3]));
	}
	function a0(t, n) {
		var e = m(n);
		...
		if (t === f.EMB) {
			const i = W0(q.Earth, e), c = i0(e), a = 1 + St;
	...
	function Y2(t, n, e, r) {
		...
		if (U1(e)) {
			const c = a0(e, o);
			if (r) {
				const u = q1(n, o), h = new L(c.x - u.x, c.y - u.y, c.z - u.z, o), l = P1 / h.Length();
	...
	function M3(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = f1(q[f.Earth], e.tt), s = t === f.Moon ? h1(e) : xt(e);
	...
	function q1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = f1(q.Earth, e.tt), s = t == f.Moon ? h1(e) : xt(e);
	...
	function J(t, n, e, r) {
		const o = T(r && r.dt_tolerance_seconds || 1), s = Math.abs(o / T1);
	...
	function Ot(t, n, e) {
		...
		const r = m(e), o = l1(n0(t, r, !1)), s = l1(n0(n, r, !1));
	...
	function A3(t, n, e, r, o) {
		const s = l1(r), i = p * 28.06, c = p * (169.51 + 382e-7 * o.tt), a = p * s.elat, u = p * s.elon, h = Math.asin(Math.sin(a) * Math.cos(i) - Math.cos(a) * Math.sin(i) * Math.sin(u - c)), l = Math.sin(Math.abs(h));
		let d = -9 + .044 * t;
	...
	function Y1(t, n) {
		...
		let o, s, i, c;
		t === f.Sun ? (i = new L(-r.x, -r.y, -r.z, e), s = new L(0, 0, 0, e), o = 0) : (t === f.Moon ? (i = i0(e), s = new L(r.x + i.x, r.y + i.y, r.z + i.z, e)) : (s = a0(t, n), i = new L(s.x - r.x, s.y - r.y, s.z - r.z, e)), o = C1(i, s));
	...
	function Z2(t) {
		let n = bt(t), e = (Math.floor(n / 90) + 1) % 4, r = _1(90 * e, t, 10);
		if (!r) throw "Cannot find moon quarter";
		return new X2(e, r);
	}
	function E3(t) {
		return Z2(new Date(t.time.date.getTime() + 6 * Ne));
	}
	var tn = class {
		constructor(t, n, e) {
	...
	function g3(t, n, e, r, o, s = 0) {
		...
		const i = y3(t), c = nn(n.height - s);
		return en(t, n, e, r, o, i, w3(n, s) - ke * c.density);
	}
	...
	function en(t, n, e, r, o, s, i) {
		...
		function u(A) {
			...
			return e * (K1(A, n, g.ra, g.dec).altitude + V * Math.asin(s / g.dist) - i);
		}
		const h = m(r);
		let l = h, d = h, _ = u(l), M = _;
		for (;;) {
			o < 0 ? (l = d.AddDays(-c), _ = u(l)) : (d = l.AddDays(+c), M = u(d));
			const A = kt(0, u, a, l, d, _, M);
			if (A) {
	...
	function I3(t, n, e, r, o = 1) {
		...
		for (;;) {
			++i;
			let c = M0(s), a = u1(t, s, n, !0, !0), u = (e + a.ra - n.longitude / 15 - c) % 24;
			if (i === 1 ? o > 0 ? u < 0 && (u += 24) : u > 0 && (u -= 24) : u < -12 ? u += 24 : u > 12 && (u -= 24), Math.abs(u) * 3600 < .1) {
				const l = K1(s, n, a.ra, a.dec, "normal");
				return new rn(s, l);
			}
			let h = u / 24 * m2;
			s = s.AddDays(h);
	...
	function D3(t, n, e) {
		const r = m(n), o = O2(r), s = u1(t, r, e, !0, !0);
	...
	function P3(t, n) {
		...
		let i = 0;
		for (; ++i <= 2;) {
			let c = Z0(C0(t, o) - C0(f.Earth, o)), a, u, h;
	...
	function z3(t, n) {
		...
		let c = 0;
		for (; ++c <= 2;) {
			let a = Z0(C0(t, o) - C0(f.Earth, o)), u, h, l;
	...
	function N3(t, n) {
		...
		for (let d = 0; d < 100; ++d) {
			const _ = r.AddDays(d * u), M = N0(t, _);
	...
	function O3(t, n) {
		const e = Vt(t);
		return e.lon = hn(e.lon), e.lat += p1(n, e.lat), e;
	}
	function b3(t, n, e) {
		n = m(n);
		const r = hn(t.lon);
		return W1(new B0(t.lat + fn(e, t.lat), r, t.dist), n);
	}
	function p1(t, n) {
		let e;
	...
	function X1(t) {
		return t = m(t), x0(b1(t, F.From2000), F1(t, F.From2000));
	}
	function F3(t) {
		const n = m(t);
		return x0(X1(n), wn(n));
	...
	function Z1(t) {
		return t = m(t), x0(F1(t, F.Into2000), b1(t, F.Into2000));
	}
	function Ht(t, n) {
		t = m(t);
	...
	function Q3(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Kt || (Kt = X1(new y0(-45655.74141261017)), yn = new y0(0));
		const e = W1(new B0(n, 15 * t, 1), yn), r = Ft(E1(Kt, e)), o = 10 / 240, s = o / 15;
		for (let i of B3) {
	...
	function Gt(t, n) {
		const e = k2(t, n), r = n0(f.Sun, t, !0), o = i0(t), s = new L(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
	...
	function W3(t) {
		const e = J((r) => $t(tt, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return tt(e);
	}
	function j3(t) {
		const e = J((r) => $t(Rn, r), t.AddDays(-.03), t.AddDays(.03));
	...
	function In(t, n) {
		const e = new L(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = xn(Math.asin(R2 / e.Length()), Math.asin(be / n.Length()), C1(n, e) * p);
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (i.r < i.p + W) {
					...
					return i.r < i.k + W && (c = X.Partial, h = Jt(i.time, i.k + W, l), i.r + W < i.k ? (c = X.Total, a = 1, u = Jt(i.time, i.k - W, h)) : a = xn(W, i.k, i.r)), new mn(c, a, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function t4(t) {
		...
		const i = X1(t.time), c = E1(i, t.dir), a = E1(i, t.target);
		...
		if (_ > 0) {
			...
			const R = r1(i);
			let P = new L(g / b, E / b, y / b, t.time);
			P = E1(R, P), P.x += t.target.x, P.y += t.target.y, P.z += t.target.z;
			const D = w1(I2, t.time, P, t.dir);
			if (D.r > 1e-9 || D.r < 0) throw `Unexpected shadow distance from geoid intersection = ${D.r}`;
			n = Pn(D.k), M = n === X.Total ? 1 : In(t.dir, P);
		} else M = void 0;
	...
	function r4(t, n) {
		...
		const c = et(n, 1, Ln, s, t.time), a = et(n, -1, Ln, t.time, i);
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = et(n, 1, Cn, s, t.time), h = et(n, -1, Cn, t.time, i), l = Pn(t.k)) : l = X.Partial;
	...
	function s4(t, n) {
		return t = m(t), On(t.AddDays(10), n);
	}
	var bn = class {
		constructor(t, n, e, r) {
	...
	function Fn(t, n) {
		...
		for (;;) {
			...
			if (n1(t, i) < e) {
				const c = X3(t, o, i);
				if (c.r < c.p) {
					const a = c.time.AddDays(-r), u = kn(t, o, a, c.time, -1), h = c.time.AddDays(+r), l = kn(t, o, c.time, h, 1), d = 60 * n1(t, c.time);
	...
	function a4(t, n) {
		return n = m(n), Fn(t, n.AddDays(100));
	}
	var _0;
	(function(t) {
	...
	function u4(t) {
		const n = $0(J0([
			...
			0,
			1
		], t, F.Into2000), t, F.Into2000), e = new L(n[0], n[1], n[2], t), r = Ft(e), o = 190.41375788700253 + 360.9856122880876 * t.ut;
	...
	function l4(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
				const d = p * (125.045 - .0529921 * r), _ = p * (250.089 - .1059842 * r), M = p * (260.008 + 13.0120009 * r), A = p * (176.625 + 13.3407154 * r), g = p * (357.529 + .9856003 * r), E = p * (311.589 + 26.4057084 * r), y = p * (134.963 + 13.064993 * r), w = p * (276.617 + .3287146 * r), x = p * (34.226 + 1.7484877 * r), R = p * (15.134 - .1589763 * r), P = p * (119.743 + .0036096 * r), D = p * (239.961 + .1643573 * r), z = p * (25.053 + 12.9590088 * r);
			...
			case f.Mars:
				...
				break;
			case f.Jupiter:
				const v = p * (99.360714 + 4850.4046 * o), N = p * (175.895369 + 1191.9605 * o), U = p * (300.323162 + 262.5475 * o), B = p * (114.012305 + 6070.2476 * o), c0 = p * (49.511251 + 64.3 * o);
				s = 268.056595 - .006499 * o + 117e-6 * Math.sin(v) + 938e-6 * Math.sin(N) + .001432 * Math.sin(U) + 3e-5 * Math.sin(B) + .00215 * Math.sin(c0), i = 64.495303 + .002413 * o + 5e-5 * Math.cos(v) + 404e-6 * Math.cos(N) + 617e-6 * Math.cos(U) - 13e-6 * Math.cos(B) + 926e-6 * Math.cos(c0), c = 284.95 + 870.536 * r;
				break;
			case f.Saturn:
	...
	function h4(t, n, e, r) {
		const o = m(n), s = Et(e), i = Et(r);
		let c, a;
		return e === f.Earth && r === f.Moon ? (c = new K(0, 0, 0, 0, 0, 0, o), a = h1(o)) : (c = q1(e, o), a = q1(r, o)), Gn(t, c, s, a, i);
	}
	function Gn(t, n, e, r, o) {
		...
		if (t === 4 || t === 5) {
			...
			const D = t == 4 ? +i : -i, z = .5 * c + D * w, v = .5 * a + D * x, N = .5 * u + D * R, U = .5 * w - D * c, B = .5 * x - D * a, c0 = .5 * R - D * u, r0 = l * z, A0 = l * v, I0 = l * N, u0 = d * c + _ * a + M * u, l0 = d * w + _ * x + M * R;
			A = new K(r0, A0, I0, u0 * z + l0 * U, u0 * v + l0 * B, u0 * N + l0 * c0, n.t);
		} else {
	...
	var f4 = class Z {
		...
		Update(n) {
			...
			if (r === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					a.tt = e.tt, a.r = X0(r, c.r, c.v, u), a.v = Nt(r, c.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = j(r, n.tt, f.Mercury, _t), e[f.Venus] = j(r, n.tt, f.Venus, At), e[f.Earth] = j(r, n.tt, f.Earth, c1 + N1), e[f.Mars] = j(r, n.tt, f.Mars, pt), e[f.Jupiter] = j(r, n.tt, f.Jupiter, F0), e[f.Saturn] = j(r, n.tt, f.Saturn, V0), e[f.Uranus] = j(r, n.tt, f.Uranus, H0), e[f.Neptune] = j(r, n.tt, f.Neptune, K0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new T0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Y.zero(), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, _t), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, At), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + N1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, pt), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, F0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, V0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, H0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, K0);
		}
	...
	const { MakeTime: r6, SearchRiseSet: o6, Body: s6, Observer: d4 } = rt(v1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: u6, CombineRotation: l6, MakeRotation: h6 } = rt(v1);
	Math.PI / (180 * 3600);
	function M4(t) {
		return t == null || !Number.isFinite(t) || t < 1 || t > 4 ? 4 : Math.floor(t);
	}
	const { HelioState: M6 } = rt(v1);
	function S4(t, n) {
	...
	function p4(t) {
		...
		const n = Ee(A4(t)), { x: e, y: r, z: o, ra: s, dec: i } = t, c = e != null && r != null && o != null && Number.isFinite(e) && Number.isFinite(r) && Number.isFinite(o);
		let a = null;
		return c && (a = le({
			x: e,
			y: r,
			z: o
		})), a == null && (a = M2(s, i)), a == null ? {
			x: 0,
			y: 0,
			z: n
		} : {
	...
	const Jn = 1, w4 = 500, Bn = .01;
	function U0(t) {
		return Math.max(0, Math.min(1, t));
	}
	function y4(t) {
		return t?.warm != null && Number.isFinite(t.warm) ? U0(t.warm) : Bn;
	}
	function g4(t) {
	...
	function D4(t, n, e, r, o, s, i, c = x4) {
		...
		for (const d of h) {
			...
			for (let A = 0; A < _.length; A += c) {
				const g = _.slice(A, A + c), E = g.length, y = new Float32Array(E * 3), w = new Float32Array(E), x = new Float32Array(E * 3), R = new Float32Array(E), P = new Float32Array(E), D = new Float32Array(E), z = [];
				for (let N = 0; N < E; N += 1) {
					const U = g[N];
	...
	function z4(t) {
		const { catalog: n, maxDistanceLevel: e, bounds: r, raInHours: o } = t, s = _4(S4(n, { raInHours: o }).filter((E) => !qt(E)), r, { maxDistanceLevel: e }), i = () => ({
			chunks: [],
			namedStarsInView: [],
			starsInView: []
		});
		if (s.length === 0) {
			if (e === 0) return i();
			const E = P4(), y = E.length, w = new Float32Array(y * 3), x = new Float32Array(y).fill(Jn), R = new Float32Array(y * 3).fill(1), P = new Float32Array(y).fill(1), D = new Float32Array(y).fill(Bn);
			for (let z = 0; z < y; z += 1) {
				const v = E[z];
		...
		for (let E = 0; E < a; E += 1) {
			...
			const x = g4(w);
			h[E] = R4(w);
			const [R, P, D] = E4(w?.c != null ? `#${w.c}` : void 0), z = y4(w), v = m4(z), N = 1 - v;
			l[E * 3] = U0(v + N * R), l[E * 3 + 1] = U0(v + N * P), l[E * 3 + 2] = U0(v + N * D), d[E] = z, _[E] = U0(.24 + .46 * (w?.br != null && Number.isFinite(w.br) ? Math.max(0, Math.min(1, w.br)) : 1) + .12 * x), M[E] = w?.mag != null && Number.isFinite(w.mag) ? w.mag : Number.POSITIVE_INFINITY, w?.proper && A.push({
				position: { ...y },
				name: w.proper,
