import{Lt as c}from"./simStateMigration-CNRffUVb.js";import{t as m}from"./deepSkyScenePosition-Dq0yD05M.js";import{D as f,U as d,dt as p,m as v,pt as C}from"./three-vendor-BPq9nlj2.js";import{it as h}from"./index-DDha546p.js";import{a as g,o as S}from"./majorDsoSelector-BbNB9bgB.js";import{n as y}from"./dsoMajorCluster-CNZjzsil.js";import{t as P}from"./shaderNoiseHelpers-BZZYASr5.js";import{t as k}from"./createDsoMountR3f-BuHEhKb6.js";var D=Math.PI/180/60,A=h.far/4;function M(o){return o.openNgcTypeRaw==="GCl"?"globular":"open"}function R(o){if(o.type!=="star_cluster"||!Number.isFinite(o.distPc)||o.distPc<=0||!Number.isFinite(o.majAxArcmin)||(o.majAxArcmin??0)<=0)return null;const r=o.majAxArcmin/2*D,e=o.distPc*Math.tan(r);if(!Number.isFinite(e)||e<=0)return null;const a=Math.min(c(e),A);return a<=0?null:{radiusSu:a,radiusPc:e,morphScale:[1,1,1],kind:M(o)}}var x={colorCore:[1.4,1.5,1.7],colorHalo:[.5,.6,.9],coreDensity:1.5,haloStrength:.4,sparkleContrast:5,intensity:1.1},F={colorCore:[1.5,1.25,.75],colorHalo:[1,.75,.45],coreDensity:2.4,haloStrength:1.6,sparkleContrast:3,intensity:1.2};function L(o){return o==="globular"?F:x}var T=`
