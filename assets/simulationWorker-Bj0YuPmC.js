(function() {
	const V = Symbol("Comlink.proxy"), ue = Symbol("Comlink.endpoint"), le = Symbol("Comlink.releaseProxy"), K = Symbol("Comlink.finalizer"), M = Symbol("Comlink.thrown"), F = (e) => typeof e == "object" && e !== null || typeof e == "function", z = new Map([["proxy", {
		canHandle: (e) => F(e) && e[V],
		serialize(e) {
	...
	function D(e, n = globalThis, r = ["*"]) {
		n.addEventListener("message", function o(s) {
			...
			let u;
			try {
				const d = c.slice(0, -1).reduce((_, T) => _[T], e), S = c.reduce((_, T) => _[T], e);
				switch (l) {
					case "GET":
						u = S;
						break;
			...
			Promise.resolve(u).catch((d) => ({
				...
				const [S, _] = b(d);
				n.postMessage(Object.assign(Object.assign({}, S), { id: i }), _), l === "RELEASE" && (n.removeEventListener("message", o), W(n), K in e && typeof e[K] == "function" && e[K]());
			}).catch((d) => {
				const [S, _] = b({
	...
	Math.PI / 180;
	180 / Math.PI;
	const L = 86400, ye = 365.25, m = 299792.458, h = m * ye * L, a = 149597870.7, j = 648e3 / Math.PI, Z = j * a / h, Me = 23.4392911, fe = 1e3, Ne = m, Ue = m ** Math.sqrt(Math.E), be = m ** 2, Oe = m ** Math.E, ge = [
		1,
		fe,
		Ne,
		Ue
	...
	var O = (e, n, r) => Object.defineProperty(e, n, {
		...
		writable: !0,
		configurable: !0
	}), Pe = Symbol.for("bitecs-relation"), Ke = Symbol.for("bitecs-pairTarget"), De = Symbol.for("bitecs-isPairComponent"), p = Symbol.for("bitecs-relationData"), ee = () => {
		let e = {
			...
			if (!e.pairsMap.has(o)) {
				...
				O(s, Pe, n), O(s, Ke, o), O(s, De, !0), e.pairsMap.set(o, s);
			}
	...
	Ye();
	const Fe = 384399 / a, ze = 421800 / a, We = 671034 / a, $e = 1070400 / a, qe = 1882700 / a, Qe = 9376 / a, Ze = 23463 / a, et = 185540 / a, tt = 237948 / a, nt = 294619 / a, rt = 377396 / a, ot = 527108 / a, st = 1221870 / a, at = 3560820 / a, it = 129390 / a, ct = 190900 / a, ut = 266e3 / a, lt = 436300 / a, dt = 583520 / a, At = 354759 / a, Et = {
		[t.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	const re = 1e3 / a, w = re * h * Z, St = 695700, mt = 6378.137;
	function oe(e) {
