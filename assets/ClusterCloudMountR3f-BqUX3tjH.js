import{i as b}from"./rolldown-runtime-BOC55nOF.js";import{p as M}from"./r3f-vendor-CiF_hEUp.js";import{n as D}from"./state-data-vendor-AdClwYuZ.js";import{Et as E}from"./sceneRuntimeTypes-IFh14Xrr.js";import{n as v}from"./scenePrefsStore-ySh80ahF.js";import{n as h}from"./appSimRuntimeHost-EsArdl6f.js";import{a as F}from"./catalog-query-defaults-sD_XjDib.js";import"./use-custom-objects-catalog-mdXWCpAr.js";import{$ as k,a as w}from"./index-B4NfcNKY.js";import{a as x,i as L,o as T,t as N}from"./r3fHostExtras-C8VytOx0.js";import{D as y,W as H,h as I,ht as O,pt as U}from"./three-vendor-DnPFe64c.js";import{i as G,r as C}from"./majorDsoSelector-8oHOLqyL.js";import{n as B}from"./dsoMajorCluster-PeXucn-R.js";import{t as q}from"./shaderNoiseHelpers-DXgXQMEZ.js";var g=b(M(),1),j=Math.PI/180/60,z=k.far/4;function Q(e){return e.openNgcTypeRaw==="GCl"?"globular":"open"}function V(e){if(e.type!=="star_cluster"||!Number.isFinite(e.distPc)||e.distPc<=0||!Number.isFinite(e.majAxArcmin)||(e.majAxArcmin??0)<=0)return null;const o=e.majAxArcmin/2*j,r=e.distPc*Math.tan(o);if(!Number.isFinite(r)||r<=0)return null;const s=Math.min(E(r),z);return s<=0?null:{radiusSu:s,radiusPc:r,morphScale:[1,1,1],kind:Q(e)}}var W={colorCore:[1.4,1.5,1.7],colorHalo:[.5,.6,.9],coreDensity:1.5,haloStrength:.4,sparkleContrast:5,intensity:1.1},Y={colorCore:[1.5,1.25,.75],colorHalo:[1,.75,.45],coreDensity:2.4,haloStrength:1.6,sparkleContrast:3,intensity:1.2};function $(e){return e==="globular"?Y:W}var K=`
