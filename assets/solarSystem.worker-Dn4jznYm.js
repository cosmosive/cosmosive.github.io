(function() {
	...
	const h2 = Symbol("Comlink.proxy"), ae = Symbol("Comlink.endpoint"), ce = Symbol("Comlink.releaseProxy"), ft = Symbol("Comlink.finalizer"), g1 = Symbol("Comlink.thrown"), d2 = (t) => typeof t == "object" && t !== null || typeof t == "function", f2 = new Map([["proxy", {
	...
	function Mt(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, M] = D1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), M), i === "RELEASE" && (n.removeEventListener("message", o), M2(n), ft in t && typeof t[ft] == "function" && t[ft]());
			}).catch((h) => {
				const [l, M] = D1({
	...
	W * 3600;
	W * St;
	const p2 = W * pe * St, k = 149597870.7, E2 = 648e3 / Math.PI, Ee = E2 * k;
	k / p2;
	const ye = Ee / p2;
	Object.freeze({
		x: 0,
	...
	var N1 = (t, n, e) => Object.defineProperty(t, n, {
		...
		writable: !0,
		configurable: !0
	}), me = Symbol.for("bitecs-relation"), Re = Symbol.for("bitecs-pairTarget"), Ie = Symbol.for("bitecs-isPairComponent"), a1 = Symbol.for("bitecs-relationData"), y2 = () => {
		let t = {
	...
	}, pt = k, I2 = E2, g2 = 1e3 / pt, k0 = pt * g2;
	100 * k0;
	100 / I2;
	const w2 = ye, Et = k0 * I2;
	25 * Et;
	function x2(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * Et;
	}
	const s3 = 5e4, i3 = 2e3, a3 = s3 / w2, c3 = i3 / w2;
	x2(a3);
	x2(c3);
	25 * Et;
	const yt = 1e3;
	...
	const v1 = 173.1446326846693, z = 149597870.69098932, P2 = 63241.07708807546, _ = .017453292519943295, mt = .26179938779914946, K = 57.29577951308232, Rt = 3.819718634205488, d3 = 71492, f3 = 66854, M3 = 69911, A3 = 1821.6, S3 = 1560.8, _3 = 2631.2, p3 = 2410.3, O2 = 365.24217, v2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), e0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), K0 = 484813681109536e-20, z2 = 10800 * 60, E3 = 2 * z2, b2 = 7292115e-11, y3 = z2 / Math.PI, m3 = -.17 - 5 * Math.log10(y3), z1 = 29.530588, b1 = 24 * 3600, R3 = b1 * 1e3, L2 = .9972695717592592, u1 = 695700, C2 = u1 / z, i0 = .996647180302104, B0 = i0 * i0, A0 = 6378.1366, I3 = A0 / z, g3 = A0 * i0, k2 = 6371, w3 = k2 + 88, x3 = 1738.1 / z, X = 1737.4, K2 = 1736, T3 = K2 / z, D3 = 34 / 60, It = 81.30056, l1 = .0002959122082855911, gt = 4912547451450812e-26, wt = 7243452486162703e-25, h1 = 8887692390113509e-25, xt = 9549535105779258e-26, H0 = 2.825345909524226e-7, J0 = 8.459715185680659e-8, V0 = 1.292024916781969e-8, F0 = 1.524358900784276e-8, N3 = 218869976542597e-26, L1 = h1 / It;
	function Tt(t) {
		switch (t) {
	...
	function w0(t) {
		...
		let i, a, c, u, h, l, M, p, A, E, m, I, g, R, x, w, U, D, C, O, Y, G, q, l0 = o(-6, 6, 1, 4), s0 = o(-6, 6, 1, 4);
		function E0(P, b) {
			return r(l0, P, b);
		}
		function D0(P, b) {
		...
		var f0 = v(.19833 + .05611 * n), r2 = v(.27869 + .04508 * n), s2 = v(.16827 - .36903 * n), i2 = v(.34734 - 5.37261 * n), a2 = v(.10498 - 5.37899 * n), ht = v(.42681 - .41855 * n), l6 = v(.14943 - 5.37511 * n);
		for (D = .84 * f0 + .31 * r2 + 14.27 * s2 + 7.26 * i2 + .28 * a2 + .24 * ht, C = 2.94 * f0 + .31 * r2 + 14.27 * s2 + 9.34 * i2 + 1.12 * a2 + .83 * ht, O = -6.4 * f0 - 1.89 * ht, Y = .21 * f0 + .31 * r2 + 14.27 * s2 - 88.7 * i2 - 15.3 * a2 + .24 * ht - 1.86 * l6, G = D - O, p = -3332e-9 * v(.59734 - 5.37261 * n) - 539e-9 * v(.35498 - 5.37899 * n) - 64e-9 * v(.39943 - 5.37511 * n), g = e0 * G0(.60643382 + 1336.85522467 * n - 313e-8 * M) + D / R0, R = e0 * G0(.37489701 + 1325.55240982 * n + 2565e-8 * M) + C / R0, x = e0 * G0(.99312619 + 99.99735956 * n - 44e-8 * M) + O / R0, w = e0 * G0(.25909118 + 1342.2278298 * n - 892e-8 * M) + Y / R0, U = e0 * G0(.82736186 + 1236.85308708 * n - 397e-8 * M) + G / R0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (h0(0, h, 1), h0(1, h, Math.cos(c) * u), d0(0, h, 0), d0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) lt(E0(l - 1, h), D0(l - 1, h), E0(1, h), D0(1, h), (P, b) => (h0(l, h, P), d0(l, h, b)));
			for (l = 1; l <= a; ++l) h0(-l, h, E0(l, h)), d0(-l, h, -D0(l, h));
		}
		function re(P, b, B, J) {
			for (var $ = {
				x: 1,
				...
				B,
				J
			], y0 = 1; y0 <= 4; ++y0) N0[y0] !== 0 && lt($.x, $.y, E0(N0[y0], y0), D0(N0[y0], y0), (c2, i1) => ($.x = c2, $.y = i1));
			return $;
		}
		function S(P, b, B, J, $, N0, y0, c2) {
			var i1 = re($, N0, y0, c2);
		...
		E = 0, E += M0(-526.069, 0, 0, 1, -2), E += M0(-3.352, 0, 0, 1, -4), E += M0(44.297, 1, 0, 1, -2), E += M0(-6, 1, 0, 1, -4), E += M0(20.599, -1, 0, 1, 0), E += M0(-30.598, -1, 0, 1, -2), E += M0(-24.649, -2, 0, 1, 0), E += M0(-2, -2, 0, 1, -2), E += M0(-22.571, 0, 1, 1, -2), E += M0(10.985, 0, -1, 1, -2), A += .82 * v(.7736 - 62.5512 * n) + .31 * v(.0466 - 125.1025 * n) + .35 * v(.5785 - 25.1042 * n) + .66 * v(.4591 + 1335.8075 * n) + .64 * v(.313 - 91.568 * n) + 1.14 * v(.148 + 1331.2898 * n) + .21 * v(.5918 + 1056.5859 * n) + .44 * v(.5784 + 1322.8595 * n) + .24 * v(.2275 - 5.7374 * n) + .28 * v(.2965 + 2.6929 * n) + .33 * v(.3132 + 6.3368 * n), i = w + q / R0;
		let h6 = (1.000002708 + 139.978 * p) * (18519.699999999997 + m) * Math.sin(i) - 6.24 * Math.sin(3 * i) + E;
		return {
			geo_eclip_lon: e0 * G0((g + A / R0) / e0),
	...
	function Nt(t, n) {
		const e = t.latitude * _, o = Math.sin(e), r = Math.cos(e), s = 1 / Math.hypot(r, i0 * o), i = B0 * s, a = t.height / 1e3, c = A0 * s + a, u = A0 * i + a, h = (15 * n + t.longitude) * _, l = Math.sin(h), M = Math.cos(h);
		return {
			pos: [
				c * r * M / z,
				c * r * l / z,
	...
	function $1(t, n, e, o, r) {
		let s = y(t);
		q0(n), T(e), T(o);
		const i = Math.sin(n.latitude * _), a = Math.cos(n.latitude * _), c = Math.sin(n.longitude * _), u = Math.cos(n.longitude * _), h = Math.sin(o * _), l = Math.cos(o * _), M = Math.sin(e * mt), p = Math.cos(e * mt);
		let A = [
			a * u,
			a * c,
			i
		...
		let G = K * Math.atan2(O, U), q = e, l0 = o;
		if (r) {
			let s0 = G, E0 = m1(r, 90 - G);
			if (G -= E0, E0 > 0 && G > 3e-4) {
				const D0 = Math.sin(G * _), h0 = Math.cos(G * _), d0 = Math.sin(s0 * _), lt = Math.cos(s0 * _), v = [];
				for (let f0 = 0; f0 < 3; ++f0) v.push((w[f0] - lt * g[f0]) / d0 * D0 + g[f0] * h0);
				O = Math.hypot(v[0], v[1]), O > 0 ? (q = Rt * Math.atan2(v[1], v[0]), q < 0 && (q += 24)) : q = 0, l0 = K * Math.atan2(v[2], O);
			}
		}
		return new X2(Y, 90 - G, q, l0);
	}
	function q0(t) {
	...
	function G3(t, n, e) {
		const o = y(t);
		let r = Nt(n, S0(o)).pos;
		return e || (r = F1(r, o, L.Into2000)), Ut(r, o);
	}
	function $3(t, n, e) {
		const o = y(t), r = Nt(n, S0(o)), s = new H(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
	...
	function Y1(t) {
		const n = y(t), e = w0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			...
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = g0(n), i = Ut(Y0(F2(s.mobl, r), n, L.From2000), n), a = s.tobl * _, c = Ot(i, Math.cos(a), Math.sin(a));
	...
	const W0 = 365250, bt = 0, Lt = 1, j1 = 2;
	function Ct(t) {
	...
	function X0(t, n) {
		const e = n.tt / W0;
		return Ct(en(P0(t[bt], e, !0), P0(t[Lt], e, !1), P0(t[j1], e, !1))).ToAstroVector(n);
	}
	function A1(t, n) {
		const e = n / W0, o = P0(t[bt], e, !0), r = P0(t[Lt], e, !1), s = P0(t[j1], e, !1), i = zt(t[bt], e), a = zt(t[Lt], e), c = zt(t[j1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), M = Math.sin(r), p = +(c * l * u) - s * M * u * a - s * l * h * i, A = +(c * l * h) - s * M * h * a + s * l * u * i, E = +(c * M) + s * l * a, m = en(o, r, s), I = [
			p / W0,
			A / W0,
			E / W0
		];
	...
	const kt = 51, q3 = 29200, Z0 = 146, _0 = 201, O0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function Z3(t, n) {
		...
		const o = rn((n - e) / q3, kt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Jt(O0[o]).grav, s[_0 - 1] = Jt(O0[o + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < _0 - 1; ++i) s[i] = Ht(a += Z0, s[i - 1]).grav;
			a = s[_0 - 1].tt;
			var r = [];
			for (r[_0 - 1] = s[_0 - 1], i = _0 - 2; i > 0; --i) r[i] = Ht(a -= Z0, r[i + 1]).grav;
			for (i = _0 - 2; i > 0; --i) {
				const c = i / (_0 - 1);
	...
	function Vt(t, n) {
		...
		const s = Z3(X3, t.tt);
		if (s) {
			const i = rn((t.tt - s[0].tt) / Z0, _0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = t1(t.tt - a.tt, a.r, a.v, u), l = Bt(t.tt - a.tt, a.v, u), M = t1(t.tt - c.tt, c.r, c.v, u), p = Bt(t.tt - c.tt, c.v, u), A = (t.tt - a.tt) / Z0;
			e = h.mul(1 - A).add(M.mul(A)), o = l.mul(1 - A).add(p.mul(A));
		} else {
			let i;
			t.tt < O0[0][0] ? i = sn(O0[0], t.tt, -Z0) : i = sn(O0[kt - 1], t.tt, +Z0), e = i.grav.r, o = i.grav.v, r = i.bary;
		}
	...
	function u0(t, n) {
		...
		if (t === d.Moon) {
			var o = X0(j.Earth, e), r = c0(e);
			return new N(o.x + r.x, o.y + r.y, o.z + r.z, e);
		}
		if (t === d.EMB) {
			const i = X0(j.Earth, e), a = c0(e), c = 1 + It;
	...
	function z0(t, n) {
		...
		if (e) return e.dist;
		const o = y(n);
		return t in j ? P0(j[t][j1], o.tt / W0, !1) : u0(t, o).Length();
	}
	function cn(t, n) {
		let e = n, o = 0;
		for (let r = 0; r < 10; ++r) {
	...
	function r4(t, n) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = A1(j[d.Earth], e.tt), s = t === d.Moon ? M1(e) : vt(e);
	...
	function X1(t, n) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = A1(j.Earth, e.tt), s = t == d.Moon ? M1(e) : vt(e);
	...
	function Ft(t, n, e) {
		...
		const o = y(e), r = f1(o0(t, o, !1)), s = f1(o0(n, o, !1));
	...
	function Z1(t, n) {
		...
		let r, s, i, a;
		t === d.Sun ? (i = new N(-o.x, -o.y, -o.z, e), s = new N(0, 0, 0, e), r = 0) : (t === d.Moon ? (i = c0(e), s = new N(o.x + i.x, o.y + i.y, o.z + i.z, e)) : (s = u0(t, n), i = new N(s.x - o.x, s.y - o.y, s.z - o.z, e)), r = k1(i, s));
	...
	function fn(t) {
		let n = Gt(t), e = (Math.floor(n / 90) + 1) % 4, o = E1(90 * e, t, 10);
	...
	function l4(t, n) {
		const e = t.latitude * _, o = Math.sin(e), r = Math.cos(e), s = 1 / Math.hypot(r, o * i0), i = s * (i0 * i0), a = (t.height - n) / 1e3, c = A0 * s + a, u = A0 * i + a, h = 1e3 * Math.hypot(c * r, u * o), l = .175 * Math.pow(1 - .0065 / 283.15 * (t.height - 2 / 3 * n), 3.256);
	...
	function $t(t, n, e, o, r, s, i) {
		...
		return $t(1 + t, n, e, o, c, s, u) || $t(1 + t, n, e, c, r, u, i);
	}
	function A4(t, n) {
	...
	function C4(t, n) {
		...
		const e = tt(new j0(n, 15 * t, 1), zn), o = Yt(R1(qt, e)), r = 10 / 240, s = r / 15;
		for (let i of L4) {
	...
	function rt(t) {
		const n = o0(d.Sun, t, !0), e = new N(-n.x, -n.y, -n.z, n.t);
		return I1(w3, t, c0(t), e);
	}
	function Cn(t) {
		const n = o0(d.Sun, t, !0), e = c0(t), o = new N(-e.x, -e.y, -e.z, e.t);
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, I1(X, t, o, e);
	}
	function Wt(t, n) {
		const e = W2(t, n), o = o0(d.Sun, t, !0), r = c0(t), s = new N(e[0] - r.x, e[1] - r.y, e[2] - r.z, t);
		return r.x -= o.x, r.y -= o.y, r.z -= o.z, I1(X, t, s, r);
	}
	function st(t, n, e) {
		const o = o0(t, e, !0), r = o0(d.Sun, e, !0), s = new N(o.x - r.x, o.y - r.y, o.z - r.z, e);
	...
	function B4(t) {
		const e = F((o) => Xt(rt, o), t.AddDays(-.03), t.AddDays(.03));
	...
	function F4(t) {
		...
		let A;
		if (p > 0) {
			const E = (-l - Math.sqrt(p)) / (2 * h), m = E * a.x - c.x, I = E * a.y - c.y, g = (E * a.z - c.z) * i0, R = Math.hypot(m, I) * B0;
			...
			n = Jn(D.k), A = n === t0.Total ? 1 : Kn(t.dir, U);
		} else A = void 0;
	...
	function Y4(t, n) {
		...
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = it(n, 1, Yn, s, t.time), h = it(n, -1, Yn, t.time, i), l = Jn(t.k)) : l = t0.Partial;
	...
	function Z4(t) {
		const n = $0(Y0([
			...
			0,
			1
		], t, L.Into2000), t, L.Into2000), e = new N(n[0], n[1], n[2], t), o = Yt(e), r = 190.41375788700253 + 360.9856122880876 * t.ut;
	...
	function t6(t, n) {
		...
		switch (t) {
			...
			case d.Mars:
				...
				break;
			case d.Jupiter:
				const O = _ * (99.360714 + 4850.4046 * r), Y = _ * (175.895369 + 1191.9605 * r), G = _ * (300.323162 + 262.5475 * r), q = _ * (114.012305 + 6070.2476 * r), l0 = _ * (49.511251 + 64.3 * r);
				s = 268.056595 - .006499 * r + 117e-6 * Math.sin(O) + 938e-6 * Math.sin(Y) + .001432 * Math.sin(G) + 3e-5 * Math.sin(q) + .00215 * Math.sin(l0), i = 64.495303 + .002413 * r + 5e-5 * Math.cos(O) + 404e-6 * Math.cos(Y) + 617e-6 * Math.cos(G) - 13e-6 * Math.cos(q) + 926e-6 * Math.cos(l0), a = 284.95 + 870.536 * o;
				break;
			case d.Saturn:
	...
	function ee(t, n, e, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const D = t == 4 ? +i : -i, C = .5 * a + D * R, O = .5 * c + D * x, Y = .5 * u + D * w, G = .5 * R - D * a, q = .5 * x - D * c, l0 = .5 * w - D * u, s0 = l * C, E0 = l * O, D0 = l * Y, h0 = M * a + p * c + A * u, d0 = M * R + p * x + A * w;
			E = new H(s0, E0, D0, h0 * C + d0 * G, h0 * O + d0 * q, h0 * Y + d0 * l0, n.t);
		} else {
	...
	var e6 = class n0 {
		...
		Update(n) {
			...
			if (o === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = t1(o, a.r, a.v, u), c.v = Bt(o, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[d.Mercury] = Z(o, n.tt, d.Mercury, gt), e[d.Venus] = Z(o, n.tt, d.Venus, wt), e[d.Earth] = Z(o, n.tt, d.Earth, h1 + L1), e[d.Mars] = Z(o, n.tt, d.Mars, xt), e[d.Jupiter] = Z(o, n.tt, d.Jupiter, H0), e[d.Saturn] = Z(o, n.tt, d.Saturn, J0), e[d.Uranus] = Z(o, n.tt, d.Uranus, V0), e[d.Neptune] = Z(o, n.tt, d.Neptune, F0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[d.Sun] = new v0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Q.zero(), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Sun].r, l1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Mercury].r, gt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Venus].r, wt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Earth].r, h1 + L1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Mars].r, xt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Jupiter].r, H0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Saturn].r, J0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Uranus].r, V0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Neptune].r, F0);
		}
	...
	const { MakeTime: i8, SearchRiseSet: a8, Body: c8, Observer: o6 } = at(c1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: d8, CombineRotation: f8, MakeRotation: M8 } = at(c1);
	Math.PI / (180 * 3600);
	function ct(t, n) {
	...
	const { HelioState: E8, MakeTime: y8, JupiterMoons: m8, Body: ut } = at(c1);
