(function() {
	...
	180 / Math.PI;
	const lt = 86400, Ze = 365.25, m0 = 299792.458, ht = m0 * Ze * lt, C = 149597870.7, dt = 648e3 / Math.PI, en = dt * C / ht, nn = 23.4392911, on = 1e3, rn = m0, sn = m0 ** Math.sqrt(Math.E), an = m0 ** 2, cn = m0 ** Math.E, un = [
		1,
		on,
		rn,
		sn
	...
	var R1 = (t, e, n) => Object.defineProperty(t, e, {
		...
		writable: !0,
		configurable: !0
	}), hn = Symbol.for("bitecs-relation"), dn = Symbol.for("bitecs-pairTarget"), fn = Symbol.for("bitecs-isPairComponent"), a1 = Symbol.for("bitecs-relationData"), c2 = () => {
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				R1(r, hn, e), R1(r, dn, o), R1(r, fn, !0), t.pairsMap.set(o, r);
			}
	...
	const h2 = Symbol("Comlink.proxy"), qn = Symbol("Comlink.endpoint"), Xn = Symbol("Comlink.releaseProxy"), Mt = Symbol("Comlink.finalizer"), x1 = Symbol("Comlink.thrown"), d2 = (t) => typeof t == "object" && t !== null || typeof t == "function", f2 = new Map([["proxy", {
	...
	const D1 = 173.1446326846693, P = 149597870.69098932, E2 = 63241.07708807546, _ = .017453292519943295, _t = .26179938779914946, k = 57.29577951308232, Et = 3.819718634205488, i3 = 71492, c3 = 66854, u3 = 69911, l3 = 1821.6, h3 = 1560.8, d3 = 2631.2, f3 = 2410.3, p2 = 365.24217, y2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), e0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), L0 = 484813681109536e-20, m2 = 10800 * 60, M3 = 2 * m2, A3 = 7292115e-11, S3 = m2 / Math.PI, _3 = -.17 - 5 * Math.log10(S3), v1 = 29.530588, O1 = 24 * 3600, E3 = O1 * 1e3, R2 = .9972695717592592, pt = 695700, I2 = pt / P, s0 = .996647180302104, k0 = s0 * s0, M0 = 6378.1366, p3 = M0 / P, y3 = M0 * s0, m3 = 6371, R3 = 6459, I3 = 1738.1 / P, X = 1737.4, g2 = 1736, g3 = g2 / P, x3 = 34 / 60, w3 = 81.30056, c1 = .0002959122082855911, yt = 4912547451450812e-26, mt = 7243452486162703e-25, x2 = 8887692390113509e-25, Rt = 9549535105779258e-26, K0 = 2.825345909524226e-7, B0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, V0 = 1.524358900784276e-8, T3 = 218869976542597e-26, N3 = x2 / w3;
	function It(t) {
		switch (t) {
	...
	function u1(t, e, n, o, r) {
		...
		return B2(o ? B1(c, s, z.From2000) : c, s);
	}
	function F3(t, e, n) {
		const o = m(t);
		let r = xt(e, A0(o)).pos;
	...
	function q0(t, e) {
		const n = e.tt / Q0;
		return Pt(V2(D0(t[vt], n, !0), D0(t[Ot], n, !1), D0(t[F1], n, !1))).ToAstroVector(e);
	}
	function d1(t, e) {
		const n = e / Q0, o = D0(t[vt], n, !0), r = D0(t[Ot], n, !1), s = D0(t[F1], n, !1), a = Dt(t[vt], n), i = Dt(t[Ot], n), c = Dt(t[F1], n), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), M = Math.sin(r), y = +(c * h * u) - s * M * u * i - s * h * l * a, A = +(c * h * l) - s * M * l * i + s * h * u * a, E = +(c * M) + s * h * i, I = V2(o, r, s), R = [
			y / Q0,
			A / Q0,
			E / Q0
		];
	...
	function kt(t) {
		const e = q3(t), n = new M1(e.tt), o = e.r.add(n.Sun.r), r = e.v.add(n.Sun.v), s = n.Acceleration(o);
	...
	function Kt(t, e) {
		...
		const s = W3(X3, t.tt);
		if (s) {
			const a = F2((t.tt - s[0].tt) / G1, S0 - 1), i = s[a], c = s[a + 1], u = i.a.mean(c.a), l = X0(t.tt - i.tt, i.r, i.v, u), h = Ct(t.tt - i.tt, i.v, u), M = X0(t.tt - c.tt, c.r, c.v, u), y = Ct(t.tt - c.tt, c.v, u), A = (t.tt - i.tt) / G1;
	...
	function j1(t, e) {
		...
		return W1(Z3, t4(t, e.mu, o));
	}
	function e4(t) {
		const e = new I0(t);
		return new G2(j1(e, Y1[0]), j1(e, Y1[1]), j1(e, Y1[2]), j1(e, Y1[3]));
	}
	function c0(t, e) {
		var n = m(e);
	...
	function S4(t, e, n) {
		const o = m(e), r = z2(o), s = u1(t, o, n, !0, !0);
	...
	function x4(t, e) {
		const n = Ft(t);
		return n.lon = ue(n.lon), n.lat += E1(e, n.lat), n;
	}
	function w4(t, e, n) {
		e = m(e);
		const o = ue(t.lon);
		return X1(new G0(t.lat + le(n, t.lat), o, t.dist), e);
	}
	function E1(t, e) {
		let n;
	...
	function C4(t, e) {
		...
		t %= 24, t < 0 && (t += 24), Gt || (Gt = Z1(new I0(-45655.74141261017)), pe = new I0(0));
		const n = X1(new G0(e, 15 * t, 1), pe), o = Jt(p1(Gt, n)), r = 10 / 240, s = r / 15;
		for (let a of z4) {
	...
	function ge(t, e) {
		const n = new U(t.x + e.x, t.y + e.y, t.z + e.z, t.t), o = Ie(Math.asin(I2 / n.Length()), Math.asin(g3 / e.Length()), b1(e, n) * _);
	...
	function G4(t, e) {
		...
		const s = ot(e, 1, ve, o, t.time), a = ot(e, -1, ve, t.time, r);
		let i, c, u;
		t.r < Math.abs(t.k) ? (o = t.time.AddDays(-.01), r = t.time.AddDays(.01), i = ot(e, 1, Oe, o, t.time), c = ot(e, -1, Oe, t.time, r), u = Te(t.k)) : u = Z.Partial;
	...
	function t6(t, e, n, o) {
		...
		let i, c;
		return n === d.Earth && o === d.Moon ? (i = new H(0, 0, 0, 0, 0, 0, r), c = h1(r)) : (i = Q1(n, r), c = Q1(o, r)), He(t, i, s, c, a);
	}
	...
	const { MakeTime: W6, SearchRiseSet: Z6, Body: t8, Observer: n6 } = rt(i1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: r8, CombineRotation: s8, MakeRotation: a8 } = rt(i1);
	Math.PI / (180 * 3600);
	nn * We;
	(() => {
		const t = i1;
	...
	const { HelioState: h8, MakeTime: d8, JupiterMoons: f8, Body: at } = rt(i1);
	f.IO, f.EUROPA, f.GANYMEDE, f.CALLISTO;
	at.Mars, at.Saturn, at.Uranus, at.Neptune;
	f.CERES, f.ERIS, f.HAUMEA, f.MAKEMAKE;
	const o1 = 1e3, Je = o1 / C, Fe = Je * ht * en, s6 = 695700, a6 = 6378.137;
	function $e(t) {
