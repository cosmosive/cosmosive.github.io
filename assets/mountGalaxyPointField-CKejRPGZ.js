import{n as C}from"./state-data-vendor-DwYWRG6B.js";import{n as G}from"./manifest.generated-B_QDKHYB.js";import{A as _,d as m,f as z,ht as R,it as T}from"./three-vendor-Ce7iT1Ri.js";import{a as B,b as L,ni as P,yn as N}from"./index-CDiC8UFL.js";import{t as E}from"./createMountComponent-BWjwSNjq.js";import{n as g}from"./backdropCache-DtKmT5Q5.js";import{n as S,t as V}from"./deepSkyCatalogBridge-CXF-9I3p.js";import{i as I,t as O}from"./galaxyVolumeActivations-DjDa8t_c.js";var D=13;function k(a){switch(N(a.hubbleType).kind){case"elliptical":case"lenticular":return[1.3,1.05,.7];case"irregular":return[.8,.95,1.3];default:return[1.05,1,1.05]}}function Q(a){return a.type==="galaxy"&&(a.openNgcTypeRaw==null||a.openNgcTypeRaw==="G")&&a.parentGalaxyId==null}function Y(a){if(!Q(a)||!Number.isFinite(a.distPc)||(a.distPc??0)<=0)return null;const l=G(a);if(!Number.isFinite(l.x)||!Number.isFinite(l.y)||!Number.isFinite(l.z)||l.x===0&&l.y===0&&l.z===0)return null;const i=a.vMag!=null&&Number.isFinite(a.vMag)?a.vMag:D;return{pos:[l.x,l.y,l.z],mag:i,color:k(a)}}function U(a){const l=[],i=[],s=[],n=[];for(const e of a){const t=Y(e);t!==null&&(l.push(t.pos[0],t.pos[1],t.pos[2]),i.push(t.mag),s.push(t.color[0],t.color[1],t.color[2]),n.push(e.catalogId))}return{positions:new Float32Array(l),mag:new Float32Array(i),colors:new Float32Array(s),catalogIds:n,count:n.length}}var j=96,X=`
  attribute float mag;
...
`;function q(){return new R({uniforms:{uMagLimit:{value:8.5},uMagRef:{value:0},uMagFadeRange:{value:1.5},uFluxClampMax:{value:6},uFluxGamma:{value:.45},uPointSizeFloor:{value:1.6},uPointSizeMax:{value:j},uPsfMaxMult:{value:4},uSizeMultiplier:{value:1}},vertexShader:X,fragmentShader:K,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1})}function W(a){const l=L(a).layers.dso,i=new _;i.name="galaxyPointFieldLayer",l.add(i);const s=B(),n=q();let e=null,t=null,d=new Map,u=new Set,v=!1;const x={current:P.getState().showDsoVolumes},h=()=>{i.visible=x.current&&e!==null},y=()=>{if(e===null||t===null)return;const o=e.geometry.getAttribute("suppress"),c=o.array,p=new Set;for(const r of O()){const M=d.get(r);M!==void 0&&p.add(M)}let f=!1;for(const r of u)p.has(r)||(c[r]=0,f=!0);for(const r of p)u.has(r)||(c[r]=1,f=!0);f&&(u=p,o.needsUpdate=!0,g())},F=()=>{if(!v){if(e!==null&&(i.remove(e),e.geometry.dispose(),e=null),t=U(V()),d=new Map(t.catalogIds.map((o,c)=>[o,c])),u=new Set,t.count>0){const o=new z;o.setAttribute("position",new m(t.positions,3)),o.setAttribute("mag",new m(t.mag,1)),o.setAttribute("color",new m(t.colors,3)),o.setAttribute("suppress",new m(new Float32Array(t.count),1)),e=new T(o,n),e.name="galaxyPointField",e.frustumCulled=!1,e.renderOrder=-20,e.layers.set(1),i.add(e),y()}h(),g()}};Promise.resolve().then(F).catch(o=>console.error("[mountGalaxyPointField] rebuild failed:",o));const w=P.subscribe(o=>({showDsoVolumes:o.showDsoVolumes}),o=>{x.current=o.showDsoVolumes,h()},{equalityFn:C}),b=s.getQueryCache().subscribe(o=>{(S(o,"openngc-dso-catalog")||S(o,"custom-objects-catalog"))&&F()}),A=I(()=>y());return{onFrame:()=>{},dispose:()=>{v=!0,w(),b(),A(),e!==null&&(i.remove(e),e.geometry.dispose(),e=null,g()),n.dispose(),l.remove(i)}}}var re=E(W,"present.hud");export{re as GalaxyPointFieldMountR3f};
