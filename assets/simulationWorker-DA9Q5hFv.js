(function() {
	var s2 = Object.defineProperty, Qn = (t, n) => {
		let e = {};
		for (var r in t) s2(e, r, {
			get: t[r],
			enumerable: !0
		});
		return n || s2(e, Symbol.toStringTag, { value: "Module" }), e;
	};
	const i2 = Symbol("Comlink.proxy"), Bn = Symbol("Comlink.endpoint"), qn = Symbol("Comlink.releaseProxy"), it = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), a2 = (t) => typeof t == "object" && t !== null || typeof t == "function", c2 = new Map([["proxy", {
		canHandle: (t) => a2(t) && t[i2],
		serialize(t) {
	...
	function at(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function r(o) {
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, d] = m1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), d), i === "RELEASE" && (n.removeEventListener("message", r), u2(n), it in t && typeof t[it] == "function" && t[it]());
			}).catch((h) => {
				const [l, d] = m1({
	...
	function ct(t, n, e = [], r = function() {}) {
		let o = !1;
		const s = new Proxy(r, {
			get(i, a) {
				if (g1(o), a === qn) return () => {
					Xn(s), l2(t), n.clear(), o = !0;
				};
				if (a === "then") {
			...
			apply(i, a, c) {
				...
				if (u === Bn) return O0(t, n, { type: "ENDPOINT" }).then(P0);
	...
	function n3(t) {
		return Object.assign(t, { [i2]: !0 });
	}
	function m1(t) {
		for (const [n, e] of c2) if (e.canHandle(t)) {
	...
	}, o3 = 149597870.7, s3 = 648e3 / Math.PI, d2 = 1500;
	d2 / 15;
	100 / s3;
	d2 + 500;
	const ut = 1721545, lt = 3181545;
	function i3(t) {
		return {
			name: t.name,
			type: t.type,
	...
	const M2 = Object.fromEntries(Object.entries(r3).map(([t, n]) => [t, i3(n)]));
	D.SUN, D.MERCURY, D.VENUS, D.EARTH, D.MARS, D.JUPITER, D.SATURN, D.URANUS, D.NEPTUNE, D.PLUTO;
	const ht = M2[D.EARTH]?.radiusKm ?? 6371, ft = M2[D.SUN]?.radiusKm ?? 696340, a3 = ht / ft, s1 = .04;
	ht / s1;
	s1 / ht / (15 / o3);
	function c3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : t / a3 * s1;
	}
	function u3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : c3(t / ft);
	}
	u3(ft);
	var v1 = Qn({
		AU_PER_LY: () => S2,
		...
		InverseRotation: () => r1,
		JUPITER_EQUATORIAL_RADIUS_KM: () => l3,
		JUPITER_MEAN_RADIUS_KM: () => f3,
		JUPITER_POLAR_RADIUS_KM: () => h3,
		JupiterMoons: () => te,
		JupiterMoonsInfo: () => G2,
		KM_PER_AU: () => L,
		LagrangePoint: () => Ze,
		...
		MoonPhase: () => kt,
		MoonQuarter: () => Y2,
		NextGlobalSolarEclipse: () => Ge,
		NextLocalSolarEclipse: () => qe,
		NextLunarApsis: () => ye,
		NextLunarEclipse: () => He,
		NextMoonNode: () => je,
		NextMoonQuarter: () => ae,
		...
		SearchMaxElongation: () => _e,
		SearchMoonNode: () => Vn,
		SearchMoonPhase: () => p1,
		SearchMoonQuarter: () => j2,
		SearchPeakMagnitude: () => Ae,
		...
		TransitInfo: () => Ln,
		Vector: () => P,
		VectorFromHorizon: () => me,
		VectorFromSphere: () => K1,
		VectorObserver: () => Q3,
		e_tilt: () => R0
	});
	const D1 = 173.1446326846693, L = 149597870.69098932, S2 = 63241.07708807546, p = .017453292519943295, dt = .26179938779914946, b = 57.29577951308232, Mt = 3.819718634205488, l3 = 71492, h3 = 66854, f3 = 69911, d3 = 1821.6, M3 = 1560.8, S3 = 2631.2, p3 = 2410.3, p2 = 365.24217, _2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, A2 = 10800 * 60, _3 = 2 * A2, y2 = 7292115e-11, A3 = A2 / Math.PI, y3 = -.17 - 5 * Math.log10(A3), I1 = 29.530588, P1 = 24 * 3600, E3 = P1 * 1e3, E2 = .9972695717592592, i1 = 695700, w2 = i1 / L, s0 = .996647180302104, b0 = s0 * s0, M0 = 6378.1366, w3 = M0 / L, g3 = M0 * s0, g2 = 6371, R3 = g2 + 88, x3 = 1738.1 / L, j = 1737.4, R2 = 1736, m3 = R2 / L, v3 = 34 / 60, St = 81.30056, a1 = .0002959122082855911, pt = 4912547451450812e-26, _t = 7243452486162703e-25, c1 = 8887692390113509e-25, At = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, J0 = 1.292024916781969e-8, $0 = 1.524358900784276e-8, D3 = 218869976542597e-26, z1 = c1 / St;
	function yt(t) {
		switch (t) {
	...
	var g0 = class st {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - _2.getTime()) / e, this.tt = v2(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(_2.getTime() + n * e), this.ut = n, this.tt = v2(this.ut);
				return;
			}
	...
	function R0(t) {
		if (!L1 || Math.abs(L1.tt - t.tt) > 1e-6) {
			const n = C3(t), e = D2(t), r = e + n.deps / 3600;
			L1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function x0(t) {
		...
		function r(T, C, V, J) {
			const Q = [];
			for (let I0 = 0; I0 <= C - T; ++I0) Q.push(e(V, J));
			return {
				min: T,
				array: Q
			};
		...
		function o(T, C, V) {
			const J = T.array[C - T.min];
			return J.array[V - J.min];
		}
		function s(T, C, V, J) {
			const Q = T.array[C - T.min];
			Q.array[V - Q.min] = J;
		}
		let i, a, c, u, h, l, d, _, M, A, E, g, R, w, m, x, z, I, k, N, B, G, Y, u0 = r(-6, 6, 1, 4), o0 = r(-6, 6, 1, 4);
		function A0(T, C) {
			return o(u0, T, C);
		}
		function D0(T, C) {
		...
		function rt(T, C, V, J, Q) {
			Q(T * V - C * J, C * V + T * J);
		}
		function U(T) {
			return Math.sin(n0 * T);
		}
		d = n * n, M = 0, Y = 0, E = 0, g = 3422.7;
		var f0 = U(.19833 + .05611 * n), Zt = U(.27869 + .04508 * n), t2 = U(.16827 - .36903 * n), n2 = U(.34734 - 5.37261 * n), e2 = U(.10498 - 5.37899 * n), ot = U(.42681 - .41855 * n), a4 = U(.14943 - 5.37511 * n);
		for (I = .84 * f0 + .31 * Zt + 14.27 * t2 + 7.26 * n2 + .28 * e2 + .24 * ot, k = 2.94 * f0 + .31 * Zt + 14.27 * t2 + 9.34 * n2 + 1.12 * e2 + .83 * ot, N = -6.4 * f0 - 1.89 * ot, B = .21 * f0 + .31 * Zt + 14.27 * t2 - 88.7 * n2 - 15.3 * e2 + .24 * ot - 1.86 * a4, G = I - N, _ = -3332e-9 * U(.59734 - 5.37261 * n) - 539e-9 * U(.35498 - 5.37899 * n) - 64e-9 * U(.39943 - 5.37511 * n), R = n0 * H0(.60643382 + 1336.85522467 * n - 313e-8 * d) + I / w0, w = n0 * H0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = n0 * H0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * H0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, z = n0 * H0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (l0(0, h, 1), l0(1, h, Math.cos(c) * u), h0(0, h, 0), h0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) rt(A0(l - 1, h), D0(l - 1, h), A0(1, h), D0(1, h), (T, C) => (l0(l, h, T), h0(l, h, C)));
		...
		function Hn(T, C, V, J) {
			for (var Q = {
				...
				V,
				J
			], y0 = 1; y0 <= 4; ++y0) I0[y0] !== 0 && rt(Q.x, Q.y, A0(I0[y0], y0), D0(I0[y0], y0), (r2, o1) => (Q.x = r2, Q.y = o1));
			return Q;
		}
		function S(T, C, V, J, Q, I0, y0, r2) {
			var o1 = Hn(Q, I0, y0, r2);
			M += T * o1.y, Y += C * o1.y, E += V * o1.x, g += J * o1.x;
		}
		...
		function d0(T, C, V, J, Q) {
			return T * Hn(C, V, J, Q).y;
		}
		A = 0, A += d0(-526.069, 0, 0, 1, -2), A += d0(-3.352, 0, 0, 1, -4), A += d0(44.297, 1, 0, 1, -2), A += d0(-6, 1, 0, 1, -4), A += d0(20.599, -1, 0, 1, 0), A += d0(-30.598, -1, 0, 1, -2), A += d0(-24.649, -2, 0, 1, 0), A += d0(-2, -2, 0, 1, -2), A += d0(-22.571, 0, 1, 1, -2), A += d0(10.985, 0, -1, 1, -2), M += .82 * U(.7736 - 62.5512 * n) + .31 * U(.0466 - 125.1025 * n) + .35 * U(.5785 - 25.1042 * n) + .66 * U(.4591 + 1335.8075 * n) + .64 * U(.313 - 91.568 * n) + 1.14 * U(.148 + 1331.2898 * n) + .21 * U(.5918 + 1056.5859 * n) + .44 * U(.5784 + 1322.8595 * n) + .24 * U(.2275 - 5.7374 * n) + .28 * U(.2965 + 2.6929 * n) + .33 * U(.3132 + 6.3368 * n), i = x + Y / w0;
		let c4 = (1.000002708 + 139.978 * _) * (18519.699999999997 + E) * Math.sin(i) - 6.24 * Math.sin(3 * i) + A;
		return {
			geo_eclip_lon: n0 * H0((R + M / w0) / n0),
			geo_eclip_lat: Math.PI / (180 * 3600) * c4,
			distance_au: w0 * w3 / (.999953253 * g)
		};
	}
	var z2 = class {
	...
	function C1(t, n) {
		...
		r *= k0, o *= k0, s *= k0, i *= k0;
		const a = Math.sin(r), c = Math.cos(r), u = Math.sin(-o), h = Math.cos(-o), l = Math.sin(-s), d = Math.cos(-s), _ = Math.sin(i), M = Math.cos(i), A = M * h - u * _ * d, E = M * u * c + _ * d * h * c - a * _ * l, g = M * u * a + _ * d * h * a + c * _ * l, R = -_ * h - u * M * d, w = -_ * u * c + M * d * h * c - a * M * l, m = -_ * u * a + M * d * h * a + c * M * l, x = u * l, z = -l * h * c - a * d, I = -l * h * a + d * c;
	...
	function V3(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = o > 0 ? 90 : -90, c = Math.abs(o) - g3;
		else {
			...
			for (;;) {
				...
				const A = (b0 - 1) * M0, E = h * h, g = l * l, R = E + b0 * g;
				d = Math.sqrt(R);
				const w = A * l * h / d - o * h + s * l;
				if (Math.abs(w) < 1e-8) break;
				const m = A * ((E - g) / d - g * E * (b0 - 1) / (A * R)) + o * l + s * h;
				u -= w / m;
			}
			a = b * u;
			const M = M0 / d;
	...
	function k1(t, n) {
		const e = R0(t), r = e.mobl * p, o = e.tobl * p, s = e.dpsi * k0, i = Math.cos(r), a = Math.sin(r), c = Math.cos(o), u = Math.sin(o), h = Math.cos(s), l = Math.sin(s), d = h, _ = -l * i, M = -l * a, A = l * c, E = h * i * c + a * u, g = h * a * c - i * u, R = l * u, w = h * i * u - a * c, m = h * a * u + i * c;
		if (n === O.From2000) return new $([
			[
				d,
				A,
	...
	function F1(t, n, e, r, o) {
		let s = y(t);
		K0(n), v(e), v(r);
		const i = Math.sin(n.latitude * p), a = Math.cos(n.latitude * p), c = Math.sin(n.longitude * p), u = Math.cos(n.longitude * p), h = Math.sin(r * p), l = Math.cos(r * p), d = Math.sin(e * dt), _ = Math.cos(e * dt);
		let M = [
			a * u,
			a * c,
			i
		...
		const g = -15 * S0(s);
		let R = q0(g, M), w = q0(g, A), m = q0(g, E), x = [
			l * _,
			l * d,
			h
		];
		...
		if (o) {
			let o0 = G, A0 = A1(o, 90 - G);
			if (G -= A0, A0 > 0 && G > 3e-4) {
				const D0 = Math.sin(G * p), l0 = Math.cos(G * p), h0 = Math.sin(o0 * p), rt = Math.cos(o0 * p), U = [];
				for (let f0 = 0; f0 < 3; ++f0) U.push((x[f0] - rt * R[f0]) / h0 * D0 + R[f0] * l0);
				N = Math.hypot(U[0], U[1]), N > 0 ? (Y = Mt * Math.atan2(U[1], U[0]), Y < 0 && (Y += 24)) : Y = 0, u0 = b * Math.atan2(U[2], N);
			}
		}
		return new O2(B, 90 - G, Y, u0);
	}
	function K0(t) {
	...
	function V2(t) {
		const n = y(t).AddDays(-1 / D1), e = j0(q.Earth, n), [r, o, s] = b1([
			-e.x,
			-e.y,
			-e.z
		], n, O.From2000), i = p * R0(n).tobl, a = Math.cos(i), c = Math.sin(i);
		return xt(new P(r, o, s, n), a, c);
	}
	function u1(t, n, e, r, o) {
		K0(e), T1(r), T1(o);
		const s = y(n), i = C2(s, e), a = e0(t, s, o), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
		return b2(r ? b1(c, s, O.From2000) : c, s);
	}
	function H3(t, n, e) {
		const r = y(t);
		let o = wt(n, S0(r)).pos;
	...
	function G3(t, n, e) {
		const r = y(t), o = wt(n, S0(r)), s = new F(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
		return e ? s : F3(s, r, O.Into2000);
	}
	function Q3(t, n) {
		const e = S0(t.t);
		let r = [
	...
	function xt(t, n, e) {
		...
		return new k2(new P(r, o, s, t.t), c, a);
	}
	function l1(t) {
	...
	function a0(t) {
		const n = y(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = G0(O3(n, [
	...
	function J1(t) {
		const n = y(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			r * Math.cos(e.geo_eclip_lon),
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = gt(Q0(I2(s.mobl, o), n, O.From2000), n), a = s.tobl * p, c = xt(i, Math.cos(a), Math.sin(a));
	...
	function j0(t, n) {
		const e = n.tt / Y0;
		return Pt(F2(z0(t[Dt], e, !0), z0(t[It], e, !1), z0(t[$1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / Y0, r = z0(t[Dt], e, !0), o = z0(t[It], e, !1), s = z0(t[$1], e, !1), i = vt(t[Dt], e), a = vt(t[It], e), c = vt(t[$1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, E = F2(r, o, s), g = [
			_ / Y0,
			M / Y0,
			A / Y0
		];
		return new N0(n, Pt(E), Pt(g));
	}
	function H1(t, n, e, r) {
	...
	function q3(t) {
		...
		return H1(n, t, f.Jupiter, V0), H1(n, t, f.Saturn, F0), H1(n, t, f.Uranus, J0), H1(n, t, f.Neptune, $0), n;
	}
	const zt = 51, K3 = 29200, W0 = 146, p0 = 201, T0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function Lt(t) {
		const n = Y3(t), e = new M1(n.tt), r = n.r.add(e.Sun.r), o = n.v.add(e.Sun.v), s = e.Acceleration(r);
		return new J2(e, new Tt(n.tt, r, o, s));
	}
	function W3(t, n) {
		const e = T0[0][0];
		if (n < e || n > T0[zt - 1][0]) return null;
		const r = $2((n - e) / K3, zt - 1);
		if (!t[r]) {
			const s = t[r] = [];
			s[0] = Lt(T0[r]).grav, s[p0 - 1] = Lt(T0[r + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < p0 - 1; ++i) s[i] = Ut(a += W0, s[i - 1]).grav;
			a = s[p0 - 1].tt;
			var o = [];
			for (o[p0 - 1] = s[p0 - 1], i = p0 - 2; i > 0; --i) o[i] = Ut(a -= W0, o[i + 1]).grav;
			for (i = p0 - 2; i > 0; --i) {
				const c = i / (p0 - 1);
	...
	function Ct(t, n) {
		...
		const s = W3(j3, t.tt);
		if (s) {
			const i = $2((t.tt - s[0].tt) / W0, p0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = X0(t.tt - a.tt, a.r, a.v, u), l = Nt(t.tt - a.tt, a.v, u), d = X0(t.tt - c.tt, c.r, c.v, u), _ = Nt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
			e = h.mul(1 - M).add(d.mul(M)), r = l.mul(1 - M).add(_.mul(M));
		} else {
			let i;
			t.tt < T0[0][0] ? i = H2(T0[0], t.tt, -W0) : i = H2(T0[zt - 1], t.tt, +W0), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
		return n && (o || (o = new M1(t.tt)), e = e.sub(o.Sun.r), r = r.sub(o.Sun.v)), new F(e.x, e.y, e.z, r.x, r.y, r.z, t);
	}
	const X3 = new $([
		[
			.999432765338654,
	...
	function Z3(t, n, e) {
		...
		const M = i * h - s * l, A = -s * h - i * l, E = 1 / (1 + A), g = 1 / (1 + Math.sqrt(1 - s * s - i * i)), R = r * (h - s - g * i * M), w = r * (l - i + g * s * M), m = u * E * r * (-l - g * i * A), x = u * E * r * (+h + g * s * A), z = 2 * Math.sqrt(1 - a * a - c * c), I = 1 - 2 * c * c, k = 1 - 2 * a * a, N = 2 * c * a;
	...
	function c0(t, n) {
		...
		if (t === f.EMB) {
			const i = j0(q.Earth, e), a = a0(e), c = 1 + St;
			return new P(i.x + a.x / c, i.y + a.y / c, i.z + a.z / c, e);
		}
		if (t === f.SSB) return q3(e);
		const s = U1(t);
		if (s) return K1(new B0(s.dec, 15 * s.ra, s.dist), e);
	...
	function U0(t, n) {
		...
		if (e) return e.dist;
		const r = y(n);
		return t in q ? z0(q[t][$1], r.tt / Y0, !1) : c0(t, r).Length();
	}
	function Q2(t, n) {
		let e = n, r = 0;
		for (let o = 0; o < 10; ++o) {
	...
	function B2(t, n, e, r) {
		...
		const i = new ne(n, e, r, s);
		return Q2((a) => i.Position(a), o);
	}
	function e0(t, n, e) {
		T1(e);
		const r = y(n);
	...
	function ee(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = f1(q[f.Earth], e.tt), s = t === f.Moon ? h1(e) : mt(e);
	...
	function B1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = f1(q.Earth, e.tt), s = t == f.Moon ? h1(e) : mt(e);
	...
	function H(t, n, e, r) {
		...
		for (;;) {
			...
			let d = L3(n, e, .5), _ = d.ut - n.ut;
			if (Math.abs(_) < s) return d;
			l ? c = t(d) : l = !0;
			let M = re(d.ut, e.ut - d.ut, i, c, a);
			if (M) {
				let A = y(M.t), E = t(A);
				if (M.df_dt !== 0) {
	...
	function se(t, n, e, r, o) {
		const s = l1(r), i = p * 28.06, a = p * (169.51 + 382e-7 * o.tt), c = p * s.elat, u = p * s.elon, h = Math.asin(Math.sin(c) * Math.cos(i) - Math.cos(c) * Math.sin(i) * Math.sin(u - a)), l = Math.sin(Math.abs(h));
		let d = -9 + .044 * t;
	...
	function ie(t, n, e) {
		let r = t * p, o = r * r, s = o * o, i = -12.717 + 1.49 * Math.abs(r) + .0431 * s, a = e / (385000.6 / L);
	...
	function q1(t, n) {
		...
		let o, s, i, a;
		t === f.Sun ? (i = new P(-r.x, -r.y, -r.z, e), s = new P(0, 0, 0, e), o = 0) : (t === f.Moon ? (i = a0(e), s = new P(r.x + i.x, r.y + i.y, r.z + i.z, e)) : (s = c0(t, n), i = new P(s.x - r.x, s.y - r.y, s.z - r.z, e)), o = N1(i, s));
		let c = i.Length(), u = s.Length(), h;
		if (t === f.Sun) a = y3 + 5 * Math.log10(c);
		else if (t === f.Moon) a = ie(o, u, c);
		else if (t === f.Saturn) {
			const l = se(o, u, c, i, e);
	...
	function p1(t, n, e) {
		...
		return H(r, s.AddDays(c), s.AddDays(u), { dt_tolerance_seconds: .1 });
	}
	var Y2 = class {
		constructor(t, n) {
	...
	function j2(t) {
		let n = kt(t), e = (Math.floor(n / 90) + 1) % 4, r = p1(90 * e, t, 10);
		if (!r) throw "Cannot find moon quarter";
		return new Y2(e, r);
	}
	function ae(t) {
		return j2(new Date(t.time.date.getTime() + 6 * E3));
	}
	var W2 = class {
		constructor(t, n, e) {
	...
	function ue(t) {
		switch (t) {
			...
			case f.Moon: return x3;
			default: return 0;
		}
	}
	function le(t, n, e, r, o, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = ue(t), a = X2(n.height - s);
		return Z2(t, n, e, r, o, i, ce(n, s) - v3 * a.density);
	}
	function he(t, n, e, r, o, s) {
	...
	function bt(t, n, e, r, o, s, i) {
		if (s < 0 && i >= 0) return new fe(r, o, s, i);
	...
	function Z2(t, n, e, r, o, s, i) {
		...
		const a = .42, c = de(t, n.latitude);
		function u(A) {
			const E = u1(t, A, n, !0, !0);
			return e * (F1(A, n, E.ra, E.dec).altitude + b * Math.asin(s / E.dist) - i);
		}
		const h = y(r);
		let l = h, d = h, _ = u(l), M = _;
		for (;;) {
			o < 0 ? (l = d.AddDays(-a), _ = u(l)) : (d = l.AddDays(+a), M = u(d));
			const A = bt(0, u, c, l, d, _, M);
			if (A) {
				const E = H(u, A.tx, A.ty, {
	...
	function Se(t, n, e) {
		const r = y(n), o = U2(r), s = u1(t, r, e, !0, !0);
	...
	function an(t, n) {
		if (n = y(n), t === f.Neptune || t === f.Pluto) return Ee(t, n);
		function e(c) {
	...
	function we(t, n) {
		...
		const e = .25 * i0[t].OrbitalPeriod, r = an(t, n.time.AddDays(e));
	...
	function xe(t, n) {
		const e = Ft(t);
		return e.lon = cn(e.lon), e.lat += A1(n, e.lat), e;
	}
	function me(t, n, e) {
		n = y(n);
		const r = cn(t.lon);
		return K1(new B0(t.lat + un(e, t.lat), r, t.dist), n);
	}
	function A1(t, n) {
		let e;
	...
	function j1(t) {
		return t = y(t), v0(C1(t, O.From2000), k1(t, O.From2000));
	}
	function De(t) {
		const n = y(t);
		return v0(j1(n), _n(n));
	...
	function W1(t) {
		return t = y(t), v0(k1(t, O.Into2000), C1(t, O.Into2000));
	}
	function Jt(t, n) {
		t = y(t);
	...
	function Ce(t, n) {
		...
		t %= 24, t < 0 && (t += 24), $t || ($t = j1(new g0(-45655.74141261017)), An = new g0(0));
		const e = K1(new B0(n, 15 * t, 1), An), r = Vt(y1($t, e)), o = 10 / 240, s = o / 15;
		for (let i of Le) {
	...
	function E1(t, n, e, r) {
		...
		return new Oe(n, o, L * Math.hypot(s, i, a), +i1 - (1 + o) * (i1 - t), -i1 + (1 + o) * (i1 + t), e, r);
	}
	function X1(t) {
		const n = e0(f.Sun, t, !0), e = new P(-n.x, -n.y, -n.z, n.t);
		return E1(R3, t, a0(t), e);
	}
	function wn(t) {
		const n = e0(f.Sun, t, !0), e = a0(t), r = new P(-e.x, -e.y, -e.z, e.t);
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, E1(j, t, r, e);
	}
	function Ht(t, n) {
		const e = C2(t, n), r = e0(f.Sun, t, !0), o = a0(t), s = new P(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
		return o.x -= r.x, o.y -= r.y, o.z -= r.z, E1(j, t, s, o);
	}
	function Z1(t, n, e) {
	...
	function be(t) {
		const e = H((r) => Gt(X1, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return X1(e);
	}
	function Ve(t) {
		const e = H((r) => Gt(wn, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Moon shadow time.";
		return wn(e);
	}
	function Fe(t, n, e) {
		const o = H((s) => ke(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function Je(t, n) {
		...
		const i = H((a) => Gt(s, a), r, o);
		if (!i) throw `PeakLocalMoonShadow: search failure for search_center_time = ${t}`;
		return Ht(i, n);
	}
	function Qt(t, n, e) {
		const r = e / 1440, o = t.AddDays(-r), s = t.AddDays(+r), i = H((c) => -(X1(c).r - n), o, t), a = H((c) => +(X1(c).r - n), t, s);
	...
	function Rn(t, n) {
		const e = new P(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = gn(Math.asin(w2 / e.Length()), Math.asin(m3 / n.Length()), N1(n, e) * p);
	...
	function xn(t) {
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				const i = be(o);
				if (i.r < i.p + j) {
					let a = X.Penumbral, c = 0, u = 0, h = 0, l = Qt(i.time, i.p + j, 200);
					return i.r < i.k + j && (a = X.Partial, h = Qt(i.time, i.k + j, l), i.r + j < i.k ? (a = X.Total, c = 1, u = Qt(i.time, i.k - j, h)) : c = gn(j, i.k, i.r)), new En(a, c, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function $e(t) {
		...
		const i = j1(t.time), a = y1(i, t.dir), c = y1(i, t.target);
		a.x *= L, a.y *= L, a.z *= L / s0, c.x *= L, c.y *= L, c.z *= L / s0;
		const u = M0, h = a.x * a.x + a.y * a.y + a.z * a.z, l = -2 * (a.x * c.x + a.y * c.y + a.z * c.z), d = c.x * c.x + c.y * c.y + c.z * c.z - u * u, _ = l * l - 4 * h * d;
		let M;
		if (_ > 0) {
			const A = (-l - Math.sqrt(_)) / (2 * h), E = A * a.x - c.x, g = A * a.y - c.y, R = (A * a.z - c.z) * s0, w = Math.hypot(E, g) * b0;
			w == 0 ? o = R > 0 ? 90 : -90 : o = b * Math.atan(R / w);
			const m = S0(e);
			s = (b * Math.atan2(g, E) - 15 * m) % 360, s <= -180 ? s += 360 : s > 180 && (s -= 360);
			const x = r1(i);
			let z = new P(E / L, g / L, R / L, t.time);
			z = y1(x, z), z.x += t.target.x, z.y += t.target.y, z.z += t.target.z;
			const I = E1(R2, t.time, z, t.dir);
			if (I.r > 1e-9 || I.r < 0) throw `Unexpected shadow distance from geoid intersection = ${I.r}`;
			n = vn(I.k), M = n === X.Total ? 1 : Rn(t.dir, z);
		} else M = void 0;
	...
	function qe(t, n) {
		return t = y(t), Un(t.AddDays(10), n);
	}
	var Ln = class {
		constructor(t, n, e, r) {
	...
	function On(t, n) {
		...
		for (;;) {
			...
			if (n1(t, i) < e) {
				const a = Fe(t, o, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-r), u = Cn(t, o, c, a.time, -1), h = a.time.AddDays(+r), l = Cn(t, o, a.time, h, 1), d = 60 * n1(t, a.time);
	...
	function Vn(t) {
		let n = y(t), e = J1(n);
		for (;;) {
			const r = n.AddDays(bn), o = J1(r);
			if (e.lat * o.lat <= 0) {
				const s = o.lat > e.lat ? _0.Ascending : _0.Descending, i = H((a) => s * J1(a).lat, n, r);
	...
	function Xe(t, n) {
		...
		switch (t) {
			...
			case f.Venus:
				...
				break;
			case f.Earth: return We(e);
			case f.Moon:
				const d = p * (125.045 - .0529921 * r), _ = p * (250.089 - .1059842 * r), M = p * (260.008 + 13.0120009 * r), A = p * (176.625 + 13.3407154 * r), E = p * (357.529 + .9856003 * r), g = p * (311.589 + 26.4057084 * r), R = p * (134.963 + 13.064993 * r), w = p * (276.617 + .3287146 * r), m = p * (34.226 + 1.7484877 * r), x = p * (15.134 - .1589763 * r), z = p * (119.743 + .0036096 * r), I = p * (239.961 + .1643573 * r), k = p * (25.053 + 12.9590088 * r);
			...
			case f.Mars:
				...
				break;
			case f.Jupiter:
				const N = p * (99.360714 + 4850.4046 * o), B = p * (175.895369 + 1191.9605 * o), G = p * (300.323162 + 262.5475 * o), Y = p * (114.012305 + 6070.2476 * o), u0 = p * (49.511251 + 64.3 * o);
				s = 268.056595 - .006499 * o + 117e-6 * Math.sin(N) + 938e-6 * Math.sin(B) + .001432 * Math.sin(G) + 3e-5 * Math.sin(Y) + .00215 * Math.sin(u0), i = 64.495303 + .002413 * o + 5e-5 * Math.cos(N) + 404e-6 * Math.cos(B) + 617e-6 * Math.cos(G) - 13e-6 * Math.cos(Y) + 926e-6 * Math.cos(u0), a = 284.95 + 870.536 * r;
				break;
			case f.Saturn:
	...
	function Ze(t, n, e, r) {
		const o = y(n), s = yt(e), i = yt(r);
		let a, c;
		return e === f.Earth && r === f.Moon ? (a = new F(0, 0, 0, 0, 0, 0, o), c = h1(o)) : (a = B1(e, o), c = B1(r, o)), Fn(t, a, s, c, i);
	}
	function Fn(t, n, e, r, o) {
		...
		let A;
		if (t === 4 || t === 5) {
			const E = c * M - u * _, g = u * d - a * M, R = a * _ - c * d;
			let w = g * u - R * c, m = R * a - E * u, x = E * c - g * a;
			const z = Math.sqrt(w * w + m * m + x * x);
			w /= z, m /= z, x /= z, a /= l, c /= l, u /= l;
			const I = t == 4 ? +i : -i, k = .5 * a + I * w, N = .5 * c + I * m, B = .5 * u + I * x, G = .5 * w - I * a, Y = .5 * m - I * c, u0 = .5 * x - I * u, o0 = l * k, A0 = l * N, D0 = l * B, l0 = d * a + _ * c + M * u, h0 = d * w + _ * m + M * x;
			A = new F(o0, A0, D0, l0 * k + h0 * G, l0 * N + h0 * Y, l0 * B + h0 * u0, n.t);
		} else {
			const E = -l * (o / (e + o)), g = +l * (e / (e + o)), R = (e + o) / (h * l);
			let w, m, x;
	...
	var t4 = class t0 {
		constructor(n, e, r) {
			...
			const s = [];
			this.curr = new Jn(o, t0.CalcSolarSystem(o), s);
		...
		Update(n) {
			...
			if (r === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = X0(r, a.r, a.v, u), c.v = Nt(r, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = W(r, n.tt, f.Mercury, pt), e[f.Venus] = W(r, n.tt, f.Venus, _t), e[f.Earth] = W(r, n.tt, f.Earth, c1 + z1), e[f.Mars] = W(r, n.tt, f.Mars, At), e[f.Jupiter] = W(r, n.tt, f.Jupiter, V0), e[f.Saturn] = W(r, n.tt, f.Saturn, F0), e[f.Uranus] = W(r, n.tt, f.Uranus, J0), e[f.Neptune] = W(r, n.tt, f.Neptune, $0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new N0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = K.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, _t), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + z1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, At), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, V0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, J0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, $0);
		}
	...
	const { MakeTime: E4, SearchRiseSet: w4, Body: g4, Observer: n4 } = nt(v1);
	new n4(40.7128, -74.006, 10);
	const { Body: r0 } = nt(v1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: v4, CombineRotation: D4, MakeRotation: I4 } = nt(v1);
	Math.PI / (180 * 3600);
	const { HelioState: z4 } = nt(v1), e4 = 86400;
	function r4(t) {
	...
	function $n(t, n) {
		...
		switch (e.type) {
			...
			case "seek": {
				...
				const r = e.jd;
				let o = r;
				(o < 1721545 || o > 3181545) && (console.warn(`[kernel/seek] JD ${o} outside supported range [${ut}, ${lt}] (years 0-4000 AD); clamping.`), o = Math.max(ut, Math.min(lt, o)));
				const s = {
					...t,
					jd: o
				}, i = [{
			...
			case "step": {
				...
				const o = t.jd + t.speed * r / e4, s = Math.max(ut, Math.min(lt, o)), i = {
					...t,
					jd: s
				}, a = [{
					type: "tick",
	...
	function i4(t) {
		...
		if (t.type === "time") {
			const { state: n, events: e } = $n(Z, t.cmd);
			Z = n, jt({
				type: "workerTick",
				state: Z,
				events: e
