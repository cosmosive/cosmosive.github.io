(function() {
	var Nn = Object.defineProperty, G2 = (t, n) => {
		let e = {};
		for (var r in t) Nn(e, r, {
			get: t[r],
			enumerable: !0
		});
		return n || Nn(e, Symbol.toStringTag, { value: "Module" }), e;
	};
	const Tn = Symbol("Comlink.proxy"), V2 = Symbol("Comlink.endpoint"), J2 = Symbol("Comlink.releaseProxy"), m1 = Symbol("Comlink.finalizer"), Nt = Symbol("Comlink.thrown"), Dn = (t) => typeof t == "object" && t !== null || typeof t == "function", Cn = /* @__PURE__ */ new Map([["proxy", {
		canHandle: (t) => Dn(t) && t[Tn],
		serialize(t) {
	...
	function E1(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function r(o) {
			...
			Promise.resolve(u).catch((l) => ({
				...
				const [h, d] = vt(l);
				n.postMessage(Object.assign(Object.assign({}, h), { id: s }), d), i === "RELEASE" && (n.removeEventListener("message", r), vn(n), m1 in t && typeof t[m1] == "function" && t[m1]());
			}).catch((l) => {
				const [h, d] = vt({
	...
	const Dt = /* @__PURE__ */ new WeakMap(), Ct = "FinalizationRegistry" in globalThis && new FinalizationRegistry((t) => {
		const n = (Dt.get(t) || 0) - 1;
		Dt.set(t, n), n === 0 && zn(t);
	});
	function q2(t, n) {
		const e = (Dt.get(n) || 0) + 1;
		Dt.set(n, e), Ct && Ct.register(t, n, t);
	}
	function Q2(t) {
		Ct && Ct.unregister(t);
	}
	function y1(t, n, e = [], r = function() {}) {
		let o = !1;
		const s = new Proxy(r, {
			get(i, c) {
				if (Tt(o), c === J2) return () => {
					Q2(s), zn(t), n.clear(), o = !0;
				};
				if (c === "then") {
			...
			apply(i, c, a) {
				...
				if (u === V2) return k0(t, n, { type: "ENDPOINT" }).then(D0);
				if (u === "bind") return y1(t, n, e.slice(0, -1));
				const [l, h] = bn(a);
				return k0(t, n, {
					type: "APPLY",
	...
	function bn(t) {
		const n = t.map(vt);
		return [n.map((e) => e[0]), X2(n.map((e) => e[1]))];
	}
	...
	function Z2(t) {
		return Object.assign(t, { [Tn]: !0 });
	}
	function vt(t) {
		for (const [n, e] of Cn) if (e.canHandle(t)) {
	...
	function D0(t) {
		switch (t.type) {
			case "HANDLER": return Cn.get(t.name).deserialize(t.value);
	...
	180 / Math.PI;
	const p1 = 86400, On = 365.25, Ln = 2451545, p0 = 299792.458, R1 = p0 * On * p1, F = 149597870.7, g1 = 648e3 / Math.PI, zt = g1 * F, x1 = zt / R1, kn = 23.4392911, er = 1e3, rr = p0, or = p0 ** Math.sqrt(Math.E), sr = p0 ** 2, ir = p0 ** Math.E, ar = [
		1,
		er,
		rr,
		or
	...
	var bt = (t, n, e) => Object.defineProperty(t, n, {
		value: e,
		enumerable: !1,
		writable: !0,
		configurable: !0
	}), cr = Symbol.for("bitecs-relation"), ur = Symbol.for("bitecs-pairTarget"), lr = Symbol.for("bitecs-isPairComponent"), hr = Symbol.for("bitecs-relationData"), Hn = () => {
		let t = {
			...
			if (!t.pairsMap.has(r)) {
				...
				bt(o, cr, n), bt(o, ur, r), bt(o, lr, !0), t.pairsMap.set(r, o);
			}
			return t.pairsMap.get(r);
		};
		return bt(n, hr, t), n;
	}, fr = Symbol.for("bitecs-wildcard");
	function dr() {
		let t = Hn();
	...
	function Mr() {
		...
		return globalThis[t] || (globalThis[t] = dr()), globalThis[t];
	}
	var Sr = Mr();
	function _r() {
		return Hn();
	...
	const K = {
		...
		BlackHole: "blackHole"
	}, Er = 1.7, yr = 4, pr = 10, Rr = 50, gr = 1500, xr = 500, Ir = 250;
	function N1(t) {
		return t != null && Number.isFinite(t) ? t : null;
	}
	function Yn(t) {
		return t == null ? K.Barren : t >= gr ? K.Molten : t >= xr ? K.Desert : t >= Ir ? K.Oceanic : K.Barren;
	}
	function wr(t) {
		const n = N1(t.radiusEarth), e = N1(t.massEarth), r = N1(t.eqTempK);
		return n != null ? n > yr ? K.GasGiant : n > Er ? K.IceGiant : Yn(r) : e != null ? e > Rr ? K.GasGiant : e > pr ? K.IceGiant : Yn(r) : K.Barren;
	}
	const Pr = 384399 / F, Nr = 421800 / F, Tr = 671034 / F, Dr = 1070400 / F, Cr = 1882700 / F, vr = 9376 / F, zr = 23463 / F, br = 185540 / F, Ur = 237948 / F, Or = 294619 / F, Lr = 377396 / F, kr = 527108 / F, Fr = 1221870 / F, Kr = 3560820 / F, Hr = 129390 / F, Br = 190900 / F, Gr = 266e3 / F, Vr = 436300 / F, Jr = 583520 / F, Yr = 354759 / F, $r = {
		[S.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	const T1 = Object.fromEntries(Object.entries($r).map(([t, n]) => [t, jr(n)]));
	function qr(t) {
		return T1[t]?.name ?? t;
	}
	function Qr(t) {
		return T1[t]?.type ?? "planet";
	}
	new TextEncoder();
	new TextDecoder();
	new TextEncoder();
	new TextDecoder("utf-8");
	const lt = 1e3, C0 = lt / F, F0 = C0 * R1 * x1, D1 = 695700, $n = 6378.137;
	function jn(t) {
	...
	function v1(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * F0;
	}
	function z1(t) {
	...
	function no(t, n) {
		const e = z1(t), r = z1(n), o = r.x - e.x, s = r.y - e.y, i = r.z - e.z;
	...
	function ao(t) {
		switch (te(t)) {
			case "local_system": return K0.local * ht + so(t.source, t.bodyType, t.rawId);
			case "exo_host_star": return K0.exoHost * ht + oo(Zn - t.exoCount, 0, Zn);
			case "dso": return K0.dso * ht + io(t.bodyType);
			case "proper_star": return K0.properStar * ht;
			default: return (t.source === "hyg" ? K0.otherStar : K0.leftover) * ht;
		}
	}
	const ft = (t) => t;
	function co(t, n) {
		const r = v1(Number.isFinite(t.distPc) && t.distPc > 0 ? t.distPc : 0);
		if (n) {
			const { raDeg: s, decDeg: i } = t;
			if (Number.isFinite(s) && Number.isFinite(i)) {
				const c = s * Math.PI / 180, a = i * Math.PI / 180, u = Math.cos(a);
				n.x = u * Math.cos(c) * r, n.y = u * Math.sin(c) * r, n.z = Math.sin(a) * r;
			} else n.x = 0, n.y = 0, n.z = r;
			return n;
		}
		const o = C1(t.raDeg, t.decDeg) ?? {
			x: 0,
			y: 0,
			z: 1
		};
	...
	function ne(t) {
		...
		return n != null && e != null && r != null && Number.isFinite(n) && Number.isFinite(e) && Number.isFinite(r) ? w1({
			x: n,
			y: e,
			z: r
		}) : qn(o) ?? 25;
	...
	function uo(t, n) {
		...
		const r = v1(ne(t)), { x: o, y: s, z: i, ra: c, dec: a } = t, u = o != null && s != null && i != null && Number.isFinite(o) && Number.isFinite(s) && Number.isFinite(i);
		let l = null;
		return u && (l = Kn({
			x: o,
			y: s,
			z: i
		})), l == null && (l = C1(c, a)), l == null ? ft({
			x: 0,
			y: 0,
			z: r
		}) : ft({
	...
	function lo(t, n) {
		if (b1(t)) return n.x = M0.x, n.y = M0.y, n.z = M0.z, n;
		const r = v1(ne(t)), { x: o, y: s, z: i, ra: c, dec: a } = t;
		if (o != null && s != null && i != null && Number.isFinite(o) && Number.isFinite(s) && Number.isFinite(i)) {
			const u = Math.sqrt(o * o + s * s + i * i);
			if (u >= 1e-18) return n.x = o / u * r, n.y = s / u * r, n.z = i / u * r, n;
		}
		if (Number.isFinite(c) && Number.isFinite(a)) {
			const u = c * Math.PI / 180, l = a * Math.PI / 180, h = Math.cos(l);
			return n.x = h * Math.cos(u) * r, n.y = h * Math.sin(u) * r, n.z = Math.sin(l) * r, n;
		}
		return n.x = 0, n.y = 0, n.z = r, n;
	}
	function ho(t, n, e, r, o) {
		...
		if (d <= 0) return o;
		const _ = s / h, M = i / h, m = c / h, g = a * _ + u * M + l * m, R = d / h;
		return o.x = (a - g * _) * R, o.y = (u - g * M) * R, o.z = (l - g * m) * R, o;
	}
	function U1(t) {
		return (t - Ln) / On;
	}
	...
	function ee(t, n, e) {
		return uo(t, e), ho(t, e.x, e.y, e.z, Ut), e.x += Ut.x * n, e.y += Ut.y * n, e.z += Ut.z * n, e;
	}
	const Ot = {
		x: 0,
		y: 0,
	...
	function Lt(t) {
		const n = Eo(t.objectScenePosition, t.viewpointScenePosition), e = oe(n);
		...
		const s = Math.acos(mo(o)), i = Xn(t.viewpointScenePosition, t.objectScenePosition), { source: c, rawId: a } = Jn(t.entityId), u = {
			source: c,
			bodyType: t.bodyType,
			rawId: a,
			isLocal: t.isLocal,
	...
	function po(t) {
		const n = Math.max(1, Math.floor(t.maxCount ?? _o)), e = oe(t.viewForward);
		if (!Number.isFinite(e) || e <= 0) return [];
		const r = {
			x: t.viewForward.x / e,
			y: t.viewForward.y / e,
			z: t.viewForward.z / e
		}, o = Number.isFinite(t.halfAngleRad) ? Math.max(0, t.halfAngleRad) : 0, s = Math.cos(o), i = t.activeSystem ?? So, c = i.originId != null ? Jn(i.originId).rawId : null, { exoCountByStarId: a } = t, u = [], l = i.kind === "sol";
		for (const p of t.solarCandidates) {
			const I = Lt({
				entityId: ut("hor", p.rawId),
				name: p.name,
				category: "solar",
				bodyType: Qr(p.rawId),
				isLocal: l,
		...
		const h = t.viewpointScenePosition, d = t.maxDistancePc != null && Number.isFinite(t.maxDistancePc) ? t.maxDistancePc : null, _ = (p) => {
			const I = p.x - h.x, T = p.y - h.y, w = p.z - h.z, C = Math.sqrt(I * I + T * T + w * w);
			return !(!Number.isFinite(C) || C <= 0 || !((I * r.x + T * r.y + w * r.z) / C >= s) || d != null && Xn(h, p) > d);
		};
		for (const p of t.deepSkyObjects) {
			const I = co(p);
			if (_(I)) {
				const T = ut("dso", p.catalogId), w = Lt({
					entityId: T,
					name: p.name,
					category: "dso",
					bodyType: p.type,
					isLocal: i.kind === "dso" && T === i.originId,
					exoCount: 0,
					hasProperName: !1,
					objectScenePosition: I,
					viewpointScenePosition: t.viewpointScenePosition,
					viewForward: r,
					cosHalfAngle: s
				});
		...
		const R = (p) => {
			if (m == null) return !0;
			const { x: I, y: T, z: w } = p;
			if (I == null || T == null || w == null) return !0;
			const C = I - m.x, k = T - m.y, G = w - m.z;
			return C * C + k * k + G * G <= g;
		}, E = {
			x: 0,
			y: 0,
			z: 0
		};
		for (const p of t.stars) if (R(p) && (ee(p, M, E), _(E))) {
			const I = ut("hyg", p.id), T = a?.get(String(p.id)) ?? 0, w = Lt({
				entityId: I,
				name: ro(p),
				category: Wn(p),
				bodyType: "star",
				isLocal: i.kind === "star" && I === i.originId,
				exoCount: T,
				hasProperName: Wn(p) === "proper_star",
		...
		const { maxDistancePc: P } = t, N = P != null && Number.isFinite(P) ? u.filter((p) => p.distancePc <= P) : u;
		return t.selection === "priority" ? [...N].sort(se).slice(0, n) : [...N].sort(yo).slice(0, n).sort(se);
	}
	kn * nr;
	var Ro = G2({
		AU_PER_LY: () => ie,
		...
		BaryState: () => Es,
		Body: () => f,
		CALLISTO_RADIUS_KM: () => To,
		C_AUDAY: () => kt,
		CalcMoonCount: () => Ee,
		CombineRotation: () => P0,
		Constellation: () => Ws,
		ConstellationInfo: () => c2,
		CorrectLightTravel: () => Ue,
		DEG2RAD: () => y,
		DefineStar: () => $o,
		DeltaT_EspenakMeeus: () => G1,
		DeltaT_JplHorizons: () => qo,
		EUROPA_RADIUS_KM: () => Po,
		EclipseEvent: () => A2,
		EclipseKind: () => t0,
		Ecliptic: () => St,
		EclipticCoordinates: () => Pe,
		EclipticGeoMoon: () => Wt,
		EclipticLongitude: () => L0,
		Elongation: () => $e,
		ElongationEvent: () => Ye,
		Equator: () => Mt,
		EquatorFromVector: () => cn,
		EquatorialCoordinates: () => Qt,
		GANYMEDE_RADIUS_KM: () => No,
		GeoEmbState: () => j1,
		GeoMoon: () => a0,
		GeoMoonState: () => _t,
		GeoVector: () => r0,
		...
		HelioVector: () => c0,
		Horizon: () => Xt,
		HorizonFromVector: () => Hs,
		HorizontalCoordinates: () => we,
		HourAngle: () => vs,
		HourAngleEvent: () => Ve,
		IO_RADIUS_KM: () => wo,
		IdentityMatrix: () => Fs,
		Illumination: () => s1,
		IlluminationInfo: () => ke,
		InverseRefraction: () => We,
		InverseRotation: () => st,
		JUPITER_EQUATORIAL_RADIUS_KM: () => go,
		JUPITER_MEAN_RADIUS_KM: () => Io,
		JUPITER_POLAR_RADIUS_KM: () => xo,
		JupiterMoons: () => As,
		JupiterMoonsInfo: () => be,
		KM_PER_AU: () => U,
		LagrangePoint: () => _3,
		LagrangePointFast: () => T2,
		Libration: () => ts,
		LibrationInfo: () => ye,
		LocalSolarEclipseInfo: () => m2,
		LunarEclipseInfo: () => u2,
		MakeRotation: () => ss,
		MakeTime: () => x,
		MassProduct: () => B1,
		MoonPhase: () => sn,
		MoonQuarter: () => Fe,
		NextGlobalSolarEclipse: () => a3,
		NextLocalSolarEclipse: () => l3,
		NextLunarApsis: () => Os,
		NextLunarEclipse: () => i3,
		NextMoonNode: () => d3,
		NextMoonQuarter: () => xs,
		...
		Search: () => $,
		SearchAltitude: () => Ns,
		SearchGlobalSolarEclipse: () => _2,
		SearchHourAngle: () => Cs,
		SearchLocalSolarEclipse: () => R2,
		SearchLunarApsis: () => je,
		SearchLunarEclipse: () => d2,
		SearchMaxElongation: () => bs,
		SearchMoonNode: () => N2,
		SearchMoonPhase: () => pt,
		SearchMoonQuarter: () => Ke,
		SearchPeakMagnitude: () => Us,
		SearchPlanetApsis: () => Qe,
		SearchRelativeLongitude: () => ot,
		SearchRiseSet: () => Ps,
		SearchSunLongitude: () => Le,
		SearchTransit: () => I2,
		SeasonInfo: () => Je,
		Seasons: () => zs,
		SetDeltaTFunction: () => Qo,
		SiderealTime: () => ge,
		SphereFromVector: () => un,
		Spherical: () => q0,
		StateVector: () => V,
		...
		TransitInfo: () => g2,
		Vector: () => v,
		VectorFromHorizon: () => Bs,
		VectorFromSphere: () => i1,
		VectorObserver: () => cs,
		e_tilt: () => x0
	});
	const kt = 173.1446326846693, U = 149597870.69098932, ie = 63241.07708807546, y = .017453292519943295, O1 = .26179938779914946, H = 57.29577951308232, L1 = 3.819718634205488, go = 71492, xo = 66854, Io = 69911, wo = 1821.6, Po = 1560.8, No = 2631.2, To = 2410.3, ae = 365.24217, ce = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), e0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), H0 = 484813681109536e-20, ue = 648e3, Do = 2 * ue, Co = 7292115e-11, vo = ue / Math.PI, zo = -.17 - 5 * Math.log10(vo), Ft = 29.530588, Kt = 86400, bo = Kt * 1e3, le = .9972695717592592, k1 = 695700, he = k1 / U, s0 = .996647180302104, Ht = s0 * s0, S0 = 6378.1366, Uo = S0 / U, Oo = S0 * s0, Lo = 6371, ko = 6459, Fo = 1738.1 / U, W = 1737.4, fe = 1736, Ko = fe / U, Ho = 34 / 60, Bo = 81.30056, dt = .0002959122082855911, F1 = 4912547451450812e-26, K1 = 7243452486162703e-25, de = 8887692390113509e-25, H1 = 9549535105779258e-26, B0 = 2.825345909524226e-7, G0 = 8.459715185680659e-8, V0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, Go = 218869976542597e-26, Vo = de / Bo;
	function B1(t) {
		switch (t) {
			case f.Sun: return dt;
			case f.Mercury: return F1;
			case f.Venus: return K1;
			case f.Earth: return de;
			case f.Moon: return Vo;
			case f.EMB: return 8997011346712498e-25;
			case f.Mars: return H1;
			case f.Jupiter: return B0;
			case f.Saturn: return G0;
			case f.Uranus: return V0;
			case f.Neptune: return J0;
			case f.Pluto: return Go;
	...
	function Me(t) {
		const n = Jo.indexOf(t);
		return n >= 0 ? Yo[n] : null;
	}
	function Vt(t) {
		const n = Me(t);
	...
	var g0 = class A1 {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - ce.getTime()) / e, this.tt = _e(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(ce.getTime() + n * e), this.ut = n, this.tt = _e(this.ut);
				return;
			}
	...
	function x0(t) {
		if (!Jt || Math.abs(Jt.tt - t.tt) > 1e-6) {
			const n = Wo(t), e = Ae(t), r = e + n.deps / 3600;
			Jt = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function I0(t) {
		...
		function r(z, O, B, J) {
			const j = [];
			for (let T0 = 0; T0 <= O - z; ++T0) j.push(e(B, J));
			return {
				min: z,
				array: j
			};
		...
		let i, c, a, u, l, h, d, _, M, m, g, R, E, P, N, p, I, T, w, C, k, G, X, u0 = r(-6, 6, 1, 4), o0 = r(-6, 6, 1, 4);
		function m0(z, O) {
			return o(u0, z, O);
		}
		function l0(z, O) {
		...
		function at(z, O, B, J, j) {
			j(z * B - O * J, O * B + z * J);
		}
		function b(z) {
			return Math.sin(e0 * z);
		}
		d = n * n, M = 0, X = 0, g = 0, R = 3422.7;
		var f0 = b(.19833 + .05611 * n), Rn = b(.27869 + .04508 * n), gn = b(.16827 - .36903 * n), xn = b(.34734 - 5.37261 * n), In = b(.10498 - 5.37899 * n), _1 = b(.42681 - .41855 * n), h4 = b(.14943 - 5.37511 * n);
		for (T = .84 * f0 + .31 * Rn + 14.27 * gn + 7.26 * xn + .28 * In + .24 * _1, w = 2.94 * f0 + .31 * Rn + 14.27 * gn + 9.34 * xn + 1.12 * In + .83 * _1, C = -6.4 * f0 - 1.89 * _1, k = .21 * f0 + .31 * Rn + 14.27 * gn - 88.7 * xn - 15.3 * In + .24 * _1 - 1.86 * h4, G = T - C, _ = -3332e-9 * b(.59734 - 5.37261 * n) - 539e-9 * b(.35498 - 5.37899 * n) - 64e-9 * b(.39943 - 5.37511 * n), E = e0 * Y0(.60643382 + 1336.85522467 * n - 313e-8 * d) + T / R0, P = e0 * Y0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + w / R0, N = e0 * Y0(.99312619 + 99.99735956 * n - 44e-8 * d) + C / R0, p = e0 * Y0(.25909118 + 1342.2278298 * n - 892e-8 * d) + k / R0, I = e0 * Y0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / R0, l = 1; l <= 4; ++l) {
			switch (l) {
				case 1:
					a = P, c = 4, u = 1.000002208;
					break;
				case 2:
			...
			for (h0(0, l, 1), h0(1, l, Math.cos(a) * u), N0(0, l, 0), N0(1, l, Math.sin(a) * u), h = 2; h <= c; ++h) at(m0(h - 1, l), l0(h - 1, l), m0(1, l), l0(1, l), (z, O) => (h0(h, l, z), N0(h, l, O)));
			for (h = 1; h <= c; ++h) h0(-h, l, m0(h, l)), N0(-h, l, -l0(h, l));
		}
		function H2(z, O, B, J) {
			for (var j = {
				x: 1,
				...
				B,
				J
			], E0 = 1; E0 <= 4; ++E0) T0[E0] !== 0 && at(j.x, j.y, m0(T0[E0], E0), l0(T0[E0], E0), (wn, ct) => (j.x = wn, j.y = ct));
			return j;
		}
		function A(z, O, B, J, j, T0, E0, wn) {
			var ct = H2(j, T0, E0, wn);
			M += z * ct.y, X += O * ct.y, g += B * ct.x, R += J * ct.x;
		}
		...
		function d0(z, O, B, J, j) {
			return z * H2(O, B, J, j).y;
		}
		m = 0, m += d0(-526.069, 0, 0, 1, -2), m += d0(-3.352, 0, 0, 1, -4), m += d0(44.297, 1, 0, 1, -2), m += d0(-6, 1, 0, 1, -4), m += d0(20.599, -1, 0, 1, 0), m += d0(-30.598, -1, 0, 1, -2), m += d0(-24.649, -2, 0, 1, 0), m += d0(-2, -2, 0, 1, -2), m += d0(-22.571, 0, 1, 1, -2), m += d0(10.985, 0, -1, 1, -2), M += .82 * b(.7736 - 62.5512 * n) + .31 * b(.0466 - 125.1025 * n) + .35 * b(.5785 - 25.1042 * n) + .66 * b(.4591 + 1335.8075 * n) + .64 * b(.313 - 91.568 * n) + 1.14 * b(.148 + 1331.2898 * n) + .21 * b(.5918 + 1056.5859 * n) + .44 * b(.5784 + 1322.8595 * n) + .24 * b(.2275 - 5.7374 * n) + .28 * b(.2965 + 2.6929 * n) + .33 * b(.3132 + 6.3368 * n), i = p + X / R0;
		let f4 = (1.000002708 + 139.978 * _) * (18518.511 + 1.189 + g) * Math.sin(i) - 6.24 * Math.sin(3 * i) + m;
		return {
			geo_eclip_lon: e0 * Y0((E + M / R0) / e0),
			geo_eclip_lat: Math.PI / 648e3 * f4,
			distance_au: R0 * Uo / (.999953253 * R)
		};
	}
	var ye = class {
	...
	function ts(t) {
		const n = x(t), e = n.tt / 36525, r = e * e, o = r * e, s = r * r, i = I0(n), c = i.geo_eclip_lon, a = i.geo_eclip_lat, u = i.distance_au * U, l = y * 1.543, h = y * et(93.272095 + 483202.0175233 * e - .0036539 * r - o / 3526e3 + s / 86331e4), d = y * et(125.0445479 - 1934.1362891 * e + .0020754 * r + o / 467441 - s / 60616e3), _ = y * et(357.5291092 + 35999.0502909 * e - 1536e-7 * r + o / 2449e4), M = y * et(134.9633964 + 477198.8675055 * e + .0087414 * r + o / 69699 - s / 14712e3), m = y * et(297.8501921 + 445267.1114034 * e - .0018819 * r + o / 545868 - s / 113065e3), g = 1 - .002516 * e - 74e-7 * r, R = c - d, E = Math.atan2(Math.sin(R) * Math.cos(a) * Math.cos(l) - Math.sin(a) * Math.sin(l), Math.cos(R) * Math.cos(a)), P = nt(H * (E - h)), N = Math.asin(-Math.sin(R) * Math.cos(a) * Math.sin(l) - Math.sin(a) * Math.cos(l)), p = y * (119.75 + 131.849 * e), I = y * (72.56 + 20.186 * e), T = -.02752 * Math.cos(M) + -.02245 * Math.sin(h) + .00684 * Math.cos(M - 2 * h) + -.00293 * Math.cos(2 * h) + -85e-5 * Math.cos(2 * h - 2 * m) + -54e-5 * Math.cos(M - 2 * m) + -2e-4 * Math.sin(M + h) + -2e-4 * Math.cos(M + 2 * h) + -2e-4 * Math.cos(M - h) + 14e-5 * Math.cos(M + 2 * h - 2 * m), w = -.02816 * Math.sin(M) + .02244 * Math.cos(h) + -.00682 * Math.sin(M - 2 * h) + -.00279 * Math.sin(2 * h) + -83e-5 * Math.sin(2 * h - 2 * m) + 69e-5 * Math.sin(M - 2 * m) + 4e-4 * Math.cos(M + h) + -25e-5 * Math.sin(2 * M) + -23e-5 * Math.sin(M + 2 * h) + 2e-4 * Math.cos(M - h) + 19e-5 * Math.sin(M - h) + 13e-5 * Math.sin(M + 2 * h - 2 * m) + -1e-4 * Math.cos(M - 3 * h), C = -(.0252 * g * Math.sin(_) + .00473 * Math.sin(2 * M - 2 * h) + -.00467 * Math.sin(M) + .00396 * Math.sin(p) + .00276 * Math.sin(2 * M - 2 * m) + .00196 * Math.sin(d) + -.00183 * Math.cos(M - h) + .00115 * Math.sin(M - 2 * m) + -96e-5 * Math.sin(M - m) + 46e-5 * Math.sin(2 * h - 2 * m) + -39e-5 * Math.sin(M - h) + -32e-5 * Math.sin(M - _ - m) + 27e-5 * Math.sin(2 * M - _ - 2 * m) + 23e-5 * Math.sin(I) + -14e-5 * Math.sin(2 * m) + 14e-5 * Math.cos(2 * M - 2 * h) + -12e-5 * Math.sin(M - 2 * h) + -12e-5 * Math.sin(2 * M) + 11e-5 * Math.sin(2 * M - 2 * _ - 2 * m)) + (T * Math.cos(E) + w * Math.sin(E)) * Math.tan(N), k = w * Math.cos(E) - T * Math.sin(E), G = 2 * H * Math.atan(W / Math.sqrt(u * u - W * W));
		return new ye(H * N + k, P + C, H * a, H * c, u, G);
	}
	function pe(t, n) {
		return [
	...
	function Yt(t, n) {
		...
		r *= H0, o *= H0, s *= H0, i *= H0;
		const c = Math.sin(r), a = Math.cos(r), u = Math.sin(-o), l = Math.cos(-o), h = Math.sin(-s), d = Math.cos(-s), _ = Math.sin(i), M = Math.cos(i), m = M * l - u * _ * d, g = M * u * a + _ * d * l * a - c * _ * h, R = M * u * c + _ * d * l * c + a * _ * h, E = -_ * l - u * M * d, P = -_ * u * a + M * d * l * a - c * M * h, N = -_ * u * c + M * d * l * c + a * M * h, p = u * h, I = -h * l * a - c * d, T = -h * l * c + d * a;
		if (n === L.Into2000) return new Y([
			[
				m,
				g,
				R
	...
	function es(t, n) {
		...
		let i, c, a;
		if (s < 1e-6) i = 0, c = o > 0 ? 90 : -90, a = Math.abs(o) - Oo;
		else {
			for (i = H * Math.atan2(r, e) - 15 * n; i <= -180;) i += 360;
			for (; i > 180;) i -= 360;
			let u = Math.atan2(o, s), l, h, d, _ = 0;
			for (;;) {
				if (++_ > 10) throw "inverse_terra failed to converge.";
				l = Math.cos(u), h = Math.sin(u);
				const m = -.006694397995865464 * S0, g = l * l, R = h * h, E = g + Ht * R;
				d = Math.sqrt(E);
				const P = m * h * l / d - o * l + s * h;
				if (Math.abs(P) < 1e-8) break;
				const N = m * ((g - R) / d - R * g * -.006694397995865464 / (m * E)) + o * h + s * l;
				u -= P / N;
			}
			c = H * u;
			const M = S0 / d;
			Math.abs(h) > Math.abs(l) ? a = o / h - Ht * M : a = s / l - M;
		}
		return new Y1(c, i, 1e3 * a);
	}
	function V1(t, n) {
		const e = t.latitude * y, r = Math.sin(e), o = Math.cos(e), s = 1 / Math.hypot(o, s0 * r), i = Ht * s, c = t.height / 1e3, a = S0 * s + c, u = S0 * i + c, l = (15 * n + t.longitude) * y, h = Math.sin(l), d = Math.cos(l);
		return {
			pos: [
				a * o * d / U,
				a * o * h / U,
	...
	function jt(t, n) {
		const e = x0(t), r = e.mobl * y, o = e.tobl * y, s = e.dpsi * H0, i = Math.cos(r), c = Math.sin(r), a = Math.cos(o), u = Math.sin(o), l = Math.cos(s), h = Math.sin(s), d = l, _ = -h * i, M = -h * c, m = h * a, g = l * i * a + c * u, R = l * c * a - i * u, E = h * u, P = l * i * u - c * a, N = l * c * u + i * a;
		if (n === L.From2000) return new Y([
			[
				d,
				m,
	...
	function qt(t, n, e) {
		return e === L.Into2000 ? $0(j0(t, n, e), n, e) : j0($0(t, n, e), n, e);
	}
	function rs(t, n, e) {
		return e === L.Into2000 ? Re(xe(t, n, e), n, e) : xe(Re(t, n, e), n, e);
	}
	function Ie(t, n) {
		const e = V1(n, _0(t)).pos;
	...
	function ss(t) {
		if (!os(t)) throw "Argument must be a [3][3] array of numbers";
		return new Y(t);
	}
	var we = class {
		constructor(t, n, e, r) {
	...
	function Ne(t, n) {
		const e = J1(t, n), r = e.x * e.x + e.y * e.y, o = Math.sqrt(r + e.z * e.z);
		if (r === 0) {
			if (e.z === 0) throw "Indeterminate sky coordinates";
			return new Qt(0, e.z < 0 ? -90 : 90, o, e);
		}
		let s = L1 * Math.atan2(e.y, e.x);
		s < 0 && (s += 24);
		const i = H * Math.atan2(t[2], Math.sqrt(r));
		return new Qt(s, i, o, e);
	}
	function Q0(t, n) {
		const e = t * y, r = Math.cos(e), o = Math.sin(e);
		return [
	...
	function Xt(t, n, e, r, o) {
		let s = x(t);
		X0(n), D(e), D(r);
		const i = Math.sin(n.latitude * y), c = Math.cos(n.latitude * y), a = Math.sin(n.longitude * y), u = Math.cos(n.longitude * y), l = Math.sin(r * y), h = Math.cos(r * y), d = Math.sin(e * O1), _ = Math.cos(e * O1);
		let M = [
			c * u,
			c * a,
			i
		...
		const R = -15 * _0(s);
		let E = Q0(R, M), P = Q0(R, m), N = Q0(R, g), p = [
			h * _,
			h * d,
			l
		];
		const I = p[0] * E[0] + p[1] * E[1] + p[2] * E[2], T = p[0] * P[0] + p[1] * P[1] + p[2] * P[2], w = p[0] * N[0] + p[1] * N[1] + p[2] * N[2];
		let C = Math.hypot(T, w), k;
		C > 0 ? (k = -57.29577951308232 * Math.atan2(w, T), k < 0 && (k += 360)) : k = 0;
		let G = H * Math.atan2(C, I), X = e, u0 = r;
		if (o) {
			let o0 = G, m0 = gt(o, 90 - G);
			if (G -= m0, m0 > 0 && G > 3e-4) {
				const l0 = Math.sin(G * y), h0 = Math.cos(G * y), N0 = Math.sin(o0 * y), at = Math.cos(o0 * y), b = [];
				for (let f0 = 0; f0 < 3; ++f0) b.push((p[f0] - at * E[f0]) / N0 * l0 + E[f0] * h0);
				C = Math.hypot(b[0], b[1]), C > 0 ? (X = L1 * Math.atan2(b[1], b[0]), X < 0 && (X += 24)) : X = 0, u0 = H * Math.atan2(b[2], C);
			}
		}
		return new we(k, 90 - G, X, u0);
	}
	function X0(t) {
		if (!(t instanceof Y1)) throw `Not an instance of the Observer class: ${t}`;
	...
	var Y1 = class {
		constructor(t, n, e) {
			this.latitude = t, this.longitude = n, this.height = e, X0(this);
		}
	};
	function Te(t) {
		const n = x(t).AddDays(-1 / kt), e = Z0(q.Earth, n), [r, o, s] = qt([
			-e.x,
			-e.y,
			-e.z
		], n, L.From2000), i = y * x0(n).tobl, c = Math.cos(i), a = Math.sin(i);
		return $1(new v(r, o, s, n), c, a);
	}
	function Mt(t, n, e, r, o) {
		X0(e), Bt(r), Bt(o);
		const s = x(n), i = Ie(s, e), c = r0(t, s, o), a = [
			c.x - i[0],
			c.y - i[1],
			c.z - i[2]
		];
		return Ne(r ? qt(a, s, L.From2000) : a, s);
	}
	function is(t, n, e) {
		const r = x(t);
		let o = V1(n, _0(r)).pos;
		return e || (o = qt(o, r, L.Into2000)), J1(o, r);
	}
	function as(t, n, e) {
		const r = x(t), o = V1(n, _0(r)), s = new V(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
		return e ? s : rs(s, r, L.Into2000);
	}
	function cs(t, n) {
		const e = _0(t.t);
		let r = [
		...
		return n || (r = $0(r, t.t, L.From2000), r = j0(r, t.t, L.From2000)), es(r, e);
	}
	function us(t, n) {
	...
	function $1(t, n, e) {
		...
		let c = 0;
		i > 0 && (c = H * Math.atan2(o, r), c < 0 && (c += 360));
		let a = H * Math.atan2(s, i);
		return new Pe(new v(r, o, s, t.t), a, c);
	}
	function St(t) {
		const n = x0(t.t), [e, r, o] = j0($0([
			t.x,
			t.y,
			t.z
		], t.t, L.From2000), t.t, L.From2000), s = new v(e, r, o, t.t), i = n.tobl * y;
		return $1(s, Math.cos(i), Math.sin(i));
	}
	function a0(t) {
		const n = x(t), e = I0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = $0(Zo(n, [
	...
	function Wt(t) {
		const n = x(t), e = I0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			r * Math.cos(e.geo_eclip_lon),
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = x0(n), i = J1(j0(me(s.mobl, o), n, L.From2000), n), c = s.tobl * y, a = $1(i, Math.cos(c), Math.sin(c));
		return new q0(a.elat, a.elon, e.distance_au);
	}
	function _t(t) {
		const n = x(t), e = 1e-5, r = n.AddDays(-1e-5), o = n.AddDays(1e-5), s = a0(r), i = a0(o);
		return new V((s.x + i.x) / 2, (s.y + i.y) / 2, (s.z + i.z) / 2, (i.x - s.x) / (2 * e), (i.y - s.y) / (2 * e), (i.z - s.z) / (2 * e), n);
	}
	function j1(t) {
		const n = x(t), e = _t(n), r = 82.30056;
	...
	const W0 = 365250, Q1 = 0, X1 = 1, Zt = 2;
	function W1(t) {
	...
	function Z0(t, n) {
		const e = n.tt / W0;
		return W1(De(v0(t[Q1], e, !0), v0(t[X1], e, !1), v0(t[Zt], e, !1))).ToAstroVector(n);
	}
	function At(t, n) {
		const e = n / W0, r = v0(t[Q1], e, !0), o = v0(t[X1], e, !1), s = v0(t[Zt], e, !1), i = q1(t[Q1], e), c = q1(t[X1], e), a = q1(t[Zt], e), u = Math.cos(r), l = Math.sin(r), h = Math.cos(o), d = Math.sin(o), _ = +(a * h * u) - s * d * u * c - s * h * l * i, M = +(a * h * l) - s * d * l * c + s * h * u * i, m = +(a * d) + s * h * c, g = De(r, o, s), R = [
			_ / W0,
			M / W0,
			m / W0
		];
		return new b0(n, W1(g), W1(R));
	}
	function t1(t, n, e, r) {
		const o = r / (r + dt), s = Z0(q[e], n);
		t.x += o * s.x, t.y += o * s.y, t.z += o * s.z;
	}
	function ls(t) {
		const n = new v(0, 0, 0, t);
		return t1(n, t, f.Jupiter, B0), t1(n, t, f.Saturn, G0), t1(n, t, f.Uranus, V0), t1(n, t, f.Neptune, J0), n;
	}
	const hs = 29200, n1 = 146, z0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var Q = class y0 {
		...
		clone() {
			return new Pn(this.tt, this.r, this.v);
		}
		sub(n) {
			return new Pn(this.tt, this.r.sub(n.r), this.v.sub(n.v));
		}
	};
	function fs(t) {
		let [n, [e, r, o], [s, i, c]] = t;
		return new b0(n, new Q(e, r, o), new Q(s, i, c));
	}
	function Z(t, n, e, r) {
		const o = r / (r + dt), s = At(q[e], n);
	...
	var Et = class {
		constructor(t) {
			let n = new b0(t, new Q(0, 0, 0), new Q(0, 0, 0));
			this.Jupiter = Z(n, t, f.Jupiter, B0), this.Saturn = Z(n, t, f.Saturn, G0), this.Uranus = Z(n, t, f.Uranus, V0), this.Neptune = Z(n, t, f.Neptune, J0), this.Jupiter.r.decr(n.r), this.Jupiter.v.decr(n.v), this.Saturn.r.decr(n.r), this.Saturn.v.decr(n.v), this.Uranus.r.decr(n.r), this.Uranus.v.decr(n.v), this.Neptune.r.decr(n.r), this.Neptune.v.decr(n.v), this.Sun = new b0(t, n.r.mul(-1), n.v.mul(-1));
		}
		Acceleration(t) {
			let n = mt(t, dt, this.Sun.r);
			return n.incr(mt(t, B0, this.Jupiter.r)), n.incr(mt(t, G0, this.Saturn.r)), n.incr(mt(t, V0, this.Uranus.r)), n.incr(mt(t, J0, this.Neptune.r)), n;
		}
	}, Z1 = class B2 {
		constructor(n, e, r, o) {
		...
		clone() {
			return new B2(this.tt, this.r.clone(), this.v.clone(), this.a.clone());
		}
	}, Ce = class {
		constructor(t, n) {
	...
	function nn(t, n) {
		const e = t - n.tt, r = new Et(t), o = tt(e, n.r, n.v, n.a), s = r.Acceleration(o).mean(n.a), i = tt(e, n.r, n.v, s);
		return new Ce(r, new Z1(t, i, n.v.add(s.mul(e)), r.Acceleration(i)));
	}
	const ds = [];
	function ve(t, n) {
	...
	function en(t) {
		const n = fs(t), e = new Et(n.tt), r = n.r.add(e.Sun.r), o = n.v.add(e.Sun.v), s = e.Acceleration(r);
		return new Ce(e, new Z1(n.tt, r, o, s));
	}
	function Ms(t, n) {
		const e = z0[0][0];
		if (n < e || n > z0[50][0]) return null;
		const r = ve((n - e) / hs, 50);
		if (!t[r]) {
			const s = t[r] = [];
			s[0] = en(z0[r]).grav, s[200] = en(z0[r + 1]).grav;
			let i, c = s[0].tt;
			for (i = 1; i < 200; ++i) s[i] = nn(c += n1, s[i - 1]).grav;
			c = s[200].tt;
			var o = [];
			for (o[200] = s[200], i = 199; i > 0; --i) o[i] = nn(c -= n1, o[i + 1]).grav;
			for (i = 199; i > 0; --i) {
				const a = i / 200;
	...
	function ze(t, n, e) {
		...
		for (let s = 0; s < o; ++s) r = nn(s + 1 === o ? n : r.grav.tt + e, r.grav);
		return r;
	}
	function rn(t, n) {
		let e, r, o;
		const s = Ms(ds, t.tt);
		if (s) {
			const i = ve((t.tt - s[0].tt) / n1, 200), c = s[i], a = s[i + 1], u = c.a.mean(a.a), l = tt(t.tt - c.tt, c.r, c.v, u), h = tn(t.tt - c.tt, c.v, u), d = tt(t.tt - a.tt, a.r, a.v, u), _ = tn(t.tt - a.tt, a.v, u), M = (t.tt - c.tt) / n1;
			e = l.mul(1 - M).add(d.mul(M)), r = h.mul(1 - M).add(_.mul(M));
		} else {
			let i;
			t.tt < z0[0][0] ? i = ze(z0[0], t.tt, -146) : i = ze(z0[50], t.tt, 146), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
	...
	function _s(t, n, e) {
		...
		const M = i * l - s * h, m = -s * l - i * h, g = 1 / (1 + m), R = 1 / (1 + Math.sqrt(1 - s * s - i * i)), E = r * (l - s - R * i * M), P = r * (h - i + R * s * M), N = u * g * r * (-h - R * i * m), p = u * g * r * (+l + R * s * m), I = 2 * Math.sqrt(1 - c * c - a * a), T = 1 - 2 * a * a, w = 1 - 2 * c * c, C = 2 * a * c;
		return new V(E * T + P * C, E * C + P * w, (c * P - E * a) * I, N * T + p * C, N * C + p * w, (c * p - N * a) * I, t);
	}
	function r1(t, n) {
	...
	function As(t) {
		const n = new g0(t);
		return new be(r1(n, e1[0]), r1(n, e1[1]), r1(n, e1[2]), r1(n, e1[3]));
	}
	function c0(t, n) {
		var e = x(n);
		...
		if (t === f.Pluto) {
			const i = rn(e, !0);
			return new v(i.x, i.y, i.z, e);
		}
		if (t === f.Sun) return new v(0, 0, 0, e);
		if (t === f.Moon) {
			var r = Z0(q.Earth, e), o = a0(e);
			return new v(r.x + o.x, r.y + o.y, r.z + o.z, e);
		}
		if (t === f.EMB) {
			const i = Z0(q.Earth, e), c = a0(e), a = 82.30056;
			return new v(i.x + c.x / a, i.y + c.y / a, i.z + c.z / a, e);
		}
		if (t === f.SSB) return ls(e);
		const s = Vt(t);
		if (s) return i1(new q0(s.dec, 15 * s.ra, s.dist), e);
	...
	function U0(t, n) {
		...
		if (e) return e.dist;
		const r = x(n);
		return t in q ? v0(q[t][Zt], r.tt / W0, !1) : c0(t, r).Length();
	}
	function Ue(t, n) {
		let e = n, r = 0;
		for (let o = 0; o < 10; ++o) {
	...
	function Oe(t, n, e, r) {
		...
		if (Vt(e)) {
			const c = c0(e, o);
			if (r) {
				const u = o1(n, o), l = new v(c.x - u.x, c.y - u.y, c.z - u.z, o), h = kt / l.Length();
				return new v(l.x + u.vx / h, l.y + u.vy / h, l.z + u.vz / h, o);
			}
			const a = c0(n, o);
			return new v(c.x - a.x, c.y - a.y, c.z - a.z, o);
		}
		let s;
		r ? s = new v(0, 0, 0, o) : s = c0(n, o);
		const i = new ms(n, e, r, s);
		return Ue((c) => i.Position(c), o);
	}
	function r0(t, n, e) {
		Bt(e);
		const r = x(n);
	...
	function Es(t, n) {
		...
		if (t === f.Pluto) return rn(e, !1);
		const r = new Et(e.tt);
		switch (t) {
			case f.Sun: return O0(r.Sun, e);
			case f.Jupiter: return O0(r.Jupiter, e);
			case f.Saturn: return O0(r.Saturn, e);
			case f.Uranus: return O0(r.Uranus, e);
			case f.Neptune: return O0(r.Neptune, e);
			case f.Moon:
			case f.EMB:
				const o = At(q[f.Earth], e.tt), s = t === f.Moon ? _t(e) : j1(e);
	...
	function o1(t, n) {
		...
		switch (t) {
			...
			case f.Saturn:
			case f.Uranus:
			case f.Neptune: return O0(At(q[t], e.tt), e);
			case f.Pluto: return rn(e, !0);
			case f.Moon:
			case f.EMB:
				const o = At(q.Earth, e.tt), s = t == f.Moon ? _t(e) : j1(e);
	...
	function $(t, n, e, r) {
		const o = D(r && r.dt_tolerance_seconds || 1), s = Math.abs(o / Kt);
		let i = r && r.init_f1 || t(n), c = r && r.init_f2 || t(e), a = NaN, u = 0, l = r && r.iter_limit || 20, h = !0;
		for (;;) {
			if (++u > l) throw "Excessive iteration in Search()";
			let d = Xo(n, e, .5), _ = d.ut - n.ut;
			if (Math.abs(_) < s) return d;
			h ? a = t(d) : h = !0;
			let M = ys(d.ut, e.ut - d.ut, i, a, c);
			if (M) {
				let m = x(M.t), g = t(m);
				if (M.df_dt !== 0) {
					if (Math.abs(g / M.df_dt) < s) return m;
					let R = 1.2 * Math.abs(g / M.df_dt);
					if (R < _ / 10) {
						let E = m.AddDays(-R), P = m.AddDays(+R);
						if ((E.ut - n.ut) * (E.ut - e.ut) < 0 && (P.ut - n.ut) * (P.ut - e.ut) < 0) {
							let N = t(E), p = t(P);
							if (N < 0 && p >= 0) {
								i = N, c = p, n = E, e = P, a = g, h = !1;
								continue;
							}
						}
					}
	...
	function Rs(t, n, e, r, o) {
		const s = St(r), i = y * 28.06, c = y * (169.51 + 382e-7 * o.tt), a = y * s.elat, u = y * s.elon, l = Math.asin(Math.sin(a) * Math.cos(i) - Math.cos(a) * Math.sin(i) * Math.sin(u - c)), h = Math.sin(Math.abs(l));
		let d = -9 + .044 * t;
	...
	function s1(t, n) {
		...
		const e = x(n), r = Z0(q.Earth, e);
		let o, s, i, c;
		t === f.Sun ? (i = new v(-r.x, -r.y, -r.z, e), s = new v(0, 0, 0, e), o = 0) : (t === f.Moon ? (i = a0(e), s = new v(r.x + i.x, r.y + i.y, r.z + i.z, e)) : (s = c0(t, n), i = new v(s.x - r.x, s.y - r.y, s.z - r.z, e)), o = Gt(i, s));
		let a = i.Length(), u = s.Length(), l;
		if (t === f.Sun) c = zo + 5 * Math.log10(a);
		else if (t === f.Moon) c = gs(o, u, a);
		else if (t === f.Saturn) {
			const h = Rs(o, u, a, i, e);
	...
	function ot(t, n, e) {
		...
		function s(u) {
			const l = L0(t, u), h = L0(f.Earth, u);
			return nt(o * (h - l) - n);
		}
		let i = yt(t), c = x(e), a = s(c);
		a > 0 && (a -= 360);
		for (let u = 0; u < 100; ++u) {
			let l = -a / 360 * i;
			if (c = c.AddDays(l), Math.abs(l) * Kt < 1) return c;
			let h = a;
	...
	function pt(t, n, e) {
		...
		let i = r(s), c, a, u;
		if (e < 0) {
			if (i < 0 && (i += 360), c = -(Ft * i) / 360, u = c + o, u < e) return null;
			a = Math.max(e, c - o);
		} else {
			if (i > 0 && (i -= 360), c = -(Ft * i) / 360, a = c - o, a > e) return null;
			u = Math.min(e, c + o);
		}
		return $(r, s.AddDays(a), s.AddDays(u), { dt_tolerance_seconds: .1 });
	}
	var Fe = class {
		constructor(t, n) {
	...
	function Ke(t) {
		let n = sn(t), e = (Math.floor(n / 90) + 1) % 4, r = pt(90 * e, t, 10);
		if (!r) throw "Cannot find moon quarter";
		return new Fe(e, r);
	}
	function xs(t) {
		return Ke(new Date(t.time.date.getTime() + 6 * bo));
	}
	var He = class {
		constructor(t, n, e) {
	...
	function ws(t) {
		switch (t) {
			case f.Sun: return he;
			case f.Moon: return Fo;
			default: return 0;
		}
	}
	function Ps(t, n, e, r, o, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = ws(t), c = Be(n.height - s);
		return Ge(t, n, e, r, o, i, Is(n, s) - Ho * c.density);
	}
	function Ns(t, n, e, r, o, s) {
		if (!Number.isFinite(s) || s < -90 || s > 90) throw `Invalid altitude angle: ${s}`;
		return Ge(t, n, e, r, o, 0, s);
	}
	var Ts = class {
		constructor(t, n, e, r) {
	...
	function an(t, n, e, r, o, s, i) {
		if (s < 0 && i >= 0) return new Ts(r, o, s, i);
		if (s >= 0 && i < 0) return null;
		if (t > 17) throw "Excessive recursion in rise/set ascent search.";
		const c = o.ut - r.ut;
		if (c * Kt < 1 || Math.min(Math.abs(s), Math.abs(i)) > e * (c / 2)) return null;
		const a = new g0((r.ut + o.ut) / 2), u = n(a);
		return an(1 + t, n, e, r, a, s, u) || an(1 + t, n, e, a, o, u, i);
	}
	function Ds(t, n) {
		...
		const o = y * n;
		return Math.abs((360 / le - e) * Math.cos(o)) + Math.abs(r * Math.sin(o));
	}
	function Ge(t, n, e, r, o, s, i) {
		if (X0(n), D(o), D(s), D(i), i < -90 || i > 90) throw `Invalid target altitude angle: ${i}`;
		const c = Ds(t, n.latitude);
		function a(M) {
			const m = Mt(t, M, n, !0, !0);
			return e * (Xt(M, n, m.ra, m.dec).altitude + H * Math.asin(s / m.dist) - i);
		}
		const u = x(r);
		let l = u, h = u, d = a(l), _ = d;
		for (;;) {
			o < 0 ? (l = h.AddDays(-.42), d = a(l)) : (h = l.AddDays(.42), _ = a(h));
			const M = an(0, a, c, l, h, d, _);
			if (M) {
				const m = $(a, M.tx, M.ty, {
	...
	function Cs(t, n, e, r, o = 1) {
		...
		for (;;) {
			++i;
			let c = _0(s), a = Mt(t, s, n, !0, !0), u = (e + a.ra - n.longitude / 15 - c) % 24;
			if (i === 1 ? o > 0 ? u < 0 && (u += 24) : u > 0 && (u -= 24) : u < -12 ? u += 24 : u > 12 && (u -= 24), Math.abs(u) * 3600 < .1) {
				const h = Xt(s, n, a.ra, a.dec, "normal");
				return new Ve(s, h);
			}
			let l = u / 24 * le;
			s = s.AddDays(l);
	...
	function vs(t, n, e) {
		const r = x(n), o = ge(r), s = Mt(t, r, e, !0, !0);
	...
	function zs(t) {
		function n(i, c, a) {
			let u = new Date(Date.UTC(t, c - 1, a)), l = Le(i, u, 20);
		...
		return new Je(n(0, 3, 10), n(90, 6, 10), n(180, 9, 10), n(270, 12, 10));
	}
	var Ye = class {
		constructor(t, n, e, r) {
	...
	function bs(t, n) {
		...
		let i = 0;
		for (; ++i <= 2;) {
			let c = nt(L0(t, o) - L0(f.Earth, o)), a, u, l;
			c >= -s.s1 && c < +s.s1 ? (l = 0, a = +s.s1, u = +s.s2) : c >= +s.s2 || c < -s.s2 ? (l = 0, a = -s.s2, u = -s.s1) : c >= 0 ? (l = -yt(t) / 4, a = +s.s1, u = +s.s2) : (l = -yt(t) / 4, a = -s.s2, u = -s.s1);
			let h = o.AddDays(l), d = ot(t, a, h), _ = ot(t, u, d), M = r(d);
			...
			if (!g) throw `SearchMaxElongation: failed search iter ${i} (t1=${d.toString()}, t2=${_.toString()})`;
			if (g.tt >= o.tt) return $e(t, g);
			o = _.AddDays(1);
		}
	...
	function Us(t, n) {
		...
		const e = .01;
		function r(i) {
			const c = i.AddDays(-.005), a = i.AddDays(.01 / 2), u = s1(t, c).mag;
			return (s1(t, a).mag - u) / e;
		}
		let o = x(n), s = 0;
		for (; ++s <= 2;) {
			let i = nt(L0(t, o) - L0(f.Earth, o)), c, a, u;
			i >= -10 && i < 10 ? (u = 0, c = 10, a = 30) : i >= 30 || i < -30 ? (u = 0, c = -30, a = -10) : i >= 0 ? (u = -yt(t) / 4, c = 10, a = 30) : (u = -yt(t) / 4, c = -30, a = -10);
			let l = o.AddDays(u), h = ot(t, c, l), d = ot(t, a, h), _ = r(h);
	...
	function je(t) {
		function e(a) {
			let u = a.AddDays(-5e-4), l = a.AddDays(.001 / 2), h = I0(u).distance_au;
			return (I0(l).distance_au - h) / .001;
		}
		function r(a) {
			return -e(a);
		}
	...
	function qe(t, n, e, r) {
		...
		for (;;) {
			...
			if (i < 1 / 1440) {
				...
				return new Rt(u, n, U0(t, u));
			}
			let c = -1, a = 0;
			for (let u = 0; u < s; ++u) {
				const l = o * U0(t, e.AddDays(u * i));
				(u == 0 || l > a) && (c = u, a = l);
			}
	...
	function Ls(t, n) {
		...
		const l = qe(t, 0, s.AddDays(-2 * u), 4 * u), h = qe(t, 1, i.AddDays(-2 * u), 4 * u);
	...
	function Qe(t, n) {
		if (n = x(n), t === f.Neptune || t === f.Pluto) return Ls(t, n);
		function e(a) {
		...
		for (let a = 0; a * s < 2 * o; ++a) {
			...
			if (c * l <= 0) {
				let h, d;
				if (c < 0 || l > 0) h = e, d = w0.Pericenter;
				else if (c > 0 || l < 0) h = r, d = w0.Apocenter;
	...
	function ks(t, n) {
		...
		const e = .25 * i0[t].OrbitalPeriod, r = Qe(t, n.time.AddDays(e));
	...
	function Ks(t, n, e) {
		...
		return u[i][i] = o * t.rot[i][i] - s * t.rot[i][c], u[i][c] = s * t.rot[i][i] + o * t.rot[i][c], u[i][a] = t.rot[i][a], u[c][i] = o * t.rot[c][i] - s * t.rot[c][c], u[c][c] = s * t.rot[c][i] + o * t.rot[c][c], u[c][a] = t.rot[c][a], u[a][i] = o * t.rot[a][i] - s * t.rot[a][c], u[a][c] = s * t.rot[a][i] + o * t.rot[a][c], u[a][a] = t.rot[a][a], new Y(u);
	}
	function i1(t, n) {
		n = x(n);
	...
	function cn(t) {
		const n = un(t);
		return new Qt(n.lon / 15, n.lat, n.dist, t);
	}
	function un(t) {
	...
	function Hs(t, n) {
		const e = un(t);
		return e.lon = Xe(e.lon), e.lat += gt(n, e.lat), e;
	}
	function Bs(t, n, e) {
		n = x(n);
		const r = Xe(t.lon);
		return i1(new q0(t.lat + We(e, t.lat), r, t.dist), n);
	}
	function gt(t, n) {
		let e;
	...
	function c1(t) {
		return t = x(t), P0(Yt(t, L.From2000), jt(t, L.From2000));
	}
	function Vs(t) {
		const n = x(t);
		return P0(c1(n), i2(n));
	...
	function u1(t) {
		return t = x(t), P0(jt(t, L.Into2000), Yt(t, L.Into2000));
	}
	function ln(t, n) {
		t = x(t);
		const e = Math.sin(n.latitude * y), r = Math.cos(n.latitude * y), o = Math.sin(n.longitude * y), s = Math.cos(n.longitude * y), i = [
			...
			-s,
			0
		], u = -15 * _0(t), l = Q0(u, i), h = Q0(u, c), d = Q0(u, a);
		return new Y([
			[
				h[0],
				d[0],
	...
	function s2(t) {
		const n = x0(x(t)).tobl * y, e = Math.cos(n), r = Math.sin(n);
		return new Y([
			[
				1,
				0,
	...
	function Ws(t, n) {
		...
		t %= 24, t < 0 && (t += 24), hn || (hn = c1(new g0(-45655.74141261017)), a2 = new g0(0));
		const e = i1(new q0(n, 15 * t, 1), a2), r = cn(xt(hn, e)), o = 10 / 240, s = o / 15;
		for (let i of Xs) {
			const c = i[3] * o, a = i[1] * s, u = i[2] * s;
			if (c <= r.dec && a <= r.ra && r.ra < u) {
				const l = Qs[i[0]];
				return new c2(l[0], l[1], r.ra, r.dec);
			}
		}
	...
	function It(t, n, e, r) {
		...
		return new Zs(n, o, U * Math.hypot(s, i, c), 695700 - (1 + o) * (k1 - t), -695700 + (1 + o) * (k1 + t), e, r);
	}
	function l1(t) {
		const n = r0(f.Sun, t, !0), e = new v(-n.x, -n.y, -n.z, n.t), r = a0(t);
		return It(ko, t, r, e);
	}
	function l2(t) {
		const n = r0(f.Sun, t, !0), e = a0(t), r = new v(-e.x, -e.y, -e.z, e.t);
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, It(W, t, r, e);
	}
	function fn(t, n) {
		const e = Ie(t, n), r = r0(f.Sun, t, !0), o = a0(t), s = new v(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
		return o.x -= r.x, o.y -= r.y, o.z -= r.z, It(W, t, s, o);
	}
	function h1(t, n, e) {
		const r = r0(t, e, !0), o = r0(f.Sun, e, !0), s = new v(r.x - o.x, r.y - o.y, r.z - o.z, e);
		return o.x = -r.x, o.y = -r.y, o.z = -r.z, It(n, e, o, s);
	}
	function dn(t, n) {
	...
	function t3(t, n, e) {
		const r = 11574074074074073e-21, o = h1(t, n, e.AddDays(-11574074074074073e-21));
		return (h1(t, n, e.AddDays(11574074074074073e-21)).r - o.r) / r;
	}
	function n3(t) {
		const n = $((e) => dn(l1, e), t.AddDays(-.03), t.AddDays(.03));
		if (!n) throw "Failed to find peak Earth shadow time.";
		return l1(n);
	}
	function e3(t) {
		const n = $((e) => dn(l2, e), t.AddDays(-.03), t.AddDays(.03));
		if (!n) throw "Failed to find peak Moon shadow time.";
		return l2(n);
	}
	function r3(t, n, e) {
		const r = $((o) => t3(t, n, o), e.AddDays(-1), e.AddDays(1));
	...
	function o3(t, n) {
		...
		const s = $((i) => dn(o, i), e, r);
		if (!s) throw `PeakLocalMoonShadow: search failure for search_center_time = ${t}`;
		return fn(s, n);
	}
	function Mn(t, n, e) {
		const r = e / 1440, o = t.AddDays(-r), s = t.AddDays(+r), i = $((a) => -(l1(a).r - n), o, t), c = $((a) => +(l1(a).r - n), t, s);
	...
	function f2(t, n) {
		const e = new v(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = h2(Math.asin(he / e.Length()), Math.asin(Ko / n.Length()), Gt(n, e) * y);
	...
	function d2(t) {
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				const i = n3(o);
				if (i.r < i.p + W) {
					let c = t0.Penumbral, a = 0, u = 0, l = 0, h = Mn(i.time, i.p + W, 200);
					return i.r < i.k + W && (c = t0.Partial, l = Mn(i.time, i.k + W, h), i.r + W < i.k ? (c = t0.Total, a = 1, u = Mn(i.time, i.k - W, l)) : a = h2(W, i.k, i.r)), new u2(c, a, i.time, h, l, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function s3(t) {
		...
		const i = c1(t.time), c = xt(i, t.dir), a = xt(i, t.target);
		...
		let M;
		if (_ > 0) {
			const m = (-h - Math.sqrt(_)) / (2 * l), g = m * c.x - a.x, R = m * c.y - a.y, E = (m * c.z - a.z) * s0, P = Math.hypot(g, R) * Ht;
			P == 0 ? o = E > 0 ? 90 : -90 : o = H * Math.atan(E / P);
			const N = _0(e);
			s = (H * Math.atan2(R, g) - 15 * N) % 360, s <= -180 ? s += 360 : s > 180 && (s -= 360);
			const p = st(i);
			let I = new v(g / U, R / U, E / U, t.time);
			I = xt(p, I), I.x += t.target.x, I.y += t.target.y, I.z += t.target.z;
			const T = It(fe, t.time, I, t.dir);
			if (T.r > 1e-9 || T.r < 0) throw `Unexpected shadow distance from geoid intersection = ${T.r}`;
			n = S2(T.k), M = n === t0.Total ? 1 : f2(t.dir, I);
		} else M = void 0;
		return new M2(n, M, e, r, o, s);
	}
	function i3(t) {
		return t = x(t), d2(t.AddDays(10));
	}
	function _2(t) {
		t = x(t);
		const n = 1.8;
	...
	function c3(t, n) {
		...
		const s = f1(n, 1, E2, r, t.time), i = f1(n, -1, E2, t.time, o);
		let c, a, u;
		t.r < Math.abs(t.k) ? (r = t.time.AddDays(-.01), o = t.time.AddDays(.01), c = f1(n, 1, y2, r, t.time), a = f1(n, -1, y2, t.time, o), u = S2(t.k)) : u = t0.Partial;
		const l = u === t0.Total ? 1 : f2(t.dir, t.target);
		return new m2(u, l, s, c, e, a, i);
	}
	...
	function p2(t, n) {
		return new A2(n, u3(n, t));
	}
	function u3(t, n) {
		const e = Mt(f.Sun, t, n, !0, !0);
		return Xt(t, n, e.ra, e.dec, "normal").altitude;
	}
	function R2(t, n) {
		t = x(t), X0(n);
		const e = 1.8;
	...
	function l3(t, n) {
		return t = x(t), R2(t.AddDays(10), n);
	}
	var g2 = class {
		constructor(t, n, e, r) {
	...
	function I2(t, n) {
		...
		for (;;) {
			...
			if (rt(t, s) < e) {
				const i = r3(t, r, s);
				if (i.r < i.p) {
					const c = i.time.AddDays(-1), a = x2(t, r, c, i.time, -1), u = i.time.AddDays(1), l = x2(t, r, i.time, u, 1), h = 60 * rt(t, i.time);
					return new g2(a, i.time, l, h);
				}
			}
			o = s.AddDays(10);
		}
	...
	function f3(t, n) {
		return n = x(n), I2(t, n.AddDays(100));
	}
	var A0;
	(function(t) {
	...
	function N2(t) {
		let n = x(t), e = Wt(n);
		for (;;) {
			const r = n.AddDays(P2), o = Wt(r);
			if (e.lat * o.lat <= 0) {
				const s = o.lat > e.lat ? A0.Ascending : A0.Descending, i = $((c) => s * Wt(c).lat, n, r);
	...
	function M3(t) {
		const n = $0(j0([
			...
			0,
			1
		], t, L.Into2000), t, L.Into2000), e = new v(n[0], n[1], n[2], t), r = cn(e), o = 190.41375788700253 + 360.9856122880876 * t.ut;
		return new _n(r.ra, r.dec, o, e);
	}
	function S3(t, n) {
		const e = x(n), r = e.tt, o = r / 36525;
		let s, i, c;
		switch (t) {
			case f.Sun:
			...
			case f.Venus:
				...
				break;
			case f.Earth: return M3(e);
			case f.Moon:
				const d = y * (125.045 - .0529921 * r), _ = y * (250.089 - .1059842 * r), M = y * (260.008 + 13.0120009 * r), m = y * (176.625 + 13.3407154 * r), g = y * (357.529 + .9856003 * r), R = y * (311.589 + 26.4057084 * r), E = y * (134.963 + 13.064993 * r), P = y * (276.617 + .3287146 * r), N = y * (34.226 + 1.7484877 * r), p = y * (15.134 - .1589763 * r), I = y * (119.743 + .0036096 * r), T = y * (239.961 + .1643573 * r), w = y * (25.053 + 12.9590088 * r);
				s = 269.9949 + .0031 * o - 3.8787 * Math.sin(d) - .1204 * Math.sin(_) + .07 * Math.sin(M) - .0172 * Math.sin(m) + .0072 * Math.sin(R) - .0052 * Math.sin(p) + .0043 * Math.sin(w), i = 66.5392 + .013 * o + 1.5419 * Math.cos(d) + .0239 * Math.cos(_) - .0278 * Math.cos(M) + .0068 * Math.cos(m) - .0029 * Math.cos(R) + 9e-4 * Math.cos(E) + 8e-4 * Math.cos(p) - 9e-4 * Math.cos(w), c = 38.3213 + (13.17635815 - 14e-13 * r) * r + 3.561 * Math.sin(d) + .1208 * Math.sin(_) - .0642 * Math.sin(M) + .0158 * Math.sin(m) + .0252 * Math.sin(g) - .0066 * Math.sin(R) - .0047 * Math.sin(E) - .0046 * Math.sin(P) + .0028 * Math.sin(N) + .0052 * Math.sin(p) + .004 * Math.sin(I) + .0019 * Math.sin(T) - .0044 * Math.sin(w);
				break;
			case f.Mars:
				...
				break;
			case f.Jupiter:
				const C = y * (99.360714 + 4850.4046 * o), k = y * (175.895369 + 1191.9605 * o), G = y * (300.323162 + 262.5475 * o), X = y * (114.012305 + 6070.2476 * o), u0 = y * (49.511251 + 64.3 * o);
				s = 268.056595 - .006499 * o + 117e-6 * Math.sin(C) + 938e-6 * Math.sin(k) + .001432 * Math.sin(G) + 3e-5 * Math.sin(X) + .00215 * Math.sin(u0), i = 64.495303 + .002413 * o + 5e-5 * Math.cos(C) + 404e-6 * Math.cos(k) + 617e-6 * Math.cos(G) - 13e-6 * Math.cos(X) + 926e-6 * Math.cos(u0), c = 284.95 + 870.536 * r;
				break;
			case f.Saturn:
		...
		const a = i * y, u = s * y, l = Math.cos(a), h = new v(l * Math.cos(u), l * Math.sin(u), Math.sin(a), e);
		return new _n(s / 15, i, c, h);
	}
	function _3(t, n, e, r) {
		const o = x(n), s = B1(e), i = B1(r);
		let c, a;
		return e === f.Earth && r === f.Moon ? (c = new V(0, 0, 0, 0, 0, 0, o), a = _t(o)) : (c = o1(e, o), a = o1(r, o)), T2(t, c, s, a, i);
	}
	function T2(t, n, e, r, o) {
		...
		let M;
		if (t === 4 || t === 5) {
			const m = c * _ - a * d, g = a * h - i * _, R = i * d - c * h;
			let E = g * a - R * c, P = R * i - m * a, N = m * c - g * i;
			const p = Math.sqrt(E * E + P * P + N * N);
			E /= p, P /= p, N /= p, i /= l, c /= l, a /= l;
			const I = t == 4 ? .8660254037844386 : -.8660254037844386, T = .5 * i + I * E, w = .5 * c + I * P, C = .5 * a + I * N, k = .5 * E - I * i, G = .5 * P - I * c, X = .5 * N - I * a, u0 = l * T, o0 = l * w, m0 = l * C, l0 = h * i + d * c + _ * a, h0 = h * E + d * P + _ * N;
			M = new V(u0, o0, m0, l0 * T + h0 * k, l0 * w + h0 * G, l0 * C + h0 * X, n.t);
		} else {
			const m = -l * (o / (e + o)), g = +l * (e / (e + o)), R = (e + o) / (u * l);
			let E, P, N;
			if (t === 1 || t === 2) E = e / (e + o) * Math.cbrt(o / (3 * e)), P = -e, t == 1 ? (E = 1 - E, N = +o) : (E = 1 + E, N = -o);
			else if (t === 3) E = (7 / 12 * o - e) / (o + e), P = +e, N = +o;
			else throw `Invalid Langrage point ${t}. Must be an integer 1..5.`;
			let p = l * E - m, I;
			do {
				const T = p - m, w = p - g;
				I = (R * p + P / (T * T) + N / (w * w)) / (R - 2 * P / (T * T * T) - 2 * N / (w * w * w)), p -= I;
			} while (Math.abs(I / l) > 1e-14);
			E = (p - m) / l, M = new V(E * i, E * c, E * a, E * h, E * d, E * _, n.t);
		}
		return M;
	}
	var A3 = class n0 {
		...
		Update(n) {
			const e = x(n), r = e.tt - this.curr.time.tt;
		...
		SolarSystemBodyState(n) {
			...
			return O0(e.sub(r), this.curr.time);
		}
		InternalBodyState(n) {
			if (n === f.SSB) return new b0(this.curr.time.tt, Q.zero(), Q.zero());
			const e = this.curr.gravitators[n];
			if (e) return e;
			throw `Invalid body: ${n}`;
		}
		static CalcSolarSystem(n) {
			const e = {}, r = new b0(n.tt, Q.zero(), Q.zero());
			e[f.Mercury] = Z(r, n.tt, f.Mercury, F1), e[f.Venus] = Z(r, n.tt, f.Venus, K1), e[f.Earth] = Z(r, n.tt, f.Earth, 8997011346712498e-25), e[f.Mars] = Z(r, n.tt, f.Mars, H1), e[f.Jupiter] = Z(r, n.tt, f.Jupiter, B0), e[f.Saturn] = Z(r, n.tt, f.Saturn, G0), e[f.Uranus] = Z(r, n.tt, f.Uranus, V0), e[f.Neptune] = Z(r, n.tt, f.Neptune, J0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new b0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Q.zero(), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, dt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, F1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, K1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, 8997011346712498e-25), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, H1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, B0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, G0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, V0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, J0);
		}
		...
		Duplicate() {
			...
			return new D2(this.curr.time, n, e);
		}
	}, D2 = class {
		constructor(t, n, e) {
	...
	function m3(t, n, e) {
		...
		const c = i.time.jd - s.time.jd, a = (n - s.time.jd) / c, u = a * a, l = u * a, h = 2 * l - 3 * u + 1, d = l - 2 * u + a, _ = -2 * l + 3 * u, M = l - u, m = h * s.position.x + d * c * s.velocity.x + _ * i.position.x + M * c * i.velocity.x, g = h * s.position.y + d * c * s.velocity.y + _ * i.position.y + M * c * i.velocity.y, R = h * s.position.z + d * c * s.velocity.z + _ * i.position.z + M * c * i.velocity.z;
		return e ? (e.x = m, e.y = g, e.z = R, e) : {
			x: m,
			y: g,
			z: R
		};
	...
	const p3 = .0073, R3 = 2.5, g3 = 1.25;
	function x3(t) {
		return t === K.Star || t === K.BlackHole;
	}
	function I3(t) {
		return {
			appearance: t,
			selectionBoundaryMul: x3(t) ? R3 : g3,
			angularFloorRad: p3
		};
	}
	const C2 = x1;
	...
	const w3 = 5e4, P3 = 2e3, N3 = w3 / C2, T3 = P3 / C2;
	wt(N3);
	wt(T3);
	[...I1];
	function it(t, n, e) {
	...
	function z2(t) {
		return Math.max(Wr, Math.min(Zr, t));
	}
	function C3(t, n) {
		if (!Number.isFinite(n) || n <= 0 || t == null || !Number.isFinite(t)) return null;
		const e = 10 ** ((4.83 - (t - 5 * Math.log10(n / 10))) / 2.5);
		return z2(Math.sqrt(e));
	}
	function v3(t, n) {
		const e = t.solrad;
		return e != null && Number.isFinite(e) && e > 0 ? z2(e) * D1 : (C3(t.mag, n) ?? 1) * D1;
	}
	function b2(t) {
		if (mn(t)) return 0;
		const { x: n, y: e, z: r, plx: o } = t;
	...
	function z3(t) {
		if (mn(t)) return it(M0.x, M0.y, M0.z);
		const n = b2(t) * zt, { x: e, y: r, z: o, ra: s, dec: i } = t, c = e != null && r != null && o != null && Number.isFinite(e) && Number.isFinite(r) && Number.isFinite(o);
		let a = null;
		return c && (a = Kn({
			x: e,
			y: r,
			z: o
		})), a == null && (a = C1(s, i)), a == null ? it(0, 0, n) : it(a.x * n, a.y * n, a.z * n);
	}
	function b3(t, n) {
		const e = mn(t), r = v3(t, b2(t)), s = An(z3(t), "icrf-j2000-equatorial");
		let i;
		return t.proper && t.proper.length > 0 ? i = t.proper : e ? i = D3 : i = String(t.id), v2({
			source: "hyg",
			key: String(t.id),
			name: i,
			type: "star",
	...
	const U2 = Math.PI / 180;
	function U3(t) {
		return t == null || !Number.isFinite(t) || t <= 0 ? 0 : Math.min(t, .99);
	}
	function O3(t, n) {
		let e = t % Pt;
		if (e > Math.PI ? e -= Pt : e < -Math.PI && (e += Pt), n === 0) return e;
	...
	function L3(t) {
		...
		return n / 2147483647 * Pt;
	}
	function k3(t, n, e) {
		const r = En(t.semiMajorAxisAU) ? t.semiMajorAxisAU * F : 0;
		if (r === 0) return n;
		const o = t.orbitalPeriodDays;
		if (!En(o) || !Number.isFinite(e)) return it(n.x + r, n.y, n.z);
		const s = U3(t.eccentricity), i = O3(Pt * (e - Ln) / o, s), c = r * (Math.cos(i) - s), a = r * Math.sqrt(1 - s * s) * Math.sin(i), u = (t.argPeriapsisDeg ?? 0) * U2, l = (t.inclinationDeg ?? 0) * U2, h = L3(t.hostStarId), d = Math.cos(u), _ = Math.sin(u), M = Math.cos(l), m = Math.sin(l), g = Math.cos(h), R = Math.sin(h), E = c * (g * d - R * _ * M) - a * (g * _ + R * d * M), P = c * (R * d + g * _ * M) - a * (R * _ - g * d * M), N = c * (_ * m) + a * (d * m);
		return it(n.x + E, n.y + P, n.z + N);
	}
	function F3(t, n, e, r) {
		const o = (En(t.radiusEarth) ? t.radiusEarth : 1) * $n, s = wr({
		...
		return v2({
			...
			appearance: s,
			getHeliocentricKm(i) {
				return An(k3(t, n, i ?? e), "icrf-j2000-equatorial");
			},
			renderOverrides: r
		});
	}
	S.MERCURY, S.VENUS, S.EARTH, S.MARS, S.JUPITER, S.SATURN, S.URANUS, S.NEPTUNE, S.PLUTO;
	K.Star, K.Barren, K.Molten, K.Oceanic, K.Desert, K.GasGiant, K.IceGiant, K.Galaxy, K.Nebula, K.StarCluster, K.BlackHole;
	function K3(t) {
		return Number.isFinite(t.x) && Number.isFinite(t.y) && Number.isFinite(t.z);
	}
	function H3(t, n, e, r) {
		...
		for (const a of n) if (a.hostStarId) {
			...
			if (u != null && i(u)) {
				const l = Mo(u, t), h = b3(u).getHeliocentricKm().value, d = F3(a, h, t).getHeliocentricKm(t).value, _ = {
					x: l.x + (d.x - h.x) * C0,
					y: l.y + (d.y - h.y) * C0,
					z: l.z + (d.z - h.z) * C0
				};
	...
	let O2 = null, M1 = null;
	function G3(t) {
		return M1 != null && t === O2 || (O2 = t, M1 = B3(t)), M1;
	}
	const V3 = 1;
	function J3(t) {
		return 2 ** Math.ceil(Math.log2(Math.max(1, t)));
	}
	let L2 = null, k2 = -1, yn = null;
	function Y3(t, n, e) {
		if (!Number.isFinite(n) || n <= 0) return t;
		const r = J3(n + (Number.isFinite(e) ? Math.max(0, e) : 0) + V3);
		if (yn != null && t === L2 && r === k2) return yn;
		const o = r * r, s = [];
		for (const i of t) {
			const { x: c, y: a, z: u } = i;
			(c == null || a == null || u == null || c * c + a * a + u * u <= o) && s.push(i);
		}
		return L2 = t, k2 = r, yn = s, s;
	}
	function $3(t) {
		const n = /* @__PURE__ */ new Map();
		if (!t) return n;
	...
	let F2 = null, S1 = null;
	function j3(t) {
		return S1 != null && t === F2 || (F2 = t, S1 = $3(t)), S1;
	}
	const q3 = 500 * F0;
	function Q3(t, n) {
		...
		const s = o * F0;
		return !Number.isFinite(s) || s <= 0 ? 0 : Math.min(s, q3);
	}
	const X3 = {
		a: 0,
		b: .4,
	...
	const Z3 = Math.PI / 180, t4 = Math.PI / 180 / 60, n4 = wt(1e4);
	wt(500);
	const e4 = .05, r4 = .15, o4 = .7, s4 = .35, i4 = {
		NGC0224: "spiral",
		NGC0598: "spiral",
		NGC5457: "spiral",
		NGC3031: "spiral",
	...
	function a4(t) {
		switch (t) {
			case "lenticular": return r4;
			case "elliptical": return o4;
			case "irregular": return s4;
			default: return e4;
		}
	}
	function c4(t) {
		if (!Number.isFinite(t.distPc) || t.distPc <= 0 || !Number.isFinite(t.majAxArcmin) || (t.majAxArcmin ?? 0) <= 0) return null;
		const n = t.majAxArcmin / 2 * t4, e = t.distPc * Math.tan(n);
		if (!Number.isFinite(e) || e <= 0) return null;
		const r = wt(e), o = Math.min(r, n4), s = W3(t.hubbleType), i = i4[t.catalogId] ?? s.kind, c = Number.isFinite(t.minAxArcmin) && (t.minAxArcmin ?? 0) > 0, a = t.majAxArcmin;
		return {
			discRadiusSu: o,
			discRadiusPc: e,
			morphScale: [
			...
			positionAngleRad: Number.isFinite(t.positionAngleDeg) ? t.positionAngleDeg * Z3 : 0,
			kind: i,
			armTightness: s.tightness
		};
	}
	function u4(t) {
		return t.type === "nebula" || t.type === "planetary_nebula" ? Q3(t.distPc, t.majAxArcmin) : t.type === "galaxy" ? c4(t)?.discRadiusSu ?? 0 : 0;
	}
	function l4(t, n) {
		const { stars: e, exoplanetRows: r, deepSkyObjects: o, ephemerisByBodyId: s } = t, { jd: i, viewpointScenePosition: c, viewForward: a, halfAngleRad: u, nearbyScanMaxLy: l, activeSystem: h } = n, d = y3(i, s), _ = l / x1, M = Qn(c), m = r && r.length > 0 ? j3(e) : /* @__PURE__ */ new Map(), g = r != null ? H3(i, r, m, {
			viewerPc: M,
			maxDistancePc: _,
			padPc: re(U1(i))
		}) : [], R = G3(r), N = po({
			...
			solarCandidates: d,
			exoplanets: g,
			stars: Y3(e, _, Math.hypot(M.x, M.y, M.z)),
			deepSkyObjects: o,
			maxCount: 10,
			maxDistancePc: _,
			selection: "priority",
		...
		const I = (w) => {
			if (p == null) {
				p = /* @__PURE__ */ new Map();
				for (const k of o) p.set(k.catalogId, k);
			}
			const C = p.get(w);
			return C != null ? u4(C) : 0;
		}, T = (w, C) => {
			if (w === "hor") {
				const k = T1[C]?.radiusKm;
				return k != null && k > 0 ? k * C0 : 0;
			}
			return w === "dso" ? I(C) : 0;
		};
		return N.map((w) => ({
			...
			sceneRadiusSu: T(w.source, w.rawId)
		}));
	}
	let pn = null;
	E1({
