import{a as De}from"./rolldown-runtime-WehaI0Q3.js";import{i as We}from"./react-vendor-C4vVqT8x.js";import{u as Ve}from"./state-data-vendor-Cgva2hV6.js";import{a as je,o as Ye}from"./useHygStars-BSU17X3E.js";import{b as ie}from"./teleportTargets-Crc2JGPF.js";var te=De(We(),1),we=Symbol("Comlink.proxy"),qe=Symbol("Comlink.endpoint"),ye=Symbol("Comlink.releaseProxy"),q=Symbol("Comlink.finalizer"),U=Symbol("Comlink.thrown"),ue=e=>typeof e=="object"&&e!==null||typeof e=="function",Re=new Map([["proxy",{canHandle:e=>ue(e)&&e[we],serialize(e){const{port1:t,port2:a}=new MessageChannel;return Te(e,t),[a,[a]]},deserialize(e){return e.start(),Ge(e)}}],["throw",{canHandle:e=>ue(e)&&U in e,serialize({value:e}){let t;return e instanceof Error?t={isError:!0,value:{message:e.message,name:e.name,stack:e.stack}}:t={isError:!1,value:e},[t,[]]},deserialize(e){throw e.isError?Object.assign(new Error(e.value.message),e.value):e.value}}]]);function Xe(e,t){for(const a of e)if(t===a||a==="*"||a instanceof RegExp&&a.test(t))return!0;return!1}function Te(e,t=globalThis,a=["*"]){t.addEventListener("message",function o(r){if(!r||!r.data)return;if(!Xe(a,r.origin)){console.warn(`Invalid origin '${r.origin}' for comlink proxy`);return}const{id:l,type:n,path:i}=Object.assign({path:[]},r.data),u=(r.data.argumentList||[]).map(C);let c;try{const d=i.slice(0,-1).reduce((v,h)=>v[h],e),f=i.reduce((v,h)=>v[h],e);switch(n){case"GET":c=f;break;case"SET":d[i.slice(-1)[0]]=C(r.data.value),c=!0;break;case"APPLY":c=f.apply(d,u);break;case"CONSTRUCT":c=tt(new f(...u));break;case"ENDPOINT":{const{port1:v,port2:h}=new MessageChannel;Te(e,h),c=et(v,[v])}break;case"RELEASE":c=void 0;break;default:return}}catch(d){c={value:d,[U]:0}}Promise.resolve(c).catch(d=>({value:d,[U]:0})).then(d=>{const[f,v]=W(d);t.postMessage(Object.assign(Object.assign({},f),{id:l}),v),n==="RELEASE"&&(t.removeEventListener("message",o),Ee(t),q in e&&typeof e[q]=="function"&&e[q]())}).catch(d=>{const[f,v]=W({value:new TypeError("Unserializable return value"),[U]:0});t.postMessage(Object.assign(Object.assign({},f),{id:l}),v)})}),t.start&&t.start()}function Ke(e){return e.constructor.name==="MessagePort"}function Ee(e){Ke(e)&&e.close()}function Ge(e,t){const a=new Map;return e.addEventListener("message",function(r){const{data:l}=r;if(!l||!l.id)return;const n=a.get(l.id);if(n)try{n(l)}finally{a.delete(l.id)}}),oe(e,a,[],t)}function N(e){if(e)throw new Error("Proxy has been released and is not useable")}function Me(e){return A(e,new Map,{type:"RELEASE"}).then(()=>{Ee(e)})}var F=new WeakMap,D="FinalizationRegistry"in globalThis&&new FinalizationRegistry(e=>{const t=(F.get(e)||0)-1;F.set(e,t),t===0&&Me(e)});function Ze(e,t){const a=(F.get(t)||0)+1;F.set(t,a),D&&D.register(e,t,e)}function Qe(e){D&&D.unregister(e)}function oe(e,t,a=[],o=function(){}){let r=!1;const l=new Proxy(o,{get(n,i){if(N(r),i===ye)return()=>{Qe(l),Me(e),t.clear(),r=!0};if(i==="then"){if(a.length===0)return{then:()=>l};const u=A(e,t,{type:"GET",path:a.map(c=>c.toString())}).then(C);return u.then.bind(u)}return oe(e,t,[...a,i])},set(n,i,u){N(r);const[c,d]=W(u);return A(e,t,{type:"SET",path:[...a,i].map(f=>f.toString()),value:c},d).then(C)},apply(n,i,u){N(r);const c=a[a.length-1];if(c===qe)return A(e,t,{type:"ENDPOINT"}).then(C);if(c==="bind")return oe(e,t,a.slice(0,-1));const[d,f]=de(u);return A(e,t,{type:"APPLY",path:a.map(v=>v.toString()),argumentList:d},f).then(C)},construct(n,i){N(r);const[u,c]=de(i);return A(e,t,{type:"CONSTRUCT",path:a.map(d=>d.toString()),argumentList:u},c).then(C)}});return Ze(l,e),l}function Je(e){return Array.prototype.concat.apply([],e)}function de(e){const t=e.map(W);return[t.map(a=>a[0]),Je(t.map(a=>a[1]))]}var Ce=new WeakMap;function et(e,t){return Ce.set(e,t),e}function tt(e){return Object.assign(e,{[we]:!0})}function W(e){for(const[t,a]of Re)if(a.canHandle(e)){const[o,r]=a.serialize(e);return[{type:"HANDLER",name:t,value:o},r]}return[{type:"RAW",value:e},Ce.get(e)||[]]}function C(e){switch(e.type){case"HANDLER":return Re.get(e.name).deserialize(e.value);case"RAW":return e.value}}function A(e,t,a,o){return new Promise(r=>{const l=ot();t.set(l,r),e.start&&e.start(),e.postMessage(Object.assign({id:l},a),o)})}function ot(){return new Array(4).fill(0).map(()=>Math.floor(Math.random()*Number.MAX_SAFE_INTEGER).toString(16)).join("-")}var at="/assets/openngc.worker-CdGvbq4q.js";async function rt(e){if(typeof Worker>"u")return ie(e);let t;try{t=new Worker(at,{type:"module"})}catch{return ie(e)}const a=Ge(t);try{return await a.loadCatalog(e)}catch(o){const r=o instanceof Error?o.message:String(o);throw Object.assign(new Error(r),{cause:o})}finally{a[ye](),t.terminate()}}var lt="openngc-dso-catalog";function st(e){const t=e?.extraEnabled===!0,[a,o]=(0,te.useState)(!1);return(0,te.useEffect)(()=>{o(!0)},[]),Ve({queryKey:[lt],queryFn:()=>rt(Ye("openngc-dso.json")),enabled:t||a,staleTime:je,retry:!1})}var nt=[];function To(e){const t=st(e),a=(0,te.useMemo)(()=>t.data??nt,[t.data]);return{...t,objects:a}}var ae=null,Pe=0,re=new Set;function ct(){Pe+=1;for(const e of re)e()}function Eo(){return Pe}function Go(e){return re.add(e),()=>re.delete(e)}function Mo(e,t){ae={c1Abbr:e,c2Abbr:t},ct()}function Co(){const e=ae;return ae=null,e}var s;(function(e){e.TerrainWet="terrain_wet",e.TerrainDry="terrain_dry",e.Aquatic="aquatic",e.Barren="barren",e.GasGiant="gas_giant",e.GasGiantRinged="gas_giant_ringed",e.Molten="molten",e.Ice="ice",e.Star="star",e.BlackHole="black_hole",e.Galaxy="galaxy",e.Nebula="nebula"})(s||(s={}));var w={[s.TerrainWet]:{base1:[.4,.69,.78,1],base2:[.4,.69,.78,1],base3:[.204,.255,.616,1],land1:[.784,.831,.365,1],land2:[.388,.671,.247,1],land3:[.184,.341,.325,1],land4:[.157,.208,.251,1],cloud1:[.882,.949,1,1],cloud2:[.753,.89,1,1],cloud3:[.369,.439,.647,1],cloud4:[.251,.286,.451,1],atmo1:[.678,.847,.902,.25],atmo2:[0,.498,1,.35],atmo3:[0,0,.502,.45]},[s.TerrainDry]:{col1:[.96,.85,.63,1],col2:[.85,.65,.4,1],col3:[.58,.38,.26,1],col4:[.35,.22,.2,1]},[s.Aquatic]:{base1:[.157,.38,.69,1],base2:[.118,.286,.58,1],base3:[.078,.176,.42,1],land1:[.388,.671,.247,1],land2:[.255,.502,.216,1],land3:[.184,.341,.325,1],land4:[.118,.22,.259,1],cloud1:[.882,.949,1,1],cloud2:[.753,.89,1,1],cloud3:[.369,.439,.647,1],cloud4:[.251,.286,.451,1],atmo1:[.4,.7,.9,.25],atmo2:[.1,.4,.8,.35],atmo3:[.05,.15,.5,.45]},[s.Barren]:{base1:[.608,.62,.722,1],base2:[.278,.38,.486,1],base3:[.208,.224,.333,1],crater1:[.278,.38,.486,1],crater2:[.208,.224,.333,1]},[s.GasGiant]:{gas_base1:[.941,.71,.255,1],gas_base2:[.812,.459,.169,1],gas_base3:[.671,.318,.188,1],gas_base4:[.49,.22,.2,1],gas_dark1:[.231,.125,.153,1],gas_dark2:[.231,.125,.153,1],gas_dark3:[.129,.094,.106,1],gas_dark4:[.129,.094,.106,1]},[s.GasGiantRinged]:{gas1:[.941,.71,.255,1],gas2:[.812,.459,.169,1],gas3:[.671,.318,.188,1],gas4:[.49,.22,.2,1],gas_dark1:[.231,.125,.153,1],gas_dark2:[.2,.11,.14,1],gas_dark3:[.129,.094,.106,1],gas_dark4:[.1,.07,.09,1],ring1:[.941,.78,.45,1],ring2:[.812,.56,.3,1],ring3:[.58,.35,.2,1],ring4:[.35,.2,.15,1]},[s.Molten]:{base1:[.561,.302,.341,1],base2:[.322,.2,.247,1],base3:[.239,.161,.212,1],crater1:[.322,.2,.247,1],crater2:[.239,.161,.212,1],river1:[1,.537,.2,1],river2:[.902,.271,.224,1],river3:[.678,.184,.271,1]},[s.Ice]:{base1:[.98,1,1,1],base2:[.78,.831,1,1],base3:[.573,.561,.722,1],lake1:[.31,.643,.722,1],lake2:[.298,.408,.522,1],lake3:[.227,.247,.369,1],cloud1:[.882,.949,1,1],cloud2:[.753,.89,1,1],cloud3:[.369,.439,.647,1],cloud4:[.251,.286,.451,1]},[s.Star]:{star1:[1,.95,.5,1],star2:[1,.7,.2,1],star3:[.9,.35,.1,1],star4:[.6,.15,.05,1],blob:[1,.647,0,1],glow:[1,.6,.15,1]},[s.BlackHole]:{glow1:[1,.902,.784,1],glow2:[.98,.588,.353,1],glow3:[.973,.353,.137,1],glow4:[.667,.039,.031,1],purple:[.498,.004,.498,1],rim:[1,.816,.694,1],inset:[.867,.686,.765,1]},[s.Galaxy]:{core:[1,.96,.8,1],arm1:[.4,.5,.9,1],arm2:[.3,.35,.7,1],dust:[.15,.1,.2,1]}},y={[s.TerrainWet]:["base1","base2","base3","land1","land2","land3","land4","cloud1","cloud2","cloud3","cloud4","atmo1","atmo2","atmo3"],[s.TerrainDry]:["col1","col2","col3","col4"],[s.Aquatic]:["base1","base2","base3","land1","land2","land3","land4","cloud1","cloud2","cloud3","cloud4","atmo1","atmo2","atmo3"],[s.Barren]:["base1","base2","base3","crater1","crater2"],[s.GasGiant]:["gas_base1","gas_base2","gas_base3","gas_base4","gas_dark1","gas_dark2","gas_dark3","gas_dark4"],[s.GasGiantRinged]:["gas1","gas2","gas3","gas4","gas_dark1","gas_dark2","gas_dark3","gas_dark4","ring1","ring2","ring3","ring4"],[s.Molten]:["base1","base2","base3","crater1","crater2","river1","river2","river3"],[s.Ice]:["base1","base2","base3","lake1","lake2","lake3","cloud1","cloud2","cloud3","cloud4"],[s.Star]:["star1","star2","star3","star4","blob","glow"],[s.BlackHole]:["glow1","glow2","glow3","glow4","purple","rim","inset"],[s.Galaxy]:["core","arm1","arm2","dust"]},S={[s.TerrainWet]:20,[s.TerrainDry]:10,[s.Aquatic]:20,[s.Barren]:10,[s.GasGiant]:9,[s.GasGiantRinged]:75,[s.Molten]:10,[s.Ice]:20,[s.Star]:60,[s.BlackHole]:10,[s.Galaxy]:20,[s.Nebula]:0};function fe(e,t,a){const o=e.createShader(t);if(!o)throw new Error("Failed to create shader");if(e.shaderSource(o,a),e.compileShader(o),!e.getShaderParameter(o,e.COMPILE_STATUS)){const r=e.getShaderInfoLog(o);throw e.deleteShader(o),new Error(`Shader compile error: ${r}`)}return o}function Ae(e,t,a){const o=fe(e,e.VERTEX_SHADER,t),r=fe(e,e.FRAGMENT_SHADER,a),l=e.createProgram();if(!l)throw new Error("Failed to create program");if(e.attachShader(l,o),e.attachShader(l,r),e.linkProgram(l),!e.getProgramParameter(l,e.LINK_STATUS)){const n=e.getProgramInfoLog(l);throw e.deleteProgram(l),new Error(`Program link error: ${n}`)}return e.deleteShader(o),e.deleteShader(r),l}function _e(e,t){const a=e.createTexture();if(!a)throw new Error("Failed to create texture");return e.bindTexture(e.TEXTURE_2D,a),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,t),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.REPEAT),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.REPEAT),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),a}function P(e,t){e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,1);const a=e.createTexture();if(!a)throw new Error("Failed to create BH texture");return e.bindTexture(e.TEXTURE_2D,a),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,t),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,0),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,0),a}function it(e){const t=e.createTexture();if(!t)throw new Error("Failed to create fallback texture");return e.bindTexture(e.TEXTURE_2D,t),e.texImage2D(e.TEXTURE_2D,0,e.LUMINANCE,1,1,0,e.LUMINANCE,e.UNSIGNED_BYTE,new Uint8Array([128])),t}function ut(e=128){const t=document.createElement("canvas");t.width=e,t.height=e;const a=t.getContext("2d");let o=48271;const r=()=>(o=o*16807%2147483647,(o-1)/2147483646);a.fillStyle="rgb(128,128,128)",a.fillRect(0,0,e,e);const l=e/2,n=e/2,i=e*8;for(let c=0;c<i;c++){const d=r()*Math.PI*2,f=r()*e*.5,v=l+Math.cos(d)*f,h=n+Math.sin(d)*f,g=r()*e*.08+1,p=Math.floor(80+r()*96);a.fillStyle=`rgba(${p},${p},${p},${.1+r()*.3})`,a.beginPath(),a.arc(v,h,g,0,Math.PI*2),a.fill()}const u=a.createRadialGradient(l,n,0,l,n,e*.5);return u.addColorStop(0,"rgba(128,128,128,0)"),u.addColorStop(.7,"rgba(128,128,128,0)"),u.addColorStop(1,"rgba(128,128,128,0.5)"),a.fillStyle=u,a.fillRect(0,0,e,e),t}function dt(e){return new Promise((t,a)=>{const o=new Image;o.crossOrigin="anonymous",o.onload=()=>t(o),o.onerror=()=>a(new Error(`Failed to load noise texture: ${e}`)),o.src=e})}function ft(e,t){let a=Math.imul(e|0,2654435761)+Math.imul(t|0,2246822519)|0;return a=Math.imul(a>>>16^a,73244475),a=Math.imul(a>>>16^a,73244475),a=a>>>16^a,(a>>>0)%1e4/100+.1}var _t=`
...
`;function mt(e,t){const a=t!==1?`    uv = (uv - 0.5) * ${t.toFixed(4)} + 0.5;
...
`}function vt(e){return Be+Ie+e}var gt=class{constructor(e,t,a){this.programs=new Map,this.noiseTexture=null,this.gl=e,this.quadVBO=t,this.fallbackTexture=a}setNoiseTexture(e){this.noiseTexture=e}precompile(e){this.programs.has(e.type)||this.buildProgram(e)}render(e,t,a){const o=this.gl,r=this.getOrBuild(e),l=t.resolution||512,n=t.seed,i=t.rotationAngle??0,u=t.timeSpeed??.1,c=t.lightPos??[.39,.7];o.useProgram(r.prog);const d=o.getAttribLocation(r.prog,"a_position");o.enableVertexAttribArray(d),o.bindBuffer(o.ARRAY_BUFFER,this.quadVBO),o.vertexAttribPointer(d,2,o.FLOAT,!1,0,0),this.setUniform1f(r,"u_pixels",l),this.setUniform1f(r,"u_time",a),this.setUniform1f(r,"u_time_speed",u),this.setUniform1f(r,"u_rotation",i),this.setUniform2f(r,"u_light_origin",c[0],c[1]);for(let p=1;p<=6;p++)this.setUniform1f(r,`u_seed${p}`,ft(n,p));const f=e.colorSlots,v=e.palette,h=t.colors||{};for(let p=0;p<16;p++){const T=f[p];let R=[0,0,0,0];T&&(h[T]?R=h[T]:v[T]&&(R=v[T])),this.setUniform4f(r,`u_col${p}`,R[0],R[1],R[2],R[3])}o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,this.noiseTexture||this.fallbackTexture);const g=this.getUniform(r,"u_noise_tex");g!==null&&o.uniform1i(g,0),o.clearColor(0,0,0,0),o.clear(o.COLOR_BUFFER_BIT),o.disable(o.BLEND),o.drawArrays(o.TRIANGLE_STRIP,0,4)}dispose(){const e=this.gl;this.programs.forEach(t=>e.deleteProgram(t.prog)),this.programs.clear()}getOrBuild(e){let t=this.programs.get(e.type);return t||(t=this.buildProgram(e)),t}buildProgram(e){let t;if(e.mode==="composed"&&e.features)t=mt(e.features,e.uvScaling);else if(e.mode==="standalone"&&e.standaloneGlsl)t=vt(e.standaloneGlsl);else throw new Error(`Invalid profile mode for shader rendering: ${e.mode}`);const a={prog:Ae(this.gl,_t,t),uniforms:new Map};return this.programs.set(e.type,a),a}getUniform(e,t){return e.uniforms.has(t)||e.uniforms.set(t,this.gl.getUniformLocation(e.prog,t)),e.uniforms.get(t)}setUniform1f(e,t,a){const o=this.getUniform(e,t);o!==null&&this.gl.uniform1f(o,a)}setUniform2f(e,t,a,o){const r=this.getUniform(e,t);r!==null&&this.gl.uniform2f(r,a,o)}setUniform4f(e,t,a,o,r,l){const n=this.getUniform(e,t);n!==null&&this.gl.uniform4f(n,a,o,r,l)}},x=.4,ht=84*Math.PI/180;200/2*x;var X=400/2*x,K=350/2*x,Z=400/2*x,Q=1500/2*x*1.05,pt=800/2*x,bt=1200/2*x,me=33*x,St=83*x,xt=20*x,wt=1200*x,yt=-50*x,ve=10,ge=3.33,he=800,pe=1.74;function le(){return new Float32Array(16)}function V(){const e=le();return e[0]=e[5]=e[10]=e[15]=1,e}function k(e,t){const a=le();for(let o=0;o<4;o++)for(let r=0;r<4;r++)a[o*4+r]=e[r]*t[o*4]+e[4+r]*t[o*4+1]+e[8+r]*t[o*4+2]+e[12+r]*t[o*4+3];return a}function He(e,t){const a=V();return a[0]=e,a[5]=t,a}function Rt(e){const t=V(),a=Math.cos(e),o=Math.sin(e);return t[5]=a,t[9]=-o,t[6]=o,t[10]=a,t}function Le(e){const t=V(),a=Math.cos(e),o=Math.sin(e);return t[0]=a,t[4]=-o,t[1]=o,t[5]=a,t}function Tt(e,t,a){const o=V();return o[12]=e,o[13]=t,o[14]=a,o}function Et(){const e=le(),t=he/2,a=he/2;return e[0]=pe/t,e[5]=-pe/a,e[10]=-.001,e[11]=-1/wt,e[15]=1,e}function J(e,t,a=0){const o=He(e,t);return a?k(Le(a),o):o}function M(e,t=0){let a=He(e,e);return t&&(a=k(Le(t),a)),a=k(Tt(0,yt,0),a),k(Rt(ht),a)}var Gt=`
attribute vec2 aPos;
uniform mat4 uMVP;
uniform mat4 uModel;
varying vec2 vUV;
...
`;function m(e,t){return`rgba(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)},${t})`}function Ct(e){return`rgb(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)})`}function be(e){return`rgba(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)},`}function Pt(e){const t=e.glow1,a=e.glow2,o=e.glow3,r=e.glow4,l=e.purple,n=e.rim,i=e.inset;return{glow:[{offset:0,color:m(t,.65)},{offset:.08,color:m(t,.55)},{offset:.2,color:m(a,.6)},{offset:.34,color:m(a,.6)},{offset:.49,color:m(o,.55)},{offset:.63,color:m(o,.55)},{offset:.73,color:m(r,.45)},{offset:.83,color:m(r,.18)},{offset:.97,color:m(r,.05)},{offset:1,color:m(r,0)}],hGlow:[{offset:0,color:m(t,0)},{offset:.53,color:m(t,0)},{offset:.54,color:"rgba(255,255,255,0.7)"},{offset:.55,color:m(t,.85)},{offset:.59,color:m(a,.75)},{offset:.63,color:m(a,.85)},{offset:.73,color:m(o,.6)},{offset:.83,color:m(r,.4)},{offset:.97,color:m(r,.1)},{offset:1,color:m(r,0)}],backglow:[{offset:0,color:m(l,0)},{offset:.14,color:m(l,0)},{offset:.4,color:m(l,.1)},{offset:.7,color:"rgba(0,0,0,0)"},{offset:1,color:"rgba(0,0,0,0)"}],holeBloom:m(l,.6),holeHalo:m(l,.6),holeOuterRim:Ct(n),holeInsetA:be(n),holeInsetB:be(i)}}function j(e,t){const a=document.createElement("canvas");return a.width=Math.ceil(e),a.height=Math.ceil(t),[a,a.getContext("2d")]}function At(e){const t=me*3,a=(X+t)*2,o=(K+t)*2,[r,l]=j(a,o),n=a/2,i=o/2;l.filter=`blur(${me}px)`;const u=Math.sqrt(X**2+K**2),c=l.createRadialGradient(n,i,0,n,i,u);for(const d of e.glow)c.addColorStop(d.offset,d.color);return l.fillStyle=c,l.beginPath(),l.ellipse(n,i,X,K,0,0,Math.PI*2),l.fill(),r}function ke(e,t,a){const o=(e+t*3)*2,[r,l]=j(o,o),n=o/2;l.filter=`blur(${t}px)`;const i=e*Math.SQRT2,u=l.createRadialGradient(n,n,0,n,n,i);for(const c of a)u.addColorStop(c.offset,c.color);return l.fillStyle=u,l.beginPath(),l.arc(n,n,e,0,Math.PI*2),l.fill(),r}function Bt(e){return ke(pt,St,e.hGlow)}function It(e){return ke(bt,xt,e.backglow)}function Ht(e){const[r,l]=j(600,600),n=600/2,i=600/2;l.save(),l.filter="blur(100px)",l.fillStyle=e.holeBloom,l.beginPath(),l.arc(n,i,110,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(50px)",l.fillStyle="white",l.beginPath(),l.arc(n,i,105,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(2px)",l.fillStyle="rgb(0,0,0)",l.beginPath(),l.arc(n,i,108,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(6px)",l.fillStyle=e.holeHalo,l.beginPath(),l.arc(n,i,102,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(2px)",l.fillStyle=e.holeOuterRim,l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill(),l.restore(),l.fillStyle="black",l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill();const u=l.createRadialGradient(n,i,98,n,i,100);u.addColorStop(0,"transparent"),u.addColorStop(.5,e.holeInsetA+"0.15)"),u.addColorStop(1,e.holeInsetA+"0.5)"),l.fillStyle=u,l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill();const c=l.createRadialGradient(n,i,97,n,i,100);return c.addColorStop(0,"transparent"),c.addColorStop(.5,e.holeInsetB+"0.1)"),c.addColorStop(1,e.holeInsetB+"0.35)"),l.fillStyle=c,l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill(),r}function Se(e,t,a){const o=Math.ceil(t*2),[r,l]=j(o,o),n=o/2;l.save(),l.beginPath(),l.arc(n,n,t,0,Math.PI*2),l.clip(),l.drawImage(e,0,0,o,o),l.restore(),l.globalCompositeOperation="destination-in";const i=l.createRadialGradient(n,n,0,n,n,t);for(const u of a)i.addColorStop(u.offset,`rgba(0,0,0,${u.alpha})`);return l.fillStyle=i,l.fillRect(0,0,o,o),l.globalCompositeOperation="source-over",r}var Lt=class{constructor(e,t){this.state=null,this.noiseImage=null,this.gl=e,this.quadVBO=t}setNoiseImage(e){this.noiseImage=e,this.state&&!this.state.texHEH&&this.dispose()}init(e){const t=this.gl;this.dispose();const a=Pt(e),o=Ae(t,Gt,Mt);t.useProgram(o);const r=t.getUniformLocation(o,"uMVP"),l=t.getUniformLocation(o,"uModel"),n=t.getUniformLocation(o,"uTex"),i=t.getUniformLocation(o,"uAlpha"),u=t.getUniformLocation(o,"uClipZ"),c=t.getAttribLocation(o,"aPos");t.uniform1i(n,0);const d=Et(),f=At(a),v=Bt(a),h=It(a),g=Ht(a),p=P(t,f),T=P(t,v),R=P(t,h),z=P(t,g);let B=null,I=null;this.noiseImage&&(B=P(t,Se(this.noiseImage,Z,[{offset:0,alpha:1},{offset:.283,alpha:1},{offset:.99,alpha:0},{offset:1,alpha:0}])),I=P(t,Se(this.noiseImage,Q,[{offset:0,alpha:1},{offset:.283,alpha:.7},{offset:.99,alpha:0},{offset:1,alpha:0}]))),this.state={prog:o,locMvp:r,locModel:l,locTex:n,locAlpha:i,locClipZ:u,aPosLoc:c,proj:d,texGlow:p,glowHW:f.width/2,glowHH:f.height/2,texHGlow:T,hglowHS:v.width/2,texBglow:R,bglowHS:h.width/2,texHole:z,holeHS:g.width/2*x,texEH:B,texHEH:I}}render(e,t,a){const o=this.gl;(!this.state||this.state.texHEH===null&&this.noiseImage!==null)&&this.init(e);const r=this.state;o.useProgram(r.prog),o.bindBuffer(o.ARRAY_BUFFER,this.quadVBO),o.enableVertexAttribArray(r.aPosLoc),o.vertexAttribPointer(r.aPosLoc,2,o.FLOAT,!1,0,0),o.clearColor(0,0,0,0),o.clear(o.COLOR_BUFFER_BIT),o.enable(o.BLEND),o.disable(o.DEPTH_TEST);const l=t*a,n=l%ve/ve*Math.PI*2,i=l%ge/ge*Math.PI*2,u=()=>o.blendFunc(o.ONE,o.ONE_MINUS_SRC_ALPHA),c=()=>o.blendFunc(o.ONE,o.ONE_MINUS_SRC_COLOR);u(),this.drawQuad(r,r.texGlow,J(r.glowHW,r.glowHH),1,0),r.texHEH&&(c(),this.drawQuad(r,r.texHEH,M(Q,n),.35,-1)),u(),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,-1),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,-1),r.texEH&&(c(),this.drawQuad(r,r.texEH,J(Z,Z,i),.7,0)),u(),this.drawQuad(r,r.texBglow,M(r.bglowHS),1,0),this.drawQuad(r,r.texHole,J(r.holeHS,r.holeHS),1,0),u(),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,1),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,1),r.texHEH&&(c(),this.drawQuad(r,r.texHEH,M(Q,n),.35,1)),o.disable(o.BLEND)}dispose(){if(!this.state)return;const e=this.gl,t=this.state;e.deleteProgram(t.prog),e.deleteTexture(t.texGlow),e.deleteTexture(t.texHGlow),e.deleteTexture(t.texBglow),e.deleteTexture(t.texHole),t.texEH&&e.deleteTexture(t.texEH),t.texHEH&&e.deleteTexture(t.texHEH),this.state=null}drawQuad(e,t,a,o,r){const l=this.gl,n=k(e.proj,a);l.uniformMatrix4fv(e.locMvp,!1,n),l.uniformMatrix4fv(e.locModel,!1,a),l.uniform1f(e.locAlpha,o),l.uniform1f(e.locClipZ,r),l.activeTexture(l.TEXTURE0),l.bindTexture(l.TEXTURE_2D,t),l.drawArrays(l.TRIANGLE_STRIP,0,4)}},kt=class{constructor(e){this.hasSpare=!1,this.spare=0,this.s=e}next(){return this.s=(this.s*16807+0)%2147483647,(this.s-1)/2147483646}random(e,t){return t!==void 0?e+this.next()*(t-e):e!==void 0?this.next()*e:this.next()}randomGaussian(e=0,t=1){if(this.hasSpare)return this.hasSpare=!1,e+t*this.spare;let a,o,r;do a=this.next()*2-1,o=this.next()*2-1,r=a*a+o*o;while(r>=1||r===0);return r=Math.sqrt(-2*Math.log(r)/r),this.spare=o*r,this.hasSpare=!0,e+t*a*r}},Ot=Math.PI*2,zt=900;function xe(e){if(typeof document>"u")return new OffscreenCanvas(e,e);const t=document.createElement("canvas");return t.width=e,t.height=e,t}function $t(e,t=512,a){const o=new kt(e),r=zt,l=xe(r),n=l.getContext("2d");function i(b,E,H,G){const L=Math.max(0,Math.min(255,G));n.fillStyle=`rgba(${b|0},${E|0},${H|0},${L/255})`}function u(b,E,H){const G=Math.abs(H)/2;G<.1||(n.beginPath(),n.arc(b,E,G,0,Ot),n.fill())}function c(b,E,H,G,L){L=L+r/2e3;const Ue=8300+Math.floor(r/3),Fe=r/1500,Y=20;for(let ce=0;ce<Ue;ce++)i(b+o.random(Y),H+o.random(Y),E+o.random(Y),Math.abs(o.randomGaussian())/4),u(-r/2+r/2*o.randomGaussian(),r*o.randomGaussian()/G,o.randomGaussian(r/100,r/G+r/40)),i(255,255,255,L*o.randomGaussian()/2),u(-r/2+r/2*o.randomGaussian(),r*o.randomGaussian()/G,Fe*o.randomGaussian())}function d(){const b=r*4;for(let E=0;E<b;E++)i(255,255,255,Math.abs(255*o.randomGaussian())),u(-r/2+r/2*o.randomGaussian(),r*o.randomGaussian()*o.randomGaussian()*o.randomGaussian()*o.randomGaussian(),.5*o.randomGaussian())}function f(){n.save(),n.translate(o.random(-r/2,r/2),o.random(-r/10,r/10)),c(o.random(100,255),o.random(100,255),o.random(100,255),29,100),n.scale(.05,.05),c(o.random(100,255),o.random(100,255),o.random(100,255),10,2),c(255,255,255,2,2),d(),n.restore()}n.save(),n.translate(r/2,r/2);const v=o.random(.3,1);n.scale(v,v),n.rotate(o.random(-Math.PI,Math.PI));const h=a?.dominant??[o.random(10,255),o.random(10,255),o.random(10,255)];c(h[0],h[1],h[2],3,6),d();const g=a?.accents??[[200,200,200],[0,200,250],[250,100,250]];c(g[0][0],g[0][1],g[0][2],7,205),g.length>1&&c(g[1][0],g[1][1],g[1][2],22,205),g.length>2&&c(g[2][0],g[2][1],g[2][2],25,205);const p=Math.floor(o.random(0,3.1));for(let b=0;b<p;b++)f();const T=Math.max(10,r/12),R=Math.floor(o.random(5,T));for(let b=0;b<R;b++)n.save(),n.translate(r/3*o.randomGaussian(),r/3*o.randomGaussian()),n.scale(o.random(.5,1),o.random(.5,1)),n.rotate(o.random(-Math.PI/4,Math.PI/4)),c(o.random(100,255),o.random(100,255),o.random(100,255),15,100),n.restore();n.restore();const z=r/2,B=r/2,I=r,$=n.createRadialGradient(z,B,I*.25,z,B,I*.52);if($.addColorStop(0,"rgba(0,0,0,0)"),$.addColorStop(.6,"rgba(0,0,0,0)"),$.addColorStop(1,"rgba(0,0,0,1)"),n.globalCompositeOperation="destination-out",n.fillStyle=$,n.fillRect(0,0,r,r),n.globalCompositeOperation="source-over",t===r)return l;const ne=xe(t);return ne.getContext("2d").drawImage(l,0,0,t,t),ne}var O={id:"base_planet",seedSlots:[1],colorSlotRange:[0,3],glsl:e=>{const t=e.uvSource===1?"sphered":"rotated",a=e.octaves||6,o=`u_seed${e.seedSlot||1}`,r=`u_col${e.colorStart||0}`,l=`u_col${(e.colorStart||0)+1}`,n=`u_col${(e.colorStart||0)+2}`;return`
    // === BASE PLANET ===
    {
    ...
    }`}},Oe={id:"land_mass",seedSlots:[2],colorSlotRange:[3,7],glsl:e=>{const t=(e.landCutoff??.5).toFixed(4),a=`u_seed${e.seedSlot||2}`,o=`u_col${e.colorStart||3}`,r=`u_col${(e.colorStart||3)+1}`,l=`u_col${(e.colorStart||3)+2}`,n=`u_col${(e.colorStart||3)+3}`;return`
    // === LAND MASS ===
    {
    ...
    }`},Nt={type:s.TerrainWet,mode:"composed",uvScaling:1.05,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Oe,params:{landCutoff:.5,seedSlot:2,colorStart:3,noiseScale:10}},{feature:se,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:7}},{feature:ze,params:{colorStart:11}}],palette:w[s.TerrainWet],colorSlots:y[s.TerrainWet],loopLCM:S[s.TerrainWet],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,landCutoff:.5}},Ut=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
...
`,Ft={type:s.TerrainDry,mode:"standalone",uvScaling:1,standaloneGlsl:Ut,palette:w[s.TerrainDry],colorSlots:y[s.TerrainDry],loopLCM:S[s.TerrainDry],defaults:{}},Dt={type:s.Aquatic,mode:"composed",uvScaling:1.05,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Oe,params:{landCutoff:.65,seedSlot:2,colorStart:3,noiseScale:10}},{feature:se,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:7}},{feature:ze,params:{colorStart:11}}],palette:w[s.Aquatic],colorSlots:y[s.Aquatic],loopLCM:S[s.Aquatic],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,landCutoff:.65}},$e={id:"craters",seedSlots:[2],colorSlotRange:[3,5],glsl:e=>{const t=(e.craterScale||5).toFixed(1),a=`u_seed${e.seedSlot||2}`,o=`u_col${e.colorStart||3}`,r=`u_col${(e.colorStart||3)+1}`;return`
    // === CRATER LAYER ===
    {
        float crater_sz = ${t};
        float c1_val = 1.0;
    ...
    }`}},Wt={type:s.Barren,mode:"composed",uvScaling:1,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:$e,params:{craterScale:5,seedSlot:2,colorStart:3}}],palette:w[s.Barren],colorSlots:y[s.Barren],loopLCM:S[s.Barren],defaults:{fbmOctaves:6,noiseScale:10,craterScale:5}},Vt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
...
`,jt={type:s.GasGiant,mode:"standalone",uvScaling:1,standaloneGlsl:Vt,palette:w[s.GasGiant],colorSlots:y[s.GasGiant],loopLCM:S[s.GasGiant],defaults:{}},Yt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,qt={type:s.GasGiantRinged,mode:"standalone",uvScaling:1,standaloneGlsl:Yt,palette:w[s.GasGiantRinged],colorSlots:y[s.GasGiantRinged],loopLCM:S[s.GasGiantRinged],defaults:{}},Ne={id:"flow_layer",seedSlots:[2,3],colorSlotRange:[3,6],glsl:e=>{const t=e.flowOctaves||5,a=(e.flowCutoff??.6).toFixed(4),o=(e.flowScale||10).toFixed(1),r=`u_seed${e.seedSlot||3}`,l=`u_col${e.colorStart||5}`,n=`u_col${(e.colorStart||5)+1}`,i=`u_col${(e.colorStart||5)+2}`;return e.useScroll,`
    // === FLOW LAYER ===
    {
        float flow_sz = ${o};
        float flow_cutoff = ${a};
    ...
    }`}},Xt={type:s.Molten,mode:"composed",uvScaling:1,features:[{feature:O,params:{uvSource:1,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:$e,params:{craterScale:5,seedSlot:2,colorStart:3}},{feature:Ne,params:{flowOctaves:5,flowCutoff:.6,flowScale:10,seedSlot:3,colorStart:5}}],palette:w[s.Molten],colorSlots:y[s.Molten],loopLCM:S[s.Molten],defaults:{fbmOctaves:6,noiseScale:10,craterScale:5,flowCutoff:.6,flowOctaves:5,flowScale:10}},Kt={type:s.Ice,mode:"composed",uvScaling:1,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Ne,params:{flowOctaves:4,flowCutoff:.6,flowScale:10,seedSlot:2,colorStart:3}},{feature:se,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:6}}],palette:w[s.Ice],colorSlots:y[s.Ice],loopLCM:S[s.Ice],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,flowCutoff:.6,flowOctaves:4,flowScale:10}},Zt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,Qt={type:s.Star,mode:"standalone",uvScaling:1,standaloneGlsl:Zt,palette:w[s.Star],colorSlots:y[s.Star],loopLCM:S[s.Star],defaults:{}},Jt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,eo={type:s.Galaxy,mode:"standalone",uvScaling:1,standaloneGlsl:Jt,palette:w[s.Galaxy],colorSlots:y[s.Galaxy],loopLCM:S[s.Galaxy],defaults:{}},to={type:s.BlackHole,mode:"multipass",uvScaling:1,palette:w[s.BlackHole],colorSlots:y[s.BlackHole],loopLCM:S[s.BlackHole],defaults:{}},oo={type:s.Nebula,mode:"canvas2d",uvScaling:1,palette:{},colorSlots:[],loopLCM:S[s.Nebula],defaults:{}},ee={[s.TerrainWet]:Nt,[s.TerrainDry]:Ft,[s.Aquatic]:Dt,[s.Barren]:Wt,[s.GasGiant]:jt,[s.GasGiantRinged]:qt,[s.Molten]:Xt,[s.Ice]:Kt,[s.Star]:Qt,[s.Galaxy]:eo,[s.BlackHole]:to,[s.Nebula]:oo},Po=class{constructor(e){this.noiseTexture=null,this.noiseImage=null,this.canvas=e||document.createElement("canvas");const t=this.canvas.getContext("webgl",{premultipliedAlpha:!1,alpha:!0,antialias:!1,preserveDrawingBuffer:!0});if(!t)throw new Error("WebGL not supported");this.gl=t;const a=t.createBuffer();if(!a)throw new Error("Failed to create buffer");this.quadVBO=a,t.bindBuffer(t.ARRAY_BUFFER,a),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),t.STATIC_DRAW),this.fallbackTexture=it(t),this.noiseTexture=_e(t,ut(128)),this.shaderRenderer=new gt(t,this.quadVBO,this.fallbackTexture),this.shaderRenderer.setNoiseTexture(this.noiseTexture),this.bhRenderer=new Lt(t,this.quadVBO)}async precompile(e){const t=e||Object.values(s).filter(a=>a!==s.BlackHole&&a!==s.Nebula);for(const a of t){const o=ee[a];!o||o.mode==="multipass"||o.mode==="canvas2d"||(this.shaderRenderer.precompile(o),await new Promise(r=>setTimeout(r,0)))}}async loadNoiseTexture(e){const t=await dt(e);this.noiseImage=t,this.setNoiseTexture(t),this.bhRenderer.setNoiseImage(t)}setNoiseTexture(e){const t=this.gl;this.noiseTexture&&t.deleteTexture(this.noiseTexture),this.noiseTexture=_e(t,e),this.shaderRenderer.setNoiseTexture(this.noiseTexture)}render(e,t){const a=this.gl,o=e.resolution||512,r=e.type;if(r===s.Nebula)return $t(e.seed,o,e.colors);if((this.canvas.width!==o||this.canvas.height!==o)&&(this.canvas.width=o,this.canvas.height=o),a.viewport(0,0,o,o),r===s.BlackHole){const n=ee[s.BlackHole],i=n.palette,u=e.colors||{},c={};for(const f of n.colorSlots)c[f]=u[f]||i[f];const d=e.timeSpeed??.1;return this.bhRenderer.render(c,t,d),this.canvas}const l=ee[r];if(!l)throw new Error(`Unknown celestial type: ${r}`);return this.shaderRenderer.render(l,e,t),this.canvas}renderToImageData(e,t){this.render(e,t);const a=this.gl,o=this.canvas.width,r=this.canvas.height,l=new Uint8Array(o*r*4);a.readPixels(0,0,o,r,a.RGBA,a.UNSIGNED_BYTE,l);const n=o*4,i=new Uint8Array(n);for(let u=0;u<Math.floor(r/2);u++){const c=u*n,d=(r-1-u)*n;i.set(l.subarray(c,c+n)),l.copyWithin(c,d,d+n),l.set(i,d)}return new ImageData(new Uint8ClampedArray(l.buffer),o,r)}getCanvas(){return this.canvas}getLoopDuration(e,t){const a=t??.1,o=S[e];return o?o/a:0}static getCelestialTypes(){return Object.values(s)}static getColorSlots(e){return[...y[e]||[]]}static getDefaultPalette(e){return{...w[e]||{}}}dispose(){const e=this.gl;this.shaderRenderer.dispose(),this.bhRenderer.dispose(),e.deleteBuffer(this.quadVBO),e.deleteTexture(this.fallbackTexture),this.noiseTexture&&e.deleteTexture(this.noiseTexture)}};function Ao(e){const t=e.replace(/^#/,""),a=parseInt(t,16);return[a>>16&255,a>>8&255,a&255]}function ao(e){if(!e||typeof e!="string")return[1,1,1];const t=e.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return t?[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]:[1,1,1]}function Bo(e){return Math.max(0,Math.min(255,Math.round(e)))}function _(e,t=1,a=1){const[o,r,l]=ao(e),n=Math.max(.15,Math.min(1,t));return[o*n,r*n,l*n,a]}var ro={kind:"barren",eluvadeType:s.Barren,defaultTextureResolution:192,defaultColors(e){const t=_(e,1),a=_(e,.82),o=_(e,.64);return{base1:t,base2:a,base3:o,crater1:a,crater2:o}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},lo={kind:"blackHole",eluvadeType:s.BlackHole,defaultTextureResolution:256,defaultColors(){return{}},textureBlit:{backdropFill:"transparent",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"billboard"}},so={kind:"desert",eluvadeType:s.TerrainDry,defaultTextureResolution:192,defaultColors(e){return{col1:_(e,1),col2:_(e,.82),col3:_(e,.64),col4:_(e,.48)}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},no={kind:"galaxy",eluvadeType:s.Galaxy,defaultTextureResolution:256,defaultColors(){return{}},textureBlit:{backdropFill:"transparent",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"billboard"}},co={kind:"gasGiant",eluvadeType:s.GasGiant,defaultTextureResolution:256,defaultColors(e){return{gas_base1:_(e,1),gas_base2:_(e,.82),gas_base3:_(e,.64),gas_base4:_(e,.48),gas_dark1:_(e,.35),gas_dark2:_(e,.28)}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,rings:!1,sceneGraph:"sphere"}},io={kind:"iceGiant",eluvadeType:s.Ice,defaultTextureResolution:224,defaultColors(e){const t=_(e,1),a=_(e,.82),o=_(e,.64);return{base1:[Math.min(1,t[0]+.15),Math.min(1,t[1]+.2),1,1],base2:a,base3:o,lake1:t,lake2:a,cloud1:[.9,.95,1,1]}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},uo={kind:"molten",eluvadeType:s.Molten,defaultTextureResolution:224,defaultColors(e){const t=_(e,1),a=_(e,.82),o=_(e,.64);return{base1:a,base2:o,river1:t,river2:a,river3:o}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},fo={kind:"nebula",eluvadeType:s.Nebula,defaultTextureResolution:256,defaultColors(){return{}},textureBlit:{backdropFill:"transparent",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!1,sceneGraph:"billboard"}},_o={kind:"oceanic",eluvadeType:s.TerrainWet,defaultTextureResolution:224,defaultColors(e){const t=_(e,1),a=_(e,.82);return{base1:a,base2:_(e,.64),land1:t,land2:a,cloud1:[.9,.95,1,1],atmo2:[t[0]*.3,t[1]*.5,Math.min(1,t[2]+.2),.35]}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},mo={kind:"star",eluvadeType:s.Star,defaultTextureResolution:512,defaultColors(e){const t=_(e,1),a=_(e,.82);return{star1:t,star2:a,star3:_(e,.64),blob:a,glow:[t[0],t[1],t[2],1]}},textureBlit:{backdropFill:"starDim",starBodyZoomOnSphere:!0},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},vo={star:mo,barren:ro,molten:uo,oceanic:_o,desert:so,gasGiant:co,iceGiant:io,galaxy:no,nebula:fo,blackHole:lo},go=new Set,ho={galaxy:"galaxy",nebula:"nebula",planetary_nebula:"nebula",star_cluster:"nebula"};function po(e){return ho[e]}function bo(e){return go.has(e.catalogId)?"blackHole":po(e.type)}function Io(e){return vo[bo(e)].eluvadeType}function Ho(e){return e===s.BlackHole?"black_hole":e}function Lo(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/6e4),o=Math.floor(t%6e4/1e3),r=n=>n<10?`0${n}`:String(n),l=t%1e3;return`${a}:${r(o)}.${String(l).padStart(3,"0")}`}export{st as _,vo as a,Ge as b,Ao as c,s as d,Eo as f,To as g,Co as h,bo as i,ao as l,Go as m,Io as n,_ as o,Mo as p,Ho as r,Bo as s,Lo as t,Po as u,tt as v,ye as y};
