import{n as S}from"./state-data-vendor-DwYWRG6B.js";import{n as F}from"./manifest.generated-DbEr_Uqr.js";import{t as G}from"./skyLightStore-CcPC6YfG.js";import{A as C,d as u,f as b,g as P,ht as y,it as A}from"./three-vendor-Ce7iT1Ri.js";import{Qt as _,Ur as d,a as z}from"./index-DcO8RMP0.js";import{t as L}from"./r3fHostExtras-BtatsfV9.js";import{t as R}from"./createMountComponent-Ch-nBYE6.js";import{n as v,t as E}from"./deepSkyCatalogBridge-CcCVO4DN.js";var T={mainSequence:[.85,.95,1.4],giant:[1.4,1,.55],giantFraction:.08},B={mainSequence:[1.35,1.15,.8],giant:[1.5,.85,.5],giantFraction:.25};function O(t){return t==="globular"?B:T}var k=8;function I(t,i,e,n,l,s,o){t.xs.push(e,n,l),t.mags.push(s),t.cols.push(o[0],o[1],o[2]),t.glow.push(1),t.ids.push(i)}function N(t,i){const e=F(t);if(!Number.isFinite(e.x)||!Number.isFinite(e.y)||!Number.isFinite(e.z)||e.x===0&&e.y===0&&e.z===0)return;const n=t.vMag!=null&&Number.isFinite(t.vMag)?t.vMag:k,l=_(t),s=O(l),o=l==="globular"?s.giant:s.mainSequence;I(i,t.catalogId,e.x,e.y,e.z,n,o)}function D(t){const i={xs:[],mags:[],cols:[],glow:[],ids:[]};for(const e of t)e.type==="star_cluster"&&N(e,i);return{positions:new Float32Array(i.xs),mag:new Float32Array(i.mags),color:new Float32Array(i.cols),isGlow:new Float32Array(i.glow),catalogIds:i.ids,count:i.ids.length}}var U=160,Q=`
  attribute float mag;
...
`;function q(){return new y({uniforms:{uMagLimit:{value:13},uGlowMagLimit:{value:5},uMagRef:{value:0},uMagFadeRange:{value:1.5},uFluxClampMax:{value:6},uFluxGamma:{value:.45},uPointSizeFloor:{value:1.1},uPointSizeMax:{value:U},uPsfMaxMult:{value:3.5},uGlowSizeMult:{value:3},uSizeMultiplier:{value:1}},vertexShader:Q,fragmentShader:V,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1})}function j(t){const i=L(t).layers.dsoReRooted,e=new C;e.name="clusterGlowLayer",i.add(e);const n=z(),l=q(),s=new P;let o=null,r=null,m=!1;const f={current:d.getState().showDsoVolumes},c=()=>{e.visible=f.current&&o!==null},g=()=>{if(!m){if(o!==null&&(e.remove(o),o.geometry.dispose(),o=null),r=D(E()),r.count>0){const a=new b;a.setAttribute("position",new u(r.positions,3)),a.setAttribute("mag",new u(r.mag,1)),a.setAttribute("color",new u(r.color,3)),a.setAttribute("isGlow",new u(r.isGlow,1)),o=new A(a,l),o.name="clusterGlow",o.frustumCulled=!1,o.renderOrder=-18,e.add(o)}c()}};Promise.resolve().then(g).catch(a=>console.error("[mountClusterGlow] rebuild failed:",a));const w=d.subscribe(a=>({showDsoVolumes:a.showDsoVolumes}),a=>{f.current=a.showDsoVolumes,c()},{equalityFn:S}),h=n.getQueryCache().subscribe(a=>{(v(a,"openngc-dso-catalog")||v(a,"custom-objects-catalog"))&&g()});return{onFrame:()=>{if(l.uniforms.uMagLimit){const a=s.getDelta(),x=G(),M=1-Math.exp(-a/.7),p=l.uniforms.uMagLimit.value;l.uniforms.uMagLimit.value=p+(x.bandMagLimit-p)*M}},dispose:()=>{m=!0,w(),h(),o!==null&&(e.remove(o),o.geometry.dispose(),o=null),l.dispose(),i.remove(e)}}}var te=R(j,"present.hud");export{te as ClusterGlowMountR3f};
