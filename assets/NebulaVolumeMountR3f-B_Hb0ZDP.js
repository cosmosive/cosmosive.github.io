import{i as L}from"./rolldown-runtime-BOC55nOF.js";import{p as B}from"./r3f-vendor-XIshX99T.js";import{n as j}from"./state-data-vendor-sq1yP6E9.js";import{R as _,V as q,bt as p,dt as O,lt as V,p as A,w as P,yt as Q}from"./three-vendor-vu4QJ6OG.js";import{Ba as S,Jn as I,Vn as U,_a as M,a as k,fn as z,xo as W}from"./index-C_rG7Dgs.js";import{n as G,r as H,t as Y}from"./sceneModule-CDKLj-DQ.js";import{n as J,t as N}from"./queryCacheNotify-BH_-JPMx.js";var C=L(B(),1),K=I.far/4,X=10,h=10,$=17,Z=9,ee=`
...
`;function te(e){let a=17;for(let t=0;t<e.length;t+=1)a=(a*31+e.charCodeAt(t))%104729;return a/104729}function s(e,a){const t=Math.sin((e+a)*43758.5453123)*12589.317;return t-Math.floor(t)}function oe(e){if(!Number.isFinite(e.distPc)||e.distPc<=0||!Number.isFinite(e.majAxArcmin)||(e.majAxArcmin??0)<=0)return 0;const a=_.degToRad(e.majAxArcmin/120),t=W(e.distPc*Math.tan(a));return!Number.isFinite(t)||t<=0?0:Math.min(t,K)}function re(e,a){const t=Number.isFinite(e.majAxArcmin)?Math.max(e.majAxArcmin??0,4):4,n=Number.isFinite(e.minAxArcmin)&&(e.minAxArcmin??0)>0?Math.min(1,Math.max(.2,(e.minAxArcmin??t)/t)):null,o=e.type==="planetary_nebula"?.72+s(a,.11)*.2:.34+s(a,.11)*.42,i=n??o,f=e.type==="planetary_nebula"?Math.max(i,.72+s(a,.29)*.2):Math.max(.28,i*(.68+s(a,.29)*.3)),u=Number.isFinite(e.positionAngleDeg)?_.degToRad(e.positionAngleDeg??0):s(a,.47)*Math.PI*2,c=(s(a,.67)-.5)*(e.type==="planetary_nebula"?.22:.58),l=new p(s(a,.81)-.5,s(a,1.03)-.5,s(a,1.29)-.5);l.lengthSq()<1e-8&&l.set(.3,-.2,.5),l.normalize();const m=e.type==="planetary_nebula"?.42+s(a,1.41)*.2:.78+s(a,1.41)*.5;return{morphAngleRad:u,morphScale:new p(1,i,f),morphTiltRad:c,warpAxis:l,warpStrength:m}}function R(e){return Math.min(1,Math.max(0,e))}function x(e,a,t){return new A().setHSL(e,R(a),R(t))}function ne(e,a){if((e.openNgcTypeRaw??"").toUpperCase()==="DRKN")return{colorA:new A(1774351),colorB:new A(3416600),colorC:new A(8014375),intensityScale:.7};const t=(a%h+h)%h,n=($/360+t/h)%1,o=t===Z,i=t%2===0?.3:.65,f=x(n,o?.32:.62,.08),u=x(n,o?.4:.9,o?.3:i),c=x(n,o?.3:.65,o?.62:.82);return e.type==="planetary_nebula"&&c.lerp(x(.52,.54,.74),.22),{colorA:f,colorB:u,colorC:c,intensityScale:e.type==="planetary_nebula"?1.6:1.4}}function ie(e,a,t,n){return{uTime:{value:0},uRadius:{value:e},uIntensity:{value:1.5*n.intensityScale},uStructureScale:{value:4.5},uQuality:{value:0},uWarpStrength:{value:t.warpStrength},uColorA:{value:n.colorA.clone()},uColorB:{value:n.colorB.clone()},uColorC:{value:n.colorC.clone()},uSeedOffset:{value:new p(a*3.1,(a+.17)*2.6,(a+.31)*4.2)},uMorphScale:{value:t.morphScale},uWarpAxis:{value:t.warpAxis},uDriftVec:{value:new p(.009+s(a,2.11)*.005,-.006+s(a,2.47)*.004,.007+s(a,2.79)*.005)},uMorphAngles:{value:new Q(t.morphAngleRad,t.morphTiltRad)}}}function se(e,a){const t=U(e),n=new p(t.x,t.y,t.z),o=oe(e),i=te(e.catalogId),f=ie(o,i,re(e,i),ne(e,a)),u=new O(o,40,28),c=new V({uniforms:f,vertexShader:ee,fragmentShader:ae,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1}),l=new q(u,c);l.frustumCulled=!1,l.renderOrder=-10;const m=new P;return m.name=`nebula-${e.catalogId}`,m.position.copy(n),m.add(l),{group:m,material:c,mesh:l}}function le(e){e.mesh.geometry.dispose(),e.material.dispose()}function w(e,a){const t=a==="ultra";for(const n of e)n.material.uniforms.uQuality.value=t?1:0}function ue(){const e=J().filter(a=>!(a.type!=="nebula"&&a.type!=="planetary_nebula"||!Number.isFinite(a.distPc)||a.distPc<=0||!Number.isFinite(a.majAxArcmin)||(a.majAxArcmin??0)<=0));return e.sort((a,t)=>{const n=+!!t.featured-+!!a.featured;if(n!==0)return n;const o=Number.isFinite(a.majAxArcmin)?a.majAxArcmin??0:0,i=(Number.isFinite(t.majAxArcmin)?t.majAxArcmin??0:0)-o;return i!==0?i:a.distPc-t.distPc}),e.slice(0,X)}function ce(e){const a=z(e).layers.dso,t=new P;t.name="nebulaVolumeLayer",a.add(t);const n=k(),o=[],i=S.getState(),f={current:i.showNebulaClouds},u={current:i.nebulaQuality},c={current:M().getState().universeMode.activeGalaxyId!==null},l={current:0},m={current:performance.now()},b=()=>{t.visible=f.current&&!c.current&&o.length>0},y=()=>{for(;o.length>0;){const r=o.pop();r!=null&&(t.remove(r.group),le(r))}},g=()=>{y(),ue().forEach((r,v)=>{const d=se(r,v);o.push(d),t.add(d.group)}),w(o,u.current),b()};g();const D=S.subscribe(r=>({showNebulaClouds:r.showNebulaClouds,nebulaQuality:r.nebulaQuality}),r=>{f.current=r.showNebulaClouds,u.current!==r.nebulaQuality&&(u.current=r.nebulaQuality,w(o,u.current)),b()},{equalityFn:j}),E=M().subscribeSelector(r=>r.universeMode.activeGalaxyId,r=>{c.current=r!==null,b()}),F=n.getQueryCache().subscribe(r=>{(N(r,"openngc-dso-catalog")||N(r,"custom-objects-catalog"))&&g()});return{onFrame:r=>{if(!t.visible)return;const v=performance.now(),d=Math.min(.06,Math.max(0,(v-m.current)/1e3));m.current=v,l.current+=d;for(const T of o)T.material.uniforms.uTime.value=l.current},dispose:()=>{D(),E(),F(),y(),a.remove(t)}}}function ye(){const e=H(),a=(0,C.useRef)(null);return(0,C.useLayoutEffect)(()=>{const t=ce(e);return a.current=t.onFrame,()=>{t.dispose(),a.current=null}},[e]),G(()=>a.current?.(),Y.HUD_BRIDGE),null}export{ye as NebulaVolumeMountR3f};
