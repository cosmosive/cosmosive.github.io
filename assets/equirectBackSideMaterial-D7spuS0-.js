import{W as d,m as s}from"./three-vendor-D5I3Zz7G.js";import{n as m,t as i}from"./majorDsoSelector-D5ycB_Gf.js";var f=new Set(["nebula","planetary_nebula"]);function l(e){return m(e,{types:f,max:10})}function E(e){return i(l(e))}var p=.07,v=-Math.PI/2;function c({texture:e,colorMul:r=1,initialOpacity:o=0,programCacheKey:n="dso-immersive-dome-edge-feather"}){const t=new d({map:e,side:1,depthWrite:!1,toneMapped:!1,transparent:!0,opacity:o});return t.color=new s(r,r,r),t.customProgramCacheKey=()=>n,t.onBeforeCompile=a=>{a.uniforms.dsoEdgeFeather={value:p},a.fragmentShader=a.fragmentShader.replace("#include <common>",`#include <common>
