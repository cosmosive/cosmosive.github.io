(function() {
	...
	function ct(t, n, e = [], r = function() {}) {
		...
		const s = new Proxy(r, {
			...
			apply(i, a, c) {
				...
				if (u === Bn) return C0(t, n, { type: "ENDPOINT" }).then(P0);
	...
	}, oe = 149597870.7, se = 648e3 / Math.PI, ie = 1500;
	100 / se;
	const d2 = 1e6;
	if (1500 > d2) throw new Error(`SOLAR_ENVELOPE_RADIUS_AU=100 exceeds float32-safe scene radius (>${d2} SU)`);
	ie + 500;
	...
	const M2 = Object.fromEntries(Object.entries(re).map(([t, n]) => [t, ae(n)]));
	D.SUN, D.MERCURY, D.VENUS, D.EARTH, D.MARS, D.JUPITER, D.SATURN, D.URANUS, D.NEPTUNE, D.PLUTO;
	const ht = M2[D.EARTH]?.radiusKm ?? 6371, ft = M2[D.SUN]?.radiusKm ?? 696340, ce = ht / ft, s1 = .04;
	ht / s1;
	s1 / ht / (15 / oe);
	function ue(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : t / ce * s1;
	}
	function le(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : ue(t / ft);
	}
	le(ft);
	var v1 = Qn({
		AU_PER_LY: () => S2,
		...
		InverseRotation: () => r1,
		JUPITER_EQUATORIAL_RADIUS_KM: () => he,
		JUPITER_MEAN_RADIUS_KM: () => de,
		JUPITER_POLAR_RADIUS_KM: () => fe,
		JupiterMoons: () => n3,
		JupiterMoonsInfo: () => G2,
		KM_PER_AU: () => L,
		LagrangePoint: () => t4,
		...
		MoonPhase: () => kt,
		MoonQuarter: () => Y2,
		NextGlobalSolarEclipse: () => Q3,
		NextLocalSolarEclipse: () => K3,
		NextLunarApsis: () => y3,
		NextLunarEclipse: () => G3,
		NextMoonNode: () => W3,
		NextMoonQuarter: () => c3,
		...
		SearchMaxElongation: () => A3,
		SearchMoonNode: () => Vn,
		SearchMoonPhase: () => p1,
		SearchMoonQuarter: () => j2,
		SearchPeakMagnitude: () => E3,
	...
	const D1 = 173.1446326846693, L = 149597870.69098932, S2 = 63241.07708807546, p = .017453292519943295, dt = .26179938779914946, b = 57.29577951308232, Mt = 3.819718634205488, he = 71492, fe = 66854, de = 69911, Me = 1821.6, Se = 1560.8, pe = 2631.2, _e = 2410.3, p2 = 365.24217, _2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, A2 = 10800 * 60, Ae = 2 * A2, E2 = 7292115e-11, Ee = A2 / Math.PI, ye = -.17 - 5 * Math.log10(Ee), I1 = 29.530588, P1 = 24 * 3600, we = P1 * 1e3, y2 = .9972695717592592, i1 = 695700, w2 = i1 / L, s0 = .996647180302104, b0 = s0 * s0, M0 = 6378.1366, ge = M0 / L, Re = M0 * s0, g2 = 6371, xe = g2 + 88, me = 1738.1 / L, j = 1737.4, R2 = 1736, ve = R2 / L, De = 34 / 60, St = 81.30056, a1 = .0002959122082855911, pt = 4912547451450812e-26, _t = 7243452486162703e-25, c1 = 8887692390113509e-25, At = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, $0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, Ie = 218869976542597e-26, z1 = c1 / St;
	function Et(t) {
		switch (t) {
	...
	function R0(t) {
		if (!L1 || Math.abs(L1.tt - t.tt) > 1e-6) {
			const n = Ce(t), e = D2(t), r = e + n.deps / 3600;
			L1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function x0(t) {
		...
		function r(T, O, V, $) {
			const Q = [];
			for (let I0 = 0; I0 <= O - T; ++I0) Q.push(e(V, $));
			return {
				min: T,
				array: Q
			};
		...
		function o(T, O, V) {
			const $ = T.array[O - T.min];
			return $.array[V - $.min];
		}
		function s(T, O, V, $) {
			const Q = T.array[O - T.min];
			Q.array[V - Q.min] = $;
		}
		let i, a, c, u, h, l, d, _, M, A, y, g, R, w, m, x, z, I, k, N, B, G, Y, u0 = r(-6, 6, 1, 4), o0 = r(-6, 6, 1, 4);
		function A0(T, O) {
			return o(u0, T, O);
		}
		function D0(T, O) {
		...
		var f0 = U(.19833 + .05611 * n), Zt = U(.27869 + .04508 * n), t2 = U(.16827 - .36903 * n), n2 = U(.34734 - 5.37261 * n), e2 = U(.10498 - 5.37899 * n), ot = U(.42681 - .41855 * n), c4 = U(.14943 - 5.37511 * n);
		for (I = .84 * f0 + .31 * Zt + 14.27 * t2 + 7.26 * n2 + .28 * e2 + .24 * ot, k = 2.94 * f0 + .31 * Zt + 14.27 * t2 + 9.34 * n2 + 1.12 * e2 + .83 * ot, N = -6.4 * f0 - 1.89 * ot, B = .21 * f0 + .31 * Zt + 14.27 * t2 - 88.7 * n2 - 15.3 * e2 + .24 * ot - 1.86 * c4, G = I - N, _ = -3332e-9 * U(.59734 - 5.37261 * n) - 539e-9 * U(.35498 - 5.37899 * n) - 64e-9 * U(.39943 - 5.37511 * n), R = n0 * H0(.60643382 + 1336.85522467 * n - 313e-8 * d) + I / w0, w = n0 * H0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = n0 * H0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * H0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, z = n0 * H0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (l0(0, h, 1), l0(1, h, Math.cos(c) * u), h0(0, h, 0), h0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) rt(A0(l - 1, h), D0(l - 1, h), A0(1, h), D0(1, h), (T, O) => (l0(l, h, T), h0(l, h, O)));
		...
		function Hn(T, O, V, $) {
			for (var Q = {
				...
				V,
				$
			], E0 = 1; E0 <= 4; ++E0) I0[E0] !== 0 && rt(Q.x, Q.y, A0(I0[E0], E0), D0(I0[E0], E0), (r2, o1) => (Q.x = r2, Q.y = o1));
			return Q;
		}
		function S(T, O, V, $, Q, I0, E0, r2) {
			var o1 = Hn(Q, I0, E0, r2);
			M += T * o1.y, Y += O * o1.y, y += V * o1.x, g += $ * o1.x;
		}
		...
		let u4 = (1.000002708 + 139.978 * _) * (18519.699999999997 + y) * Math.sin(i) - 6.24 * Math.sin(3 * i) + A;
		return {
			geo_eclip_lon: n0 * H0((R + M / w0) / n0),
			geo_eclip_lat: Math.PI / (180 * 3600) * u4,
			distance_au: w0 * ge / (.999953253 * g)
		};
	}
	var z2 = class {
	...
	function Fe(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = o > 0 ? 90 : -90, c = Math.abs(o) - Re;
		else {
	...
	function b1(t, n, e) {
		return e === C.Into2000 ? G0(Q0(t, n, e), n, e) : Q0(G0(t, n, e), n, e);
	}
	function $e(t, n, e) {
		return e === C.Into2000 ? N2(L2(t, n, e), n, e) : L2(N2(t, n, e), n, e);
	}
	function O2(t, n) {
	...
	function F1(t, n, e, r, o) {
		...
		const g = -15 * S0(s);
		let R = q0(g, M), w = q0(g, A), m = q0(g, y), x = [
			l * _,
			l * d,
			h
		];
	...
	function V2(t) {
		const n = E(t).AddDays(-1 / D1), e = j0(q.Earth, n), [r, o, s] = b1([
			-e.x,
			-e.y,
			-e.z
		], n, C.From2000), i = p * R0(n).tobl, a = Math.cos(i), c = Math.sin(i);
		return xt(new P(r, o, s, n), a, c);
	}
	function u1(t, n, e, r, o) {
		K0(e), T1(r), T1(o);
		const s = E(n), i = O2(s, e), a = e0(t, s, o), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
		return b2(r ? b1(c, s, C.From2000) : c, s);
	}
	function Ge(t, n, e) {
		const r = E(t);
		let o = wt(n, S0(r)).pos;
		return e || (o = b1(o, r, C.Into2000)), gt(o, r);
	}
	function Qe(t, n, e) {
		const r = E(t), o = wt(n, S0(r)), s = new F(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
		return e ? s : $e(s, r, C.Into2000);
	}
	function Be(t, n) {
		const e = S0(t.t);
		let r = [
		...
		return n || (r = G0(r, t.t, C.From2000), r = Q0(r, t.t, C.From2000)), Fe(r, e);
	}
	function qe(t, n) {
	...
	function l1(t) {
		const n = R0(t.t), [e, r, o] = Q0(G0([
			...
			t.y,
			t.z
		], t.t, C.From2000), t.t, C.From2000), s = new P(e, r, o, t.t), i = n.tobl * p;
		return xt(s, Math.cos(i), Math.sin(i));
	}
	function a0(t) {
		const n = E(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = G0(ke(n, [
	...
	function $1(t) {
		const n = E(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = gt(Q0(I2(s.mobl, o), n, C.From2000), n), a = s.tobl * p, c = xt(i, Math.cos(a), Math.sin(a));
	...
	const Y0 = 365250, Dt = 0, It = 1, J1 = 2;
	function Pt(t) {
	...
	function j0(t, n) {
		const e = n.tt / Y0;
		return Pt(F2(z0(t[Dt], e, !0), z0(t[It], e, !1), z0(t[J1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / Y0, r = z0(t[Dt], e, !0), o = z0(t[It], e, !1), s = z0(t[J1], e, !1), i = vt(t[Dt], e), a = vt(t[It], e), c = vt(t[J1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, y = F2(r, o, s), g = [
			_ / Y0,
			M / Y0,
			A / Y0
		];
		return new N0(n, Pt(y), Pt(g));
	}
	function H1(t, n, e, r) {
	...
	function Ke(t) {
		...
		return H1(n, t, f.Jupiter, V0), H1(n, t, f.Saturn, F0), H1(n, t, f.Uranus, $0), H1(n, t, f.Neptune, J0), n;
	}
	const zt = 51, Ye = 29200, W0 = 146, p0 = 201, T0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function Lt(t) {
		const n = je(t), e = new M1(n.tt), r = n.r.add(e.Sun.r), o = n.v.add(e.Sun.v), s = e.Acceleration(r);
		return new $2(e, new Tt(n.tt, r, o, s));
	}
	function Xe(t, n) {
		const e = T0[0][0];
		if (n < e || n > T0[zt - 1][0]) return null;
		const r = J2((n - e) / Ye, zt - 1);
		if (!t[r]) {
			const s = t[r] = [];
	...
	function Ot(t, n) {
		...
		const s = Xe(We, t.tt);
		if (s) {
			const i = J2((t.tt - s[0].tt) / W0, p0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = X0(t.tt - a.tt, a.r, a.v, u), l = Nt(t.tt - a.tt, a.v, u), d = X0(t.tt - c.tt, c.r, c.v, u), _ = Nt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
	...
	function U0(t, n) {
		...
		if (e) return e.dist;
		const r = E(n);
		return t in q ? z0(q[t][J1], r.tt / Y0, !1) : c0(t, r).Length();
	}
	function Q2(t, n) {
		let e = n, r = 0;
		for (let o = 0; o < 10; ++o) {
	...
	function H(t, n, e, r) {
		...
		for (;;) {
			...
			let d = Oe(n, e, .5), _ = d.ut - n.ut;
			if (Math.abs(_) < s) return d;
			l ? c = t(d) : l = !0;
			let M = o3(d.ut, e.ut - d.ut, i, c, a);
			if (M) {
				let A = E(M.t), y = t(A);
				if (M.df_dt !== 0) {
	...
	function Ct(t, n, e) {
		...
		const r = E(e), o = l1(e0(t, r, !1)), s = l1(e0(n, r, !1));
	...
	function q1(t, n) {
		...
		if (t === f.Sun) a = ye + 5 * Math.log10(c);
		else if (t === f.Moon) a = a3(o, u, c);
		else if (t === f.Saturn) {
			const l = i3(o, u, c, i, e);
	...
	function c3(t) {
		return j2(new Date(t.time.date.getTime() + 6 * we));
	}
	var W2 = class {
		constructor(t, n, e) {
	...
	function l3(t) {
		switch (t) {
			...
			case f.Moon: return me;
			default: return 0;
		}
	}
	function h3(t, n, e, r, o, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = l3(t), a = X2(n.height - s);
		return Z2(t, n, e, r, o, i, u3(n, s) - De * a.density);
	}
	function f3(t, n, e, r, o, s) {
	...
	function bt(t, n, e, r, o, s, i) {
		if (s < 0 && i >= 0) return new d3(r, o, s, i);
	...
	function Z2(t, n, e, r, o, s, i) {
		...
		function u(A) {
			...
			return e * (F1(A, n, y.ra, y.dec).altitude + b * Math.asin(s / y.dist) - i);
		}
		const h = E(r);
	...
	function p3(t, n, e) {
		const r = E(n), o = U2(r), s = u1(t, r, e, !0, !0);
	...
	function A3(t, n) {
		...
		let i = 0;
		for (; ++i <= 2;) {
			let a = Z0(O0(t, o) - O0(f.Earth, o)), c, u, h;
	...
	function E3(t, n) {
		...
		let a = 0;
		for (; ++a <= 2;) {
			let c = Z0(O0(t, o) - O0(f.Earth, o)), u, h, l;
	...
	function an(t, n) {
		if (n = E(n), t === f.Neptune || t === f.Pluto) return w3(t, n);
		function e(c) {
	...
	function j1(t) {
		return t = E(t), v0(O1(t, C.From2000), k1(t, C.From2000));
	}
	function I3(t) {
		const n = E(t);
		return v0(j1(n), _n(n));
	...
	function W1(t) {
		return t = E(t), v0(k1(t, C.Into2000), O1(t, C.Into2000));
	}
	function $t(t, n) {
		t = E(t);
	...
	function C3(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Jt || (Jt = j1(new g0(-45655.74141261017)), An = new g0(0));
		const e = K1(new B0(n, 15 * t, 1), An), r = Vt(E1(Jt, e)), o = 10 / 240, s = o / 15;
		for (let i of O3) {
	...
	function y1(t, n, e, r) {
		...
		return new k3(n, o, L * Math.hypot(s, i, a), +i1 - (1 + o) * (i1 - t), -i1 + (1 + o) * (i1 + t), e, r);
	}
	function X1(t) {
		const n = e0(f.Sun, t, !0), e = new P(-n.x, -n.y, -n.z, n.t);
		return y1(xe, t, a0(t), e);
	}
	function wn(t) {
	...
	function Ht(t, n) {
		const e = O2(t, n), r = e0(f.Sun, t, !0), o = a0(t), s = new P(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
	...
	function $3(t, n, e) {
		const o = H((s) => b3(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function Rn(t, n) {
		const e = new P(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = gn(Math.asin(w2 / e.Length()), Math.asin(ve / n.Length()), N1(n, e) * p);
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (i.r < i.p + j) {
					...
					return i.r < i.k + j && (a = X.Partial, h = Qt(i.time, i.k + j, l), i.r + j < i.k ? (a = X.Total, c = 1, u = Qt(i.time, i.k - j, h)) : c = gn(j, i.k, i.r)), new yn(a, c, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function H3(t) {
		...
		if (_ > 0) {
			...
			const x = r1(i);
			let z = new P(y / L, g / L, R / L, t.time);
			z = E1(x, z), z.x += t.target.x, z.y += t.target.y, z.z += t.target.z;
			const I = y1(R2, t.time, z, t.dir);
	...
	function Cn(t, n) {
		...
		for (;;) {
			...
			if (n1(t, i) < e) {
				const a = $3(t, o, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-r), u = On(t, o, c, a.time, -1), h = a.time.AddDays(+r), l = On(t, o, a.time, h, 1), d = 60 * n1(t, a.time);
	...
	function Vn(t) {
		let n = E(t), e = $1(n);
		for (;;) {
			const r = n.AddDays(bn), o = $1(r);
			if (e.lat * o.lat <= 0) {
				const s = o.lat > e.lat ? _0.Ascending : _0.Descending, i = H((a) => s * $1(a).lat, n, r);
	...
	function X3(t) {
		const n = G0(Q0([
			...
			0,
			1
		], t, C.Into2000), t, C.Into2000), e = new P(n[0], n[1], n[2], t), r = Vt(e), o = 190.41375788700253 + 360.9856122880876 * t.ut;
	...
	var n4 = class t0 {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = W(r, n.tt, f.Mercury, pt), e[f.Venus] = W(r, n.tt, f.Venus, _t), e[f.Earth] = W(r, n.tt, f.Earth, c1 + z1), e[f.Mars] = W(r, n.tt, f.Mars, At), e[f.Jupiter] = W(r, n.tt, f.Jupiter, V0), e[f.Saturn] = W(r, n.tt, f.Saturn, F0), e[f.Uranus] = W(r, n.tt, f.Uranus, $0), e[f.Neptune] = W(r, n.tt, f.Neptune, J0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new N0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = K.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, _t), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + z1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, At), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, V0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, $0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, J0);
		}
	...
	const { MakeTime: w4, SearchRiseSet: g4, Body: R4, Observer: e4 } = nt(v1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: D4, CombineRotation: I4, MakeRotation: P4 } = nt(v1);
	Math.PI / (180 * 3600);
	const { HelioState: T4 } = nt(v1), r4 = 86400;
	function o4(t) {
	...
	function Jn(t, n) {
		...
		switch (e.type) {
			...
			case "step": {
				...
				const o = t.jd + t.speed * r / r4, s = Math.max(ut, Math.min(lt, o)), i = {
					...t,
					jd: s
				}, a = [{
					type: "tick",
