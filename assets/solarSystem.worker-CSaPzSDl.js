(function() {
	var s2 = Object.defineProperty, ce = (t, n) => {
		let e = {};
	...
	2 * Math.PI;
	const le = Math.PI / 180;
	180 / Math.PI;
	const ct = 86400, he = 365.25, a2 = ct * 1e3, i2 = 2451545, c2 = 2440587.5, y0 = 299792.458, ut = y0 * he * ct, T = 149597870.7, lt = 648e3 / Math.PI, de = lt * T / ut, Me = 23.4392911, Ae = 1e3, Se = y0, _e = y0 ** Math.sqrt(Math.E), Ee = y0 ** 2, pe = y0 ** Math.E, ye = [
		1,
		Ae,
		Se,
		_e
	...
	var R1 = (t, n, e) => Object.defineProperty(t, n, {
		value: e,
		enumerable: !1,
		writable: !0,
		configurable: !0
	}), xe = Symbol.for("bitecs-relation"), ge = Symbol.for("bitecs-pairTarget"), we = Symbol.for("bitecs-isPairComponent"), Te = Symbol.for("bitecs-relationData"), f2 = () => {
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				R1(r, xe, n), R1(r, ge, o), R1(r, we, !0), t.pairsMap.set(o, r);
			}
	...
	function De() {
		let t = f2();
		return Object.defineProperty(t, Ne, {
			value: !0,
			enumerable: !1,
			writable: !1,
			configurable: !1
	...
	Pe();
	const ze = 384399 / T, Ce = 421800 / T, be = 671034 / T, Le = 1070400 / T, ke = 1882700 / T, Be = 9376 / T, Ke = 23463 / T, He = 185540 / T, Je = 237948 / T, Ve = 294619 / T, Fe = 377396 / T, Ge = 527108 / T, $e = 1221870 / T, Ye = 3560820 / T, je = 129390 / T, Qe = 190900 / T, qe = 266e3 / T, Xe = 436300 / T, We = 583520 / T, Ze = 354759 / T, t3 = {
		[d.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	Object.fromEntries(Object.entries(t3).map(([t, n]) => [t, n3(n)]));
	new TextEncoder();
	new TextDecoder();
	new TextEncoder();
	new TextDecoder("utf-8");
	const S2 = Symbol("Comlink.proxy"), e3 = Symbol("Comlink.endpoint"), o3 = Symbol("Comlink.releaseProxy"), ft = Symbol("Comlink.finalizer"), I1 = Symbol("Comlink.thrown"), _2 = (t) => typeof t == "object" && t !== null || typeof t == "function", E2 = /* @__PURE__ */ new Map([["proxy", {
		canHandle: (t) => _2(t) && t[S2],
		serialize(t) {
	...
	function dt(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			Promise.resolve(u).catch((l) => ({
				...
				const [h, M] = T1(l);
				n.postMessage(Object.assign(Object.assign({}, h), { id: s }), M), a === "RELEASE" && (n.removeEventListener("message", o), p2(n), ft in t && typeof t[ft] == "function" && t[ft]());
			}).catch((l) => {
				const [h, M] = T1({
	...
	function Mt(t, n, e = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(a, c, i) {
				...
				if (u === e3) return b0(t, n, { type: "ENDPOINT" }).then(D0);
	...
	function m2(t) {
		const n = t.map(T1);
		return [n.map((e) => e[0]), u3(n.map((e) => e[1]))];
	}
	...
	var s1 = ce({
		...
		MoonPhase: () => kt,
		MoonQuarter: () => en,
		NextGlobalSolarEclipse: () => X4,
		NextLocalSolarEclipse: () => t6,
		NextLunarApsis: () => w4,
		NextLunarEclipse: () => q4,
		NextMoonNode: () => o6,
		NextMoonQuarter: () => M4,
		...
		SearchLunarApsis: () => fn,
		SearchLunarEclipse: () => Un,
		SearchMaxElongation: () => x4,
		SearchMoonNode: () => $n,
		SearchMoonPhase: () => M1,
		SearchMoonQuarter: () => on,
		SearchPeakMagnitude: () => g4,
		SearchPlanetApsis: () => Mn,
		SearchRelativeLongitude: () => t1,
		SearchRiseSet: () => _4,
		SearchSunLongitude: () => tn,
		SearchTransit: () => Vn,
		SeasonInfo: () => un,
		Seasons: () => I4,
	...
	const N1 = 173.1446326846693, z = 149597870.69098932, I2 = 63241.07708807546, _ = .017453292519943295, At = .26179938779914946, k = 57.29577951308232, St = 3.819718634205488, d3 = 71492, M3 = 66854, A3 = 69911, S3 = 1821.6, _3 = 1560.8, E3 = 2631.2, p3 = 2410.3, x2 = 365.24217, g2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, m0 = 3600 * (180 / Math.PI), L0 = 484813681109536e-20, w2 = 648e3, y3 = 2 * w2, m3 = 7292115e-11, R3 = w2 / Math.PI, I3 = -.17 - 5 * Math.log10(R3), D1 = 29.530588, O1 = 86400, x3 = O1 * 1e3, T2 = .9972695717592592, _t = 695700, N2 = _t / z, s0 = .996647180302104, U1 = s0 * s0, M0 = 6378.1366, g3 = M0 / z, w3 = M0 * s0, T3 = 6371, N3 = 6459, D3 = 1738.1 / z, X = 1737.4, D2 = 1736, O3 = D2 / z, U3 = 34 / 60, v3 = 81.30056, a1 = .0002959122082855911, Et = 4912547451450812e-26, pt = 7243452486162703e-25, O2 = 8887692390113509e-25, yt = 9549535105779258e-26, k0 = 2.825345909524226e-7, B0 = 8.459715185680659e-8, K0 = 1.292024916781969e-8, H0 = 1.524358900784276e-8, P3 = 218869976542597e-26, z3 = O2 / v3;
	function mt(t) {
		switch (t) {
			case f.Sun: return a1;
			case f.Mercury: return Et;
			case f.Venus: return pt;
			case f.Earth: return O2;
	...
	var R0 = class it {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - g2.getTime()) / e, this.tt = P2(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(g2.getTime() + n * e), this.ut = n, this.tt = P2(this.ut);
				return;
			}
	...
	function I0(t) {
		if (!C1 || Math.abs(C1.tt - t.tt) > 1e-6) {
			const n = J3(t), e = z2(t), o = e + n.deps / 3600;
			C1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function x0(t) {
		...
		var f0 = P(.19833 + .05611 * n), Zt = P(.27869 + .04508 * n), t2 = P(.16827 - .36903 * n), n2 = P(.34734 - 5.37261 * n), e2 = P(.10498 - 5.37899 * n), at = P(.42681 - .41855 * n), D6 = P(.14943 - 5.37511 * n);
		for (v = .84 * f0 + .31 * Zt + 14.27 * t2 + 7.26 * n2 + .28 * e2 + .24 * at, L = 2.94 * f0 + .31 * Zt + 14.27 * t2 + 9.34 * n2 + 1.12 * e2 + .83 * at, B = -6.4 * f0 - 1.89 * at, Q = .21 * f0 + .31 * Zt + 14.27 * t2 - 88.7 * n2 - 15.3 * e2 + .24 * at - 1.86 * D6, G = v - B, y = -3332e-9 * P(.59734 - 5.37261 * n) - 539e-9 * P(.35498 - 5.37899 * n) - 64e-9 * P(.39943 - 5.37511 * n), E = n0 * J0(.60643382 + 1336.85522467 * n - 313e-8 * M) + v / m0, I = n0 * J0(.37489701 + 1325.55240982 * n + 2565e-8 * M) + L / m0, w = n0 * J0(.99312619 + 99.99735956 * n - 44e-8 * M) + B / m0, g = n0 * J0(.25909118 + 1342.2278298 * n - 892e-8 * M) + Q / m0, D = n0 * J0(.82736186 + 1236.85308708 * n - 397e-8 * M) + G / m0, l = 1; l <= 4; ++l) {
			switch (l) {
				case 1:
		...
		p = 0, p += d0(-526.069, 0, 0, 1, -2), p += d0(-3.352, 0, 0, 1, -4), p += d0(44.297, 1, 0, 1, -2), p += d0(-6, 1, 0, 1, -4), p += d0(20.599, -1, 0, 1, 0), p += d0(-30.598, -1, 0, 1, -2), p += d0(-24.649, -2, 0, 1, 0), p += d0(-2, -2, 0, 1, -2), p += d0(-22.571, 0, 1, 1, -2), p += d0(10.985, 0, -1, 1, -2), A += .82 * P(.7736 - 62.5512 * n) + .31 * P(.0466 - 125.1025 * n) + .35 * P(.5785 - 25.1042 * n) + .66 * P(.4591 + 1335.8075 * n) + .64 * P(.313 - 91.568 * n) + 1.14 * P(.148 + 1331.2898 * n) + .21 * P(.5918 + 1056.5859 * n) + .44 * P(.5784 + 1322.8595 * n) + .24 * P(.2275 - 5.7374 * n) + .28 * P(.2965 + 2.6929 * n) + .33 * P(.3132 + 6.3368 * n), a = g + q / m0;
		let O6 = (1.000002708 + 139.978 * y) * (18518.511 + 1.189 + x) * Math.sin(a) - 6.24 * Math.sin(3 * a) + p;
		return {
			geo_eclip_lon: n0 * J0((E + A / m0) / n0),
			geo_eclip_lat: Math.PI / 648e3 * O6,
			distance_au: m0 * g3 / (.999953253 * R)
		};
	}
	var L2 = class {
	...
	function $3(t, n) {
		...
		let a, c, i;
		if (s < 1e-6) a = 0, c = r > 0 ? 90 : -90, i = Math.abs(r) - w3;
		else {
			...
			for (;;) {
				...
				const p = -.006694397995865464 * M0, x = l * l, R = h * h, E = x + U1 * R;
				M = Math.sqrt(E);
			...
			c = k * u;
			const A = M0 / M;
			Math.abs(h) > Math.abs(l) ? i = r / h - U1 * A : i = s / l - A;
		}
		return new gt(c, a, 1e3 * i);
	}
	function It(t, n) {
		const e = t.latitude * _, o = Math.sin(e), r = Math.cos(e), s = 1 / Math.hypot(r, s0 * o), a = U1 * s, c = t.height / 1e3, i = M0 * s + c, u = M0 * a + c, l = (15 * n + t.longitude) * _, h = Math.sin(l), M = Math.cos(l);
		return {
			pos: [
				i * r * M / z,
				i * r * h / z,
	...
	function k1(t, n) {
		const e = I0(t), o = e.mobl * _, r = e.tobl * _, s = e.dpsi * L0, a = Math.cos(o), c = Math.sin(o), i = Math.cos(r), u = Math.sin(r), l = Math.cos(s), h = Math.sin(s), M = l, y = -h * a, A = -h * c, p = h * i, x = l * a * i + c * u, R = l * c * i - a * u, E = h * u, I = l * a * u - c * i, w = l * c * u + a * i;
		if (n === b.From2000) return new V([
			[
				M,
				p,
	...
	function Y3(t, n, e) {
		return e === b.Into2000 ? B2(H2(t, n, e), n, e) : H2(B2(t, n, e), n, e);
	}
	function J2(t, n) {
		const e = It(n, A0(t)).pos;
		return B1(e, t, b.Into2000);
	}
	var O = class {
		constructor(t, n, e, o) {
	...
	function H1(t, n, e, o, r) {
		let s = m(t);
		Y0(n), N(e), N(o);
		const a = Math.sin(n.latitude * _), c = Math.cos(n.latitude * _), i = Math.sin(n.longitude * _), u = Math.cos(n.longitude * _), l = Math.sin(o * _), h = Math.cos(o * _), M = Math.sin(e * At), y = Math.cos(e * At);
		let A = [
			c * u,
			c * i,
			a
	...
	function $2(t) {
		const n = m(t).AddDays(-1 / N1), e = Q0(Y.Earth, n), [o, r, s] = B1([
			-e.x,
			-e.y,
			-e.z
	...
	function i1(t, n, e, o, r) {
		Y0(e), v1(o), v1(r);
		const s = m(n), a = J2(s, e), c = e0(t, s, r), i = [
			c.x - a[0],
			c.y - a[1],
			c.z - a[2]
		];
		return G2(o ? B1(i, s, b.From2000) : i, s);
	}
	function q3(t, n, e) {
		const o = m(t);
		let r = It(n, A0(o)).pos;
		return e || (r = B1(r, o, b.Into2000)), xt(r, o);
	}
	function X3(t, n, e) {
		const o = m(t), r = It(n, A0(o)), s = new H(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
		return e ? s : Y3(s, o, b.Into2000);
	}
	function W3(t, n) {
		const e = A0(t.t);
		let o = [
		...
		return n || (o = V0(o, t.t, b.From2000), o = F0(o, t.t, b.From2000)), $3(o, e);
	}
	function Z3(t, n) {
	...
	function wt(t, n, e) {
		...
		return new F2(new O(o, r, s, t.t), i, c);
	}
	function c1(t) {
	...
	function i0(t) {
		const n = m(t), e = x0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = V0(V3(n, [
	...
	function J1(t) {
		const n = m(t), e = x0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			o * Math.cos(e.geo_eclip_lon),
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = I0(n), a = xt(F0(C2(s.mobl, r), n, b.From2000), n), c = s.tobl * _, i = wt(a, Math.cos(c), Math.sin(c));
	...
	const j0 = 365250, Dt = 0, Ot = 1, V1 = 2;
	function Ut(t) {
	...
	function Q0(t, n) {
		const e = n.tt / j0;
		return Ut(Y2(O0(t[Dt], e, !0), O0(t[Ot], e, !1), O0(t[V1], e, !1))).ToAstroVector(n);
	}
	function l1(t, n) {
		const e = n / j0, o = O0(t[Dt], e, !0), r = O0(t[Ot], e, !1), s = O0(t[V1], e, !1), a = Nt(t[Dt], e), c = Nt(t[Ot], e), i = Nt(t[V1], e), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), M = Math.sin(r), y = +(i * h * u) - s * M * u * c - s * h * l * a, A = +(i * h * l) - s * M * l * c + s * h * u * a, p = +(i * M) + s * h * c, x = Y2(o, r, s), R = [
			y / j0,
			A / j0,
			p / j0
		];
	...
	function t4(t) {
		...
		return F1(n, t, f.Jupiter, k0), F1(n, t, f.Saturn, B0), F1(n, t, f.Uranus, K0), F1(n, t, f.Neptune, H0), n;
	}
	const n4 = 29200, G1 = 146, U0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function zt(t, n) {
		...
		return new j2(o, new vt(t, a, n.v.add(s.mul(e)), o.Acceleration(a)));
	}
	const o4 = [];
	function Q2(t, n) {
	...
	function Ct(t) {
		const n = e4(t), e = new f1(n.tt), o = n.r.add(e.Sun.r), r = n.v.add(e.Sun.v), s = e.Acceleration(o);
		return new j2(e, new vt(n.tt, o, r, s));
	}
	function r4(t, n) {
		const e = U0[0][0];
		if (n < e || n > U0[50][0]) return null;
		const o = Q2((n - e) / n4, 50);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Ct(U0[o]).grav, s[200] = Ct(U0[o + 1]).grav;
			let a, c = s[0].tt;
			for (a = 1; a < 200; ++a) s[a] = zt(c += G1, s[a - 1]).grav;
			c = s[200].tt;
			var r = [];
			for (r[200] = s[200], a = 199; a > 0; --a) r[a] = zt(c -= G1, r[a + 1]).grav;
			for (a = 199; a > 0; --a) {
				const i = a / 200;
	...
	function bt(t, n) {
		...
		const s = r4(o4, t.tt);
		if (s) {
			const a = Q2((t.tt - s[0].tt) / G1, 200), c = s[a], i = s[a + 1], u = c.a.mean(i.a), l = q0(t.tt - c.tt, c.r, c.v, u), h = Pt(t.tt - c.tt, c.v, u), M = q0(t.tt - i.tt, i.r, i.v, u), y = Pt(t.tt - i.tt, i.v, u), A = (t.tt - c.tt) / G1;
			e = l.mul(1 - A).add(M.mul(A)), o = h.mul(1 - A).add(y.mul(A));
		} else {
			let a;
			t.tt < U0[0][0] ? a = q2(U0[0], t.tt, -146) : a = q2(U0[50], t.tt, 146), e = a.grav.r, o = a.grav.v, r = a.bary;
		}
	...
	function i4(t) {
		const n = new R0(t);
		return new X2(Y1(n, $1[0]), Y1(n, $1[1]), Y1(n, $1[2]), Y1(n, $1[3]));
	}
	function c0(t, n) {
		var e = m(n);
		...
		if (t === f.SSB) return t4(e);
		const s = z1(t);
		if (s) return q1(new G0(s.dec, 15 * s.ra, s.dist), e);
	...
	function P0(t, n) {
		...
		if (e) return e.dist;
		const o = m(n);
		return t in Y ? O0(Y[t][V1], o.tt / j0, !1) : c0(t, o).Length();
	}
	function W2(t, n) {
		let e = n, o = 0;
		for (let r = 0; r < 10; ++r) {
			const s = t(e), a = s.Length() / N1;
	...
	function Z2(t, n, e, o) {
		...
		if (z1(e)) {
			const c = c0(e, r);
			if (o) {
				const u = j1(n, r), l = new O(c.x - u.x, c.y - u.y, c.z - u.z, r), h = N1 / l.Length();
	...
	function Lt(t, n, e) {
		...
		const o = m(e), r = c1(e0(t, o, !1)), s = c1(e0(n, o, !1));
	...
	function Q1(t, n) {
		...
		const e = m(n), o = Q0(Y.Earth, e);
		let r, s, a, c;
		t === f.Sun ? (a = new O(-o.x, -o.y, -o.z, e), s = new O(0, 0, 0, e), r = 0) : (t === f.Moon ? (a = i0(e), s = new O(o.x + a.x, o.y + a.y, o.z + a.z, e)) : (s = c0(t, n), a = new O(s.x - o.x, s.y - o.y, s.z - o.z, e)), r = P1(a, s));
		let i = a.Length(), u = s.Length(), l;
		if (t === f.Sun) c = I3 + 5 * Math.log10(i);
		else if (t === f.Moon) c = d4(r, u, i);
		else if (t === f.Saturn) {
			const h = f4(r, u, i, a, e);
			c = h.mag, l = h.ring_tilt;
		} else c = h4(t, r, u, i);
		return new nn(e, c, r, u, i, a, s, l);
	}
	function d1(t) {
	...
	function t1(t, n, e) {
		...
		let a = d1(t), c = m(e), i = s(c);
		i > 0 && (i -= 360);
		for (let u = 0; u < 100; ++u) {
			let l = -i / 360 * a;
			if (c = c.AddDays(l), Math.abs(l) * O1 < 1) return c;
			let h = i;
	...
	function M1(t, n, e) {
		...
		let a = o(s), c, i, u;
		if (e < 0) {
			if (a < 0 && (a += 360), c = -(D1 * a) / 360, u = c + r, u < e) return null;
			i = Math.max(e, c - r);
		} else {
			if (a > 0 && (a -= 360), c = -(D1 * a) / 360, i = c - r, i > e) return null;
			u = Math.min(e, c + r);
		}
	...
	function M4(t) {
		return on(new Date(t.time.date.getTime() + 6 * x3));
	}
	var rn = class {
		constructor(t, n, e) {
	...
	function _4(t, n, e, o, r, s = 0) {
		...
		const a = S4(t), c = sn(n.height - s);
		return an(t, n, e, o, r, a, A4(n, s) - U3 * c.density);
	}
	function E4(t, n, e, o, r, s) {
	...
	function Bt(t, n, e, o, r, s, a) {
		if (s < 0 && a >= 0) return new p4(o, r, s, a);
		if (s >= 0 && a < 0) return null;
		if (t > 17) throw "Excessive recursion in rise/set ascent search.";
		const c = r.ut - o.ut;
		if (c * O1 < 1 || Math.min(Math.abs(s), Math.abs(a)) > e * (c / 2)) return null;
	...
	function y4(t, n) {
		...
		const r = _ * n;
		return Math.abs((360 / T2 - e) * Math.cos(r)) + Math.abs(o * Math.sin(r));
	}
	function an(t, n, e, o, r, s, a) {
		if (Y0(n), N(r), N(s), N(a), a < -90 || a > 90) throw `Invalid target altitude angle: ${a}`;
		const c = y4(t, n.latitude);
		function i(A) {
			const p = i1(t, A, n, !0, !0);
			return e * (H1(A, n, p.ra, p.dec).altitude + k * Math.asin(s / p.dist) - a);
		}
		const u = m(o);
		let l = u, h = u, M = i(l), y = M;
		for (;;) {
			r < 0 ? (l = h.AddDays(-.42), M = i(l)) : (h = l.AddDays(.42), y = i(h));
			const A = Bt(0, i, c, l, h, M, y);
			if (A) {
	...
	function m4(t, n, e, o, r = 1) {
		...
		for (;;) {
			...
			if (a === 1 ? r > 0 ? u < 0 && (u += 24) : u > 0 && (u -= 24) : u < -12 ? u += 24 : u > 12 && (u -= 24), Math.abs(u) * 3600 < .1) {
				const h = H1(s, n, i.ra, i.dec, "normal");
				return new cn(s, h);
			}
			let l = u / 24 * T2;
			s = s.AddDays(l);
	...
	function R4(t, n, e) {
		const o = m(n), r = K2(o), s = i1(t, o, e, !0, !0);
	...
	function I4(t) {
		function n(a, c, i) {
			let u = new Date(Date.UTC(t, c - 1, i)), l = tn(a, u, 20);
		...
		return new un(n(0, 3, 10), n(90, 6, 10), n(180, 9, 10), n(270, 12, 10));
	}
	var ln = class {
		constructor(t, n, e, o) {
	...
	function hn(t, n) {
		let e = m(n), o = Lt(t, f.Sun, e), r;
		o > 180 ? (r = "morning", o = 360 - o) : r = "evening";
		let s = Z0(t, e);
		return new ln(e, r, s, o);
	}
	function x4(t, n) {
		function o(c) {
		...
		for (; ++a <= 2;) {
			...
			let h = r.AddDays(l), M = t1(t, i, h), y = t1(t, u, M), A = o(M);
	...
	function g4(t, n) {
		...
		for (; ++s <= 2;) {
			...
			let l = r.AddDays(u), h = t1(t, c, l), M = t1(t, i, h), y = o(h);
	...
	function T4(t, n) {
		...
		const l = dn(t, 0, s.AddDays(-2 * u), 4 * u), h = dn(t, 1, a.AddDays(-2 * u), 4 * u);
	...
	function Mn(t, n) {
		if (n = m(n), t === f.Neptune || t === f.Pluto) return T4(t, n);
		function e(i) {
	...
	function N4(t, n) {
		...
		const e = .25 * a0[t].OrbitalPeriod, o = Mn(t, n.time.AddDays(e));
	...
	function U4(t, n) {
		const e = Ht(t);
		return e.lon = An(e.lon), e.lat += S1(n, e.lat), e;
	}
	function v4(t, n, e) {
		n = m(n);
		const o = An(t.lon);
		return q1(new G0(t.lat + Sn(e, t.lat), o, t.dist), n);
	}
	function S1(t, n) {
		let e;
	...
	function W1(t) {
		return t = m(t), w0(b1(t, b.From2000), k1(t, b.From2000));
	}
	function z4(t) {
		const n = m(t);
		return w0(W1(n), xn(n));
	...
	function Z1(t) {
		return t = m(t), w0(k1(t, b.Into2000), b1(t, b.Into2000));
	}
	function Jt(t, n) {
		t = m(t);
	...
	function In(t) {
		const n = I0(m(t)).tobl * _, e = Math.cos(n), o = Math.sin(n);
		return new V([
			[
				1,
				0,
	...
	function J4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Vt || (Vt = W1(new R0(-45655.74141261017)), gn = new R0(0));
		const e = q1(new G0(n, 15 * t, 1), gn), o = Kt(_1(Vt, e)), r = 10 / 240, s = r / 15;
		for (let a of H4) {
			const c = a[3] * r, i = a[1] * s, u = a[2] * s;
			if (c <= o.dec && i <= o.ra && o.ra < u) {
				const l = K4[a[0]];
				return new wn(l[0], l[1], o.ra, o.dec);
			}
		}
	...
	function E1(t, n, e, o) {
		...
		return new V4(n, r, z * Math.hypot(s, a, c), 695700 - (1 + r) * (_t - t), -695700 + (1 + r) * (_t + t), e, o);
	}
	function tt(t) {
	...
	function Ft(t, n) {
		const e = J2(t, n), o = e0(f.Sun, t, !0), r = i0(t), s = new O(e[0] - r.x, e[1] - r.y, e[2] - r.z, t);
	...
	function F4(t, n, e) {
		const o = 11574074074074073e-21, r = nt(t, n, e.AddDays(-11574074074074073e-21));
		return (nt(t, n, e.AddDays(11574074074074073e-21)).r - r.r) / o;
	}
	function G4(t) {
		const n = F((e) => Gt(tt, e), t.AddDays(-.03), t.AddDays(.03));
		if (!n) throw "Failed to find peak Earth shadow time.";
		return tt(n);
	}
	function $4(t) {
		const n = F((e) => Gt(Nn, e), t.AddDays(-.03), t.AddDays(.03));
		if (!n) throw "Failed to find peak Moon shadow time.";
		return Nn(n);
	}
	function Y4(t, n, e) {
		const o = F((r) => F4(t, n, r), e.AddDays(-1), e.AddDays(1));
	...
	function $t(t, n, e) {
		const o = e / 1440, r = t.AddDays(-o), s = t.AddDays(+o), a = F((i) => -(tt(i).r - n), r, t), c = F((i) => +(tt(i).r - n), t, s);
	...
	function On(t, n) {
		const e = new O(t.x + n.x, t.y + n.y, t.z + n.z, t.t), o = Dn(Math.asin(N2 / e.Length()), Math.asin(O3 / n.Length()), P1(n, e) * _);
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (a.r < a.p + X) {
					...
					return a.r < a.k + X && (c = Z.Partial, l = $t(a.time, a.k + X, h), a.r + X < a.k ? (c = Z.Total, i = 1, u = $t(a.time, a.k - X, l)) : i = Dn(X, a.k, a.r)), new Tn(c, i, a.time, h, l, u);
				}
			}
			e = r.AddDays(10);
		}
	...
	function Q4(t) {
		...
		const a = W1(t.time), c = _1(a, t.dir), i = _1(a, t.target);
		...
		let A;
		if (y > 0) {
			const p = (-h - Math.sqrt(y)) / (2 * l), x = p * c.x - i.x, R = p * c.y - i.y, E = (p * c.z - i.z) * s0, I = Math.hypot(x, R) * U1;
			...
			const v = E1(D2, t.time, D, t.dir);
			if (v.r > 1e-9 || v.r < 0) throw `Unexpected shadow distance from geoid intersection = ${v.r}`;
			n = Pn(v.k), A = n === Z.Total ? 1 : On(t.dir, D);
		} else A = void 0;
		return new vn(n, A, e, o, r, s);
	}
	function q4(t) {
		return t = m(t), Un(t.AddDays(10));
	}
	function zn(t) {
		t = m(t);
		const n = 1.8;
	...
	function W4(t, n) {
		...
		const s = et(n, 1, Ln, o, t.time), a = et(n, -1, Ln, t.time, r);
		let c, i, u;
		t.r < Math.abs(t.k) ? (o = t.time.AddDays(-.01), r = t.time.AddDays(.01), c = et(n, 1, kn, o, t.time), i = et(n, -1, kn, t.time, r), u = Pn(t.k)) : u = Z.Partial;
		const l = u === Z.Total ? 1 : On(t.dir, t.target);
		return new bn(u, l, s, c, e, i, a);
	}
	...
	function t6(t, n) {
		return t = m(t), Kn(t.AddDays(10), n);
	}
	var Hn = class {
		constructor(t, n, e, o) {
	...
	function Vn(t, n) {
		...
		for (;;) {
			...
			if (Z0(t, s) < e) {
				const a = Y4(t, o, s);
				if (a.r < a.p) {
					const c = a.time.AddDays(-1), i = Jn(t, o, c, a.time, -1), u = a.time.AddDays(1), l = Jn(t, o, a.time, u, 1), h = 60 * Z0(t, a.time);
					return new Hn(i, a.time, l, h);
				}
			}
			r = s.AddDays(10);
		}
	...
	function $n(t) {
		let n = m(t), e = J1(n);
		for (;;) {
			const o = n.AddDays(Gn), r = J1(o);
			if (e.lat * r.lat <= 0) {
				const s = r.lat > e.lat ? S0.Ascending : S0.Descending, a = F((c) => s * J1(c).lat, n, o);
	...
	function a6(t, n, e, o) {
		const r = m(n), s = mt(e), a = mt(o);
		let c, i;
		return e === f.Earth && o === f.Moon ? (c = new H(0, 0, 0, 0, 0, 0, r), i = u1(r)) : (c = j1(e, r), i = j1(o, r)), Yn(t, c, s, i, a);
	}
	function Yn(t, n, e, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const D = t == 4 ? .8660254037844386 : -.8660254037844386, v = .5 * a + D * E, L = .5 * c + D * I, B = .5 * i + D * w, Q = .5 * E - D * a, G = .5 * I - D * c, q = .5 * w - D * i, u0 = l * v, r0 = l * L, _0 = l * B, l0 = h * a + M * c + y * i, h0 = h * E + M * I + y * w;
	...
	var i6 = class t0 {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = W(o, n.tt, f.Mercury, Et), e[f.Venus] = W(o, n.tt, f.Venus, pt), e[f.Earth] = W(o, n.tt, f.Earth, 8997011346712498e-25), e[f.Mars] = W(o, n.tt, f.Mars, yt), e[f.Jupiter] = W(o, n.tt, f.Jupiter, k0), e[f.Saturn] = W(o, n.tt, f.Saturn, B0), e[f.Uranus] = W(o, n.tt, f.Uranus, K0), e[f.Neptune] = W(o, n.tt, f.Neptune, H0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new v0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = j.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, Et), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, 8997011346712498e-25), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, yt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, k0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, B0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, K0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, H0);
		}
	...
	const { MakeTime: oo, SearchRiseSet: ro, Body: so, Observer: c6 } = ot(s1);
	new c6(40.7128, -74.006, 10);
	const { Body: o0 } = ot(s1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: uo, CombineRotation: lo, MakeRotation: ho } = ot(s1);
	Math.PI / 648e3;
	const u6 = (t) => t, p1 = (t, n, e) => u6(me(t, n, e));
	Me * le;
	const e1 = (() => {
		const t = s1;
	...
	function h6(t) {
		const n = Qn.get(t);
		if (n) return n;
		const e = e1.MakeTime(/* @__PURE__ */ new Date(10957.5 * a2)), o = e1.RotationAxis(l6(t), e).north, r = Math.sqrt(o.x * o.x + o.y * o.y + o.z * o.z), s = p1(o.x / r, o.y / r, o.z / r);
		return Qn.set(t, s), s;
	}
	function f6(t, n) {
		const e = /* @__PURE__ */ new Date((n - c2) * a2), o = e1.MakeTime(e);
		if (t === "Moon") {
	...
	function d6(t) {
		const n = Xn.get(t);
		if (n) return n;
		const e = h6(t), r = Ie(h2(Math.abs(e.z) < .9 ? {
			x: 0,
			y: 0,
			z: 1
		} : {
	...
	function M6(t, n) {
		...
		const o = 2 * Math.PI * (n - i2) / e.periodDays, { u: r, v: s } = d6(e.parentName), a = e.semiMajorAxisKm, c = Math.cos(o), i = Math.sin(o);
	...
	function A6(t) {
		return Zn[t]?.parentBodyId ?? Qt[t]?.parentBodyId ?? null;
	}
	function S6(t, n) {
		const e = Zn[t];
		if (e) return f6(e.name, ue(n));
		const o = Qt[t];
		return o && qn[o.name] ? M6(o.name, n) : null;
	}
	const { HelioState: So, MakeTime: _o, JupiterMoons: Eo, Body: st } = ot(s1);
	d.IO, d.EUROPA, d.GANYMEDE, d.CALLISTO;
	st.Mars, st.Saturn, st.Uranus, st.Neptune;
	d.CERES, d.ERIS, d.HAUMEA, d.MAKEMAKE;
	const y1 = 1e3, te = y1 / T, ne = te * ut * de, _6 = 695700, E6 = 6378.137;
	function ee(t) {
		return !Number.isFinite(t) || t <= 0 ? 0 : t * te;
	}
	ee(E6);
	ee(_6);
	100 / lt;
	...
	function g6(t) {
		return Atomics.load(re(t), oe) === 1 ? 1 : 0;
	}
	function se(t) {
		return g6(t) === 0 ? 1 : 0;
	}
	...
	dt({
		async init(t) {
			const n = new Float32Array(t), e = I6();
