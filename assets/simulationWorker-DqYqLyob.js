(function() {
	const F = Symbol("Comlink.proxy"), nt = Symbol("Comlink.endpoint"), rt = Symbol("Comlink.releaseProxy"), g = Symbol("Comlink.finalizer"), m = Symbol("Comlink.thrown"), j = (t) => typeof t == "object" && t !== null || typeof t == "function", Y = new Map([["proxy", {
		canHandle: (t) => j(t) && t[F],
		serialize(t) {
	...
	const _t = 149597870.7, At = 648e3 / Math.PI, G = 1500, Rt = G;
	G / 15;
	100 / At;
	Rt + 500;
	const r = {
	...
	const h = W[r.EARTH]?.radiusKm ?? 6371, L = W[r.SUN]?.radiusKm ?? 696340, ft = h / L, U = .04;
	h / U;
	U / h / (15 / _t);
	function pt(t) {
		return !Number.isFinite(t) || t <= 0 ? U : t / ft * U;
	}
	function Ut(t) {
		return !Number.isFinite(t) || t <= 0 ? U : pt(t / L);
	}
	Ut(L);
	...
	function Nt(t) {
		if (!(t instanceof X)) throw `Not an instance of the Observer class: ${t}`;
	...
	var X = class {
		constructor(t, e, n) {
			this.latitude = t, this.longitude = e, this.height = n, Nt(this);
		}
	};
	new mt([
		[
