import{i as L}from"./rolldown-runtime-BOC55nOF.js";import{p as q}from"./r3f-vendor-BCy1-YIF.js";import{n as O}from"./state-data-vendor-ClC9dufS.js";import{bt as Q}from"./sceneRuntimeTypes-DQ88oEdD.js";import{n as S}from"./scenePrefsStore-BmgLHvPY.js";import{n as M}from"./appSimRuntimeHost-DDPEVp1Y.js";import{c as I}from"./titleScreenLookDirection-BcRi9AW9.js";import"./use-custom-objects-catalog-DtTPNMtP.js";import{$ as V,a as B}from"./index-wGG7-ka9.js";import{a as U,i as k,o as z,t as W}from"./r3fHostExtras-DltafJ2h.js";import{H as j,T as _,bt as G,ft as H,p as b,ut as Y,xt as p,z as P}from"./three-vendor-CKuGOTEJ.js";import{i as K,n as X,r as C}from"./dsoMajorNebula-DNYRvs0d.js";var R=L(q(),1),$=V.far/4,h=10,J=17,Z=9,ee=`
...
`;function oe(e){let o=17;for(let a=0;a<e.length;a+=1)o=(o*31+e.charCodeAt(a))%104729;return o/104729}function i(e,o){const a=Math.sin((e+o)*43758.5453123)*12589.317;return a-Math.floor(a)}function te(e){if(!Number.isFinite(e.distPc)||e.distPc<=0||!Number.isFinite(e.majAxArcmin)||(e.majAxArcmin??0)<=0)return 0;const o=P.degToRad(e.majAxArcmin/120),a=Q(e.distPc*Math.tan(o));return!Number.isFinite(a)||a<=0?0:Math.min(a,$)}function re(e,o){const a=Number.isFinite(e.majAxArcmin)?Math.max(e.majAxArcmin??0,4):4,n=Number.isFinite(e.minAxArcmin)&&(e.minAxArcmin??0)>0?Math.min(1,Math.max(.2,(e.minAxArcmin??a)/a)):null,r=e.type==="planetary_nebula"?.72+i(o,.11)*.2:.34+i(o,.11)*.42,l=n??r,f=e.type==="planetary_nebula"?Math.max(l,.72+i(o,.29)*.2):Math.max(.28,l*(.68+i(o,.29)*.3)),u=Number.isFinite(e.positionAngleDeg)?P.degToRad(e.positionAngleDeg??0):i(o,.47)*Math.PI*2,c=(i(o,.67)-.5)*(e.type==="planetary_nebula"?.22:.58),s=new p(i(o,.81)-.5,i(o,1.03)-.5,i(o,1.29)-.5);s.lengthSq()<1e-8&&s.set(.3,-.2,.5),s.normalize();const m=e.type==="planetary_nebula"?.42+i(o,1.41)*.2:.78+i(o,1.41)*.5;return{morphAngleRad:u,morphScale:new p(1,l,f),morphTiltRad:c,warpAxis:s,warpStrength:m}}function N(e){return Math.min(1,Math.max(0,e))}function x(e,o,a){return new b().setHSL(e,N(o),N(a))}function ne(e,o){if((e.openNgcTypeRaw??"").toUpperCase()==="DRKN")return{colorA:new b(1774351),colorB:new b(3416600),colorC:new b(8014375),intensityScale:.7};const a=(o%h+h)%h,n=(J/360+a/h)%1,r=a===Z,l=a%2===0?.3:.65,f=x(n,r?.32:.62,.08),u=x(n,r?.4:.9,r?.3:l),c=x(n,r?.3:.65,r?.62:.82);return e.type==="planetary_nebula"&&c.lerp(x(.52,.54,.74),.22),{colorA:f,colorB:u,colorC:c,intensityScale:e.type==="planetary_nebula"?1.6:1.4}}function ie(e,o,a,n){return{uTime:{value:0},uRadius:{value:e},uIntensity:{value:1.5*n.intensityScale},uStructureScale:{value:4.5},uQuality:{value:0},uWarpStrength:{value:a.warpStrength},uColorA:{value:n.colorA.clone()},uColorB:{value:n.colorB.clone()},uColorC:{value:n.colorC.clone()},uSeedOffset:{value:new p(o*3.1,(o+.17)*2.6,(o+.31)*4.2)},uMorphScale:{value:a.morphScale},uWarpAxis:{value:a.warpAxis},uDriftVec:{value:new p(.009+i(o,2.11)*.005,-.006+i(o,2.47)*.004,.007+i(o,2.79)*.005)},uMorphAngles:{value:new G(a.morphAngleRad,a.morphTiltRad)}}}function se(e,o){const a=I(e),n=new p(a.x,a.y,a.z),r=te(e),l=oe(e.catalogId),f=ie(r,l,re(e,l),ne(e,o)),u=new H(r,40,28),c=new Y({uniforms:f,vertexShader:ee,fragmentShader:ae,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1}),s=new j(u,c);s.frustumCulled=!1,s.renderOrder=-10;const m=new _;return m.name=`nebula-${e.catalogId}`,m.position.copy(n),m.add(s),{group:m,material:c,mesh:s}}function le(e){e.mesh.geometry.dispose(),e.material.dispose()}function w(e,o){const a=o==="ultra";for(const n of e)n.material.uniforms.uQuality.value=a?1:0}function ue(){return X(K())}function ce(e){const o=W(e).layers.dso,a=new _;a.name="nebulaVolumeLayer",o.add(a);const n=B(),r=[],l=S.getState(),f={current:l.showNebulaClouds},u={current:l.nebulaQuality},c={current:M().getState().universeMode.activeGalaxyId!==null},s={current:0},m={current:performance.now()},y=()=>{a.visible=f.current&&!c.current&&r.length>0},A=()=>{for(;r.length>0;){const t=r.pop();t!=null&&(a.remove(t.group),le(t))}},g=()=>{A(),ue().forEach((t,v)=>{const d=se(t,v);r.push(d),a.add(d.group)}),w(r,u.current),y()};g();const D=S.subscribe(t=>({showNebulaClouds:t.showNebulaClouds,nebulaQuality:t.nebulaQuality}),t=>{f.current=t.showNebulaClouds,u.current!==t.nebulaQuality&&(u.current=t.nebulaQuality,w(r,u.current)),y()},{equalityFn:O}),E=M().subscribeSelector(t=>t.universeMode.activeGalaxyId,t=>{c.current=t!==null,y()}),T=n.getQueryCache().subscribe(t=>{(C(t,"openngc-dso-catalog")||C(t,"custom-objects-catalog"))&&g()});return{onFrame:t=>{if(!a.visible)return;const v=performance.now(),d=Math.min(.06,Math.max(0,(v-m.current)/1e3));m.current=v,s.current+=d;for(const F of r)F.material.uniforms.uTime.value=s.current},dispose:()=>{D(),E(),T(),A(),o.remove(a)}}}function Re(){const e=z(),o=(0,R.useRef)(null);return(0,R.useLayoutEffect)(()=>{const a=ce(e);return o.current=a.onFrame,()=>{a.dispose(),o.current=null}},[e]),U(()=>o.current?.(),k.HUD_BRIDGE),null}export{Re as NebulaVolumeMountR3f};
