(function() {
	...
	180 / Math.PI;
	const ht = 86400, Ze = 365.25, M0 = 299792.458, a1 = M0 * Ze * ht, C = 149597870.7, dt = 648e3 / Math.PI, en = dt * C / a1, nn = 23.4392911, on = 1e3, rn = M0, sn = M0 ** Math.sqrt(Math.E), an = M0 ** 2, cn = M0 ** Math.E, un = [
		1,
		on,
		rn,
		sn
	...
	var I1 = (t, e, n) => Object.defineProperty(t, e, {
		...
		writable: !0,
		configurable: !0
	}), hn = Symbol.for("bitecs-relation"), dn = Symbol.for("bitecs-pairTarget"), fn = Symbol.for("bitecs-isPairComponent"), i1 = Symbol.for("bitecs-relationData"), c2 = () => {
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				I1(r, hn, e), I1(r, dn, o), I1(r, fn, !0), t.pairsMap.set(o, r);
			}
			return t.pairsMap.get(o);
		};
		return I1(e, i1, t), e;
	}, Mn = Symbol.for("bitecs-wildcard");
	function An() {
		let t = c2();
	...
	function Sn() {
		...
		return globalThis[t] || (globalThis[t] = An()), globalThis[t];
	}
	var _n = Sn();
	function En() {
		return c2();
	...
	function pn() {
		...
		return globalThis[t] || (globalThis[t] = En()), globalThis[t];
	}
	pn();
	const Nn = 384399 / C, Un = 421800 / C, Dn = 671034 / C, vn = 1070400 / C, On = 1882700 / C, Pn = 9376 / C, bn = 23463 / C, zn = 185540 / C, Cn = 237948 / C, Ln = 294619 / C, kn = 377396 / C, Kn = 527108 / C, Bn = 1221870 / C, Hn = 3560820 / C, Vn = 129390 / C, Jn = 190900 / C, Fn = 266e3 / C, $n = 436300 / C, Gn = 583520 / C, Yn = 354759 / C, jn = {
		[f.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	Object.fromEntries(Object.entries(jn).map(([t, e]) => [t, Qn(e)]));
	new TextEncoder();
	new TextDecoder();
	new TextEncoder();
	new TextDecoder("utf-8");
	const h2 = Symbol("Comlink.proxy"), qn = Symbol("Comlink.endpoint"), Xn = Symbol("Comlink.releaseProxy"), Mt = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), d2 = (t) => typeof t == "object" && t !== null || typeof t == "function", f2 = new Map([["proxy", {
	...
	function At(t, e = globalThis, n = ["*"]) {
		e.addEventListener("message", function o(r) {
			...
			Promise.resolve(u).catch((l) => ({
				...
				const [h, M] = D1(l);
				e.postMessage(Object.assign(Object.assign({}, h), { id: s }), M), a === "RELEASE" && (e.removeEventListener("message", o), M2(e), Mt in t && typeof t[Mt] == "function" && t[Mt]());
			}).catch((l) => {
				const [h, M] = D1({
	...
	function St(t, e, n = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(a, i, c) {
				...
				if (u === qn) return C0(t, e, { type: "ENDPOINT" }).then(U0);
	...
	function S2(t) {
		const e = t.map(D1);
		return [e.map((n) => n[0]), o3(e.map((n) => n[1]))];
	}
	...
	const v1 = 173.1446326846693, P = 149597870.69098932, E2 = 63241.07708807546, _ = .017453292519943295, _t = .26179938779914946, k = 57.29577951308232, Et = 3.819718634205488, i3 = 71492, c3 = 66854, u3 = 69911, l3 = 1821.6, h3 = 1560.8, d3 = 2631.2, f3 = 2410.3, p2 = 365.24217, y2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), e0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), L0 = 484813681109536e-20, m2 = 10800 * 60, M3 = 2 * m2, A3 = 7292115e-11, S3 = m2 / Math.PI, _3 = -.17 - 5 * Math.log10(S3), O1 = 29.530588, P1 = 24 * 3600, E3 = P1 * 1e3, R2 = .9972695717592592, pt = 695700, I2 = pt / P, s0 = .996647180302104, k0 = s0 * s0, A0 = 6378.1366, p3 = A0 / P, y3 = A0 * s0, m3 = 6371, R3 = 6459, I3 = 1738.1 / P, X = 1737.4, g2 = 1736, g3 = g2 / P, x3 = 34 / 60, w3 = 81.30056, u1 = .0002959122082855911, yt = 4912547451450812e-26, mt = 7243452486162703e-25, x2 = 8887692390113509e-25, Rt = 9549535105779258e-26, K0 = 2.825345909524226e-7, B0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, V0 = 1.524358900784276e-8, T3 = 218869976542597e-26, N3 = x2 / w3;
	function It(t) {
		switch (t) {
	...
	function g0(t) {
		if (!L1 || Math.abs(L1.tt - t.tt) > 1e-6) {
			const e = C3(t), n = U2(t), o = n + e.deps / 3600;
			L1 = {
				tt: t.tt,
				dpsi: e.dpsi,
				deps: e.deps,
	...
	function x0(t) {
		...
		for (v = .84 * d0 + .31 * e2 + 14.27 * n2 + 7.26 * o2 + .28 * r2 + .24 * ut, L = 2.94 * d0 + .31 * e2 + 14.27 * n2 + 9.34 * o2 + 1.12 * r2 + .83 * ut, K = -6.4 * d0 - 1.89 * ut, Q = .21 * d0 + .31 * e2 + 14.27 * n2 - 88.7 * o2 - 15.3 * r2 + .24 * ut - 1.86 * A6, $ = v - K, y = -3332e-9 * O(.59734 - 5.37261 * e) - 539e-9 * O(.35498 - 5.37899 * e) - 64e-9 * O(.39943 - 5.37511 * e), p = e0 * J0(.60643382 + 1336.85522467 * e - 313e-8 * M) + v / R0, g = e0 * J0(.37489701 + 1325.55240982 * e + 2565e-8 * M) + L / R0, w = e0 * J0(.99312619 + 99.99735956 * e - 44e-8 * M) + K / R0, x = e0 * J0(.25909118 + 1342.2278298 * e - 892e-8 * M) + Q / R0, N = e0 * J0(.82736186 + 1236.85308708 * e - 397e-8 * M) + $ / R0, l = 1; l <= 4; ++l) {
			...
			for (h0(0, l, 1), h0(1, l, Math.cos(c) * u), r1(0, l, 0), r1(1, l, Math.sin(c) * u), h = 2; h <= i; ++h) ct(p0(h - 1, l), l0(h - 1, l), p0(1, l), l0(1, l), (D, b) => (h0(h, l, D), r1(h, l, b)));
			for (h = 1; h <= i; ++h) h0(-h, l, p0(h, l)), r1(-h, l, -l0(h, l));
		}
		function Qe(D, b, B, V) {
			for (var G = {
				x: 1,
				...
				B,
				V
			], y0 = 1; y0 <= 4; ++y0) N0[y0] !== 0 && ct(G.x, G.y, p0(N0[y0], y0), l0(N0[y0], y0), (s2, s1) => (G.x = s2, G.y = s1));
			return G;
		}
		function S(D, b, B, V, G, N0, y0, s2) {
			var s1 = Qe(G, N0, y0, s2);
		...
		let S6 = (1.000002708 + 139.978 * y) * (18519.699999999997 + I) * Math.sin(a) - 6.24 * Math.sin(3 * a) + E;
		return {
			geo_eclip_lon: e0 * J0((p + A / R0) / e0),
			geo_eclip_lat: Math.PI / (180 * 3600) * S6,
			distance_au: R0 * p3 / (.999953253 * R)
		};
	}
	var O2 = class {
	...
	function k3(t) {
		...
		return new O2(k * w + Q, g + K, k * c, k * i, u, $);
	}
	function P2(t, e) {
		return [
	...
	function B3(t, e) {
		...
		let a, i, c;
		if (s < 1e-6) a = 0, i = r > 0 ? 90 : -90, c = Math.abs(r) - y3;
		else {
			...
			for (;;) {
				...
				const E = (k0 - 1) * A0, I = l * l, R = h * h, p = I + k0 * R;
				M = Math.sqrt(p);
	...
	function xt(t, e) {
		const n = t.latitude * _, o = Math.sin(n), r = Math.cos(n), s = 1 / Math.hypot(r, s0 * o), a = k0 * s, i = t.height / 1e3, c = A0 * s + i, u = A0 * a + i, l = (15 * e + t.longitude) * _, h = Math.sin(l), M = Math.cos(l);
		return {
			pos: [
				c * r * M / P,
				c * r * h / P,
	...
	function J1(t, e, n, o, r) {
		...
		if (r) {
			let r0 = $, p0 = p1(r, 90 - $);
			if ($ -= p0, p0 > 0 && $ > 3e-4) {
				const l0 = Math.sin($ * _), h0 = Math.cos($ * _), r1 = Math.sin(r0 * _), ct = Math.cos(r0 * _), O = [];
				for (let d0 = 0; d0 < 3; ++d0) O.push((x[d0] - ct * p[d0]) / r1 * l0 + p[d0] * h0);
	...
	function H2(t) {
		const e = m(t).AddDays(-1 / v1), n = q0(Y.Earth, e), [o, r, s] = H1([
			-n.x,
			-n.y,
			-n.z
	...
	function l1(t, e, n, o, r) {
		j0(n), b1(o), b1(r);
		const s = m(e), a = L2(s, n), i = n0(t, s, r), c = [
			i.x - a[0],
			i.y - a[1],
			i.z - a[2]
		];
		return B2(o ? H1(c, s, z.From2000) : c, s);
	}
	function F3(t, e, n) {
		const o = m(t);
		let r = xt(e, S0(o)).pos;
	...
	function $3(t, e, n) {
		const o = m(t), r = xt(e, S0(o)), s = new H(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
		return n ? s : H3(s, o, z.Into2000);
	}
	function G3(t, e) {
		const n = S0(t.t);
		let o = [
		...
		return e || (o = F0(o, t.t, z.From2000), o = $0(o, t.t, z.From2000)), B3(o, n);
	}
	function Y3(t, e) {
	...
	function Nt(t, e, n) {
		...
		return new K2(new U(o, r, s, t.t), c, i);
	}
	function h1(t) {
	...
	function i0(t) {
		const e = m(t), n = x0(e), o = n.distance_au * Math.cos(n.geo_eclip_lat), r = F0(L3(e, [
	...
	function F1(t) {
		const e = m(t), n = x0(e), o = n.distance_au * Math.cos(n.geo_eclip_lat), r = [
			...
			o * Math.sin(n.geo_eclip_lon),
			n.distance_au * Math.sin(n.geo_eclip_lat)
		], s = g0(e), a = wt($0(D2(s.mobl, r), e, z.From2000), e), i = s.tobl * _, c = Nt(a, Math.cos(i), Math.sin(i));
	...
	function q0(t, e) {
		const n = e.tt / Q0;
		return Pt(V2(D0(t[vt], n, !0), D0(t[Ot], n, !1), D0(t[$1], n, !1))).ToAstroVector(e);
	}
	function f1(t, e) {
		const n = e / Q0, o = D0(t[vt], n, !0), r = D0(t[Ot], n, !1), s = D0(t[$1], n, !1), a = Dt(t[vt], n), i = Dt(t[Ot], n), c = Dt(t[$1], n), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), M = Math.sin(r), y = +(c * h * u) - s * M * u * i - s * h * l * a, A = +(c * h * l) - s * M * l * i + s * h * u * a, E = +(c * M) + s * h * i, I = V2(o, r, s), R = [
			y / Q0,
			A / Q0,
			E / Q0
		];
	...
	function G1(t, e, n, o) {
		const r = o / (o + u1), s = q0(Y[n], e);
		t.x += r * s.x, t.y += r * s.y, t.z += r * s.z;
	}
	function j3(t) {
		const e = new U(0, 0, 0, t);
		return G1(e, t, d.Jupiter, K0), G1(e, t, d.Saturn, B0), G1(e, t, d.Uranus, H0), G1(e, t, d.Neptune, V0), e;
	}
	const bt = 51, Q3 = 29200, Y1 = 146, _0 = 201, v0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var j = class m0 {
		...
		add(e) {
			return new m0(this.x + e.x, this.y + e.y, this.z + e.z);
		}
		sub(e) {
			return new m0(this.x - e.x, this.y - e.y, this.z - e.z);
		}
		...
		mul(e) {
			return new m0(e * this.x, e * this.y, e * this.z);
		}
		div(e) {
			return new m0(this.x / e, this.y / e, this.z / e);
		}
		mean(e) {
			return new m0((this.x + e.x) / 2, (this.y + e.y) / 2, (this.z + e.z) / 2);
		}
		neg() {
			return new m0(-this.x, -this.y, -this.z);
		}
	...
	var A1 = class {
		...
		Acceleration(t) {
			...
			return e.incr(M1(t, K0, this.Jupiter.r)), e.incr(M1(t, B0, this.Saturn.r)), e.incr(M1(t, H0, this.Uranus.r)), e.incr(M1(t, V0, this.Neptune.r)), e;
		}
	}, zt = class qe {
		constructor(e, n, o, r) {
	...
	function Lt(t, e) {
		const n = t - e.tt, o = new A1(t), r = X0(n, e.r, e.v, e.a), s = o.Acceleration(r).mean(e.a), a = X0(n, e.r, e.v, s);
	...
	function kt(t) {
		const e = q3(t), n = new A1(e.tt), o = e.r.add(n.Sun.r), r = e.v.add(n.Sun.v), s = n.Acceleration(o);
		return new J2(n, new zt(e.tt, o, r, s));
	}
	function W3(t, e) {
		const n = v0[0][0];
		if (e < n || e > v0[bt - 1][0]) return null;
		const o = F2((e - n) / Q3, bt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = kt(v0[o]).grav, s[_0 - 1] = kt(v0[o + 1]).grav;
			let a, i = s[0].tt;
			for (a = 1; a < _0 - 1; ++a) s[a] = Lt(i += Y1, s[a - 1]).grav;
			i = s[_0 - 1].tt;
			var r = [];
			for (r[_0 - 1] = s[_0 - 1], a = _0 - 2; a > 0; --a) r[a] = Lt(i -= Y1, r[a + 1]).grav;
			for (a = _0 - 2; a > 0; --a) {
				const c = a / (_0 - 1);
	...
	function Kt(t, e) {
		...
		const s = W3(X3, t.tt);
		if (s) {
			const a = F2((t.tt - s[0].tt) / Y1, _0 - 1), i = s[a], c = s[a + 1], u = i.a.mean(c.a), l = X0(t.tt - i.tt, i.r, i.v, u), h = Ct(t.tt - i.tt, i.v, u), M = X0(t.tt - c.tt, c.r, c.v, u), y = Ct(t.tt - c.tt, c.v, u), A = (t.tt - i.tt) / Y1;
			n = l.mul(1 - A).add(M.mul(A)), o = h.mul(1 - A).add(y.mul(A));
		} else {
			let a;
			t.tt < v0[0][0] ? a = $2(v0[0], t.tt, -146) : a = $2(v0[bt - 1], t.tt, 146), n = a.grav.r, o = a.grav.v, r = a.bary;
		}
	...
	function Q1(t, e) {
		...
		return Z1(Z3, t4(t, e.mu, o));
	}
	function e4(t) {
		const e = new I0(t);
		return new G2(Q1(e, j1[0]), Q1(e, j1[1]), Q1(e, j1[2]), Q1(e, j1[3]));
	}
	function c0(t, e) {
		var n = m(e);
		...
		if (t === d.SSB) return j3(n);
		const s = C1(t);
		if (s) return W1(new G0(s.dec, 15 * s.ra, s.dist), n);
	...
	function P0(t, e) {
		...
		if (n) return n.dist;
		const o = m(e);
		return t in Y ? D0(Y[t][$1], o.tt / Q0, !1) : c0(t, o).Length();
	}
	function Y2(t, e) {
		let n = e, o = 0;
		for (let r = 0; r < 10; ++r) {
	...
	function j2(t, e, n, o) {
		...
		if (C1(n)) {
			const i = c0(n, r);
			if (o) {
				const u = q1(e, r), l = new U(i.x - u.x, i.y - u.y, i.z - u.z, r), h = v1 / l.Length();
	...
	function o4(t, e) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = f1(Y[d.Earth], n.tt), s = t === d.Moon ? d1(n) : Ut(n);
	...
	function q1(t, e) {
		...
		switch (t) {
			...
			case d.Saturn:
			case d.Uranus:
			case d.Neptune: return b0(f1(Y[t], n.tt), n);
			case d.Pluto: return Kt(n, !0);
			case d.Moon:
			case d.EMB:
				const r = f1(Y.Earth, n.tt), s = t == d.Moon ? d1(n) : Ut(n);
	...
	function F(t, e, n, o) {
		...
		for (;;) {
			...
			let M = z3(e, n, .5), y = M.ut - e.ut;
			if (Math.abs(y) < s) return M;
			h ? c = t(M) : h = !0;
			let A = r4(M.ut, n.ut - M.ut, a, c, i);
			if (A) {
				let E = m(A.t), I = t(E);
				if (A.df_dt !== 0) {
	...
	function a4(t, e, n, o, r) {
		const s = h1(o), a = _ * 28.06, i = _ * (169.51 + 382e-7 * r.tt), c = _ * s.elat, u = _ * s.elon, l = Math.asin(Math.sin(c) * Math.cos(a) - Math.cos(c) * Math.sin(a) * Math.sin(u - i)), h = Math.sin(Math.abs(l));
		let M = -9 + .044 * t;
	...
	function X1(t, e) {
		...
		if (t === d.Sun) i = _3 + 5 * Math.log10(c);
		else if (t === d.Moon) i = i4(r, u, c);
		else if (t === d.Saturn) {
			const h = a4(r, u, c, a, n);
			i = h.mag, l = h.ring_tilt;
		} else i = s4(t, r, u, c);
		return new q2(n, i, r, u, c, a, s, l);
	}
	function S1(t) {
	...
	function e1(t, e, n) {
		...
		let a = S1(t), i = m(n), c = s(i);
		c > 0 && (c -= 360);
		for (let u = 0; u < 100; ++u) {
			let l = -c / 360 * a;
			if (i = i.AddDays(l), Math.abs(l) * P1 < 1) return i;
			let h = c;
	...
	function c4(t) {
		return W2(new Date(t.time.date.getTime() + 6 * E3));
	}
	var Z2 = class {
		constructor(t, e, n) {
	...
	function u4(t, e) {
		const n = t.latitude * _, o = Math.sin(n), r = Math.cos(n), s = 1 / Math.hypot(r, o * s0), a = s * (s0 * s0), i = (t.height - e) / 1e3, c = A0 * s + i, u = A0 * a + i, l = 1e3 * Math.hypot(c * r, u * o), h = .175 * Math.pow(1 - .0065 / 283.15 * (t.height - 2 / 3 * e), 3.256);
		return k * -(Math.sqrt(2 * (1 - h) * e / l) / (1 - h));
	}
	function l4(t) {
		switch (t) {
			case d.Sun: return I2;
			case d.Moon: return I3;
			default: return 0;
		}
	}
	function h4(t, e, n, o, r, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const a = l4(t), i = te(e.height - s);
		return ee(t, e, n, o, r, a, u4(e, s) - x3 * i.density);
	}
	...
	function Vt(t, e, n, o, r, s, a) {
		...
		const i = r.ut - o.ut;
		if (i * P1 < 1 || Math.min(Math.abs(s), Math.abs(a)) > n * (i / 2)) return null;
	...
	function A4(t, e, n, o, r = 1) {
		...
		for (;;) {
			++a;
			let i = S0(s), c = l1(t, s, e, !0, !0), u = (n + c.ra - e.longitude / 15 - i) % 24;
			if (a === 1 ? r > 0 ? u < 0 && (u += 24) : u > 0 && (u -= 24) : u < -12 ? u += 24 : u > 12 && (u -= 24), Math.abs(u) * 3600 < .1) {
				const h = J1(s, e, c.ra, c.dec, "normal");
				return new ne(s, h);
			}
			let l = u / 24 * R2;
			s = s.AddDays(l);
	...
	function E4(t, e) {
		...
		for (; ++a <= 2;) {
			...
			i >= -s.s1 && i < +s.s1 ? (l = 0, c = +s.s1, u = +s.s2) : i >= +s.s2 || i < -s.s2 ? (l = 0, c = -s.s2, u = -s.s1) : i >= 0 ? (l = -S1(t) / 4, c = +s.s1, u = +s.s2) : (l = -S1(t) / 4, c = -s.s2, u = -s.s1);
	...
	function p4(t, e) {
		...
		const n = .01;
		function o(a) {
			const i = a.AddDays(-.005), c = a.AddDays(.01 / 2), u = X1(t, i).mag;
			return (X1(t, c).mag - u) / n;
		}
		let r = m(e), s = 0;
		for (; ++s <= 2;) {
			let a = W0(z0(t, r) - z0(d.Earth, r)), i, c, u;
			a >= -10 && a < 10 ? (u = 0, i = 10, c = 30) : a >= 30 || a < -30 ? (u = 0, i = -30, c = -10) : a >= 0 ? (u = -S1(t) / 4, i = 10, c = 30) : (u = -S1(t) / 4, i = -30, c = -10);
	...
	function m4(t, e) {
		...
		const l = ie(t, 0, s.AddDays(-2 * u), 4 * u), h = ie(t, 1, a.AddDays(-2 * u), 4 * u);
	...
	function w4(t, e, n) {
		e = m(e);
		const o = ue(t.lon);
		return W1(new G0(t.lat + le(n, t.lat), o, t.dist), e);
	}
	function p1(t, e) {
		let n;
	...
	function tt(t) {
		return t = m(t), T0(k1(t, z.From2000), B1(t, z.From2000));
	}
	function N4(t) {
		const e = m(t);
		return T0(tt(e), Ee(e));
	...
	function et(t) {
		return t = m(t), T0(B1(t, z.Into2000), k1(t, z.Into2000));
	}
	function $t(t, e) {
		t = m(t);
		const n = Math.sin(e.latitude * _), o = Math.cos(e.latitude * _), r = Math.sin(e.longitude * _), s = Math.cos(e.longitude * _), a = [
			...
			-s,
			0
		], u = -15 * S0(t), l = Y0(u, a), h = Y0(u, i), M = Y0(u, c);
		return new J([
			[
				h[0],
				M[0],
	...
	function C4(t, e) {
		...
		t %= 24, t < 0 && (t += 24), Gt || (Gt = tt(new I0(-45655.74141261017)), pe = new I0(0));
		const n = W1(new G0(e, 15 * t, 1), pe), o = Jt(y1(Gt, n)), r = 10 / 240, s = r / 15;
		for (let a of z4) {
			const i = a[3] * r, c = a[1] * s, u = a[2] * s;
			if (i <= o.dec && c <= o.ra && o.ra < u) {
				const l = b4[a[0]];
				return new ye(l[0], l[1], o.ra, o.dec);
			}
		}
	...
	function m1(t, e, n, o) {
		...
		return new L4(e, r, P * Math.hypot(s, a, i), 695700 - (1 + r) * (pt - t), -695700 + (1 + r) * (pt + t), n, o);
	}
	function nt(t) {
		const e = n0(d.Sun, t, !0), n = new U(-e.x, -e.y, -e.z, e.t);
		return m1(R3, t, i0(t), n);
	}
	function Re(t) {
	...
	function K4(t) {
		const e = F((n) => jt(nt, n), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return nt(e);
	}
	function B4(t) {
		const e = F((n) => jt(Re, n), t.AddDays(-.03), t.AddDays(.03));
	...
	function Qt(t, e, n) {
		const o = n / 1440, r = t.AddDays(-o), s = t.AddDays(+o), a = F((c) => -(nt(c).r - e), r, t), i = F((c) => +(nt(c).r - e), t, s);
	...
	function ge(t, e) {
		const n = new U(t.x + e.x, t.y + e.y, t.z + e.z, t.t), o = Ie(Math.asin(I2 / n.Length()), Math.asin(g3 / e.Length()), z1(e, n) * _);
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (a.r < a.p + X) {
					...
					return a.r < a.k + X && (i = Z.Partial, l = Qt(a.time, a.k + X, h), a.r + X < a.k ? (i = Z.Total, c = 1, u = Qt(a.time, a.k - X, l)) : c = Ie(X, a.k, a.r)), new me(i, c, a.time, h, l, u);
				}
			}
			n = r.AddDays(10);
		}
	...
	function J4(t) {
		...
		const a = tt(t.time), i = y1(a, t.dir), c = y1(a, t.target);
		i.x *= P, i.y *= P, i.z *= P / s0, c.x *= P, c.y *= P, c.z *= P / s0;
		const u = A0, l = i.x * i.x + i.y * i.y + i.z * i.z, h = -2 * (i.x * c.x + i.y * c.y + i.z * c.z), M = c.x * c.x + c.y * c.y + c.z * c.z - u * u, y = h * h - 4 * l * M;
		let A;
		if (y > 0) {
			...
			N = y1(x, N), N.x += t.target.x, N.y += t.target.y, N.z += t.target.z;
	...
	function G4(t, e) {
		...
		let i, c, u;
		t.r < Math.abs(t.k) ? (o = t.time.AddDays(-.01), r = t.time.AddDays(.01), i = rt(e, 1, Oe, o, t.time), c = rt(e, -1, Oe, t.time, r), u = Te(t.k)) : u = Z.Partial;
		const l = u === Z.Total ? 1 : ge(t.dir, t.target);
		return new De(u, l, s, i, n, c, a);
	}
	...
	function Le(t, e) {
		...
		for (;;) {
			...
			if (t1(t, s) < n) {
				const a = H4(t, o, s);
				if (a.r < a.p) {
					const i = a.time.AddDays(-1), c = Ce(t, o, i, a.time, -1), u = a.time.AddDays(1), l = Ce(t, o, a.time, u, 1), h = 60 * t1(t, a.time);
					return new ze(c, a.time, l, h);
				}
			}
			r = s.AddDays(10);
		}
	...
	function Be(t) {
		let e = m(t), n = F1(e);
		for (;;) {
			const o = e.AddDays(Ke), r = F1(o);
			if (n.lat * r.lat <= 0) {
				const s = r.lat > n.lat ? E0.Ascending : E0.Descending, a = F((i) => s * F1(i).lat, e, o);
	...
	function X4(t) {
		const e = Be(t.time.AddDays(Ke));
		switch (t.kind) {
			case E0.Ascending:
				if (e.kind !== E0.Descending) throw `Internal error: previous node was ascending, but this node was: ${e.kind}`;
				break;
			case E0.Descending:
				if (e.kind !== E0.Ascending) throw `Internal error: previous node was descending, but this node was: ${e.kind}`;
				break;
	...
	function t6(t, e, n, o) {
		...
		let i, c;
		return n === d.Earth && o === d.Moon ? (i = new H(0, 0, 0, 0, 0, 0, r), c = d1(r)) : (i = q1(n, r), c = q1(o, r)), He(t, i, s, c, a);
	}
	function He(t, e, n, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const N = t == 4 ? .8660254037844386 : -.8660254037844386, v = .5 * a + N * p, L = .5 * i + N * g, K = .5 * c + N * w, Q = .5 * p - N * a, $ = .5 * g - N * i, q = .5 * w - N * c, u0 = l * v, r0 = l * L, p0 = l * K, l0 = h * a + M * i + y * c, h0 = h * p + M * g + y * w;
			A = new H(u0, r0, p0, l0 * v + h0 * Q, l0 * L + h0 * $, l0 * K + h0 * q, e.t);
		} else {
	...
	const { MakeTime: W6, SearchRiseSet: Z6, Body: t8, Observer: n6 } = st(c1);
	new n6(40.7128, -74.006, 10);
	const { Body: o0 } = st(c1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: r8, CombineRotation: s8, MakeRotation: a8 } = st(c1);
	Math.PI / (180 * 3600);
	nn * We;
	(() => {
		const t = c1;
	...
	Object.fromEntries(Object.entries(r6).map(([t, e]) => [e.bodyId, t]));
	const { HelioState: h8, MakeTime: d8, JupiterMoons: f8, Body: it } = st(c1);
	f.IO, f.EUROPA, f.GANYMEDE, f.CALLISTO;
	it.Mars, it.Saturn, it.Uranus, it.Neptune;
	f.CERES, f.ERIS, f.HAUMEA, f.MAKEMAKE;
	const o1 = 1e3, Je = o1 / C, Fe = Je * a1 * en, s6 = 695700, a6 = 6378.137;
	function $e(t) {
	...
	25 * Fe;
	25 * Fe;
	function c6(t, e, n = R1) {
		const o = {};
		for (const r of n) {
			const s = e[r] ?? [], a = s.length ? o6(s, t) : null;
			if (a) {
				const i = i6(a);
				o[r] = [
					i.x,
	...
	function h6(t) {
		return Atomics.load(Ye(t), Ge) === 1 ? 1 : 0;
	}
	function je(t) {
		return h6(t) === 0 ? 1 : 0;
	}
	...
	At({
		async init(t) {
			const e = new Float32Array(t), n = u6();
