import{Pt as c}from"./sceneRuntimeTypes-BIGCaVoh.js";import{a as m}from"./catalog-query-defaults-BENbjf7M.js";import{$ as f}from"./index-BbkUVtqJ.js";import{D as p,W as d,h as v,ht as h,pt as C}from"./three-vendor-BZf4UzLD.js";import{a as g,i as S}from"./majorDsoSelector-ZdN40Aic.js";import{n as y}from"./dsoMajorCluster-CMFhAIlP.js";import{t as P}from"./shaderNoiseHelpers-Cu9aXpza.js";import{t as k}from"./createDsoMountR3f-CInpblb5.js";var D=Math.PI/180/60,A=f.far/4;function M(o){return o.openNgcTypeRaw==="GCl"?"globular":"open"}function R(o){if(o.type!=="star_cluster"||!Number.isFinite(o.distPc)||o.distPc<=0||!Number.isFinite(o.majAxArcmin)||(o.majAxArcmin??0)<=0)return null;const r=o.majAxArcmin/2*D,e=o.distPc*Math.tan(r);if(!Number.isFinite(e)||e<=0)return null;const a=Math.min(c(e),A);return a<=0?null:{radiusSu:a,radiusPc:e,morphScale:[1,1,1],kind:M(o)}}var x={colorCore:[1.4,1.5,1.7],colorHalo:[.5,.6,.9],coreDensity:1.5,haloStrength:.4,sparkleContrast:5,intensity:1.1},F={colorCore:[1.5,1.25,.75],colorHalo:[1,.75,.45],coreDensity:2.4,haloStrength:1.6,sparkleContrast:3,intensity:1.2};function L(o){return o==="globular"?F:x}var T=`
