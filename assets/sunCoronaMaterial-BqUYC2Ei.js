import{P as ot,Pt as rt,X as at,Xt as nt,ot as U,wt as it}from"./sceneRuntimeTypes-Ba-OycFt.js";import{T as st,t as lt}from"./simActions-DqEdGokZ.js";import{t as J}from"./r3fHostExtras-C8VytOx0.js";import{E as ut,Et as E,U as ct,V as ft,c as j,h as H,l as mt,mt as ht,nt as Q,pt as W}from"./three-vendor-DnPFe64c.js";function pt(t,e,o){return o&&e&&nt(t,e.position.x,e.position.y,e.position.z),t}function ce(t,e,o){if(o&&e){const r=t;r.x+=e.position.x,r.y+=e.position.y,r.z+=e.position.z}return t}var Y={current:null};function fe(t,e){return t.getWorldPosition(e),pt(e,Y.current,!0),e}function dt(t,e,o,r,a){t.updateMatrixWorld(!0),t.getWorldPosition(o),e.position.x=o.x,e.position.y=o.y,e.position.z=o.z,t.getWorldDirection(o),r.setFromMatrixColumn(t.matrixWorld,0).normalize(),a.setFromMatrixColumn(t.matrixWorld,1).normalize(),e.forward.x=o.x,e.forward.y=o.y,e.forward.z=o.z,e.right.x=r.x,e.right.y=r.y,e.right.z=r.z,e.up.x=a.x,e.up.y=a.y,e.up.z=a.z,e.fovYRadians=ft.degToRad(t.fov),e.aspect=t.aspect}function vt(t,e,o,r,a){dt(t,e,o,r,a);{const n=Y.current;n&&(e.position.x-=n.position.x,e.position.y-=n.position.y,e.position.z-=n.position.z)}}function me(t){const e=t.replace(/^#/,""),o=parseInt(e,16);return Number.isFinite(o)?[Math.floor(o/65536)%256,Math.floor(o/256)%256,o%256]:[0,0,0]}function xt(t){if(!t||typeof t!="string")return[1,1,1];const e=t.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return e?[parseInt(e[1],16)/255,parseInt(e[2],16)/255,parseInt(e[3],16)/255]:[1,1,1]}function he(t){return Math.max(0,Math.min(255,Math.round(t)))}var gt=1,St=-25,yt=500,Pt=.01;function G(t,e){let o=e;for(;t[o]!==o;)o=t[o];let r=e;for(;r!==o;){const a=t[r];t[r]=o,r=a}return o}function Mt(t,e,o){const r=G(t,e),a=G(t,o);r!==a&&(t[r]=a)}function X(t,e,o){return`${t},${e},${o}`}function pe(t,e){const o=t.length,r=Array.from({length:o},(i,l)=>l),a=e,n=new Map;for(let i=0;i<o;i+=1){const l=t[i],f=X(Math.floor(l.x/a),Math.floor(l.y/a),Math.floor(l.z/a));n.has(f)||n.set(f,[]),n.get(f).push(i)}const u=e*e;for(let i=0;i<o;i+=1){const l=t[i],f=Math.floor(l.x/a),x=Math.floor(l.y/a),m=Math.floor(l.z/a);for(let h=-1;h<=1;h+=1)for(let d=-1;d<=1;d+=1)for(let g=-1;g<=1;g+=1){const S=X(f+h,x+d,m+g),y=n.get(S);if(y)for(const P of y){if(P<=i)continue;const M=t[P],F=M.x-l.x,C=M.y-l.y,T=M.z-l.z;F*F+C*C+T*T<u&&Mt(r,i,P)}}}const c=new Map;for(let i=0;i<o;i+=1){const l=G(r,i);c.has(l)||c.set(l,[]),c.get(l).push(i)}const s=[];for(let i=0;i<o;i+=1)s.push(void 0);for(const i of c.values())i.length<=1||(i.sort((l,f)=>l-f),i.forEach((l,f)=>{f>0&&(s[l]={x:0,y:f*St})}));return s}function Ct(){const t=[];for(let e=0;e<yt;e+=1){const o=ot(e*.7%360,e*.3%180-90);o!=null&&t.push(o)}return t}function wt(){const t=Ct(),e=t.length,o=it,r=new Float32Array(e*3);return t.forEach((a,n)=>{r[n*3]=a.x*o,r[n*3+1]=a.y*o,r[n*3+2]=a.z*o}),{abbr:"_bootstrap",positions:r,sizes:new Float32Array(e).fill(gt),colors:new Float32Array(e*3).fill(1),warm:new Float32Array(e).fill(Pt),brightness:new Float32Array(e).fill(1),mag:new Float32Array(e).fill(-1/0),starsInChunk:[]}}var Ft={raMin:0,raMax:360,decMin:-90,decMax:90},de={chunks:[],namedStarsInView:[]};function ve(t,e){return t===0&&e!=="success"}function Z(t,e){return t.chunks.length>0?t.chunks:e==="idle"||e==="loading"?[wt()]:[]}function xe(t,e){const o=Z(t,e),r=o.slice(0,3).map(a=>a.abbr).join(",");return o.length===0?{syntheticKind:"empty",chunkAbbrevSample:r}:o.length===1&&o[0]?.abbr==="_bootstrap"?{syntheticKind:"bootstrap",chunkAbbrevSample:r}:o.some(a=>a.abbr==="_fallback")?{syntheticKind:"fallback",chunkAbbrevSample:r}:{syntheticKind:"real",chunkAbbrevSample:r}}function $(t,e){return e.current===t.current}function ge(t,e,o,r,a){t.onerror=n=>{$(e,o)||(r("error"),a(n.message??"Starfield worker failed"))},t.onmessageerror=()=>{$(e,o)||(r("error"),a("Starfield worker message error"))}}function zt(t,e,o,r,a,n,u){const{runId:c,...s}=t;c===e.current&&(o.current=c,r.current=s.starsInView,a({chunks:s.chunks,namedStarsInView:s.namedStarsInView}),n("ready"),u(null))}function Se(t,e,o,r,a){t.processStarfield({runId:e,catalog:o,maxDistanceLevel:r,bounds:Ft,raInHours:!1}).then(n=>{zt(n,a.runIdRef,a.lastSuccessfulRunIdRef,a.starsInViewRef,a.setStarData,a.setStarfieldStatus,a.setErrorMessage)}).catch(n=>{e===a.runIdRef.current&&(a.setStarfieldStatus("error"),a.setErrorMessage(n instanceof Error?n.message:"Starfield worker failed"))})}function bt(t,e){e.length=0;for(const o of t){const r=new Float32Array(o.starsInChunk.length);for(let a=0;a<o.starsInChunk.length;a+=1){const n=o.starsInChunk[a];r[a]=n?st(n)*U:0}e.push(r)}}function kt(t,e,o){const r=Z(t(),e());return bt(r,o),r}var Tt=500*U;function At(t,e,o,r){const a=Math.sqrt(t*t+e*e+o*o);if(a<=0||!Number.isFinite(a)){r.x=0,r.y=0,r.z=0;return}const n=at(a)*U/a;r.x=t*n,r.y=e*n,r.z=o*n}function _t(t,e,o,r,a,n,u,c){const s=Math.sqrt(t*t+e*e+o*o);if(s<=0||!Number.isFinite(s)||!Number.isFinite(r)){const m=-a,h=-n,d=-u;return m*m+h*h+d*d<=c}const i=r/s,l=t*i-a,f=e*i-n,x=o*i-u;return l*l+f*f+x*x<=c}function It(){return{frustum:{position:{x:0,y:0,z:0},forward:{x:0,y:0,z:-1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:Math.PI/4,aspect:1},cameraHelioKm:{x:0,y:0,z:0}}}function Rt(t){const e=Math.tan(t.frustum.fovYRadians*.5);return At(t.frustum.position.x,t.frustum.position.y,t.frustum.position.z,t.cameraHelioKm),{tanHalfV:e,maxDistSqKm:Tt**2}}var Et=256,Wt=320,Dt=`
