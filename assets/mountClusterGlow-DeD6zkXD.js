import{n as S}from"./state-data-vendor-I825NqV8.js";import{n as F}from"./manifest.generated-C3012b77.js";import{t as G}from"./skyLightStore-ahq7l6TE.js";import{_ as b,at as C,f as u,gt as P,j as y,p as _}from"./three-vendor-7Zt43m1U.js";import{Wr as v,a as z,b as A,xn as L}from"./index-Cq0Ou5we.js";import{t as R}from"./createMountComponent-DVRuGE-n.js";import{n as d,t as E}from"./deepSkyCatalogBridge-B4MmkZAn.js";var T={mainSequence:[.85,.95,1.4],giant:[1.4,1,.55],giantFraction:.08},B={mainSequence:[1.35,1.15,.8],giant:[1.5,.85,.5],giantFraction:.25};function O(t){return t==="globular"?B:T}var k=8;function I(t,i,e,n,l,s,o){t.xs.push(e,n,l),t.mags.push(s),t.cols.push(o[0],o[1],o[2]),t.glow.push(1),t.ids.push(i)}function N(t,i){const e=F(t);if(!Number.isFinite(e.x)||!Number.isFinite(e.y)||!Number.isFinite(e.z)||e.x===0&&e.y===0&&e.z===0)return;const n=t.vMag!=null&&Number.isFinite(t.vMag)?t.vMag:k,l=L(t),s=O(l),o=l==="globular"?s.giant:s.mainSequence;I(i,t.catalogId,e.x,e.y,e.z,n,o)}function D(t){const i={xs:[],mags:[],cols:[],glow:[],ids:[]};for(const e of t)e.type==="star_cluster"&&N(e,i);return{positions:new Float32Array(i.xs),mag:new Float32Array(i.mags),color:new Float32Array(i.cols),isGlow:new Float32Array(i.glow),catalogIds:i.ids,count:i.ids.length}}var U=160,V=`
  attribute float mag;
...
`;function j(){return new P({uniforms:{uMagLimit:{value:13},uGlowMagLimit:{value:5},uMagRef:{value:0},uMagFadeRange:{value:1.5},uFluxClampMax:{value:6},uFluxGamma:{value:.45},uPointSizeFloor:{value:1.1},uPointSizeMax:{value:U},uPsfMaxMult:{value:3.5},uGlowSizeMult:{value:3},uSizeMultiplier:{value:1}},vertexShader:V,fragmentShader:Q,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1})}function q(t){const i=A(t).layers.dsoReRooted,e=new y;e.name="clusterGlowLayer",i.add(e);const n=z(),l=j(),s=new b;let o=null,r=null,m=!1;const f={current:v.getState().showDsoVolumes},c=()=>{e.visible=f.current&&o!==null},g=()=>{if(!m){if(o!==null&&(e.remove(o),o.geometry.dispose(),o=null),r=D(E()),r.count>0){const a=new _;a.setAttribute("position",new u(r.positions,3)),a.setAttribute("mag",new u(r.mag,1)),a.setAttribute("color",new u(r.color,3)),a.setAttribute("isGlow",new u(r.isGlow,1)),o=new C(a,l),o.name="clusterGlow",o.frustumCulled=!1,o.renderOrder=-18,e.add(o)}c()}};Promise.resolve().then(g).catch(a=>console.error("[mountClusterGlow] rebuild failed:",a));const w=v.subscribe(a=>({showDsoVolumes:a.showDsoVolumes}),a=>{f.current=a.showDsoVolumes,c()},{equalityFn:S}),x=n.getQueryCache().subscribe(a=>{(d(a,"openngc-dso-catalog")||d(a,"custom-objects-catalog"))&&g()});return{onFrame:()=>{if(l.uniforms.uMagLimit){const a=s.getDelta(),h=G(),M=1-Math.exp(-a/.7),p=l.uniforms.uMagLimit.value;l.uniforms.uMagLimit.value=p+(h.bandMagLimit-p)*M}},dispose:()=>{m=!0,w(),x(),o!==null&&(e.remove(o),o.geometry.dispose(),o=null),l.dispose(),i.remove(e)}}}var oe=R(q,"present.hud");export{oe as ClusterGlowMountR3f};
