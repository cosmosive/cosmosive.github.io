(function() {
	...
	const u2 = Symbol("Comlink.proxy"), Wn = Symbol("Comlink.endpoint"), Xn = Symbol("Comlink.releaseProxy"), at = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), l2 = (t) => typeof t == "object" && t !== null || typeof t == "function", h2 = new Map([["proxy", {
	...
	const E2 = Object.fromEntries(Object.entries(ce).map(([t, n]) => [t, Se(n)]));
	D.SUN, D.MERCURY, D.VENUS, D.EARTH, D.MARS, D.JUPITER, D.SATURN, D.URANUS, D.NEPTUNE, D.PLUTO;
	const Mt = E2[D.EARTH]?.radiusKm ?? 6371, St = E2[D.SUN]?.radiusKm ?? 696340, pe = Mt / St, s1 = .04;
	Mt / s1;
	s1 / Mt / (15 / ue);
	function _e(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : t / pe * s1;
	}
	function Ae(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : _e(t / St);
	}
	Ae(St);
	var D1 = jn({
		AU_PER_LY: () => y2,
	...
	const I1 = 173.1446326846693, C = 149597870.69098932, y2 = 63241.07708807546, p = .017453292519943295, pt = .26179938779914946, b = 57.29577951308232, _t = 3.819718634205488, Ee = 71492, ye = 66854, we = 69911, ge = 1821.6, Re = 1560.8, xe = 2631.2, me = 2410.3, w2 = 365.24217, g2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, R2 = 10800 * 60, ve = 2 * R2, x2 = 7292115e-11, De = R2 / Math.PI, Ie = -.17 - 5 * Math.log10(De), P1 = 29.530588, z1 = 24 * 3600, Pe = z1 * 1e3, m2 = .9972695717592592, i1 = 695700, v2 = i1 / C, s0 = .996647180302104, b0 = s0 * s0, M0 = 6378.1366, ze = M0 / C, Te = M0 * s0, D2 = 6371, Ne = D2 + 88, Le = 1738.1 / C, j = 1737.4, I2 = 1736, Ce = I2 / C, Ue = 34 / 60, At = 81.30056, a1 = .0002959122082855911, Et = 4912547451450812e-26, yt = 7243452486162703e-25, c1 = 8887692390113509e-25, wt = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, Oe = 218869976542597e-26, T1 = c1 / At;
	function gt(t) {
		switch (t) {
	...
	function R0(t) {
		if (!U1 || Math.abs(U1.tt - t.tt) > 1e-6) {
			const n = Ge(t), e = N2(t), r = e + n.deps / 3600;
			U1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function qe(t) {
		...
		return new U2(b * m + q, w + N, b * c, b * a, u, G);
	}
	function O2(t, n) {
		return [
	...
	function u1(t, n, e, r, o) {
		K0(e), N1(r), N1(o);
		const s = E(n), i = F2(s, e), a = e0(t, s, o), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
	...
	function J1(t) {
		const n = E(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = mt(Q0(L2(s.mobl, o), n, O.From2000), n), a = s.tobl * p, c = Dt(i, Math.cos(a), Math.sin(a));
	...
	function j0(t, n) {
		const e = n.tt / Y0;
		return Nt(Q2(z0(t[zt], e, !0), z0(t[Tt], e, !1), z0(t[$1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / Y0, r = z0(t[zt], e, !0), o = z0(t[Tt], e, !1), s = z0(t[$1], e, !1), i = Pt(t[zt], e), a = Pt(t[Tt], e), c = Pt(t[$1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, y = Q2(r, o, s), g = [
			_ / Y0,
			M / Y0,
			A / Y0
		];
	...
	function kt(t) {
		const n = o3(t), e = new M1(n.tt), r = n.r.add(e.Sun.r), o = n.v.add(e.Sun.v), s = e.Acceleration(r);
		return new q2(e, new Ct(n.tt, r, o, s));
	}
	function i3(t, n) {
		const e = T0[0][0];
		if (n < e || n > T0[Lt - 1][0]) return null;
		const r = B2((n - e) / r3, Lt - 1);
		if (!t[r]) {
			const s = t[r] = [];
	...
	function bt(t, n) {
		...
		if (s) {
			...
			let i;
			t.tt < T0[0][0] ? i = K2(T0[0], t.tt, -W0) : i = K2(T0[Lt - 1], t.tt, +W0), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
	...
	function q1(t, n) {
		...
		return j1(a3, c3(t, n.mu, r));
	}
	function u3(t) {
		const n = new g0(t);
		return new Y2(q1(n, Q1[0]), q1(n, Q1[1]), q1(n, Q1[2]), q1(n, Q1[3]));
	}
	function c0(t, n) {
		var e = E(n);
	...
	function p3(t) {
		return nn(new Date(t.time.date.getTime() + 6 * Pe));
	}
	var en = class {
		constructor(t, n, e) {
	...
	function E3(t, n, e, r, o, s = 0) {
		...
		const i = A3(t), a = rn(n.height - s);
		return on(t, n, e, r, o, i, _3(n, s) - Ue * a.density);
	}
	...
	function x3(t, n, e) {
		const r = E(n), o = b2(r), s = u1(t, r, e, !0, !0);
	...
	function L3(t, n) {
		const e = $t(t);
		return e.lon = dn(e.lon), e.lat += A1(n, e.lat), e;
	}
	function C3(t, n, e) {
		n = E(n);
		const r = dn(t.lon);
		return Y1(new q0(t.lat + Mn(e, t.lat), r, t.dist), n);
	}
	function A1(t, n) {
		let e;
	...
	function G3(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Qt || (Qt = W1(new g0(-45655.74141261017)), Rn = new g0(0));
		const e = Y1(new q0(n, 15 * t, 1), Rn), r = Jt(E1(Qt, e)), o = 10 / 240, s = o / 15;
		for (let i of $3) {
			const a = i[3] * o, c = i[1] * s, u = i[2] * s;
			if (a <= r.dec && c <= r.ra && r.ra < u) {
				const h = J3[i[0]];
				return new xn(h[0], h[1], r.ra, r.dec);
			}
		}
	...
	function y1(t, n, e, r) {
		...
		return new Q3(n, o, C * Math.hypot(s, i, a), +i1 - (1 + o) * (i1 - t), -i1 + (1 + o) * (i1 + t), e, r);
	}
	function Z1(t) {
		const n = e0(f.Sun, t, !0), e = new P(-n.x, -n.y, -n.z, n.t);
		return y1(Ne, t, a0(t), e);
	}
	function vn(t) {
	...
	function K3(t) {
		const e = $((r) => Bt(vn, r), t.AddDays(-.03), t.AddDays(.03));
	...
	function In(t, n) {
		const e = new P(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = Dn(Math.asin(v2 / e.Length()), Math.asin(Ce / n.Length()), L1(n, e) * p);
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (i.r < i.p + j) {
					...
					return i.r < i.k + j && (a = X.Partial, h = Kt(i.time, i.k + j, l), i.r + j < i.k ? (a = X.Total, c = 1, u = Kt(i.time, i.k - j, h)) : c = Dn(j, i.k, i.r)), new mn(a, c, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function t4(t, n) {
		...
		const a = nt(n, 1, Un, s, t.time), c = nt(n, -1, Un, t.time, i);
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = nt(n, 1, On, s, t.time), h = nt(n, -1, On, t.time, i), l = Tn(t.k)) : l = X.Partial;
		const d = l === X.Total ? 1 : In(t.dir, t.target);
		return new Cn(l, d, a, u, o, h, c);
	}
	...
	function e4(t, n) {
		return t = E(t), bn(t.AddDays(10), n);
	}
	var Vn = class {
		constructor(t, n, e, r) {
	...
	function c4(t, n, e, r) {
		...
		let a, c;
		return e === f.Earth && r === f.Moon ? (a = new F(0, 0, 0, 0, 0, 0, o), c = h1(o)) : (a = B1(e, o), c = B1(r, o)), Qn(t, a, s, c, i);
	}
	...
	const { MakeTime: P4, SearchRiseSet: z4, Body: T4, Observer: l4 } = et(D1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: U4, CombineRotation: O4, MakeRotation: k4 } = et(D1);
	Math.PI / (180 * 3600);
	const { HelioState: V4 } = et(D1), h4 = 86400;
	function f4(t) {
