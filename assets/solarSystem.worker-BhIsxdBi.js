(function() {
	...
	const r2 = Symbol("Comlink.proxy"), Gn = Symbol("Comlink.endpoint"), Qn = Symbol("Comlink.releaseProxy"), it = Symbol("Comlink.finalizer"), y1 = Symbol("Comlink.thrown"), s2 = (t) => typeof t == "object" && t !== null || typeof t == "function", i2 = new Map([["proxy", {
	...
	function at(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, d] = m1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), d), i === "RELEASE" && (n.removeEventListener("message", o), a2(n), it in t && typeof t[it] == "function" && t[it]());
			}).catch((h) => {
				const [l, d] = m1({
	...
	function ct(t, n, e = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(i, a, c) {
				...
				if (u === "bind") return ct(t, n, e.slice(0, -1));
				const [h, l] = u2(c);
				return U0(t, n, {
					type: "APPLY",
	...
	}, e3 = 149597870.7, o3 = 648e3 / Math.PI, v1 = 1500, r1 = 100 / o3, r3 = 16777216, h2 = 3.2615637771694;
	(r3 - v1) / 20 + r1;
	function f2(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * 20;
	}
	const s3 = 5e4, i3 = 2e3, a3 = s3 / h2, c3 = i3 / h2;
	f2(a3);
	f2(c3);
	r1 <= 0 || (25 >= r1 ? v1 + (25 - r1) * 20 : 25 / r1 * v1);
	function u3(t) {
		return {
			name: t.name,
			type: t.type,
	...
	const d2 = Object.fromEntries(Object.entries(n3).map(([t, n]) => [t, u3(n)])), lt = [
		D.SUN,
		D.MERCURY,
		D.VENUS,
		D.EARTH,
	...
	const ft = d2[D.SUN]?.radiusKm ?? 696340, h3 = ht / ft, s1 = .04;
	ht / s1;
	s1 / ht / (15 / e3);
	function f3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : t / h3 * s1;
	}
	function d3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : f3(t / ft);
	}
	d3(ft);
	var D1 = Jn({
		AU_PER_LY: () => M2,
	...
	const I1 = 173.1446326846693, C = 149597870.69098932, M2 = 63241.07708807546, _ = .017453292519943295, dt = .26179938779914946, b = 57.29577951308232, Mt = 3.819718634205488, M3 = 71492, S3 = 66854, _3 = 69911, p3 = 1821.6, A3 = 1560.8, E3 = 2631.2, w3 = 2410.3, S2 = 365.24217, _2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), t0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), O0 = 484813681109536e-20, p2 = 10800 * 60, y3 = 2 * p2, A2 = 7292115e-11, g3 = p2 / Math.PI, R3 = -.17 - 5 * Math.log10(g3), z1 = 29.530588, P1 = 24 * 3600, x3 = P1 * 1e3, E2 = .9972695717592592, i1 = 695700, w2 = i1 / C, r0 = .996647180302104, k0 = r0 * r0, d0 = 6378.1366, m3 = d0 / C, v3 = d0 * r0, y2 = 6371, D3 = y2 + 88, I3 = 1738.1 / C, W = 1737.4, g2 = 1736, z3 = g2 / C, P3 = 34 / 60, St = 81.30056, a1 = .0002959122082855911, _t = 4912547451450812e-26, pt = 7243452486162703e-25, c1 = 8887692390113509e-25, At = 9549535105779258e-26, b0 = 2.825345909524226e-7, V0 = 8.459715185680659e-8, F0 = 1.292024916781969e-8, H0 = 1.524358900784276e-8, T3 = 218869976542597e-26, T1 = c1 / St;
	function Et(t) {
		switch (t) {
			...
			case f.Moon: return T1;
			case f.EMB: return c1 + T1;
	...
	function g0(t) {
		if (!U1 || Math.abs(U1.tt - t.tt) > 1e-6) {
			const n = V3(t), e = v2(t), o = e + n.deps / 3600;
			U1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function R0(t) {
		...
		var h0 = L(.19833 + .05611 * n), jt = L(.27869 + .04508 * n), Xt = L(.16827 - .36903 * n), Zt = L(.34734 - 5.37261 * n), t2 = L(.10498 - 5.37899 * n), rt = L(.42681 - .41855 * n), l6 = L(.14943 - 5.37511 * n);
		for (I = .84 * h0 + .31 * jt + 14.27 * Xt + 7.26 * Zt + .28 * t2 + .24 * rt, k = 2.94 * h0 + .31 * jt + 14.27 * Xt + 9.34 * Zt + 1.12 * t2 + .83 * rt, N = -6.4 * h0 - 1.89 * rt, B = .21 * h0 + .31 * jt + 14.27 * Xt - 88.7 * Zt - 15.3 * t2 + .24 * rt - 1.86 * l6, G = I - N, p = -3332e-9 * L(.59734 - 5.37261 * n) - 539e-9 * L(.35498 - 5.37899 * n) - 64e-9 * L(.39943 - 5.37511 * n), R = t0 * $0(.60643382 + 1336.85522467 * n - 313e-8 * d) + I / w0, y = t0 * $0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = t0 * $0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = t0 * $0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, P = t0 * $0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (u0(0, h, 1), u0(1, h, Math.cos(c) * u), l0(0, h, 0), l0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) ot(p0(l - 1, h), v0(l - 1, h), p0(1, h), v0(1, h), (T, U) => (u0(l, h, T), l0(l, h, U)));
		...
		function Hn(T, U, V, H) {
			for (var Q = {
				...
				V,
				H
			], A0 = 1; A0 <= 4; ++A0) D0[A0] !== 0 && ot(Q.x, Q.y, p0(D0[A0], A0), v0(D0[A0], A0), (n2, o1) => (Q.x = n2, Q.y = o1));
			return Q;
		}
		function S(T, U, V, H, Q, D0, A0, n2) {
			var o1 = Hn(Q, D0, A0, n2);
	...
	function H1(t, n, e, o, r) {
		...
		if (r) {
			let o0 = G, p0 = A1(r, 90 - G);
			if (G -= p0, p0 > 0 && G > 3e-4) {
				const v0 = Math.sin(G * _), u0 = Math.cos(G * _), l0 = Math.sin(o0 * _), ot = Math.cos(o0 * _), L = [];
				for (let h0 = 0; h0 < 3; ++h0) L.push((x[h0] - ot * R[h0]) / l0 * v0 + R[h0] * u0);
	...
	function b2(t) {
		const n = E(t).AddDays(-1 / I1), e = Y0(q.Earth, n), [o, r, s] = V1([
			-e.x,
			-e.y,
			-e.z
	...
	function u1(t, n, e, o, r) {
		...
		return k2(o ? V1(c, s, O.From2000) : c, s);
	}
	function q3(t, n, e) {
		const o = E(t);
		let r = yt(n, M0(o)).pos;
		return e || (r = V1(r, o, O.Into2000)), gt(r, o);
	}
	function K3(t, n, e) {
	...
	const K0 = 365250, Dt = 0, It = 1, J1 = 2;
	function zt(t) {
	...
	function Y0(t, n) {
		const e = n.tt / K0;
		return zt(V2(z0(t[Dt], e, !0), z0(t[It], e, !1), z0(t[J1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / K0, o = z0(t[Dt], e, !0), r = z0(t[It], e, !1), s = z0(t[J1], e, !1), i = vt(t[Dt], e), a = vt(t[It], e), c = vt(t[J1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), d = Math.sin(r), p = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, w = V2(o, r, s), g = [
			p / K0,
			M / K0,
			A / K0
		];
	...
	function G1(t, n, e, o) {
		const r = o / (o + a1), s = Y0(q[e], n);
		t.x += r * s.x, t.y += r * s.y, t.z += r * s.z;
	}
	function j3(t) {
		const n = new z(0, 0, 0, t);
		return G1(n, t, f.Jupiter, b0), G1(n, t, f.Saturn, V0), G1(n, t, f.Uranus, F0), G1(n, t, f.Neptune, H0), n;
	}
	...
	var M1 = class {
		...
		Acceleration(t) {
			...
			return n.incr(d1(t, b0, this.Jupiter.r)), n.incr(d1(t, V0, this.Saturn.r)), n.incr(d1(t, F0, this.Uranus.r)), n.incr(d1(t, H0, this.Neptune.r)), n;
		}
	}, Tt = class $n {
		constructor(n, e, o, r) {
	...
	function Lt(t, n) {
		const e = t - n.tt, o = new M1(t), r = j0(e, n.r, n.v, n.a), s = o.Acceleration(r).mean(n.a), i = j0(e, n.r, n.v, s);
		return new F2(o, new Tt(t, i, n.v.add(s.mul(e)), o.Acceleration(i)));
	}
	const t4 = [];
	function H2(t, n) {
	...
	function Ct(t) {
		const n = Z3(t), e = new M1(n.tt), o = n.r.add(e.Sun.r), r = n.v.add(e.Sun.v), s = e.Acceleration(o);
		return new F2(e, new Tt(n.tt, o, r, s));
	}
	function n4(t, n) {
		const e = P0[0][0];
		if (n < e || n > P0[Pt - 1][0]) return null;
		const o = H2((n - e) / X3, Pt - 1);
		if (!t[o]) {
			const s = t[o] = [];
	...
	function Ut(t, n) {
		...
		const s = n4(t4, t.tt);
		if (s) {
			const i = H2((t.tt - s[0].tt) / W0, S0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = j0(t.tt - a.tt, a.r, a.v, u), l = Nt(t.tt - a.tt, a.v, u), d = j0(t.tt - c.tt, c.r, c.v, u), p = Nt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
		...
		return n && (r || (r = new M1(t.tt)), e = e.sub(r.Sun.r), o = o.sub(r.Sun.v)), new F(e.x, e.y, e.z, o.x, o.y, o.z, t);
	}
	const e4 = new $([
		[
			.999432765338654,
	...
	function B1(t, n) {
		...
		return W1(e4, o4(t, n.mu, o));
	}
	function r4(t) {
		const n = new y0(t);
		return new J2(B1(n, Q1[0]), B1(n, Q1[1]), B1(n, Q1[2]), B1(n, Q1[3]));
	}
	function a0(t, n) {
		var e = E(n);
	...
	function N0(t, n) {
		...
		if (e) return e.dist;
		const o = E(n);
		return t in q ? z0(q[t][J1], o.tt / K0, !1) : a0(t, o).Length();
	}
	function G2(t, n) {
		let e = n, o = 0;
		for (let r = 0; r < 10; ++r) {
			const s = t(e), i = s.Length() / I1;
	...
	function Q2(t, n, e, o) {
		...
		if (C1(e)) {
			const a = a0(e, r);
			if (o) {
				const u = q1(n, r), h = new z(a.x - u.x, a.y - u.y, a.z - u.z, r), l = I1 / h.Length();
	...
	function i4(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(q[f.Earth], e.tt), s = t === f.Moon ? h1(e) : mt(e);
	...
	function q1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(q.Earth, e.tt), s = t == f.Moon ? h1(e) : mt(e);
	...
	function J(t, n, e, o) {
		const r = v(o && o.dt_tolerance_seconds || 1), s = Math.abs(r / P1);
	...
	function K1(t, n) {
		...
		let r, s, i, a;
		t === f.Sun ? (i = new z(-o.x, -o.y, -o.z, e), s = new z(0, 0, 0, e), r = 0) : (t === f.Moon ? (i = i0(e), s = new z(o.x + i.x, o.y + i.y, o.z + i.z, e)) : (s = a0(t, n), i = new z(s.x - o.x, s.y - o.y, s.z - o.z, e)), r = L1(i, s));
	...
	function Y2(t) {
		let n = kt(t), e = (Math.floor(n / 90) + 1) % 4, o = _1(90 * e, t, 10);
		if (!o) throw "Cannot find moon quarter";
		return new K2(e, o);
	}
	function h4(t) {
		return Y2(new Date(t.time.date.getTime() + 6 * x3));
	}
	var W2 = class {
		constructor(t, n, e) {
	...
	function M4(t, n, e, o, r, s = 0) {
		...
		const i = d4(t), a = j2(n.height - s);
		return X2(t, n, e, o, r, i, f4(n, s) - P3 * a.density);
	}
	...
	function A4(t, n, e, o, r = 1) {
		...
		for (;;) {
			++i;
			let a = M0(s), c = u1(t, s, n, !0, !0), u = (e + c.ra - n.longitude / 15 - a) % 24;
	...
	function E4(t, n, e) {
		const o = E(n), r = N2(o), s = u1(t, o, e, !0, !0);
	...
	function I4(t, n) {
		const e = Ft(t);
		return e.lon = an(e.lon), e.lat += A1(n, e.lat), e;
	}
	function z4(t, n, e) {
		n = E(n);
		const o = an(t.lon);
		return Y1(new Q0(t.lat + cn(e, t.lat), o, t.dist), n);
	}
	function A1(t, n) {
		let e;
	...
	function j1(t) {
		return t = E(t), m0(O1(t, O.From2000), b1(t, O.From2000));
	}
	function T4(t) {
		const n = E(t);
		return m0(j1(n), _n(n));
	...
	function X1(t) {
		return t = E(t), m0(b1(t, O.Into2000), O1(t, O.Into2000));
	}
	function Ht(t, n) {
		t = E(t);
	...
	function V4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), $t || ($t = j1(new y0(-45655.74141261017)), pn = new y0(0));
		const e = Y1(new Q0(n, 15 * t, 1), pn), o = Vt(E1($t, e)), r = 10 / 240, s = r / 15;
		for (let i of b4) {
	...
	function H4(t, n, e) {
		const o = 11574074074074073e-21, r = tt(t, n, e.AddDays(-o));
		return (tt(t, n, e.AddDays(+o)).r - r.r) / o;
	}
	function $4(t) {
		const e = J((o) => Gt(Z1, o), t.AddDays(-.03), t.AddDays(.03));
	...
	function Qt(t, n, e) {
		const o = e / 1440, r = t.AddDays(-o), s = t.AddDays(+o), i = J((c) => -(Z1(c).r - n), r, t), a = J((c) => +(Z1(c).r - n), t, s);
	...
	function gn(t, n) {
		const e = new z(t.x + n.x, t.y + n.y, t.z + n.z, t.t), o = yn(Math.asin(w2 / e.Length()), Math.asin(z3 / n.Length()), L1(n, e) * _);
	...
	function B4(t) {
		...
		const i = j1(t.time), a = E1(i, t.dir), c = E1(i, t.target);
		...
		if (p > 0) {
			...
			P = E1(x, P), P.x += t.target.x, P.y += t.target.y, P.z += t.target.z;
			const I = w1(g2, t.time, P, t.dir);
	...
	function Y4(t, n) {
		...
		const a = nt(n, 1, zn, s, t.time), c = nt(n, -1, zn, t.time, i);
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = nt(n, 1, Pn, s, t.time), h = nt(n, -1, Pn, t.time, i), l = mn(t.k)) : l = X.Partial;
		const d = l === X.Total ? 1 : gn(t.dir, t.target);
		return new In(l, d, a, u, r, h, c);
	}
	function nt(t, n, e, o, r) {
		function s(a) {
			return n * e(Jt(a, t));
		}
		const i = J(s, o, r);
	...
	function bn(t) {
		let n = E(t), e = $1(n);
		for (;;) {
			const o = n.AddDays(kn), r = $1(o);
			if (e.lat * r.lat <= 0) {
				const s = r.lat > e.lat ? _0.Ascending : _0.Descending, i = J((a) => s * $1(a).lat, n, o);
	...
	function o6(t, n, e, o) {
		...
		let a, c;
		return e === f.Earth && o === f.Moon ? (a = new F(0, 0, 0, 0, 0, 0, r), c = h1(r)) : (a = q1(e, r), c = q1(o, r)), Vn(t, a, s, c, i);
	}
	...
	var r6 = class Z {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = j(o, n.tt, f.Mercury, _t), e[f.Venus] = j(o, n.tt, f.Venus, pt), e[f.Earth] = j(o, n.tt, f.Earth, c1 + T1), e[f.Mars] = j(o, n.tt, f.Mars, At), e[f.Jupiter] = j(o, n.tt, f.Jupiter, b0), e[f.Saturn] = j(o, n.tt, f.Saturn, V0), e[f.Uranus] = j(o, n.tt, f.Uranus, F0), e[f.Neptune] = j(o, n.tt, f.Neptune, H0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new T0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = K.zero(), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, _t), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, pt), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + T1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, At), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, b0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, V0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, F0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, H0);
		}
	...
	const { MakeTime: R6, SearchRiseSet: x6, Body: m6, Observer: s6 } = et(D1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: z6, CombineRotation: P6, MakeRotation: T6 } = et(D1);
	Math.PI / (180 * 3600);
	function Kt(t, n) {
