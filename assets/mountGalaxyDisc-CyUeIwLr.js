...
`;function u(a){return new p(a[0],a[1],a[2])}function q(a){return new f(a[0],a[1],a[2])}function w(a,o){return{uTime:{value:0},uRadius:{value:a.discRadiusSu},uIntensity:{value:o.intensity},uBulgeStrength:{value:o.bulgeStrength},uBulgeRadiusRatio:{value:o.bulgeRadiusRatio},uArmCount:{value:o.armCount},uArmWinding:{value:o.armWinding},uArmContrast:{value:o.armContrast},uDustStrength:{value:o.dustStrength},uPositionAngle:{value:a.positionAngleRad},uColorBulge:{value:u(o.colorBulge)},uColorArms:{value:u(o.colorArms)},uColorDust:{value:u(o.colorDust)},uMorphScale:{value:q(a.morphScale)}}}function F(a){const o=L(a);if(o===null||o.discRadiusSu<=0)return null;const r=W(a),t=c(a),i=new g;i.name=`galaxy-${a.catalogId}`,i.position.set(t.x,t.y,t.z);const e=new v(o.discRadiusSu,64,32),n=w(o,r),s=new A({uniforms:n,vertexShader:k,fragmentShader:O,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1}),l=new h(e,s);return l.frustumCulled=!1,l.renderOrder=-15,i.add(l),{group:i,mesh:l,material:s,geometry:e}}function j(a){a.geometry.dispose(),a.material.dispose()}function H(a){return D(a,{layerName:"galaxyDiscLayer",selectEntries:()=>R(C()),createVisual:F,disposeVisual:j,applyFrame:(o,r)=>{const{uTime:t}=o.material.uniforms;t.value=r}})}var J=S(H,"present.hud");export{J as GalaxyDiscMountR3f};
