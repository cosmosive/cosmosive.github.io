(function() {
	var i2 = Object.defineProperty, Ze = (t, e) => {
		let n = {};
	...
	180 / Math.PI;
	const lt = 86400, en = 365.25, m0 = 299792.458, ht = m0 * en * lt, C = 149597870.7, dt = 648e3 / Math.PI, on = dt * C / ht, rn = 23.4392911, sn = 1e3, an = m0, cn = m0 ** Math.sqrt(Math.E), un = m0 ** 2, ln = m0 ** Math.E, hn = [
		1,
		sn,
		an,
		cn
	...
	var R1 = (t, e, n) => Object.defineProperty(t, e, {
		...
		writable: !0,
		configurable: !0
	}), dn = Symbol.for("bitecs-relation"), fn = Symbol.for("bitecs-pairTarget"), Mn = Symbol.for("bitecs-isPairComponent"), a1 = Symbol.for("bitecs-relationData"), l2 = () => {
		let t = {
	...
	yn();
	const Dn = 384399 / C, Un = 421800 / C, On = 671034 / C, vn = 1070400 / C, Pn = 1882700 / C, bn = 9376 / C, zn = 23463 / C, Cn = 185540 / C, Ln = 237948 / C, kn = 294619 / C, Kn = 377396 / C, Bn = 527108 / C, Hn = 1221870 / C, Vn = 3560820 / C, Jn = 129390 / C, Fn = 190900 / C, $n = 266e3 / C, Gn = 436300 / C, Yn = 583520 / C, jn = 354759 / C, Qn = {
		[f.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	const f2 = Symbol("Comlink.proxy"), Xn = Symbol("Comlink.endpoint"), Wn = Symbol("Comlink.releaseProxy"), Mt = Symbol("Comlink.finalizer"), x1 = Symbol("Comlink.thrown"), M2 = (t) => typeof t == "object" && t !== null || typeof t == "function", A2 = /* @__PURE__ */ new Map([["proxy", {
	...
	function At(t, e = globalThis, n = ["*"]) {
		e.addEventListener("message", function o(r) {
			...
			const { id: s, type: a, path: i } = Object.assign({ path: [] }, r.data), c = (r.data.argumentList || []).map(D0);
			let u;
			try {
				...
				switch (a) {
					case "GET":
						...
						break;
					case "SET":
						l[i.slice(-1)[0]] = D0(r.data.value), u = !0;
						break;
					case "APPLY":
						u = h.apply(l, c);
						break;
			...
			Promise.resolve(u).catch((l) => ({
				...
				const [h, M] = D1(l);
				e.postMessage(Object.assign(Object.assign({}, h), { id: s }), M), a === "RELEASE" && (e.removeEventListener("message", o), S2(e), Mt in t && typeof t[Mt] == "function" && t[Mt]());
			}).catch((l) => {
				const [h, M] = D1({
	...
	function St(t, e, n = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(a, i, c) {
				...
				if (u === Xn) return C0(t, e, { type: "ENDPOINT" }).then(D0);
	...
	var i1 = Ze({
		...
		SearchLunarApsis: () => ce,
		SearchLunarEclipse: () => Te,
		SearchMaxElongation: () => p4,
		SearchMoonNode: () => Ve,
		SearchMoonPhase: () => S1,
		SearchMoonQuarter: () => te,
		SearchPeakMagnitude: () => y4,
		SearchPlanetApsis: () => le,
	...
	const U1 = 173.1446326846693, P = 149597870.69098932, y2 = 63241.07708807546, _ = .017453292519943295, _t = .26179938779914946, k = 57.29577951308232, Et = 3.819718634205488, c3 = 71492, u3 = 66854, l3 = 69911, h3 = 1821.6, d3 = 1560.8, f3 = 2631.2, M3 = 2410.3, m2 = 365.24217, R2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), e0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), L0 = 484813681109536e-20, I2 = 10800 * 60, A3 = 2 * I2, S3 = 7292115e-11, _3 = I2 / Math.PI, E3 = -.17 - 5 * Math.log10(_3), O1 = 29.530588, v1 = 24 * 3600, p3 = v1 * 1e3, g2 = .9972695717592592, pt = 695700, x2 = pt / P, s0 = .996647180302104, k0 = s0 * s0, M0 = 6378.1366, y3 = M0 / P, m3 = M0 * s0, R3 = 6371, I3 = 6459, g3 = 1738.1 / P, X = 1737.4, w2 = 1736, x3 = w2 / P, w3 = 34 / 60, T3 = 81.30056, c1 = .0002959122082855911, yt = 4912547451450812e-26, mt = 7243452486162703e-25, T2 = 8887692390113509e-25, Rt = 9549535105779258e-26, K0 = 2.825345909524226e-7, B0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, V0 = 1.524358900784276e-8, N3 = 218869976542597e-26, D3 = T2 / T3;
	function It(t) {
		switch (t) {
			case d.Sun: return c1;
			case d.Mercury: return yt;
			case d.Venus: return mt;
			case d.Earth: return T2;
	...
	function N2(t) {
		const e = U3.indexOf(t);
		return e >= 0 ? O3[e] : null;
	}
	function z1(t) {
		const e = N2(t);
	...
	var I0 = class ut {
		constructor(e) {
			...
			if (e instanceof Date && Number.isFinite(e.getTime())) {
				this.date = e, this.ut = (e.getTime() - R2.getTime()) / n, this.tt = U2(this.ut);
				return;
			}
			if (Number.isFinite(e)) {
				this.date = new Date(R2.getTime() + e * n), this.ut = e, this.tt = U2(this.ut);
				return;
			}
	...
	function g0(t) {
		if (!C1 || Math.abs(C1.tt - t.tt) > 1e-6) {
			const e = L3(t), n = O2(t), o = n + e.deps / 3600;
			C1 = {
				tt: t.tt,
				dpsi: e.dpsi,
				deps: e.deps,
	...
	function x0(t) {
		...
		function o(U, b, B, V) {
			const G = [];
			for (let N0 = 0; N0 <= b - U; ++N0) G.push(n(B, V));
			return {
				min: U,
				array: G
			};
		...
		function r(U, b, B) {
			const V = U.array[b - U.min];
			return V.array[B - V.min];
		}
		function s(U, b, B, V) {
			const G = U.array[b - U.min];
			G.array[B - G.min] = V;
		}
		let a, i, c, u, l, h, M, y, A, E, I, R, p, g, w, x, N, O, L, K, Q, $, q, u0 = o(-6, 6, 1, 4), r0 = o(-6, 6, 1, 4);
		function E0(U, b) {
			return r(u0, U, b);
		}
		function l0(U, b) {
		...
		function it(U, b, B, V, G) {
			G(U * B - b * V, b * B + U * V);
		}
		function v(U) {
			return Math.sin(e0 * U);
		}
		M = e * e, A = 0, q = 0, I = 0, R = 3422.7;
		var d0 = v(.19833 + .05611 * e), e2 = v(.27869 + .04508 * e), n2 = v(.16827 - .36903 * e), o2 = v(.34734 - 5.37261 * e), r2 = v(.10498 - 5.37899 * e), ct = v(.42681 - .41855 * e), S6 = v(.14943 - 5.37511 * e);
		for (O = .84 * d0 + .31 * e2 + 14.27 * n2 + 7.26 * o2 + .28 * r2 + .24 * ct, L = 2.94 * d0 + .31 * e2 + 14.27 * n2 + 9.34 * o2 + 1.12 * r2 + .83 * ct, K = -6.4 * d0 - 1.89 * ct, Q = .21 * d0 + .31 * e2 + 14.27 * n2 - 88.7 * o2 - 15.3 * r2 + .24 * ct - 1.86 * S6, $ = O - K, y = -3332e-9 * v(.59734 - 5.37261 * e) - 539e-9 * v(.35498 - 5.37899 * e) - 64e-9 * v(.39943 - 5.37511 * e), p = e0 * J0(.60643382 + 1336.85522467 * e - 313e-8 * M) + O / R0, g = e0 * J0(.37489701 + 1325.55240982 * e + 2565e-8 * M) + L / R0, w = e0 * J0(.99312619 + 99.99735956 * e - 44e-8 * M) + K / R0, x = e0 * J0(.25909118 + 1342.2278298 * e - 892e-8 * M) + Q / R0, N = e0 * J0(.82736186 + 1236.85308708 * e - 397e-8 * M) + $ / R0, l = 1; l <= 4; ++l) {
			switch (l) {
				case 1:
			...
			for (h0(0, l, 1), h0(1, l, Math.cos(c) * u), r1(0, l, 0), r1(1, l, Math.sin(c) * u), h = 2; h <= i; ++h) it(E0(h - 1, l), l0(h - 1, l), E0(1, l), l0(1, l), (U, b) => (h0(h, l, U), r1(h, l, b)));
		...
		function S(U, b, B, V, G, N0, p0, s2) {
			var s1 = Xe(G, N0, p0, s2);
			A += U * s1.y, q += b * s1.y, I += B * s1.x, R += V * s1.x;
		}
		...
		function f0(U, b, B, V, G) {
			return U * Xe(b, B, V, G).y;
		}
		E = 0, E += f0(-526.069, 0, 0, 1, -2), E += f0(-3.352, 0, 0, 1, -4), E += f0(44.297, 1, 0, 1, -2), E += f0(-6, 1, 0, 1, -4), E += f0(20.599, -1, 0, 1, 0), E += f0(-30.598, -1, 0, 1, -2), E += f0(-24.649, -2, 0, 1, 0), E += f0(-2, -2, 0, 1, -2), E += f0(-22.571, 0, 1, 1, -2), E += f0(10.985, 0, -1, 1, -2), A += .82 * v(.7736 - 62.5512 * e) + .31 * v(.0466 - 125.1025 * e) + .35 * v(.5785 - 25.1042 * e) + .66 * v(.4591 + 1335.8075 * e) + .64 * v(.313 - 91.568 * e) + 1.14 * v(.148 + 1331.2898 * e) + .21 * v(.5918 + 1056.5859 * e) + .44 * v(.5784 + 1322.8595 * e) + .24 * v(.2275 - 5.7374 * e) + .28 * v(.2965 + 2.6929 * e) + .33 * v(.3132 + 6.3368 * e), a = x + q / R0;
	...
	function L1(t, e) {
		...
		o *= L0, r *= L0, s *= L0, a *= L0;
		const i = Math.sin(o), c = Math.cos(o), u = Math.sin(-r), l = Math.cos(-r), h = Math.sin(-s), M = Math.cos(-s), y = Math.sin(a), A = Math.cos(a), E = A * l - u * y * M, I = A * u * c + y * M * l * c - i * y * h, R = A * u * i + y * M * l * i + c * y * h, p = -y * l - u * A * M, g = -y * u * c + A * M * l * c - i * A * h, w = -y * u * i + A * M * l * i + c * A * h, x = u * h, N = -h * l * c - i * M, O = -h * l * i + M * c;
	...
	function V3(t, e, n) {
		return n === z.Into2000 ? C2(k2(t, e, n), e, n) : k2(C2(t, e, n), e, n);
	}
	function K2(t, e) {
	...
	function V1(t, e, n, o, r) {
		...
		const N = x[0] * p[0] + x[1] * p[1] + x[2] * p[2], O = x[0] * g[0] + x[1] * g[1] + x[2] * g[2], L = x[0] * w[0] + x[1] * w[1] + x[2] * w[2];
		let K = Math.hypot(O, L), Q;
		K > 0 ? (Q = -57.29577951308232 * Math.atan2(L, O), Q < 0 && (Q += 360)) : Q = 0;
		let $ = k * Math.atan2(K, N), q = n, u0 = o;
		if (r) {
			let r0 = $, E0 = E1(r, 90 - $);
			if ($ -= E0, E0 > 0 && $ > 3e-4) {
				const l0 = Math.sin($ * _), h0 = Math.cos($ * _), r1 = Math.sin(r0 * _), it = Math.cos(r0 * _), v = [];
				for (let d0 = 0; d0 < 3; ++d0) v.push((x[d0] - it * p[d0]) / r1 * l0 + p[d0] * h0);
				K = Math.hypot(v[0], v[1]), K > 0 ? (q = Et * Math.atan2(v[1], v[0]), q < 0 && (q += 24)) : q = 0, u0 = k * Math.atan2(v[2], K);
			}
		}
		return new B2(Q, 90 - $, q, u0);
	}
	function j0(t) {
	...
	function J2(t) {
		const e = m(t).AddDays(-1 / U1), n = q0(Y.Earth, e), [o, r, s] = B1([
			-n.x,
			-n.y,
			-n.z
		], e, z.From2000), a = _ * g0(e).tobl, i = Math.cos(a), c = Math.sin(a);
		return Nt(new D(o, r, s, e), i, c);
	}
	function u1(t, e, n, o, r) {
		...
		return V2(o ? B1(c, s, z.From2000) : c, s);
	}
	function $3(t, e, n) {
		const o = m(t);
		let r = xt(e, A0(o)).pos;
	...
	function Nt(t, e, n) {
		...
		return new H2(new D(o, r, s, t.t), c, i);
	}
	function l1(t) {
		const e = g0(t.t), [n, o, r] = $0(F0([
			...
			t.y,
			t.z
		], t.t, z.From2000), t.t, z.From2000), s = new D(n, o, r, t.t), a = e.tobl * _;
	...
	const Q0 = 365250, Ot = 0, vt = 1, F1 = 2;
	function Pt(t) {
	...
	function q0(t, e) {
		const n = e.tt / Q0;
		return Pt(F2(U0(t[Ot], n, !0), U0(t[vt], n, !1), U0(t[F1], n, !1))).ToAstroVector(e);
	}
	function d1(t, e) {
		const n = e / Q0, o = U0(t[Ot], n, !0), r = U0(t[vt], n, !1), s = U0(t[F1], n, !1), a = Ut(t[Ot], n), i = Ut(t[vt], n), c = Ut(t[F1], n), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), M = Math.sin(r), y = +(c * h * u) - s * M * u * i - s * h * l * a, A = +(c * h * l) - s * M * l * i + s * h * u * a, E = +(c * M) + s * h * i, I = F2(o, r, s), R = [
			y / Q0,
			A / Q0,
			E / Q0
		];
		return new v0(e, Pt(I), Pt(R));
	}
	function $1(t, e, n, o) {
	...
	const bt = 51, q3 = 29200, G1 = 146, S0 = 201, O0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function X3(t) {
		let [e, [n, o, r], [s, a, i]] = t;
		return new v0(e, new j(n, o, r), new j(s, a, i));
	}
	function W(t, e, n, o) {
	...
	var M1 = class {
		constructor(t) {
			let e = new v0(t, new j(0, 0, 0), new j(0, 0, 0));
			this.Jupiter = W(e, t, d.Jupiter, K0), this.Saturn = W(e, t, d.Saturn, B0), this.Uranus = W(e, t, d.Uranus, H0), this.Neptune = W(e, t, d.Neptune, V0), this.Jupiter.r.decr(e.r), this.Jupiter.v.decr(e.v), this.Saturn.r.decr(e.r), this.Saturn.v.decr(e.v), this.Uranus.r.decr(e.r), this.Uranus.v.decr(e.v), this.Neptune.r.decr(e.r), this.Neptune.v.decr(e.v), this.Sun = new v0(t, e.r.mul(-1), e.v.mul(-1));
		}
		Acceleration(t) {
		...
		clone() {
			return new We(this.tt, this.r.clone(), this.v.clone(), this.a.clone());
		}
	}, $2 = class {
		constructor(t, e) {
	...
	function Lt(t, e) {
		...
		return new $2(o, new zt(t, a, e.v.add(s.mul(n)), o.Acceleration(a)));
	}
	const W3 = [];
	function G2(t, e) {
	...
	function kt(t) {
		...
		return new $2(n, new zt(e.tt, o, r, s));
	}
	function Z3(t, e) {
		const n = O0[0][0];
		if (e < n || e > O0[bt - 1][0]) return null;
		const o = G2((e - n) / q3, bt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = kt(O0[o]).grav, s[S0 - 1] = kt(O0[o + 1]).grav;
			let a, i = s[0].tt;
	...
	function Kt(t, e) {
		...
		const s = Z3(W3, t.tt);
		if (s) {
			const a = G2((t.tt - s[0].tt) / G1, S0 - 1), i = s[a], c = s[a + 1], u = i.a.mean(c.a), l = X0(t.tt - i.tt, i.r, i.v, u), h = Ct(t.tt - i.tt, i.v, u), M = X0(t.tt - c.tt, c.r, c.v, u), y = Ct(t.tt - c.tt, c.v, u), A = (t.tt - i.tt) / G1;
			n = l.mul(1 - A).add(M.mul(A)), o = h.mul(1 - A).add(y.mul(A));
		} else {
			let a;
			t.tt < O0[0][0] ? a = Y2(O0[0], t.tt, -146) : a = Y2(O0[bt - 1], t.tt, 146), n = a.grav.r, o = a.grav.v, r = a.bary;
		}
	...
	function e4(t, e, n) {
		...
		const A = a * l - s * h, E = -s * l - a * h, I = 1 / (1 + E), R = 1 / (1 + Math.sqrt(1 - s * s - a * a)), p = o * (l - s - R * a * A), g = o * (h - a + R * s * A), w = u * I * o * (-h - R * a * E), x = u * I * o * (+l + R * s * E), N = 2 * Math.sqrt(1 - i * i - c * c), O = 1 - 2 * c * c, L = 1 - 2 * i * i, K = 2 * c * i;
		return new H(p * O + g * K, p * K + g * L, (i * g - p * c) * N, w * O + x * K, w * K + x * L, (i * x - w * c) * N, t);
	}
	function j1(t, e) {
	...
	function n4(t) {
		const e = new I0(t);
		return new j2(j1(e, Y1[0]), j1(e, Y1[1]), j1(e, Y1[2]), j1(e, Y1[3]));
	}
	function c0(t, e) {
		var n = m(e);
		...
		if (t === d.EMB) {
			...
			return new D(a.x + i.x / c, a.y + i.y / c, a.z + i.z / c, n);
		}
	...
	function q2(t, e, n, o) {
		...
		if (z1(n)) {
			const i = c0(n, r);
			if (o) {
				const u = Q1(e, r), l = new D(i.x - u.x, i.y - u.y, i.z - u.z, r), h = U1 / l.Length();
				return new D(l.x + u.vx / h, l.y + u.vy / h, l.z + u.vz / h, r);
			}
			const c = c0(e, r);
			return new D(i.x - c.x, i.y - c.y, i.z - c.z, r);
		}
		let s;
		o ? s = new D(0, 0, 0, r) : s = c0(e, r);
		const a = new o4(e, n, o, s);
		return Q2((i) => a.Position(i), r);
	}
	function n0(t, e, n) {
		P1(n);
		const o = m(e);
	...
	function r4(t, e) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = d1(Y[d.Earth], n.tt), s = t === d.Moon ? h1(n) : Dt(n);
	...
	function Q1(t, e) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = d1(Y.Earth, n.tt), s = t == d.Moon ? h1(n) : Dt(n);
	...
	function F(t, e, n, o) {
		const r = T(o && o.dt_tolerance_seconds || 1), s = Math.abs(r / v1);
	...
	function q1(t, e) {
		...
		let r, s, a, i;
		t === d.Sun ? (a = new D(-o.x, -o.y, -o.z, n), s = new D(0, 0, 0, n), r = 0) : (t === d.Moon ? (a = i0(n), s = new D(o.x + a.x, o.y + a.y, o.z + a.z, n)) : (s = c0(t, e), a = new D(s.x - o.x, s.y - o.y, s.z - o.z, n)), r = b1(a, s));
	...
	function e1(t, e, n) {
		...
		for (let u = 0; u < 100; ++u) {
			let l = -c / 360 * a;
			if (i = i.AddDays(l), Math.abs(l) * v1 < 1) return i;
			let h = c;
	...
	function S1(t, e, n) {
		...
		let a = o(s), i, c, u;
		if (n < 0) {
			if (a < 0 && (a += 360), i = -(O1 * a) / 360, u = i + r, u < n) return null;
			c = Math.max(n, i - r);
		} else {
			if (a > 0 && (a -= 360), i = -(O1 * a) / 360, c = i - r, c > n) return null;
			u = Math.min(n, i + r);
		}
	...
	function u4(t) {
		return te(new Date(t.time.date.getTime() + 6 * p3));
	}
	var ee = class {
		constructor(t, e, n) {
	...
	function d4(t, e, n, o, r, s = 0) {
		...
		const a = h4(t), i = ne(e.height - s);
		return oe(t, e, n, o, r, a, l4(e, s) - w3 * i.density);
	}
	function f4(t, e, n, o, r, s) {
		if (!Number.isFinite(s) || s < -90 || s > 90) throw `Invalid altitude angle: ${s}`;
		return oe(t, e, n, o, r, 0, s);
	}
	var M4 = class {
		constructor(t, e, n, o) {
	...
	function Vt(t, e, n, o, r, s, a) {
		...
		const i = r.ut - o.ut;
		if (i * v1 < 1 || Math.min(Math.abs(s), Math.abs(a)) > n * (i / 2)) return null;
	...
	function A4(t, e) {
		...
		const r = _ * e;
		return Math.abs((360 / g2 - n) * Math.cos(r)) + Math.abs(o * Math.sin(r));
	}
	function oe(t, e, n, o, r, s, a) {
	...
	function _4(t, e, n) {
		const o = m(e), r = L2(o), s = u1(t, o, n, !0, !0);
	...
	function E4(t) {
		function e(n, o, r) {
			let s = new Date(Date.UTC(t, o - 1, r)), a = X2(n, s, 20);
		...
		return new se(e(0, 3, 10), e(90, 6, 10), e(180, 9, 10), e(270, 12, 10));
	}
	var ae = class {
		constructor(t, e, n, o) {
	...
	function R4(t, e) {
		...
		const l = ue(t, 0, s.AddDays(-2 * u), 4 * u), h = ue(t, 1, a.AddDays(-2 * u), 4 * u);
	...
	function I4(t, e) {
		...
		const n = .25 * a0[t].OrbitalPeriod, o = le(t, e.time.AddDays(n));
	...
	function w4(t, e) {
		const n = Ft(t);
		return n.lon = he(n.lon), n.lat += E1(e, n.lat), n;
	}
	function T4(t, e, n) {
		e = m(e);
		const o = he(t.lon);
		return X1(new G0(t.lat + de(n, t.lat), o, t.dist), e);
	}
	function E1(t, e) {
		let n;
	...
	function L4(t, e) {
		...
		t %= 24, t < 0 && (t += 24), Gt || (Gt = Z1(new I0(-45655.74141261017)), me = new I0(0));
		const n = X1(new G0(e, 15 * t, 1), me), o = Jt(p1(Gt, n)), r = 10 / 240, s = r / 15;
		for (let a of C4) {
			const i = a[3] * r, c = a[1] * s, u = a[2] * s;
			if (i <= o.dec && c <= o.ra && o.ra < u) {
				const l = z4[a[0]];
				return new Re(l[0], l[1], o.ra, o.dec);
			}
		}
	...
	function ge(t) {
		const e = n0(d.Sun, t, !0), n = i0(t), o = new D(-n.x, -n.y, -n.z, n.t);
		return n.x -= e.x, n.y -= e.y, n.z -= e.z, y1(X, t, o, n);
	}
	function Yt(t, e) {
		const n = K2(t, e), o = n0(d.Sun, t, !0), r = i0(t), s = new D(n[0] - r.x, n[1] - r.y, n[2] - r.z, t);
	...
	function H4(t) {
		const e = F((n) => jt(ge, n), t.AddDays(-.03), t.AddDays(.03));
	...
	function we(t, e) {
		const n = new D(t.x + e.x, t.y + e.y, t.z + e.z, t.t), o = xe(Math.asin(x2 / n.Length()), Math.asin(x3 / e.Length()), b1(e, n) * _);
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (a.r < a.p + X) {
					...
					return a.r < a.k + X && (i = Z.Partial, l = Qt(a.time, a.k + X, h), a.r + X < a.k ? (i = Z.Total, c = 1, u = Qt(a.time, a.k - X, l)) : c = xe(X, a.k, a.r)), new Ie(i, c, a.time, h, l, u);
				}
			}
			n = r.AddDays(10);
		}
	...
	function F4(t) {
		...
		if (y > 0) {
			...
			const x = n1(a);
			let N = new D(I / P, R / P, p / P, t.time);
			N = p1(x, N), N.x += t.target.x, N.y += t.target.y, N.z += t.target.z;
			const O = y1(w2, t.time, N, t.dir);
			if (O.r > 1e-9 || O.r < 0) throw `Unexpected shadow distance from geoid intersection = ${O.r}`;
			e = De(O.k), A = e === Z.Total ? 1 : we(t.dir, N);
		} else A = void 0;
		return new Ne(e, A, n, o, r, s);
	}
	function $4(t) {
		return t = m(t), Te(t.AddDays(10));
	}
	function Ue(t) {
		t = m(t);
		const e = 1.8;
	...
	function Y4(t, e) {
		...
		const s = ot(e, 1, Pe, o, t.time), a = ot(e, -1, Pe, t.time, r);
		let i, c, u;
		t.r < Math.abs(t.k) ? (o = t.time.AddDays(-.01), r = t.time.AddDays(.01), i = ot(e, 1, be, o, t.time), c = ot(e, -1, be, t.time, r), u = De(t.k)) : u = Z.Partial;
		const l = u === Z.Total ? 1 : we(t.dir, t.target);
	...
	function Q4(t, e) {
		return t = m(t), Ce(t.AddDays(10), e);
	}
	var Le = class {
		constructor(t, e, n, o) {
	...
	function Ke(t, e) {
		...
		for (;;) {
			...
			if (t1(t, s) < n) {
				const a = V4(t, o, s);
				if (a.r < a.p) {
					const i = a.time.AddDays(-1), c = ke(t, o, i, a.time, -1), u = a.time.AddDays(1), l = ke(t, o, a.time, u, 1), h = 60 * t1(t, a.time);
					return new Le(c, a.time, l, h);
				}
			}
			r = s.AddDays(10);
		}
	...
	function Z4(t) {
		const e = F0($0([
			...
			0,
			1
		], t, z.Into2000), t, z.Into2000), n = new D(e[0], e[1], e[2], t), o = Jt(n), r = 190.41375788700253 + 360.9856122880876 * t.ut;
	...
	function t6(t, e) {
		...
		switch (t) {
			...
			case d.Moon:
				const M = _ * (125.045 - .0529921 * o), y = _ * (250.089 - .1059842 * o), A = _ * (260.008 + 13.0120009 * o), E = _ * (176.625 + 13.3407154 * o), I = _ * (357.529 + .9856003 * o), R = _ * (311.589 + 26.4057084 * o), p = _ * (134.963 + 13.064993 * o), g = _ * (276.617 + .3287146 * o), w = _ * (34.226 + 1.7484877 * o), x = _ * (15.134 - .1589763 * o), N = _ * (119.743 + .0036096 * o), O = _ * (239.961 + .1643573 * o), L = _ * (25.053 + 12.9590088 * o);
		...
		const c = a * _, u = s * _, l = Math.cos(c), h = new D(l * Math.cos(u), l * Math.sin(u), Math.sin(c), n);
		return new Xt(s / 15, a, i, h);
	}
	function e6(t, e, n, o) {
		const r = m(e), s = It(n), a = It(o);
		let i, c;
		return n === d.Earth && o === d.Moon ? (i = new H(0, 0, 0, 0, 0, 0, r), c = h1(r)) : (i = Q1(n, r), c = Q1(o, r)), Je(t, i, s, c, a);
	}
	function Je(t, e, n, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const N = t == 4 ? .8660254037844386 : -.8660254037844386, O = .5 * a + N * p, L = .5 * i + N * g, K = .5 * c + N * w, Q = .5 * p - N * a, $ = .5 * g - N * i, q = .5 * w - N * c, u0 = l * O, r0 = l * L, E0 = l * K, l0 = h * a + M * i + y * c, h0 = h * p + M * g + y * w;
			A = new H(u0, r0, E0, l0 * O + h0 * Q, l0 * L + h0 * $, l0 * K + h0 * q, e.t);
		} else {
			...
			do {
				const O = x - E, L = x - I;
				N = (R * x + g / (O * O) + w / (L * L)) / (R - 2 * g / (O * O * O) - 2 * w / (L * L * L)), x -= N;
	...
	var n6 = class t0 {
		...
		InternalBodyState(e) {
			if (e === d.SSB) return new v0(this.curr.time.tt, j.zero(), j.zero());
			const n = this.curr.gravitators[e];
			if (n) return n;
			throw `Invalid body: ${e}`;
		}
		static CalcSolarSystem(e) {
			const n = {}, o = new v0(e.tt, j.zero(), j.zero());
	...
	const { MakeTime: t8, SearchRiseSet: e8, Body: n8, Observer: o6 } = rt(i1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: a8, CombineRotation: i8, MakeRotation: c8 } = rt(i1);
	Math.PI / (180 * 3600);
	rn * tn;
	(() => {
		const t = i1;
	...
	const { HelioState: f8, MakeTime: M8, JupiterMoons: A8, Body: at } = rt(i1);
	f.IO, f.EUROPA, f.GANYMEDE, f.CALLISTO;
	at.Mars, at.Saturn, at.Uranus, at.Neptune;
	f.CERES, f.ERIS, f.HAUMEA, f.MAKEMAKE;
	const o1 = 1e3, $e = o1 / C, Ge = $e * ht * on, a6 = 695700, i6 = 6378.137;
	function Ye(t) {
		return !Number.isFinite(t) || t <= 0 ? 0 : t * $e;
	}
	Ye(i6);
	Ye(a6);
	100 / dt;
	...
	function d6(t) {
		return Atomics.load(Qe(t), je) === 1 ? 1 : 0;
	}
	function qe(t) {
		return d6(t) === 0 ? 1 : 0;
	}
