(function() {
	...
	const s2 = Symbol("Comlink.proxy"), Yn = Symbol("Comlink.endpoint"), Wn = Symbol("Comlink.releaseProxy"), lt = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), i2 = (t) => typeof t == "object" && t !== null || typeof t == "function", a2 = new Map([["proxy", {
	...
	}, v1 = 149597870.7, dt = 648e3 / Math.PI;
	dt * v1 / 3.2615637771694;
	const f2 = 1e3 / v1, k0 = v1 * f2;
	100 * k0;
	100 / dt;
	...
	M2(h3);
	25 * Mt;
	const Y = 299792.458, I1 = .001, P1 = 1e3;
	1 * I1, 10 * I1, 100 * I1, 1 * P1, 10 * P1, 100 * P1, .01 * Y, .1 * Y, .5 * Y, 1 * Y, 10 * Y, 100 * Y, 1e3 * Y, 1e4 * Y, 1e5 * Y, 1e6 * Y, 1e7 * Y, 1e8 * Y, 1e9 * Y;
	1 * I1;
	1e9 * Y;
	1 * P1;
	function f3(t) {
	...
	const T1 = 173.1446326846693, C = 149597870.69098932, E2 = 63241.07708807546, _ = .017453292519943295, St = .26179938779914946, b = 57.29577951308232, _t = 3.819718634205488, M3 = 71492, S3 = 66854, _3 = 69911, A3 = 1821.6, p3 = 1560.8, E3 = 2631.2, y3 = 2410.3, y2 = 365.24217, w2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), b0 = 484813681109536e-20, g2 = 10800 * 60, w3 = 2 * g2, R2 = 7292115e-11, g3 = g2 / Math.PI, R3 = -.17 - 5 * Math.log10(g3), N1 = 29.530588, U1 = 24 * 3600, m3 = U1 * 1e3, m2 = .9972695717592592, i1 = 695700, x2 = i1 / C, s0 = .996647180302104, V0 = s0 * s0, M0 = 6378.1366, x3 = M0 / C, v3 = M0 * s0, v2 = 6371, I3 = v2 + 88, P3 = 1738.1 / C, j = 1737.4, I2 = 1736, D3 = I2 / C, z3 = 34 / 60, At = 81.30056, a1 = .0002959122082855911, pt = 4912547451450812e-26, Et = 7243452486162703e-25, c1 = 8887692390113509e-25, yt = 9549535105779258e-26, H0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, $0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, T3 = 218869976542597e-26, C1 = c1 / At;
	function wt(t) {
		switch (t) {
	...
	function m0(t) {
		...
		var f0 = U(.19833 + .05611 * n), Xt = U(.27869 + .04508 * n), Zt = U(.16827 - .36903 * n), t2 = U(.34734 - 5.37261 * n), n2 = U(.10498 - 5.37899 * n), ct = U(.42681 - .41855 * n), he = U(.14943 - 5.37511 * n);
		for (P = .84 * f0 + .31 * Xt + 14.27 * Zt + 7.26 * t2 + .28 * n2 + .24 * ct, k = 2.94 * f0 + .31 * Xt + 14.27 * Zt + 9.34 * t2 + 1.12 * n2 + .83 * ct, N = -6.4 * f0 - 1.89 * ct, B = .21 * f0 + .31 * Xt + 14.27 * Zt - 88.7 * t2 - 15.3 * n2 + .24 * ct - 1.86 * he, K = P - N, A = -3332e-9 * U(.59734 - 5.37261 * n) - 539e-9 * U(.35498 - 5.37899 * n) - 64e-9 * U(.39943 - 5.37511 * n), m = n0 * K0(.60643382 + 1336.85522467 * n - 313e-8 * d) + P / w0, w = n0 * K0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, v = n0 * K0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * K0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, z = n0 * K0(.82736186 + 1236.85308708 * n - 397e-8 * d) + K / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (l0(0, h, 1), l0(1, h, Math.cos(c) * u), h0(0, h, 0), h0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) at(p0(l - 1, h), I0(l - 1, h), p0(1, h), I0(1, h), (T, L) => (l0(l, h, T), h0(l, h, L)));
		...
		function Bn(T, L, V, F) {
			for (var G = {
				...
				V,
				F
			], E0 = 1; E0 <= 4; ++E0) P0[E0] !== 0 && at(G.x, G.y, p0(P0[E0], E0), I0(P0[E0], E0), (e2, s1) => (G.x = e2, G.y = s1));
			return G;
		}
		function S(T, L, V, F, G, P0, E0, e2) {
			var s1 = Bn(G, P0, E0, e2);
	...
	function K1(t, n, e, o, r) {
		...
		if (r) {
			...
			if (K -= p0, p0 > 0 && K > 3e-4) {
				const I0 = Math.sin(K * _), l0 = Math.cos(K * _), h0 = Math.sin(r0 * _), at = Math.cos(r0 * _), U = [];
				for (let f0 = 0; f0 < 3; ++f0) U.push((x[f0] - at * m[f0]) / h0 * I0 + m[f0] * l0);
	...
	function J2(t) {
		const n = E(t).AddDays(-1 / T1), e = j0(Q.Earth, n), [o, r, s] = $1([
			-e.x,
			-e.y,
			-e.z
	...
	function u1(t, n, e, o, r) {
		...
		return $2(o ? $1(c, s, O.From2000) : c, s);
	}
	function Q3(t, n, e) {
		const o = E(t);
		let r = Rt(n, S0(o)).pos;
		return e || (r = $1(r, o, O.Into2000)), mt(r, o);
	}
	function q3(t, n, e) {
	...
	function Y3(t, n) {
		...
		return n || (o = G0(o, t.t, O.From2000), o = B0(o, t.t, O.From2000)), J3(o, e);
	}
	function W3(t, n) {
	...
	function a0(t) {
		const n = E(t), e = m0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = G0(H3(n, [
	...
	function G1(t) {
		const n = E(t), e = m0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			...
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = mt(B0(N2(s.mobl, r), n, O.From2000), n), a = s.tobl * _, c = vt(i, Math.cos(a), Math.sin(a));
	...
	function j0(t, n) {
		const e = n.tt / W0;
		return Tt(K2(z0(t[Dt], e, !0), z0(t[zt], e, !1), z0(t[B1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / W0, o = z0(t[Dt], e, !0), r = z0(t[zt], e, !1), s = z0(t[B1], e, !1), i = Pt(t[Dt], e), a = Pt(t[zt], e), c = Pt(t[B1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), d = Math.sin(r), A = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, p = +(c * d) + s * l * a, y = K2(o, r, s), g = [
			A / W0,
			M / W0,
			p / W0
		];
	...
	function j3(t) {
		...
		return Q1(n, t, f.Jupiter, H0), Q1(n, t, f.Saturn, F0), Q1(n, t, f.Uranus, $0), Q1(n, t, f.Neptune, J0), n;
	}
	const Nt = 51, X3 = 29200, X0 = 146, _0 = 201, T0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var M1 = class {
		...
		Acceleration(t) {
			...
			return n.incr(d1(t, H0, this.Jupiter.r)), n.incr(d1(t, F0, this.Saturn.r)), n.incr(d1(t, $0, this.Uranus.r)), n.incr(d1(t, J0, this.Neptune.r)), n;
		}
	}, Ut = class Qn {
		constructor(n, e, o, r) {
	...
	function n4(t, n) {
		...
		if (!t[o]) {
			...
			let i, a = s[0].tt;
			for (i = 1; i < _0 - 1; ++i) s[i] = Lt(a += X0, s[i - 1]).grav;
			a = s[_0 - 1].tt;
			var r = [];
			for (r[_0 - 1] = s[_0 - 1], i = _0 - 2; i > 0; --i) r[i] = Lt(a -= X0, r[i + 1]).grav;
			for (i = _0 - 2; i > 0; --i) {
				const c = i / (_0 - 1);
	...
	function J(t, n, e, o) {
		const r = I(o && o.dt_tolerance_seconds || 1), s = Math.abs(r / U1);
	...
	function o1(t, n, e) {
		...
		for (let u = 0; u < 100; ++u) {
			let h = -c / 360 * i;
			if (a = a.AddDays(h), Math.abs(h) * U1 < 1) return a;
			let l = c;
	...
	function Ht(t, n, e, o, r, s, i) {
		...
		const a = r.ut - o.ut;
		if (a * U1 < 1 || Math.min(Math.abs(s), Math.abs(i)) > e * (a / 2)) return null;
	...
	function on(t, n, e, o, r, s, i) {
		...
		function u(p) {
			...
			return e * (K1(p, n, y.ra, y.dec).altitude + b * Math.asin(s / y.dist) - i);
		}
		const h = E(o);
	...
	function tt(t) {
		return t = E(t), v0(V1(t, O.From2000), F1(t, O.From2000));
	}
	function T4(t) {
		const n = E(t);
		return v0(tt(n), wn(n));
	...
	function nt(t) {
		return t = E(t), v0(F1(t, O.Into2000), V1(t, O.Into2000));
	}
	function Jt(t, n) {
		t = E(t);
	...
	function V4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Kt || (Kt = tt(new g0(-45655.74141261017)), gn = new g0(0));
		const e = X1(new Q0(n, 15 * t, 1), gn), o = Ft(E1(Kt, e)), r = 10 / 240, s = r / 15;
		for (let i of b4) {
	...
	function $4(t) {
		const e = J((o) => Bt(et, o), t.AddDays(-.03), t.AddDays(.03));
	...
	function Qt(t, n, e) {
		const o = e / 1440, r = t.AddDays(-o), s = t.AddDays(+o), i = J((c) => -(et(c).r - n), r, t), a = J((c) => +(et(c).r - n), t, s);
	...
	function In(t, n) {
		const e = new D(t.x + n.x, t.y + n.y, t.z + n.z, t.t), o = vn(Math.asin(x2 / e.Length()), Math.asin(D3 / n.Length()), O1(n, e) * _);
	...
	function Hn(t, n) {
		...
		for (;;) {
			...
			if (e1(t, i) < e) {
				const a = K4(t, r, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-o), u = Vn(t, r, c, a.time, -1), h = a.time.AddDays(+o), l = Vn(t, r, a.time, h, 1), d = 60 * e1(t, a.time);
	...
	function oe(t, n, e, o) {
		...
		let a, c;
		return e === f.Earth && o === f.Moon ? (a = new H(0, 0, 0, 0, 0, 0, r), c = h1(r)) : (a = W1(e, r), c = W1(o, r)), Kn(t, a, s, c, i);
	}
	...
	var re = class t0 {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = X(o, n.tt, f.Mercury, pt), e[f.Venus] = X(o, n.tt, f.Venus, Et), e[f.Earth] = X(o, n.tt, f.Earth, c1 + C1), e[f.Mars] = X(o, n.tt, f.Mars, yt), e[f.Jupiter] = X(o, n.tt, f.Jupiter, H0), e[f.Saturn] = X(o, n.tt, f.Saturn, F0), e[f.Uranus] = X(o, n.tt, f.Uranus, $0), e[f.Neptune] = X(o, n.tt, f.Neptune, J0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new N0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = q.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, Et), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + C1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, yt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, H0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, $0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, J0);
		}
	...
	const { MakeTime: ze, SearchRiseSet: Te, Body: Ne, Observer: se } = st(z1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: Oe, CombineRotation: ke, MakeRotation: be } = st(z1);
	Math.PI / (180 * 3600);
	function it(t, n) {
	...
	const { HelioState: He } = st(z1);
	function ae(t, n, e = D1) {
		const o = {};
		for (const r of e) {
