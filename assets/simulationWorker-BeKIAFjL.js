(function() {
	const V = Symbol("Comlink.proxy"), le = Symbol("Comlink.endpoint"), de = Symbol("Comlink.releaseProxy"), K = Symbol("Comlink.finalizer"), M = Symbol("Comlink.thrown"), F = (e) => typeof e == "object" && e !== null || typeof e == "function", z = new Map([["proxy", {
		canHandle: (e) => F(e) && e[V],
		serialize(e) {
	...
	function D(e, n = globalThis, r = ["*"]) {
		n.addEventListener("message", function o(s) {
			...
			let u;
			try {
				const d = c.slice(0, -1).reduce((E, T) => E[T], e), S = c.reduce((E, T) => E[T], e);
				switch (l) {
					case "GET":
						u = S;
						break;
	...
	function C(e, n, r = [], o = function() {}) {
		...
		const i = new Proxy(o, {
			...
			apply(l, c, A) {
				...
				if (u === le) return I(e, n, { type: "ENDPOINT" }).then(R);
	...
	function q(e) {
		const n = e.map(b);
		return [n.map((r) => r[0]), Re(n.map((r) => r[1]))];
	}
	...
	Math.PI / 180;
	180 / Math.PI;
	const L = 86400, Te = 365.25, m = 299792.458, h = m * Te * L, a = 149597870.7, j = 648e3 / Math.PI, Z = j * a / h, fe = 23.4392911, Ne = 1e3, Ue = m, be = m ** Math.sqrt(Math.E), Oe = m ** 2, ge = m ** Math.E, xe = [
		1,
		Ne,
		Ue,
		be
	...
	var O = (e, n, r) => Object.defineProperty(e, n, {
		...
		writable: !0,
		configurable: !0
	}), Ke = Symbol.for("bitecs-relation"), De = Symbol.for("bitecs-pairTarget"), Ce = Symbol.for("bitecs-isPairComponent"), p = Symbol.for("bitecs-relationData"), te = () => {
		let e = {
	...
	we();
	const ze = 384399 / a, We = 421800 / a, $e = 671034 / a, qe = 1070400 / a, Qe = 1882700 / a, Ze = 9376 / a, et = 23463 / a, tt = 185540 / a, nt = 237948 / a, rt = 294619 / a, ot = 377396 / a, st = 527108 / a, at = 1221870 / a, it = 3560820 / a, ct = 129390 / a, ut = 190900 / a, lt = 266e3 / a, dt = 436300 / a, At = 583520 / a, _t = 354759 / a, Et = {
		[t.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	const oe = 1e3 / a, w = oe * h * Z, mt = 695700, Rt = 6378.137;
	function se(e) {
	...
	const pt = 5e4, yt = 2e3, Tt = pt / ae, Mt = yt / ae;
	ie(Tt);
	ie(Mt);
