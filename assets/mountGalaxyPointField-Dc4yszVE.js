import{n as C}from"./state-data-vendor-poX9OG4b.js";import{t as G}from"./deepSkyScenePosition-PvQBd_xt.js";import{A as _,d as m,f as z,mt as R,rt as T}from"./three-vendor-DtGC8FGl.js";import{a as B,kr as P,tn as L}from"./index-DhdJTZpa.js";import{t as N}from"./r3fHostExtras-BV5eJ3qI.js";import{t as E}from"./createMountComponent-6SiL4h9m.js";import{n as g}from"./backdropCache-DtKmT5Q5.js";import{n as S,t as I}from"./deepSkyCatalogBridge-DBMLBJDz.js";import{i as O,t as V}from"./galaxyVolumeActivations-DjDa8t_c.js";var k=13;function D(a){switch(L(a.hubbleType).kind){case"elliptical":case"lenticular":return[1.3,1.05,.7];case"irregular":return[.8,.95,1.3];default:return[1.05,1,1.05]}}function Q(a){return a.type==="galaxy"&&(a.openNgcTypeRaw==null||a.openNgcTypeRaw==="G")&&a.parentGalaxyId==null}function Y(a){if(!Q(a)||!Number.isFinite(a.distPc)||(a.distPc??0)<=0)return null;const l=G(a);if(!Number.isFinite(l.x)||!Number.isFinite(l.y)||!Number.isFinite(l.z)||l.x===0&&l.y===0&&l.z===0)return null;const i=a.vMag!=null&&Number.isFinite(a.vMag)?a.vMag:k;return{pos:[l.x,l.y,l.z],mag:i,color:D(a)}}function U(a){const l=[],i=[],n=[],s=[];for(const e of a){const t=Y(e);t!==null&&(l.push(t.pos[0],t.pos[1],t.pos[2]),i.push(t.mag),n.push(t.color[0],t.color[1],t.color[2]),s.push(e.catalogId))}return{positions:new Float32Array(l),mag:new Float32Array(i),colors:new Float32Array(n),catalogIds:s,count:s.length}}var j=96,X=`
  attribute float mag;
