import{n as W}from"./state-data-vendor-poX9OG4b.js";import{t as H}from"./publicUrl-Dg1xy6-A.js";import{t as J}from"./skyLightStore-BfXJGTVl.js";import{x as Z}from"./playerBoostLadderPort-Dz0KSiwT.js";import{t as B}from"./deepSkyScenePosition-CJpe8tKj.js";import{t as $}from"./dsoSpheremapLOD-hw7O3U3k.js";import{A as tt,d as C,f as et,g as ot,mt as at,rt as it}from"./three-vendor-DtGC8FGl.js";import{Gt as rt,Or as I,a as st}from"./index-wDW9sPMk.js";import{t as lt}from"./r3fHostExtras-DoOV6si3.js";import{t as nt}from"./createMountComponent-D5fmzFWU.js";import{n as N,t as ut}from"./deepSkyCatalogBridge-CRcBG0ed.js";import{n as M,t as ct}from"./nebulaSeed-D0YYy3wG.js";var mt=Math.PI/180/60,ft=rt.far/4;function D(t){return t.openNgcTypeRaw==="GCl"?"globular":"open"}function gt(t){const o=t.majAxArcmin,e=t.minAxArcmin;let r=1;Number.isFinite(o)&&(o??0)>0&&Number.isFinite(e)&&(e??0)>0&&(r=Math.min(1,e/o));const s=t.positionAngleDeg,a=Number.isFinite(s)?s*Math.PI/180:0;return{axisRatio:r,tiltRad:a}}function pt(t){if(t.type!=="star_cluster"||!Number.isFinite(t.distPc)||t.distPc<=0)return null;const o=Number.isFinite(t.majAxArcmin)&&(t.majAxArcmin??0)>0;let e;if(o){const s=t.majAxArcmin/2*mt;e=t.distPc*Math.tan(s)}else e=4;(!Number.isFinite(e)||e<=0)&&(e=4);const r=Math.min(Z(e),ft);return r<=0?null:{radiusSu:r,radiusPc:e,morphScale:[1,1,1],kind:D(t)}}var dt={mainSequence:[.85,.95,1.4],giant:[1.4,1,.55],giantFraction:.08},Mt={mainSequence:[1.35,1.15,.8],giant:[1.5,.85,.5],giantFraction:.25};function ht(t){return t==="globular"?Mt:dt}var U=7,vt=12e4,St=8,xt=24,bt=4e3;function wt(t,o){const e=10**(.4*(6-t)),r=Math.round(e*(o==="globular"?90:40));return Math.max(xt,Math.min(bt,r))}function Ft(t){return 5*(Math.log10(t)-1)}function Ct(t,o){return(M(t,o)+M(t,o+.37)+M(t,o+.71))/1.5-1}function At(t,o){if(o==="globular"){const e=t*t;return Math.min(1,e*(.4+.6*t))}return Math.cbrt(t)*(.85+.15*t)}function F(t,o,e,r,s,a,l,n){t.xs.push(e,r,s),t.mags.push(a),t.cols.push(l[0],l[1],l[2]),t.glow.push(n),t.ids.push(o)}function Pt(t,o,e,r,s,a,l){const{members:n}=r,f=Math.floor(n.length/U),c=Math.min(f,Math.max(0,e-1));let m=0;for(let g=0;g<c;g+=1){const u=g*U,h=n[u],x=n[u+1],v=n[u+2],i=n[u+3],b=n[u+4],S=n[u+5],p=n[u+6],d=B({raDeg:h,decDeg:x,distPc:t.distPc+v});F(o,t.catalogId,d.x,d.y,d.z,i,[b,S,p],0),m+=1}return e-m>=1&&(F(o,t.catalogId,s.x,s.y,s.z,a,l.mainSequence,1),m+=1),m}function _t(t,o,e,r){if(e<=0)return 0;const s=pt(t);if(s===null)return 0;const a=B(t);if(!Number.isFinite(a.x)||!Number.isFinite(a.y)||!Number.isFinite(a.z)||a.x===0&&a.y===0&&a.z===0)return 0;const{distPc:l}=t,n=t.vMag!=null&&Number.isFinite(t.vMag)?t.vMag:St,f=D(t),c=ht(f),m=r?.get($(t.catalogId));if(m!=null&&m.kind==="open")return Pt(t,o,e,m,a,n,c);const{axisRatio:g,tiltRad:u}=gt(t),h=ct(t.catalogId),x=s.radiusSu,v=Ft(l);let i=wt(n,f);if(i=Math.min(i,Math.max(0,e-1)),i<=0)return e>=1?(F(o,t.catalogId,a.x,a.y,a.z,n,c.giant,1),1):0;const b=n-v,S=Math.cos(u),p=Math.sin(u);let d=0;for(let P=0;P<i;P+=1){const w=h+P*.0137,y=M(w,.11)*Math.PI*2,_=M(w,.23)*2-1,T=Math.sqrt(Math.max(0,1-_*_));let R=T*Math.cos(y),G=T*Math.sin(y),z=_;const E=At(M(w,.41),f)*x;R*=E,G*=E,z*=E;const L=G*g,k=R*S-L*p,O=R*p+L*S,q=a.x+k,V=a.y+O,Q=a.z+z,Y=Ct(w,.61)*2.5,K=b+2.5*Math.log10(i)+Y+v,X=M(w,.83)<c.giantFraction?c.giant:c.mainSequence;F(o,t.catalogId,q,V,Q,K,X,0),d+=1}const j=f==="globular"?c.giant:c.mainSequence;return F(o,t.catalogId,a.x,a.y,a.z,n,j,1),d+=1,d}function Rt(t,o){const e={xs:[],mags:[],cols:[],glow:[],ids:[]};let r=0;for(const s of t){if(r>=12e4)break;s.type==="star_cluster"&&(r+=_t(s,e,vt-r,o))}return{positions:new Float32Array(e.xs),mag:new Float32Array(e.mags),color:new Float32Array(e.cols),isGlow:new Float32Array(e.glow),catalogIds:e.ids,count:e.ids.length}}var Et="/assets/data/clusters/cluster-members.json",yt=1e4,A=null;function Tt(t){const o=atob(t),e=new Uint8Array(o.length);for(let r=0;r<o.length;r+=1)e[r]=o.charCodeAt(r);return new Float32Array(e.buffer.slice(0))}function Gt(t){const o=new Map;if(t===null||typeof t!="object")return o;const e=t;if(e.clusters===null||typeof e.clusters!="object"||e.clusters===void 0)return o;for(const[r,s]of Object.entries(e.clusters))if(s!==null&&typeof s=="object"){const{kind:a,members:l}=s;(a==="open"||a==="globular")&&typeof l=="string"&&o.set(r,{kind:a,members:Tt(l)})}return o}function zt(){if(A!==null)return A;const t=new AbortController,o=setTimeout(()=>t.abort(),yt);return A=fetch(H(Et),{signal:t.signal}).then(async e=>e.ok?Gt(await e.json()):new Map).catch(()=>new Map).finally(()=>clearTimeout(o)),A}async function Lt(){return zt()}var It=160,Nt=`
  attribute float mag;
