...
`;function pt(e,t){const a=t!==1?`    uv = (uv - 0.5) * ${t.toFixed(4)} + 0.5;
...
`}function bt(e){return He+Le+e}var St=class{constructor(e,t,a){this.programs=new Map,this.noiseTexture=null,this.gl=e,this.quadVBO=t,this.fallbackTexture=a}setNoiseTexture(e){this.noiseTexture=e}precompile(e){this.programs.has(e.type)||this.buildProgram(e)}render(e,t,a){const o=this.gl,r=this.getOrBuild(e),l=t.resolution||512,n=t.seed,i=t.rotationAngle??0,u=t.timeSpeed??.1,c=t.lightPos??[.39,.7];o.useProgram(r.prog);const d=o.getAttribLocation(r.prog,"a_position");o.enableVertexAttribArray(d),o.bindBuffer(o.ARRAY_BUFFER,this.quadVBO),o.vertexAttribPointer(d,2,o.FLOAT,!1,0,0),this.setUniform1f(r,"u_pixels",l),this.setUniform1f(r,"u_time",a),this.setUniform1f(r,"u_time_speed",u),this.setUniform1f(r,"u_rotation",i),this.setUniform2f(r,"u_light_origin",c[0],c[1]);for(let p=1;p<=6;p++)this.setUniform1f(r,`u_seed${p}`,gt(n,p));const f=e.colorSlots,v=e.palette,h=t.colors||{};for(let p=0;p<16;p++){const R=f[p];let T=[0,0,0,0];R&&(h[R]?T=h[R]:v[R]&&(T=v[R])),this.setUniform4f(r,`u_col${p}`,T[0],T[1],T[2],T[3])}o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,this.noiseTexture||this.fallbackTexture);const g=this.getUniform(r,"u_noise_tex");g!==null&&o.uniform1i(g,0),o.clearColor(0,0,0,0),o.clear(o.COLOR_BUFFER_BIT),o.disable(o.BLEND),o.drawArrays(o.TRIANGLE_STRIP,0,4)}dispose(){const e=this.gl;this.programs.forEach(t=>e.deleteProgram(t.prog)),this.programs.clear()}getOrBuild(e){let t=this.programs.get(e.type);return t||(t=this.buildProgram(e)),t}buildProgram(e){let t;if(e.mode==="composed"&&e.features)t=pt(e.features,e.uvScaling);else if(e.mode==="standalone"&&e.standaloneGlsl)t=bt(e.standaloneGlsl);else throw new Error(`Invalid profile mode for shader rendering: ${e.mode}`);const a={prog:ke(this.gl,ht,t),uniforms:new Map};return this.programs.set(e.type,a),a}getUniform(e,t){return e.uniforms.has(t)||e.uniforms.set(t,this.gl.getUniformLocation(e.prog,t)),e.uniforms.get(t)}setUniform1f(e,t,a){const o=this.getUniform(e,t);o!==null&&this.gl.uniform1f(o,a)}setUniform2f(e,t,a,o){const r=this.getUniform(e,t);r!==null&&this.gl.uniform2f(r,a,o)}setUniform4f(e,t,a,o,r,l){const n=this.getUniform(e,t);n!==null&&this.gl.uniform4f(n,a,o,r,l)}},x=.4,xt=84*Math.PI/180;200/2*x;var K=400/2*x,Z=350/2*x,Q=400/2*x,J=1500/2*x*1.05,yt=800/2*x,wt=1200/2*x,ve=33*x,Tt=83*x,Rt=20*x,Et=1200*x,Gt=-50*x,ge=10,he=3.33,pe=800,be=1.74;function le(){return new Float32Array(16)}function j(){const e=le();return e[0]=e[5]=e[10]=e[15]=1,e}function L(e,t){const a=le();for(let o=0;o<4;o++)for(let r=0;r<4;r++)a[o*4+r]=e[r]*t[o*4]+e[4+r]*t[o*4+1]+e[8+r]*t[o*4+2]+e[12+r]*t[o*4+3];return a}function Oe(e,t){const a=j();return a[0]=e,a[5]=t,a}function Mt(e){const t=j(),a=Math.cos(e),o=Math.sin(e);return t[5]=a,t[9]=-o,t[6]=o,t[10]=a,t}function ze(e){const t=j(),a=Math.cos(e),o=Math.sin(e);return t[0]=a,t[4]=-o,t[1]=o,t[5]=a,t}function Ct(e,t,a){const o=j();return o[12]=e,o[13]=t,o[14]=a,o}function Pt(){const e=le(),t=pe/2,a=pe/2;return e[0]=be/t,e[5]=-be/a,e[10]=-.001,e[11]=-1/Et,e[15]=1,e}function ee(e,t,a=0){const o=Oe(e,t);return a?L(ze(a),o):o}function M(e,t=0){let a=Oe(e,e);return t&&(a=L(ze(t),a)),a=L(Ct(0,Gt,0),a),L(Mt(xt),a)}var At=`
attribute vec2 aPos;
uniform mat4 uMVP;
uniform mat4 uModel;
varying vec2 vUV;
...
`;function m(e,t){return`rgba(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)},${t})`}function It(e){return`rgb(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)})`}function Se(e){return`rgba(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)},`}function kt(e){const t=e.glow1,a=e.glow2,o=e.glow3,r=e.glow4,l=e.purple,n=e.rim,i=e.inset;return{glow:[{offset:0,color:m(t,.65)},{offset:.08,color:m(t,.55)},{offset:.2,color:m(a,.6)},{offset:.34,color:m(a,.6)},{offset:.49,color:m(o,.55)},{offset:.63,color:m(o,.55)},{offset:.73,color:m(r,.45)},{offset:.83,color:m(r,.18)},{offset:.97,color:m(r,.05)},{offset:1,color:m(r,0)}],hGlow:[{offset:0,color:m(t,0)},{offset:.53,color:m(t,0)},{offset:.54,color:"rgba(255,255,255,0.7)"},{offset:.55,color:m(t,.85)},{offset:.59,color:m(a,.75)},{offset:.63,color:m(a,.85)},{offset:.73,color:m(o,.6)},{offset:.83,color:m(r,.4)},{offset:.97,color:m(r,.1)},{offset:1,color:m(r,0)}],backglow:[{offset:0,color:m(l,0)},{offset:.14,color:m(l,0)},{offset:.4,color:m(l,.1)},{offset:.7,color:"rgba(0,0,0,0)"},{offset:1,color:"rgba(0,0,0,0)"}],holeBloom:m(l,.6),holeHalo:m(l,.6),holeOuterRim:It(n),holeInsetA:Se(n),holeInsetB:Se(i)}}function q(e,t){const a=document.createElement("canvas");return a.width=Math.ceil(e),a.height=Math.ceil(t),[a,a.getContext("2d")]}function Ht(e){const t=ve*3,a=(K+t)*2,o=(Z+t)*2,[r,l]=q(a,o),n=a/2,i=o/2;l.filter=`blur(${ve}px)`;const u=Math.sqrt(K**2+Z**2),c=l.createRadialGradient(n,i,0,n,i,u);for(const d of e.glow)c.addColorStop(d.offset,d.color);return l.fillStyle=c,l.beginPath(),l.ellipse(n,i,K,Z,0,0,Math.PI*2),l.fill(),r}function $e(e,t,a){const o=(e+t*3)*2,[r,l]=q(o,o),n=o/2;l.filter=`blur(${t}px)`;const i=e*Math.SQRT2,u=l.createRadialGradient(n,n,0,n,n,i);for(const c of a)u.addColorStop(c.offset,c.color);return l.fillStyle=u,l.beginPath(),l.arc(n,n,e,0,Math.PI*2),l.fill(),r}function Lt(e){return $e(yt,Tt,e.hGlow)}function Ot(e){return $e(wt,Rt,e.backglow)}function zt(e){const[r,l]=q(600,600),n=600/2,i=600/2;l.save(),l.filter="blur(100px)",l.fillStyle=e.holeBloom,l.beginPath(),l.arc(n,i,110,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(50px)",l.fillStyle="white",l.beginPath(),l.arc(n,i,105,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(2px)",l.fillStyle="rgb(0,0,0)",l.beginPath(),l.arc(n,i,108,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(6px)",l.fillStyle=e.holeHalo,l.beginPath(),l.arc(n,i,102,0,Math.PI*2),l.fill(),l.restore(),l.save(),l.filter="blur(2px)",l.fillStyle=e.holeOuterRim,l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill(),l.restore(),l.fillStyle="black",l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill();const u=l.createRadialGradient(n,i,98,n,i,100);u.addColorStop(0,"transparent"),u.addColorStop(.5,e.holeInsetA+"0.15)"),u.addColorStop(1,e.holeInsetA+"0.5)"),l.fillStyle=u,l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill();const c=l.createRadialGradient(n,i,97,n,i,100);return c.addColorStop(0,"transparent"),c.addColorStop(.5,e.holeInsetB+"0.1)"),c.addColorStop(1,e.holeInsetB+"0.35)"),l.fillStyle=c,l.beginPath(),l.arc(n,i,100,0,Math.PI*2),l.fill(),r}function xe(e,t,a){const o=Math.ceil(t*2),[r,l]=q(o,o),n=o/2;l.save(),l.beginPath(),l.arc(n,n,t,0,Math.PI*2),l.clip(),l.drawImage(e,0,0,o,o),l.restore(),l.globalCompositeOperation="destination-in";const i=l.createRadialGradient(n,n,0,n,n,t);for(const u of a)i.addColorStop(u.offset,`rgba(0,0,0,${u.alpha})`);return l.fillStyle=i,l.fillRect(0,0,o,o),l.globalCompositeOperation="source-over",r}var $t=class{constructor(e,t){this.state=null,this.noiseImage=null,this.gl=e,this.quadVBO=t}setNoiseImage(e){this.noiseImage=e,this.state&&!this.state.texHEH&&this.dispose()}init(e){const t=this.gl;this.dispose();const a=kt(e),o=ke(t,At,Bt);t.useProgram(o);const r=t.getUniformLocation(o,"uMVP"),l=t.getUniformLocation(o,"uModel"),n=t.getUniformLocation(o,"uTex"),i=t.getUniformLocation(o,"uAlpha"),u=t.getUniformLocation(o,"uClipZ"),c=t.getAttribLocation(o,"aPos");t.uniform1i(n,0);const d=Pt(),f=Ht(a),v=Lt(a),h=Ot(a),g=zt(a),p=P(t,f),R=P(t,v),T=P(t,h),z=P(t,g);let B=null,I=null;this.noiseImage&&(B=P(t,xe(this.noiseImage,Q,[{offset:0,alpha:1},{offset:.283,alpha:1},{offset:.99,alpha:0},{offset:1,alpha:0}])),I=P(t,xe(this.noiseImage,J,[{offset:0,alpha:1},{offset:.283,alpha:.7},{offset:.99,alpha:0},{offset:1,alpha:0}]))),this.state={prog:o,locMvp:r,locModel:l,locTex:n,locAlpha:i,locClipZ:u,aPosLoc:c,proj:d,texGlow:p,glowHW:f.width/2,glowHH:f.height/2,texHGlow:R,hglowHS:v.width/2,texBglow:T,bglowHS:h.width/2,texHole:z,holeHS:g.width/2*x,texEH:B,texHEH:I}}render(e,t,a){const o=this.gl;(!this.state||this.state.texHEH===null&&this.noiseImage!==null)&&this.init(e);const r=this.state;o.useProgram(r.prog),o.bindBuffer(o.ARRAY_BUFFER,this.quadVBO),o.enableVertexAttribArray(r.aPosLoc),o.vertexAttribPointer(r.aPosLoc,2,o.FLOAT,!1,0,0),o.clearColor(0,0,0,0),o.clear(o.COLOR_BUFFER_BIT),o.enable(o.BLEND),o.disable(o.DEPTH_TEST);const l=t*a,n=l%ge/ge*Math.PI*2,i=l%he/he*Math.PI*2,u=()=>o.blendFunc(o.ONE,o.ONE_MINUS_SRC_ALPHA),c=()=>o.blendFunc(o.ONE,o.ONE_MINUS_SRC_COLOR);u(),this.drawQuad(r,r.texGlow,ee(r.glowHW,r.glowHH),1,0),r.texHEH&&(c(),this.drawQuad(r,r.texHEH,M(J,n),.35,-1)),u(),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,-1),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,-1),r.texEH&&(c(),this.drawQuad(r,r.texEH,ee(Q,Q,i),.7,0)),u(),this.drawQuad(r,r.texBglow,M(r.bglowHS),1,0),this.drawQuad(r,r.texHole,ee(r.holeHS,r.holeHS),1,0),u(),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,1),this.drawQuad(r,r.texHGlow,M(r.hglowHS),1,1),r.texHEH&&(c(),this.drawQuad(r,r.texHEH,M(J,n),.35,1)),o.disable(o.BLEND)}dispose(){if(!this.state)return;const e=this.gl,t=this.state;e.deleteProgram(t.prog),e.deleteTexture(t.texGlow),e.deleteTexture(t.texHGlow),e.deleteTexture(t.texBglow),e.deleteTexture(t.texHole),t.texEH&&e.deleteTexture(t.texEH),t.texHEH&&e.deleteTexture(t.texHEH),this.state=null}drawQuad(e,t,a,o,r){const l=this.gl,n=L(e.proj,a);l.uniformMatrix4fv(e.locMvp,!1,n),l.uniformMatrix4fv(e.locModel,!1,a),l.uniform1f(e.locAlpha,o),l.uniform1f(e.locClipZ,r),l.activeTexture(l.TEXTURE0),l.bindTexture(l.TEXTURE_2D,t),l.drawArrays(l.TRIANGLE_STRIP,0,4)}},Nt=class{constructor(e){this.hasSpare=!1,this.spare=0,this.s=e}next(){return this.s=(this.s*16807+0)%2147483647,(this.s-1)/2147483646}random(e,t){return t!==void 0?e+this.next()*(t-e):e!==void 0?this.next()*e:this.next()}randomGaussian(e=0,t=1){if(this.hasSpare)return this.hasSpare=!1,e+t*this.spare;let a,o,r;do a=this.next()*2-1,o=this.next()*2-1,r=a*a+o*o;while(r>=1||r===0);return r=Math.sqrt(-2*Math.log(r)/r),this.spare=o*r,this.hasSpare=!0,e+t*a*r}},Ut=Math.PI*2,Ft=900;function ye(e){if(typeof document>"u")return new OffscreenCanvas(e,e);const t=document.createElement("canvas");return t.width=e,t.height=e,t}function Dt(e,t=512,a){const o=new Nt(e),r=Ft,l=ye(r),n=l.getContext("2d");function i(b,E,k,G){const H=Math.max(0,Math.min(255,G));n.fillStyle=`rgba(${b|0},${E|0},${k|0},${H/255})`}function u(b,E,k){const G=Math.abs(k)/2;G<.1||(n.beginPath(),n.arc(b,E,G,0,Ut),n.fill())}function c(b,E,k,G,H){H=H+r/2e3;const We=8300+Math.floor(r/3),Ve=r/1500,Y=20;for(let ce=0;ce<We;ce++)i(b+o.random(Y),k+o.random(Y),E+o.random(Y),Math.abs(o.randomGaussian())/4),u(-r/2+r/2*o.randomGaussian(),r*o.randomGaussian()/G,o.randomGaussian(r/100,r/G+r/40)),i(255,255,255,H*o.randomGaussian()/2),u(-r/2+r/2*o.randomGaussian(),r*o.randomGaussian()/G,Ve*o.randomGaussian())}function d(){const b=r*4;for(let E=0;E<b;E++)i(255,255,255,Math.abs(255*o.randomGaussian())),u(-r/2+r/2*o.randomGaussian(),r*o.randomGaussian()*o.randomGaussian()*o.randomGaussian()*o.randomGaussian(),.5*o.randomGaussian())}function f(){n.save(),n.translate(o.random(-r/2,r/2),o.random(-r/10,r/10)),c(o.random(100,255),o.random(100,255),o.random(100,255),29,100),n.scale(.05,.05),c(o.random(100,255),o.random(100,255),o.random(100,255),10,2),c(255,255,255,2,2),d(),n.restore()}n.save(),n.translate(r/2,r/2);const v=o.random(.3,1);n.scale(v,v),n.rotate(o.random(-Math.PI,Math.PI));const h=a?.dominant??[o.random(10,255),o.random(10,255),o.random(10,255)];c(h[0],h[1],h[2],3,6),d();const g=a?.accents??[[200,200,200],[0,200,250],[250,100,250]];c(g[0][0],g[0][1],g[0][2],7,205),g.length>1&&c(g[1][0],g[1][1],g[1][2],22,205),g.length>2&&c(g[2][0],g[2][1],g[2][2],25,205);const p=Math.floor(o.random(0,3.1));for(let b=0;b<p;b++)f();const R=Math.max(10,r/12),T=Math.floor(o.random(5,R));for(let b=0;b<T;b++)n.save(),n.translate(r/3*o.randomGaussian(),r/3*o.randomGaussian()),n.scale(o.random(.5,1),o.random(.5,1)),n.rotate(o.random(-Math.PI/4,Math.PI/4)),c(o.random(100,255),o.random(100,255),o.random(100,255),15,100),n.restore();n.restore();const z=r/2,B=r/2,I=r,$=n.createRadialGradient(z,B,I*.25,z,B,I*.52);if($.addColorStop(0,"rgba(0,0,0,0)"),$.addColorStop(.6,"rgba(0,0,0,0)"),$.addColorStop(1,"rgba(0,0,0,1)"),n.globalCompositeOperation="destination-out",n.fillStyle=$,n.fillRect(0,0,r,r),n.globalCompositeOperation="source-over",t===r)return l;const ne=ye(t);return ne.getContext("2d").drawImage(l,0,0,t,t),ne}var O={id:"base_planet",seedSlots:[1],colorSlotRange:[0,3],glsl:e=>{const t=e.uvSource===1?"sphered":"rotated",a=e.octaves||6,o=`u_seed${e.seedSlot||1}`,r=`u_col${e.colorStart||0}`,l=`u_col${(e.colorStart||0)+1}`,n=`u_col${(e.colorStart||0)+2}`;return`
    // === BASE PLANET ===
    {
    ...
    }`}},Ne={id:"land_mass",seedSlots:[2],colorSlotRange:[3,7],glsl:e=>{const t=(e.landCutoff??.5).toFixed(4),a=`u_seed${e.seedSlot||2}`,o=`u_col${e.colorStart||3}`,r=`u_col${(e.colorStart||3)+1}`,l=`u_col${(e.colorStart||3)+2}`,n=`u_col${(e.colorStart||3)+3}`;return`
    // === LAND MASS ===
    {
    ...
    }`}},Ue={id:"atmosphere",seedSlots:[],colorSlotRange:[11,14],glsl:e=>`
    // === ATMOSPHERE ===
    {
    ...
    }`},Wt={type:s.TerrainWet,mode:"composed",uvScaling:1.05,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Ne,params:{landCutoff:.5,seedSlot:2,colorStart:3,noiseScale:10}},{feature:se,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:7}},{feature:Ue,params:{colorStart:11}}],palette:y[s.TerrainWet],colorSlots:w[s.TerrainWet],loopLCM:S[s.TerrainWet],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,landCutoff:.5}},Vt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
...
`,jt={type:s.TerrainDry,mode:"standalone",uvScaling:1,standaloneGlsl:Vt,palette:y[s.TerrainDry],colorSlots:w[s.TerrainDry],loopLCM:S[s.TerrainDry],defaults:{}},qt={type:s.Aquatic,mode:"composed",uvScaling:1.05,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Ne,params:{landCutoff:.65,seedSlot:2,colorStart:3,noiseScale:10}},{feature:se,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:7}},{feature:Ue,params:{colorStart:11}}],palette:y[s.Aquatic],colorSlots:w[s.Aquatic],loopLCM:S[s.Aquatic],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,landCutoff:.65}},Fe={id:"craters",seedSlots:[2],colorSlotRange:[3,5],glsl:e=>{const t=(e.craterScale||5).toFixed(1),a=`u_seed${e.seedSlot||2}`,o=`u_col${e.colorStart||3}`,r=`u_col${(e.colorStart||3)+1}`;return`
    // === CRATER LAYER ===
    {
        float crater_sz = ${t};
        float c1_val = 1.0;
    ...
    }`}},Yt={type:s.Barren,mode:"composed",uvScaling:1,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Fe,params:{craterScale:5,seedSlot:2,colorStart:3}}],palette:y[s.Barren],colorSlots:w[s.Barren],loopLCM:S[s.Barren],defaults:{fbmOctaves:6,noiseScale:10,craterScale:5}},Xt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
...
`,Kt={type:s.GasGiant,mode:"standalone",uvScaling:1,standaloneGlsl:Xt,palette:y[s.GasGiant],colorSlots:w[s.GasGiant],loopLCM:S[s.GasGiant],defaults:{}},Zt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,Qt={type:s.GasGiantRinged,mode:"standalone",uvScaling:1,standaloneGlsl:Zt,palette:y[s.GasGiantRinged],colorSlots:w[s.GasGiantRinged],loopLCM:S[s.GasGiantRinged],defaults:{}},De={id:"flow_layer",seedSlots:[2,3],colorSlotRange:[3,6],glsl:e=>{const t=e.flowOctaves||5,a=(e.flowCutoff??.6).toFixed(4),o=(e.flowScale||10).toFixed(1),r=`u_seed${e.seedSlot||3}`,l=`u_col${e.colorStart||5}`,n=`u_col${(e.colorStart||5)+1}`,i=`u_col${(e.colorStart||5)+2}`;return e.useScroll,`
    // === FLOW LAYER ===
    {
        float flow_sz = ${o};
        float flow_cutoff = ${a};
    ...
    }`}},Jt={type:s.Molten,mode:"composed",uvScaling:1,features:[{feature:O,params:{uvSource:1,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Fe,params:{craterScale:5,seedSlot:2,colorStart:3}},{feature:De,params:{flowOctaves:5,flowCutoff:.6,flowScale:10,seedSlot:3,colorStart:5}}],palette:y[s.Molten],colorSlots:w[s.Molten],loopLCM:S[s.Molten],defaults:{fbmOctaves:6,noiseScale:10,craterScale:5,flowCutoff:.6,flowOctaves:5,flowScale:10}},eo={type:s.Ice,mode:"composed",uvScaling:1,features:[{feature:O,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:De,params:{flowOctaves:4,flowCutoff:.6,flowScale:10,seedSlot:2,colorStart:3}},{feature:se,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:6}}],palette:y[s.Ice],colorSlots:w[s.Ice],loopLCM:S[s.Ice],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,flowCutoff:.6,flowOctaves:4,flowScale:10}},to=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,oo={type:s.Star,mode:"standalone",uvScaling:1,standaloneGlsl:to,palette:y[s.Star],colorSlots:w[s.Star],loopLCM:S[s.Star],defaults:{}},ao=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,ro={type:s.Galaxy,mode:"standalone",uvScaling:1,standaloneGlsl:ao,palette:y[s.Galaxy],colorSlots:w[s.Galaxy],loopLCM:S[s.Galaxy],defaults:{}},lo={type:s.BlackHole,mode:"multipass",uvScaling:1,palette:y[s.BlackHole],colorSlots:w[s.BlackHole],loopLCM:S[s.BlackHole],defaults:{}},so={type:s.Nebula,mode:"canvas2d",uvScaling:1,palette:{},colorSlots:[],loopLCM:S[s.Nebula],defaults:{}},te={[s.TerrainWet]:Wt,[s.TerrainDry]:jt,[s.Aquatic]:qt,[s.Barren]:Yt,[s.GasGiant]:Kt,[s.GasGiantRinged]:Qt,[s.Molten]:Jt,[s.Ice]:eo,[s.Star]:oo,[s.Galaxy]:ro,[s.BlackHole]:lo,[s.Nebula]:so},Ho=class{constructor(e){this.noiseTexture=null,this.noiseImage=null,this.canvas=e||document.createElement("canvas");const t=this.canvas.getContext("webgl",{premultipliedAlpha:!1,alpha:!0,antialias:!1,preserveDrawingBuffer:!0});if(!t)throw new Error("WebGL not supported");this.gl=t;const a=t.createBuffer();if(!a)throw new Error("Failed to create buffer");this.quadVBO=a,t.bindBuffer(t.ARRAY_BUFFER,a),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),t.STATIC_DRAW),this.fallbackTexture=_t(t),this.noiseTexture=me(t,mt(128)),this.shaderRenderer=new St(t,this.quadVBO,this.fallbackTexture),this.shaderRenderer.setNoiseTexture(this.noiseTexture),this.bhRenderer=new $t(t,this.quadVBO)}async precompile(e){const t=e||Object.values(s).filter(a=>a!==s.BlackHole&&a!==s.Nebula);for(const a of t){const o=te[a];!o||o.mode==="multipass"||o.mode==="canvas2d"||(this.shaderRenderer.precompile(o),await new Promise(r=>setTimeout(r,0)))}}async loadNoiseTexture(e){const t=await vt(e);this.noiseImage=t,this.setNoiseTexture(t),this.bhRenderer.setNoiseImage(t)}setNoiseTexture(e){const t=this.gl;this.noiseTexture&&t.deleteTexture(this.noiseTexture),this.noiseTexture=me(t,e),this.shaderRenderer.setNoiseTexture(this.noiseTexture)}render(e,t){const a=this.gl,o=e.resolution||512,r=e.type;if(r===s.Nebula)return Dt(e.seed,o,e.colors);if((this.canvas.width!==o||this.canvas.height!==o)&&(this.canvas.width=o,this.canvas.height=o),a.viewport(0,0,o,o),r===s.BlackHole){const n=te[s.BlackHole],i=n.palette,u=e.colors||{},c={};for(const f of n.colorSlots)c[f]=u[f]||i[f];const d=e.timeSpeed??.1;return this.bhRenderer.render(c,t,d),this.canvas}const l=te[r];if(!l)throw new Error(`Unknown celestial type: ${r}`);return this.shaderRenderer.render(l,e,t),this.canvas}renderToImageData(e,t){this.render(e,t);const a=this.gl,o=this.canvas.width,r=this.canvas.height,l=new Uint8Array(o*r*4);a.readPixels(0,0,o,r,a.RGBA,a.UNSIGNED_BYTE,l);const n=o*4,i=new Uint8Array(n);for(let u=0;u<Math.floor(r/2);u++){const c=u*n,d=(r-1-u)*n;i.set(l.subarray(c,c+n)),l.copyWithin(c,d,d+n),l.set(i,d)}return new ImageData(new Uint8ClampedArray(l.buffer),o,r)}getCanvas(){return this.canvas}getLoopDuration(e,t){const a=t??.1,o=S[e];return o?o/a:0}static getCelestialTypes(){return Object.values(s)}static getColorSlots(e){return[...w[e]||[]]}static getDefaultPalette(e){return{...y[e]||{}}}dispose(){const e=this.gl;this.shaderRenderer.dispose(),this.bhRenderer.dispose(),e.deleteBuffer(this.quadVBO),e.deleteTexture(this.fallbackTexture),this.noiseTexture&&e.deleteTexture(this.noiseTexture)}};function Lo(e){const t=e.replace(/^#/,""),a=parseInt(t,16);return[a>>16&255,a>>8&255,a&255]}function no(e){if(!e||typeof e!="string")return[1,1,1];const t=e.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return t?[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]:[1,1,1]}function Oo(e){return Math.max(0,Math.min(255,Math.round(e)))}function _(e,t=1,a=1){const[o,r,l]=no(e),n=Math.max(.15,Math.min(1,t));return[o*n,r*n,l*n,a]}var co={kind:"barren",eluvadeType:s.Barren,defaultTextureResolution:192,defaultColors(e){const t=_(e,1),a=_(e,.82),o=_(e,.64);return{base1:t,base2:a,base3:o,crater1:a,crater2:o}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},io={kind:"blackHole",eluvadeType:s.BlackHole,defaultTextureResolution:256,defaultColors(){return{}},textureBlit:{backdropFill:"transparent",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"billboard"}},uo={kind:"desert",eluvadeType:s.TerrainDry,defaultTextureResolution:192,defaultColors(e){return{col1:_(e,1),col2:_(e,.82),col3:_(e,.64),col4:_(e,.48)}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},fo={kind:"galaxy",eluvadeType:s.Galaxy,defaultTextureResolution:256,defaultColors(){return{}},textureBlit:{backdropFill:"transparent",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"billboard"}},_o={kind:"gasGiant",eluvadeType:s.GasGiant,defaultTextureResolution:256,defaultColors(e){return{gas_base1:_(e,1),gas_base2:_(e,.82),gas_base3:_(e,.64),gas_base4:_(e,.48),gas_dark1:_(e,.35),gas_dark2:_(e,.28)}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,rings:!1,sceneGraph:"sphere"}},mo={kind:"iceGiant",eluvadeType:s.Ice,defaultTextureResolution:224,defaultColors(e){const t=_(e,1),a=_(e,.82),o=_(e,.64);return{base1:[Math.min(1,t[0]+.15),Math.min(1,t[1]+.2),1,1],base2:a,base3:o,lake1:t,lake2:a,cloud1:[.9,.95,1,1]}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},vo={kind:"molten",eluvadeType:s.Molten,defaultTextureResolution:224,defaultColors(e){const t=_(e,1),a=_(e,.82),o=_(e,.64);return{base1:a,base2:o,river1:t,river2:a,river3:o}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},go={kind:"nebula",eluvadeType:s.Nebula,defaultTextureResolution:256,defaultColors(){return{}},textureBlit:{backdropFill:"transparent",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!1,sceneGraph:"billboard"}},ho={kind:"oceanic",eluvadeType:s.TerrainWet,defaultTextureResolution:224,defaultColors(e){const t=_(e,1),a=_(e,.82);return{base1:a,base2:_(e,.64),land1:t,land2:a,cloud1:[.9,.95,1,1],atmo2:[t[0]*.3,t[1]*.5,Math.min(1,t[2]+.2),.35]}},textureBlit:{backdropFill:"baseColor",starBodyZoomOnSphere:!1},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},po={kind:"star",eluvadeType:s.Star,defaultTextureResolution:512,defaultColors(e){const t=_(e,1),a=_(e,.82);return{star1:t,star2:a,star3:_(e,.64),blob:a,glow:[t[0],t[1],t[2],1]}},textureBlit:{backdropFill:"starDim",starBodyZoomOnSphere:!0},sphereMaterialCosmos:"unlit",features:{animated:!0,sceneGraph:"sphere"}},bo={star:po,barren:co,molten:vo,oceanic:ho,desert:uo,gasGiant:_o,iceGiant:mo,galaxy:fo,nebula:go,blackHole:io},So=new Set,xo={galaxy:"galaxy",nebula:"nebula",planetary_nebula:"nebula",star_cluster:"nebula"},we=new Set;function yo(e){const t=xo[e];return t??(we.has(e)||(we.add(e),console.warn(`[dsoBodyRegistry] unknown DeepSkyBodyType "${String(e)}"; defaulting to nebula`)),"nebula")}function wo(e){return So.has(e.catalogId)?"blackHole":yo(e.type)}function zo(e){return bo[wo(e)].eluvadeType}function $o(e){return e===s.BlackHole?"black_hole":e}function No(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/6e4),o=Math.floor(t%6e4/1e3),r=n=>n<10?`0${n}`:String(n),l=t%1e3;return`${a}:${r(o)}.${String(l).padStart(3,"0")}`}export{Co as C,Pe as S,fe as _,bo as a,st as b,Lo as c,s as d,Ao as f,Po as g,ko as h,wo as i,no as l,Bo as m,zo as n,_ as o,Io as p,$o as r,Oo as s,No as t,Ho as u,ut as v,Ee as x,it as y};
