...
`;function it(e,t){const o=t!==1?`    uv = (uv - 0.5) * ${t.toFixed(4)} + 0.5;
...
`}function ut(e){return ke+Be+e}var ft=class{constructor(e,t,o){this.programs=new Map,this.noiseTexture=null,this.gl=e,this.quadVBO=t,this.fallbackTexture=o}setNoiseTexture(e){this.noiseTexture=e}precompile(e){this.programs.has(e.type)||this.buildProgram(e)}render(e,t,o){const a=this.gl,r=this.getOrBuild(e),s=t.resolution||512,l=t.seed,i=t.rotationAngle??0,u=t.timeSpeed??.1,c=t.lightPos??[.39,.7];a.useProgram(r.prog);const f=a.getAttribLocation(r.prog,"a_position");a.enableVertexAttribArray(f),a.bindBuffer(a.ARRAY_BUFFER,this.quadVBO),a.vertexAttribPointer(f,2,a.FLOAT,!1,0,0),this.setUniform1f(r,"u_pixels",s),this.setUniform1f(r,"u_time",o),this.setUniform1f(r,"u_time_speed",u),this.setUniform1f(r,"u_rotation",i),this.setUniform2f(r,"u_light_origin",c[0],c[1]);for(let S=1;S<=6;S++)this.setUniform1f(r,`u_seed${S}`,nt(l,S));const _=e.colorSlots,d=e.palette,b=t.colors||{};for(let S=0;S<16;S++){const R=_[S];let y=[0,0,0,0];R&&(b[R]?y=b[R]:d[R]&&(y=d[R])),this.setUniform4f(r,`u_col${S}`,y[0],y[1],y[2],y[3])}a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,this.noiseTexture||this.fallbackTexture);const v=this.getUniform(r,"u_noise_tex");v!==null&&a.uniform1i(v,0),a.clearColor(0,0,0,0),a.clear(a.COLOR_BUFFER_BIT),a.disable(a.BLEND),a.drawArrays(a.TRIANGLE_STRIP,0,4)}dispose(){const e=this.gl;this.programs.forEach(t=>e.deleteProgram(t.prog)),this.programs.clear()}getOrBuild(e){let t=this.programs.get(e.type);return t||(t=this.buildProgram(e)),t}buildProgram(e){let t;if(e.mode==="composed"&&e.features)t=it(e.features,e.uvScaling);else if(e.mode==="standalone"&&e.standaloneGlsl)t=ut(e.standaloneGlsl);else throw new Error(`Invalid profile mode for shader rendering: ${e.mode}`);const o={prog:Oe(this.gl,ct,t),uniforms:new Map};return this.programs.set(e.type,o),o}getUniform(e,t){return e.uniforms.has(t)||e.uniforms.set(t,this.gl.getUniformLocation(e.prog,t)),e.uniforms.get(t)}setUniform1f(e,t,o){const a=this.getUniform(e,t);a!==null&&this.gl.uniform1f(a,o)}setUniform2f(e,t,o,a){const r=this.getUniform(e,t);r!==null&&this.gl.uniform2f(r,o,a)}setUniform4f(e,t,o,a,r,s){const l=this.getUniform(e,t);l!==null&&this.gl.uniform4f(l,o,a,r,s)}},E=.4,dt=84*Math.PI/180;200/2*E;var Z=400/2*E,J=350/2*E,ee=400/2*E,te=1500/2*E*1.05,_t=800/2*E,mt=1200/2*E,pe=33*E,gt=83*E,ht=20*E,vt=1200*E,pt=-50*E,be=10,Se=3.33,ye=800,we=1.74;function ce(){return new Float32Array(16)}function X(){const e=ce();return e[0]=e[5]=e[10]=e[15]=1,e}function D(e,t){const o=ce();for(let a=0;a<4;a++)for(let r=0;r<4;r++)o[a*4+r]=e[r]*t[a*4]+e[4+r]*t[a*4+1]+e[8+r]*t[a*4+2]+e[12+r]*t[a*4+3];return o}function He(e,t){const o=X();return o[0]=e,o[5]=t,o}function bt(e){const t=X(),o=Math.cos(e),a=Math.sin(e);return t[5]=o,t[9]=-a,t[6]=a,t[10]=o,t}function ze(e){const t=X(),o=Math.cos(e),a=Math.sin(e);return t[0]=o,t[4]=-a,t[1]=a,t[5]=o,t}function St(e,t,o){const a=X();return a[12]=e,a[13]=t,a[14]=o,a}function yt(){const e=ce(),t=ye/2,o=ye/2;return e[0]=we/t,e[5]=-we/o,e[10]=-.001,e[11]=-1/vt,e[15]=1,e}function oe(e,t,o=0){const a=He(e,t);return o?D(ze(o),a):a}function O(e,t=0){let o=He(e,e);return t&&(o=D(ze(t),o)),o=D(St(0,pt,0),o),D(bt(dt),o)}var wt=`
attribute vec2 aPos;
uniform mat4 uMVP;
uniform mat4 uModel;
varying vec2 vUV;
...
`;function g(e,t){return`rgba(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)},${t})`}function Et(e){return`rgb(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)})`}function xe(e){return`rgba(${Math.round(e[0]*255)},${Math.round(e[1]*255)},${Math.round(e[2]*255)},`}function Rt(e){const t=e.glow1,o=e.glow2,a=e.glow3,r=e.glow4,s=e.purple,l=e.rim,i=e.inset;return{glow:[{offset:0,color:g(t,.65)},{offset:.08,color:g(t,.55)},{offset:.2,color:g(o,.6)},{offset:.34,color:g(o,.6)},{offset:.49,color:g(a,.55)},{offset:.63,color:g(a,.55)},{offset:.73,color:g(r,.45)},{offset:.83,color:g(r,.18)},{offset:.97,color:g(r,.05)},{offset:1,color:g(r,0)}],hGlow:[{offset:0,color:g(t,0)},{offset:.53,color:g(t,0)},{offset:.54,color:"rgba(255,255,255,0.7)"},{offset:.55,color:g(t,.85)},{offset:.59,color:g(o,.75)},{offset:.63,color:g(o,.85)},{offset:.73,color:g(a,.6)},{offset:.83,color:g(r,.4)},{offset:.97,color:g(r,.1)},{offset:1,color:g(r,0)}],backglow:[{offset:0,color:g(s,0)},{offset:.14,color:g(s,0)},{offset:.4,color:g(s,.1)},{offset:.7,color:"rgba(0,0,0,0)"},{offset:1,color:"rgba(0,0,0,0)"}],holeBloom:g(s,.6),holeHalo:g(s,.6),holeOuterRim:Et(l),holeInsetA:xe(l),holeInsetB:xe(i)}}function K(e,t){const o=document.createElement("canvas");return o.width=Math.ceil(e),o.height=Math.ceil(t),[o,o.getContext("2d")]}function Tt(e){const t=pe*3,o=(Z+t)*2,a=(J+t)*2,[r,s]=K(o,a),l=o/2,i=a/2;s.filter=`blur(${pe}px)`;const u=Math.sqrt(Z**2+J**2),c=s.createRadialGradient(l,i,0,l,i,u);for(const f of e.glow)c.addColorStop(f.offset,f.color);return s.fillStyle=c,s.beginPath(),s.ellipse(l,i,Z,J,0,0,Math.PI*2),s.fill(),r}function Ne(e,t,o){const a=(e+t*3)*2,[r,s]=K(a,a),l=a/2;s.filter=`blur(${t}px)`;const i=e*Math.SQRT2,u=s.createRadialGradient(l,l,0,l,l,i);for(const c of o)u.addColorStop(c.offset,c.color);return s.fillStyle=u,s.beginPath(),s.arc(l,l,e,0,Math.PI*2),s.fill(),r}function At(e){return Ne(_t,gt,e.hGlow)}function Ct(e){return Ne(mt,ht,e.backglow)}function Mt(e){const[r,s]=K(600,600),l=600/2,i=600/2;s.save(),s.filter="blur(100px)",s.fillStyle=e.holeBloom,s.beginPath(),s.arc(l,i,110,0,Math.PI*2),s.fill(),s.restore(),s.save(),s.filter="blur(50px)",s.fillStyle="white",s.beginPath(),s.arc(l,i,105,0,Math.PI*2),s.fill(),s.restore(),s.save(),s.filter="blur(2px)",s.fillStyle="rgb(0,0,0)",s.beginPath(),s.arc(l,i,108,0,Math.PI*2),s.fill(),s.restore(),s.save(),s.filter="blur(6px)",s.fillStyle=e.holeHalo,s.beginPath(),s.arc(l,i,102,0,Math.PI*2),s.fill(),s.restore(),s.save(),s.filter="blur(2px)",s.fillStyle=e.holeOuterRim,s.beginPath(),s.arc(l,i,100,0,Math.PI*2),s.fill(),s.restore(),s.fillStyle="black",s.beginPath(),s.arc(l,i,100,0,Math.PI*2),s.fill();const u=s.createRadialGradient(l,i,98,l,i,100);u.addColorStop(0,"transparent"),u.addColorStop(.5,e.holeInsetA+"0.15)"),u.addColorStop(1,e.holeInsetA+"0.5)"),s.fillStyle=u,s.beginPath(),s.arc(l,i,100,0,Math.PI*2),s.fill();const c=s.createRadialGradient(l,i,97,l,i,100);return c.addColorStop(0,"transparent"),c.addColorStop(.5,e.holeInsetB+"0.1)"),c.addColorStop(1,e.holeInsetB+"0.35)"),s.fillStyle=c,s.beginPath(),s.arc(l,i,100,0,Math.PI*2),s.fill(),r}function Ee(e,t,o){const a=Math.ceil(t*2),[r,s]=K(a,a),l=a/2;s.save(),s.beginPath(),s.arc(l,l,t,0,Math.PI*2),s.clip(),s.drawImage(e,0,0,a,a),s.restore(),s.globalCompositeOperation="destination-in";const i=s.createRadialGradient(l,l,0,l,l,t);for(const u of o)i.addColorStop(u.offset,`rgba(0,0,0,${u.alpha})`);return s.fillStyle=i,s.fillRect(0,0,a,a),s.globalCompositeOperation="source-over",r}var Pt=class{constructor(e,t){this.state=null,this.noiseImage=null,this.gl=e,this.quadVBO=t}setNoiseImage(e){this.noiseImage=e,this.state&&!this.state.texHEH&&this.dispose()}init(e){const t=this.gl;this.dispose();const o=Rt(e),a=Oe(t,wt,xt);t.useProgram(a);const r=t.getUniformLocation(a,"uMVP"),s=t.getUniformLocation(a,"uModel"),l=t.getUniformLocation(a,"uTex"),i=t.getUniformLocation(a,"uAlpha"),u=t.getUniformLocation(a,"uClipZ"),c=t.getAttribLocation(a,"aPos");t.uniform1i(l,0);const f=yt(),_=Tt(o),d=At(o),b=Ct(o),v=Mt(o),S=B(t,_),R=B(t,d),y=B(t,b),L=B(t,v);let P=null,G=null;this.noiseImage&&(P=B(t,Ee(this.noiseImage,ee,[{offset:0,alpha:1},{offset:.283,alpha:1},{offset:.99,alpha:0},{offset:1,alpha:0}])),G=B(t,Ee(this.noiseImage,te,[{offset:0,alpha:1},{offset:.283,alpha:.7},{offset:.99,alpha:0},{offset:1,alpha:0}]))),this.state={prog:a,locMvp:r,locModel:s,locTex:l,locAlpha:i,locClipZ:u,aPosLoc:c,proj:f,texGlow:S,glowHW:_.width/2,glowHH:_.height/2,texHGlow:R,hglowHS:d.width/2,texBglow:y,bglowHS:b.width/2,texHole:L,holeHS:v.width/2*E,texEH:P,texHEH:G}}render(e,t,o){const a=this.gl;(!this.state||this.state.texHEH===null&&this.noiseImage!==null)&&this.init(e);const r=this.state;a.useProgram(r.prog),a.bindBuffer(a.ARRAY_BUFFER,this.quadVBO),a.enableVertexAttribArray(r.aPosLoc),a.vertexAttribPointer(r.aPosLoc,2,a.FLOAT,!1,0,0),a.clearColor(0,0,0,0),a.clear(a.COLOR_BUFFER_BIT),a.enable(a.BLEND),a.disable(a.DEPTH_TEST);const s=t*o,l=s%be/be*Math.PI*2,i=s%Se/Se*Math.PI*2,u=()=>a.blendFunc(a.ONE,a.ONE_MINUS_SRC_ALPHA),c=()=>a.blendFunc(a.ONE,a.ONE_MINUS_SRC_COLOR);u(),this.drawQuad(r,r.texGlow,oe(r.glowHW,r.glowHH),1,0),r.texHEH&&(c(),this.drawQuad(r,r.texHEH,O(te,l),.35,-1)),u(),this.drawQuad(r,r.texHGlow,O(r.hglowHS),1,-1),this.drawQuad(r,r.texHGlow,O(r.hglowHS),1,-1),r.texEH&&(c(),this.drawQuad(r,r.texEH,oe(ee,ee,i),.7,0)),u(),this.drawQuad(r,r.texBglow,O(r.bglowHS),1,0),this.drawQuad(r,r.texHole,oe(r.holeHS,r.holeHS),1,0),u(),this.drawQuad(r,r.texHGlow,O(r.hglowHS),1,1),this.drawQuad(r,r.texHGlow,O(r.hglowHS),1,1),r.texHEH&&(c(),this.drawQuad(r,r.texHEH,O(te,l),.35,1)),a.disable(a.BLEND)}dispose(){if(!this.state)return;const e=this.gl,t=this.state;e.deleteProgram(t.prog),e.deleteTexture(t.texGlow),e.deleteTexture(t.texHGlow),e.deleteTexture(t.texBglow),e.deleteTexture(t.texHole),t.texEH&&e.deleteTexture(t.texEH),t.texHEH&&e.deleteTexture(t.texHEH),this.state=null}drawQuad(e,t,o,a,r){const s=this.gl,l=D(e.proj,o);s.uniformMatrix4fv(e.locMvp,!1,l),s.uniformMatrix4fv(e.locModel,!1,o),s.uniform1f(e.locAlpha,a),s.uniform1f(e.locClipZ,r),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,t),s.drawArrays(s.TRIANGLE_STRIP,0,4)}},Gt=class{constructor(e){this.hasSpare=!1,this.spare=0,this.s=e}next(){return this.s=(this.s*16807+0)%2147483647,(this.s-1)/2147483646}random(e,t){return t!==void 0?e+this.next()*(t-e):e!==void 0?this.next()*e:this.next()}randomGaussian(e=0,t=1){if(this.hasSpare)return this.hasSpare=!1,e+t*this.spare;let o,a,r;do o=this.next()*2-1,a=this.next()*2-1,r=o*o+a*a;while(r>=1||r===0);return r=Math.sqrt(-2*Math.log(r)/r),this.spare=a*r,this.hasSpare=!0,e+t*o*r}},It=Math.PI*2,$t=900;function Re(e){if(typeof document>"u")return new OffscreenCanvas(e,e);const t=document.createElement("canvas");return t.width=e,t.height=e,t}function Lt(e,t=512,o){const a=new Gt(e),r=$t,s=Re(r),l=s.getContext("2d");function i(h,I,N,$){const U=Math.max(0,Math.min(255,$));l.fillStyle=`rgba(${h|0},${I|0},${N|0},${U/255})`}function u(h,I,N){const $=Math.abs(N)/2;$<.1||(l.beginPath(),l.arc(h,I,$,0,It),l.fill())}function c(h,I,N,$,U){U=U+r/2e3;const Je=8300+Math.floor(r/3),et=r/1500,Q=20;for(let me=0;me<Je;me++)i(h+a.random(Q),N+a.random(Q),I+a.random(Q),Math.abs(a.randomGaussian())/4),u(-r/2+r/2*a.randomGaussian(),r*a.randomGaussian()/$,a.randomGaussian(r/100,r/$+r/40)),i(255,255,255,U*a.randomGaussian()/2),u(-r/2+r/2*a.randomGaussian(),r*a.randomGaussian()/$,et*a.randomGaussian())}function f(){const h=r*4;for(let I=0;I<h;I++)i(255,255,255,Math.abs(255*a.randomGaussian())),u(-r/2+r/2*a.randomGaussian(),r*a.randomGaussian()*a.randomGaussian()*a.randomGaussian()*a.randomGaussian(),.5*a.randomGaussian())}function _(){l.save(),l.translate(a.random(-r/2,r/2),a.random(-r/10,r/10)),c(a.random(100,255),a.random(100,255),a.random(100,255),29,100),l.scale(.05,.05),c(a.random(100,255),a.random(100,255),a.random(100,255),10,2),c(255,255,255,2,2),f(),l.restore()}l.save(),l.translate(r/2,r/2);const d=a.random(.3,1);l.scale(d,d),l.rotate(a.random(-Math.PI,Math.PI));const b=o?.dominant??[a.random(10,255),a.random(10,255),a.random(10,255)];c(b[0],b[1],b[2],3,6),f();const v=o?.accents??[[200,200,200],[0,200,250],[250,100,250]];c(v[0][0],v[0][1],v[0][2],7,205),v.length>1&&c(v[1][0],v[1][1],v[1][2],22,205),v.length>2&&c(v[2][0],v[2][1],v[2][2],25,205);const S=Math.floor(a.random(0,3.1));for(let h=0;h<S;h++)_();const R=Math.max(10,r/12),y=Math.floor(a.random(5,R));for(let h=0;h<y;h++)l.save(),l.translate(r/3*a.randomGaussian(),r/3*a.randomGaussian()),l.scale(a.random(.5,1),a.random(.5,1)),l.rotate(a.random(-Math.PI/4,Math.PI/4)),c(a.random(100,255),a.random(100,255),a.random(100,255),15,100),l.restore();l.restore();const L=r/2,P=r/2,G=r,m=l.createRadialGradient(L,P,G*.25,L,P,G*.52);if(m.addColorStop(0,"rgba(0,0,0,0)"),m.addColorStop(.6,"rgba(0,0,0,0)"),m.addColorStop(1,"rgba(0,0,0,1)"),l.globalCompositeOperation="destination-out",l.fillStyle=m,l.fillRect(0,0,r,r),l.globalCompositeOperation="source-over",t===r)return s;const M=Re(t);return M.getContext("2d").drawImage(s,0,0,t,t),M}var j={id:"base_planet",seedSlots:[1],colorSlotRange:[0,3],glsl:e=>{const t=e.uvSource===1?"sphered":"rotated",o=e.octaves||6,a=`u_seed${e.seedSlot||1}`,r=`u_col${e.colorStart||0}`,s=`u_col${(e.colorStart||0)+1}`,l=`u_col${(e.colorStart||0)+2}`;return`
    // === BASE PLANET ===
    {
    ...
    }`}},Ue={id:"land_mass",seedSlots:[2],colorSlotRange:[3,7],glsl:e=>{const t=(e.landCutoff??.5).toFixed(4),o=`u_seed${e.seedSlot||2}`,a=`u_col${e.colorStart||3}`,r=`u_col${(e.colorStart||3)+1}`,s=`u_col${(e.colorStart||3)+2}`,l=`u_col${(e.colorStart||3)+3}`;return`
    // === LAND MASS ===
    {
    ...
    }`}},ie={id:"clouds",seedSlots:[3],colorSlotRange:[7,11],glsl:e=>{const t=(e.cloudCover??.546).toFixed(4),o=(e.cloudScale||4).toFixed(1),a=`u_seed${e.seedSlot||3}`;return`
    // === CLOUD LAYER ===
    {
        float cloud_sz = ${o};
    ...
    }`}},De={id:"atmosphere",seedSlots:[],colorSlotRange:[11,14],glsl:e=>`
    // === ATMOSPHERE ===
    {
...
`,Bt={type:n.TerrainDry,mode:"standalone",uvScaling:1,standaloneGlsl:kt,palette:T[n.TerrainDry],colorSlots:A[n.TerrainDry],loopLCM:x[n.TerrainDry],defaults:{}},Ht={type:n.Aquatic,mode:"composed",uvScaling:1.05,features:[{feature:j,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Ue,params:{landCutoff:.65,seedSlot:2,colorStart:3,noiseScale:10}},{feature:ie,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:7}},{feature:De,params:{colorStart:11}}],palette:T[n.Aquatic],colorSlots:A[n.Aquatic],loopLCM:x[n.Aquatic],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,landCutoff:.65}},je={id:"craters",seedSlots:[2],colorSlotRange:[3,5],glsl:e=>{const t=(e.craterScale||5).toFixed(1),o=`u_seed${e.seedSlot||2}`,a=`u_col${e.colorStart||3}`,r=`u_col${(e.colorStart||3)+1}`;return`
    // === CRATER LAYER ===
    {
        float crater_sz = ${t};
        float c1_val = 1.0;
    ...
    }`}},zt={type:n.Barren,mode:"composed",uvScaling:1,features:[{feature:j,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:je,params:{craterScale:5,seedSlot:2,colorStart:3}}],palette:T[n.Barren],colorSlots:A[n.Barren],loopLCM:x[n.Barren],defaults:{fbmOctaves:6,noiseScale:10,craterScale:5}},Nt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
...
`,Ut={type:n.GasGiant,mode:"standalone",uvScaling:1,standaloneGlsl:Nt,palette:T[n.GasGiant],colorSlots:A[n.GasGiant],loopLCM:x[n.GasGiant],defaults:{}},Dt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,jt={type:n.GasGiantRinged,mode:"standalone",uvScaling:1,standaloneGlsl:Dt,palette:T[n.GasGiantRinged],colorSlots:A[n.GasGiantRinged],loopLCM:x[n.GasGiantRinged],defaults:{}},Fe={id:"flow_layer",seedSlots:[2,3],colorSlotRange:[3,6],glsl:e=>{const t=e.flowOctaves||5,o=(e.flowCutoff??.6).toFixed(4),a=(e.flowScale||10).toFixed(1),r=`u_seed${e.seedSlot||3}`,s=`u_col${e.colorStart||5}`,l=`u_col${(e.colorStart||5)+1}`,i=`u_col${(e.colorStart||5)+2}`;return e.useScroll,`
    // === FLOW LAYER ===
    {
        float flow_sz = ${a};
        float flow_cutoff = ${o};
    ...
    }`}},Ft={type:n.Molten,mode:"composed",uvScaling:1,features:[{feature:j,params:{uvSource:1,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:je,params:{craterScale:5,seedSlot:2,colorStart:3}},{feature:Fe,params:{flowOctaves:5,flowCutoff:.6,flowScale:10,seedSlot:3,colorStart:5}}],palette:T[n.Molten],colorSlots:A[n.Molten],loopLCM:x[n.Molten],defaults:{fbmOctaves:6,noiseScale:10,craterScale:5,flowCutoff:.6,flowOctaves:5,flowScale:10}},Wt={type:n.Ice,mode:"composed",uvScaling:1,features:[{feature:j,params:{uvSource:0,octaves:6,seedSlot:1,colorStart:0,noiseScale:10}},{feature:Fe,params:{flowOctaves:4,flowCutoff:.6,flowScale:10,seedSlot:2,colorStart:3}},{feature:ie,params:{cloudCover:.546,cloudScale:4,seedSlot:3,colorStart:6}}],palette:T[n.Ice],colorSlots:A[n.Ice],loopLCM:x[n.Ice],defaults:{fbmOctaves:6,noiseScale:10,cloudCover:.546,cloudScale:4,flowCutoff:.6,flowOctaves:4,flowScale:10}},Yt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,Vt={type:n.Star,mode:"standalone",uvScaling:1,standaloneGlsl:Yt,palette:T[n.Star],colorSlots:A[n.Star],loopLCM:x[n.Star],defaults:{}},qt=`
void main() {
    vec2 raw_uv = v_pos;
    vec2 uv = (floor(raw_uv * u_pixels) / u_pixels) + 0.5;
    float t = u_time * u_time_speed;
...
`,Xt={type:n.Galaxy,mode:"standalone",uvScaling:1,standaloneGlsl:qt,palette:T[n.Galaxy],colorSlots:A[n.Galaxy],loopLCM:x[n.Galaxy],defaults:{}},Kt={type:n.BlackHole,mode:"multipass",uvScaling:1,palette:T[n.BlackHole],colorSlots:A[n.BlackHole],loopLCM:x[n.BlackHole],defaults:{}},Qt={type:n.Nebula,mode:"canvas2d",uvScaling:1,palette:{},colorSlots:[],loopLCM:x[n.Nebula],defaults:{}},ae={[n.TerrainWet]:Ot,[n.TerrainDry]:Bt,[n.Aquatic]:Ht,[n.Barren]:zt,[n.GasGiant]:Ut,[n.GasGiantRinged]:jt,[n.Molten]:Ft,[n.Ice]:Wt,[n.Star]:Vt,[n.Galaxy]:Xt,[n.BlackHole]:Kt,[n.Nebula]:Qt},ko=class{constructor(e){this.noiseTexture=null,this.noiseImage=null,this.canvas=e||document.createElement("canvas");const t=this.canvas.getContext("webgl",{premultipliedAlpha:!1,alpha:!0,antialias:!1,preserveDrawingBuffer:!0});if(!t)throw new Error("WebGL not supported");this.gl=t;const o=t.createBuffer();if(!o)throw new Error("Failed to create buffer");this.quadVBO=o,t.bindBuffer(t.ARRAY_BUFFER,o),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),t.STATIC_DRAW),this.fallbackTexture=rt(t);const a=st(128);this.noiseTexture=ve(t,a),this.shaderRenderer=new ft(t,this.quadVBO,this.fallbackTexture),this.shaderRenderer.setNoiseTexture(this.noiseTexture),this.bhRenderer=new Pt(t,this.quadVBO)}async precompile(e){const t=e||Object.values(n).filter(o=>o!==n.BlackHole&&o!==n.Nebula);for(const o of t){const a=ae[o];!a||a.mode==="multipass"||a.mode==="canvas2d"||(this.shaderRenderer.precompile(a),await new Promise(r=>setTimeout(r,0)))}}async loadNoiseTexture(e){const t=await lt(e);this.noiseImage=t,this.setNoiseTexture(t),this.bhRenderer.setNoiseImage(t)}setNoiseTexture(e){const t=this.gl;this.noiseTexture&&t.deleteTexture(this.noiseTexture),this.noiseTexture=ve(t,e),this.shaderRenderer.setNoiseTexture(this.noiseTexture)}render(e,t){const o=this.gl,a=e.resolution||512,r=e.type;if(r===n.Nebula)return Lt(e.seed,a,e.colors);if((this.canvas.width!==a||this.canvas.height!==a)&&(this.canvas.width=a,this.canvas.height=a),o.viewport(0,0,a,a),r===n.BlackHole){const l=ae[n.BlackHole],i=l.palette,u=e.colors||{},c={};for(const _ of l.colorSlots)c[_]=u[_]||i[_];const f=e.timeSpeed??.1;return this.bhRenderer.render(c,t,f),this.canvas}const s=ae[r];if(!s)throw new Error(`Unknown celestial type: ${r}`);return this.shaderRenderer.render(s,e,t),this.canvas}renderToImageData(e,t){this.render(e,t);const o=this.gl,a=this.canvas.width,r=this.canvas.height,s=new Uint8Array(a*r*4);o.readPixels(0,0,a,r,o.RGBA,o.UNSIGNED_BYTE,s);const l=a*4,i=new Uint8Array(l);for(let u=0;u<Math.floor(r/2);u++){const c=u*l,f=(r-1-u)*l;i.set(s.subarray(c,c+l)),s.copyWithin(c,f,f+l),s.set(i,f)}return new ImageData(new Uint8ClampedArray(s.buffer),a,r)}getCanvas(){return this.canvas}getLoopDuration(e,t){const o=t??.1,a=x[e];return a?a/o:0}static getCelestialTypes(){return Object.values(n)}static getColorSlots(e){return[...A[e]||[]]}static getDefaultPalette(e){return{...T[e]||{}}}dispose(){const e=this.gl;this.shaderRenderer.dispose(),this.bhRenderer.dispose(),e.deleteBuffer(this.quadVBO),e.deleteTexture(this.fallbackTexture),this.noiseTexture&&e.deleteTexture(this.noiseTexture)}},Zt=new Set,Jt={galaxy:"galaxy",nebula:"nebula",planetary_nebula:"nebula",star_cluster:"nebula",black_hole:"blackHole"},Te=new Set;function eo(e){const t=Jt[e];return t??(Te.has(e)||(Te.add(e),console.warn(`[dsoCatalogKind] unknown DeepSkyBodyType "${String(e)}"; defaulting to nebula`)),"nebula")}function to(e){return Zt.has(e.catalogId)?"blackHole":eo(e.type)}function oo(e){switch(e){case"galaxy":return n.Galaxy;case"nebula":return n.Nebula;case"blackHole":return n.BlackHole;default:return n.Nebula}}function Bo(e){return oo(to(e))}function Ho(e){return e===n.BlackHole?"black_hole":e}function zo(e,t){const o=new Map;for(const a of e)o.set(a.catalogId,a);for(const a of t)o.set(a.catalogId,a);return Array.from(o.values())}var z=tt(ot(),1),Ae="openngc";function ao(e,t){if(e.length===0)return`${Ae}:0`;const o=e[0]?.catalogId??"",a=e[e.length-1]?.catalogId??"",r=typeof t=="number"&&Number.isFinite(t)?`:sch${t}`:"";return`${Ae}:${e.length}:${o}:${a}${r}`}var ue=null,fe=[];function ro(e,t){fe=e,ue=t}function No(){return ue}function Uo(){return fe}function so(){fe=[],ue=null}var We=Symbol("Comlink.proxy"),lo=Symbol("Comlink.endpoint"),Ye=Symbol("Comlink.releaseProxy"),re=Symbol("Comlink.finalizer"),W=Symbol("Comlink.thrown"),Ce=e=>typeof e=="object"&&e!==null||typeof e=="function",Ve=new Map([["proxy",{canHandle:e=>Ce(e)&&e[We],serialize(e){const{port1:t,port2:o}=new MessageChannel;return qe(e,t),[o,[o]]},deserialize(e){return e.start(),Ke(e)}}],["throw",{canHandle:e=>Ce(e)&&W in e,serialize({value:e}){let t;return e instanceof Error?t={isError:!0,value:{message:e.message,name:e.name,stack:e.stack}}:t={isError:!1,value:e},[t,[]]},deserialize(e){throw e.isError?Object.assign(new Error(e.value.message),e.value):e.value}}]]);function no(e,t){for(const o of e)if(t===o||o==="*"||o instanceof RegExp&&o.test(t))return!0;return!1}function qe(e,t=globalThis,o=["*"]){t.addEventListener("message",function a(r){if(!r||!r.data)return;if(!no(o,r.origin)){console.warn(`Invalid origin '${r.origin}' for comlink proxy`);return}const{id:s,type:l,path:i}=Object.assign({path:[]},r.data),u=(r.data.argumentList||[]).map(k);let c;try{const f=i.slice(0,-1).reduce((d,b)=>d[b],e),_=i.reduce((d,b)=>d[b],e);switch(l){case"GET":c=_;break;case"SET":f[i.slice(-1)[0]]=k(r.data.value),c=!0;break;case"APPLY":c=_.apply(f,u);break;case"CONSTRUCT":c=mo(new _(...u));break;case"ENDPOINT":{const{port1:d,port2:b}=new MessageChannel;qe(e,b),c=_o(d,[d])}break;case"RELEASE":c=void 0;break;default:return}}catch(f){c={value:f,[W]:0}}Promise.resolve(c).catch(f=>({value:f,[W]:0})).then(f=>{const[_,d]=q(f);t.postMessage(Object.assign(Object.assign({},_),{id:s}),d),l==="RELEASE"&&(t.removeEventListener("message",a),Xe(t),re in e&&typeof e[re]=="function"&&e[re]())}).catch(f=>{const[_,d]=q({value:new TypeError("Unserializable return value"),[W]:0});t.postMessage(Object.assign(Object.assign({},_),{id:s}),d)})}),t.start&&t.start()}function co(e){return e.constructor.name==="MessagePort"}function Xe(e){co(e)&&e.close()}function Ke(e,t){const o=new Map;return e.addEventListener("message",function(r){const{data:s}=r;if(!s||!s.id)return;const l=o.get(s.id);if(l)try{l(s)}finally{o.delete(s.id)}}),ne(e,o,[],t)}function F(e){if(e)throw new Error("Proxy has been released and is not useable")}function Qe(e){return H(e,new Map,{type:"RELEASE"}).then(()=>{Xe(e)})}var Y=new WeakMap,V="FinalizationRegistry"in globalThis&&new FinalizationRegistry(e=>{const t=(Y.get(e)||0)-1;Y.set(e,t),t===0&&Qe(e)});function io(e,t){const o=(Y.get(t)||0)+1;Y.set(t,o),V&&V.register(e,t,e)}function uo(e){V&&V.unregister(e)}function ne(e,t,o=[],a=function(){}){let r=!1;const s=new Proxy(a,{get(l,i){if(F(r),i===Ye)return()=>{uo(s),Qe(e),t.clear(),r=!0};if(i==="then"){if(o.length===0)return{then:()=>s};const u=H(e,t,{type:"GET",path:o.map(c=>c.toString())}).then(k);return u.then.bind(u)}return ne(e,t,[...o,i])},set(l,i,u){F(r);const[c,f]=q(u);return H(e,t,{type:"SET",path:[...o,i].map(_=>_.toString()),value:c},f).then(k)},apply(l,i,u){F(r);const c=o[o.length-1];if(c===lo)return H(e,t,{type:"ENDPOINT"}).then(k);if(c==="bind")return ne(e,t,o.slice(0,-1));const[f,_]=Me(u);return H(e,t,{type:"APPLY",path:o.map(d=>d.toString()),argumentList:f},_).then(k)},construct(l,i){F(r);const[u,c]=Me(i);return H(e,t,{type:"CONSTRUCT",path:o.map(f=>f.toString()),argumentList:u},c).then(k)}});return io(s,e),s}function fo(e){return Array.prototype.concat.apply([],e)}function Me(e){const t=e.map(q);return[t.map(o=>o[0]),fo(t.map(o=>o[1]))]}var Ze=new WeakMap;function _o(e,t){return Ze.set(e,t),e}function mo(e){return Object.assign(e,{[We]:!0})}function q(e){for(const[t,o]of Ve)if(o.canHandle(e)){const[a,r]=o.serialize(e);return[{type:"HANDLER",name:t,value:a},r]}return[{type:"RAW",value:e},Ze.get(e)||[]]}function k(e){switch(e.type){case"HANDLER":return Ve.get(e.name).deserialize(e.value);case"RAW":return e.value}}function H(e,t,o,a){return new Promise(r=>{const s=go();t.set(s,r),e.start&&e.start(),e.postMessage(Object.assign({id:s},o),a)})}function go(){return new Array(4).fill(0).map(()=>Math.floor(Math.random()*Number.MAX_SAFE_INTEGER).toString(16)).join("-")}var ho="/assets/openngc.worker-CoGk7Wpu.js";async function vo(e){if(typeof Worker>"u")return ge(e);let t;try{t=new Worker(ho,{type:"module"})}catch{return ge(e)}const o=Ke(t);try{return await o.loadCatalog(e)}catch(a){const r=a instanceof Error?a.message:String(a);throw Object.assign(new Error(r),{cause:a})}finally{o[Ye](),t.terminate()}}var po="openngc-dso-catalog";function Do(e){const t=e?.extraEnabled===!0,[o,a]=(0,z.useState)(!1);(0,z.useEffect)(()=>{queueMicrotask(()=>{a(!0)})},[]);const r=Ge({queryKey:[po],queryFn:async()=>{const{entries:s,schemaVersion:l}=await vo(Ie("data/openngc/openngc-dso.json"));return ro(s,ao(s,l)),s},enabled:t||o,staleTime:$e,retry:!1});return(0,z.useEffect)(()=>{r.isError&&so()},[r.isError]),r}var Pe="custom-objects";function bo(e,t){if(e.length===0)return`${Pe}:0`;const o=e[0]?.catalogId??"",a=e[e.length-1]?.catalogId??"",r=typeof t=="number"&&Number.isFinite(t)?`:sch${t}`:"";return`${Pe}:${e.length}:${o}:${a}${r}`}var de=[],_e=null;function So(e,t){de=e,_e=t}function jo(){return _e}function Fo(){return de}function yo(){de=[],_e=null}var wo=new Set(["galaxy","star_cluster","planetary_nebula","nebula","black_hole"]),p=class extends Error{constructor(e){super(e),this.name="CustomObjectsCatalogShapeError"}};function C(e){return typeof e=="number"&&Number.isFinite(e)}function w(e){if(typeof e!="string")return;const t=e.trim();return t.length>0?t:void 0}function xo(e,t){if(e==null||typeof e!="object")throw new p(`custom-objects entries[${t}] must be an object`);const o=e,a=w(o.catalogId),r=w(o.name),s=w(o.type);if(!a||!r||!s)throw new p(`custom-objects entries[${t}]: catalogId, name, and type are required`);if(!wo.has(s))throw new p(`custom-objects entries[${t}]: unknown type "${String(s)}"`);const{raDeg:l}=o,{decDeg:i}=o,{distPc:u}=o;if(!C(l)||!C(i)||!C(u))throw new p(`custom-objects entries[${t}]: raDeg, decDeg, and distPc must be finite numbers`);let c;if(o.aliases!=null){if(!Array.isArray(o.aliases))throw new p(`custom-objects entries[${t}]: aliases must be an array of strings when present`);c=o.aliases.map((m,M)=>{const h=w(m);if(h==null)throw new p(`custom-objects entries[${t}].aliases[${M}]: invalid string`);return h})}let f;if(o.physical!=null){if(typeof o.physical!="object")throw new p(`custom-objects entries[${t}]: physical must be an object when present`);const m=o.physical;if(f={},m.massSolarMasses!=null){if(!C(m.massSolarMasses))throw new p(`custom-objects entries[${t}].physical.massSolarMasses must be finite`);f.massSolarMasses=m.massSolarMasses}if(m.radiusKm!=null){if(!C(m.radiusKm))throw new p(`custom-objects entries[${t}].physical.radiusKm must be finite`);f.radiusKm=m.radiusKm}if(m.schwarzschildRadiusKm!=null){if(!C(m.schwarzschildRadiusKm))throw new p(`custom-objects entries[${t}].physical.schwarzschildRadiusKm must be finite`);f.schwarzschildRadiusKm=m.schwarzschildRadiusKm}if(m.spinDimensionless!=null){if(!C(m.spinDimensionless))throw new p(`custom-objects entries[${t}].physical.spinDimensionless must be finite`);f.spinDimensionless=m.spinDimensionless}if(m.luminositySolar!=null){if(!C(m.luminositySolar))throw new p(`custom-objects entries[${t}].physical.luminositySolar must be finite`);f.luminositySolar=m.luminositySolar}Object.keys(f).length===0&&(f=void 0)}let _;if(o.references!=null){if(!Array.isArray(o.references))throw new p(`custom-objects entries[${t}]: references must be an array of strings when present`);_=o.references.map((m,M)=>{const h=w(m);if(h==null)throw new p(`custom-objects entries[${t}].references[${M}]: invalid string`);return h})}const d={catalogId:a,name:r,type:s,raDeg:l,decDeg:i,distPc:u};c!=null&&(d.aliases=c);const b=w(o.subtype);if(b!=null&&(d.subtype=b),o.vMag!=null){if(!C(o.vMag))throw new p(`custom-objects entries[${t}]: vMag must be a finite number when set`);d.vMag=o.vMag}if(o.majAxArcmin!=null){if(!C(o.majAxArcmin))throw new p(`custom-objects entries[${t}]: majAxArcmin must be a finite number when set`);d.majAxArcmin=o.majAxArcmin}const v=w(o.constellation);v!=null&&(d.constellation=v);const S=w(o.messier);S!=null&&(d.messier=S);const R=w(o.parentGalaxyId);if(R!=null&&(d.parentGalaxyId=R),o.featured!=null){if(typeof o.featured!="boolean")throw new p(`custom-objects entries[${t}]: featured must be a boolean when set`);d.featured=o.featured}const y=w(o.notesMarkdown);y!=null&&(d.notesMarkdown=y);const L=w(o.description);L!=null&&(d.description=L);const P=w(o.imageUrl);P!=null&&(d.imageUrl=P);const G=w(o.wikipediaTitle);if(G!=null&&(d.wikipediaTitle=G),o.discoveredYear!=null){if(typeof o.discoveredYear!="number"||!Number.isInteger(o.discoveredYear))throw new p(`custom-objects entries[${t}]: discoveredYear must be an integer when set`);d.discoveredYear=o.discoveredYear}if(_!=null&&(d.references=_),f!=null&&(d.physical=f),o.externalLinks!=null){if(o.externalLinks===null||typeof o.externalLinks!="object"||Array.isArray(o.externalLinks))throw new p(`custom-objects entries[${t}]: externalLinks must be a non-null object when set`);const m={};for(const[M,h]of Object.entries(o.externalLinks)){if(typeof h!="string"||!h.startsWith("https://"))throw new p(`custom-objects entries[${t}].externalLinks.${M}: value must be an https:// URL string`);m[M]=h}d.externalLinks=m}return d}function Eo(e){const t={catalogId:e.catalogId,name:e.name,type:e.type,raDeg:e.raDeg,decDeg:e.decDeg,distPc:e.distPc};return e.aliases!=null&&(t.aliases=e.aliases),e.subtype!=null&&(t.subtype=e.subtype),e.vMag!=null&&(t.vMag=e.vMag),e.majAxArcmin!=null&&(t.majAxArcmin=e.majAxArcmin),e.constellation!=null&&(t.constellation=e.constellation),e.messier!=null&&(t.messier=e.messier),e.parentGalaxyId!=null&&(t.parentGalaxyId=e.parentGalaxyId),e.featured!=null&&(t.featured=e.featured),e.notesMarkdown!=null&&(t.notesMarkdown=e.notesMarkdown),e.description!=null&&(t.description=e.description),e.imageUrl!=null&&(t.imageUrl=e.imageUrl),e.wikipediaTitle!=null&&(t.wikipediaTitle=e.wikipediaTitle),e.references!=null&&(t.references=e.references),e.discoveredYear!=null&&(t.discoveredYear=e.discoveredYear),e.physical!=null&&(t.physical=e.physical),e.externalLinks!=null&&(t.externalLinks=e.externalLinks),t}function Ro(e){if(e==null||typeof e!="object")throw new p("Custom objects JSON must be an object");const t=e;if(!Array.isArray(t.entries))throw new p("Custom objects JSON must include entries: []");let o;return typeof t.version=="number"&&Number.isFinite(t.version)&&(o=t.version),{entries:t.entries.map((a,r)=>xo(a,r)).map(Eo),...o!==void 0&&{schemaVersion:o}}}async function To(e){const t=await fetch(e);if(!t.ok)throw new Error(`Failed to load custom objects catalog: ${t.status}`);return Ro(await t.json())}var Ao="custom-objects-catalog";function Wo(e){const t=e?.extraEnabled===!0,[o,a]=(0,z.useState)(!1);(0,z.useEffect)(()=>{queueMicrotask(()=>{a(!0)})},[]);const r=Ge({queryKey:[Ao],queryFn:async()=>{const{entries:s,schemaVersion:l}=await To(Ie("data/custom/custom-objects.json"));return So(s,bo(s,l)),s},enabled:t||o,staleTime:$e,retry:!1});return(0,z.useEffect)(()=>{r.isError&&yo()},[r.isError]),r}export{n as C,Oo as D,$o as E,ko as S,Lo as T,ro as _,Fo as a,Ho as b,po as c,mo as d,Ye as f,Uo as g,No as h,bo as i,Do as l,ao as m,Wo as n,jo as o,Ke as p,To as r,So as s,Ao as t,vo as u,zo as v,Io as w,to as x,Bo as y};
