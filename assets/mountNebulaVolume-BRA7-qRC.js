...
`,Pe="/assets/transcoder/",B=new Map,I=null;function X(){if(I!==null)return I;const e=new se;return e.setTranscoderPath(Pe),I=e,e}function Ie(e){try{X().detectSupport(e)}catch{}}function E(e){const t=B.get(e);t!==void 0&&(t.refCount-=1,!(t.refCount>0)&&(t.texture?.dispose(),B.delete(e)))}function De(e,t){if(t?.aborted)return Promise.reject(new DOMException("aborted","AbortError"));const o=B.get(e);if(o!==void 0){if(o.refCount+=1,t!==void 0){const r=new Promise((u,n)=>{t.addEventListener("abort",()=>{E(e),n(new DOMException("aborted","AbortError"))})});return Promise.race([o.promise,r])}return o.promise}const a={refCount:1,texture:null,promise:new Promise((r,u)=>{X().load(e,n=>{if(t?.aborted){n.dispose(),B.delete(e),u(new DOMException("aborted","AbortError"));return}a.texture=n,r(n)},void 0,n=>{B.delete(e),u(n instanceof Error?n:new Error(String(n)))})})};return B.set(e,a),a.promise}var Oe="/assets/textures/nebulas/manifest.json",w=null;function Fe(e){if(e===null||typeof e!="object")return!1;const t=e;return typeof t.thumb=="string"&&typeof t.mid=="string"&&typeof t.high=="string"&&typeof t.source=="string"&&typeof t.license=="string"&&typeof t.attribution=="string"}function ke(e){if(e===null||typeof e!="object")return{entries:{}};const t=e;if(t.entries===null||typeof t.entries!="object")return{entries:{}};const o={};for(const[a,r]of Object.entries(t.entries))Fe(r)&&(o[a]=r);return{entries:o}}function Ue(){return w!==null||(w=fetch(Oe).then(async e=>e.ok?ke(await e.json()):{entries:{}}).catch(()=>({entries:{}}))),w}function qe(e){return e.replace(/\s+/g,"").toUpperCase()}async function We(e){return(await Ue()).entries[qe(e)]??null}var je=.6,He=1.2;function Ve(e,t,o){if(t<=e)return o>=t?1:0;const a=Math.min(1,Math.max(0,(o-e)/(t-e)));return a*a*(3-2*a)}function Qe(e){return!Number.isFinite(e)||e<0?"none":e<=.8?"high":e<=2?"mid":e<=5?"thumb":"none"}function ze(e){if(!Number.isFinite(e)||e<0)return{shellOpacity:0,sphereOpacity:1};const t=Ve(je,He,e);return{shellOpacity:t,sphereOpacity:1-t}}var Ge=.95,W=48;function Ye(e,t){switch(t){case"high":return e.high;case"mid":return e.mid;case"thumb":return e.thumb;default:return null}}function Je(e,t){const{center:o,radius:a,entry:r}=t,u=new G(a*Ge,W,Math.max(2,Math.floor(W/2))),n=new Uint8Array([0,0,0,0]),c=new ue(n,1,1,ie);c.needsUpdate=!0;const f=ge({texture:c,programCacheKey:"nebula-spheremap-edge-feather"}),s=new V(u,f);s.name=`nebula-spheremap-${r.thumb}`,s.position.copy(o),s.rotation.set(-Math.PI/2,0,0),s.raycast=()=>{},s.frustumCulled=!1,s.renderOrder=-5,e.add(s);let d="none",i=null,l=null,m=!1,g=0;const v=(S,y)=>{if(m){E(S);return}i!==null&&i!==S&&E(i),i=S,f.map=y,f.needsUpdate=!0},R=S=>{const y=Ye(r,S);if(y===null)return;if(l!==null){if(l.url===y)return;l.ac.abort(),l=null}const M=new AbortController;l={url:y,ac:M},De(y,M.signal).then(h=>{l!==null&&l.url===y&&(l=null),v(y,h)}).catch(()=>{l!==null&&l.url===y&&(l=null)})};return{update(S){if(m)return;const y=S.distanceTo(o),M=a>0?y/a:Number.POSITIVE_INFINITY,h=Qe(M);h!==d&&(d=h,h==="none"?l!==null&&(l.ac.abort(),l=null):R(h));const b=ze(M);g=i!==null?b.sphereOpacity:0,f.opacity=g,s.visible=g>.001},getSphereOpacity(){return g},dispose(){m||(m=!0,l!==null&&(l.ac.abort(),l=null),e.remove(s),u.dispose(),f.map=null,f.dispose(),c.dispose(),i!==null&&(E(i),i=null))}}}var Ke=ce.far/4;function _(e){return new ne(e[0],e[1],e[2])}function D(e){return new N(e[0],e[1],e[2])}function Xe(e){if(!Number.isFinite(e.distPc)||e.distPc<=0||!Number.isFinite(e.majAxArcmin)||(e.majAxArcmin??0)<=0)return 0;const t=te.degToRad(e.majAxArcmin/120),o=Z(e.distPc*Math.tan(t));return!Number.isFinite(o)||o<=0?0:Math.min(o,Ke)}function $e(e,t,o,a,r,u,n,c){return{uTime:{value:0},uRadius:{value:t},uIntensity:{value:1.45*c.intensityScale},uStructureScale:{value:4.4+o*.6},uQuality:{value:0},uShellIndex:{value:o},uShellIntensityMul:{value:a},uOctaveBoost:{value:r},uMorphologyMode:{value:c.morphologyMode},uDustStrength:{value:c.dustStrength},uCoreBoost:{value:c.coreBoost},uAccentBias:{value:c.accentBias},uWarpStrength:{value:n.warpStrength},uColorA:{value:_(c.colorA)},uColorB:{value:_(c.colorB)},uColorC:{value:_(c.colorC)},uMorphScale:{value:D(n.morphScale)},uWarpAxis:{value:D(n.warpAxis)},uDriftVec:{value:new N(.009+Math.sin(e+o*1.1)*.004,-.006+Math.cos(e*1.7+o)*.004,.007+Math.sin(e*.6+o*2.3)*.005)},uSeedOffset:{value:D(u)},uMorphAngles:{value:new oe(n.morphAngleRad,n.morphTiltRad)}}}function Ze(e){return new Q({uniforms:e,vertexShader:Y,fragmentShader:Te,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1})}function et(e){return new Q({uniforms:e,vertexShader:Y,fragmentShader:Le,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1})}var O=null;function tt(){if(O!==null)return O;const e=128,t=document.createElement("canvas");t.width=e,t.height=e;const o=t.getContext("2d");if(o!==null){const r=o.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.35,"rgba(255,255,255,0.55)"),r.addColorStop(.7,"rgba(255,255,255,0.12)"),r.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=r,o.fillRect(0,0,e,e)}const a=new le(t);return a.colorSpace=re,a.needsUpdate=!0,O=a,a}function ot(e,t){const o=Xe(e);if(o<=0)return null;const a=ee(e),r=ye(e.catalogId),u=Me(e,r),n=we(e,r),c=Ee(t,r),f=new H;f.name=`nebula-${e.catalogId}`,f.position.set(a.x,a.y,a.z);const s=[];for(let m=0;m<c.length;m+=1){const g=c[m],v=o*g.radiusScale,R=$e(o,v,m,g.intensityMul,g.octaveBoost,g.seedOffset,u,n),S=new G(v,40,28),y=Ze(R),M=new V(S,y);M.frustumCulled=!1,M.renderOrder=-10-m,f.add(M),s.push({mesh:M,shellMaterial:y,raymarchMaterial:null,shellIndex:m,baseIntensity:R.uIntensity.value})}const d=_e(o,r,n,u),i=[];let l=null;if(d.length>0){l=tt();for(const m of d){const g=new z({map:l,color:_(m.color),transparent:!0,depthWrite:!1,blending:2,toneMapped:!1}),v=new ae(g);v.position.set(m.offset[0],m.offset[1],m.offset[2]),v.scale.setScalar(m.radius*2),v.renderOrder=-10-c.length,v.frustumCulled=!1,f.add(v),i.push(v)}}return{group:f,shells:s,sprites:i,spriteTexture:l,radius:o,spheremap:null}}function rt(e){e.spheremap!==null&&(e.spheremap.dispose(),Object.assign(e,{spheremap:null}));for(const t of e.shells)t.mesh.geometry.dispose(),t.shellMaterial.dispose(),t.raymarchMaterial!==null&&t.raymarchMaterial.dispose();for(const t of e.sprites)t.material instanceof z&&t.material.dispose()}function j(e,t){const o=t==="ultra";for(const a of e)for(const r of a.shells)r.shellMaterial.uniforms.uQuality.value=o?1:0,r.shellIndex===2&&(o?(r.raymarchMaterial===null&&(r.raymarchMaterial=et(r.shellMaterial.uniforms)),r.raymarchMaterial.uniforms.uQuality.value=1,r.mesh.material=r.raymarchMaterial):r.mesh.material=r.shellMaterial)}function at(){return pe(de())}function nt(e){const t=he(e),o=t.layers.dso,a=t.cameraThree,r=new H;r.name="nebulaVolumeLayer",o.add(r);const u=new N,n=new N;Ie(t.gl);const c=fe(),f=[],s=U.getState(),d={current:s.showNebulaClouds},i={current:s.nebulaQuality},l={current:0},m={current:performance.now()},g=()=>{r.visible=d.current&&f.length>0},v=()=>{for(;f.length>0;){const h=f.pop();r.remove(h.group),rt(h)}},R=(h,b)=>{We(b.catalogId).then(A=>{if(A===null||!f.includes(h))return;const C=Je(h.group,{center:new N(0,0,0),radius:h.radius,entry:A});Object.assign(h,{spheremap:C})})},S=()=>{v();const h=at();for(const b of h){const A=ot(b,i.current);A!==null&&(f.push(A),r.add(A.group),R(A,b))}j(f,i.current),g()};S();const y=U.subscribe(h=>({showNebulaClouds:h.showNebulaClouds,nebulaQuality:h.nebulaQuality}),h=>{d.current=h.showNebulaClouds,i.current!==h.nebulaQuality&&(i.current=h.nebulaQuality,j(f,i.current)),g()},{equalityFn:$}),M=c.getQueryCache().subscribe(h=>{(q(h,"openngc-dso-catalog")||q(h,"custom-objects-catalog"))&&S()});return{onFrame:h=>{if(!r.visible)return;const b=performance.now(),A=Math.min(.06,Math.max(0,(b-m.current)/1e3));m.current=b,l.current+=A,a.getWorldPosition(u);for(const C of f){let k=1;C.spheremap!==null&&(n.copy(u),C.group.worldToLocal(n),C.spheremap.update(n),k=1-C.spheremap.getSphereOpacity());for(const x of C.shells){x.shellMaterial.uniforms.uTime.value=l.current;const T=x.baseIntensity*k;x.shellMaterial.uniforms.uIntensity.value!==T&&(x.shellMaterial.uniforms.uIntensity.value=T),x.raymarchMaterial!==null&&(x.raymarchMaterial.uniforms.uIntensity.value=T)}}},dispose:()=>{y(),M(),v(),o.remove(r)}}}var yt=me(nt,"present.hud");export{yt as NebulaVolumeMountR3f};
