(function() {
	var e2 = Object.defineProperty, Qn = (t, n) => {
		let e = {};
		for (var o in t) e2(e, o, {
			get: t[o],
			enumerable: !0
		});
		return n || e2(e, Symbol.toStringTag, { value: "Module" }), e;
	};
	const o2 = Symbol("Comlink.proxy"), Yn = Symbol("Comlink.endpoint"), qn = Symbol("Comlink.releaseProxy"), ct = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), r2 = (t) => typeof t == "object" && t !== null || typeof t == "function", s2 = new Map([["proxy", {
		canHandle: (t) => r2(t) && t[o2],
		serialize(t) {
	...
	function ut(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			const { id: s, type: i, path: a } = Object.assign({ path: [] }, r.data), c = (r.data.argumentList || []).map(P0);
			let u;
			try {
				...
				switch (i) {
					case "GET":
						...
						break;
					case "SET":
						h[a.slice(-1)[0]] = P0(r.data.value), u = !0;
						break;
					case "APPLY":
						u = l.apply(h, c);
						break;
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, d] = x1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), d), i === "RELEASE" && (n.removeEventListener("message", o), i2(n), ct in t && typeof t[ct] == "function" && t[ct]());
			}).catch((h) => {
				const [l, d] = x1({
	...
	function lt(t, n, e = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(i, a, c) {
				...
				if (u === Yn) return C0(t, n, { type: "ENDPOINT" }).then(P0);
	...
	}, I1 = 149597870.7, ht = 648e3 / Math.PI;
	ht * I1 / 3.2615637771694;
	const l2 = 1e3 / I1, O0 = I1 * l2;
	100 * O0;
	100 / ht;
	const h2 = 3.2615637771694, ft = O0 * ht;
	25 * ft;
	function f2(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * ft;
	}
	const a3 = 5e4, c3 = 2e3, u3 = a3 / h2, l3 = c3 / h2;
	f2(u3);
	f2(l3);
	25 * ft;
	const s1 = 299792.458, d2 = 1e3;
	1 * d2, 1 * s1, 1e3 * s1, 1e6 * s1, 1e9 * s1;
	1e9 * s1;
	1 * d2;
	function h3(t) {
		return {
	...
	const M2 = Object.fromEntries(Object.entries(i3).map(([t, n]) => [t, h3(n)])), v1 = [
		R.SUN,
		R.MERCURY,
		R.VENUS,
		R.EARTH,
	...
	const S2 = M2[R.EARTH]?.radiusKm ?? 6371, _2 = M2[R.SUN]?.radiusKm ?? 696340;
	S2 / _2;
	function f3(t) {
		return {
			x: t.x * O0,
	...
	const D1 = 173.1446326846693, U = 149597870.69098932, p2 = 63241.07708807546, _ = .017453292519943295, dt = .26179938779914946, b = 57.29577951308232, Mt = 3.819718634205488, M3 = 71492, S3 = 66854, _3 = 69911, A3 = 1821.6, p3 = 1560.8, E3 = 2631.2, y3 = 2410.3, E2 = 365.24217, y2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), t0 = 2 * Math.PI, y0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, w2 = 10800 * 60, w3 = 2 * w2, g2 = 7292115e-11, g3 = w2 / Math.PI, R3 = -.17 - 5 * Math.log10(g3), z1 = 29.530588, T1 = 24 * 3600, m3 = T1 * 1e3, R2 = .9972695717592592, i1 = 695700, m2 = i1 / U, r0 = .996647180302104, b0 = r0 * r0, d0 = 6378.1366, x3 = d0 / U, I3 = d0 * r0, x2 = 6371, v3 = x2 + 88, P3 = 1738.1 / U, W = 1737.4, I2 = 1736, D3 = I2 / U, z3 = 34 / 60, St = 81.30056, a1 = .0002959122082855911, _t = 4912547451450812e-26, At = 7243452486162703e-25, c1 = 8887692390113509e-25, pt = 9549535105779258e-26, H0 = 2.825345909524226e-7, V0 = 8.459715185680659e-8, F0 = 1.292024916781969e-8, G0 = 1.524358900784276e-8, T3 = 218869976542597e-26, N1 = c1 / St;
	function Et(t) {
		switch (t) {
	...
	var w0 = class at {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - y2.getTime()) / e, this.tt = D2(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(y2.getTime() + n * e), this.ut = n, this.tt = D2(this.ut);
				return;
			}
	...
	function g0(t) {
		if (!O1 || Math.abs(O1.tt - t.tt) > 1e-6) {
			const n = H3(t), e = z2(t), o = e + n.deps / 3600;
			O1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function R0(t) {
		...
		let i, a, c, u, h, l, d, A, M, p, y, g, m, w, I, x, z, P, k, N, B, K, q, c0 = o(-6, 6, 1, 4), o0 = o(-6, 6, 1, 4);
		function A0(T, C) {
			return r(c0, T, C);
		}
		function I0(T, C) {
		...
		var h0 = L(.19833 + .05611 * n), Wt = L(.27869 + .04508 * n), jt = L(.16827 - .36903 * n), Xt = L(.34734 - 5.37261 * n), Zt = L(.10498 - 5.37899 * n), it = L(.42681 - .41855 * n), h4 = L(.14943 - 5.37511 * n);
		for (P = .84 * h0 + .31 * Wt + 14.27 * jt + 7.26 * Xt + .28 * Zt + .24 * it, k = 2.94 * h0 + .31 * Wt + 14.27 * jt + 9.34 * Xt + 1.12 * Zt + .83 * it, N = -6.4 * h0 - 1.89 * it, B = .21 * h0 + .31 * Wt + 14.27 * jt - 88.7 * Xt - 15.3 * Zt + .24 * it - 1.86 * h4, K = P - N, A = -3332e-9 * L(.59734 - 5.37261 * n) - 539e-9 * L(.35498 - 5.37899 * n) - 64e-9 * L(.39943 - 5.37511 * n), m = t0 * J0(.60643382 + 1336.85522467 * n - 313e-8 * d) + P / y0, w = t0 * J0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / y0, I = t0 * J0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / y0, x = t0 * J0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / y0, z = t0 * J0(.82736186 + 1236.85308708 * n - 397e-8 * d) + K / y0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (u0(0, h, 1), u0(1, h, Math.cos(c) * u), l0(0, h, 0), l0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) st(A0(l - 1, h), I0(l - 1, h), A0(1, h), I0(1, h), (T, C) => (u0(l, h, T), l0(l, h, C)));
			for (l = 1; l <= a; ++l) u0(-l, h, A0(l, h)), l0(-l, h, -I0(l, h));
		}
		function $n(T, C, H, F) {
			for (var $ = {
				x: 1,
				...
				H,
				F
			], p0 = 1; p0 <= 4; ++p0) v0[p0] !== 0 && st($.x, $.y, A0(v0[p0], p0), I0(v0[p0], p0), (t2, r1) => ($.x = t2, $.y = r1));
			return $;
		}
		function S(T, C, H, F, $, v0, p0, t2) {
			var r1 = $n($, v0, p0, t2);
			M += T * r1.y, q += C * r1.y, y += H * r1.x, g += F * r1.x;
		}
		...
		p = 0, p += f0(-526.069, 0, 0, 1, -2), p += f0(-3.352, 0, 0, 1, -4), p += f0(44.297, 1, 0, 1, -2), p += f0(-6, 1, 0, 1, -4), p += f0(20.599, -1, 0, 1, 0), p += f0(-30.598, -1, 0, 1, -2), p += f0(-24.649, -2, 0, 1, 0), p += f0(-2, -2, 0, 1, -2), p += f0(-22.571, 0, 1, 1, -2), p += f0(10.985, 0, -1, 1, -2), M += .82 * L(.7736 - 62.5512 * n) + .31 * L(.0466 - 125.1025 * n) + .35 * L(.5785 - 25.1042 * n) + .66 * L(.4591 + 1335.8075 * n) + .64 * L(.313 - 91.568 * n) + 1.14 * L(.148 + 1331.2898 * n) + .21 * L(.5918 + 1056.5859 * n) + .44 * L(.5784 + 1322.8595 * n) + .24 * L(.2275 - 5.7374 * n) + .28 * L(.2965 + 2.6929 * n) + .33 * L(.3132 + 6.3368 * n), i = x + q / y0;
		let f4 = (1.000002708 + 139.978 * A) * (18519.699999999997 + y) * Math.sin(i) - 6.24 * Math.sin(3 * i) + p;
		return {
			geo_eclip_lon: t0 * J0((m + M / y0) / t0),
			geo_eclip_lat: Math.PI / (180 * 3600) * f4,
			distance_au: y0 * x3 / (.999953253 * g)
		};
	}
	var L2 = class {
	...
	function k1(t, n) {
		...
		o *= k0, r *= k0, s *= k0, i *= k0;
		const a = Math.sin(o), c = Math.cos(o), u = Math.sin(-r), h = Math.cos(-r), l = Math.sin(-s), d = Math.cos(-s), A = Math.sin(i), M = Math.cos(i), p = M * h - u * A * d, y = M * u * c + A * d * h * c - a * A * l, g = M * u * a + A * d * h * a + c * A * l, m = -A * h - u * M * d, w = -A * u * c + M * d * h * c - a * M * l, I = -A * u * a + M * d * h * a + c * M * l, x = u * l, z = -l * h * c - a * d, P = -l * h * a + d * c;
	...
	function J3(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = r > 0 ? 90 : -90, c = Math.abs(r) - I3;
		else {
			...
			for (;;) {
				...
				const I = p * ((y - g) / d - g * y * (b0 - 1) / (p * m)) + r * l + s * h;
				u -= w / I;
			}
			a = b * u;
			const M = d0 / d;
	...
	function H1(t, n) {
		const e = g0(t), o = e.mobl * _, r = e.tobl * _, s = e.dpsi * k0, i = Math.cos(o), a = Math.sin(o), c = Math.cos(r), u = Math.sin(r), h = Math.cos(s), l = Math.sin(s), d = h, A = -l * i, M = -l * a, p = l * c, y = h * i * c + a * u, g = h * a * c - i * u, m = l * u, w = h * i * u - a * c, I = h * a * u + i * c;
		if (n === O.From2000) return new G([
			[
				d,
				p,
	...
	function V1(t, n, e) {
		return e === O.Into2000 ? K0($0(t, n, e), n, e) : $0(K0(t, n, e), n, e);
	}
	function K3(t, n, e) {
		return e === O.Into2000 ? C2(k2(t, n, e), n, e) : k2(C2(t, n, e), n, e);
	}
	function b2(t, n) {
	...
	function G1(t, n, e, o, r) {
		let s = E(t);
		Y0(n), v(e), v(o);
		const i = Math.sin(n.latitude * _), a = Math.cos(n.latitude * _), c = Math.sin(n.longitude * _), u = Math.cos(n.longitude * _), h = Math.sin(o * _), l = Math.cos(o * _), d = Math.sin(e * dt), A = Math.cos(e * dt);
		let M = [
			a * u,
			a * c,
			i
		...
		const g = -15 * M0(s);
		let m = Q0(g, M), w = Q0(g, p), I = Q0(g, y), x = [
			l * A,
			l * d,
			h
		];
		const z = x[0] * m[0] + x[1] * m[1] + x[2] * m[2], P = x[0] * w[0] + x[1] * w[1] + x[2] * w[2], k = x[0] * I[0] + x[1] * I[1] + x[2] * I[2];
		let N = Math.hypot(P, k), B;
		N > 0 ? (B = -b * Math.atan2(k, P), B < 0 && (B += 360)) : B = 0;
		let K = b * Math.atan2(N, z), q = e, c0 = o;
		if (r) {
			let o0 = K, A0 = p1(r, 90 - K);
			if (K -= A0, A0 > 0 && K > 3e-4) {
				const I0 = Math.sin(K * _), u0 = Math.cos(K * _), l0 = Math.sin(o0 * _), st = Math.cos(o0 * _), L = [];
				for (let h0 = 0; h0 < 3; ++h0) L.push((x[h0] - st * m[h0]) / l0 * I0 + m[h0] * u0);
				N = Math.hypot(L[0], L[1]), N > 0 ? (q = Mt * Math.atan2(L[1], L[0]), q < 0 && (q += 24)) : q = 0, c0 = b * Math.atan2(L[2], N);
			}
		}
		return new H2(B, 90 - K, q, c0);
	}
	function Y0(t) {
	...
	function G2(t) {
		const n = E(t).AddDays(-1 / D1), e = W0(Q.Earth, n), [o, r, s] = V1([
			-e.x,
			-e.y,
			-e.z
		], n, O.From2000), i = _ * g0(n).tobl, a = Math.cos(i), c = Math.sin(i);
		return mt(new D(o, r, s, n), a, c);
	}
	function u1(t, n, e, o, r) {
		Y0(e), L1(o), L1(r);
		const s = E(n), i = b2(s, e), a = n0(t, s, r), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
		return F2(o ? V1(c, s, O.From2000) : c, s);
	}
	function Q3(t, n, e) {
		const o = E(t);
		let r = wt(n, M0(o)).pos;
	...
	function Y3(t, n, e) {
		const o = E(t), r = wt(n, M0(o)), s = new V(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
	...
	function q3(t, n) {
		...
		return n || (o = K0(o, t.t, O.From2000), o = $0(o, t.t, O.From2000)), J3(o, e);
	}
	function W3(t, n) {
	...
	function mt(t, n, e) {
		...
		return new V2(new D(o, r, s, t.t), c, a);
	}
	function l1(t) {
		const n = g0(t.t), [e, o, r] = $0(K0([
			t.x,
			t.y,
			t.z
	...
	function i0(t) {
		const n = E(t), e = R0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = K0(V3(n, [
	...
	function J1(t) {
		const n = E(t), e = R0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			...
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = g0(n), i = gt($0(T2(s.mobl, r), n, O.From2000), n), a = s.tobl * _, c = mt(i, Math.cos(a), Math.sin(a));
	...
	const q0 = 365250, vt = 0, Pt = 1, K1 = 2;
	function Dt(t) {
	...
	function W0(t, n) {
		const e = n.tt / q0;
		return Dt(J2(D0(t[vt], e, !0), D0(t[Pt], e, !1), D0(t[K1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / q0, o = D0(t[vt], e, !0), r = D0(t[Pt], e, !1), s = D0(t[K1], e, !1), i = It(t[vt], e), a = It(t[Pt], e), c = It(t[K1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), d = Math.sin(r), A = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, p = +(c * d) + s * l * a, y = J2(o, r, s), g = [
			A / q0,
			M / q0,
			p / q0
		];
		return new T0(n, Dt(y), Dt(g));
	}
	function $1(t, n, e, o) {
		const r = o / (o + a1), s = W0(Q[e], n);
		t.x += r * s.x, t.y += r * s.y, t.z += r * s.z;
	}
	function j3(t) {
		const n = new D(0, 0, 0, t);
		return $1(n, t, f.Jupiter, H0), $1(n, t, f.Saturn, V0), $1(n, t, f.Uranus, F0), $1(n, t, f.Neptune, G0), n;
	}
	const zt = 51, X3 = 29200, j0 = 146, S0 = 201, z0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function Z3(t) {
		let [n, [e, o, r], [s, i, a]] = t;
		return new T0(n, new Y(e, o, r), new Y(s, i, a));
	}
	function j(t, n, e, o) {
	...
	var M1 = class {
		...
		Acceleration(t) {
			...
			return n.incr(d1(t, H0, this.Jupiter.r)), n.incr(d1(t, V0, this.Saturn.r)), n.incr(d1(t, F0, this.Uranus.r)), n.incr(d1(t, G0, this.Neptune.r)), n;
		}
	}, Tt = class Bn {
		constructor(n, e, o, r) {
	...
	function Lt(t, n) {
		const e = t - n.tt, o = new M1(t), r = X0(e, n.r, n.v, n.a), s = o.Acceleration(r).mean(n.a), i = X0(e, n.r, n.v, s);
		return new K2(o, new Tt(t, i, n.v.add(s.mul(e)), o.Acceleration(i)));
	}
	const te = [];
	function $2(t, n) {
	...
	function Ut(t) {
		...
		return new K2(e, new Tt(n.tt, o, r, s));
	}
	function ne(t, n) {
		const e = z0[0][0];
		if (n < e || n > z0[zt - 1][0]) return null;
		const o = $2((n - e) / X3, zt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Ut(z0[o]).grav, s[S0 - 1] = Ut(z0[o + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < S0 - 1; ++i) s[i] = Lt(a += j0, s[i - 1]).grav;
			a = s[S0 - 1].tt;
			var r = [];
			for (r[S0 - 1] = s[S0 - 1], i = S0 - 2; i > 0; --i) r[i] = Lt(a -= j0, r[i + 1]).grav;
			for (i = S0 - 2; i > 0; --i) {
				const c = i / (S0 - 1);
	...
	function Ct(t, n) {
		...
		const s = ne(te, t.tt);
		if (s) {
			const i = $2((t.tt - s[0].tt) / j0, S0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = X0(t.tt - a.tt, a.r, a.v, u), l = Nt(t.tt - a.tt, a.v, u), d = X0(t.tt - c.tt, c.r, c.v, u), A = Nt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / j0;
			e = h.mul(1 - M).add(d.mul(M)), o = l.mul(1 - M).add(A.mul(M));
		} else {
			let i;
			t.tt < z0[0][0] ? i = B2(z0[0], t.tt, -j0) : i = B2(z0[zt - 1], t.tt, +j0), e = i.grav.r, o = i.grav.v, r = i.bary;
		}
	...
	function oe(t, n, e) {
		...
		const M = i * h - s * l, p = -s * h - i * l, y = 1 / (1 + p), g = 1 / (1 + Math.sqrt(1 - s * s - i * i)), m = o * (h - s - g * i * M), w = o * (l - i + g * s * M), I = u * y * o * (-l - g * i * p), x = u * y * o * (+h + g * s * p), z = 2 * Math.sqrt(1 - a * a - c * c), P = 1 - 2 * c * c, k = 1 - 2 * a * a, N = 2 * c * a;
		return new V(m * P + w * N, m * N + w * k, (a * w - m * c) * z, I * P + x * N, I * N + x * k, (a * x - I * c) * z, t);
	}
	function Q1(t, n) {
	...
	function a0(t, n) {
		...
		if (t === f.EMB) {
			const i = W0(Q.Earth, e), a = i0(e), c = 1 + St;
	...
	function N0(t, n) {
		...
		if (e) return e.dist;
		const o = E(n);
		return t in Q ? D0(Q[t][K1], o.tt / q0, !1) : a0(t, o).Length();
	}
	function Y2(t, n) {
		let e = n, o = 0;
		for (let r = 0; r < 10; ++r) {
	...
	function q2(t, n, e, o) {
		...
		if (C1(e)) {
			const a = a0(e, r);
			if (o) {
				const u = Y1(n, r), h = new D(a.x - u.x, a.y - u.y, a.z - u.z, r), l = D1 / h.Length();
		...
		let s;
		o ? s = new D(0, 0, 0, r) : s = a0(n, r);
		const i = new se(n, e, o, s);
		return Y2((a) => i.Position(a), r);
	}
	function n0(t, n, e) {
		L1(e);
		const o = E(n);
	...
	function ie(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(Q[f.Earth], e.tt), s = t === f.Moon ? h1(e) : xt(e);
	...
	function Y1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(Q.Earth, e.tt), s = t == f.Moon ? h1(e) : xt(e);
	...
	function J(t, n, e, o) {
		const r = v(o && o.dt_tolerance_seconds || 1), s = Math.abs(r / T1);
	...
	function q1(t, n) {
		...
		let r, s, i, a;
		t === f.Sun ? (i = new D(-o.x, -o.y, -o.z, e), s = new D(0, 0, 0, e), r = 0) : (t === f.Moon ? (i = i0(e), s = new D(o.x + i.x, o.y + i.y, o.z + i.z, e)) : (s = a0(t, n), i = new D(s.x - o.x, s.y - o.y, s.z - o.z, e)), r = U1(i, s));
		let c = i.Length(), u = s.Length(), h;
		if (t === f.Sun) a = R3 + 5 * Math.log10(c);
		else if (t === f.Moon) a = le(r, u, c);
		else if (t === f.Saturn) {
			const l = ue(r, u, c, i, e);
			a = l.mag, h = l.ring_tilt;
		} else a = ce(t, r, u, c);
		return new j2(e, a, r, u, c, i, s, h);
	}
	function S1(t) {
	...
	function he(t) {
		return Z2(new Date(t.time.date.getTime() + 6 * m3));
	}
	var tn = class {
		constructor(t, n, e) {
	...
	function Me(t, n, e, o, r, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = de(t), a = nn(n.height - s);
		return en(t, n, e, o, r, i, fe(n, s) - z3 * a.density);
	}
	function Se(t, n, e, o, r, s) {
		if (!Number.isFinite(s) || s < -90 || s > 90) throw `Invalid altitude angle: ${s}`;
		return en(t, n, e, o, r, 0, s);
	}
	var _e = class {
		constructor(t, n, e, o) {
	...
	function bt(t, n, e, o, r, s, i) {
		if (s < 0 && i >= 0) return new _e(o, r, s, i);
	...
	function Ae(t, n) {
		...
		const r = _ * n;
		return Math.abs((360 / R2 - e) * Math.cos(r)) + Math.abs(o * Math.sin(r));
	}
	function en(t, n, e, o, r, s, i) {
		if (Y0(n), v(r), v(s), v(i), i < -90 || i > 90) throw `Invalid target altitude angle: ${i}`;
		const a = .42, c = Ae(t, n.latitude);
		function u(p) {
			const y = u1(t, p, n, !0, !0);
			return e * (G1(p, n, y.ra, y.dec).altitude + b * Math.asin(s / y.dist) - i);
		}
		const h = E(o);
		let l = h, d = h, A = u(l), M = A;
		for (;;) {
			r < 0 ? (l = d.AddDays(-a), A = u(l)) : (d = l.AddDays(+a), M = u(d));
			const p = bt(0, u, c, l, d, A, M);
			if (p) {
	...
	function pe(t, n, e, o, r = 1) {
		...
		for (;;) {
			...
			if (i === 1 ? r > 0 ? u < 0 && (u += 24) : u > 0 && (u -= 24) : u < -12 ? u += 24 : u > 12 && (u -= 24), Math.abs(u) * 3600 < .1) {
				const l = G1(s, n, c.ra, c.dec, "normal");
				return new on(s, l);
			}
			let h = u / 24 * R2;
			s = s.AddDays(h);
	...
	function Ee(t, n, e) {
		const o = E(n), r = O2(o), s = u1(t, o, e, !0, !0);
	...
	function ye(t) {
		function n(e, o, r) {
			let s = new Date(Date.UTC(t, o - 1, r)), i = W2(e, s, 20);
	...
	function we(t, n) {
		...
		let i = 0;
		for (; ++i <= 2;) {
			let a = Z0(U0(t, r) - U0(f.Earth, r)), c, u, h;
	...
	function ge(t, n) {
		...
		let a = 0;
		for (; ++a <= 2;) {
			let c = Z0(U0(t, r) - U0(f.Earth, r)), u, h, l;
	...
	function ln(t, n) {
		if (n = E(n), t === f.Neptune || t === f.Pluto) return me(t, n);
		function e(c) {
	...
	function xe(t, n) {
		...
		const e = .25 * s0[t].OrbitalPeriod, o = ln(t, n.time.AddDays(e));
	...
	function De(t, n, e) {
		n = E(n);
		const o = hn(t.lon);
		return W1(new B0(t.lat + fn(e, t.lat), o, t.dist), n);
	}
	function p1(t, n) {
		let e;
	...
	function X1(t) {
		return t = E(t), x0(k1(t, O.From2000), H1(t, O.From2000));
	}
	function Te(t) {
		const n = E(t);
		return x0(X1(n), yn(n));
	...
	function Z1(t) {
		return t = E(t), x0(H1(t, O.Into2000), k1(t, O.Into2000));
	}
	function Ft(t, n) {
		t = E(t);
	...
	function He(t, n) {
		...
		const e = W1(new B0(n, 15 * t, 1), wn), o = Ht(E1(Gt, e)), r = 10 / 240, s = r / 15;
		for (let i of be) {
			const a = i[3] * r, c = i[1] * s, u = i[2] * s;
			if (a <= o.dec && c <= o.ra && o.ra < u) {
				const h = ke[i[0]];
				return new gn(h[0], h[1], o.ra, o.dec);
			}
		}
	...
	function y1(t, n, e, o) {
		...
		return new Ve(n, r, U * Math.hypot(s, i, a), +i1 - (1 + r) * (i1 - t), -i1 + (1 + r) * (i1 + t), e, o);
	}
	function tt(t) {
		const n = n0(f.Sun, t, !0), e = new D(-n.x, -n.y, -n.z, n.t);
		return y1(v3, t, i0(t), e);
	}
	function mn(t) {
		const n = n0(f.Sun, t, !0), e = i0(t), o = new D(-e.x, -e.y, -e.z, e.t);
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, y1(W, t, o, e);
	}
	function Jt(t, n) {
		const e = b2(t, n), o = n0(f.Sun, t, !0), r = i0(t), s = new D(e[0] - r.x, e[1] - r.y, e[2] - r.z, t);
		return r.x -= o.x, r.y -= o.y, r.z -= o.z, y1(W, t, s, r);
	}
	function nt(t, n, e) {
		const o = n0(t, e, !0), r = n0(f.Sun, e, !0), s = new D(o.x - r.x, o.y - r.y, o.z - r.z, e);
	...
	function Je(t) {
		const e = J((o) => Kt(mn, o), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Moon shadow time.";
		return mn(e);
	}
	function Ke(t, n, e) {
		const r = J((s) => Fe(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function In(t, n) {
		const e = new D(t.x + n.x, t.y + n.y, t.z + n.z, t.t), o = xn(Math.asin(m2 / e.Length()), Math.asin(D3 / n.Length()), U1(n, e) * _);
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (i.r < i.p + W) {
					...
					return i.r < i.k + W && (a = X.Partial, h = $t(i.time, i.k + W, l), i.r + W < i.k ? (a = X.Total, c = 1, u = $t(i.time, i.k - W, h)) : c = xn(W, i.k, i.r)), new Rn(a, c, i.time, l, h, u);
				}
			}
			e = r.AddDays(10);
		}
	...
	function Be(t) {
		...
		const i = X1(t.time), a = E1(i, t.dir), c = E1(i, t.target);
		a.x *= U, a.y *= U, a.z *= U / r0, c.x *= U, c.y *= U, c.z *= U / r0;
		...
		if (A > 0) {
			...
			const P = y1(I2, t.time, z, t.dir);
			if (P.r > 1e-9 || P.r < 0) throw `Unexpected shadow distance from geoid intersection = ${P.r}`;
			n = Dn(P.k), M = n === X.Total ? 1 : In(t.dir, z);
		} else M = void 0;
		return new Pn(n, M, e, o, r, s);
	}
	function Qe(t) {
	...
	function qe(t, n) {
		...
		const a = et(n, 1, Ln, s, t.time), c = et(n, -1, Ln, t.time, i);
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = et(n, 1, Un, s, t.time), h = et(n, -1, Un, t.time, i), l = Dn(t.k)) : l = X.Partial;
		const d = l === X.Total ? 1 : In(t.dir, t.target);
		return new Nn(l, d, a, u, r, h, c);
	}
	...
	function je(t, n) {
		return t = E(t), On(t.AddDays(10), n);
	}
	var kn = class {
		constructor(t, n, e, o) {
	...
	function bn(t, n, e, o, r) {
		const s = J((i) => Xe(i, t, n, r), e, o);
	...
	function Hn(t, n) {
		...
		for (;;) {
			...
			if (n1(t, i) < e) {
				const a = Ke(t, r, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-o), u = bn(t, r, c, a.time, -1), h = a.time.AddDays(+o), l = bn(t, r, a.time, h, 1), d = 60 * n1(t, a.time);
					return new kn(u, a.time, l, d);
				}
			}
			s = i.AddDays(10);
		}
	...
	function Ze(t, n) {
		return n = E(n), Hn(t, n.AddDays(100));
	}
	var _0;
	(function(t) {
	...
	function n4(t) {
		const n = K0($0([
			...
			0,
			1
		], t, O.Into2000), t, O.Into2000), e = new D(n[0], n[1], n[2], t), o = Ht(e), r = 190.41375788700253 + 360.9856122880876 * t.ut;
	...
	function e4(t, n) {
		...
		switch (t) {
			...
			case f.Venus:
				...
				break;
			case f.Earth: return n4(e);
			case f.Moon:
				const d = _ * (125.045 - .0529921 * o), A = _ * (250.089 - .1059842 * o), M = _ * (260.008 + 13.0120009 * o), p = _ * (176.625 + 13.3407154 * o), y = _ * (357.529 + .9856003 * o), g = _ * (311.589 + 26.4057084 * o), m = _ * (134.963 + 13.064993 * o), w = _ * (276.617 + .3287146 * o), I = _ * (34.226 + 1.7484877 * o), x = _ * (15.134 - .1589763 * o), z = _ * (119.743 + .0036096 * o), P = _ * (239.961 + .1643573 * o), k = _ * (25.053 + 12.9590088 * o);
			...
			case f.Mars:
				...
				break;
			case f.Jupiter:
				const N = _ * (99.360714 + 4850.4046 * r), B = _ * (175.895369 + 1191.9605 * r), K = _ * (300.323162 + 262.5475 * r), q = _ * (114.012305 + 6070.2476 * r), c0 = _ * (49.511251 + 64.3 * r);
				s = 268.056595 - .006499 * r + 117e-6 * Math.sin(N) + 938e-6 * Math.sin(B) + .001432 * Math.sin(K) + 3e-5 * Math.sin(q) + .00215 * Math.sin(c0), i = 64.495303 + .002413 * r + 5e-5 * Math.cos(N) + 404e-6 * Math.cos(B) + 617e-6 * Math.cos(K) - 13e-6 * Math.cos(q) + 926e-6 * Math.cos(c0), a = 284.95 + 870.536 * o;
				break;
			case f.Saturn:
	...
	function o4(t, n, e, o) {
		...
		let a, c;
		return e === f.Earth && o === f.Moon ? (a = new V(0, 0, 0, 0, 0, 0, r), c = h1(r)) : (a = Y1(e, r), c = Y1(o, r)), Jn(t, a, s, c, i);
	}
	function Jn(t, n, e, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const P = t == 4 ? +i : -i, k = .5 * a + P * w, N = .5 * c + P * I, B = .5 * u + P * x, K = .5 * w - P * a, q = .5 * I - P * c, c0 = .5 * x - P * u, o0 = l * k, A0 = l * N, I0 = l * B, u0 = d * a + A * c + M * u, l0 = d * w + A * I + M * x;
			p = new V(o0, A0, I0, u0 * k + l0 * K, u0 * N + l0 * q, u0 * B + l0 * c0, n.t);
		} else {
			...
			do {
				const k = z - y, N = z - g;
				P = (m * z + I / (k * k) + x / (N * N)) / (m - 2 * I / (k * k * k) - 2 * x / (N * N * N)), z -= P;
			} while (Math.abs(P / l) > 1e-14);
	...
	var r4 = class Z {
		...
		Update(n) {
			...
			if (o === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = X0(o, a.r, a.v, u), c.v = Nt(o, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			const e = {}, o = new T0(n.tt, Y.zero(), Y.zero());
			e[f.Mercury] = j(o, n.tt, f.Mercury, _t), e[f.Venus] = j(o, n.tt, f.Venus, At), e[f.Earth] = j(o, n.tt, f.Earth, c1 + N1), e[f.Mars] = j(o, n.tt, f.Mars, pt), e[f.Jupiter] = j(o, n.tt, f.Jupiter, H0), e[f.Saturn] = j(o, n.tt, f.Saturn, V0), e[f.Uranus] = j(o, n.tt, f.Uranus, F0), e[f.Neptune] = j(o, n.tt, f.Neptune, G0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new T0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Y.zero(), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, _t), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, At), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + N1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, pt), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, H0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, V0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, F0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, G0);
		}
	...
	const { MakeTime: k4, SearchRiseSet: b4, Body: H4, Observer: s4 } = ot(P1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: J4, CombineRotation: K4, MakeRotation: $4 } = ot(P1);
	Math.PI / (180 * 3600);
	function rt(t, n) {
	...
	const { HelioState: Q4 } = ot(P1);
	function a4(t, n, e = v1) {
		const o = {};
		for (const r of e) {
			const s = n[r] ?? [], i = s.length ? i4(s, t) : null;
			if (i) {
				const a = f3(i);
				o[r] = [
					a.x,
	...
	ut({
		async init(t) {
			const n = new Float32Array(t), e = c4();
