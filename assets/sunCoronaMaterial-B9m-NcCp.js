import{Ht as k,Rt as ht,wt as dt}from"./babylon-postprocess-vendor-CPXB9tym.js";import{B as pt,C as vt,Q as nt,R as gt,bt as D,lt as W,o as tt,p as U,s as xt,ut as St}from"./three-vendor-BZgPQKFQ.js";import{Mn as yt,No as J,Oo as Pt,Uo as wt,Yo as Mt,bo as bt,mn as at,qn as Ct,vn as kt}from"./index-Bu6BaRv8.js";import{u as zt}from"./babylon-vendor-Cyt56fsS.js";var Z=new WeakMap;function Fe(t,e){Z.set(t,e)}function Te(t){Z.delete(t)}function Ft(t){if(t.engineKind!=="babylon")throw new Error("asBabylon: SceneHost is not a Babylon implementation");const e=Z.get(t);if(!e)throw new Error("asBabylon: missing Babylon extras (host not fully initialized?)");return e}function Tt(t,e,o,r,n){t.updateMatrixWorld(!0),t.getWorldPosition(o),e.position.x=o.x,e.position.y=o.y,e.position.z=o.z,t.getWorldDirection(o),r.setFromMatrixColumn(t.matrixWorld,0).normalize(),n.setFromMatrixColumn(t.matrixWorld,1).normalize(),e.forward.x=o.x,e.forward.y=o.y,e.forward.z=o.z,e.right.x=r.x,e.right.y=r.y,e.right.z=r.z,e.up.x=n.x,e.up.y=n.y,e.up.z=n.z,e.fovYRadians=gt.degToRad(t.fov),e.aspect=t.aspect}function Rt(t,e,o,r,n){Tt(t,e,o,r,n);{const a=yt.current;a&&(e.position.x-=a.position.x,e.position.y-=a.position.y,e.position.z-=a.position.z)}}var At=new k(0,0,-1),It=new k(1,0,0),_t=new k(0,1,0),H=new k,B=new k,V=new k,N=new k;function Et(t,e,o){t.computeWorldMatrix(),t.getWorldMatrix().getTranslationToRef(H),o.position.x=H.x,o.position.y=H.y,o.position.z=H.z;{const[n,a,u]=e.getFloatingOrigin();o.position.x+=n,o.position.y+=a,o.position.z+=u}t.getDirectionToRef(At,B),t.getDirectionToRef(It,V),t.getDirectionToRef(_t,N),o.forward.x=B.x,o.forward.y=B.y,o.forward.z=B.z,o.right.x=V.x,o.right.y=V.y,o.right.z=V.z,o.up.x=N.x,o.up.y=N.y,o.up.z=N.z,o.fovYRadians=t.fov;const r=t.getEngine();o.aspect=r.getRenderWidth()/Math.max(1,r.getRenderHeight())}function Re(t){const e=t.replace(/^#/,""),o=parseInt(e,16);return Number.isFinite(o)?[Math.floor(o/65536)%256,Math.floor(o/256)%256,o%256]:[0,0,0]}function Dt(t){if(!t||typeof t!="string")return[1,1,1];const e=t.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return e?[parseInt(e[1],16)/255,parseInt(e[2],16)/255,parseInt(e[3],16)/255]:[1,1,1]}function Ae(t){return Math.max(0,Math.min(255,Math.round(t)))}var Wt=1,Lt=-25,Ht=500,Bt=.01;function Q(t,e){let o=e;for(;t[o]!==o;)o=t[o];let r=e;for(;r!==o;){const n=t[r];t[r]=o,r=n}return o}function Vt(t,e,o){const r=Q(t,e),n=Q(t,o);r!==n&&(t[r]=n)}function et(t,e,o){return`${t},${e},${o}`}function Ie(t,e){const o=t.length,r=Array.from({length:o},(i,l)=>l),n=e,a=new Map;for(let i=0;i<o;i+=1){const l=t[i],f=et(Math.floor(l.x/n),Math.floor(l.y/n),Math.floor(l.z/n));a.has(f)||a.set(f,[]),a.get(f).push(i)}const u=e*e;for(let i=0;i<o;i+=1){const l=t[i],f=Math.floor(l.x/n),p=Math.floor(l.y/n),m=Math.floor(l.z/n);for(let h=-1;h<=1;h+=1)for(let d=-1;d<=1;d+=1)for(let g=-1;g<=1;g+=1){const S=et(f+h,p+d,m+g),P=a.get(S);if(P)for(const w of P){if(w<=i)continue;const M=t[w],b=M.x-l.x,y=M.y-l.y,C=M.z-l.z;b*b+y*y+C*C<u&&Vt(r,i,w)}}}const c=new Map;for(let i=0;i<o;i+=1){const l=Q(r,i);c.has(l)||c.set(l,[]),c.get(l).push(i)}const s=[];for(let i=0;i<o;i+=1)s.push(void 0);for(const i of c.values())i.length<=1||(i.sort((l,f)=>l-f),i.forEach((l,f)=>{f>0&&(s[l]={x:0,y:f*Lt})}));return s}function Nt(){const t=[];for(let e=0;e<Ht;e+=1){const o=bt(e*.7%360,e*.3%180-90);o!=null&&t.push(o)}return t}function Ot(){const t=Nt(),e=t.length,o=wt,r=new Float32Array(e*3);return t.forEach((n,a)=>{r[a*3]=n.x*o,r[a*3+1]=n.y*o,r[a*3+2]=n.z*o}),{abbr:"_bootstrap",positions:r,sizes:new Float32Array(e).fill(Wt),colors:new Float32Array(e*3).fill(1),warm:new Float32Array(e).fill(Bt),brightness:new Float32Array(e).fill(1),mag:new Float32Array(e).fill(-1/0),starsInChunk:[]}}var Kt={raMin:0,raMax:360,decMin:-90,decMax:90},_e={chunks:[],namedStarsInView:[]};function Ee(t,e){return t===0&&e!=="success"}function it(t,e){return t.chunks.length>0?t.chunks:e==="idle"||e==="loading"?[Ot()]:[]}function De(t,e){const o=it(t,e),r=o.slice(0,3).map(n=>n.abbr).join(",");return o.length===0?{syntheticKind:"empty",chunkAbbrevSample:r}:o.length===1&&o[0]?.abbr==="_bootstrap"?{syntheticKind:"bootstrap",chunkAbbrevSample:r}:o.some(n=>n.abbr==="_fallback")?{syntheticKind:"fallback",chunkAbbrevSample:r}:{syntheticKind:"real",chunkAbbrevSample:r}}function ot(t,e){return e.current===t.current}function We(t,e,o,r,n){t.onerror=a=>{ot(e,o)||(r("error"),n(a.message??"Starfield worker failed"))},t.onmessageerror=()=>{ot(e,o)||(r("error"),n("Starfield worker message error"))}}function qt(t,e,o,r,n,a,u){const{runId:c,...s}=t;c===e.current&&(o.current=c,r.current=s.starsInView,n({chunks:s.chunks,namedStarsInView:s.namedStarsInView}),a("ready"),u(null))}function Le(t,e,o,r,n){t.processStarfield({runId:e,catalog:o,maxDistanceLevel:r,bounds:Kt,raInHours:!1}).then(a=>{qt(a,n.runIdRef,n.lastSuccessfulRunIdRef,n.starsInViewRef,n.setStarData,n.setStarfieldStatus,n.setErrorMessage)}).catch(a=>{e===n.runIdRef.current&&(n.setStarfieldStatus("error"),n.setErrorMessage(a instanceof Error?a.message:"Starfield worker failed"))})}function Ut(t,e){e.length=0;for(const o of t){const r=new Float32Array(o.starsInChunk.length);for(let n=0;n<o.starsInChunk.length;n+=1){const a=o.starsInChunk[n];r[n]=a?Ct(a)*J:0}e.push(r)}}function Gt(t,e,o){const r=it(t(),e());return Ut(r,o),r}var jt=500*J;function Xt(t,e,o,r){const n=Math.sqrt(t*t+e*e+o*o);if(n<=0||!Number.isFinite(n)){r.x=0,r.y=0,r.z=0;return}const a=Pt(n)*J/n;r.x=t*a,r.y=e*a,r.z=o*a}function $t(t,e,o,r,n,a,u,c){const s=Math.sqrt(t*t+e*e+o*o);if(s<=0||!Number.isFinite(s)||!Number.isFinite(r)){const m=-n,h=-a,d=-u;return m*m+h*h+d*d<=c}const i=r/s,l=t*i-n,f=e*i-a,p=o*i-u;return l*l+f*f+p*p<=c}function Yt(){return{frustum:{position:{x:0,y:0,z:0},forward:{x:0,y:0,z:-1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:Math.PI/4,aspect:1},cameraHelioKm:{x:0,y:0,z:0}}}function st(t){const e=Math.tan(t.frustum.fovYRadians*.5);return Xt(t.frustum.position.x,t.frustum.position.y,t.frustum.position.z,t.cameraHelioKm),{tanHalfV:e,maxDistSqKm:jt**2}}var Qt=256,Jt=320,Zt=`
