(function() {
	const Z = Symbol("Comlink.proxy"), dt = Symbol("Comlink.endpoint"), gt = Symbol("Comlink.releaseProxy"), z = Symbol("Comlink.finalizer"), y = Symbol("Comlink.thrown"), W = (t) => typeof t == "object" && t !== null || typeof t == "function", Q = /* @__PURE__ */ new Map([["proxy", {
		canHandle: (t) => W(t) && t[Z],
		serialize(t) {
