...
`,ya=Math.PI/180;function V(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function P(e,t){const a=Math.hypot(e[0],e[1],e[2]);return!Number.isFinite(a)||a<1e-9?t:[e[0]/a,e[1]/a,e[2]/a]}function ve(e,t,a,r){return[e[0]*t+a[0]*r,e[1]*t+a[1]*r,e[2]*t+a[2]*r]}var xa=[0,0,1];function Ca(e,t,a){const r=P(e,[0,0,1]),l=P(V(xa,r),[1,0,0]),n=P(V(r,l),[0,1,0]),i=Number.isFinite(t)?t*ya:0,s=P(ve(n,Math.cos(i),l,Math.sin(i)),n),m=P(V(r,s),l),c=Math.min(1,Math.max(.001,a)),f=Math.acos(c),o=P(ve(r,c,m,Math.sqrt(Math.max(0,1-c*c))),r),y=s;return{xAxis:y,yAxis:P(V(o,y),m),zAxis:o,inclinationRad:f}}function Ra(e,t,a){if(e.texture===null)return null;const{radius:r}=e,l=e.morphScale!==void 0?e.morphScale[1]:.5,n=Ca(t.lengthSq()>1e-12?[t.x,t.y,t.z]:[0,0,1],e.entry.positionAngleDeg,l),i=new q;i.quaternion.setFromRotationMatrix(new ke().makeBasis(new C(n.xAxis[0],n.xAxis[1],n.xAxis[2]),new C(n.yAxis[0],n.yAxis[1],n.yAxis[2]),new C(n.zAxis[0],n.zAxis[1],n.zAxis[2]))),a.add(i);const s=new ae(new Uint8Array([0,0,0,0]),1,1,re);s.needsUpdate=!0;const m={uMap:{value:s},uRadius:{value:r},uUvScale:{value:new Ge(pe,pe*l)},uIntensity:{value:fa*(e.galaxyBrightnessScale??1)},uBgLo:{value:ca},uBgHi:{value:da},uCenterFade:{value:ma},uEdgeFade:{value:ha}},c=new ze(r,96),f=new Ae({uniforms:m,vertexShader:Sa,fragmentShader:Aa,transparent:!0,depthWrite:!1,blending:1,side:2,toneMapped:!1}),o=new ye(c,f);o.name=`dso-disc-${e.entry.catalogId}`,o.raycast=()=>{},o.frustumCulled=!1,o.renderOrder=-15,i.add(o);const y=e.galaxyPalette?.colorBulge??[1,.95,.85],h=new We({map:ba(),color:new N(y[0],y[1],y[2]),transparent:!0,depthWrite:!1,blending:2,toneMapped:!1});h.opacity=ge;const F=new Ve(h),R=r*Math.min(.6,Math.max(.2,e.galaxyPalette?.bulgeRadiusRatio??.34))*2;F.scale.set(R,R,1),F.renderOrder=-14,a.add(F);let A="none",_=null,S=null,u=!1;const b=x=>{if(e.texture===null)return;const p=Ee(e.texture,x);if(p===null)return;if(S!==null){if(S.url===p)return;S.ac.abort(),S=null}const B=new AbortController;S={url:p,ac:B},Fe(p,B.signal).then(D=>{if(u||S===null||S.ac!==B){k(p);return}_!==null&&_!==p&&k(_),_=p,m.uMap.value=D,S=null}).catch(()=>{S!==null&&S.ac===B&&(S=null)})};return A="thumb",b("thumb"),{group:a,mesh:o,radius:r,scenePos:t,tick(x,p){o.frustumCulled=p>1,h.opacity=ge*Math.min(1,Math.max(0,(p-.15)/.85));const B=Ce(p),D=B==="none"?"thumb":B;D!==A&&(A=D,b(D))},dispose(){u=!0,S!==null&&(S.ac.abort(),S=null),c.dispose(),f.dispose(),h.dispose(),s.dispose(),_!==null&&(k(_),_=null)}}}function _a(e){if(e.radius<=0)return null;const{entry:t,shape:a}=e,r=Se(t),l=new C(r.x,r.y,r.z),n=new q;if(n.name=`dso-${t.catalogId}`,n.position.copy(l),a==="galaxy"&&e.texture?.projection==="flat-disc")return Ra(e,l,n);let i=n;if(a==="nebula"){const u=l.clone();u.lengthSq()<1e-12&&u.set(1,0,0),u.normalize();const b=new C().crossVectors(u,new C(0,0,1));b.lengthSq()<1e-6&&b.crossVectors(u,new C(1,0,0)),b.normalize();const x=b.multiplyScalar(Math.sqrt(1-ee*ee)).addScaledVector(u,ee).normalize(),p=new q;p.quaternion.setFromUnitVectors(new C(0,0,1),x),n.add(p),i=p}const s=new Ue(e.radius,24,16),m=new ae(new Uint8Array([0,0,0,0]),1,1,re);m.needsUpdate=!0;const c=a==="galaxy",f=e.texture!==null,o={uMap:{value:m},uTime:{value:0},uRadius:{value:e.radius},uSteps:{value:c?28:30},uExtinction:{value:c?2:3},uIntensity:{value:he},uDensity:{value:c?ua:1},uDrift:{value:c?sa:oa},uUsePalette:{value:f?0:1},uViewMix:{value:1},uZoom:{value:na},uWarp:{value:fe},uPalA:{value:new N(0,0,0)},uPalB:{value:new N(0,0,0)},uPalC:{value:new N(0,0,0)},uShapeMode:{value:0},uShapeWarp:{value:fe},uShapeFreq:{value:3},uShellMid:{value:0},uShellThick:{value:0},uClump:{value:.15},uBipolar:{value:0},uCstar:{value:0},uShapeSeed:{value:new C(0,0,0)},uBulgeStrength:{value:1},uBulgeRadiusRatio:{value:.2},uBar:{value:0},uArmCount:{value:0},uArmWinding:{value:0},uArmContrast:{value:1},uDustStrength:{value:0},uPositionAngle:{value:e.positionAngleRad??0},uColorBulge:{value:new N(0,0,0)},uColorArms:{value:new N(0,0,0)},uColorDust:{value:new N(0,0,0)},uMorphScale:{value:new C(1,1,1)}};if(c&&e.galaxyPalette!==void 0){const u=e.galaxyPalette;o.uBulgeStrength.value=u.bulgeStrength,o.uBulgeRadiusRatio.value=u.bulgeRadiusRatio,o.uArmCount.value=u.armCount,o.uArmWinding.value=u.armWinding,o.uArmContrast.value=u.armContrast,o.uDustStrength.value=u.dustStrength,o.uBar.value=u.bar??0,W(o.uColorBulge.value,u.colorBulge),W(o.uColorArms.value,u.colorArms),W(o.uColorDust.value,u.colorDust),o.uIntensity.value=u.intensity*la*(e.galaxyBrightnessScale??1),e.morphScale!==void 0&&o.uMorphScale.value.set(e.morphScale[0],e.morphScale[1],e.morphScale[2])}else if(!c&&!f&&e.nebulaPalette!==void 0){const u=e.nebulaPalette;W(o.uPalA.value,u.colorA),W(o.uPalB.value,u.colorB),W(o.uPalC.value,u.colorC),o.uIntensity.value=he*u.intensity}if(!c&&e.nebulaShape!==void 0){const u=e.nebulaShape;o.uShapeMode.value=u.mode,o.uShapeWarp.value=u.warp,o.uShapeFreq.value=u.freq,o.uShellMid.value=u.shellMid,o.uShellThick.value=u.shellThick,o.uClump.value=u.clump,o.uBipolar.value=u.bipolar,o.uPositionAngle.value=u.positionAngleRad,o.uMorphScale.value.set(u.morphScale[0],u.morphScale[1],u.morphScale[2]),o.uShapeSeed.value.set(u.seedOffset[0],u.seedOffset[1],u.seedOffset[2]),o.uCstar.value=e.cstarBright??0}!c&&e.brightnessScale!==void 0&&(o.uIntensity.value=o.uIntensity.value*e.brightnessScale);const y=new Ae({uniforms:o,vertexShader:Jt,fragmentShader:c?ra:aa,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1}),h=new ye(s,y);h.name=`dso-vol-${t.catalogId}`,h.raycast=()=>{},h.frustumCulled=!1,h.renderOrder=c?-15:-12,i.add(h);let F="none",R=null,A=null,_=!1;const S=u=>{if(e.texture===null)return;const b=Ee(e.texture,u);if(b===null)return;if(A!==null){if(A.url===b)return;A.ac.abort(),A=null}const x=new AbortController;A={url:b,ac:x},Fe(b,x.signal).then(p=>{if(_||A===null||A.ac!==x){k(b);return}R!==null&&R!==b&&k(R),R=b,o.uMap.value=p,A=null}).catch(()=>{A!==null&&A.ac===x&&(A=null)})};return f&&(F="thumb",S("thumb")),{group:n,mesh:h,radius:e.radius,scenePos:l,tick(u,b){if(o.uTime.value=o.uTime.value+u,h.frustumCulled=b>1,!c){const x=Math.min(1,Math.max(0,(b-1)/2));o.uSteps.value=Math.round(16+14*x);const p=G((30-b)/28);o.uViewMix.value=p**ia}if(f){const x=Ce(b),p=x==="none"?"thumb":x;p!==F&&(F=p,S(p))}},dispose(){_=!0,A!==null&&(A.ac.abort(),A=null),s.dispose(),y.dispose(),m.dispose(),R!==null&&(k(R),R=null)}}}function Ma(e,t){const a=je(e),r=a.layers.dsoReRooted,l=a.cameraThree,n=new q;n.name="dsoVolumeLayer",r.add(n),Zt(a.gl);const i=qe();let s=[];const m=new Map;let c=!1,f=0;const o={current:oe.getState().showDsoVolumes},y={current:performance.now()},h={position:{x:0,y:0,z:0},forward:{x:0,y:0,z:1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:1,aspect:1},F=new C,R=new C,A=new C,_=new C,S=()=>{n.visible=o.current&&m.size>0},u=()=>{et(l,h,F,R,A);const d=Je();d&&(h.position.x+=d.x,h.position.y+=d.y,h.position.z+=d.z),_.set(h.position.x,h.position.y,h.position.z)},b=d=>{const M=m.get(d);M!==void 0&&(n.remove(M.group),M.dispose(),m.delete(d),rt(d))},x=()=>{for(const d of[...m.keys()])b(d)},p=()=>{c||(x(),s=t.buildSpecs().filter(d=>d.radius>0).map(d=>{const M=Se(d.entry);return{id:d.entry.catalogId,scenePos:new C(M.x,M.y,M.z),radius:d.radius,spec:d}}),S())},B=()=>{u();const d=[],M=[];for(const v of s){const E=v.scenePos.distanceToSquared(_),U=Math.sqrt(E);if(U<=v.radius){M.push(v);continue}const Te=v.radius/U,Ie=v.spec.visibilityFactor??1;Te<(m.has(v.id)?.00105:.0015)*Ie||Ne(v.scenePos,h.position,h.forward,h.right,h.up,h.fovYRadians,h.aspect)&&d.push({cand:v,distSq:E})}d.sort((v,E)=>v.distSq-E.distSq);const T=new Map;for(const v of M)T.set(v.id,v);for(const{cand:v}of d){if(T.size>=128)break;T.set(v.id,v)}for(const v of[...m.keys()])T.has(v)||b(v);let I=0;for(const[v,E]of T){if(m.has(v))continue;if(I>=4)break;const U=_a(E.spec);U!==null&&(n.add(U.group),m.set(v,U),E.spec.shape==="galaxy"&&at(v),I+=1)}S()};Promise.resolve().then(p).catch(d=>console.error("[createDsoVolumeMount] rebuildCandidates failed:",d));const D=oe.subscribe(d=>({showDsoVolumes:d.showDsoVolumes}),d=>{o.current=d.showDsoVolumes,S()},{equalityFn:Pe}),Le=i.getQueryCache().subscribe(d=>{(ie(d,"openngc-dso-catalog")||ie(d,"custom-objects-catalog"))&&p()}),De=t.subscribeReady?.(p);return{onFrame:d=>{if(!o.current||s.length===0)return;const M=performance.now(),T=Math.min(ga,Math.max(0,(M-y.current)/1e3));if(y.current=M,f+=1,f%6===0&&B(),m.size!==0){u();for(const I of m.values()){const v=I.scenePos.distanceTo(_),E=I.radius>0?v/I.radius:Number.POSITIVE_INFINITY;I.tick(T,E)}}},dispose:()=>{c=!0,D(),Le(),De?.(),x(),r.remove(n)}}}function wa(e){return(e.openNgcTypeRaw==null||e.openNgcTypeRaw==="G")&&e.parentGalaxyId==null}function be(e,t){const a=$e(e.distPc,e.majAxArcmin);if(a<=0)return null;const r=_e(e.catalogId);return{entry:e,shape:"nebula",radius:a,texture:t,nebulaPalette:t===null?pt(e,r):void 0,nebulaShape:Nt(e,r),brightnessScale:Gt(e.vMag),cstarBright:e.type==="planetary_nebula"?Ut(e.cstarVMag):0,visibilityFactor:Wt(e.vMag)}}function Fa(e,t){if(!wa(e))return null;const a=xe(e);if(a===null||a.discRadiusSu<=0)return null;const r=it(e.catalogId)?ot(e):St(e,_e(e.catalogId));return{entry:e,shape:"galaxy",radius:t?.projection==="flat-disc"?Ke(a.discRadiusSu):a.discRadiusSu,texture:t,galaxyPalette:r,morphScale:a.morphScale,positionAngleRad:a.positionAngleRad,galaxyBrightnessScale:yt(e.surfBrightness)}}function Ba(e){let t={},a={};return Ma(e,{buildSpecs:()=>{const l=[];for(const n of Qe()){const i=Ye(n.catalogId);if(n.type==="nebula"||n.type==="planetary_nebula"){const s=be(n,t[i]??null);s!==null&&l.push(s)}else if(n.type==="star_cluster"&&n.openNgcTypeRaw==="Cl+N"){const s=be(n,t[i]??null);s!==null&&l.push(s)}else if(n.type==="galaxy"){const s=Fa(n,a[i]??null);s!==null&&l.push(s)}}return l},subscribeReady:l=>{let n=!1;return jt().then(i=>{n||(t=i,l())}),Ze().then(i=>{n||(a=i,l())}),()=>{n=!0}}})}var ja=Xe(Ba,"present.hud");export{ja as DsoVolumesMountR3f};
