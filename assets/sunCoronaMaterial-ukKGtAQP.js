import{Ht as z,Rt as ye,wt as Pe}from"./babylon-postprocess-vendor-CPXB9tym.js";import{B as be,C as we,Q as ie,R as Ce,bt as E,lt as W,o as ne,p as j,s as Me,ut as ke,yt as ze}from"./three-vendor-BZgPQKFQ.js";import{Bo as Te,Po as Fe,So as Ie,Vn as se,Wo as Ae,_o as le,bn as Re,gn as ue,go as _e,ho as Ee}from"./index-Cus0Ju13.js";import{u as We}from"./babylon-vendor-Cyt56fsS.js";var Z=new WeakMap;function Bt(e,t){Z.set(e,t)}function Lt(e){Z.delete(e)}function De(e){if(e.engineKind!=="babylon")throw new Error("asBabylon: SceneHost is not a Babylon implementation");const t=Z.get(e);if(!t)throw new Error("asBabylon: missing Babylon extras (host not fully initialized?)");return t}var ce={current:null};function He(e,t,n){return n&&t&&Ae(e,t.position.x,t.position.y,t.position.z),e}function Nt(e,t,n){if(n&&t){const r=e;r.x+=t.position.x,r.y+=t.position.y,r.z+=t.position.z}return e}function Vt(e,t){return e.getWorldPosition(t),He(t,ce.current,!0),t}function Be(e,t,n,r,o){e.updateMatrixWorld(!0),e.getWorldPosition(n),t.position.x=n.x,t.position.y=n.y,t.position.z=n.z,e.getWorldDirection(n),r.setFromMatrixColumn(e.matrixWorld,0).normalize(),o.setFromMatrixColumn(e.matrixWorld,1).normalize(),t.forward.x=n.x,t.forward.y=n.y,t.forward.z=n.z,t.right.x=r.x,t.right.y=r.y,t.right.z=r.z,t.up.x=o.x,t.up.y=o.y,t.up.z=o.z,t.fovYRadians=Ce.degToRad(e.fov),t.aspect=e.aspect}function Le(e,t,n,r,o){Be(e,t,n,r,o);{const a=ce.current;a&&(t.position.x-=a.position.x,t.position.y-=a.position.y,t.position.z-=a.position.z)}}var Ne=new z(0,0,-1),Ve=new z(1,0,0),Oe=new z(0,1,0),B=new z,L=new z,N=new z,V=new z;function qe(e,t,n){e.computeWorldMatrix(),e.getWorldMatrix().getTranslationToRef(B),n.position.x=B.x,n.position.y=B.y,n.position.z=B.z;{const[o,a,i]=t.getFloatingOrigin();n.position.x+=o,n.position.y+=a,n.position.z+=i}e.getDirectionToRef(Ne,L),e.getDirectionToRef(Ve,N),e.getDirectionToRef(Oe,V),n.forward.x=L.x,n.forward.y=L.y,n.forward.z=L.z,n.right.x=N.x,n.right.y=N.y,n.right.z=N.z,n.up.x=V.x,n.up.y=V.y,n.up.z=V.z,n.fovYRadians=e.fov;const r=e.getEngine();n.aspect=r.getRenderWidth()/Math.max(1,r.getRenderHeight())}function Ot(e){const t=e.replace(/^#/,""),n=parseInt(t,16);return Number.isFinite(n)?[Math.floor(n/65536)%256,Math.floor(n/256)%256,n%256]:[0,0,0]}function Ue(e){if(!e||typeof e!="string")return[1,1,1];const t=e.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return t?[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]:[1,1,1]}function qt(e){return Math.max(0,Math.min(255,Math.round(e)))}function O(e,t=1,n=1){const[r,o,a]=Ue(e),i=Math.max(.15,Math.min(1,t));return[r*i,o*i,a*i,n]}var R={star1:O("#fff3a8",1),star2:O("#f5c238",1),star3:O("#e07b1a",1),star4:O("#a8380c",1)},J=4,Ut=64*J,je=-25,Ke=500,Ge=.01;function fe(e){return Math.max(0,Math.min(1,e))}function Xe(e){return e?.size!=null&&Number.isFinite(e.size)?fe(e.size):.5}function $e(e){return .08+.76*fe((e-.99)/.01)**3}function jt(e){return(e?_e(e,se(e)):le)*$e(Xe(e))*J}function Q(e,t){let n=t;for(;e[n]!==n;)n=e[n];let r=t;for(;r!==n;){const o=e[r];e[r]=n,r=o}return n}function Ye(e,t,n){const r=Q(e,t),o=Q(e,n);r!==o&&(e[r]=o)}function re(e,t,n){return`${e},${t},${n}`}function Kt(e,t){const n=e.length,r=Array.from({length:n},(s,u)=>u),o=t,a=new Map;for(let s=0;s<n;s+=1){const u=e[s],f=re(Math.floor(u.x/o),Math.floor(u.y/o),Math.floor(u.z/o));a.has(f)||a.set(f,[]),a.get(f).push(s)}const i=t*t;for(let s=0;s<n;s+=1){const u=e[s],f=Math.floor(u.x/o),p=Math.floor(u.y/o),h=Math.floor(u.z/o);for(let d=-1;d<=1;d+=1)for(let m=-1;m<=1;m+=1)for(let x=-1;x<=1;x+=1){const g=re(f+d,p+m,h+x),P=a.get(g);if(P)for(const b of P){if(b<=s)continue;const w=e[b],M=w.x-u.x,C=w.y-u.y,y=w.z-u.z;M*M+C*C+y*y<i&&Ye(r,s,b)}}}const c=new Map;for(let s=0;s<n;s+=1){const u=Q(r,s);c.has(u)||c.set(u,[]),c.get(u).push(s)}const l=[];for(let s=0;s<n;s+=1)l.push(void 0);for(const s of c.values())s.length<=1||(s.sort((u,f)=>u-f),s.forEach((u,f)=>{f>0&&(l[u]={x:0,y:f*je})}));return l}function Qe(){const e=[];for(let t=0;t<Ke;t+=1){const n=Ee(t*.7%360,t*.3%180-90);n!=null&&e.push(n)}return e}function Ze(){const e=Qe(),t=e.length,n=Fe,r=new Float32Array(t*3);return e.forEach((o,a)=>{r[a*3]=o.x*n,r[a*3+1]=o.y*n,r[a*3+2]=o.z*n}),{abbr:"_bootstrap",positions:r,sizes:new Float32Array(t).fill(le*J),colors:new Float32Array(t*3).fill(1),warm:new Float32Array(t).fill(Ge),brightness:new Float32Array(t).fill(1),starsInChunk:[]}}var Je={raMin:0,raMax:360,decMin:-90,decMax:90},Gt={chunks:[],namedStarsInView:[]};function Xt(e,t){return e===0&&t!=="success"}function me(e,t){return e.chunks.length>0?e.chunks:t==="idle"||t==="loading"?[Ze()]:[]}function $t(e,t){const n=me(e,t),r=n.slice(0,3).map(o=>o.abbr).join(",");return n.length===0?{syntheticKind:"empty",chunkAbbrevSample:r}:n.length===1&&n[0]?.abbr==="_bootstrap"?{syntheticKind:"bootstrap",chunkAbbrevSample:r}:n.some(o=>o.abbr==="_fallback")?{syntheticKind:"fallback",chunkAbbrevSample:r}:{syntheticKind:"real",chunkAbbrevSample:r}}function oe(e,t){return t.current===e.current}function Yt(e,t,n,r,o){e.onerror=a=>{oe(t,n)||(r("error"),o(a.message??"Starfield worker failed"))},e.onmessageerror=()=>{oe(t,n)||(r("error"),o("Starfield worker message error"))}}function et(e,t,n,r,o,a,i){const{runId:c,...l}=e;c===t.current&&(n.current=c,r.current=l.starsInView,o({chunks:l.chunks,namedStarsInView:l.namedStarsInView}),a("ready"),i(null))}function Qt(e,t,n,r,o){e.processStarfield({runId:t,catalog:n,maxDistanceLevel:r,bounds:Je,raInHours:!1}).then(a=>{et(a,o.runIdRef,o.lastSuccessfulRunIdRef,o.starsInViewRef,o.setStarData,o.setStarfieldStatus,o.setErrorMessage)}).catch(a=>{t===o.runIdRef.current&&(o.setStarfieldStatus("error"),o.setErrorMessage(a instanceof Error?a.message:"Starfield worker failed"))})}function tt(e,t){t.length=0;for(const n of e){const r=new Float32Array(n.starsInChunk.length);for(let o=0;o<n.starsInChunk.length;o+=1){const a=n.starsInChunk[o];r[o]=a?se(a):0}t.push(r)}}function nt(e,t,n){const r=me(e(),t());return tt(r,n),r}function rt(e,t,n,r){const o=Math.sqrt(e*e+t*t+n*n);if(o<=0||!Number.isFinite(o)){r.x=0,r.y=0,r.z=0;return}const a=Ie(o)/o;r.x=e*a,r.y=t*a,r.z=n*a}function ot(e,t,n,r,o,a,i,c){const l=Math.sqrt(e*e+t*t+n*n);if(l<=0||!Number.isFinite(l)||!Number.isFinite(r)){const h=-o,d=-a,m=-i;return h*h+d*d+m*m<=c}const s=r/l,u=e*s-o,f=t*s-a,p=n*s-i;return u*u+f*f+p*p<=c}function at(){return{frustum:{position:{x:0,y:0,z:0},forward:{x:0,y:0,z:-1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:Math.PI/4,aspect:1},cameraHelioPc:{x:0,y:0,z:0}}}function he(e){const t=Math.tan(e.frustum.fovYRadians*.5);return rt(e.frustum.position.x,e.frustum.position.y,e.frustum.position.z,e.cameraHelioPc),{tanHalfV:t,maxDistSqPc:500**2}}var it=256,st=320,lt=`
...
`;function Y(e){return new j(e[0],e[1],e[2])}function _t(){return{warm:Y(R.star3),hot:Y(R.star2),flare:Y(R.star1)}}function nn(e){return e==null||Array.isArray(e)||!(e instanceof W)?!1:e.userData.cosmosiveSunCorona===!0}function rn(e){const t=_t(),n={warm:e?.warm??t.warm,hot:e?.hot??t.hot,flare:e?.flare??t.flare},r={uTime:{value:0},uIntensity:{value:1.4},uPaletteWarm:{value:n.warm.clone()},uPaletteHot:{value:n.hot.clone()},uPaletteFlare:{value:n.flare.clone()}},o=new W({uniforms:r,vertexShader:At,fragmentShader:Rt,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1});return o.userData.cosmosiveSunCorona=!0,o}export{Bt as A,Ue as C,Vt as D,Nt as E,ce as O,Ot as S,Le as T,Kt as _,Jt as a,O as b,pt as c,Gt as d,$t as f,me as g,Xt as h,en as i,Lt as j,De as k,at as l,Yt as m,nn as n,Zt as o,Qt as p,tn as r,zt as s,rn as t,nt as u,jt as v,qe as w,qt as x,R as y};
