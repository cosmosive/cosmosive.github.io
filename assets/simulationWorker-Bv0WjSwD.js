(function() {
	...
	const s2 = Symbol("Comlink.proxy"), Qn = Symbol("Comlink.endpoint"), Bn = Symbol("Comlink.releaseProxy"), st = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), i2 = (t) => typeof t == "object" && t !== null || typeof t == "function", a2 = new Map([["proxy", {
	...
	function it(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function r(o) {
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, d] = m1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), d), i === "RELEASE" && (n.removeEventListener("message", r), c2(n), st in t && typeof t[st] == "function" && t[st]());
			}).catch((h) => {
				const [l, d] = m1({
	...
	function at(t, n, e = [], r = function() {}) {
		...
		const s = new Proxy(r, {
			...
			apply(i, a, c) {
				...
				if (u === Qn) return O0(t, n, { type: "ENDPOINT" }).then(P0);
	...
	}, r3 = 149597870.7, o3 = 648e3 / Math.PI, f2 = 1500;
	f2 / 15;
	100 / o3;
	f2 + 500;
	const ct = 1721545, ut = 3181545;
	function s3(t) {
		return {
			name: t.name,
			type: t.type,
	...
	const d2 = Object.fromEntries(Object.entries(e3).map(([t, n]) => [t, s3(n)]));
	D.SUN, D.MERCURY, D.VENUS, D.EARTH, D.MARS, D.JUPITER, D.SATURN, D.URANUS, D.NEPTUNE, D.PLUTO;
	const lt = d2[D.EARTH]?.radiusKm ?? 6371, ht = d2[D.SUN]?.radiusKm ?? 696340, i3 = lt / ht, s1 = .04;
	lt / s1;
	s1 / lt / (15 / r3);
	function a3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : t / i3 * s1;
	}
	function c3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : a3(t / ht);
	}
	c3(ht);
	var v1 = Gn({
		AU_PER_LY: () => M2,
		...
		MoonPhase: () => Ot,
		MoonQuarter: () => K2,
		NextGlobalSolarEclipse: () => He,
		NextLocalSolarEclipse: () => Be,
		NextLunarApsis: () => Ae,
		NextLunarEclipse: () => $e,
		NextMoonNode: () => Ye,
		NextMoonQuarter: () => ie,
		...
		SearchMaxElongation: () => pe,
		SearchMoonNode: () => bn,
		SearchMoonPhase: () => p1,
		SearchMoonQuarter: () => Y2,
		SearchPeakMagnitude: () => _e,
		...
		TransitInfo: () => Un,
		Vector: () => P,
		VectorFromHorizon: () => xe,
		VectorFromSphere: () => K1,
		VectorObserver: () => G3,
		e_tilt: () => R0
	});
	const D1 = 173.1446326846693, L = 149597870.69098932, M2 = 63241.07708807546, p = .017453292519943295, ft = .26179938779914946, b = 57.29577951308232, dt = 3.819718634205488, u3 = 71492, l3 = 66854, h3 = 69911, f3 = 1821.6, d3 = 1560.8, M3 = 2631.2, S3 = 2410.3, S2 = 365.24217, p2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, _2 = 10800 * 60, p3 = 2 * _2, A2 = 7292115e-11, _3 = _2 / Math.PI, A3 = -.17 - 5 * Math.log10(_3), I1 = 29.530588, P1 = 24 * 3600, y3 = P1 * 1e3, y2 = .9972695717592592, i1 = 695700, E2 = i1 / L, s0 = .996647180302104, b0 = s0 * s0, M0 = 6378.1366, E3 = M0 / L, w3 = M0 * s0, w2 = 6371, g3 = w2 + 88, R3 = 1738.1 / L, j = 1737.4, g2 = 1736, x3 = g2 / L, m3 = 34 / 60, Mt = 81.30056, a1 = .0002959122082855911, St = 4912547451450812e-26, pt = 7243452486162703e-25, c1 = 8887692390113509e-25, _t = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, J0 = 1.292024916781969e-8, $0 = 1.524358900784276e-8, v3 = 218869976542597e-26, z1 = c1 / Mt;
	function At(t) {
		switch (t) {
	...
	function R2(t) {
		const n = D3.indexOf(t);
		return n >= 0 ? I3[n] : null;
	}
	function U1(t) {
		const n = R2(t);
	...
	var g0 = class ot {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - p2.getTime()) / e, this.tt = m2(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(p2.getTime() + n * e), this.ut = n, this.tt = m2(this.ut);
				return;
			}
	...
	function R0(t) {
		if (!L1 || Math.abs(L1.tt - t.tt) > 1e-6) {
			const n = L3(t), e = v2(t), r = e + n.deps / 3600;
			L1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function x0(t) {
		...
		var f0 = U(.19833 + .05611 * n), Xt = U(.27869 + .04508 * n), Zt = U(.16827 - .36903 * n), t2 = U(.34734 - 5.37261 * n), n2 = U(.10498 - 5.37899 * n), rt = U(.42681 - .41855 * n), i4 = U(.14943 - 5.37511 * n);
		for (I = .84 * f0 + .31 * Xt + 14.27 * Zt + 7.26 * t2 + .28 * n2 + .24 * rt, k = 2.94 * f0 + .31 * Xt + 14.27 * Zt + 9.34 * t2 + 1.12 * n2 + .83 * rt, N = -6.4 * f0 - 1.89 * rt, B = .21 * f0 + .31 * Xt + 14.27 * Zt - 88.7 * t2 - 15.3 * n2 + .24 * rt - 1.86 * i4, G = I - N, _ = -3332e-9 * U(.59734 - 5.37261 * n) - 539e-9 * U(.35498 - 5.37899 * n) - 64e-9 * U(.39943 - 5.37511 * n), R = n0 * H0(.60643382 + 1336.85522467 * n - 313e-8 * d) + I / w0, w = n0 * H0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = n0 * H0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * H0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, z = n0 * H0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (l0(0, h, 1), l0(1, h, Math.cos(c) * u), h0(0, h, 0), h0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) et(A0(l - 1, h), D0(l - 1, h), A0(1, h), D0(1, h), (T, C) => (l0(l, h, T), h0(l, h, C)));
		...
		function $n(T, C, V, J) {
			for (var Q = {
				...
				V,
				J
			], y0 = 1; y0 <= 4; ++y0) I0[y0] !== 0 && et(Q.x, Q.y, A0(I0[y0], y0), D0(I0[y0], y0), (e2, o1) => (Q.x = e2, Q.y = o1));
			return Q;
		}
		function S(T, C, V, J, Q, I0, y0, e2) {
			var o1 = $n(Q, I0, y0, e2);
		...
		let a4 = (1.000002708 + 139.978 * _) * (18519.699999999997 + E) * Math.sin(i) - 6.24 * Math.sin(3 * i) + A;
		return {
			geo_eclip_lon: n0 * H0((R + M / w0) / n0),
			geo_eclip_lat: Math.PI / (180 * 3600) * a4,
			distance_au: w0 * E3 / (.999953253 * g)
		};
	}
	var P2 = class {
	...
	function O3(t) {
		...
		return new P2(b * m + B, w + N, b * c, b * a, u, G);
	}
	function z2(t, n) {
		return [
	...
	function b3(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = o > 0 ? 90 : -90, c = Math.abs(o) - w3;
		else {
	...
	function F1(t, n, e, r, o) {
		let s = y(t);
		K0(n), v(e), v(r);
		const i = Math.sin(n.latitude * p), a = Math.cos(n.latitude * p), c = Math.sin(n.longitude * p), u = Math.cos(n.longitude * p), h = Math.sin(r * p), l = Math.cos(r * p), d = Math.sin(e * ft), _ = Math.cos(e * ft);
		let M = [
			a * u,
			a * c,
			i
		...
		if (o) {
			...
			if (G -= A0, A0 > 0 && G > 3e-4) {
				const D0 = Math.sin(G * p), l0 = Math.cos(G * p), h0 = Math.sin(o0 * p), et = Math.cos(o0 * p), U = [];
				for (let f0 = 0; f0 < 3; ++f0) U.push((x[f0] - et * R[f0]) / h0 * D0 + R[f0] * l0);
				N = Math.hypot(U[0], U[1]), N > 0 ? (Y = dt * Math.atan2(U[1], U[0]), Y < 0 && (Y += 24)) : Y = 0, u0 = b * Math.atan2(U[2], N);
			}
		}
		return new C2(B, 90 - G, Y, u0);
	}
	function K0(t) {
	...
	function u1(t, n, e, r, o) {
		K0(e), T1(r), T1(o);
		const s = y(n), i = L2(s, e), a = e0(t, s, o), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
	...
	function $3(t, n, e) {
		const r = y(t);
		let o = Et(n, S0(r)).pos;
		return e || (o = b1(o, r, O.Into2000)), wt(o, r);
	}
	function H3(t, n, e) {
		const r = y(t), o = Et(n, S0(r)), s = new F(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
		return e ? s : V3(s, r, O.Into2000);
	}
	function G3(t, n) {
		const e = S0(t.t);
		let r = [
		...
		return n || (r = G0(r, t.t, O.From2000), r = Q0(r, t.t, O.From2000)), b3(r, e);
	}
	function Q3(t, n) {
	...
	function a0(t) {
		const n = y(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = G0(C3(n, [
	...
	function J1(t) {
		const n = y(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = wt(Q0(D2(s.mobl, o), n, O.From2000), n), a = s.tobl * p, c = Rt(i, Math.cos(a), Math.sin(a));
	...
	function j0(t, n) {
		const e = n.tt / Y0;
		return It(V2(z0(t[vt], e, !0), z0(t[Dt], e, !1), z0(t[$1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / Y0, r = z0(t[vt], e, !0), o = z0(t[Dt], e, !1), s = z0(t[$1], e, !1), i = mt(t[vt], e), a = mt(t[Dt], e), c = mt(t[$1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, E = V2(r, o, s), g = [
			_ / Y0,
			M / Y0,
			A / Y0
		];
		return new N0(n, It(E), It(g));
	}
	function H1(t, n, e, r) {
	...
	const Pt = 51, q3 = 29200, W0 = 146, p0 = 201, T0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function Ut(t) {
		const n = K3(t), e = new M1(n.tt), r = n.r.add(e.Sun.r), o = n.v.add(e.Sun.v), s = e.Acceleration(r);
		return new F2(e, new zt(n.tt, r, o, s));
	}
	function j3(t, n) {
		const e = T0[0][0];
		if (n < e || n > T0[Pt - 1][0]) return null;
		const r = J2((n - e) / q3, Pt - 1);
		if (!t[r]) {
			const s = t[r] = [];
			s[0] = Ut(T0[r]).grav, s[p0 - 1] = Ut(T0[r + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < p0 - 1; ++i) s[i] = Nt(a += W0, s[i - 1]).grav;
			a = s[p0 - 1].tt;
			var o = [];
			for (o[p0 - 1] = s[p0 - 1], i = p0 - 2; i > 0; --i) o[i] = Nt(a -= W0, o[i + 1]).grav;
			for (i = p0 - 2; i > 0; --i) {
				const c = i / (p0 - 1);
	...
	function Lt(t, n) {
		...
		const s = j3(Y3, t.tt);
		if (s) {
			const i = J2((t.tt - s[0].tt) / W0, p0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = X0(t.tt - a.tt, a.r, a.v, u), l = Tt(t.tt - a.tt, a.v, u), d = X0(t.tt - c.tt, c.r, c.v, u), _ = Tt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
			e = h.mul(1 - M).add(d.mul(M)), r = l.mul(1 - M).add(_.mul(M));
		} else {
			let i;
			t.tt < T0[0][0] ? i = $2(T0[0], t.tt, -W0) : i = $2(T0[Pt - 1], t.tt, +W0), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
	...
	function c0(t, n) {
		...
		if (t === f.EMB) {
			const i = j0(q.Earth, e), a = a0(e), c = 1 + Mt;
			return new P(i.x + a.x / c, i.y + a.y / c, i.z + a.z / c, e);
		}
		if (t === f.SSB) return B3(e);
		const s = U1(t);
	...
	function H(t, n, e, r) {
		...
		for (;;) {
			...
			let d = U3(n, e, .5), _ = d.ut - n.ut;
			if (Math.abs(_) < s) return d;
			l ? c = t(d) : l = !0;
			let M = ee(d.ut, e.ut - d.ut, i, c, a);
			if (M) {
				let A = y(M.t), E = t(A);
				if (M.df_dt !== 0) {
	...
	function q1(t, n) {
		...
		if (t === f.Sun) a = A3 + 5 * Math.log10(c);
		else if (t === f.Moon) a = se(o, u, c);
		else if (t === f.Saturn) {
			const l = oe(o, u, c, i, e);
	...
	function Y2(t) {
		let n = Ot(t), e = (Math.floor(n / 90) + 1) % 4, r = p1(90 * e, t, 10);
		if (!r) throw "Cannot find moon quarter";
		return new K2(e, r);
	}
	function ie(t) {
		return Y2(new Date(t.time.date.getTime() + 6 * y3));
	}
	var j2 = class {
		constructor(t, n, e) {
	...
	function ue(t, n, e, r, o, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = ce(t), a = W2(n.height - s);
		return X2(t, n, e, r, o, i, ae(n, s) - m3 * a.density);
	}
	function le(t, n, e, r, o, s) {
	...
	function kt(t, n, e, r, o, s, i) {
		if (s < 0 && i >= 0) return new he(r, o, s, i);
	...
	function Me(t, n, e) {
		const r = y(n), o = N2(r), s = u1(t, r, e, !0, !0);
	...
	function Ee(t, n) {
		...
		const e = .25 * i0[t].OrbitalPeriod, r = sn(t, n.time.AddDays(e));
	...
	function xe(t, n, e) {
		n = y(n);
		const r = an(t.lon);
		return K1(new B0(t.lat + cn(e, t.lat), r, t.dist), n);
	}
	function A1(t, n) {
		let e;
	...
	function Le(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Jt || (Jt = j1(new g0(-45655.74141261017)), _n = new g0(0));
		const e = K1(new B0(n, 15 * t, 1), _n), r = bt(y1(Jt, e)), o = 10 / 240, s = o / 15;
		for (let i of Ue) {
	...
	function E1(t, n, e, r) {
		...
		return new Ce(n, o, L * Math.hypot(s, i, a), +i1 - (1 + o) * (i1 - t), -i1 + (1 + o) * (i1 + t), e, r);
	}
	function X1(t) {
		const n = e0(f.Sun, t, !0), e = new P(-n.x, -n.y, -n.z, n.t);
		return E1(g3, t, a0(t), e);
	}
	function En(t) {
	...
	function $t(t, n) {
		const e = L2(t, n), r = e0(f.Sun, t, !0), o = a0(t), s = new P(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
	...
	function ke(t) {
		const e = H((r) => Ht(X1, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return X1(e);
	}
	function be(t) {
		const e = H((r) => Ht(En, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Moon shadow time.";
		return En(e);
	}
	function Ve(t, n, e) {
		const o = H((s) => Oe(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function gn(t, n) {
		const e = new P(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = wn(Math.asin(E2 / e.Length()), Math.asin(x3 / n.Length()), N1(n, e) * p);
	...
	function Rn(t) {
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				const i = ke(o);
				if (i.r < i.p + j) {
					let a = X.Penumbral, c = 0, u = 0, h = 0, l = Gt(i.time, i.p + j, 200);
					return i.r < i.k + j && (a = X.Partial, h = Gt(i.time, i.k + j, l), i.r + j < i.k ? (a = X.Total, c = 1, u = Gt(i.time, i.k - j, h)) : c = wn(j, i.k, i.r)), new yn(a, c, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function Ge(t, n) {
		...
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = tt(n, 1, zn, s, t.time), h = tt(n, -1, zn, t.time, i), l = mn(t.k)) : l = X.Partial;
	...
	function Cn(t, n) {
		...
		for (;;) {
			...
			if (n1(t, i) < e) {
				const a = Ve(t, o, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-r), u = Ln(t, o, c, a.time, -1), h = a.time.AddDays(+r), l = Ln(t, o, a.time, h, 1), d = 60 * n1(t, a.time);
	...
	function Xe(t, n, e, r) {
		...
		let a, c;
		return e === f.Earth && r === f.Moon ? (a = new F(0, 0, 0, 0, 0, 0, o), c = h1(o)) : (a = B1(e, o), c = B1(r, o)), Vn(t, a, s, c, i);
	}
	...
	var Ze = class t0 {
		constructor(n, e, r) {
			...
			const s = [];
			this.curr = new Fn(o, t0.CalcSolarSystem(o), s);
		...
		Update(n) {
			...
			if (r === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = X0(r, a.r, a.v, u), c.v = Tt(r, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = W(r, n.tt, f.Mercury, St), e[f.Venus] = W(r, n.tt, f.Venus, pt), e[f.Earth] = W(r, n.tt, f.Earth, c1 + z1), e[f.Mars] = W(r, n.tt, f.Mars, _t), e[f.Jupiter] = W(r, n.tt, f.Jupiter, V0), e[f.Saturn] = W(r, n.tt, f.Saturn, F0), e[f.Uranus] = W(r, n.tt, f.Uranus, J0), e[f.Neptune] = W(r, n.tt, f.Neptune, $0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new N0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = K.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, St), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + z1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, _t), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, V0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, J0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, $0);
		}
	...
	const { MakeTime: y4, SearchRiseSet: E4, Body: w4, Observer: t4 } = v1;
	new t4(40.7128, -74.006, 10);
	const { Body: r0 } = v1;
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: m4, CombineRotation: v4, MakeRotation: D4 } = v1;
	Math.PI / (180 * 3600);
	const { HelioState: P4 } = v1, n4 = 86400;
	function e4(t) {
	...
	function Jn(t, n) {
		...
		switch (e.type) {
			...
			case "seek": {
				...
				const r = e.jd;
				let o = r;
				(o < 1721545 || o > 3181545) && (console.warn(`[kernel/seek] JD ${o} outside supported range [${ct}, ${ut}] (years 0-4000 AD); clamping.`), o = Math.max(ct, Math.min(ut, o)));
				const s = {
					...t,
					jd: o
				}, i = [{
			...
			case "step": {
				...
				const o = t.jd + t.speed * r / n4, s = Math.max(ct, Math.min(ut, o)), i = {
					...t,
					jd: s
				}, a = [{
					type: "tick",
	...
	function s4(t) {
		...
		if (t.type === "time") {
			const { state: n, events: e } = Jn(Z, t.cmd);
			Z = n, Yt({
				type: "workerTick",
				state: Z,
				events: e
