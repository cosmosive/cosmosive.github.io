import{G as ae,V as ie,Y as te}from"./src-CU7t4spL.js";import{Y as xe,o as ye,t as Pe,w as we}from"./src--Dj6uCWZ.js";import{t as se}from"./activeGameplayHost-Dtma4eUw.js";import{t as ke}from"./skyLightStore-BfXJGTVl.js";import{t as fe}from"./activeOriginScenePos-DI3XOiL2.js";import{Dt as V,G as be,_ as G,d as Q,f as Me,ht as Fe,k as Ce,mt as K,rt as ze}from"./three-vendor-DtGC8FGl.js";import{Gn as Ae,Kt as Te,it as Re}from"./index-BRqrMmr0.js";import{t as me}from"./r3fHostExtras-BxsX4C09.js";import{t as _e}from"./combatFrustum-BN9fbl_3.js";var oe=new Map;function It(e,t){oe.set(e,t)}function Dt(e){oe.delete(e)}function Et(e,t,o){let n=null;for(const r of oe.values()){const a=r(e,t,o);a!=null&&Number.isFinite(a)&&a>=0&&(n==null||a<n)&&(n=a)}return n}var E={effectiveSpeedKmPerS:0,proximityThrottle:1,nearestBodySurfaceDistSu:null,viewpointScenePosX:0,viewpointScenePosY:0,viewpointScenePosZ:0};function Lt(e){e.effectiveSpeedKmPerS!==void 0&&(E.effectiveSpeedKmPerS=e.effectiveSpeedKmPerS),e.proximityThrottle!==void 0&&(E.proximityThrottle=e.proximityThrottle),e.nearestBodySurfaceDistSu!==void 0&&(E.nearestBodySurfaceDistSu=e.nearestBodySurfaceDistSu),e.viewpointScenePosX!==void 0&&(E.viewpointScenePosX=e.viewpointScenePosX),e.viewpointScenePosY!==void 0&&(E.viewpointScenePosY=e.viewpointScenePosY),e.viewpointScenePosZ!==void 0&&(E.viewpointScenePosZ=e.viewpointScenePosZ)}function Wt(e,t){return e.getWorldPosition(t),t}function Nt(e){if(typeof e!="string"||!/^#?[0-9a-fA-F]{6}$/.test(e))return[0,0,0];const t=e.replace(/^#/,""),o=parseInt(t,16);return Number.isFinite(o)?[Math.floor(o/65536)%256,Math.floor(o/256)%256,o%256]:[0,0,0]}function Ie(e){if(!e||typeof e!="string")return[1,1,1];const t=e.replace(/^#/,"").match(/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/);return t?[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]:[1,1,1]}function Vt(e){return Math.max(0,Math.min(255,Math.round(e)))}function Bt(e,t,o){return[e[0]+(t[0]-e[0])*o,e[1]+(t[1]-e[1])*o,e[2]+(t[2]-e[2])*o]}function H(e,t=1,o=1){const[n,r,a]=Ie(e),c=Math.max(.15,Math.min(1,t));return[n*c,r*c,a*c,o]}function De(e,t,o,n,r){r.x=0,r.y=0,r.z=0;const{x:a,y:c,z:s,vx:l,vy:i,vz:u}=e;if(a==null||c==null||s==null||l==null||i==null||u==null)return r;const f=Math.hypot(a,c,s);if(f<=0)return r;const v=Math.hypot(t,o,n);if(v<=0)return r;const p=a/f,g=c/f,d=s/f,S=l*p+i*g+u*d,P=v/f;return r.x=(l-S*p)*P,r.y=(i-S*g)*P,r.z=(u-S*d)*P,r}var U={x:0,y:0,z:0};function Ee(e){const t=e.starsInChunk,o=e.positions,n=Math.floor(o.length/3),r=new Float32Array(o.length);for(let a=0;a<n;a+=1){const c=t[a];c&&(De(c,o[a*3],o[a*3+1],o[a*3+2],U),r[a*3]=U.x,r[a*3+1]=U.y,r[a*3+2]=U.z)}return r}var Le=1,We=-25,Ne=500,Ve=.01;function ee(e,t){let o=t;for(;e[o]!==o;)o=e[o];let n=t;for(;n!==o;){const r=e[n];e[n]=o,n=r}return o}function Be(e,t,o){const n=ee(e,t),r=ee(e,o);n!==r&&(e[n]=r)}function le(e,t,o){return`${e},${t},${o}`}function Kt(e,t){const o=e.length,n=Array.from({length:o},(i,u)=>u),r=t,a=new Map;for(let i=0;i<o;i+=1){const u=e[i],f=le(Math.floor(u.x/r),Math.floor(u.y/r),Math.floor(u.z/r));a.has(f)||a.set(f,[]),a.get(f).push(i)}const c=t*t;for(let i=0;i<o;i+=1){const u=e[i],f=Math.floor(u.x/r),v=Math.floor(u.y/r),p=Math.floor(u.z/r);for(let g=-1;g<=1;g+=1)for(let d=-1;d<=1;d+=1)for(let S=-1;S<=1;S+=1){const P=le(f+g,v+d,p+S),w=a.get(P);if(w)for(const b of w){if(b<=i)continue;const C=e[b],F=C.x-u.x,T=C.y-u.y,R=C.z-u.z;F*F+T*T+R*R<c&&Be(n,i,b)}}}const s=new Map;for(let i=0;i<o;i+=1){const u=ee(n,i);s.has(u)||s.set(u,[]),s.get(u).push(i)}const l=[];for(let i=0;i<o;i+=1)l.push(void 0);for(const i of s.values())i.length<=1||(i.sort((u,f)=>u-f),i.forEach((u,f)=>{f>0&&(l[u]={x:0,y:f*We})}));return l}function Ke(){const e=[];for(let t=0;t<Ne;t+=1){const o=we(t*.7%360,t*.3%180-90);o!=null&&e.push(o)}return e}function Oe(){const e=Ke(),t=e.length,o=Pe,n=new Float32Array(t*3);return e.forEach((r,a)=>{n[a*3]=r.x*o,n[a*3+1]=r.y*o,n[a*3+2]=r.z*o}),{abbr:"_bootstrap",positions:n,sizes:new Float32Array(t).fill(Le),colors:new Float32Array(t*3).fill(1),warm:new Float32Array(t).fill(Ve),brightness:new Float32Array(t).fill(1),mag:new Float32Array(t).fill(-1/0),starsInChunk:[]}}var He={raMin:0,raMax:360,decMin:-90,decMax:90},Ot={chunks:[],namedStarsInView:[]};function Ht(e,t){return e===0&&t!=="success"}function he(e,t){return e.chunks.length>0?e.chunks:t==="idle"||t==="loading"?[Oe()]:[]}function Ut(e,t){const o=he(e,t),n=o.slice(0,3).map(r=>r.abbr).join(",");return o.length===0?{syntheticKind:"empty",chunkAbbrevSample:n}:o.length===1&&o[0]?.abbr==="_bootstrap"?{syntheticKind:"bootstrap",chunkAbbrevSample:n}:o.some(r=>r.abbr==="_fallback")?{syntheticKind:"fallback",chunkAbbrevSample:n}:{syntheticKind:"real",chunkAbbrevSample:n}}function ue(e,t){return t.current===e.current}function qt(e,t,o,n,r){e.onerror=a=>{ue(t,o)||(n("error"),r(a.message??"Starfield worker failed"))},e.onmessageerror=()=>{ue(t,o)||(n("error"),r("Starfield worker message error"))}}function ce(e){const t=e.indexOf("__part");return t===-1?e:e.slice(0,t)}function N(e,t){const o=new Float32Array(e.length+t.length);return o.set(e,0),o.set(t,e.length),o}function Ue(e,t){return{abbr:e.abbr,positions:N(e.positions,t.positions),sizes:N(e.sizes,t.sizes),colors:N(e.colors,t.colors),warm:N(e.warm,t.warm),brightness:N(e.brightness,t.brightness),mag:N(e.mag,t.mag),starsInChunk:[...e.starsInChunk,...t.starsInChunk]}}function qe(e,t){const o=new Map;e.chunks.forEach((r,a)=>o.set(ce(r.abbr),a));const n=[...e.chunks];for(const r of t.chunks){const a=ce(r.abbr),c=o.get(a);if(c!=null){const s=n[c];s&&(n[c]=Ue(s,r))}else o.set(a,n.length),n.push(r)}return{chunks:n,namedStarsInView:[...e.namedStarsInView,...t.namedStarsInView]}}function Ge(e,t,o,n,r,a,c,s="replace"){const{runId:l,...i}=e;l===t.current&&(o.current=l,s==="append"?(n.current=[...n.current,...i.starsInView],r(u=>qe(u,{chunks:i.chunks,namedStarsInView:i.namedStarsInView}))):(n.current=i.starsInView,r({chunks:i.chunks,namedStarsInView:i.namedStarsInView})),a("ready"),c(null))}function Gt(e,t,o,n,r,a={}){const c=a.mode??"replace";e.processStarfield({runId:t,catalog:o,maxDistanceLevel:n,bounds:He,raInHours:!1,maxPerChunk:a.maxPerChunk}).then(s=>{Ge(s,r.runIdRef,r.lastSuccessfulRunIdRef,r.starsInViewRef,r.setStarData,r.setStarfieldStatus,r.setErrorMessage,c),a.onComplete?.()}).catch(s=>{t===r.runIdRef.current&&(r.setStarfieldStatus("error"),r.setErrorMessage(s instanceof Error?s.message:"Starfield worker failed"))})}function Ye(e,t){t.length=0;for(const o of e){const n=new Float32Array(o.starsInChunk.length);for(let r=0;r<o.starsInChunk.length;r+=1){const a=o.starsInChunk[r];n[r]=a?Te(a)*te:0}t.push(n)}}function je(e,t,o){const n=he(e(),t());return Ye(n,o),n}var Xe=500*te;function $e(e,t,o,n){const r=Math.sqrt(e*e+t*t+o*o);if(r<=0||!Number.isFinite(r)){n.x=0,n.y=0,n.z=0;return}const a=ye(r)*te/r;n.x=e*a,n.y=t*a,n.z=o*a}function Je(e,t,o,n,r,a,c,s){const l=Math.sqrt(e*e+t*t+o*o);if(l<=0||!Number.isFinite(l)||!Number.isFinite(n)){const p=-r,g=-a,d=-c;return p*p+g*g+d*d<=s}const i=n/l,u=e*i-r,f=t*i-a,v=o*i-c;return u*u+f*f+v*v<=s}function Ze(){return{frustum:{position:{x:0,y:0,z:0},forward:{x:0,y:0,z:-1},right:{x:1,y:0,z:0},up:{x:0,y:1,z:0},fovYRadians:Math.PI/4,aspect:1},viewpointHelioKm:{x:0,y:0,z:0}}}function Qe(e){const t=Math.tan(e.frustum.fovYRadians*.5);return $e(e.frustum.position.x,e.frustum.position.y,e.frustum.position.z,e.viewpointHelioKm),{tanHalfV:t,maxDistSqKm:Xe**2}}var et=256,tt=320,ot=`
...
`;function Z(e){return new G(e[0],e[1],e[2])}function kt(){return{warm:Z(L.star3),hot:Z(L.star2),flare:Z(L.star1)}}function Jt(e){return e==null||Array.isArray(e)||!(e instanceof K)?!1:e.userData.cosmosiveSunCorona===!0}function Zt(e){const t=kt(),o={warm:e?.warm??t.warm,hot:e?.hot??t.hot,flare:e?.flare??t.flare},n={uTime:{value:0},uIntensity:{value:1.4},uPaletteWarm:{value:o.warm.clone()},uPaletteHot:{value:o.hot.clone()},uPaletteFlare:{value:o.flare.clone()}},r=new K({uniforms:n,vertexShader:Pt,fragmentShader:wt,transparent:!0,depthWrite:!1,blending:2,side:1,toneMapped:!1});return r.userData.cosmosiveSunCorona=!0,r}export{It as C,Et as S,Nt as _,L as a,E as b,Ot as c,qt as d,Ht as f,Bt as g,Vt as h,Xt as i,Ut as l,H as m,Jt as n,jt as o,Kt as p,$t as r,Yt as s,Zt as t,Gt as u,Ie as v,Dt as w,Lt as x,Wt as y};
