(function() {
	var o2 = Object.defineProperty, tn = (t, e) => {
		let n = {};
	...
	const r2 = Symbol("Comlink.proxy"), en = Symbol("Comlink.endpoint"), nn = Symbol("Comlink.releaseProxy"), ot = Symbol("Comlink.finalizer"), E1 = Symbol("Comlink.thrown"), s2 = (t) => typeof t == "object" && t !== null || typeof t == "function", a2 = /* @__PURE__ */ new Map([["proxy", {
	...
	const R1 = /* @__PURE__ */ new WeakMap(), m1 = "FinalizationRegistry" in globalThis && new FinalizationRegistry((t) => {
		const e = (R1.get(t) || 0) - 1;
		R1.set(t, e), e === 0 && c2(t);
	});
	function an(t, e) {
		const n = (R1.get(e) || 0) + 1;
		R1.set(e, n), m1 && m1.register(t, e, t);
	}
	function cn(t) {
		m1 && m1.unregister(t);
	}
	function st(t, e, n = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(a, c, i) {
				...
				if (u === en) return L0(t, e, { type: "ENDPOINT" }).then(D0);
	...
	180 / Math.PI;
	const r1 = 86400, h2 = 365.25, y0 = 299792.458, at = y0 * h2 * r1, b = 149597870.7, it = 648e3 / Math.PI, d2 = it * b / at, f2 = 23.4392911, _n = 1e3, An = y0, Sn = y0 ** Math.sqrt(Math.E), pn = y0 ** 2, En = y0 ** Math.E, yn = [
		1,
		_n,
		An,
		Sn
	...
	const _2 = .999999999;
	function Rn(t) {
		const e = Math.min(Math.max(t, 0), _2);
		return 1 / Math.sqrt((1 - e) * (1 + e));
	}
	Rn(_2);
	Object.freeze({
		x: 0,
	...
	var I1 = (t, e, n) => Object.defineProperty(t, e, {
		...
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				I1(r, mn, e), I1(r, gn, o), I1(r, In, !0), t.pairsMap.set(o, r);
			}
	...
	const R2 = 1e3 / b, lt = R2 * at * d2, t3 = 695700, e3 = 6378.137;
	function m2(t) {
	...
	const w1 = 173.1446326846693, O = 149597870.69098932, w2 = 63241.07708807546, S = .017453292519943295, ft = .26179938779914946, k = 57.29577951308232, Mt = 3.819718634205488, u3 = 71492, l3 = 66854, h3 = 69911, d3 = 1821.6, f3 = 1560.8, M3 = 2631.2, _3 = 2410.3, x2 = 365.24217, T2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), b0 = 484813681109536e-20, v2 = 648e3, A3 = 2 * v2, S3 = 7292115e-11, p3 = v2 / Math.PI, E3 = -.17 - 5 * Math.log10(p3), x1 = 29.530588, T1 = 86400, y3 = T1 * 1e3, D2 = .9972695717592592, _t = 695700, P2 = _t / O, s0 = .996647180302104, v1 = s0 * s0, M0 = 6378.1366, R3 = M0 / O, m3 = M0 * s0, g3 = 6371, I3 = 6459, w3 = 1738.1 / O, X = 1737.4, N2 = 1736, x3 = N2 / O, T3 = 34 / 60, v3 = 81.30056, s1 = .0002959122082855911, At = 4912547451450812e-26, St = 7243452486162703e-25, U2 = 8887692390113509e-25, pt = 9549535105779258e-26, k0 = 2.825345909524226e-7, K0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, D3 = 218869976542597e-26, P3 = U2 / v3;
	function Et(t) {
		switch (t) {
			case d.Sun: return s1;
	...
	function I0(t) {
		...
		var d0 = U(.19833 + .05611 * e), Xt = U(.27869 + .04508 * e), Wt = U(.16827 - .36903 * e), Zt = U(.34734 - 5.37261 * e), t2 = U(.10498 - 5.37899 * e), et = U(.42681 - .41855 * e), c6 = U(.14943 - 5.37511 * e);
		for (N = .84 * d0 + .31 * Xt + 14.27 * Wt + 7.26 * Zt + .28 * t2 + .24 * et, L = 2.94 * d0 + .31 * Xt + 14.27 * Wt + 9.34 * Zt + 1.12 * t2 + .83 * et, K = -6.4 * d0 - 1.89 * et, Q = .21 * d0 + .31 * Xt + 14.27 * Wt - 88.7 * Zt - 15.3 * t2 + .24 * et - 1.86 * c6, Y = N - K, E = -3332e-9 * U(.59734 - 5.37261 * e) - 539e-9 * U(.35498 - 5.37899 * e) - 64e-9 * U(.39943 - 5.37511 * e), y = n0 * V0(.60643382 + 1336.85522467 * e - 313e-8 * f) + N / R0, g = n0 * V0(.37489701 + 1325.55240982 * e + 2565e-8 * f) + L / R0, x = n0 * V0(.99312619 + 99.99735956 * e - 44e-8 * f) + K / R0, I = n0 * V0(.25909118 + 1342.2278298 * e - 892e-8 * f) + Q / R0, v = n0 * V0(.82736186 + 1236.85308708 * e - 397e-8 * f) + Y / R0, l = 1; l <= 4; ++l) {
			switch (l) {
				case 1:
		...
		let u6 = (1.000002708 + 139.978 * E) * (18518.511 + 1.189 + w) * Math.sin(a) - 6.24 * Math.sin(3 * a) + p;
		return {
			geo_eclip_lon: n0 * V0((y + M / R0) / n0),
			geo_eclip_lat: Math.PI / 648e3 * u6,
			distance_au: R0 * R3 / (.999953253 * m)
		};
	}
	var K2 = class {
	...
	function a1(t, e, n, o, r) {
		...
		return j2(o ? L1(i, s, C.From2000) : i, s);
	}
	function G3(t, e, n) {
		const o = R(t);
		let r = Rt(e, _0(o)).pos;
	...
	function $3(t, e) {
		...
		return e || (o = B0(o, t.t, C.From2000), o = F0(o, t.t, C.From2000)), V3(o, n);
	}
	function Q3(t, e) {
	...
	function i0(t) {
		const e = R(t), n = I0(e), o = n.distance_au * Math.cos(n.geo_eclip_lat), r = B0(K3(e, [
	...
	function K1(t) {
		const e = R(t), n = I0(e), o = n.distance_au * Math.cos(n.geo_eclip_lat), r = [
			...
			o * Math.sin(n.geo_eclip_lon),
			n.distance_au * Math.sin(n.geo_eclip_lat)
		], s = g0(e), a = mt(F0(b2(s.mobl, r), e, C.From2000), e), c = s.tobl * S, i = It(a, Math.cos(c), Math.sin(c));
	...
	function Q0(t, e) {
		const n = e.tt / $0;
		return Dt(Q2(P0(t[Tt], n, !0), P0(t[vt], n, !1), P0(t[H1], n, !1))).ToAstroVector(e);
	}
	function u1(t, e) {
		const n = e / $0, o = P0(t[Tt], n, !0), r = P0(t[vt], n, !1), s = P0(t[H1], n, !1), a = xt(t[Tt], n), c = xt(t[vt], n), i = xt(t[H1], n), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), f = Math.sin(r), E = +(i * h * u) - s * f * u * c - s * h * l * a, M = +(i * h * l) - s * f * l * c + s * h * u * a, p = +(i * f) + s * h * c, w = Q2(o, r, s), m = [
			E / $0,
			M / $0,
			p / $0
		];
	...
	var h1 = class {
		...
		Acceleration(t) {
			let e = l1(t, s1, this.Sun.r);
			return e.incr(l1(t, k0, this.Jupiter.r)), e.incr(l1(t, K0, this.Saturn.r)), e.incr(l1(t, H0, this.Uranus.r)), e.incr(l1(t, J0, this.Neptune.r)), e;
		}
	}, Pt = class Ze {
		constructor(e, n, o, r) {
	...
	function Ut(t, e) {
		const n = t - e.tt, o = new h1(t), r = q0(n, e.r, e.v, e.a), s = o.Acceleration(r).mean(e.a), a = q0(n, e.r, e.v, s);
		return new q2(o, new Pt(t, a, e.v.add(s.mul(n)), o.Acceleration(a)));
	}
	const Z3 = [];
	function X2(t, e) {
	...
	function Ot(t) {
		const e = W3(t), n = new h1(e.tt), o = e.r.add(n.Sun.r), r = e.v.add(n.Sun.v), s = n.Acceleration(o);
		return new q2(n, new Pt(e.tt, o, r, s));
	}
	function t4(t, e) {
		const n = N0[0][0];
		if (e < n || e > N0[50][0]) return null;
		const o = X2((e - n) / X3, 50);
		if (!t[o]) {
			const s = t[o] = [];
	...
	function zt(t, e) {
		...
		const s = t4(Z3, t.tt);
		if (s) {
			const a = X2((t.tt - s[0].tt) / V1, 200), c = s[a], i = s[a + 1], u = c.a.mean(i.a), l = q0(t.tt - c.tt, c.r, c.v, u), h = Nt(t.tt - c.tt, c.v, u), f = q0(t.tt - i.tt, i.r, i.v, u), E = Nt(t.tt - i.tt, i.v, u), M = (t.tt - c.tt) / V1;
			n = l.mul(1 - M).add(f.mul(M)), o = h.mul(1 - M).add(E.mul(M));
		} else {
			let a;
			t.tt < N0[0][0] ? a = W2(N0[0], t.tt, -146) : a = W2(N0[50], t.tt, 146), n = a.grav.r, o = a.grav.v, r = a.bary;
		}
		return e && (r || (r = new h1(t.tt)), n = n.sub(r.Sun.r), o = o.sub(r.Sun.v)), new J(n.x, n.y, n.z, o.x, o.y, o.z, t);
	}
	const e4 = new B([
		[
			.999432765338654,
	...
	function o4(t) {
		const e = new m0(t);
		return new Z2(F1(e, B1[0]), F1(e, B1[1]), F1(e, B1[2]), F1(e, B1[3]));
	}
	function c0(t, e) {
		var n = R(e);
	...
	function s4(t, e) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = u1(j[d.Earth], n.tt), s = t === d.Moon ? c1(n) : wt(n);
	...
	function Y1(t, e) {
		...
		switch (t) {
			...
			case d.Saturn:
			case d.Uranus:
			case d.Neptune: return z0(u1(j[t], n.tt), n);
			case d.Pluto: return zt(n, !0);
			case d.Moon:
			case d.EMB:
				const r = u1(j.Earth, n.tt), s = t == d.Moon ? c1(n) : wt(n);
	...
	function Ct(t, e, n) {
		...
		const o = R(n), r = i1(o0(t, o, !1)), s = i1(o0(e, o, !1));
	...
	function c4(t, e, n, o, r) {
		const s = i1(o), a = S * 28.06, c = S * (169.51 + 382e-7 * r.tt), i = S * s.elat, u = S * s.elon, l = Math.asin(Math.sin(i) * Math.cos(a) - Math.cos(i) * Math.sin(a) * Math.sin(u - c)), h = Math.sin(Math.abs(l));
		let f = -9 + .044 * t;
	...
	function se(t) {
		let e = Lt(t), n = (Math.floor(e / 90) + 1) % 4, o = f1(90 * n, t, 10);
	...
	function S4(t, e, n, o, r = 1) {
		...
		for (;;) {
			++a;
			let c = _0(s), i = a1(t, s, e, !0, !0), u = (n + i.ra - e.longitude / 15 - c) % 24;
	...
	function p4(t, e, n) {
		const o = R(e), r = V2(o), s = a1(t, o, n, !0, !0);
	...
	function T4(t, e) {
		const n = Kt(t);
		return n.lon = Ae(n.lon), n.lat += _1(e, n.lat), n;
	}
	function v4(t, e, n) {
		e = R(e);
		const o = Ae(t.lon);
		return j1(new Y0(t.lat + Se(n, t.lat), o, t.dist), e);
	}
	function _1(t, e) {
		let n;
	...
	function k4(t, e) {
		...
		t %= 24, t < 0 && (t += 24), Jt || (Jt = Q1(new m0(-45655.74141261017)), xe = new m0(0));
		const n = j1(new Y0(e, 15 * t, 1), xe), o = kt(A1(Jt, n)), r = 10 / 240, s = r / 15;
		for (let a of b4) {
	...
	function S1(t, e, n, o) {
		...
		return new K4(e, r, O * Math.hypot(s, a, c), 695700 - (1 + r) * (_t - t), -695700 + (1 + r) * (_t + t), n, o);
	}
	function X1(t) {
	...
	function V4(t) {
		const e = F((n) => Bt(De, n), t.AddDays(-.03), t.AddDays(.03));
	...
	function Ne(t, e) {
		const n = new D(t.x + e.x, t.y + e.y, t.z + e.z, t.t), o = Pe(Math.asin(P2 / n.Length()), Math.asin(x3 / e.Length()), P1(e, n) * S);
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (a.r < a.p + X) {
					...
					return a.r < a.k + X && (c = Z.Partial, l = Ft(a.time, a.k + X, h), a.r + X < a.k ? (c = Z.Total, i = 1, u = Ft(a.time, a.k - X, l)) : i = Pe(X, a.k, a.r)), new ve(c, i, a.time, h, l, u);
				}
			}
			n = r.AddDays(10);
		}
	...
	function Y4(t) {
		...
		const a = Q1(t.time), c = A1(a, t.dir), i = A1(a, t.target);
		...
		if (E > 0) {
			...
			v = A1(I, v), v.x += t.target.x, v.y += t.target.y, v.z += t.target.z;
			const N = S1(N2, t.time, v, t.dir);
	...
	function $4(t, e) {
		...
		const s = Z1(e, 1, ke, o, t.time), a = Z1(e, -1, ke, t.time, r);
		let c, i, u;
		t.r < Math.abs(t.k) ? (o = t.time.AddDays(-.01), r = t.time.AddDays(.01), c = Z1(e, 1, Ke, o, t.time), i = Z1(e, -1, Ke, t.time, r), u = ze(t.k)) : u = Z.Partial;
	...
	function Fe(t, e) {
		...
		for (;;) {
			...
			if (Z0(t, s) < n) {
				const a = B4(t, o, s);
				if (a.r < a.p) {
					const c = a.time.AddDays(-1), i = Be(t, o, c, a.time, -1), u = a.time.AddDays(1), l = Be(t, o, a.time, u, 1), h = 60 * Z0(t, a.time);
	...
	function n6(t, e, n, o) {
		...
		let c, i;
		return n === d.Earth && o === d.Moon ? (c = new J(0, 0, 0, 0, 0, 0, r), i = c1(r)) : (c = Y1(n, r), i = Y1(o, r)), $e(t, c, s, i, a);
	}
	...
	var o6 = class e0 {
		...
		CalcBodyAccelerations() {
			for (let e of this.curr.bodies) e.a = $.zero(), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Sun].r, s1), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Mercury].r, At), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Venus].r, St), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Earth].r, 8997011346712498e-25), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Mars].r, pt), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Jupiter].r, k0), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Saturn].r, K0), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Uranus].r, H0), e0.AddAcceleration(e.a, e.r, this.curr.gravitators[d.Neptune].r, J0);
		}
	...
	function Xe(t, e) {
		...
		switch (n.type) {
			...
			case "step": {
				...
				const r = t.jd + t.speed * o / r1, s = Math.max(ht, Math.min(dt, r)), a = {
					...t,
					jd: s
				}, c = [{
					type: "tick",
	...
	rt({
		...
		subscribe(t) {
			p1 != null && p1 !== t && console.warn("[simulationWorker] replacing existing outbound subscriber (double subscribe)"), p1 = t, qt();
		},
		unsubscribe() {
			p1 = null, Qt();
		}
