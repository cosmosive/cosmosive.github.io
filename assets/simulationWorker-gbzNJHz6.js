(function() {
	const F = Symbol("Comlink.proxy"), re = Symbol("Comlink.endpoint"), se = Symbol("Comlink.releaseProxy"), b = Symbol("Comlink.finalizer"), f = Symbol("Comlink.thrown"), B = (e) => typeof e == "object" && e !== null || typeof e == "function", G = new Map([["proxy", {
		canHandle: (e) => B(e) && e[F],
		serialize(e) {
	...
	function L(e, t = globalThis, n = ["*"]) {
		t.addEventListener("message", function o(s) {
			...
			Promise.resolve(c).catch((l) => ({
				...
				const [p, S] = M(l);
				t.postMessage(Object.assign(Object.assign({}, p), { id: a }), S), u === "RELEASE" && (t.removeEventListener("message", o), V(t), b in e && typeof e[b] == "function" && e[b]());
			}).catch((l) => {
				const [p, S] = M({
	...
	const I = /* @__PURE__ */ new WeakMap(), T = "FinalizationRegistry" in globalThis && new FinalizationRegistry((e) => {
		const t = (I.get(e) || 0) - 1;
		I.set(e, t), t === 0 && v(e);
	});
	function ce(e, t) {
		const n = (I.get(t) || 0) + 1;
		I.set(t, n), T && T.register(e, t, e);
	}
	function ue(e) {
		T && T.unregister(e);
	}
	function C(e, t, n = [], o = function() {}) {
		let s = !1;
		const a = new Proxy(o, {
			get(u, i) {
				if (g(s), i === se) return () => {
			...
			apply(u, i, d) {
				...
				if (c === "bind") return C(e, t, n.slice(0, -1));
				const [l, p] = W(d);
				return m(e, t, {
					type: "APPLY",
	...
	function ne(e, t) {
		...
		switch (n.type) {
			...
			case "seek": {
				...
				const o = n.jd;
				let s = o;
				(s < 1721545 || s > 3181545) && (console.warn(`[kernel/seek] JD ${s} outside supported range [${j}, ${k}] (years 0-4000 AD); clamping.`), s = Math.max(j, Math.min(k, s)));
				const a = {
					...e,
					jd: s
				}, u = [{
			...
			case "step": {
				...
				const s = e.jd + e.speed * o / Ie, a = Math.max(j, Math.min(k, s)), u = {
					...e,
					jd: a
				}, i = [{
					type: "tick",
