(function() {
	var c2 = Object.defineProperty, Wn = (t, n) => {
		let e = {};
	...
	const u2 = Symbol("Comlink.proxy"), Xn = Symbol("Comlink.endpoint"), Zn = Symbol("Comlink.releaseProxy"), ut = Symbol("Comlink.finalizer"), R1 = Symbol("Comlink.thrown"), l2 = (t) => typeof t == "object" && t !== null || typeof t == "function", h2 = new Map([["proxy", {
	...
	}, he = 149597870.7, fe = 648e3 / Math.PI, p2 = 1e3, D1 = 100 * p2, s1 = 100 / fe, de = 16777216, _2 = 3.2615637771694;
	(de - D1) / 20 + s1;
	function A2(t) {
	...
	const St = y2[R.EARTH]?.radiusKm ?? 6371, pt = y2[R.SUN]?.radiusKm ?? 696340, ye = St / pt, i1 = .04 * (100 / 15);
	St / i1;
	i1 / St / (p2 / he);
	function Ee(t) {
	...
	function we(t) {
		return !Number.isFinite(t) || t <= 0 ? i1 : Ee(t / pt);
	}
	we(pt);
	var P1 = Wn({
		AU_PER_LY: () => E2,
	...
	const z1 = 173.1446326846693, L = 149597870.69098932, E2 = 63241.07708807546, p = .017453292519943295, _t = .26179938779914946, b = 57.29577951308232, At = 3.819718634205488, ge = 71492, Re = 66854, me = 69911, xe = 1821.6, ve = 1560.8, Ie = 2631.2, De = 2410.3, w2 = 365.24217, g2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, R2 = 10800 * 60, Pe = 2 * R2, m2 = 7292115e-11, ze = R2 / Math.PI, Te = -.17 - 5 * Math.log10(ze), T1 = 29.530588, N1 = 24 * 3600, Ne = N1 * 1e3, x2 = .9972695717592592, a1 = 695700, v2 = a1 / L, s0 = .996647180302104, b0 = s0 * s0, M0 = 6378.1366, Ue = M0 / L, Le = M0 * s0, I2 = 6371, Ce = I2 + 88, Oe = 1738.1 / L, Y = 1737.4, D2 = 1736, ke = D2 / L, be = 34 / 60, yt = 81.30056, c1 = .0002959122082855911, Et = 4912547451450812e-26, wt = 7243452486162703e-25, u1 = 8887692390113509e-25, gt = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, Ve = 218869976542597e-26, U1 = u1 / yt;
	function Rt(t) {
		switch (t) {
	...
	function m0(t) {
		...
		var f0 = U(.19833 + .05611 * n), e2 = U(.27869 + .04508 * n), r2 = U(.16827 - .36903 * n), o2 = U(.34734 - 5.37261 * n), s2 = U(.10498 - 5.37899 * n), at = U(.42681 - .41855 * n), A4 = U(.14943 - 5.37511 * n);
		for (D = .84 * f0 + .31 * e2 + 14.27 * r2 + 7.26 * o2 + .28 * s2 + .24 * at, k = 2.94 * f0 + .31 * e2 + 14.27 * r2 + 9.34 * o2 + 1.12 * s2 + .83 * at, N = -6.4 * f0 - 1.89 * at, K = .21 * f0 + .31 * e2 + 14.27 * r2 - 88.7 * o2 - 15.3 * s2 + .24 * at - 1.86 * A4, G = D - N, _ = -3332e-9 * U(.59734 - 5.37261 * n) - 539e-9 * U(.35498 - 5.37899 * n) - 64e-9 * U(.39943 - 5.37511 * n), m = n0 * $0(.60643382 + 1336.85522467 * n - 313e-8 * d) + D / w0, w = n0 * $0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, v = n0 * $0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * $0(.25909118 + 1342.2278298 * n - 892e-8 * d) + K / w0, z = n0 * $0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
		...
		function jn(T, C, V, H) {
			for (var B = {
				...
				V,
				H
			], y0 = 1; y0 <= 4; ++y0) D0[y0] !== 0 && it(B.x, B.y, A0(D0[y0], y0), I0(D0[y0], y0), (i2, o1) => (B.x = i2, B.y = o1));
			return B;
		}
		function S(T, C, V, H, B, D0, y0, i2) {
			var o1 = jn(B, D0, y0, i2);
	...
	function We(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = o > 0 ? 90 : -90, c = Math.abs(o) - Le;
		else {
	...
	function $1(t, n, e, r, o) {
		...
		if (o) {
			let o0 = G, A0 = y1(o, 90 - G);
			if (G -= A0, A0 > 0 && G > 3e-4) {
				const I0 = Math.sin(G * p), l0 = Math.cos(G * p), h0 = Math.sin(o0 * p), it = Math.cos(o0 * p), U = [];
				for (let f0 = 0; f0 < 3; ++f0) U.push((x[f0] - it * m[f0]) / h0 * I0 + m[f0] * l0);
				N = Math.hypot(U[0], U[1]), N > 0 ? (j = At * Math.atan2(U[1], U[0]), j < 0 && (j += 24)) : j = 0, u0 = b * Math.atan2(U[2], N);
			}
		}
		return new H2(K, 90 - G, j, u0);
	}
	function q0(t) {
	...
	function G2(t) {
		const n = y(t).AddDays(-1 / z1), e = Y0(Q.Earth, n), [r, o, s] = H1([
			-e.x,
			-e.y,
			-e.z
	...
	function e3(t, n, e) {
		const r = y(t), o = xt(n, S0(r)), s = new F(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
	...
	function r3(t, n) {
		...
		return n || (r = G0(r, t.t, O.From2000), r = B0(r, t.t, O.From2000)), We(r, e);
	}
	function o3(t, n) {
	...
	function a0(t) {
		const n = y(t), e = m0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = G0(qe(n, [
	...
	function G1(t) {
		const n = y(t), e = m0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = vt(B0(U2(s.mobl, o), n, O.From2000), n), a = s.tobl * p, c = Dt(i, Math.cos(a), Math.sin(a));
	...
	const j0 = 365250, Tt = 0, Nt = 1, B1 = 2;
	function Ut(t) {
	...
	function Y0(t, n) {
		const e = n.tt / j0;
		return Ut(B2(z0(t[Tt], e, !0), z0(t[Nt], e, !1), z0(t[B1], e, !1))).ToAstroVector(n);
	}
	function d1(t, n) {
		const e = n / j0, r = z0(t[Tt], e, !0), o = z0(t[Nt], e, !1), s = z0(t[B1], e, !1), i = zt(t[Tt], e), a = zt(t[Nt], e), c = zt(t[B1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, E = B2(r, o, s), g = [
			_ / j0,
			M / j0,
			A / j0
		];
	...
	const Lt = 51, i3 = 29200, W0 = 146, p0 = 201, T0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function f3(t) {
		const n = new g0(t);
		return new j2(q1(n, Q1[0]), q1(n, Q1[1]), q1(n, Q1[2]), q1(n, Q1[3]));
	}
	function c0(t, n) {
		var e = y(n);
		...
		if (t === f.EMB) {
			const i = Y0(Q.Earth, e), a = a0(e), c = 1 + yt;
	...
	function U0(t, n) {
		...
		if (e) return e.dist;
		const r = y(n);
		return t in Q ? z0(Q[t][B1], r.tt / j0, !1) : c0(t, r).Length();
	}
	function Y2(t, n) {
		let e = n, r = 0;
		for (let o = 0; o < 10; ++o) {
	...
	function W2(t, n, e, r) {
		...
		if (O1(e)) {
			const a = c0(e, o);
			if (r) {
				const u = j1(n, o), h = new P(a.x - u.x, a.y - u.y, a.z - u.z, o), l = z1 / h.Length();
	...
	function Q3(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Kt || (Kt = Z1(new g0(-45655.74141261017)), Rn = new g0(0));
		const e = W1(new K0(n, 15 * t, 1), Rn), r = $t(E1(Kt, e)), o = 10 / 240, s = o / 15;
		for (let i of K3) {
	...
	function vn(t) {
		...
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, w1(Y, t, r, e);
	}
	function Qt(t, n) {
		const e = F2(t, n), r = e0(f.Sun, t, !0), o = a0(t), s = new P(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
		return o.x -= r.x, o.y -= r.y, o.z -= r.z, w1(Y, t, s, o);
	}
	function et(t, n, e) {
	...
	function X3(t, n, e) {
		const o = $((s) => j3(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function Pn(t) {
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				const i = Y3(o);
				if (i.r < i.p + Y) {
					let a = X.Penumbral, c = 0, u = 0, h = 0, l = jt(i.time, i.p + Y, 200);
					return i.r < i.k + Y && (a = X.Partial, h = jt(i.time, i.k + Y, l), i.r + Y < i.k ? (a = X.Total, c = 1, u = jt(i.time, i.k - Y, h)) : c = In(Y, i.k, i.r)), new xn(a, c, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function h4(t, n, e, r) {
		const o = y(n), s = Rt(e), i = Rt(r);
		let a, c;
		return e === f.Earth && r === f.Moon ? (a = new F(0, 0, 0, 0, 0, 0, o), c = f1(o)) : (a = j1(e, o), c = j1(r, o)), Bn(t, a, s, c, i);
	}
	...
	var f4 = class t0 {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = W(r, n.tt, f.Mercury, Et), e[f.Venus] = W(r, n.tt, f.Venus, wt), e[f.Earth] = W(r, n.tt, f.Earth, u1 + U1), e[f.Mars] = W(r, n.tt, f.Mars, gt), e[f.Jupiter] = W(r, n.tt, f.Jupiter, V0), e[f.Saturn] = W(r, n.tt, f.Saturn, F0), e[f.Uranus] = W(r, n.tt, f.Uranus, H0), e[f.Neptune] = W(r, n.tt, f.Neptune, J0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new N0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = q.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, c1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, Et), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, wt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, u1 + U1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, gt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, V0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, H0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, J0);
		}
	...
	const { MakeTime: T4, SearchRiseSet: N4, Body: U4, Observer: d4 } = ot(P1);
	...
	Math.PI / (180 * 3600);
	const { HelioState: H4 } = ot(P1), M4 = 86400;
	function Qn(t) {
		return t.type === "init" ? {
			type: "init",
	...
	function qn(t, n) {
		...
		switch (e.type) {
			...
			case "step": {
				...
				const o = t.jd + t.speed * r / M4, s = Math.max(dt, Math.min(Mt, o)), i = {
					...t,
					jd: s
				}, a = [{
					type: "tick",
