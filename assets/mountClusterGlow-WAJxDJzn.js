import{n as S}from"./state-data-vendor-DwYWRG6B.js";import{n as F}from"./manifest.generated-B_QDKHYB.js";import{t as G}from"./skyLightStore-CcPC6YfG.js";import{A as b,d as u,f as C,g as P,ht as y,it as A}from"./three-vendor-Ce7iT1Ri.js";import{a as z,b as _,mn as L,ni as d}from"./index-_a0r9BG7.js";import{t as R}from"./createMountComponent-DfQMjfJ4.js";import{n as v,t as E}from"./deepSkyCatalogBridge-yVsasV5g.js";var T={mainSequence:[.85,.95,1.4],giant:[1.4,1,.55],giantFraction:.08},B={mainSequence:[1.35,1.15,.8],giant:[1.5,.85,.5],giantFraction:.25};function O(t){return t==="globular"?B:T}var k=8;function I(t,i,e,n,l,s,o){t.xs.push(e,n,l),t.mags.push(s),t.cols.push(o[0],o[1],o[2]),t.glow.push(1),t.ids.push(i)}function N(t,i){const e=F(t);if(!Number.isFinite(e.x)||!Number.isFinite(e.y)||!Number.isFinite(e.z)||e.x===0&&e.y===0&&e.z===0)return;const n=t.vMag!=null&&Number.isFinite(t.vMag)?t.vMag:k,l=L(t),s=O(l),o=l==="globular"?s.giant:s.mainSequence;I(i,t.catalogId,e.x,e.y,e.z,n,o)}function D(t){const i={xs:[],mags:[],cols:[],glow:[],ids:[]};for(const e of t)e.type==="star_cluster"&&N(e,i);return{positions:new Float32Array(i.xs),mag:new Float32Array(i.mags),color:new Float32Array(i.cols),isGlow:new Float32Array(i.glow),catalogIds:i.ids,count:i.ids.length}}var V=160,U=`
  attribute float mag;
