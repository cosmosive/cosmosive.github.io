(function() {
	var e2 = Object.defineProperty, Hn = (t, n) => {
		let e = {};
	...
	const r2 = Symbol("Comlink.proxy"), $n = Symbol("Comlink.endpoint"), Jn = Symbol("Comlink.releaseProxy"), st = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), o2 = (t) => typeof t == "object" && t !== null || typeof t == "function", s2 = new Map([["proxy", {
	...
	function at(t, n, e = [], r = function() {}) {
		...
		const s = new Proxy(r, {
			...
			apply(i, a, c) {
				...
				if (u === $n) return L0(t, n, { type: "ENDPOINT" }).then(z0);
	...
	function c2(t) {
		const n = t.map(x1);
		return [n.map((e) => e[0]), Yn(n.map((e) => e[1]))];
	}
	...
	}, t3 = 149597870.7, n3 = 648e3 / Math.PI, ct = 1500, m1 = 100 / n3, l2 = 16777216;
	...
	const h2 = Object.fromEntries(Object.entries(Zn).map(([t, n]) => [t, e3(n)])), ut = [
		D.SUN,
		D.MERCURY,
		D.VENUS,
		D.EARTH,
	...
	const ht = h2[D.SUN]?.radiusKm ?? 696340, o3 = lt / ht, o1 = .04;
	lt / o1;
	o1 / lt / (15 / t3);
	function s3(t) {
		return !Number.isFinite(t) || t <= 0 ? o1 : t / o3 * o1;
	}
	function i3(t) {
		return !Number.isFinite(t) || t <= 0 ? o1 : s3(t / ht);
	}
	i3(ht);
	var v1 = Hn({
		AU_PER_LY: () => f2,
		...
		BaryState: () => Z3,
		Body: () => f,
		CALLISTO_RADIUS_KM: () => d3,
		C_AUDAY: () => D1,
		CalcMoonCount: () => v2,
		CombineRotation: () => m0,
		Constellation: () => N4,
		ConstellationInfo: () => _n,
		CorrectLightTravel: () => $2,
		DEG2RAD: () => _,
		DefineStar: () => D3,
		DeltaT_EspenakMeeus: () => Et,
		DeltaT_JplHorizons: () => P3,
		EUROPA_RADIUS_KM: () => h3,
		EclipseEvent: () => mn,
		EclipseKind: () => X,
		Ecliptic: () => u1,
		...
		Illumination: () => q1,
		IlluminationInfo: () => Q2,
		InverseRefraction: () => sn,
		InverseRotation: () => e1,
		JUPITER_EQUATORIAL_RADIUS_KM: () => a3,
		JUPITER_MEAN_RADIUS_KM: () => u3,
		JUPITER_POLAR_RADIUS_KM: () => c3,
		JupiterMoons: () => j3,
		JupiterMoonsInfo: () => H2,
		KM_PER_AU: () => O,
		LagrangePoint: () => W4,
		...
		MoonPhase: () => Ct,
		MoonQuarter: () => B2,
		NextGlobalSolarEclipse: () => H4,
		NextLocalSolarEclipse: () => G4,
		NextLunarApsis: () => _4,
		NextLunarEclipse: () => F4,
		NextMoonNode: () => q4,
		NextMoonQuarter: () => o4,
		...
		SearchHourAngle: () => h4,
		SearchLocalSolarEclipse: () => In,
		SearchLunarApsis: () => nn,
		SearchLunarEclipse: () => yn,
		SearchMaxElongation: () => M4,
		SearchMoonNode: () => Cn,
		SearchMoonPhase: () => S1,
		SearchMoonQuarter: () => q2,
		SearchPeakMagnitude: () => S4,
		...
		TransitInfo: () => Tn,
		Vector: () => P,
		VectorFromHorizon: () => g4,
		VectorFromSphere: () => K1,
		VectorObserver: () => $3,
		e_tilt: () => g0
	});
	const D1 = 173.1446326846693, O = 149597870.69098932, f2 = 63241.07708807546, _ = .017453292519943295, ft = .26179938779914946, b = 57.29577951308232, dt = 3.819718634205488, a3 = 71492, c3 = 66854, u3 = 69911, l3 = 1821.6, h3 = 1560.8, f3 = 2631.2, d3 = 2410.3, d2 = 365.24217, M2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), t0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), C0 = 484813681109536e-20, S2 = 10800 * 60, M3 = 2 * S2, _2 = 7292115e-11, S3 = S2 / Math.PI, _3 = -.17 - 5 * Math.log10(S3), z1 = 29.530588, P1 = 24 * 3600, p3 = P1 * 1e3, p2 = .9972695717592592, s1 = 695700, A2 = s1 / O, o0 = .996647180302104, k0 = o0 * o0, d0 = 6378.1366, A3 = d0 / O, E3 = d0 * o0, E2 = 6371, w3 = E2 + 88, y3 = 1738.1 / O, W = 1737.4, w2 = 1736, g3 = w2 / O, R3 = 34 / 60, Mt = 81.30056, i1 = .0002959122082855911, St = 4912547451450812e-26, _t = 7243452486162703e-25, a1 = 8887692390113509e-25, pt = 9549535105779258e-26, b0 = 2.825345909524226e-7, V0 = 8.459715185680659e-8, F0 = 1.292024916781969e-8, H0 = 1.524358900784276e-8, x3 = 218869976542597e-26, I1 = a1 / Mt;
	function At(t) {
		switch (t) {
	...
	function y2(t) {
		const n = m3.indexOf(t);
		return n >= 0 ? v3[n] : null;
	}
	function U1(t) {
		const n = y2(t);
	...
	var y0 = class ot {
		constructor(n) {
			...
			if (n instanceof Date && Number.isFinite(n.getTime())) {
				this.date = n, this.ut = (n.getTime() - M2.getTime()) / e, this.tt = R2(this.ut);
				return;
			}
			if (Number.isFinite(n)) {
				this.date = new Date(M2.getTime() + n * e), this.ut = n, this.tt = R2(this.ut);
				return;
			}
	...
	function g0(t) {
		if (!O1 || Math.abs(O1.tt - t.tt) > 1e-6) {
			const n = N3(t), e = x2(t), r = e + n.deps / 3600;
			O1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function R0(t) {
		...
		var h0 = U(.19833 + .05611 * n), Wt = U(.27869 + .04508 * n), jt = U(.16827 - .36903 * n), Xt = U(.34734 - 5.37261 * n), Zt = U(.10498 - 5.37899 * n), rt = U(.42681 - .41855 * n), r6 = U(.14943 - 5.37511 * n);
		for (z = .84 * h0 + .31 * Wt + 14.27 * jt + 7.26 * Xt + .28 * Zt + .24 * rt, k = 2.94 * h0 + .31 * Wt + 14.27 * jt + 9.34 * Xt + 1.12 * Zt + .83 * rt, N = -6.4 * h0 - 1.89 * rt, B = .21 * h0 + .31 * Wt + 14.27 * jt - 88.7 * Xt - 15.3 * Zt + .24 * rt - 1.86 * r6, G = z - N, p = -3332e-9 * U(.59734 - 5.37261 * n) - 539e-9 * U(.35498 - 5.37899 * n) - 64e-9 * U(.39943 - 5.37511 * n), R = t0 * $0(.60643382 + 1336.85522467 * n - 313e-8 * d) + z / w0, y = t0 * $0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = t0 * $0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = t0 * $0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, I = t0 * $0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (u0(0, h, 1), u0(1, h, Math.cos(c) * u), l0(0, h, 0), l0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) et(p0(l - 1, h), v0(l - 1, h), p0(1, h), v0(1, h), (T, L) => (u0(l, h, T), l0(l, h, L)));
		...
		function S(T, L, V, H, Q, D0, A0, t2) {
			var r1 = Vn(Q, D0, A0, t2);
		...
		let o6 = (1.000002708 + 139.978 * p) * (18519.699999999997 + w) * Math.sin(i) - 6.24 * Math.sin(3 * i) + A;
		return {
			geo_eclip_lon: t0 * $0((R + M / w0) / t0),
			geo_eclip_lat: Math.PI / (180 * 3600) * o6,
			distance_au: w0 * A3 / (.999953253 * g)
		};
	}
	var D2 = class {
	...
	function O3(t) {
		...
		return new D2(b * m + B, y + N, b * c, b * a, u, G);
	}
	function z2(t, n) {
		return [
	...
	function C3(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = o > 0 ? 90 : -90, c = Math.abs(o) - E3;
		else {
	...
	function k3(t, n, e) {
		return e === C.Into2000 ? P2(T2(t, n, e), n, e) : T2(P2(t, n, e), n, e);
	}
	function N2(t, n) {
		const e = wt(n, M0(t)).pos;
		return b1(e, t, C.Into2000);
	}
	var P = class {
		constructor(t, n, e, r) {
	...
	function F1(t, n, e, r, o) {
		...
		if (o) {
			...
			if (G -= p0, p0 > 0 && G > 3e-4) {
				const v0 = Math.sin(G * _), u0 = Math.cos(G * _), l0 = Math.sin(r0 * _), et = Math.cos(r0 * _), U = [];
				for (let h0 = 0; h0 < 3; ++h0) U.push((x[h0] - et * R[h0]) / l0 * v0 + R[h0] * u0);
				N = Math.hypot(U[0], U[1]), N > 0 ? (Y = dt * Math.atan2(U[1], U[0]), Y < 0 && (Y += 24)) : Y = 0, c0 = b * Math.atan2(U[2], N);
			}
		}
		return new U2(B, 90 - G, Y, c0);
	}
	function q0(t) {
	...
	function C2(t) {
		const n = E(t).AddDays(-1 / D1), e = Y0(q.Earth, n), [r, o, s] = b1([
			-e.x,
			-e.y,
			-e.z
		], n, C.From2000), i = _ * g0(n).tobl, a = Math.cos(i), c = Math.sin(i);
		return Rt(new P(r, o, s, n), a, c);
	}
	function c1(t, n, e, r, o) {
		q0(e), T1(r), T1(o);
		const s = E(n), i = N2(s, e), a = n0(t, s, o), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
		return L2(r ? b1(c, s, C.From2000) : c, s);
	}
	function F3(t, n, e) {
		const r = E(t);
		let o = wt(n, M0(r)).pos;
		return e || (o = b1(o, r, C.Into2000)), yt(o, r);
	}
	function H3(t, n, e) {
		const r = E(t), o = wt(n, M0(r)), s = new F(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
		return e ? s : k3(s, r, C.Into2000);
	}
	function $3(t, n) {
		const e = M0(t.t);
		let r = [
		...
		return n || (r = J0(r, t.t, C.From2000), r = G0(r, t.t, C.From2000)), C3(r, e);
	}
	function J3(t, n) {
	...
	function Rt(t, n, e) {
		...
		return new O2(new P(r, o, s, t.t), c, a);
	}
	function u1(t) {
	...
	function i0(t) {
		const n = E(t), e = R0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = J0(U3(n, [
	...
	function H1(t) {
		const n = E(t), e = R0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = g0(n), i = yt(G0(m2(s.mobl, o), n, C.From2000), n), a = s.tobl * _, c = Rt(i, Math.cos(a), Math.sin(a));
	...
	function Y0(t, n) {
		const e = n.tt / K0;
		return zt(k2(P0(t[vt], e, !0), P0(t[Dt], e, !1), P0(t[$1], e, !1))).ToAstroVector(n);
	}
	function h1(t, n) {
		const e = n / K0, r = P0(t[vt], e, !0), o = P0(t[Dt], e, !1), s = P0(t[$1], e, !1), i = mt(t[vt], e), a = mt(t[Dt], e), c = mt(t[$1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), p = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, w = k2(r, o, s), g = [
			p / K0,
			M / K0,
			A / K0
		];
	...
	const Pt = 51, Q3 = 29200, W0 = 146, S0 = 201, I0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var d1 = class {
		...
		clone() {
			return new Fn(this.tt, this.r.clone(), this.v.clone(), this.a.clone());
		}
	}, b2 = class {
		constructor(t, n) {
	...
	function Nt(t, n) {
		...
		return new b2(r, new It(t, i, n.v.add(s.mul(e)), r.Acceleration(i)));
	}
	const q3 = [];
	function V2(t, n) {
	...
	function Ut(t) {
		const n = B3(t), e = new d1(n.tt), r = n.r.add(e.Sun.r), o = n.v.add(e.Sun.v), s = e.Acceleration(r);
		return new b2(e, new It(n.tt, r, o, s));
	}
	function K3(t, n) {
		const e = I0[0][0];
		if (n < e || n > I0[Pt - 1][0]) return null;
		const r = V2((n - e) / Q3, Pt - 1);
		if (!t[r]) {
			const s = t[r] = [];
			s[0] = Ut(I0[r]).grav, s[S0 - 1] = Ut(I0[r + 1]).grav;
			let i, a = s[0].tt;
	...
	function Ot(t, n) {
		...
		const s = K3(q3, t.tt);
		if (s) {
			const i = V2((t.tt - s[0].tt) / W0, S0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = j0(t.tt - a.tt, a.r, a.v, u), l = Tt(t.tt - a.tt, a.v, u), d = j0(t.tt - c.tt, c.r, c.v, u), p = Tt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
			e = h.mul(1 - M).add(d.mul(M)), r = l.mul(1 - M).add(p.mul(M));
		} else {
			let i;
			t.tt < I0[0][0] ? i = F2(I0[0], t.tt, -W0) : i = F2(I0[Pt - 1], t.tt, +W0), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
	...
	function Q1(t, n) {
		...
		return Y1(Y3, W3(t, n.mu, r));
	}
	function j3(t) {
		const n = new y0(t);
		return new H2(Q1(n, G1[0]), Q1(n, G1[1]), Q1(n, G1[2]), Q1(n, G1[3]));
	}
	function a0(t, n) {
		var e = E(n);
		...
		if (t === f.EMB) {
			const i = Y0(q.Earth, e), a = i0(e), c = 1 + Mt;
			return new P(i.x + a.x / c, i.y + a.y / c, i.z + a.z / c, e);
		}
		if (t === f.SSB) return G3(e);
		const s = U1(t);
	...
	function N0(t, n) {
		...
		if (e) return e.dist;
		const r = E(n);
		return t in q ? P0(q[t][$1], r.tt / K0, !1) : a0(t, r).Length();
	}
	function $2(t, n) {
		let e = n, r = 0;
		for (let o = 0; o < 10; ++o) {
	...
	function J2(t, n, e, r) {
		...
		if (U1(e)) {
			const a = a0(e, o);
			if (r) {
				const u = B1(n, o), h = new P(a.x - u.x, a.y - u.y, a.z - u.z, o), l = D1 / h.Length();
		...
		const i = new X3(n, e, r, s);
		return $2((a) => i.Position(a), o);
	}
	function n0(t, n, e) {
		T1(e);
		const r = E(n);
	...
	function Z3(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = h1(q[f.Earth], e.tt), s = t === f.Moon ? l1(e) : xt(e);
	...
	function B1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = h1(q.Earth, e.tt), s = t == f.Moon ? l1(e) : xt(e);
	...
	function q1(t, n) {
		...
		let o, s, i, a;
		t === f.Sun ? (i = new P(-r.x, -r.y, -r.z, e), s = new P(0, 0, 0, e), o = 0) : (t === f.Moon ? (i = i0(e), s = new P(r.x + i.x, r.y + i.y, r.z + i.z, e)) : (s = a0(t, n), i = new P(s.x - r.x, s.y - r.y, s.z - r.z, e)), o = N1(i, s));
		let c = i.Length(), u = s.Length(), h;
		if (t === f.Sun) a = _3 + 5 * Math.log10(c);
		else if (t === f.Moon) a = r4(o, u, c);
		else if (t === f.Saturn) {
			const l = e4(o, u, c, i, e);
			a = l.mag, h = l.ring_tilt;
		} else a = n4(t, o, u, c);
		return new Q2(e, a, o, u, c, i, s, h);
	}
	function M1(t) {
	...
	function n1(t, n, e) {
		...
		for (let u = 0; u < 100; ++u) {
			let h = -c / 360 * i;
			if (a = a.AddDays(h), Math.abs(h) * P1 < 1) return a;
			let l = c;
	...
	function q2(t) {
		let n = Ct(t), e = (Math.floor(n / 90) + 1) % 4, r = S1(90 * e, t, 10);
		if (!r) throw "Cannot find moon quarter";
		return new B2(e, r);
	}
	function o4(t) {
		return q2(new Date(t.time.date.getTime() + 6 * p3));
	}
	var K2 = class {
		constructor(t, n, e) {
	...
	function i4(t) {
		switch (t) {
			case f.Sun: return A2;
			case f.Moon: return y3;
			default: return 0;
		}
	}
	function a4(t, n, e, r, o, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = i4(t), a = Y2(n.height - s);
		return W2(t, n, e, r, o, i, s4(n, s) - R3 * a.density);
	}
	function c4(t, n, e, r, o, s) {
	...
	function kt(t, n, e, r, o, s, i) {
		if (s < 0 && i >= 0) return new u4(r, o, s, i);
		if (s >= 0 && i < 0) return null;
		if (t > 17) throw "Excessive recursion in rise/set ascent search.";
		const a = o.ut - r.ut;
		if (a * P1 < 1 || Math.min(Math.abs(s), Math.abs(i)) > e * (a / 2)) return null;
	...
	function f4(t, n, e) {
		const r = E(n), o = I2(r), s = c1(t, r, e, !0, !0);
	...
	function d4(t) {
		function n(e, r, o) {
			let s = new Date(Date.UTC(t, r - 1, o)), i = G2(e, s, 20);
		...
		return new X2(n(0, 3, 10), n(90, 6, 10), n(180, 9, 10), n(270, 12, 10));
	}
	var Z2 = class {
		constructor(t, n, e, r) {
	...
	function tn(t, n) {
		let e = E(n), r = Lt(t, f.Sun, e), o;
		r > 180 ? (o = "morning", r = 360 - r) : o = "evening";
		let s = t1(t, e);
		return new Z2(e, o, s, r);
	}
	function M4(t, n) {
		function r(a) {
	...
	function p4(t, n) {
		...
		const h = en(t, 0, s.AddDays(-2 * u), 4 * u), l = en(t, 1, i.AddDays(-2 * u), 4 * u);
	...
	function rn(t, n) {
		if (n = E(n), t === f.Neptune || t === f.Pluto) return p4(t, n);
		function e(c) {
	...
	function A4(t, n) {
		...
		const e = .25 * s0[t].OrbitalPeriod, r = rn(t, n.time.AddDays(e));
	...
	function y4(t, n) {
		const e = Vt(t);
		return e.lon = on(e.lon), e.lat += p1(n, e.lat), e;
	}
	function g4(t, n, e) {
		n = E(n);
		const r = on(t.lon);
		return K1(new Q0(t.lat + sn(e, t.lat), r, t.dist), n);
	}
	function p1(t, n) {
		let e;
	...
	function W1(t) {
		return t = E(t), m0(L1(t, C.From2000), k1(t, C.From2000));
	}
	function x4(t) {
		const n = E(t);
		return m0(W1(n), Mn(n));
	...
	function j1(t) {
		return t = E(t), m0(k1(t, C.Into2000), L1(t, C.Into2000));
	}
	function Ft(t, n) {
		t = E(t);
	...
	function N4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Ht || (Ht = W1(new y0(-45655.74141261017)), Sn = new y0(0));
		const e = K1(new Q0(n, 15 * t, 1), Sn), r = bt(A1(Ht, e)), o = 10 / 240, s = o / 15;
		for (let i of T4) {
	...
	function E1(t, n, e, r) {
		...
		return new U4(n, o, O * Math.hypot(s, i, a), +s1 - (1 + o) * (s1 - t), -s1 + (1 + o) * (s1 + t), e, r);
	}
	function X1(t) {
		const n = n0(f.Sun, t, !0), e = new P(-n.x, -n.y, -n.z, n.t);
		return E1(w3, t, i0(t), e);
	}
	function An(t) {
	...
	function $t(t, n) {
		const e = N2(t, n), r = n0(f.Sun, t, !0), o = i0(t), s = new P(e[0] - o.x, e[1] - o.y, e[2] - o.z, t);
	...
	function C4(t) {
		const e = J((r) => Jt(An, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Moon shadow time.";
		return An(e);
	}
	function k4(t, n, e) {
		const o = J((s) => O4(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function wn(t, n) {
		const e = new P(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = En(Math.asin(A2 / e.Length()), Math.asin(g3 / n.Length()), N1(n, e) * _);
		...
		for (let r = 0; r < 12; ++r) {
			...
			if (Math.abs(s) < 1.8) {
				...
				if (i.r < i.p + W) {
					...
					return i.r < i.k + W && (a = X.Partial, h = Gt(i.time, i.k + W, l), i.r + W < i.k ? (a = X.Total, c = 1, u = Gt(i.time, i.k - W, h)) : c = En(W, i.k, i.r)), new pn(a, c, i.time, l, h, u);
				}
			}
			e = o.AddDays(10);
		}
	...
	function V4(t) {
		...
		if (p > 0) {
			...
			const z = E1(w2, t.time, I, t.dir);
			if (z.r > 1e-9 || z.r < 0) throw `Unexpected shadow distance from geoid intersection = ${z.r}`;
			n = Rn(z.k), M = n === X.Total ? 1 : wn(t.dir, I);
		} else M = void 0;
		return new gn(n, M, e, r, o, s);
	}
	function F4(t) {
	...
	function $4(t, n) {
		...
		const a = tt(n, 1, Dn, s, t.time), c = tt(n, -1, Dn, t.time, i);
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = tt(n, 1, zn, s, t.time), h = tt(n, -1, zn, t.time, i), l = Rn(t.k)) : l = X.Partial;
		const d = l === X.Total ? 1 : wn(t.dir, t.target);
		return new vn(l, d, a, u, o, h, c);
	}
	...
	function G4(t, n) {
		return t = E(t), In(t.AddDays(10), n);
	}
	var Tn = class {
		constructor(t, n, e, r) {
	...
	function Un(t, n) {
		...
		for (;;) {
			...
			if (t1(t, i) < e) {
				const a = k4(t, o, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-r), u = Nn(t, o, c, a.time, -1), h = a.time.AddDays(+r), l = Nn(t, o, a.time, h, 1), d = 60 * t1(t, a.time);
					return new Tn(u, a.time, l, d);
				}
			}
			s = i.AddDays(10);
		}
	...
	function K4(t) {
		const n = J0(G0([
			...
			0,
			1
		], t, C.Into2000), t, C.Into2000), e = new P(n[0], n[1], n[2], t), r = bt(e), o = 190.41375788700253 + 360.9856122880876 * t.ut;
	...
	function W4(t, n, e, r) {
		...
		let a, c;
		return e === f.Earth && r === f.Moon ? (a = new F(0, 0, 0, 0, 0, 0, o), c = l1(o)) : (a = B1(e, o), c = B1(r, o)), kn(t, a, s, c, i);
	}
	...
	var j4 = class Z {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = j(r, n.tt, f.Mercury, St), e[f.Venus] = j(r, n.tt, f.Venus, _t), e[f.Earth] = j(r, n.tt, f.Earth, a1 + I1), e[f.Mars] = j(r, n.tt, f.Mars, pt), e[f.Jupiter] = j(r, n.tt, f.Jupiter, b0), e[f.Saturn] = j(r, n.tt, f.Saturn, V0), e[f.Uranus] = j(r, n.tt, f.Uranus, F0), e[f.Neptune] = j(r, n.tt, f.Neptune, H0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new T0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = K.zero(), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, i1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, St), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, _t), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, a1 + I1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, pt), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, b0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, V0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, F0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, H0);
		}
		...
		Duplicate() {
			...
			return new bn(this.curr.time, n, e);
		}
	}, bn = class {
		constructor(t, n, e) {
	...
	const { MakeTime: M6, SearchRiseSet: S6, Body: _6, Observer: X4 } = nt(v1);
	new X4(40.7128, -74.006, 10);
	const { Body: e0 } = nt(v1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: w6, CombineRotation: y6, MakeRotation: g6 } = nt(v1);
	Math.PI / (180 * 3600);
	function qt(t, n) {
	...
	const { HelioState: x6 } = nt(v1);
	function t6(t, n, e = ut) {
		const r = {};
		for (const o of e) {
			const s = n[o] ?? [], i = s.length ? Z4(s, t) : null;
			if (i) {
				const a = r3(i);
				r[o] = [
					a.x,
