(function() {
	...
	const r2 = Symbol("Comlink.proxy"), Gn = Symbol("Comlink.endpoint"), Qn = Symbol("Comlink.releaseProxy"), at = Symbol("Comlink.finalizer"), y1 = Symbol("Comlink.thrown"), s2 = (t) => typeof t == "object" && t !== null || typeof t == "function", i2 = new Map([["proxy", {
	...
	function ct(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, d] = m1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), d), i === "RELEASE" && (n.removeEventListener("message", o), a2(n), at in t && typeof t[at] == "function" && t[at]());
			}).catch((h) => {
				const [l, d] = m1({
	...
	const d2 = Object.fromEntries(Object.entries(n3).map(([t, n]) => [t, u3(n)])), ht = [
		D.SUN,
		D.MERCURY,
		D.VENUS,
		D.EARTH,
	...
	const dt = d2[D.SUN]?.radiusKm ?? 696340, h3 = ft / dt, s1 = .04;
	ft / s1;
	s1 / ft / (15 / e3);
	function f3(t) {
	...
	function d3(t) {
		return !Number.isFinite(t) || t <= 0 ? s1 : f3(t / dt);
	}
	d3(dt);
	var D1 = Jn({
		AU_PER_LY: () => M2,
	...
	const I1 = 173.1446326846693, C = 149597870.69098932, M2 = 63241.07708807546, _ = .017453292519943295, Mt = .26179938779914946, b = 57.29577951308232, St = 3.819718634205488, M3 = 71492, S3 = 66854, _3 = 69911, p3 = 1821.6, A3 = 1560.8, E3 = 2631.2, w3 = 2410.3, S2 = 365.24217, _2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), t0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), O0 = 484813681109536e-20, p2 = 10800 * 60, y3 = 2 * p2, A2 = 7292115e-11, g3 = p2 / Math.PI, R3 = -.17 - 5 * Math.log10(g3), z1 = 29.530588, P1 = 24 * 3600, x3 = P1 * 1e3, E2 = .9972695717592592, i1 = 695700, w2 = i1 / C, r0 = .996647180302104, k0 = r0 * r0, d0 = 6378.1366, m3 = d0 / C, v3 = d0 * r0, y2 = 6371, D3 = y2 + 88, I3 = 1738.1 / C, W = 1737.4, g2 = 1736, z3 = g2 / C, P3 = 34 / 60, _t = 81.30056, a1 = .0002959122082855911, pt = 4912547451450812e-26, At = 7243452486162703e-25, c1 = 8887692390113509e-25, Et = 9549535105779258e-26, b0 = 2.825345909524226e-7, V0 = 8.459715185680659e-8, F0 = 1.292024916781969e-8, H0 = 1.524358900784276e-8, T3 = 218869976542597e-26, T1 = c1 / _t;
	function wt(t) {
		switch (t) {
	...
	function R0(t) {
		...
		var h0 = L(.19833 + .05611 * n), jt = L(.27869 + .04508 * n), Xt = L(.16827 - .36903 * n), Zt = L(.34734 - 5.37261 * n), t2 = L(.10498 - 5.37899 * n), st = L(.42681 - .41855 * n), l6 = L(.14943 - 5.37511 * n);
		for (I = .84 * h0 + .31 * jt + 14.27 * Xt + 7.26 * Zt + .28 * t2 + .24 * st, k = 2.94 * h0 + .31 * jt + 14.27 * Xt + 9.34 * Zt + 1.12 * t2 + .83 * st, N = -6.4 * h0 - 1.89 * st, B = .21 * h0 + .31 * jt + 14.27 * Xt - 88.7 * Zt - 15.3 * t2 + .24 * st - 1.86 * l6, G = I - N, p = -3332e-9 * L(.59734 - 5.37261 * n) - 539e-9 * L(.35498 - 5.37899 * n) - 64e-9 * L(.39943 - 5.37511 * n), R = t0 * $0(.60643382 + 1336.85522467 * n - 313e-8 * d) + I / w0, y = t0 * $0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = t0 * $0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = t0 * $0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, P = t0 * $0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (u0(0, h, 1), u0(1, h, Math.cos(c) * u), l0(0, h, 0), l0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) rt(p0(l - 1, h), v0(l - 1, h), p0(1, h), v0(1, h), (T, U) => (u0(l, h, T), l0(l, h, U)));
		...
		function Hn(T, U, V, H) {
			for (var Q = {
				...
				V,
				H
			], A0 = 1; A0 <= 4; ++A0) D0[A0] !== 0 && rt(Q.x, Q.y, p0(D0[A0], A0), v0(D0[A0], A0), (n2, o1) => (Q.x = n2, Q.y = o1));
			return Q;
		}
	...
	function k2(t, n) {
		const e = Rt(t, n), o = e.x * e.x + e.y * e.y, r = Math.sqrt(o + e.z * e.z);
		if (o === 0) {
	...
	function H1(t, n, e, o, r) {
		let s = E(t);
		q0(n), v(e), v(o);
		const i = Math.sin(n.latitude * _), a = Math.cos(n.latitude * _), c = Math.sin(n.longitude * _), u = Math.cos(n.longitude * _), h = Math.sin(o * _), l = Math.cos(o * _), d = Math.sin(e * Mt), p = Math.cos(e * Mt);
		let M = [
			a * u,
			a * c,
			i
		...
		if (r) {
			...
			if (G -= p0, p0 > 0 && G > 3e-4) {
				const v0 = Math.sin(G * _), u0 = Math.cos(G * _), l0 = Math.sin(o0 * _), rt = Math.cos(o0 * _), L = [];
				for (let h0 = 0; h0 < 3; ++h0) L.push((x[h0] - rt * R[h0]) / l0 * v0 + R[h0] * u0);
				N = Math.hypot(L[0], L[1]), N > 0 ? (Y = St * Math.atan2(L[1], L[0]), Y < 0 && (Y += 24)) : Y = 0, c0 = b * Math.atan2(L[2], N);
			}
		}
	...
	function q3(t, n, e) {
		const o = E(t);
		let r = gt(n, M0(o)).pos;
		return e || (r = V1(r, o, O.Into2000)), Rt(r, o);
	}
	function K3(t, n, e) {
		const o = E(t), r = gt(n, M0(o)), s = new F(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
	...
	function $1(t) {
		const n = E(t), e = R0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			...
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = g0(n), i = Rt(G0(D2(s.mobl, r), n, O.From2000), n), a = s.tobl * _, c = mt(i, Math.cos(a), Math.sin(a));
	...
	const K0 = 365250, It = 0, zt = 1, J1 = 2;
	function Pt(t) {
	...
	function Y0(t, n) {
		const e = n.tt / K0;
		return Pt(V2(z0(t[It], e, !0), z0(t[zt], e, !1), z0(t[J1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / K0, o = z0(t[It], e, !0), r = z0(t[zt], e, !1), s = z0(t[J1], e, !1), i = Dt(t[It], e), a = Dt(t[zt], e), c = Dt(t[J1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), d = Math.sin(r), p = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, w = V2(o, r, s), g = [
			p / K0,
			M / K0,
			A / K0
		];
		return new T0(n, Pt(w), Pt(g));
	}
	function G1(t, n, e, o) {
	...
	const Tt = 51, X3 = 29200, W0 = 146, S0 = 201, P0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function Ct(t, n) {
		...
		return new F2(o, new Nt(t, i, n.v.add(s.mul(e)), o.Acceleration(i)));
	}
	const t4 = [];
	function H2(t, n) {
	...
	function Ut(t) {
		...
		return new F2(e, new Nt(n.tt, o, r, s));
	}
	function n4(t, n) {
		const e = P0[0][0];
		if (n < e || n > P0[Tt - 1][0]) return null;
		const o = H2((n - e) / X3, Tt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Ut(P0[o]).grav, s[S0 - 1] = Ut(P0[o + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < S0 - 1; ++i) s[i] = Ct(a += W0, s[i - 1]).grav;
			a = s[S0 - 1].tt;
			var r = [];
			for (r[S0 - 1] = s[S0 - 1], i = S0 - 2; i > 0; --i) r[i] = Ct(a -= W0, r[i + 1]).grav;
			for (i = S0 - 2; i > 0; --i) {
				const c = i / (S0 - 1);
	...
	function Ot(t, n) {
		...
		const s = n4(t4, t.tt);
		if (s) {
			const i = H2((t.tt - s[0].tt) / W0, S0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = j0(t.tt - a.tt, a.r, a.v, u), l = Lt(t.tt - a.tt, a.v, u), d = j0(t.tt - c.tt, c.r, c.v, u), p = Lt(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
			e = h.mul(1 - M).add(d.mul(M)), o = l.mul(1 - M).add(p.mul(M));
		} else {
			let i;
			t.tt < P0[0][0] ? i = $2(P0[0], t.tt, -W0) : i = $2(P0[Tt - 1], t.tt, +W0), e = i.grav.r, o = i.grav.v, r = i.bary;
		}
	...
	function a0(t, n) {
		...
		if (t === f.EMB) {
			const i = Y0(q.Earth, e), a = i0(e), c = 1 + _t;
	...
	function i4(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(q[f.Earth], e.tt), s = t === f.Moon ? h1(e) : vt(e);
	...
	function q1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(q.Earth, e.tt), s = t == f.Moon ? h1(e) : vt(e);
	...
	function Y2(t) {
		let n = bt(t), e = (Math.floor(n / 90) + 1) % 4, o = _1(90 * e, t, 10);
	...
	function V4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Jt || (Jt = j1(new y0(-45655.74141261017)), pn = new y0(0));
		const e = Y1(new Q0(n, 15 * t, 1), pn), o = Ft(E1(Jt, e)), r = 10 / 240, s = r / 15;
		for (let i of b4) {
	...
	function $4(t) {
		const e = J((o) => Qt(Z1, o), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return Z1(e);
	}
	function J4(t) {
		const e = J((o) => Qt(wn, o), t.AddDays(-.03), t.AddDays(.03));
	...
	function Rn(t) {
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				const i = $4(r);
				if (i.r < i.p + W) {
					let a = X.Penumbral, c = 0, u = 0, h = 0, l = Bt(i.time, i.p + W, 200);
					return i.r < i.k + W && (a = X.Partial, h = Bt(i.time, i.k + W, l), i.r + W < i.k ? (a = X.Total, c = 1, u = Bt(i.time, i.k - W, h)) : c = yn(W, i.k, i.r)), new En(a, c, i.time, l, h, u);
				}
			}
			e = r.AddDays(10);
		}
	...
	function n6(t) {
		const n = J0(G0([
			...
			0,
			1
		], t, O.Into2000), t, O.Into2000), e = new z(n[0], n[1], n[2], t), o = Ft(e), r = 190.41375788700253 + 360.9856122880876 * t.ut;
		return new Kt(o.ra, o.dec, r, e);
	}
	function e6(t, n) {
	...
	var r6 = class Z {
		...
		Update(n) {
			...
			if (o === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = j0(o, a.r, a.v, u), c.v = Lt(o, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = j(o, n.tt, f.Mercury, pt), e[f.Venus] = j(o, n.tt, f.Venus, At), e[f.Earth] = j(o, n.tt, f.Earth, c1 + T1), e[f.Mars] = j(o, n.tt, f.Mars, Et), e[f.Jupiter] = j(o, n.tt, f.Jupiter, b0), e[f.Saturn] = j(o, n.tt, f.Saturn, V0), e[f.Uranus] = j(o, n.tt, f.Uranus, F0), e[f.Neptune] = j(o, n.tt, f.Neptune, H0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new T0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = K.zero(), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, pt), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, At), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + T1), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, Et), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, b0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, V0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, F0), Z.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, H0);
		}
