(function() {
	var c2 = Object.defineProperty, jn = (t, n) => {
		let e = {};
	...
	const u2 = Symbol("Comlink.proxy"), Wn = Symbol("Comlink.endpoint"), Xn = Symbol("Comlink.releaseProxy"), ut = Symbol("Comlink.finalizer"), R1 = Symbol("Comlink.thrown"), l2 = (t) => typeof t == "object" && t !== null || typeof t == "function", h2 = new Map([["proxy", {
	...
	const m1 = /* @__PURE__ */ new WeakMap(), v1 = "FinalizationRegistry" in globalThis && new FinalizationRegistry((t) => {
		const n = (m1.get(t) || 0) - 1;
		m1.set(t, n), n === 0 && d2(t);
	});
	function ee(t, n) {
		const e = (m1.get(n) || 0) + 1;
		m1.set(n, e), v1 && v1.register(t, n, t);
	}
	function re(t) {
		v1 && v1.unregister(t);
	}
	...
	}, ue = 149597870.7, le = 648e3 / Math.PI, I1 = 1e4, s1 = 100 / le, he = 16777216, p2 = 3.2615637771694;
	(he - I1) / 20 + s1;
	function _2(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * 20;
	}
	const fe = 5e4, de = 2e3, Me = fe / p2, Se = de / p2;
	_2(Me);
	_2(Se);
	s1 <= 0 || (25 >= s1 ? I1 + (25 - s1) * 20 : 25 / s1 * I1);
	const dt = 1721545, Mt = 3181545;
	function pe(t) {
		return {
			name: t.name,
			type: t.type,
	...
	const A2 = Object.fromEntries(Object.entries(ce).map(([t, n]) => [t, pe(n)]));
	D.SUN, D.MERCURY, D.VENUS, D.EARTH, D.MARS, D.JUPITER, D.SATURN, D.URANUS, D.NEPTUNE, D.PLUTO;
	const St = A2[D.EARTH]?.radiusKm ?? 6371, pt = A2[D.SUN]?.radiusKm ?? 696340, _e = St / pt, i1 = .04 * (100 / 15);
	St / i1;
	i1 / St / (100 / ue);
	function Ae(t) {
		return !Number.isFinite(t) || t <= 0 ? i1 : t / _e * i1;
	}
	function Ee(t) {
		return !Number.isFinite(t) || t <= 0 ? i1 : Ae(t / pt);
	}
	Ee(pt);
	var P1 = jn({
		AU_PER_LY: () => E2,
	...
	const z1 = 173.1446326846693, C = 149597870.69098932, E2 = 63241.07708807546, p = .017453292519943295, _t = .26179938779914946, b = 57.29577951308232, At = 3.819718634205488, ye = 71492, we = 66854, ge = 69911, Re = 1821.6, xe = 1560.8, me = 2631.2, ve = 2410.3, y2 = 365.24217, w2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, g2 = 10800 * 60, De = 2 * g2, R2 = 7292115e-11, Ie = g2 / Math.PI, Pe = -.17 - 5 * Math.log10(Ie), T1 = 29.530588, N1 = 24 * 3600, ze = N1 * 1e3, x2 = .9972695717592592, a1 = 695700, m2 = a1 / C, s0 = .996647180302104, b0 = s0 * s0, M0 = 6378.1366, Te = M0 / C, Ne = M0 * s0, v2 = 6371, Le = v2 + 88, Ce = 1738.1 / C, j = 1737.4, D2 = 1736, Ue = D2 / C, Oe = 34 / 60, Et = 81.30056, c1 = .0002959122082855911, yt = 4912547451450812e-26, wt = 7243452486162703e-25, u1 = 8887692390113509e-25, gt = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, H0 = 1.292024916781969e-8, J0 = 1.524358900784276e-8, ke = 218869976542597e-26, L1 = u1 / Et;
	function Rt(t) {
		switch (t) {
	...
	function x0(t) {
		...
		let i, a, c, u, h, l, d, _, M, A, y, g, R, w, m, x, z, I, k, N, q, G, K, u0 = r(-6, 6, 1, 4), o0 = r(-6, 6, 1, 4);
		function A0(T, U) {
			return o(u0, T, U);
		}
		function D0(T, U) {
		...
		for (I = .84 * f0 + .31 * e2 + 14.27 * r2 + 7.26 * o2 + .28 * s2 + .24 * at, k = 2.94 * f0 + .31 * e2 + 14.27 * r2 + 9.34 * o2 + 1.12 * s2 + .83 * at, N = -6.4 * f0 - 1.89 * at, q = .21 * f0 + .31 * e2 + 14.27 * r2 - 88.7 * o2 - 15.3 * s2 + .24 * at - 1.86 * p4, G = I - N, _ = -3332e-9 * L(.59734 - 5.37261 * n) - 539e-9 * L(.35498 - 5.37899 * n) - 64e-9 * L(.39943 - 5.37511 * n), R = n0 * $0(.60643382 + 1336.85522467 * n - 313e-8 * d) + I / w0, w = n0 * $0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, m = n0 * $0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * $0(.25909118 + 1342.2278298 * n - 892e-8 * d) + q / w0, z = n0 * $0(.82736186 + 1236.85308708 * n - 397e-8 * d) + G / w0, h = 1; h <= 4; ++h) {
			...
			for (l0(0, h, 1), l0(1, h, Math.cos(c) * u), h0(0, h, 0), h0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) it(A0(l - 1, h), D0(l - 1, h), A0(1, h), D0(1, h), (T, U) => (l0(l, h, T), h0(l, h, U)));
		...
		function Yn(T, U, V, H) {
			for (var Q = {
				...
				V,
				H
			], E0 = 1; E0 <= 4; ++E0) I0[E0] !== 0 && it(Q.x, Q.y, A0(I0[E0], E0), D0(I0[E0], E0), (i2, o1) => (Q.x = i2, Q.y = o1));
			return Q;
		}
		function S(T, U, V, H, Q, I0, E0, i2) {
			var o1 = Yn(Q, I0, E0, i2);
			M += T * o1.y, K += U * o1.y, y += V * o1.x, g += H * o1.x;
		}
		...
		function d0(T, U, V, H, Q) {
			return T * Yn(U, V, H, Q).y;
		}
		A = 0, A += d0(-526.069, 0, 0, 1, -2), A += d0(-3.352, 0, 0, 1, -4), A += d0(44.297, 1, 0, 1, -2), A += d0(-6, 1, 0, 1, -4), A += d0(20.599, -1, 0, 1, 0), A += d0(-30.598, -1, 0, 1, -2), A += d0(-24.649, -2, 0, 1, 0), A += d0(-2, -2, 0, 1, -2), A += d0(-22.571, 0, 1, 1, -2), A += d0(10.985, 0, -1, 1, -2), M += .82 * L(.7736 - 62.5512 * n) + .31 * L(.0466 - 125.1025 * n) + .35 * L(.5785 - 25.1042 * n) + .66 * L(.4591 + 1335.8075 * n) + .64 * L(.313 - 91.568 * n) + 1.14 * L(.148 + 1331.2898 * n) + .21 * L(.5918 + 1056.5859 * n) + .44 * L(.5784 + 1322.8595 * n) + .24 * L(.2275 - 5.7374 * n) + .28 * L(.2965 + 2.6929 * n) + .33 * L(.3132 + 6.3368 * n), i = x + K / w0;
	...
	function $1(t, n, e, r, o) {
		let s = E(t);
		Y0(n), v(e), v(r);
		const i = Math.sin(n.latitude * p), a = Math.cos(n.latitude * p), c = Math.sin(n.longitude * p), u = Math.cos(n.longitude * p), h = Math.sin(r * p), l = Math.cos(r * p), d = Math.sin(e * _t), _ = Math.cos(e * _t);
		let M = [
			a * u,
			a * c,
			i
		...
		let G = b * Math.atan2(N, z), K = e, u0 = r;
		if (o) {
			let o0 = G, A0 = E1(o, 90 - G);
			if (G -= A0, A0 > 0 && G > 3e-4) {
				const D0 = Math.sin(G * p), l0 = Math.cos(G * p), h0 = Math.sin(o0 * p), it = Math.cos(o0 * p), L = [];
				for (let f0 = 0; f0 < 3; ++f0) L.push((x[f0] - it * R[f0]) / h0 * D0 + R[f0] * l0);
				N = Math.hypot(L[0], L[1]), N > 0 ? (K = At * Math.atan2(L[1], L[0]), K < 0 && (K += 24)) : K = 0, u0 = b * Math.atan2(L[2], N);
			}
		}
		return new F2(q, 90 - G, K, u0);
	}
	function Y0(t) {
	...
	function $2(t) {
		const n = E(t).AddDays(-1 / z1), e = j0(B.Earth, n), [r, o, s] = H1([
			-e.x,
			-e.y,
			-e.z
		], n, O.From2000), i = p * R0(n).tobl, a = Math.cos(i), c = Math.sin(i);
		return It(new P(r, o, s, n), a, c);
	}
	function l1(t, n, e, r, o) {
		...
		return J2(r ? H1(c, s, O.From2000) : c, s);
	}
	function Ze(t, n, e) {
		const r = E(t);
		let o = mt(n, S0(r)).pos;
	...
	function t3(t, n, e) {
		const r = E(t), o = mt(n, S0(r)), s = new F(o.pos[0], o.pos[1], o.pos[2], o.vel[0], o.vel[1], o.vel[2], r);
		return e ? s : je(s, r, O.Into2000);
	}
	function n3(t, n) {
		const e = S0(t.t);
		let r = [
	...
	function G1(t) {
		const n = E(t), e = x0(n), r = e.distance_au * Math.cos(e.geo_eclip_lat), o = [
			...
			r * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = R0(n), i = vt(Q0(N2(s.mobl, o), n, O.From2000), n), a = s.tobl * p, c = It(i, Math.cos(a), Math.sin(a));
	...
	const K0 = 365250, Tt = 0, Nt = 1, Q1 = 2;
	function Lt(t) {
	...
	function j0(t, n) {
		const e = n.tt / K0;
		return Lt(G2(z0(t[Tt], e, !0), z0(t[Nt], e, !1), z0(t[Q1], e, !1))).ToAstroVector(n);
	}
	function d1(t, n) {
		const e = n / K0, r = z0(t[Tt], e, !0), o = z0(t[Nt], e, !1), s = z0(t[Q1], e, !1), i = zt(t[Tt], e), a = zt(t[Nt], e), c = zt(t[Q1], e), u = Math.cos(r), h = Math.sin(r), l = Math.cos(o), d = Math.sin(o), _ = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, A = +(c * d) + s * l * a, y = G2(r, o, s), g = [
			_ / K0,
			M / K0,
			A / K0
		];
		return new N0(n, Lt(y), Lt(g));
	}
	function q1(t, n, e, r) {
	...
	const Ct = 51, o3 = 29200, W0 = 146, p0 = 201, T0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function kt(t, n) {
		...
		return new Q2(r, new Ut(t, i, n.v.add(s.mul(e)), r.Acceleration(i)));
	}
	const i3 = [];
	function q2(t, n) {
	...
	function bt(t) {
		...
		return new Q2(e, new Ut(n.tt, r, o, s));
	}
	function a3(t, n) {
		const e = T0[0][0];
		if (n < e || n > T0[Ct - 1][0]) return null;
		const r = q2((n - e) / o3, Ct - 1);
		if (!t[r]) {
			const s = t[r] = [];
			s[0] = bt(T0[r]).grav, s[p0 - 1] = bt(T0[r + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < p0 - 1; ++i) s[i] = kt(a += W0, s[i - 1]).grav;
			a = s[p0 - 1].tt;
			var o = [];
			for (o[p0 - 1] = s[p0 - 1], i = p0 - 2; i > 0; --i) o[i] = kt(a -= W0, o[i + 1]).grav;
			for (i = p0 - 2; i > 0; --i) {
				const c = i / (p0 - 1);
	...
	function Vt(t, n) {
		...
		const s = a3(i3, t.tt);
		if (s) {
			const i = q2((t.tt - s[0].tt) / W0, p0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = X0(t.tt - a.tt, a.r, a.v, u), l = Ot(t.tt - a.tt, a.v, u), d = X0(t.tt - c.tt, c.r, c.v, u), _ = Ot(t.tt - c.tt, c.v, u), M = (t.tt - a.tt) / W0;
			e = h.mul(1 - M).add(d.mul(M)), r = l.mul(1 - M).add(_.mul(M));
		} else {
			let i;
			t.tt < T0[0][0] ? i = B2(T0[0], t.tt, -W0) : i = B2(T0[Ct - 1], t.tt, +W0), e = i.grav.r, r = i.grav.v, o = i.bary;
		}
	...
	function l3(t) {
		const n = new g0(t);
		return new Y2(Y1(n, B1[0]), Y1(n, B1[1]), Y1(n, B1[2]), Y1(n, B1[3]));
	}
	function c0(t, n) {
		var e = E(n);
		...
		if (t === f.EMB) {
			const i = j0(B.Earth, e), a = a0(e), c = 1 + Et;
	...
	function L0(t, n) {
		...
		if (e) return e.dist;
		const r = E(n);
		return t in B ? z0(B[t][Q1], r.tt / K0, !1) : c0(t, r).Length();
	}
	function K2(t, n) {
		let e = n, r = 0;
		for (let o = 0; o < 10; ++o) {
	...
	function j2(t, n, e, r) {
		...
		if (O1(e)) {
			const a = c0(e, o);
			if (r) {
				const u = K1(n, o), h = new P(a.x - u.x, a.y - u.y, a.z - u.z, o), l = z1 / h.Length();
	...
	function f3(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = d1(B[f.Earth], e.tt), s = t === f.Moon ? f1(e) : Pt(e);
	...
	function K1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const o = d1(B.Earth, e.tt), s = t == f.Moon ? f1(e) : Pt(e);
	...
	function tn(t) {
		let n = Ht(t), e = (Math.floor(n / 90) + 1) % 4, r = _1(90 * e, t, 10);
		if (!r) throw "Cannot find moon quarter";
		return new Z2(e, r);
	}
	function _3(t) {
		return tn(new Date(t.time.date.getTime() + 6 * ze));
	}
	var nn = class {
		constructor(t, n, e) {
	...
	function y3(t, n, e, r, o, s = 0) {
		...
		const i = E3(t), a = en(n.height - s);
		return rn(t, n, e, r, o, i, A3(n, s) - Oe * a.density);
	}
	...
	function U3(t, n, e) {
		n = E(n);
		const r = fn(t.lon);
		return W1(new q0(t.lat + dn(e, t.lat), r, t.dist), n);
	}
	function E1(t, n) {
		let e;
	...
	function Z1(t) {
		return t = E(t), v0(b1(t, O.From2000), F1(t, O.From2000));
	}
	function k3(t) {
		const n = E(t);
		return v0(Z1(n), wn(n));
	...
	function tt(t) {
		return t = E(t), v0(F1(t, O.Into2000), b1(t, O.Into2000));
	}
	function Qt(t, n) {
		t = E(t);
	...
	function Q3(t, n) {
		...
		t %= 24, t < 0 && (t += 24), qt || (qt = Z1(new g0(-45655.74141261017)), gn = new g0(0));
		const e = W1(new q0(n, 15 * t, 1), gn), r = $t(y1(qt, e)), o = 10 / 240, s = o / 15;
		for (let i of G3) {
	...
	function Y3(t) {
		const e = $((r) => Yt(nt, r), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return nt(e);
	}
	function K3(t) {
		const e = $((r) => Yt(mn, r), t.AddDays(-.03), t.AddDays(.03));
	...
	function Dn(t, n) {
		const e = new P(t.x + n.x, t.y + n.y, t.z + n.z, t.t), r = vn(Math.asin(m2 / e.Length()), Math.asin(Ue / n.Length()), U1(n, e) * p);
	...
	function n4(t, n) {
		...
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = rt(n, 1, Un, s, t.time), h = rt(n, -1, Un, t.time, i), l = zn(t.k)) : l = X.Partial;
	...
	function $n(t) {
		let n = E(t), e = G1(n);
		for (;;) {
			const r = n.AddDays(Jn), o = G1(r);
			if (e.lat * o.lat <= 0) {
				const s = o.lat > e.lat ? _0.Ascending : _0.Descending, i = $((a) => s * G1(a).lat, n, r);
	...
	function c4(t, n) {
		...
		switch (t) {
			...
			case f.Mars:
				...
				break;
			case f.Jupiter:
				const N = p * (99.360714 + 4850.4046 * o), q = p * (175.895369 + 1191.9605 * o), G = p * (300.323162 + 262.5475 * o), K = p * (114.012305 + 6070.2476 * o), u0 = p * (49.511251 + 64.3 * o);
				s = 268.056595 - .006499 * o + 117e-6 * Math.sin(N) + 938e-6 * Math.sin(q) + .001432 * Math.sin(G) + 3e-5 * Math.sin(K) + .00215 * Math.sin(u0), i = 64.495303 + .002413 * o + 5e-5 * Math.cos(N) + 404e-6 * Math.cos(q) + 617e-6 * Math.cos(G) - 13e-6 * Math.cos(K) + 926e-6 * Math.cos(u0), a = 284.95 + 870.536 * r;
				break;
			case f.Saturn:
	...
	function Gn(t, n, e, r, o) {
		...
		if (t === 4 || t === 5) {
			...
			const I = t == 4 ? +i : -i, k = .5 * a + I * w, N = .5 * c + I * m, q = .5 * u + I * x, G = .5 * w - I * a, K = .5 * m - I * c, u0 = .5 * x - I * u, o0 = l * k, A0 = l * N, D0 = l * q, l0 = d * a + _ * c + M * u, h0 = d * w + _ * m + M * x;
			A = new F(o0, A0, D0, l0 * k + h0 * G, l0 * N + h0 * K, l0 * q + h0 * u0, n.t);
		} else {
	...
	var l4 = class t0 {
		...
		Update(n) {
			...
			if (r === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = X0(r, a.r, a.v, u), c.v = Ot(r, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = W(r, n.tt, f.Mercury, yt), e[f.Venus] = W(r, n.tt, f.Venus, wt), e[f.Earth] = W(r, n.tt, f.Earth, u1 + L1), e[f.Mars] = W(r, n.tt, f.Mars, gt), e[f.Jupiter] = W(r, n.tt, f.Jupiter, V0), e[f.Saturn] = W(r, n.tt, f.Saturn, F0), e[f.Uranus] = W(r, n.tt, f.Uranus, H0), e[f.Neptune] = W(r, n.tt, f.Neptune, J0);
			for (let o in e) e[o].r.decr(r.r), e[o].v.decr(r.v);
			return e[f.Sun] = new N0(n.tt, r.r.neg(), r.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Y.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, c1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, yt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, wt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, u1 + L1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, gt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, V0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, H0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, J0);
		}
	...
	const { MakeTime: T4, SearchRiseSet: N4, Body: L4, Observer: h4 } = ot(P1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: k4, CombineRotation: b4, MakeRotation: V4 } = ot(P1);
	Math.PI / (180 * 3600);
	const { HelioState: H4 } = ot(P1), f4 = 86400;
	function qn(t) {
		return t.type === "init" ? {
			type: "init",
	...
	function Bn(t, n) {
		...
		switch (e.type) {
			...
			case "seek": {
				...
				const r = e.jd;
				let o = r;
				(o < 1721545 || o > 3181545) && (console.warn(`[kernel/seek] JD ${o} outside supported range [${dt}, ${Mt}] (years 0-4000 AD); clamping.`), o = Math.max(dt, Math.min(Mt, o)));
				const s = {
					...t,
					jd: o
				}, i = [{
			...
			case "step": {
				...
				const o = t.jd + t.speed * r / f4, s = Math.max(dt, Math.min(Mt, o)), i = {
					...t,
					jd: s
				}, a = [{
					type: "tick",
