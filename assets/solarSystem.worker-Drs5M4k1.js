(function() {
	...
	const T1 = 173.1446326846693, U = 149597870.69098932, E2 = 63241.07708807546, _ = .017453292519943295, St = .26179938779914946, b = 57.29577951308232, _t = 3.819718634205488, M3 = 71492, S3 = 66854, _3 = 69911, A3 = 1821.6, p3 = 1560.8, E3 = 2631.2, y3 = 2410.3, y2 = 365.24217, w2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, w0 = 3600 * (180 / Math.PI), b0 = 484813681109536e-20, g2 = 10800 * 60, w3 = 2 * g2, R2 = 7292115e-11, g3 = g2 / Math.PI, R3 = -.17 - 5 * Math.log10(g3), N1 = 29.530588, L1 = 24 * 3600, m3 = L1 * 1e3, m2 = .9972695717592592, i1 = 695700, x2 = i1 / U, s0 = .996647180302104, H0 = s0 * s0, M0 = 6378.1366, x3 = M0 / U, I3 = M0 * s0, I2 = 6371, v3 = I2 + 88, P3 = 1738.1 / U, j = 1737.4, v2 = 1736, D3 = v2 / U, z3 = 34 / 60, At = 81.30056, a1 = .0002959122082855911, pt = 4912547451450812e-26, Et = 7243452486162703e-25, c1 = 8887692390113509e-25, yt = 9549535105779258e-26, V0 = 2.825345909524226e-7, F0 = 8.459715185680659e-8, K0 = 1.292024916781969e-8, G0 = 1.524358900784276e-8, T3 = 218869976542597e-26, U1 = c1 / At;
	function wt(t) {
		switch (t) {
	...
	function m0(t) {
		...
		function o(T, C, H, F) {
			const J = [];
			for (let P0 = 0; P0 <= C - T; ++P0) J.push(e(H, F));
			return {
				min: T,
				array: J
			};
		...
		let i, a, c, u, h, l, d, A, M, p, y, g, m, w, I, x, z, P, k, N, B, $, W, u0 = o(-6, 6, 1, 4), r0 = o(-6, 6, 1, 4);
		function p0(T, C) {
			return r(u0, T, C);
		}
		function v0(T, C) {
		...
		for (P = .84 * f0 + .31 * Xt + 14.27 * Zt + 7.26 * t2 + .28 * n2 + .24 * ct, k = 2.94 * f0 + .31 * Xt + 14.27 * Zt + 9.34 * t2 + 1.12 * n2 + .83 * ct, N = -6.4 * f0 - 1.89 * ct, B = .21 * f0 + .31 * Xt + 14.27 * Zt - 88.7 * t2 - 15.3 * n2 + .24 * ct - 1.86 * he, $ = P - N, A = -3332e-9 * L(.59734 - 5.37261 * n) - 539e-9 * L(.35498 - 5.37899 * n) - 64e-9 * L(.39943 - 5.37511 * n), m = n0 * $0(.60643382 + 1336.85522467 * n - 313e-8 * d) + P / w0, w = n0 * $0(.37489701 + 1325.55240982 * n + 2565e-8 * d) + k / w0, I = n0 * $0(.99312619 + 99.99735956 * n - 44e-8 * d) + N / w0, x = n0 * $0(.25909118 + 1342.2278298 * n - 892e-8 * d) + B / w0, z = n0 * $0(.82736186 + 1236.85308708 * n - 397e-8 * d) + $ / w0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
			...
			for (l0(0, h, 1), l0(1, h, Math.cos(c) * u), h0(0, h, 0), h0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) at(p0(l - 1, h), v0(l - 1, h), p0(1, h), v0(1, h), (T, C) => (l0(l, h, T), h0(l, h, C)));
			for (l = 1; l <= a; ++l) l0(-l, h, p0(l, h)), h0(-l, h, -v0(l, h));
		}
		function Bn(T, C, H, F) {
			for (var J = {
				x: 1,
				...
				H,
				F
			], E0 = 1; E0 <= 4; ++E0) P0[E0] !== 0 && at(J.x, J.y, p0(P0[E0], E0), v0(P0[E0], E0), (e2, s1) => (J.x = e2, J.y = s1));
			return J;
		}
		function S(T, C, H, F, J, P0, E0, e2) {
			var s1 = Bn(J, P0, E0, e2);
		...
		function d0(T, C, H, F, J) {
			return T * Bn(C, H, F, J).y;
		}
	...
	function K1(t, n, e) {
		return e === O.Into2000 ? J0(B0(t, n, e), n, e) : B0(J0(t, n, e), n, e);
	}
	function $3(t, n, e) {
	...
	function $1(t, n, e, o, r) {
		...
		let $ = b * Math.atan2(N, z), W = e, u0 = o;
		if (r) {
			let r0 = $, p0 = p1(r, 90 - $);
			if ($ -= p0, p0 > 0 && $ > 3e-4) {
				const v0 = Math.sin($ * _), l0 = Math.cos($ * _), h0 = Math.sin(r0 * _), at = Math.cos(r0 * _), L = [];
	...
	function G2(t) {
		const n = E(t).AddDays(-1 / T1), e = j0(Q.Earth, n), [o, r, s] = K1([
			-e.x,
			-e.y,
			-e.z
	...
	function u1(t, n, e, o, r) {
		...
		return K2(o ? K1(c, s, O.From2000) : c, s);
	}
	function Q3(t, n, e) {
		const o = E(t);
		let r = Rt(n, S0(o)).pos;
		return e || (r = K1(r, o, O.Into2000)), mt(r, o);
	}
	function Y3(t, n, e) {
	...
	function q3(t, n) {
		...
		return n || (o = J0(o, t.t, O.From2000), o = B0(o, t.t, O.From2000)), G3(o, e);
	}
	function W3(t, n) {
	...
	function a0(t) {
		const n = E(t), e = m0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = J0(V3(n, [
	...
	function j0(t, n) {
		const e = n.tt / W0;
		return Tt($2(z0(t[Dt], e, !0), z0(t[zt], e, !1), z0(t[B1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / W0, o = z0(t[Dt], e, !0), r = z0(t[zt], e, !1), s = z0(t[B1], e, !1), i = Pt(t[Dt], e), a = Pt(t[zt], e), c = Pt(t[B1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), d = Math.sin(r), A = +(c * l * u) - s * d * u * a - s * l * h * i, M = +(c * l * h) - s * d * h * a + s * l * u * i, p = +(c * d) + s * l * a, y = $2(o, r, s), g = [
			A / W0,
			M / W0,
			p / W0
		];
	...
	function j3(t) {
		...
		return Q1(n, t, f.Jupiter, V0), Q1(n, t, f.Saturn, F0), Q1(n, t, f.Uranus, K0), Q1(n, t, f.Neptune, G0), n;
	}
	...
	var M1 = class {
		...
		Acceleration(t) {
			...
			return n.incr(d1(t, V0, this.Jupiter.r)), n.incr(d1(t, F0, this.Saturn.r)), n.incr(d1(t, K0, this.Uranus.r)), n.incr(d1(t, G0, this.Neptune.r)), n;
		}
	}, Lt = class Qn {
		constructor(n, e, o, r) {
	...
	function Ct(t, n) {
		...
		return new J2(o, new Lt(t, i, n.v.add(s.mul(e)), o.Acceleration(i)));
	}
	const t4 = [];
	function B2(t, n) {
	...
	function Ot(t) {
		...
		return new J2(e, new Lt(n.tt, o, r, s));
	}
	function n4(t, n) {
		const e = T0[0][0];
	...
	function j2(t, n, e) {
		...
		v(t), v(e);
		let r = E(n);
		return G(o, r, r.AddDays(e), { dt_tolerance_seconds: .01 });
	}
	function bt(t, n, e) {
	...
	function _1(t, n, e) {
		...
		return G(o, s.AddDays(c), s.AddDays(u), { dt_tolerance_seconds: .1 });
	}
	var Z2 = class {
		constructor(t, n) {
	...
	function v4(t, n, e) {
		...
		return u[i][i] = r * t.rot[i][i] - s * t.rot[i][a], u[i][a] = s * t.rot[i][i] + r * t.rot[i][a], u[i][c] = t.rot[i][c], u[a][i] = r * t.rot[a][i] - s * t.rot[a][a], u[a][a] = s * t.rot[a][i] + r * t.rot[a][a], u[a][c] = t.rot[a][c], u[c][i] = r * t.rot[c][i] - s * t.rot[c][a], u[c][a] = s * t.rot[c][i] + r * t.rot[c][a], u[c][c] = t.rot[c][c], new K(u);
	}
	function X1(t, n) {
		n = E(n);
	...
	function H4(t, n) {
		...
		const e = X1(new Q0(n, 15 * t, 1), gn), o = Ft(E1($t, e)), r = 10 / 240, s = r / 15;
		for (let i of b4) {
	...
	function K4(t) {
		const e = G((o) => Bt(et, o), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return et(e);
	}
	function G4(t) {
		const e = G((o) => Bt(xn, o), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Moon shadow time.";
		return xn(e);
	}
	function $4(t, n, e) {
		const r = G((s) => F4(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function J4(t, n) {
		...
		const i = G((a) => Bt(s, a), o, r);
		if (!i) throw `PeakLocalMoonShadow: search failure for search_center_time = ${t}`;
		return Jt(i, n);
	}
	function Qt(t, n, e) {
		const o = e / 1440, r = t.AddDays(-o), s = t.AddDays(+o), i = G((c) => -(et(c).r - n), r, t), a = G((c) => +(et(c).r - n), t, s);
	...
	function Gn(t) {
		let n = E(t), e = J1(n);
		for (;;) {
			const o = n.AddDays(Kn), r = J1(o);
			if (e.lat * r.lat <= 0) {
				const s = r.lat > e.lat ? A0.Ascending : A0.Descending, i = G((a) => s * J1(a).lat, n, o);
	...
	function ee(t, n) {
		...
		switch (t) {
			...
			case f.Mars:
				...
				break;
			case f.Jupiter:
				const N = _ * (99.360714 + 4850.4046 * r), B = _ * (175.895369 + 1191.9605 * r), $ = _ * (300.323162 + 262.5475 * r), W = _ * (114.012305 + 6070.2476 * r), u0 = _ * (49.511251 + 64.3 * r);
				s = 268.056595 - .006499 * r + 117e-6 * Math.sin(N) + 938e-6 * Math.sin(B) + .001432 * Math.sin($) + 3e-5 * Math.sin(W) + .00215 * Math.sin(u0), i = 64.495303 + .002413 * r + 5e-5 * Math.cos(N) + 404e-6 * Math.cos(B) + 617e-6 * Math.cos($) - 13e-6 * Math.cos(W) + 926e-6 * Math.cos(u0), a = 284.95 + 870.536 * o;
				break;
			case f.Saturn:
	...
	function oe(t, n, e, o) {
		...
		let a, c;
		return e === f.Earth && o === f.Moon ? (a = new V(0, 0, 0, 0, 0, 0, r), c = h1(r)) : (a = W1(e, r), c = W1(o, r)), $n(t, a, s, c, i);
	}
	function $n(t, n, e, o, r) {
		...
		if (t === 4 || t === 5) {
			...
			const P = t == 4 ? +i : -i, k = .5 * a + P * w, N = .5 * c + P * I, B = .5 * u + P * x, $ = .5 * w - P * a, W = .5 * I - P * c, u0 = .5 * x - P * u, r0 = l * k, p0 = l * N, v0 = l * B, l0 = d * a + A * c + M * u, h0 = d * w + A * I + M * x;
			p = new V(r0, p0, v0, l0 * k + h0 * $, l0 * N + h0 * W, l0 * B + h0 * u0, n.t);
		} else {
	...
	var re = class t0 {
		...
		static CalcSolarSystem(n) {
			...
			e[f.Mercury] = X(o, n.tt, f.Mercury, pt), e[f.Venus] = X(o, n.tt, f.Venus, Et), e[f.Earth] = X(o, n.tt, f.Earth, c1 + U1), e[f.Mars] = X(o, n.tt, f.Mars, yt), e[f.Jupiter] = X(o, n.tt, f.Jupiter, V0), e[f.Saturn] = X(o, n.tt, f.Saturn, F0), e[f.Uranus] = X(o, n.tt, f.Uranus, K0), e[f.Neptune] = X(o, n.tt, f.Neptune, G0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new N0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Y.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, a1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, Et), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, c1 + U1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, yt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, V0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, F0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, K0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, G0);
		}
	...
	const { MakeTime: Ce, SearchRiseSet: Oe, Body: ke, Observer: se } = st(z1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: Fe, CombineRotation: Ke, MakeRotation: Ge } = st(z1);
	Math.PI / (180 * 3600);
	function it(t, n) {
