(function() {
	var i2 = Object.defineProperty, le = (t, n) => {
		let e = {};
		for (var o in t) i2(e, o, {
			get: t[o],
			enumerable: !0
		});
	...
	180 / Math.PI;
	const ut = 86400, de = 365.25, c2 = ut * 1e3, u2 = 2451545, l2 = 2440587.5, m0 = 299792.458, lt = m0 * de * ut, T = 149597870.7, ht = 648e3 / Math.PI, Ae = ht * T / lt, Se = 23.4392911, _e = 1e3, Ee = m0, pe = m0 ** Math.sqrt(Math.E), ye = m0 ** 2, me = m0 ** Math.E, Re = [
		1,
		_e,
		Ee,
		pe
	...
	var x1 = (t, n, e) => Object.defineProperty(t, n, {
		value: e,
		enumerable: !1,
		writable: !0,
		configurable: !0
		...
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				x1(r, we, n), x1(r, Te, o), x1(r, Ne, !0), t.pairsMap.set(o, r);
			}
	...
	const E2 = Symbol("Comlink.proxy"), r3 = Symbol("Comlink.endpoint"), s3 = Symbol("Comlink.releaseProxy"), dt = Symbol("Comlink.finalizer"), g1 = Symbol("Comlink.thrown"), p2 = (t) => typeof t == "object" && t !== null || typeof t == "function", y2 = /* @__PURE__ */ new Map([["proxy", {
	...
	function Mt(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			const { id: s, type: a, path: c } = Object.assign({ path: [] }, r.data), i = (r.data.argumentList || []).map(O0);
			let u;
			try {
				const l = c.slice(0, -1).reduce((M, y) => M[y], t), h = c.reduce((M, y) => M[y], t);
				switch (a) {
					case "GET":
						u = h;
						break;
					case "SET":
						l[c.slice(-1)[0]] = O0(r.data.value), u = !0;
						break;
					case "APPLY":
						u = h.apply(l, i);
						break;
			...
			Promise.resolve(u).catch((l) => ({
				...
				const [h, M] = D1(l);
				n.postMessage(Object.assign(Object.assign({}, h), { id: s }), M), a === "RELEASE" && (n.removeEventListener("message", o), m2(n), dt in t && typeof t[dt] == "function" && t[dt]());
			}).catch((l) => {
				const [h, M] = D1({
	...
	function At(t, n, e = [], o = function() {}) {
		...
		const s = new Proxy(o, {
			...
			apply(a, c, i) {
				...
				if (u === r3) return L0(t, n, { type: "ENDPOINT" }).then(O0);
	...
	function D1(t) {
		for (const [n, e] of y2) if (e.canHandle(t)) {
	...
	function O0(t) {
		switch (t.type) {
			case "HANDLER": return y2.get(t.name).deserialize(t.value);
	...
	const O1 = 173.1446326846693, z = 149597870.69098932, g2 = 63241.07708807546, _ = .017453292519943295, St = .26179938779914946, k = 57.29577951308232, _t = 3.819718634205488, A3 = 71492, S3 = 66854, _3 = 69911, E3 = 1821.6, p3 = 1560.8, y3 = 2631.2, m3 = 2410.3, w2 = 365.24217, T2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), n0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, N2 = 10800 * 60, R3 = 2 * N2, I3 = 7292115e-11, x3 = N2 / Math.PI, g3 = -.17 - 5 * Math.log10(x3), U1 = 29.530588, v1 = 24 * 3600, w3 = v1 * 1e3, D2 = .9972695717592592, Et = 695700, O2 = Et / z, s0 = .996647180302104, B0 = s0 * s0, M0 = 6378.1366, T3 = M0 / z, N3 = M0 * s0, D3 = 6371, O3 = 6459, U3 = 1738.1 / z, X = 1737.4, U2 = 1736, v3 = U2 / z, P3 = 34 / 60, z3 = 81.30056, c1 = .0002959122082855911, pt = 4912547451450812e-26, yt = 7243452486162703e-25, v2 = 8887692390113509e-25, mt = 9549535105779258e-26, K0 = 2.825345909524226e-7, H0 = 8.459715185680659e-8, J0 = 1.292024916781969e-8, V0 = 1.524358900784276e-8, C3 = 218869976542597e-26, b3 = v2 / z3;
	function Rt(t) {
		switch (t) {
	...
	function g0(t) {
		...
		function o(U, C, K, J) {
			const $ = [];
			for (let D0 = 0; D0 <= C - U; ++D0) $.push(e(K, J));
			return {
				min: U,
				array: $
			};
		...
		let a, c, i, u, l, h, M, y, A, p, x, R, E, I, w, g, D, v, L, B, Q, G, q, u0 = o(-6, 6, 1, 4), r0 = o(-6, 6, 1, 4);
		function E0(U, C) {
			return r(u0, U, C);
		}
		function l0(U, C) {
		...
		var f0 = P(.19833 + .05611 * n), n2 = P(.27869 + .04508 * n), e2 = P(.16827 - .36903 * n), o2 = P(.34734 - 5.37261 * n), r2 = P(.10498 - 5.37899 * n), it = P(.42681 - .41855 * n), U6 = P(.14943 - 5.37511 * n);
		for (v = .84 * f0 + .31 * n2 + 14.27 * e2 + 7.26 * o2 + .28 * r2 + .24 * it, L = 2.94 * f0 + .31 * n2 + 14.27 * e2 + 9.34 * o2 + 1.12 * r2 + .83 * it, B = -6.4 * f0 - 1.89 * it, Q = .21 * f0 + .31 * n2 + 14.27 * e2 - 88.7 * o2 - 15.3 * r2 + .24 * it - 1.86 * U6, G = v - B, y = -3332e-9 * P(.59734 - 5.37261 * n) - 539e-9 * P(.35498 - 5.37899 * n) - 64e-9 * P(.39943 - 5.37511 * n), E = n0 * F0(.60643382 + 1336.85522467 * n - 313e-8 * M) + v / R0, I = n0 * F0(.37489701 + 1325.55240982 * n + 2565e-8 * M) + L / R0, w = n0 * F0(.99312619 + 99.99735956 * n - 44e-8 * M) + B / R0, g = n0 * F0(.25909118 + 1342.2278298 * n - 892e-8 * M) + Q / R0, D = n0 * F0(.82736186 + 1236.85308708 * n - 397e-8 * M) + G / R0, l = 1; l <= 4; ++l) {
			switch (l) {
				case 1:
				...
				case 2:
					...
					break;
				case 3:
					i = g, c = 4, u = 1.000002708 + 139.978 * y;
					break;
				case 4:
					i = D, c = 6, u = 1;
					break;
			...
			for (h0(0, l, 1), h0(1, l, Math.cos(i) * u), N0(0, l, 0), N0(1, l, Math.sin(i) * u), h = 2; h <= c; ++h) s1(E0(h - 1, l), l0(h - 1, l), E0(1, l), l0(1, l), (U, C) => (h0(h, l, U), N0(h, l, C)));
		...
		function ce(U, C, K, J) {
			for (var $ = {
				...
				K,
				J
			], p0 = 1; p0 <= 4; ++p0) D0[p0] !== 0 && s1($.x, $.y, E0(D0[p0], p0), l0(D0[p0], p0), (s2, a1) => ($.x = s2, $.y = a1));
			return $;
		}
		function S(U, C, K, J, $, D0, p0, s2) {
			var a1 = ce($, D0, p0, s2);
			A += U * a1.y, q += C * a1.y, x += K * a1.x, R += J * a1.x;
		}
		...
		p = 0, p += d0(-526.069, 0, 0, 1, -2), p += d0(-3.352, 0, 0, 1, -4), p += d0(44.297, 1, 0, 1, -2), p += d0(-6, 1, 0, 1, -4), p += d0(20.599, -1, 0, 1, 0), p += d0(-30.598, -1, 0, 1, -2), p += d0(-24.649, -2, 0, 1, 0), p += d0(-2, -2, 0, 1, -2), p += d0(-22.571, 0, 1, 1, -2), p += d0(10.985, 0, -1, 1, -2), A += .82 * P(.7736 - 62.5512 * n) + .31 * P(.0466 - 125.1025 * n) + .35 * P(.5785 - 25.1042 * n) + .66 * P(.4591 + 1335.8075 * n) + .64 * P(.313 - 91.568 * n) + 1.14 * P(.148 + 1331.2898 * n) + .21 * P(.5918 + 1056.5859 * n) + .44 * P(.5784 + 1322.8595 * n) + .24 * P(.2275 - 5.7374 * n) + .28 * P(.2965 + 2.6929 * n) + .33 * P(.3132 + 6.3368 * n), a = g + q / R0;
		let v6 = (1.000002708 + 139.978 * y) * (18519.699999999997 + x) * Math.sin(a) - 6.24 * Math.sin(3 * a) + p;
		return {
			geo_eclip_lon: n0 * F0((E + A / R0) / n0),
			geo_eclip_lat: Math.PI / (180 * 3600) * v6,
			distance_au: R0 * T3 / (.999953253 * R)
		};
	}
	var B2 = class {
	...
	function L1(t, n) {
		...
		o *= k0, r *= k0, s *= k0, a *= k0;
		const c = Math.sin(o), i = Math.cos(o), u = Math.sin(-r), l = Math.cos(-r), h = Math.sin(-s), M = Math.cos(-s), y = Math.sin(a), A = Math.cos(a), p = A * l - u * y * M, x = A * u * i + y * M * l * i - c * y * h, R = A * u * c + y * M * l * c + i * y * h, E = -y * l - u * A * M, I = -y * u * i + A * M * l * i - c * A * h, w = -y * u * c + A * M * l * c + i * A * h, g = u * h, D = -h * l * i - c * M, v = -h * l * c + M * i;
	...
	function j3(t, n) {
		...
		if (s < 1e-6) a = 0, c = r > 0 ? 90 : -90, i = Math.abs(r) - N3;
			...
			for (;;) {
				...
				const p = (B0 - 1) * M0, x = l * l, R = h * h, E = x + B0 * R;
				M = Math.sqrt(E);
				const I = p * h * l / M - r * l + s * h;
				if (Math.abs(I) < 1e-8) break;
				const w = p * ((x - R) / M - R * x * (B0 - 1) / (p * E)) + r * h + s * l;
				u -= I / w;
			}
			c = k * u;
			const A = M0 / M;
			Math.abs(h) > Math.abs(l) ? i = r / h - B0 * A : i = s / l - A;
		}
		return new wt(c, a, 1e3 * i);
	}
	function xt(t, n) {
		const e = t.latitude * _, o = Math.sin(e), r = Math.cos(e), s = 1 / Math.hypot(r, s0 * o), a = B0 * s, c = t.height / 1e3, i = M0 * s + c, u = M0 * a + c, l = (15 * n + t.longitude) * _, h = Math.sin(l), M = Math.cos(l);
		return {
			pos: [
				i * r * M / z,
				i * r * h / z,
	...
	function B1(t, n) {
		const e = x0(t), o = e.mobl * _, r = e.tobl * _, s = e.dpsi * k0, a = Math.cos(o), c = Math.sin(o), i = Math.cos(r), u = Math.sin(r), l = Math.cos(s), h = Math.sin(s), M = l, y = -h * a, A = -h * c, p = h * i, x = l * a * i + c * u, R = l * c * i - a * u, E = h * u, I = l * a * u - c * i, w = l * c * u + a * i;
		if (n === b.From2000) return new V([
			[
				M,
				p,
	...
	function K1(t, n, e) {
		return e === b.Into2000 ? G0($0(t, n, e), n, e) : $0(G0(t, n, e), n, e);
	}
	function Q3(t, n, e) {
		return e === b.Into2000 ? H2(V2(t, n, e), n, e) : V2(H2(t, n, e), n, e);
	}
	function F2(t, n) {
		const e = xt(n, A0(t)).pos;
	...
	function J1(t, n, e, o, r) {
		let s = m(t);
		Q0(n), N(e), N(o);
		const a = Math.sin(n.latitude * _), c = Math.cos(n.latitude * _), i = Math.sin(n.longitude * _), u = Math.cos(n.longitude * _), l = Math.sin(o * _), h = Math.cos(o * _), M = Math.sin(e * St), y = Math.cos(e * St);
		let A = [
			c * u,
			c * i,
			a
		...
		const R = -15 * A0(s);
		let E = j0(R, A), I = j0(R, p), w = j0(R, x), g = [
			h * y,
			h * M,
			l
		];
		...
		if (r) {
			let r0 = G, E0 = E1(r, 90 - G);
			if (G -= E0, E0 > 0 && G > 3e-4) {
				const l0 = Math.sin(G * _), h0 = Math.cos(G * _), N0 = Math.sin(r0 * _), s1 = Math.cos(r0 * _), P = [];
				for (let f0 = 0; f0 < 3; ++f0) P.push((g[f0] - s1 * E[f0]) / N0 * l0 + E[f0] * h0);
				B = Math.hypot(P[0], P[1]), B > 0 ? (q = _t * Math.atan2(P[1], P[0]), q < 0 && (q += 24)) : q = 0, u0 = k * Math.atan2(P[2], B);
			}
		}
	...
	function j2(t) {
		const n = m(t).AddDays(-1 / O1), e = X0(Y.Earth, n), [o, r, s] = K1([
			-e.x,
			-e.y,
			-e.z
		], n, b.From2000), a = _ * x0(n).tobl, c = Math.cos(a), i = Math.sin(a);
		return Tt(new O(o, r, s, n), c, i);
	}
	function u1(t, n, e, o, r) {
		Q0(e), P1(o), P1(r);
		const s = m(n), a = F2(s, e), c = e0(t, s, r), i = [
			c.x - a[0],
			c.y - a[1],
			c.z - a[2]
		];
	...
	function W3(t, n, e) {
		const o = m(t);
		let r = xt(n, A0(o)).pos;
		return e || (r = K1(r, o, b.Into2000)), gt(r, o);
	}
	function Z3(t, n, e) {
		const o = m(t), r = xt(n, A0(o)), s = new H(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
	...
	function t4(t, n) {
		...
		return n || (o = G0(o, t.t, b.From2000), o = $0(o, t.t, b.From2000)), j3(o, e);
	}
	function n4(t, n) {
	...
	function l1(t) {
		const n = x0(t.t), [e, o, r] = $0(G0([
			t.x,
			t.y,
			t.z
		], t.t, b.From2000), t.t, b.From2000), s = new O(e, o, r, t.t), a = n.tobl * _;
		return Tt(s, Math.cos(a), Math.sin(a));
	}
	function i0(t) {
		const n = m(t), e = g0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = G0(G3(n, [
	...
	function V1(t) {
		const n = m(t), e = g0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			o * Math.cos(e.geo_eclip_lon),
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = x0(n), a = gt($0(L2(s.mobl, r), n, b.From2000), n), c = s.tobl * _, i = Tt(a, Math.cos(c), Math.sin(c));
		return new Y0(i.elat, i.elon, e.distance_au);
	}
	function h1(t) {
		const n = m(t), e = 1e-5, o = n.AddDays(-1e-5), r = n.AddDays(1e-5), s = i0(o), a = i0(r);
		return new H((s.x + a.x) / 2, (s.y + a.y) / 2, (s.z + a.z) / 2, (a.x - s.x) / (2 * e), (a.y - s.y) / (2 * e), (a.z - s.z) / (2 * e), n);
	}
	function Nt(t) {
		const n = m(t), e = h1(n), o = 82.30056;
	...
	const q0 = 365250, Ot = 0, Ut = 1, F1 = 2;
	function vt(t) {
	...
	function X0(t, n) {
		const e = n.tt / q0;
		return vt(Q2(U0(t[Ot], e, !0), U0(t[Ut], e, !1), U0(t[F1], e, !1))).ToAstroVector(n);
	}
	function f1(t, n) {
		const e = n / q0, o = U0(t[Ot], e, !0), r = U0(t[Ut], e, !1), s = U0(t[F1], e, !1), a = Dt(t[Ot], e), c = Dt(t[Ut], e), i = Dt(t[F1], e), u = Math.cos(o), l = Math.sin(o), h = Math.cos(r), M = Math.sin(r), y = +(i * h * u) - s * M * u * c - s * h * l * a, A = +(i * h * l) - s * M * l * c + s * h * u * a, p = +(i * M) + s * h * c, x = Q2(o, r, s), R = [
			y / q0,
			A / q0,
			p / q0
		];
		return new P0(n, vt(x), vt(R));
	}
	function G1(t, n, e, o) {
		const r = o / (o + c1), s = X0(Y[e], n);
		t.x += r * s.x, t.y += r * s.y, t.z += r * s.z;
	}
	function e4(t) {
		const n = new O(0, 0, 0, t);
		return G1(n, t, f.Jupiter, K0), G1(n, t, f.Saturn, H0), G1(n, t, f.Uranus, J0), G1(n, t, f.Neptune, V0), n;
	}
	const Pt = 51, o4 = 29200, $1 = 146, S0 = 201, v0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	function r4(t) {
		let [n, [e, o, r], [s, a, c]] = t;
		return new P0(n, new j(e, o, r), new j(s, a, c));
	}
	function W(t, n, e, o) {
		const r = o / (o + c1), s = f1(Y[e], n);
	...
	var M1 = class {
		constructor(t) {
			...
			this.Jupiter = W(n, t, f.Jupiter, K0), this.Saturn = W(n, t, f.Saturn, H0), this.Uranus = W(n, t, f.Uranus, J0), this.Neptune = W(n, t, f.Neptune, V0), this.Jupiter.r.decr(n.r), this.Jupiter.v.decr(n.v), this.Saturn.r.decr(n.r), this.Saturn.v.decr(n.v), this.Uranus.r.decr(n.r), this.Uranus.v.decr(n.v), this.Neptune.r.decr(n.r), this.Neptune.v.decr(n.v), this.Sun = new P0(t, n.r.mul(-1), n.v.mul(-1));
		}
		Acceleration(t) {
			let n = d1(t, c1, this.Sun.r);
			return n.incr(d1(t, K0, this.Jupiter.r)), n.incr(d1(t, H0, this.Saturn.r)), n.incr(d1(t, J0, this.Uranus.r)), n.incr(d1(t, V0, this.Neptune.r)), n;
		}
	}, zt = class ue {
		constructor(n, e, o, r) {
	...
	function bt(t, n) {
		const e = t - n.tt, o = new M1(t), r = W0(e, n.r, n.v, n.a), s = o.Acceleration(r).mean(n.a), a = W0(e, n.r, n.v, s);
		return new q2(o, new zt(t, a, n.v.add(s.mul(e)), o.Acceleration(a)));
	}
	const s4 = [];
	function X2(t, n) {
	...
	function Lt(t) {
		const n = r4(t), e = new M1(n.tt), o = n.r.add(e.Sun.r), r = n.v.add(e.Sun.v), s = e.Acceleration(o);
		return new q2(e, new zt(n.tt, o, r, s));
	}
	function a4(t, n) {
		const e = v0[0][0];
		if (n < e || n > v0[Pt - 1][0]) return null;
		const o = X2((n - e) / o4, Pt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Lt(v0[o]).grav, s[S0 - 1] = Lt(v0[o + 1]).grav;
			let a, c = s[0].tt;
			for (a = 1; a < S0 - 1; ++a) s[a] = bt(c += $1, s[a - 1]).grav;
			c = s[S0 - 1].tt;
			var r = [];
			for (r[S0 - 1] = s[S0 - 1], a = S0 - 2; a > 0; --a) r[a] = bt(c -= $1, r[a + 1]).grav;
			for (a = S0 - 2; a > 0; --a) {
				const i = a / (S0 - 1);
	...
	function kt(t, n) {
		...
		const s = a4(s4, t.tt);
		if (s) {
			const a = X2((t.tt - s[0].tt) / $1, S0 - 1), c = s[a], i = s[a + 1], u = c.a.mean(i.a), l = W0(t.tt - c.tt, c.r, c.v, u), h = Ct(t.tt - c.tt, c.v, u), M = W0(t.tt - i.tt, i.r, i.v, u), y = Ct(t.tt - i.tt, i.v, u), A = (t.tt - c.tt) / $1;
			e = l.mul(1 - A).add(M.mul(A)), o = h.mul(1 - A).add(y.mul(A));
		} else {
			let a;
			t.tt < v0[0][0] ? a = W2(v0[0], t.tt, -146) : a = W2(v0[Pt - 1], t.tt, 146), e = a.grav.r, o = a.grav.v, r = a.bary;
		}
	...
	function c0(t, n) {
		...
		if (t === f.Moon) {
			var o = X0(Y.Earth, e), r = i0(e);
			return new O(o.x + r.x, o.y + r.y, o.z + r.z, e);
		}
		if (t === f.EMB) {
			const a = X0(Y.Earth, e), c = i0(e), i = 82.30056;
	...
	function z0(t, n) {
		...
		if (e) return e.dist;
		const o = m(n);
		return t in Y ? U0(Y[t][F1], o.tt / q0, !1) : c0(t, o).Length();
	}
	function tn(t, n) {
		let e = n, o = 0;
		for (let r = 0; r < 10; ++r) {
			const s = t(e), a = s.Length() / O1;
	...
	function nn(t, n, e, o) {
		...
		if (C1(e)) {
			const c = c0(e, r);
			if (o) {
				const u = Q1(n, r), l = new O(c.x - u.x, c.y - u.y, c.z - u.z, r), h = O1 / l.Length();
	...
	function h4(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(Y[f.Earth], e.tt), s = t === f.Moon ? h1(e) : Nt(e);
	...
	function Q1(t, n) {
		...
		switch (t) {
			...
			case f.Moon:
			case f.EMB:
				const r = f1(Y.Earth, e.tt), s = t == f.Moon ? h1(e) : Nt(e);
	...
	function Bt(t, n, e) {
		...
		const o = m(e), r = l1(e0(t, o, !1)), s = l1(e0(n, o, !1));
	...
	function M4(t, n, e, o, r) {
		const s = l1(o), a = _ * 28.06, c = _ * (169.51 + 382e-7 * r.tt), i = _ * s.elat, u = _ * s.elon, l = Math.asin(Math.sin(i) * Math.cos(a) - Math.cos(i) * Math.sin(a) * Math.sin(u - c)), h = Math.sin(Math.abs(l));
		let M = -9 + .044 * t;
	...
	function e1(t, n, e) {
		...
		function s(u) {
			const l = b0(t, u), h = b0(f.Earth, u);
			return Z0(r * (h - l) - n);
		}
		let a = A1(t), c = m(e), i = s(c);
		i > 0 && (i -= 360);
		for (let u = 0; u < 100; ++u) {
			let l = -i / 360 * a;
			if (c = c.AddDays(l), Math.abs(l) * v1 < 1) return c;
			let h = i;
	...
	function S1(t, n, e) {
		...
		let a = o(s), c, i, u;
		if (e < 0) {
			if (a < 0 && (a += 360), c = -(U1 * a) / 360, u = c + r, u < e) return null;
			i = Math.max(e, c - r);
		} else {
			if (a > 0 && (a -= 360), c = -(U1 * a) / 360, i = c - r, i > e) return null;
			u = Math.min(e, c + r);
		}
	...
	function Ht(t, n, e, o, r, s, a) {
		if (s < 0 && a >= 0) return new m4(o, r, s, a);
		if (s >= 0 && a < 0) return null;
		if (t > 17) throw "Excessive recursion in rise/set ascent search.";
		const c = r.ut - o.ut;
		if (c * v1 < 1 || Math.min(Math.abs(s), Math.abs(a)) > e * (c / 2)) return null;
		const i = new I0((o.ut + r.ut) / 2), u = n(i);
		return Ht(1 + t, n, e, o, i, s, u) || Ht(1 + t, n, e, i, r, u, a);
	}
	function R4(t, n) {
	...
	function un(t, n, e, o, r, s, a) {
		if (Q0(n), N(r), N(s), N(a), a < -90 || a > 90) throw `Invalid target altitude angle: ${a}`;
		const c = R4(t, n.latitude);
		function i(A) {
			const p = u1(t, A, n, !0, !0);
			return e * (J1(A, n, p.ra, p.dec).altitude + k * Math.asin(s / p.dist) - a);
		}
		const u = m(o);
		let l = u, h = u, M = i(l), y = M;
		for (;;) {
			r < 0 ? (l = h.AddDays(-.42), M = i(l)) : (h = l.AddDays(.42), y = i(h));
			const A = Ht(0, i, c, l, h, M, y);
			if (A) {
	...
	function x4(t, n, e) {
		const o = m(n), r = J2(o), s = u1(t, o, e, !0, !0);
	...
	function w4(t, n) {
		...
		for (; ++a <= 2;) {
			...
			if (!x) throw `SearchMaxElongation: failed search iter ${a} (t1=${M.toString()}, t2=${y.toString()})`;
	...
	function An(t, n, e, o) {
		const r = n === w0.Apocenter ? 1 : -1, s = 10;
		for (;;) {
			const a = o / (s - 1);
			if (a < 1 / 1440) {
				const u = e.AddDays(a / 2);
				return new _1(u, n, z0(t, u));
			}
			let c = -1, i = 0;
			for (let u = 0; u < s; ++u) {
				const l = r * z0(t, e.AddDays(u * a));
				(u == 0 || l > i) && (c = u, i = l);
			}
	...
	function D4(t, n) {
		...
		for (let M = 0; M < 100; ++M) {
			const y = o.AddDays(M * u), A = z0(t, y);
			M === 0 ? i = c = A : (A > i && (i = A, a = y), A < c && (c = A, s = y));
		}
	...
	function Sn(t, n) {
		if (n = m(n), t === f.Neptune || t === f.Pluto) return D4(t, n);
		function e(i) {
		...
		for (let i = 0; i * s < 2 * r; ++i) {
			...
			if (c * l <= 0) {
				...
				else if (c > 0 || l < 0) h = o, M = w0.Apocenter;
	...
	function z4(t, n, e) {
		n = m(n);
		const o = _n(t.lon);
		return X1(new Y0(t.lat + En(e, t.lat), o, t.dist), n);
	}
	function E1(t, n) {
		let e;
	...
	function Z1(t) {
		return t = m(t), T0(L1(t, b.From2000), B1(t, b.From2000));
	}
	function b4(t) {
		const n = m(t);
		return T0(Z1(n), wn(n));
	...
	function tt(t) {
		return t = m(t), T0(B1(t, b.Into2000), L1(t, b.Into2000));
	}
	function Ft(t, n) {
		t = m(t);
	...
	function gn(t) {
		const n = x0(m(t)).tobl * _, e = Math.cos(n), o = Math.sin(n);
		return new V([
			[
				1,
				0,
	...
	function F4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), Gt || (Gt = Z1(new I0(-45655.74141261017)), Tn = new I0(0));
		const e = X1(new Y0(n, 15 * t, 1), Tn), o = Jt(p1(Gt, e)), r = 10 / 240, s = r / 15;
		for (let a of V4) {
	...
	function y1(t, n, e, o) {
		...
		return new G4(n, r, z * Math.hypot(s, a, c), 695700 - (1 + r) * (Et - t), -695700 + (1 + r) * (Et + t), e, o);
	}
	function nt(t) {
	...
	function On(t) {
		...
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, y1(X, t, o, e);
	}
	function $t(t, n) {
	...
	function Y4(t) {
		const n = F((e) => Yt(nt, e), t.AddDays(-.03), t.AddDays(.03));
		if (!n) throw "Failed to find peak Earth shadow time.";
		return nt(n);
	}
	function j4(t) {
		const n = F((e) => Yt(On, e), t.AddDays(-.03), t.AddDays(.03));
	...
	function Pn(t) {
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				const a = Y4(r);
				if (a.r < a.p + X) {
					let c = Z.Penumbral, i = 0, u = 0, l = 0, h = jt(a.time, a.p + X, 200);
					return a.r < a.k + X && (c = Z.Partial, l = jt(a.time, a.k + X, h), a.r + X < a.k ? (c = Z.Total, i = 1, u = jt(a.time, a.k - X, l)) : i = Un(X, a.k, a.r)), new Dn(c, i, a.time, h, l, u);
				}
			}
			e = r.AddDays(10);
		}
	...
	function X4(t) {
		...
		const a = Z1(t.time), c = p1(a, t.dir), i = p1(a, t.target);
		c.x *= z, c.y *= z, c.z *= z / s0, i.x *= z, i.y *= z, i.z *= z / s0;
		const u = M0, l = c.x * c.x + c.y * c.y + c.z * c.z, h = -2 * (c.x * i.x + c.y * i.y + c.z * i.z), M = i.x * i.x + i.y * i.y + i.z * i.z - u * u, y = h * h - 4 * l * M;
		let A;
		if (y > 0) {
			const p = (-h - Math.sqrt(y)) / (2 * l), x = p * c.x - i.x, R = p * c.y - i.y, E = (p * c.z - i.z) * s0, I = Math.hypot(x, R) * B0;
			I == 0 ? r = E > 0 ? 90 : -90 : r = k * Math.atan(E / I);
			const w = A0(e);
			s = (k * Math.atan2(R, x) - 15 * w) % 360, s <= -180 ? s += 360 : s > 180 && (s -= 360);
			const g = o1(a);
			let D = new O(x / z, R / z, E / z, t.time);
			D = p1(g, D), D.x += t.target.x, D.y += t.target.y, D.z += t.target.z;
			const v = y1(U2, t.time, D, t.dir);
	...
	function e6(t, n) {
		return t = m(t), Jn(t.AddDays(10), n);
	}
	var Vn = class {
		constructor(t, n, e, o) {
	...
	function Gn(t, n) {
		...
		for (;;) {
			...
			if (n1(t, s) < e) {
				const a = Q4(t, o, s);
				if (a.r < a.p) {
					const c = a.time.AddDays(-1), i = Fn(t, o, c, a.time, -1), u = a.time.AddDays(1), l = Fn(t, o, a.time, u, 1), h = 60 * n1(t, a.time);
	...
	function r6(t, n) {
		return n = m(n), Gn(t, n.AddDays(100));
	}
	var _0;
	(function(t) {
	...
	function jn(t) {
		...
		for (;;) {
			...
			if (e.lat * r.lat <= 0) {
				const s = r.lat > e.lat ? _0.Ascending : _0.Descending, a = F((c) => s * V1(c).lat, n, o);
	...
	function a6(t) {
		const n = G0($0([
			...
			0,
			1
		], t, b.Into2000), t, b.Into2000), e = new O(n[0], n[1], n[2], t), o = Jt(e), r = 190.41375788700253 + 360.9856122880876 * t.ut;
		return new qt(o.ra, o.dec, r, e);
	}
	function i6(t, n) {
		const e = m(n), o = e.tt, r = o / 36525;
		let s, a, c;
		switch (t) {
			case f.Sun:
			...
			case f.Moon:
				...
				s = 269.9949 + .0031 * r - 3.8787 * Math.sin(M) - .1204 * Math.sin(y) + .07 * Math.sin(A) - .0172 * Math.sin(p) + .0072 * Math.sin(R) - .0052 * Math.sin(g) + .0043 * Math.sin(L), a = 66.5392 + .013 * r + 1.5419 * Math.cos(M) + .0239 * Math.cos(y) - .0278 * Math.cos(A) + .0068 * Math.cos(p) - .0029 * Math.cos(R) + 9e-4 * Math.cos(E) + 8e-4 * Math.cos(g) - 9e-4 * Math.cos(L), c = 38.3213 + (13.17635815 - 14e-13 * o) * o + 3.561 * Math.sin(M) + .1208 * Math.sin(y) - .0642 * Math.sin(A) + .0158 * Math.sin(p) + .0252 * Math.sin(x) - .0066 * Math.sin(R) - .0047 * Math.sin(E) - .0046 * Math.sin(I) + .0028 * Math.sin(w) + .0052 * Math.sin(g) + .004 * Math.sin(D) + .0019 * Math.sin(v) - .0044 * Math.sin(L);
				break;
			case f.Mars:
		...
		return new qt(s / 15, a, c, h);
	}
	function c6(t, n, e, o) {
		const r = m(n), s = Rt(e), a = Rt(o);
		let c, i;
		return e === f.Earth && o === f.Moon ? (c = new H(0, 0, 0, 0, 0, 0, r), i = h1(r)) : (c = Q1(e, r), i = Q1(o, r)), Qn(t, c, s, i, a);
	}
	function Qn(t, n, e, o, r) {
		...
		const u = a * a + c * c + i * i, l = Math.sqrt(u), h = o.vx - n.vx, M = o.vy - n.vy, y = o.vz - n.vz;
		let A;
		if (t === 4 || t === 5) {
			const p = c * y - i * M, x = i * h - a * y, R = a * M - c * h;
			let E = x * i - R * c, I = R * a - p * i, w = p * c - x * a;
			const g = Math.sqrt(E * E + I * I + w * w);
			E /= g, I /= g, w /= g, a /= l, c /= l, i /= l;
			const D = t == 4 ? .8660254037844386 : -.8660254037844386, v = .5 * a + D * E, L = .5 * c + D * I, B = .5 * i + D * w, Q = .5 * E - D * a, G = .5 * I - D * c, q = .5 * w - D * i, u0 = l * v, r0 = l * L, E0 = l * B, l0 = h * a + M * c + y * i, h0 = h * E + M * I + y * w;
			A = new H(u0, r0, E0, l0 * v + h0 * Q, l0 * L + h0 * G, l0 * B + h0 * q, n.t);
		} else {
			...
			E = (g - p) / l, A = new H(E * a, E * c, E * i, E * h, E * M, E * y, n.t);
		}
		return A;
	}
	var u6 = class t0 {
		...
		Update(n) {
			const e = m(n), o = e.tt - this.curr.time.tt;
			if (o === 0) this.prev = this.Duplicate();
				...
				for (let a = 0; a < this.curr.bodies.length; ++a) {
					...
					i.tt = e.tt, i.r = W0(o, c.r, c.v, u), i.v = Ct(o, c.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			const e = {}, o = new P0(n.tt, j.zero(), j.zero());
			e[f.Mercury] = W(o, n.tt, f.Mercury, pt), e[f.Venus] = W(o, n.tt, f.Venus, yt), e[f.Earth] = W(o, n.tt, f.Earth, 8997011346712498e-25), e[f.Mars] = W(o, n.tt, f.Mars, mt), e[f.Jupiter] = W(o, n.tt, f.Jupiter, K0), e[f.Saturn] = W(o, n.tt, f.Saturn, H0), e[f.Uranus] = W(o, n.tt, f.Uranus, J0), e[f.Neptune] = W(o, n.tt, f.Neptune, V0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[f.Sun] = new P0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = j.zero(), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Sun].r, c1), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mercury].r, pt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Venus].r, yt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Earth].r, 8997011346712498e-25), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Mars].r, mt), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Jupiter].r, K0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Saturn].r, H0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Uranus].r, J0), t0.AddAcceleration(n.a, n.r, this.curr.gravitators[f.Neptune].r, V0);
		}
	...
	const { MakeTime: so, SearchRiseSet: ao, Body: io, Observer: l6 } = rt(i1);
	...
	2 * Math.PI;
	const { Rotation_EQD_EQJ: ho, CombineRotation: fo, MakeRotation: Mo } = rt(i1);
	Math.PI / (180 * 3600);
	const h6 = (t) => t, m1 = (t, n, e) => h6(Ie(t, n, e));
	Se * fe;
	const r1 = (() => {
		const t = i1;
	...
	function d6(t) {
		const n = Xn.get(t);
		if (n) return n;
		const e = r1.MakeTime(/* @__PURE__ */ new Date((u2 - l2) * c2)), o = r1.RotationAxis(f6(t), e).north, r = Math.sqrt(o.x * o.x + o.y * o.y + o.z * o.z), s = m1(o.x / r, o.y / r, o.z / r);
		return Xn.set(t, s), s;
	}
	function M6(t, n) {
		const e = /* @__PURE__ */ new Date((n - l2) * c2), o = r1.MakeTime(e);
		if (t === "Moon") {
			const a = r1.GeoMoon(o);
			return m1(a.x * T, a.y * T, a.z * T);
		}
		const r = r1.JupiterMoons(o), s = t === "Io" ? r.io : t === "Europa" ? r.europa : t === "Ganymede" ? r.ganymede : r.callisto;
		return m1(s.x * T, s.y * T, s.z * T);
	}
	const Wn = {
		Phobos: {
			parentName: "Mars",
	...
	function A6(t) {
		const n = Zn.get(t);
		if (n) return n;
		const e = d6(t), o = ge(d2(Math.abs(e.z) < .9 ? {
			x: 0,
			y: 0,
			z: 1
		} : {
		...
		if (!o) throw new Error(`equatorialOrbitBasis: degenerate pole for ${t}`);
		const r = {
			u: o,
			v: d2(e, o)
		};
	...
	function S6(t, n) {
		const e = Wn[t];
		if (!e) return m1(0, 0, 0);
		const o = 2 * Math.PI * (n - u2) / e.periodDays, { u: r, v: s } = A6(e.parentName), a = e.semiMajorAxisKm, c = Math.cos(o), i = Math.sin(o);
		return m1(a * (c * r.x + i * s.x), a * (c * r.y + i * s.y), a * (c * r.z + i * s.z));
	}
	function st(t, n) {
	...
	function te(t, n, e) {
		...
		const c = a.time.jd - s.time.jd, i = (n - s.time.jd) / c, u = i * i, l = u * i, h = 2 * l - 3 * u + 1, M = l - 2 * u + i, y = -2 * l + 3 * u, A = l - u, p = h * s.position.x + M * c * s.velocity.x + y * a.position.x + A * c * a.velocity.x, x = h * s.position.y + M * c * s.velocity.y + y * a.position.y + A * c * a.velocity.y, R = h * s.position.z + M * c * s.velocity.z + y * a.position.z + A * c * a.velocity.z;
	...
	Object.fromEntries(Object.entries(Xt).map(([t, n]) => [t, n.name]));
	function _6(t) {
		return ne[t]?.parentBodyId ?? Xt[t]?.parentBodyId ?? null;
	}
	function E6(t, n) {
		const e = ne[t];
	...
	const { HelioState: Eo, MakeTime: po, JupiterMoons: yo, Body: at } = rt(i1);
	d.IO, d.EUROPA, d.GANYMEDE, d.CALLISTO;
	at.Mars, at.Saturn, at.Uranus, at.Neptune;
	d.CERES, d.ERIS, d.HAUMEA, d.MAKEMAKE;
	const R1 = 1e3, ee = R1 / T, oe = ee * lt * Ae, p6 = 695700, y6 = 6378.137;
	function re(t) {
