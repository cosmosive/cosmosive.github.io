(function() {
	var l2 = Object.defineProperty, ie = (t, n) => {
		let e = {};
		for (var o in t) l2(e, o, {
			get: t[o],
			enumerable: !0
		});
		return n || l2(e, Symbol.toStringTag, { value: "Module" }), e;
	};
	const h2 = Symbol("Comlink.proxy"), ae = Symbol("Comlink.endpoint"), ce = Symbol("Comlink.releaseProxy"), Mt = Symbol("Comlink.finalizer"), w1 = Symbol("Comlink.thrown"), d2 = (t) => typeof t == "object" && t !== null || typeof t == "function", f2 = new Map([["proxy", {
	...
	function St(t, n = globalThis, e = ["*"]) {
		n.addEventListener("message", function o(r) {
			...
			let u;
			try {
				const h = a.slice(0, -1).reduce((M, E) => M[E], t), l = a.reduce((M, E) => M[E], t);
				switch (i) {
					case "GET":
						u = l;
						break;
			...
			Promise.resolve(u).catch((h) => ({
				...
				const [l, M] = D1(h);
				n.postMessage(Object.assign(Object.assign({}, l), { id: s }), M), i === "RELEASE" && (n.removeEventListener("message", o), M2(n), Mt in t && typeof t[Mt] == "function" && t[Mt]());
			}).catch((h) => {
				const [l, M] = D1({
	...
	const T1 = /* @__PURE__ */ new WeakMap(), N1 = "FinalizationRegistry" in globalThis && new FinalizationRegistry((t) => {
		const n = (T1.get(t) || 0) - 1;
		T1.set(t, n), n === 0 && S2(t);
	});
	function de(t, n) {
		const e = (T1.get(n) || 0) + 1;
		T1.set(n, e), N1 && N1.register(t, n, t);
	}
	function fe(t) {
		N1 && N1.unregister(t);
	}
	...
	Math.PI / 180;
	180 / Math.PI;
	const _t = 86400, Ee = 365.25;
	_t * 1e3;
	const W = 299792.458;
	W * 60;
	W * 3600;
	W * _t;
	const i1 = W * Ee * _t, L = 149597870.7, E2 = 648e3 / Math.PI, pe = E2 * L;
	L / i1;
	const p2 = pe / i1;
	Object.freeze({
		x: 0,
	...
	var U1 = (t, n, e) => Object.defineProperty(t, n, {
		value: e,
		enumerable: !1,
		writable: !0,
		configurable: !0
	}), ye = Symbol.for("bitecs-relation"), me = Symbol.for("bitecs-pairTarget"), Re = Symbol.for("bitecs-isPairComponent"), a1 = Symbol.for("bitecs-relationData"), y2 = () => {
		let t = {
			...
			if (!t.pairsMap.has(o)) {
				...
				U1(r, ye, n), U1(r, me, o), U1(r, Re, !0), t.pairsMap.set(o, r);
			}
			return t.pairsMap.get(o);
		};
		return U1(n, a1, t), n;
	}, Ie = Symbol.for("bitecs-wildcard");
	function ge() {
		let t = y2();
		return Object.defineProperty(t, Ie, {
			value: !0,
			enumerable: !1,
			writable: !1,
			configurable: !1
	...
	function we() {
		...
		return globalThis[t] || (globalThis[t] = ge()), globalThis[t];
	}
	var xe = we();
	function Te() {
		return y2();
	...
	function Ne() {
		...
		return globalThis[t] || (globalThis[t] = Te()), globalThis[t];
	}
	Ne();
	const f = {
		SUN: "10",
		...
		OBERON: "704",
		TRITON: "801"
	}, Ce = 384399 / L, ke = 421800 / L, Ke = 671034 / L, Be = 1070400 / L, He = 1882700 / L, Je = 9376 / L, Ve = 23463 / L, Fe = 185540 / L, $e = 237948 / L, Ge = 294619 / L, Ye = 377396 / L, je = 527108 / L, Qe = 1221870 / L, qe = 3560820 / L, We = 129390 / L, Xe = 190900 / L, Ze = 266e3 / L, t3 = 436300 / L, n3 = 583520 / L, e3 = 354759 / L, o3 = {
		[f.SUN]: {
			name: "Sun",
			type: "star",
			color: "#f5e042",
	...
	}, I2 = L, g2 = E2, w2 = I2 * (1e3 / I2);
	100 * w2;
	100 / g2;
	const x2 = p2, pt = w2 * g2;
	25 * pt;
	function T2(t) {
		return !Number.isFinite(t) || t < 0 ? 0 : t * pt;
	}
	const s3 = 5e4, i3 = 2e3, a3 = s3 / x2, c3 = i3 / x2;
	T2(a3);
	T2(c3);
	25 * pt;
	const yt = 1e3;
	1 * yt, 1 * W, 10 * W, 100 * W, 1e3 * W, 1e6 * W, 1e9 * W;
	1 * yt, 1 * W;
	1e9 * W;
	1 * yt;
	function u3(t) {
	...
	const N2 = Object.fromEntries(Object.entries(o3).map(([t, n]) => [t, u3(n)])), v1 = [
		f.SUN,
		f.MERCURY,
		f.VENUS,
		f.EARTH,
	...
	const c1 = 1e3, D2 = c1 / L;
	D2 * i1 * p2;
	const l3 = 695700, h3 = 6378.137;
	function U2(t) {
		return !Number.isFinite(t) || t <= 0 ? 0 : t * D2;
	}
	U2(h3);
	U2(l3);
	function d3(t) {
	...
	(N2[f.EARTH]?.radiusKm ?? 6371) / (N2[f.SUN]?.radiusKm ?? 696340);
	function S3(t) {
	...
	const z1 = 173.1446326846693, z = 149597870.69098932, P2 = 63241.07708807546, _ = .017453292519943295, mt = .26179938779914946, K = 57.29577951308232, Rt = 3.819718634205488, A3 = 71492, _3 = 66854, E3 = 69911, p3 = 1821.6, y3 = 1560.8, m3 = 2631.2, R3 = 2410.3, O2 = 365.24217, v2 = /* @__PURE__ */ new Date("2000-01-01T12:00:00Z"), e0 = 2 * Math.PI, R0 = 3600 * (180 / Math.PI), k0 = 484813681109536e-20, z2 = 10800 * 60, I3 = 2 * z2, b2 = 7292115e-11, g3 = z2 / Math.PI, w3 = -.17 - 5 * Math.log10(g3), b1 = 29.530588, L1 = 24 * 3600, x3 = L1 * 1e3, L2 = .9972695717592592, l1 = 695700, C2 = l1 / z, i0 = .996647180302104, K0 = i0 * i0, S0 = 6378.1366, T3 = S0 / z, N3 = S0 * i0, k2 = 6371, D3 = k2 + 88, U3 = 1738.1 / z, X = 1737.4, K2 = 1736, P3 = K2 / z, O3 = 34 / 60, It = 81.30056, h1 = .0002959122082855911, gt = 4912547451450812e-26, wt = 7243452486162703e-25, d1 = 8887692390113509e-25, xt = 9549535105779258e-26, B0 = 2.825345909524226e-7, H0 = 8.459715185680659e-8, J0 = 1.292024916781969e-8, V0 = 1.524358900784276e-8, v3 = 218869976542597e-26, C1 = d1 / It;
	function Tt(t) {
		switch (t) {
			case d.Sun: return h1;
			case d.Mercury: return gt;
			case d.Venus: return wt;
			case d.Earth: return d1;
			case d.Moon: return C1;
			case d.EMB: return d1 + C1;
			case d.Mars: return xt;
			case d.Jupiter: return B0;
			case d.Saturn: return H0;
			case d.Uranus: return J0;
			case d.Neptune: return V0;
			case d.Pluto: return v3;
	...
	function g0(t) {
		if (!H1 || Math.abs(H1.tt - t.tt) > 1e-6) {
			const n = H3(t), e = V2(t), o = e + n.deps / 3600;
			H1 = {
				tt: t.tt,
				dpsi: n.dpsi,
				deps: n.deps,
	...
	function w0(t) {
		...
		function o(P, b, B, J) {
			const G = [];
			for (let D0 = 0; D0 <= b - P; ++D0) G.push(e(B, J));
			return {
				min: P,
				array: G
			};
		...
		let i, a, c, u, h, l, M, E, S, p, m, I, g, R, x, w, U, N, k, O, Y, $, q, l0 = o(-6, 6, 1, 4), s0 = o(-6, 6, 1, 4);
		function p0(P, b) {
			return r(l0, P, b);
		}
		function N0(P, b) {
		...
		function ht(P, b, B, J, G) {
			G(P * B - b * J, b * B + P * J);
		}
		function v(P) {
			return Math.sin(e0 * P);
		}
		M = n * n, S = 0, q = 0, m = 0, I = 3422.7;
		var f0 = v(.19833 + .05611 * n), r2 = v(.27869 + .04508 * n), s2 = v(.16827 - .36903 * n), i2 = v(.34734 - 5.37261 * n), a2 = v(.10498 - 5.37899 * n), dt = v(.42681 - .41855 * n), M6 = v(.14943 - 5.37511 * n);
		for (N = .84 * f0 + .31 * r2 + 14.27 * s2 + 7.26 * i2 + .28 * a2 + .24 * dt, k = 2.94 * f0 + .31 * r2 + 14.27 * s2 + 9.34 * i2 + 1.12 * a2 + .83 * dt, O = -6.4 * f0 - 1.89 * dt, Y = .21 * f0 + .31 * r2 + 14.27 * s2 - 88.7 * i2 - 15.3 * a2 + .24 * dt - 1.86 * M6, $ = N - O, E = -3332e-9 * v(.59734 - 5.37261 * n) - 539e-9 * v(.35498 - 5.37899 * n) - 64e-9 * v(.39943 - 5.37511 * n), g = e0 * F0(.60643382 + 1336.85522467 * n - 313e-8 * M) + N / R0, R = e0 * F0(.37489701 + 1325.55240982 * n + 2565e-8 * M) + k / R0, x = e0 * F0(.99312619 + 99.99735956 * n - 44e-8 * M) + O / R0, w = e0 * F0(.25909118 + 1342.2278298 * n - 892e-8 * M) + Y / R0, U = e0 * F0(.82736186 + 1236.85308708 * n - 397e-8 * M) + $ / R0, h = 1; h <= 4; ++h) {
			switch (h) {
				case 1:
				...
				case 2:
					...
					break;
				case 3:
					c = w, a = 4, u = 1.000002708 + 139.978 * E;
					break;
				case 4:
					c = U, a = 6, u = 1;
					break;
			...
			for (h0(0, h, 1), h0(1, h, Math.cos(c) * u), d0(0, h, 0), d0(1, h, Math.sin(c) * u), l = 2; l <= a; ++l) ht(p0(l - 1, h), N0(l - 1, h), p0(1, h), N0(1, h), (P, b) => (h0(l, h, P), d0(l, h, b)));
			for (l = 1; l <= a; ++l) h0(-l, h, p0(l, h)), d0(-l, h, -N0(l, h));
		}
		function re(P, b, B, J) {
			for (var G = {
				x: 1,
				...
				B,
				J
			], y0 = 1; y0 <= 4; ++y0) D0[y0] !== 0 && ht(G.x, G.y, p0(D0[y0], y0), N0(D0[y0], y0), (c2, s1) => (G.x = c2, G.y = s1));
			return G;
		}
		function A(P, b, B, J, G, D0, y0, c2) {
			var s1 = re(G, D0, y0, c2);
			S += P * s1.y, q += b * s1.y, m += B * s1.x, I += J * s1.x;
		}
		...
		function M0(P, b, B, J, G) {
			return P * re(b, B, J, G).y;
		}
		p = 0, p += M0(-526.069, 0, 0, 1, -2), p += M0(-3.352, 0, 0, 1, -4), p += M0(44.297, 1, 0, 1, -2), p += M0(-6, 1, 0, 1, -4), p += M0(20.599, -1, 0, 1, 0), p += M0(-30.598, -1, 0, 1, -2), p += M0(-24.649, -2, 0, 1, 0), p += M0(-2, -2, 0, 1, -2), p += M0(-22.571, 0, 1, 1, -2), p += M0(10.985, 0, -1, 1, -2), S += .82 * v(.7736 - 62.5512 * n) + .31 * v(.0466 - 125.1025 * n) + .35 * v(.5785 - 25.1042 * n) + .66 * v(.4591 + 1335.8075 * n) + .64 * v(.313 - 91.568 * n) + 1.14 * v(.148 + 1331.2898 * n) + .21 * v(.5918 + 1056.5859 * n) + .44 * v(.5784 + 1322.8595 * n) + .24 * v(.2275 - 5.7374 * n) + .28 * v(.2965 + 2.6929 * n) + .33 * v(.3132 + 6.3368 * n), i = w + q / R0;
		let S6 = (1.000002708 + 139.978 * E) * (18519.699999999997 + m) * Math.sin(i) - 6.24 * Math.sin(3 * i) + p;
		return {
			geo_eclip_lon: e0 * F0((g + S / R0) / e0),
			geo_eclip_lat: Math.PI / (180 * 3600) * S6,
			distance_au: R0 * T3 / (.999953253 * I)
		};
	}
	var G2 = class {
	...
	function V3(t) {
		const n = y(t), e = n.tt / 36525, o = e * e, r = o * e, s = o * o, i = w0(n), a = i.geo_eclip_lon, c = i.geo_eclip_lat, u = i.distance_au * z, h = _ * 1.543, l = _ * n1(93.272095 + 483202.0175233 * e - .0036539 * o - r / 3526e3 + s / 86331e4), M = _ * n1(125.0445479 - 1934.1362891 * e + .0020754 * o + r / 467441 - s / 60616e3), E = _ * n1(357.5291092 + 35999.0502909 * e - 1536e-7 * o + r / 2449e4), S = _ * n1(134.9633964 + 477198.8675055 * e + .0087414 * o + r / 69699 - s / 14712e3), p = _ * n1(297.8501921 + 445267.1114034 * e - .0018819 * o + r / 545868 - s / 113065e3), m = 1 - .002516 * e - 74e-7 * o, I = a - M, g = Math.atan2(Math.sin(I) * Math.cos(c) * Math.cos(h) - Math.sin(c) * Math.sin(h), Math.cos(I) * Math.cos(c)), R = t1(K * (g - l)), x = Math.asin(-Math.sin(I) * Math.cos(c) * Math.sin(h) - Math.sin(c) * Math.cos(h)), w = _ * (119.75 + 131.849 * e), U = _ * (72.56 + 20.186 * e), N = -.02752 * Math.cos(S) + -.02245 * Math.sin(l) + .00684 * Math.cos(S - 2 * l) + -.00293 * Math.cos(2 * l) + -85e-5 * Math.cos(2 * l - 2 * p) + -54e-5 * Math.cos(S - 2 * p) + -2e-4 * Math.sin(S + l) + -2e-4 * Math.cos(S + 2 * l) + -2e-4 * Math.cos(S - l) + 14e-5 * Math.cos(S + 2 * l - 2 * p), k = -.02816 * Math.sin(S) + .02244 * Math.cos(l) + -.00682 * Math.sin(S - 2 * l) + -.00279 * Math.sin(2 * l) + -83e-5 * Math.sin(2 * l - 2 * p) + 69e-5 * Math.sin(S - 2 * p) + 4e-4 * Math.cos(S + l) + -25e-5 * Math.sin(2 * S) + -23e-5 * Math.sin(S + 2 * l) + 2e-4 * Math.cos(S - l) + 19e-5 * Math.sin(S - l) + 13e-5 * Math.sin(S + 2 * l - 2 * p) + -1e-4 * Math.cos(S - 3 * l), O = -(.0252 * m * Math.sin(E) + .00473 * Math.sin(2 * S - 2 * l) + -.00467 * Math.sin(S) + .00396 * Math.sin(w) + .00276 * Math.sin(2 * S - 2 * p) + .00196 * Math.sin(M) + -.00183 * Math.cos(S - l) + .00115 * Math.sin(S - 2 * p) + -96e-5 * Math.sin(S - p) + 46e-5 * Math.sin(2 * l - 2 * p) + -39e-5 * Math.sin(S - l) + -32e-5 * Math.sin(S - E - p) + 27e-5 * Math.sin(2 * S - E - 2 * p) + 23e-5 * Math.sin(U) + -14e-5 * Math.sin(2 * p) + 14e-5 * Math.cos(2 * S - 2 * l) + -12e-5 * Math.sin(S - 2 * l) + -12e-5 * Math.sin(2 * S) + 11e-5 * Math.sin(2 * S - 2 * E - 2 * p)) + (N * Math.cos(g) + k * Math.sin(g)) * Math.tan(x), Y = k * Math.cos(g) - N * Math.sin(g), $ = 2 * K * Math.atan(X / Math.sqrt(u * u - X * X));
		return new G2(K * x + Y, R + O, K * c, K * a, u, $);
	}
	function Y2(t, n) {
		return [
	...
	function J1(t, n) {
		...
		o *= k0, r *= k0, s *= k0, i *= k0;
		const a = Math.sin(o), c = Math.cos(o), u = Math.sin(-r), h = Math.cos(-r), l = Math.sin(-s), M = Math.cos(-s), E = Math.sin(i), S = Math.cos(i), p = S * h - u * E * M, m = S * u * c + E * M * h * c - a * E * l, I = S * u * a + E * M * h * a + c * E * l, g = -E * h - u * S * M, R = -E * u * c + S * M * h * c - a * S * l, x = -E * u * a + S * M * h * a + c * S * l, w = u * l, U = -l * h * c - a * M, N = -l * h * a + M * c;
		if (n === C.Into2000) return new V([
			[
				p,
				m,
				I
	...
	function $3(t, n) {
		...
		let i, a, c;
		if (s < 1e-6) i = 0, a = r > 0 ? 90 : -90, c = Math.abs(r) - N3;
		else {
			for (i = K * Math.atan2(o, e) - 15 * n; i <= -180;) i += 360;
			for (; i > 180;) i -= 360;
			let u = Math.atan2(r, s), h, l, M, E = 0;
			for (;;) {
				if (++E > 10) throw "inverse_terra failed to converge.";
				h = Math.cos(u), l = Math.sin(u);
				const p = (K0 - 1) * S0, m = h * h, I = l * l, g = m + K0 * I;
				M = Math.sqrt(g);
				const R = p * l * h / M - r * h + s * l;
				if (Math.abs(R) < 1e-8) break;
				const x = p * ((m - I) / M - I * m * (K0 - 1) / (p * g)) + r * l + s * h;
				u -= R / x;
			}
			a = K * u;
			const S = S0 / M;
			Math.abs(l) > Math.abs(h) ? c = r / l - K0 * S : c = s / h - S;
		}
		return new Pt(a, i, 1e3 * c);
	}
	function Dt(t, n) {
		const e = t.latitude * _, o = Math.sin(e), r = Math.cos(e), s = 1 / Math.hypot(r, i0 * o), i = K0 * s, a = t.height / 1e3, c = S0 * s + a, u = S0 * i + a, h = (15 * n + t.longitude) * _, l = Math.sin(h), M = Math.cos(h);
		return {
			pos: [
				c * r * M / z,
				c * r * l / z,
	...
	function F1(t, n) {
		const e = g0(t), o = e.mobl * _, r = e.tobl * _, s = e.dpsi * k0, i = Math.cos(o), a = Math.sin(o), c = Math.cos(r), u = Math.sin(r), h = Math.cos(s), l = Math.sin(s), M = h, E = -l * i, S = -l * a, p = l * c, m = h * i * c + a * u, I = h * a * c - i * u, g = l * u, R = h * i * u - a * c, x = h * a * u + i * c;
		if (n === C.From2000) return new V([
			[
				M,
				p,
	...
	function $1(t, n, e) {
		return e === C.Into2000 ? $0(G0(t, n, e), n, e) : G0($0(t, n, e), n, e);
	}
	function G3(t, n, e) {
		return e === C.Into2000 ? j2(q2(t, n, e), n, e) : q2(j2(t, n, e), n, e);
	}
	function W2(t, n) {
		const e = Dt(n, A0(t)).pos;
		return $1(e, t, C.Into2000);
	}
	var D = class {
		constructor(t, n, e, o) {
	...
	function j3(t) {
		if (!Y3(t)) throw "Argument must be a [3][3] array of numbers";
		return new V(t);
	}
	var X2 = class {
		constructor(t, n, e, o) {
	...
	function tn(t, n) {
		const e = Ut(t, n), o = e.x * e.x + e.y * e.y, r = Math.sqrt(o + e.z * e.z);
		if (o === 0) {
			if (e.z === 0) throw "Indeterminate sky coordinates";
			return new G1(0, e.z < 0 ? -90 : 90, r, e);
		}
		let s = Rt * Math.atan2(e.y, e.x);
		s < 0 && (s += 24);
	...
	function Y1(t, n, e, o, r) {
		let s = y(t);
		Q0(n), T(e), T(o);
		const i = Math.sin(n.latitude * _), a = Math.cos(n.latitude * _), c = Math.sin(n.longitude * _), u = Math.cos(n.longitude * _), h = Math.sin(o * _), l = Math.cos(o * _), M = Math.sin(e * mt), E = Math.cos(e * mt);
		let S = [
			a * u,
			a * c,
			i
		...
		const I = -15 * A0(s);
		let g = j0(I, S), R = j0(I, p), x = j0(I, m), w = [
			l * E,
			l * M,
			h
		];
		const U = w[0] * g[0] + w[1] * g[1] + w[2] * g[2], N = w[0] * R[0] + w[1] * R[1] + w[2] * R[2], k = w[0] * x[0] + w[1] * x[1] + w[2] * x[2];
		let O = Math.hypot(N, k), Y;
		O > 0 ? (Y = -K * Math.atan2(k, N), Y < 0 && (Y += 360)) : Y = 0;
		let $ = K * Math.atan2(O, U), q = e, l0 = o;
		if (r) {
			let s0 = $, p0 = R1(r, 90 - $);
			if ($ -= p0, p0 > 0 && $ > 3e-4) {
				const N0 = Math.sin($ * _), h0 = Math.cos($ * _), d0 = Math.sin(s0 * _), ht = Math.cos(s0 * _), v = [];
				for (let f0 = 0; f0 < 3; ++f0) v.push((w[f0] - ht * g[f0]) / d0 * N0 + g[f0] * h0);
				O = Math.hypot(v[0], v[1]), O > 0 ? (q = Rt * Math.atan2(v[1], v[0]), q < 0 && (q += 24)) : q = 0, l0 = K * Math.atan2(v[2], O);
			}
		}
		return new X2(Y, 90 - $, q, l0);
	}
	function Q0(t) {
		if (!(t instanceof Pt)) throw `Not an instance of the Observer class: ${t}`;
	...
	function nn(t) {
		const n = y(t).AddDays(-1 / z1), e = W0(j.Earth, n), [o, r, s] = $1([
			-e.x,
			-e.y,
			-e.z
		], n, C.From2000), i = _ * g0(n).tobl, a = Math.cos(i), c = Math.sin(i);
		return Ot(new D(o, r, s, n), a, c);
	}
	function f1(t, n, e, o, r) {
		Q0(e), k1(o), k1(r);
		const s = y(n), i = W2(s, e), a = o0(t, s, r), c = [
			a.x - i[0],
			a.y - i[1],
			a.z - i[2]
		];
		return tn(o ? $1(c, s, C.From2000) : c, s);
	}
	function Q3(t, n, e) {
		const o = y(t);
		let r = Dt(n, A0(o)).pos;
		return e || (r = $1(r, o, C.Into2000)), Ut(r, o);
	}
	function q3(t, n, e) {
		const o = y(t), r = Dt(n, A0(o)), s = new H(r.pos[0], r.pos[1], r.pos[2], r.vel[0], r.vel[1], r.vel[2], o);
		return e ? s : G3(s, o, C.Into2000);
	}
	function W3(t, n) {
		const e = A0(t.t);
		let o = [
		...
		return n || (o = $0(o, t.t, C.From2000), o = G0(o, t.t, C.From2000)), $3(o, e);
	}
	function X3(t, n) {
	...
	function Ot(t, n, e) {
		...
		return new Z2(new D(o, r, s, t.t), c, a);
	}
	function M1(t) {
		const n = g0(t.t), [e, o, r] = G0($0([
			t.x,
			t.y,
			t.z
		], t.t, C.From2000), t.t, C.From2000), s = new D(e, o, r, t.t), i = n.tobl * _;
		return Ot(s, Math.cos(i), Math.sin(i));
	}
	function c0(t) {
		const n = y(t), e = w0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = $0(J3(n, [
	...
	function j1(t) {
		const n = y(t), e = w0(n), o = e.distance_au * Math.cos(e.geo_eclip_lat), r = [
			...
			o * Math.sin(e.geo_eclip_lon),
			e.distance_au * Math.sin(e.geo_eclip_lat)
		], s = g0(n), i = Ut(G0(F2(s.mobl, r), n, C.From2000), n), a = s.tobl * _, c = Ot(i, Math.cos(a), Math.sin(a));
		return new Y0(c.elat, c.elon, e.distance_au);
	}
	function S1(t) {
		const n = y(t), e = 1e-5, o = n.AddDays(-e), r = n.AddDays(+e), s = c0(o), i = c0(r);
		return new H((s.x + i.x) / 2, (s.y + i.y) / 2, (s.z + i.z) / 2, (i.x - s.x) / (2 * e), (i.y - s.y) / (2 * e), (i.z - s.z) / (2 * e), n);
	}
	function vt(t) {
		const n = y(t), e = S1(n), o = 1 + It;
	...
	const q0 = 365250, bt = 0, Lt = 1, Q1 = 2;
	function Ct(t) {
	...
	function W0(t, n) {
		const e = n.tt / q0;
		return Ct(en(P0(t[bt], e, !0), P0(t[Lt], e, !1), P0(t[Q1], e, !1))).ToAstroVector(n);
	}
	function A1(t, n) {
		const e = n / q0, o = P0(t[bt], e, !0), r = P0(t[Lt], e, !1), s = P0(t[Q1], e, !1), i = zt(t[bt], e), a = zt(t[Lt], e), c = zt(t[Q1], e), u = Math.cos(o), h = Math.sin(o), l = Math.cos(r), M = Math.sin(r), E = +(c * l * u) - s * M * u * a - s * l * h * i, S = +(c * l * h) - s * M * h * a + s * l * u * i, p = +(c * M) + s * l * a, m = en(o, r, s), I = [
			E / q0,
			S / q0,
			p / q0
		];
		return new v0(n, Ct(m), Ct(I));
	}
	function q1(t, n, e, o) {
		const r = o / (o + h1), s = W0(j[e], n);
		t.x += r * s.x, t.y += r * s.y, t.z += r * s.z;
	}
	function Z3(t) {
		const n = new D(0, 0, 0, t);
		return q1(n, t, d.Jupiter, B0), q1(n, t, d.Saturn, H0), q1(n, t, d.Uranus, J0), q1(n, t, d.Neptune, V0), n;
	}
	const kt = 51, t4 = 29200, X0 = 146, _0 = 201, O0 = [
		[
			-73e4,
			[
				-26.118207232108,
	...
	var Q = class m0 {
		...
		clone() {
			return new u2(this.tt, this.r, this.v);
		}
		sub(n) {
			return new u2(this.tt, this.r.sub(n.r), this.v.sub(n.v));
		}
	};
	function n4(t) {
		let [n, [e, o, r], [s, i, a]] = t;
	...
	var E1 = class {
		constructor(t) {
			...
			this.Jupiter = Z(n, t, d.Jupiter, B0), this.Saturn = Z(n, t, d.Saturn, H0), this.Uranus = Z(n, t, d.Uranus, J0), this.Neptune = Z(n, t, d.Neptune, V0), this.Jupiter.r.decr(n.r), this.Jupiter.v.decr(n.v), this.Saturn.r.decr(n.r), this.Saturn.v.decr(n.v), this.Uranus.r.decr(n.r), this.Uranus.v.decr(n.v), this.Neptune.r.decr(n.r), this.Neptune.v.decr(n.v), this.Sun = new v0(t, n.r.mul(-1), n.v.mul(-1));
		}
		Acceleration(t) {
			let n = _1(t, h1, this.Sun.r);
			return n.incr(_1(t, B0, this.Jupiter.r)), n.incr(_1(t, H0, this.Saturn.r)), n.incr(_1(t, J0, this.Uranus.r)), n.incr(_1(t, V0, this.Neptune.r)), n;
		}
	}, Kt = class se {
		constructor(n, e, o, r) {
	...
	function Ht(t, n) {
		const e = t - n.tt, o = new E1(t), r = Z0(e, n.r, n.v, n.a), s = o.Acceleration(r).mean(n.a), i = Z0(e, n.r, n.v, s);
	...
	function Jt(t) {
		const n = n4(t), e = new E1(n.tt), o = n.r.add(e.Sun.r), r = n.v.add(e.Sun.v), s = e.Acceleration(o);
		return new on(e, new Kt(n.tt, o, r, s));
	}
	function o4(t, n) {
		const e = O0[0][0];
		if (n < e || n > O0[kt - 1][0]) return null;
		const o = rn((n - e) / t4, kt - 1);
		if (!t[o]) {
			const s = t[o] = [];
			s[0] = Jt(O0[o]).grav, s[_0 - 1] = Jt(O0[o + 1]).grav;
			let i, a = s[0].tt;
			for (i = 1; i < _0 - 1; ++i) s[i] = Ht(a += X0, s[i - 1]).grav;
			a = s[_0 - 1].tt;
			var r = [];
			for (r[_0 - 1] = s[_0 - 1], i = _0 - 2; i > 0; --i) r[i] = Ht(a -= X0, r[i + 1]).grav;
			for (i = _0 - 2; i > 0; --i) {
				const c = i / (_0 - 1);
	...
	function sn(t, n, e) {
		...
		for (let s = 0; s < r; ++s) o = Ht(s + 1 === r ? n : o.grav.tt + e, o.grav);
		return o;
	}
	function Vt(t, n) {
		let e, o, r;
		const s = o4(e4, t.tt);
		if (s) {
			const i = rn((t.tt - s[0].tt) / X0, _0 - 1), a = s[i], c = s[i + 1], u = a.a.mean(c.a), h = Z0(t.tt - a.tt, a.r, a.v, u), l = Bt(t.tt - a.tt, a.v, u), M = Z0(t.tt - c.tt, c.r, c.v, u), E = Bt(t.tt - c.tt, c.v, u), S = (t.tt - a.tt) / X0;
			e = h.mul(1 - S).add(M.mul(S)), o = l.mul(1 - S).add(E.mul(S));
		} else {
			let i;
			t.tt < O0[0][0] ? i = sn(O0[0], t.tt, -X0) : i = sn(O0[kt - 1], t.tt, +X0), e = i.grav.r, o = i.grav.v, r = i.bary;
		}
		return n && (r || (r = new E1(t.tt)), e = e.sub(r.Sun.r), o = o.sub(r.Sun.v)), new H(e.x, e.y, e.z, o.x, o.y, o.z, t);
	}
	const r4 = new V([
		[
			.999432765338654,
	...
	function s4(t, n, e) {
		...
		let h, l, M, E = r + s * Math.sin(r) - i * Math.cos(r);
		do
			h = Math.cos(E), l = Math.sin(E), M = (r - E + s * l - i * h) / (1 - s * h - i * l), E += M;
		while (Math.abs(M) >= 1e-12);
		h = Math.cos(E), l = Math.sin(E);
		const S = i * h - s * l, p = -s * h - i * l, m = 1 / (1 + p), I = 1 / (1 + Math.sqrt(1 - s * s - i * i)), g = o * (h - s - I * i * S), R = o * (l - i + I * s * S), x = u * m * o * (-l - I * i * p), w = u * m * o * (+h + I * s * p), U = 2 * Math.sqrt(1 - a * a - c * c), N = 1 - 2 * c * c, k = 1 - 2 * a * a, O = 2 * c * a;
	...
	function X1(t, n) {
		...
		return et(r4, s4(t, n.mu, o));
	}
	function i4(t) {
		const n = new I0(t);
		return new an(X1(n, W1[0]), X1(n, W1[1]), X1(n, W1[2]), X1(n, W1[3]));
	}
	function u0(t, n) {
		var e = y(n);
		if (t in j) return W0(j[t], e);
		if (t === d.Pluto) {
			const i = Vt(e, !0);
			return new D(i.x, i.y, i.z, e);
		}
		if (t === d.Sun) return new D(0, 0, 0, e);
		if (t === d.Moon) {
			var o = W0(j.Earth, e), r = c0(e);
			return new D(o.x + r.x, o.y + r.y, o.z + r.z, e);
		}
		if (t === d.EMB) {
			const i = W0(j.Earth, e), a = c0(e), c = 1 + It;
			return new D(i.x + a.x / c, i.y + a.y / c, i.z + a.z / c, e);
		}
		if (t === d.SSB) return Z3(e);
		const s = B1(t);
		if (s) return nt(new Y0(s.dec, 15 * s.ra, s.dist), e);
	...
	function z0(t, n) {
		...
		if (e) return e.dist;
		const o = y(n);
		return t in j ? P0(j[t][Q1], o.tt / q0, !1) : u0(t, o).Length();
	}
	function cn(t, n) {
		let e = n, o = 0;
		for (let r = 0; r < 10; ++r) {
	...
	function un(t, n, e, o) {
		...
		if (B1(e)) {
			const a = u0(e, r);
			if (o) {
				const u = Z1(n, r), h = new D(a.x - u.x, a.y - u.y, a.z - u.z, r), l = z1 / h.Length();
	...
	function c4(t, n) {
		...
		switch (t) {
			...
			case d.Moon:
			case d.EMB:
				const r = A1(j[d.Earth], e.tt), s = t === d.Moon ? S1(e) : vt(e);
	...
	function Z1(t, n) {
		...
		switch (t) {
			...
			case d.Pluto: return Vt(e, !0);
			case d.Moon:
			case d.EMB:
				const r = A1(j.Earth, e.tt), s = t == d.Moon ? S1(e) : vt(e);
	...
	function F(t, n, e, o) {
		...
		for (;;) {
			...
			let M = B3(n, e, .5), E = M.ut - n.ut;
			if (Math.abs(E) < s) return M;
			l ? c = t(M) : l = !0;
			let S = u4(M.ut, e.ut - M.ut, i, c, a);
			if (S) {
				let p = y(S.t), m = t(p);
				if (S.df_dt !== 0) {
					if (Math.abs(m / S.df_dt) < s) return p;
					let I = 1.2 * Math.abs(m / S.df_dt);
					if (I < E / 10) {
						let g = p.AddDays(-I), R = p.AddDays(+I);
	...
	function h4(t, n, e, o, r) {
		const s = M1(o), i = _ * 28.06, a = _ * (169.51 + 382e-7 * r.tt), c = _ * s.elat, u = _ * s.elon, h = Math.asin(Math.sin(c) * Math.cos(i) - Math.cos(c) * Math.sin(i) * Math.sin(u - a)), l = Math.sin(Math.abs(h));
		let M = -9 + .044 * t;
	...
	function tt(t, n) {
		...
		const e = y(n), o = W0(j.Earth, e);
		let r, s, i, a;
		t === d.Sun ? (i = new D(-o.x, -o.y, -o.z, e), s = new D(0, 0, 0, e), r = 0) : (t === d.Moon ? (i = c0(e), s = new D(o.x + i.x, o.y + i.y, o.z + i.z, e)) : (s = u0(t, n), i = new D(s.x - o.x, s.y - o.y, s.z - o.z, e)), r = K1(i, s));
		let c = i.Length(), u = s.Length(), h;
		if (t === d.Sun) a = w3 + 5 * Math.log10(c);
		else if (t === d.Moon) a = d4(r, u, c);
		else if (t === d.Saturn) {
	...
	function y1(t, n, e) {
		...
		let i = o(s), a, c, u;
		if (e < 0) {
			if (i < 0 && (i += 360), a = -(b1 * i) / 360, u = a + r, u < e) return null;
			c = Math.max(e, a - r);
		} else {
			if (i > 0 && (i -= 360), a = -(b1 * i) / 360, c = a - r, c > e) return null;
			u = Math.min(e, a + r);
		}
	...
	function fn(t) {
		let n = $t(t), e = (Math.floor(n / 90) + 1) % 4, o = y1(90 * e, t, 10);
		if (!o) throw "Cannot find moon quarter";
		return new dn(e, o);
	}
	function f4(t) {
		return fn(new Date(t.time.date.getTime() + 6 * x3));
	}
	var Mn = class {
		constructor(t, n, e) {
	...
	function M4(t, n) {
		const e = t.latitude * _, o = Math.sin(e), r = Math.cos(e), s = 1 / Math.hypot(r, o * i0), i = s * (i0 * i0), a = (t.height - n) / 1e3, c = S0 * s + a, u = S0 * i + a, h = 1e3 * Math.hypot(c * r, u * o), l = .175 * Math.pow(1 - .0065 / 283.15 * (t.height - 2 / 3 * n), 3.256);
	...
	function A4(t, n, e, o, r, s = 0) {
		if (!Number.isFinite(s) || s < 0) throw `Invalid value for metersAboveGround: ${s}`;
		const i = S4(t), a = Sn(n.height - s);
		return An(t, n, e, o, r, i, M4(n, s) - O3 * a.density);
	}
	function _4(t, n, e, o, r, s) {
		if (!Number.isFinite(s) || s < -90 || s > 90) throw `Invalid altitude angle: ${s}`;
		return An(t, n, e, o, r, 0, s);
	}
	var E4 = class {
		constructor(t, n, e, o) {
	...
	function Gt(t, n, e, o, r, s, i) {
		if (s < 0 && i >= 0) return new E4(o, r, s, i);
	...
	function An(t, n, e, o, r, s, i) {
		if (Q0(n), T(r), T(s), T(i), i < -90 || i > 90) throw `Invalid target altitude angle: ${i}`;
		const a = .42, c = p4(t, n.latitude);
		function u(p) {
			const m = f1(t, p, n, !0, !0);
			return e * (Y1(p, n, m.ra, m.dec).altitude + K * Math.asin(s / m.dist) - i);
		}
		const h = y(o);
		let l = h, M = h, E = u(l), S = E;
		for (;;) {
			r < 0 ? (l = M.AddDays(-a), E = u(l)) : (M = l.AddDays(+a), S = u(M));
			const p = Gt(0, u, c, l, M, E, S);
			if (p) {
				const m = F(u, p.tx, p.ty, {
				...
				throw `Rise/set search failed after finding ascent: t1=${l}, t2=${M}, a1=${E}, a2=${S}`;
			}
			if (r < 0) {
	...
	function y4(t, n, e, o, r = 1) {
		...
		for (;;) {
			++i;
			let a = A0(s), c = f1(t, s, n, !0, !0), u = (e + c.ra - n.longitude / 15 - a) % 24;
			if (i === 1 ? r > 0 ? u < 0 && (u += 24) : u > 0 && (u -= 24) : u < -12 ? u += 24 : u > 12 && (u -= 24), Math.abs(u) * 3600 < .1) {
				const l = Y1(s, n, c.ra, c.dec, "normal");
				return new _n(s, l);
			}
			let h = u / 24 * L2;
			s = s.AddDays(h);
	...
	function m4(t, n, e) {
		const o = y(n), r = Q2(o), s = f1(t, o, e, !0, !0);
	...
	function yn(t, n) {
		let e = y(n), o = Ft(t, d.Sun, e), r;
		o > 180 ? (r = "morning", o = 360 - o) : r = "evening";
		let s = e1(t, e);
		return new pn(e, r, s, o);
	}
	function I4(t, n) {
		function o(a) {
		...
		let i = 0;
		for (; ++i <= 2;) {
			let a = t1(L0(t, r) - L0(d.Earth, r)), c, u, h;
			a >= -s.s1 && a < +s.s1 ? (h = 0, c = +s.s1, u = +s.s2) : a >= +s.s2 || a < -s.s2 ? (h = 0, c = -s.s2, u = -s.s1) : a >= 0 ? (h = -p1(t) / 4, c = +s.s1, u = +s.s2) : (h = -p1(t) / 4, c = -s.s2, u = -s.s1);
			let l = r.AddDays(h), M = o1(t, c, l), E = o1(t, u, M), S = o(M);
			if (S >= 0) throw `SearchMaxElongation: internal error: m1 = ${S}`;
			let p = o(E);
			...
			if (!m) throw `SearchMaxElongation: failed search iter ${i} (t1=${M.toString()}, t2=${E.toString()})`;
	...
	function g4(t, n) {
		...
		const e = .01;
		function o(c) {
			const u = c.AddDays(-e / 2), h = c.AddDays(+e / 2), l = tt(t, u).mag;
			return (tt(t, h).mag - l) / e;
		}
		let r = y(n);
		const s = 10, i = 30;
		let a = 0;
		for (; ++a <= 2;) {
			let c = t1(L0(t, r) - L0(d.Earth, r)), u, h, l;
			c >= -s && c < +s ? (l = 0, u = +s, h = +i) : c >= +i || c < -i ? (l = 0, u = -i, h = -s) : c >= 0 ? (l = -p1(t) / 4, u = +s, h = +i) : (l = -p1(t) / 4, u = -i, h = -s);
			let M = r.AddDays(l), E = o1(t, u, M), S = o1(t, h, E), p = o(E);
			...
			if (!I) throw `SearchPeakMagnitude: failed search iter ${a} (t1=${E.toString()}, t2=${S.toString()})`;
	...
	function x4(t, n) {
		...
		for (let M = 0; M < 100; ++M) {
			const E = o.AddDays(M * u), S = z0(t, E);
			M === 0 ? c = a = S : (S > c && (c = S, i = E), S < a && (a = S, s = E));
		}
	...
	function In(t, n) {
		if (n = y(n), t === d.Neptune || t === d.Pluto) return x4(t, n);
		function e(c) {
	...
	function T4(t, n) {
		...
		const e = .25 * a0[t].OrbitalPeriod, o = In(t, n.time.AddDays(e));
	...
	function U4(t, n) {
		const e = jt(t);
		return e.lon = gn(e.lon), e.lat += R1(n, e.lat), e;
	}
	function P4(t, n, e) {
		n = y(n);
		const o = gn(t.lon);
		return nt(new Y0(t.lat + wn(e, t.lat), o, t.dist), n);
	}
	function R1(t, n) {
		let e;
	...
	function ot(t) {
		return t = y(t), T0(J1(t, C.From2000), F1(t, C.From2000));
	}
	function v4(t) {
		const n = y(t);
		return T0(ot(n), vn(n));
	...
	function rt(t) {
		return t = y(t), T0(F1(t, C.Into2000), J1(t, C.Into2000));
	}
	function Qt(t, n) {
		t = y(t);
		const e = Math.sin(n.latitude * _), o = Math.cos(n.latitude * _), r = Math.sin(n.longitude * _), s = Math.cos(n.longitude * _), i = [
			...
			-s,
			0
		], u = -15 * A0(t), h = j0(u, i), l = j0(u, a), M = j0(u, c);
		return new V([
			[
				l[0],
				M[0],
	...
	function H4(t, n) {
		...
		t %= 24, t < 0 && (t += 24), qt || (qt = ot(new I0(-45655.74141261017)), zn = new I0(0));
		const e = nt(new Y0(n, 15 * t, 1), zn), o = Yt(I1(qt, e)), r = 10 / 240, s = r / 15;
		for (let i of B4) {
	...
	function g1(t, n, e, o) {
		...
		return new J4(n, r, z * Math.hypot(s, i, a), +l1 - (1 + r) * (l1 - t), -l1 + (1 + r) * (l1 + t), e, o);
	}
	function st(t) {
		const n = o0(d.Sun, t, !0), e = new D(-n.x, -n.y, -n.z, n.t);
		return g1(D3, t, c0(t), e);
	}
	function Cn(t) {
		const n = o0(d.Sun, t, !0), e = c0(t), o = new D(-e.x, -e.y, -e.z, e.t);
		return e.x -= n.x, e.y -= n.y, e.z -= n.z, g1(X, t, o, e);
	}
	function Wt(t, n) {
		const e = W2(t, n), o = o0(d.Sun, t, !0), r = c0(t), s = new D(e[0] - r.x, e[1] - r.y, e[2] - r.z, t);
		return r.x -= o.x, r.y -= o.y, r.z -= o.z, g1(X, t, s, r);
	}
	function it(t, n, e) {
		const o = o0(t, e, !0), r = o0(d.Sun, e, !0), s = new D(o.x - r.x, o.y - r.y, o.z - r.z, e);
		return r.x = -o.x, r.y = -o.y, r.z = -o.z, g1(n, e, r, s);
	}
	function Xt(t, n) {
	...
	function V4(t, n, e) {
		const o = 11574074074074073e-21, r = it(t, n, e.AddDays(-o));
		return (it(t, n, e.AddDays(+o)).r - r.r) / o;
	}
	function F4(t) {
		const e = F((o) => Xt(st, o), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Earth shadow time.";
		return st(e);
	}
	function $4(t) {
		const e = F((o) => Xt(Cn, o), t.AddDays(-.03), t.AddDays(.03));
		if (!e) throw "Failed to find peak Moon shadow time.";
		return Cn(e);
	}
	function G4(t, n, e) {
		const r = F((s) => V4(t, n, s), e.AddDays(-1), e.AddDays(1));
	...
	function Y4(t, n) {
		...
		const i = F((a) => Xt(s, a), o, r);
		if (!i) throw `PeakLocalMoonShadow: search failure for search_center_time = ${t}`;
		return Wt(i, n);
	}
	function Zt(t, n, e) {
		const o = e / 1440, r = t.AddDays(-o), s = t.AddDays(+o), i = F((c) => -(st(c).r - n), r, t), a = F((c) => +(st(c).r - n), t, s);
	...
	function Kn(t, n) {
		const e = new D(t.x + n.x, t.y + n.y, t.z + n.z, t.t), o = kn(Math.asin(C2 / e.Length()), Math.asin(P3 / n.Length()), K1(n, e) * _);
	...
	function Bn(t) {
		...
		for (let o = 0; o < 12; ++o) {
			...
			if (Math.abs(s) < 1.8) {
				const i = F4(r);
				if (i.r < i.p + X) {
					let a = t0.Penumbral, c = 0, u = 0, h = 0, l = Zt(i.time, i.p + X, 200);
					return i.r < i.k + X && (a = t0.Partial, h = Zt(i.time, i.k + X, l), i.r + X < i.k ? (a = t0.Total, c = 1, u = Zt(i.time, i.k - X, h)) : c = kn(X, i.k, i.r)), new Ln(a, c, i.time, l, h, u);
				}
			}
			e = r.AddDays(10);
		}
	...
	function j4(t) {
		let n = t0.Partial, e = t.time, o = t.r, r, s;
		const i = ot(t.time), a = I1(i, t.dir), c = I1(i, t.target);
		a.x *= z, a.y *= z, a.z *= z / i0, c.x *= z, c.y *= z, c.z *= z / i0;
		const u = S0, h = a.x * a.x + a.y * a.y + a.z * a.z, l = -2 * (a.x * c.x + a.y * c.y + a.z * c.z), M = c.x * c.x + c.y * c.y + c.z * c.z - u * u, E = l * l - 4 * h * M;
		let S;
		if (E > 0) {
			const p = (-l - Math.sqrt(E)) / (2 * h), m = p * a.x - c.x, I = p * a.y - c.y, g = (p * a.z - c.z) * i0, R = Math.hypot(m, I) * K0;
			...
			const N = g1(K2, t.time, U, t.dir);
			if (N.r > 1e-9 || N.r < 0) throw `Unexpected shadow distance from geoid intersection = ${N.r}`;
			n = Jn(N.k), S = n === t0.Total ? 1 : Kn(t.dir, U);
		} else S = void 0;
		return new Hn(n, S, e, o, r, s);
	}
	function Q4(t) {
	...
	function W4(t, n) {
		...
		const a = at(n, 1, Gn, s, t.time), c = at(n, -1, Gn, t.time, i);
		let u, h, l;
		t.r < Math.abs(t.k) ? (s = t.time.AddDays(-.01), i = t.time.AddDays(.01), u = at(n, 1, Yn, s, t.time), h = at(n, -1, Yn, t.time, i), l = Jn(t.k)) : l = t0.Partial;
		const M = l === t0.Total ? 1 : Kn(t.dir, t.target);
		return new $n(l, M, a, u, r, h, c);
	}
	function at(t, n, e, o, r) {
		function s(a) {
			return n * e(Wt(a, t));
		}
		const i = F(s, o, r);
	...
	function jn(t, n) {
		return new Fn(n, X4(n, t));
	}
	function X4(t, n) {
		const e = f1(d.Sun, t, n, !0, !0);
		return Y1(t, n, e.ra, e.dec, "normal").altitude;
	}
	function Qn(t, n) {
		t = y(t), Q0(n);
		const e = 1.8;
	...
	function Xn(t, n) {
		...
		for (;;) {
			...
			if (e1(t, i) < e) {
				const a = G4(t, r, i);
				if (a.r < a.p) {
					const c = a.time.AddDays(-o), u = Wn(t, r, c, a.time, -1), h = a.time.AddDays(+o), l = Wn(t, r, a.time, h, 1), M = 60 * e1(t, a.time);
	...
	function ne(t) {
		let n = y(t), e = j1(n);
		for (;;) {
			const o = n.AddDays(te), r = j1(o);
			if (e.lat * r.lat <= 0) {
				const s = r.lat > e.lat ? E0.Ascending : E0.Descending, i = F((a) => s * j1(a).lat, n, o);
	...
	function o6(t) {
		const n = $0(G0([
			...
			0,
			1
		], t, C.Into2000), t, C.Into2000), e = new D(n[0], n[1], n[2], t), o = Yt(e), r = 190.41375788700253 + 360.9856122880876 * t.ut;
		return new n2(o.ra, o.dec, r, e);
	}
	function r6(t, n) {
		...
		switch (t) {
			...
			case d.Mars:
				...
				break;
			case d.Jupiter:
				const O = _ * (99.360714 + 4850.4046 * r), Y = _ * (175.895369 + 1191.9605 * r), $ = _ * (300.323162 + 262.5475 * r), q = _ * (114.012305 + 6070.2476 * r), l0 = _ * (49.511251 + 64.3 * r);
				s = 268.056595 - .006499 * r + 117e-6 * Math.sin(O) + 938e-6 * Math.sin(Y) + .001432 * Math.sin($) + 3e-5 * Math.sin(q) + .00215 * Math.sin(l0), i = 64.495303 + .002413 * r + 5e-5 * Math.cos(O) + 404e-6 * Math.cos(Y) + 617e-6 * Math.cos($) - 13e-6 * Math.cos(q) + 926e-6 * Math.cos(l0), a = 284.95 + 870.536 * o;
				break;
			case d.Saturn:
			...
			case d.Uranus:
				...
				break;
			case d.Neptune:
				const s0 = _ * (357.85 + 52.316 * r);
				s = 299.36 + .7 * Math.sin(s0), i = 43.46 - .51 * Math.cos(s0), a = 249.978 + 541.1397757 * o - .48 * Math.sin(s0);
				break;
			case d.Pluto:
		...
		return new n2(s / 15, i, a, l);
	}
	function s6(t, n, e, o) {
		const r = y(n), s = Tt(e), i = Tt(o);
		let a, c;
		return e === d.Earth && o === d.Moon ? (a = new H(0, 0, 0, 0, 0, 0, r), c = S1(r)) : (a = Z1(e, r), c = Z1(o, r)), ee(t, a, s, c, i);
	}
	function ee(t, n, e, o, r) {
		...
		const h = a * a + c * c + u * u, l = Math.sqrt(h), M = o.vx - n.vx, E = o.vy - n.vy, S = o.vz - n.vz;
		let p;
		if (t === 4 || t === 5) {
			const m = c * S - u * E, I = u * M - a * S, g = a * E - c * M;
			let R = I * u - g * c, x = g * a - m * u, w = m * c - I * a;
			const U = Math.sqrt(R * R + x * x + w * w);
			R /= U, x /= U, w /= U, a /= l, c /= l, u /= l;
			const N = t == 4 ? +i : -i, k = .5 * a + N * R, O = .5 * c + N * x, Y = .5 * u + N * w, $ = .5 * R - N * a, q = .5 * x - N * c, l0 = .5 * w - N * u, s0 = l * k, p0 = l * O, N0 = l * Y, h0 = M * a + E * c + S * u, d0 = M * R + E * x + S * w;
			p = new H(s0, p0, N0, h0 * k + d0 * $, h0 * O + d0 * q, h0 * Y + d0 * l0, n.t);
		} else {
			...
			R = (U - m) / l, p = new H(R * a, R * c, R * u, R * M, R * E, R * S, n.t);
		}
		return p;
	}
	var i6 = class n0 {
		constructor(n, e, o) {
			...
			const s = [], i = n0.CalcSolarSystem(r);
		...
		Update(n) {
			...
			if (o === 0) this.prev = this.Duplicate();
				...
				for (let i = 0; i < this.curr.bodies.length; ++i) {
					...
					c.tt = e.tt, c.r = Z0(o, a.r, a.v, u), c.v = Bt(o, a.v, u);
				}
				this.CalcBodyAccelerations();
			}
		...
		static CalcSolarSystem(n) {
			...
			e[d.Mercury] = Z(o, n.tt, d.Mercury, gt), e[d.Venus] = Z(o, n.tt, d.Venus, wt), e[d.Earth] = Z(o, n.tt, d.Earth, d1 + C1), e[d.Mars] = Z(o, n.tt, d.Mars, xt), e[d.Jupiter] = Z(o, n.tt, d.Jupiter, B0), e[d.Saturn] = Z(o, n.tt, d.Saturn, H0), e[d.Uranus] = Z(o, n.tt, d.Uranus, J0), e[d.Neptune] = Z(o, n.tt, d.Neptune, V0);
			for (let r in e) e[r].r.decr(o.r), e[r].v.decr(o.v);
			return e[d.Sun] = new v0(n.tt, o.r.neg(), o.v.neg()), e;
		}
		CalcBodyAccelerations() {
			for (let n of this.curr.bodies) n.a = Q.zero(), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Sun].r, h1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Mercury].r, gt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Venus].r, wt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Earth].r, d1 + C1), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Mars].r, xt), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Jupiter].r, B0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Saturn].r, H0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Uranus].r, J0), n0.AddAcceleration(n.a, n.r, this.curr.gravitators[d.Neptune].r, V0);
		}
	...
	const { MakeTime: f8, SearchRiseSet: M8, Body: S8, Observer: a6 } = ct(u1);
	new a6(40.7128, -74.006, 10);
	const { Body: r0 } = ct(u1);
	f.SUN, r0.Sun, f.MERCURY, r0.Mercury, f.VENUS, r0.Venus, f.EARTH, r0.Earth, f.MARS, r0.Mars, f.JUPITER, r0.Jupiter, f.SATURN, r0.Saturn, f.URANUS, r0.Uranus, f.NEPTUNE, r0.Neptune, f.PLUTO, r0.Pluto, f.MOON, r0.Moon;
	2 * Math.PI;
	const { Rotation_EQD_EQJ: p8, CombineRotation: y8, MakeRotation: m8 } = ct(u1);
	Math.PI / (180 * 3600);
	function ut(t, n) {
	...
	Object.fromEntries(Object.entries(u6).map(([t, n]) => [n.bodyId, t]));
	const { HelioState: x8, MakeTime: T8, JupiterMoons: N8, Body: lt } = ct(u1);
	f.IO, f.EUROPA, f.GANYMEDE, f.CALLISTO;
	lt.Mars, lt.Saturn, lt.Uranus, lt.Neptune;
	function l6(t, n, e = v1) {
		const o = {};
		for (const r of e) {
			const s = n[r] ?? [], i = s.length ? c6(s, t) : null;
			if (i) {
				const a = d3(i);
				o[r] = [
					a.x,
	...
	St({
		async init(t) {
			const n = new Float32Array(t), e = h6();
