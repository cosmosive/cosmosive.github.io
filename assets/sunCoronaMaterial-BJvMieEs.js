...
`;function te(e){return new W({uniforms:{uPointSizeMax:{value:e?.pointSizeMax??We},uTime:{value:0},uTwinkleAmp:{value:e?.twinkleAmp??0},uTwinkleFreq:{value:e?.twinkleFreq??.8},uSizeMultiplier:{value:e?.sizeMultiplier??1},uPointSizeFloor:{value:e?.pointSizeFloor??1},uMagLimit:{value:6.5},uMagFadeRange:{value:1},uMagRef:{value:0},uFluxClampMax:{value:4},uFluxGamma:{value:.45},uPsfMaxMult:{value:3.5},uPaletteHot:{value:new H(1,.78,.56)},uPaletteFlare:{value:new H(1,.92,.75)}},vertexShader:Le,fragmentShader:e?.useHaloShader?He:Ne,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1})}function Ve(){return te({twinkleAmp:.03,twinkleFreq:.9,pointSizeFloor:1})}function Oe(){return te({useHaloShader:!0,sizeMultiplier:1.6,pointSizeMax:De,pointSizeFloor:1,twinkleAmp:.02,twinkleFreq:.55})}function Be(e){const{layers:t}=Q(e);return{createChunk(o){const r=t[o.layer],n=new he;for(const s of o.attributes)n.setAttribute(s.name,new X(s.data,s.components));n.computeBoundingSphere();const a=o.material,u=new Y(n,a);u.frustumCulled=!0,u.raycast=()=>{},r.add(u);const c=new Map(o.attributes.map(s=>[s.name,s.components]));return{meshRef:u,updateAttribute(s,i){const l=c.get(s);l!=null&&n.setAttribute(s,new X(i,l))},setVertexCount(s){n.computeBoundingSphere()},dispose(){r.remove(u),n.dispose()}}}}}function qe(e){return Be(e)}function Ke(e,t,o){const r=new Y(e.geometry,o);return r.frustumCulled=!0,r.renderOrder=1,r.raycast=()=>{},t.add(r),{mesh:r,dispose(){t.remove(r)}}}function oe(e,t){return t?e.depthCam!==t.depthCam?e.depthCam<t.depthCam:e.renderedPx!==t.renderedPx?e.renderedPx>t.renderedPx:e.distSqPx<t.distSqPx:!0}function Ge(e,t){let o=0,r=-1,n=null;for(let a=0;a<e.length;a+=1){const u=e[a],c=u.starsInChunk.length,s=t(u,a);s&&oe(s,n)&&(n=s,r=o+s.index),o+=c}return r}function Ue(e,t){if(t<0||t>=e.length)return!1;const o=e[t],r=o.proper??(o.hip!=null?`HIP ${o.hip}`:`Star ${o.id}`);return le.select(ae("hyg",o.id),r,"star"),!0}function je(e){if(e.starsInView.length===0)return!1;const t=e.prepared;if(t==null)return!1;const o=Ge(e.chunks,(r,n)=>e.pickInChunk(r,n,t));return Ue(e.starsInView,o)}function Xe(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||e<=0||t<=0?0:e/(2*Math.tan(t*.5))}function $e(){return 1}function Je(){return 8}var O={px:0,py:0};function Qe(e){const{positions:t,sizes:o,distancesKm:r,starCount:n,camFrustum:a,tanHalfV:u,cameraHelioKm:c,maxDistSqKm:s,mouseX:i,mouseY:l,projectStarToScreenPx:f}=e,x=Math.min(n,t.length/3,o.length,r.length);let m=null;for(let h=0;h<x;h+=1){const d=h*3,g=t[d],S=t[d+1],y=t[d+2];if(!Ie(g,S,y,r[h]??0,c.x,c.y,c.z,s))continue;const P=g-a.position.x,M=S-a.position.y,F=y-a.position.z,C=P*a.forward.x+M*a.forward.y+F*a.forward.z;if(C<=1e-6)continue;const T=P*a.right.x+M*a.right.y+F*a.right.z,V=P*a.up.x+M*a.up.y+F*a.up.z,p=u*a.aspect*C;if(Math.abs(T)>p)continue;const v=u*C;if(Math.abs(V)>v)continue;const z=C,b=$e(),w=Je();if(w<=0)continue;f(g,S,y,O);const I=O.px-i,A=O.py-l,R=I*I+A*A;if(R>w*w)continue;const D={index:h,distSqPx:R,depthCam:z,renderedPx:b};oe(D,m)&&(m=D)}return m}var B=new E,q=new E;function Ye(e,t,o,r,n,a,u,c,s,i,l,f,x){const m=o.getBoundingClientRect();return Qe({positions:a,sizes:u,distancesKm:c,starCount:s,uScale:Xe(m.height,r.fov*Math.PI/180),camFrustum:i,tanHalfV:l,cameraHelioKm:f,maxDistSqKm:x,mouseX:e-m.left,mouseY:t-m.top,projectStarToScreenPx:(h,d,g,S)=>{B.set(h,d,g),B.applyMatrix4(n.matrixWorld),q.copy(B).project(r),S.px=(q.x*.5+.5)*m.width,S.py=(-q.y*.5+.5)*m.height}})}function Ze(e){const{cameraThree:t,pickerScratch:o,syncScratch:r}=e;xe(t,o.frustum,r.forward,r.right,r.up);const{tanHalfV:n,maxDistSqKm:a}=Ee(o);return je({starsInView:e.starsInView,chunks:e.chunks,prepared:{tanHalfV:n,maxDistSqKm:a},pickInChunk:(u,c,s)=>{const i=e.pointsMeshes[c],l=e.chunkDistancesKm[c],f=e.chunkOriginalSizes[c];return!i||!l||!f?null:Ye(e.clientX,e.clientY,e.canvas,t,i,u.positions,f,l,u.starsInChunk.length,o.frustum,s.tanHalfV,o.cameraHelioKm,s.maxDistSqKm)}})}function et(e){return Ze(e)}var k={chunks:[],pointsMeshes:[],starsInView:[]};function wt(){return k}function Ft(e,t){const o=Q(e),r=o.layers.starfield,{starsInViewRef:n,getStarData:a,getStatus:u}=t,c=qe(e),s=[],i=[],l=[],f=[],x=[],m=Ve(),h=Oe();let d=0;const g=new fe,S=new ce,y=new pe,P=Re(),M=new E,F=new E,C=new E;function T(){for(const p of l)p.dispose();l.length=0;for(const p of s)p.dispose();s.length=0,i.length=0,f.length=0,x.length=0}function V(p){k.chunks=p,k.pointsMeshes=i,k.starsInView=n.current}return{refresh(){T();const p=Te(a,u,f);for(const v of p){x.push(new Float32Array(v.sizes));const z=c.createChunk({layer:"starfield",meshName:`cosmosive-starfield-points-${v.abbr.replace(/[^a-zA-Z0-9_-]/g,"_")}`,material:m,attributes:[{name:"position",data:v.positions,components:3},{name:"size",data:v.sizes,components:1},{name:"color",data:v.colors,components:3},{name:"warm",data:v.warm,components:1},{name:"brightness",data:v.brightness,components:1},{name:"mag",data:v.mag,components:1}]});s.push(z);const b=z.meshRef;i.push(b),l.push(Ke(b,r,h))}V(p)},advanceTime(p){d+=p,m.uniforms.uTime&&(m.uniforms.uTime.value=d),h.uniforms.uTime&&(h.uniforms.uTime.value=d)},countFrustum(){let p=0,v=0;const z=l.map(w=>w.mesh),b=[...i,...z];if(b.length>0){const w=o.cameraThree;w.updateMatrixWorld(!0),g.multiplyMatrices(w.projectionMatrix,w.matrixWorldInverse),S.setFromProjectionMatrix(g);for(const I of b){const A=I.geometry;A.boundingSphere||A.computeBoundingSphere();const R=A.boundingSphere;if(!R)continue;y.copy(R).applyMatrix4(I.matrixWorld);const D=A.getAttribute("position");v+=D?.count??0,S.intersectsSphere(y)&&(p+=1)}}return{total:b.length,visible:p,verts:v}},pickFromClick({clientX:p,clientY:v,canvas:z}){return et({kind:"r3f",clientX:p,clientY:v,canvas:z,starsInView:n.current,chunks:k.chunks,chunkDistancesKm:f,chunkOriginalSizes:x,cameraThree:o.cameraThree,pointsMeshes:i,pickerScratch:P,syncScratch:{forward:M,right:F,up:C}})},dispose(){T(),m.dispose(),h.dispose(),k.chunks=[],k.pointsMeshes=[],k.starsInView=[]}}}function L(e,t=1,o=1){const[r,n,a]=ge(e),u=Math.max(.15,Math.min(1,t));return[r*u,n*u,a*u,o]}var _={star1:L("#fff3a8",1),star2:L("#f5c238",1),star3:L("#e07b1a",1),star4:L("#a8380c",1)};function N(e){return new H(e[0],e[1],e[2])}function tt(){return{cool:N(_.star4),warm:N(_.star3),hot:N(_.star2),flare:N(_.star1)}}var ot=`
